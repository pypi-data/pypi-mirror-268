...
class MarketHandle():
    def __init__(self, tsocket: TSocket):
        ...
        self.__OHLC_Columns_Types = {
            "ExchangeID": str, "InstrumentID": str, "TradingDay": str, "ActionDay": str, "ActionTime": str, "ActionMSec": int,
            "Range": int, "OpenPrice": float, "HighestPrice": float, "LowestPrice": float,
    ...
    def fin_save_tick_list(self, instrument_id, df, **kwargs) -> Tuple[bool, str]:
        ...
        b, m, params = self.__create_fin_persists_save_param_data(instrument_id, "BTick", df, **kwargs)
        if b == False:
            return [b, m]
