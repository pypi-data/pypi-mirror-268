...
def fin_save_tick_list(instrument_id, df, **kwargs):
    ...
    Returns:
        _type_: [bool,str]
    """
    return FinClient.instance().market_handle().fin_save_tick_list(instrument_id, df, **kwargs)


def fin_read_tick_list(instrument_id: str, start_date: int = 0, end_date: int = 99999999, base_path: str = '', is_return_list: bool = False):
    '''
    获取basetick数据
    :param instrument_id:合约编码
