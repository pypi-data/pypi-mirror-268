...
class TSMLPEvalParametersProto(_message.Message):
    ...
    bn: bool
    time_column: str
    def __init__(self, input_width: _Optional[int] = ..., label_width: _Optional[int] = ..., dim_list: _Optional[_Iterable[int]] = ..., act_func: _Optional[_Union[_shared_pb2_1.ActFuncProto, str]] = ..., dropout: bool = ..., dropout_p: _Optional[float] = ..., bn: bool = ..., time_column: _Optional[str] = ...) -> None: ...
