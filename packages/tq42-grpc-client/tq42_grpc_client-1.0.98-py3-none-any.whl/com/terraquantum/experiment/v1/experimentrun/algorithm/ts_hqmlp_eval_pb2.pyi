...
from com.terraquantum.experiment.v1.experimentrun.algorithm.ml_layers import shared_pb2 as _shared_pb2_1
...
class TSHQMLPEvalParametersProto(_message.Message):
    ...
    num_qubits: int
    depth: int
    measurement_mode: _shared_pb2_1.MeasurementModeProto
    rotation: _shared_pb2_1.MeasureProto
    entangling: _shared_pb2_1.EntanglingProto
    measure: _shared_pb2_1.MeasureProto
    diff_method: _shared_pb2_1.DiffMethodProto
    qubit_type: _shared_pb2_1.QubitTypeProto
    act_func: _shared_pb2_1.ActFuncProto
    dropout: bool
    dropout_p: float
    bn: bool
    time_column: str
    def __init__(self, input_width: _Optional[int] = ..., label_width: _Optional[int] = ..., hidden_size: _Optional[int] = ..., num_qubits: _Optional[int] = ..., depth: _Optional[int] = ..., measurement_mode: _Optional[_Union[_shared_pb2_1.MeasurementModeProto, str]] = ..., rotation: _Optional[_Union[_shared_pb2_1.MeasureProto, str]] = ..., entangling: _Optional[_Union[_shared_pb2_1.EntanglingProto, str]] = ..., measure: _Optional[_Union[_shared_pb2_1.MeasureProto, str]] = ..., diff_method: _Optional[_Union[_shared_pb2_1.DiffMethodProto, str]] = ..., qubit_type: _Optional[_Union[_shared_pb2_1.QubitTypeProto, str]] = ..., act_func: _Optional[_Union[_shared_pb2_1.ActFuncProto, str]] = ..., dropout: bool = ..., dropout_p: _Optional[float] = ..., bn: bool = ..., time_column: _Optional[str] = ...) -> None: ...
