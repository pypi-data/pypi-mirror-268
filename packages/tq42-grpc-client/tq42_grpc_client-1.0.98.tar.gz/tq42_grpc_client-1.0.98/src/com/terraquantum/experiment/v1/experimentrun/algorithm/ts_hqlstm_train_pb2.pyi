...
class TSHQLSTMTrainParametersProto(_message.Message):
    __slots__ = ("input_width", "label_width", "hidden_size", "num_qubits", "depth", "n_qlayers", "dropout_coef", "num_epochs", "batch_size", "learning_rate", "optim", "loss_func", "train_model_info", "time_column", "target_column")
...
class TSHQLSTMTrainMetadataProto(_message.Message):
    ...
    def __init__(self, parameters: _Optional[_Union[TSHQLSTMTrainParametersProto, _Mapping]] = ..., inputs: _Optional[_Union[_ml_shared_pb2.MLTrainInputsProto, _Mapping]] = ...) -> None: ...

class TSHQLSTMTrainOutcomeProto(_message.Message):
