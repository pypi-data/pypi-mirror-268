...
class AppAppInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_input_id", "created_at", "created_by", "created_by_id", "default", "description", "display_name", "id", "name", "org_id", "required", "sensitive", "updated_at"]
