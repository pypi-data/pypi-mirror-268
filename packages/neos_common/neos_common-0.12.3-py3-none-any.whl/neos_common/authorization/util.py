...
PermissionArgs = typing.Union[
    # action, resource_type, resource_id
    tuple[base.Action, base.ResourceType, typing.Optional[str]],
    # action, resource_type, resource_id, partition, account_id
    tuple[base.Action, base.ResourceType, typing.Optional[str], typing.Optional[str], typing.Optional[str]],
]
...
class DepAuthorizationFactory:
    ...
    def build(  # noqa: C901
        ...
        class DepAuthorization(SecurityBase):
            def __init__(
                self,
                action_resources: typing.Union[ActionResourceList, list[ActionResource], ActionResource],
                *,
            ...
            def extract_action_resources(
                ...
                config: Config,
            ) -> tuple[list[typing.Union[base.Action, str]], list[base.ResourceLike]]:
                actions: list[typing.Union[base.Action, str]] = []
