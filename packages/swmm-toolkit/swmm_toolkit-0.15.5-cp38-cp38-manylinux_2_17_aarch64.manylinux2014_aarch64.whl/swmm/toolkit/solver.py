...
def swmm_stride(strideStep: "int") -> "double *":
...
def swmm_version_info() -> "char const *":
    return _solver.swmm_version_info()

def swmm_build_id() -> "char const *":
...
def swmm_setSimulationParam(type: "SM_SimSetting", value: "double") -> "int":
    return _solver.swmm_setSimulationParam(type, value)

def swmm_hotstart(type: "SM_HotStart", hsfile: "char const *") -> "int":
    r"""
...
def inlet_get_parameter(index: "int", param: "SM_InletProperty") -> "double *":
    r"""
...
def inlet_set_parameter(index: "int", param: "SM_InletProperty", value: "double") -> "int":
    r"""
    Get a property value for the inlet of a specified link.
...
def node_set_pollutant(index: "int", type: "SM_NodePollut", pollutant_index: "int", pollutant_value: "double") -> "int":
    r"""
...
def link_set_pollutant(index: "int", type: "SM_LinkPollut", pollutant_index: "int", pollutant_value: "double") -> "int":
    r"""
...
def inlet_get_result(index: "int", type: "SM_InletResult") -> "double *":
    r"""
    Get a result value for specified link.
