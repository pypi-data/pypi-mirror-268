...
from pista.core._root_manager import THREAD_DATA_RUNTIME_FILE
...
class RuntimeXL:
    ...
    def _fetchThisAttrFromAllThreads(cls, attr_name: RuntimeAttr, row_header_to_avoid=None) -> str:
        ...
        if 'true' in cls._IS_USE_THREAD_DATAFILE:
            try:
                thisAttrVals = ExcelUtil.read_all_excel_rows_for_col(filepath=cls.RUNTIME_FILE_PATH, col_header=attr_name.value,
    ...
    def getThisAttrFromAllThreads_old(cls, attr_name: RuntimeAttr, replaceFrom: str = None, replaceWith: str = None) -> str:
        ...
        if 'true' in cls._IS_USE_THREAD_DATAFILE:
            ...
            if thisAttrVals == '':
                ...
                thisAttrVals = \
                    Commons.get_tuplestr_by_replace(thisAttrVals, replace_from=replaceFrom, replace_with=replaceWith)
        ...
        if 'true' in cls._IS_USE_THREAD_DATAFILE:
            ...
            try:
                if len(cell_val_as_csv) > 0:
                    ExcelUtil.append_to_excel_cell(cls.RUNTIME_FILE_PATH, thread_id, attr_name.value, cell_val_as_csv)
            finally:
                pass
    ...
    def clearThisAttrForThread(cls, attr_name: RuntimeAttr):
        ...
        if 'true' in cls._IS_USE_THREAD_DATAFILE:
            ...
            try:
                ExcelUtil.clear_excel_cells(filepath=cls.RUNTIME_FILE_PATH, row_header=thread_id,
