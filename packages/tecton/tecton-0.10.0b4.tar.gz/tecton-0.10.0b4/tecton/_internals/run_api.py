...
def run_stream(fd: FeatureDefinitionWrapper, output_temp_table: str) -> StreamingQuery:
...
def _validate_mock_bfv_inputs_to_odfv(
    mock_inputs: Dict[str, Union[Dict[str, Any], pandas.DataFrame]], odfv_fd: FeatureDefinitionWrapper
):
