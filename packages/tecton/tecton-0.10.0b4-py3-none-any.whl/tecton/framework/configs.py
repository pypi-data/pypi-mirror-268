...
class Aggregation(StrictModel):
    ...
    def _to_proto(
        self, aggregation_interval: datetime.timedelta, is_continuous: bool, batch_compaction_enabled: bool = False
    ):
    ...
    def _default_name(
        self, aggregation_interval: datetime.timedelta, is_continuous: bool, batch_compaction_enabled: bool
    ) -> str:
        return build_aggregation_default_name(
            self.column, self.time_window, self.function, aggregation_interval, is_continuous, batch_compaction_enabled
        )
...
def build_aggregation_proto(
    ...
    proto = feature_view_pb2.FeatureAggregation(
        ...
        if name
            ...
            column, time_window, function, aggregation_interval, is_continuous, batch_compaction_enabled
        ),
        column=column,
...
def build_aggregation_default_name(
    ...
    if not batch_compaction_enabled:
