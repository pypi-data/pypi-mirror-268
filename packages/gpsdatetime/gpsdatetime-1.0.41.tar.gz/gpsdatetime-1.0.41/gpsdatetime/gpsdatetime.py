    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(args) > 0:
            ...
            if re.search('str', s):
                ...
                if re.search(gpsdatetime._re_snx, args[0]):
                    self.snx_t(args[0])
                    return
...
#        s1970 = decimal.Decimal(tm.mktime(t))
    ...
    def add_h(self, h=0.0):
        ...
        Output :
          self : updated gpsdatetime object
        """
        self._s1970_t(decimal.Decimal(self.s1970) + decimal.Decimal(h * 3600.0))
        return self
    ...
    def add_day(self, d=0.0):
        ...
        Output :
          self : updated gpsdatetime object
        """
        self._s1970_t(decimal.Decimal(self.s1970) + decimal.Decimal(d * 86400.0))
        return self
...
#        print(self)
    ...
    def st_iso_epoch(self, ndecimal=0):
        ...
        if ndecimal > 0:
            ...
            iso1 = format_str % (self.yyyy, self.mon, self.dd, self.hh, self.min, self.sec)      
            s60 = "60." + ndecimal * "0" + "Z"
        else:
        ...
        if re.search(s60, iso1):
            t1 = copy.copy(self)
            try:
                t1 += 5 / 10**(ndecimal+1)
            except:
                t1 += 1e-2
            return format_str % (t1.yyyy, t1.mon, t1.dd, t1.hh, t1.min, t1.sec)
...
if __name__ == "__main__":
    ...
    t = gpsdatetime('2018 12 31 23 59 59.999978')
    print(t.st_iso_epoch(0))
