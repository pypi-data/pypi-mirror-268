...
# Call the combine_files_into_dataframe function with the SharePoint client context and folder path as inputs
...
def upload_dataframe_to_sharepoint(ctx, folder, dataframe, file_name):
    """
    ...
    folder (Folder): The SharePoint folder where the file will be uploaded.
...
# Call the function to upload the DataFrame to the SharePoint folder
