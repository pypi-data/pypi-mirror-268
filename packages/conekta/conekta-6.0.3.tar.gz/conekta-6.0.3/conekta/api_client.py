...
from conekta.api_response import ApiResponse, T as ApiResponseT
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'Conekta/v2 PythonBindings/6.0.3'
    ...
    def conekta_user_agent(self, value):
        self.default_headers['X-Conekta-Client-User-Agent'] = value
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(conekta.models, klass)
