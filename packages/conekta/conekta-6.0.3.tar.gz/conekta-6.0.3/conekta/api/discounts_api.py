...
class DiscountsApi:
    ...
    @validate_call
    def orders_create_discount_line(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        order_discount_lines_request: Annotated[OrderDiscountLinesRequest, Field(description="requested field for a discount lines")],
        ...
        _param = self._orders_create_discount_line_serialize(
            id=id,
            order_discount_lines_request=order_discount_lines_request,
    ...
    @validate_call
    def orders_create_discount_line_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        order_discount_lines_request: Annotated[OrderDiscountLinesRequest, Field(description="requested field for a discount lines")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
    ...
    def _orders_create_discount_line_serialize(
        self,
        id,
        ...
        if order_discount_lines_request is not None:
            _body_params = order_discount_lines_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/orders/{id}/discount_lines',
    ...
    def orders_delete_discount_lines(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        discount_lines_id: Annotated[StrictStr, Field(description="discount line id identifier")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        x_child_company_id: Annotated[Optional[StrictStr], Field(description="In the case of a holding company, the company id of the child company to which will process the request.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param id: Identifier of the resource (required)
        :type id: str
        :param discount_lines_id: discount line id identifier (required)
        ...
        _param = self._orders_delete_discount_lines_serialize(
            id=id,
            discount_lines_id=discount_lines_id,
            accept_language=accept_language,
            x_child_company_id=x_child_company_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def orders_delete_discount_lines_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        discount_lines_id: Annotated[StrictStr, Field(description="discount line id identifier")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
    ...
    @validate_call
    def orders_delete_discount_lines_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        discount_lines_id: Annotated[StrictStr, Field(description="discount line id identifier")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
    ...
    def _orders_delete_discount_lines_serialize(
        self,
        id,
        discount_lines_id,
        accept_language,
        ...
        if id is not None:
            _path_params['id'] = id
        if discount_lines_id is not None:
            _path_params['discount_lines_id'] = discount_lines_id
        # process the query parameters
        # process the header parameters
        if accept_language is not None:
            _header_params['Accept-Language'] = accept_language
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/orders/{id}/discount_lines/{discount_lines_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def orders_get_discount_line(
        ...
        _param = self._orders_get_discount_line_serialize(
            id=id,
            discount_lines_id=discount_lines_id,
            accept_language=accept_language,
            x_child_company_id=x_child_company_id,
    ...
    @validate_call
    def orders_get_discount_line_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        discount_lines_id: Annotated[StrictStr, Field(description="discount line id identifier")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
    ...
    @validate_call
    def orders_get_discount_line_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        discount_lines_id: Annotated[StrictStr, Field(description="discount line id identifier")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
    ...
    def _orders_get_discount_line_serialize(
        self,
        id,
        discount_lines_id,
        accept_language,
    ...
    def orders_get_discount_lines(
        ...
        _param = self._orders_get_discount_lines_serialize(
            id=id,
            accept_language=accept_language,
            x_child_company_id=x_child_company_id,
            limit=limit,
    ...
    @validate_call
    def orders_get_discount_lines_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        x_child_company_id: Annotated[Optional[StrictStr], Field(description="In the case of a holding company, the company id of the child company to which will process the request.")] = None,
    ...
    @validate_call
    def orders_get_discount_lines_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        x_child_company_id: Annotated[Optional[StrictStr], Field(description="In the case of a holding company, the company id of the child company to which will process the request.")] = None,
    ...
    def _orders_get_discount_lines_serialize(
        self,
        id,
        accept_language,
        x_child_company_id,
    ...
    @validate_call
    def orders_update_discount_lines(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        discount_lines_id: Annotated[StrictStr, Field(description="discount line id identifier")],
        update_order_discount_lines_request: Annotated[UpdateOrderDiscountLinesRequest, Field(description="requested field for a discount lines")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        x_child_company_id: Annotated[Optional[StrictStr], Field(description="In the case of a holding company, the company id of the child company to which will process the request.")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._orders_update_discount_lines_serialize(
            id=id,
            discount_lines_id=discount_lines_id,
            update_order_discount_lines_request=update_order_discount_lines_request,
            accept_language=accept_language,
            x_child_company_id=x_child_company_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def orders_update_discount_lines_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        discount_lines_id: Annotated[StrictStr, Field(description="discount line id identifier")],
        update_order_discount_lines_request: Annotated[UpdateOrderDiscountLinesRequest, Field(description="requested field for a discount lines")],
    ...
    @validate_call
    def orders_update_discount_lines_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        discount_lines_id: Annotated[StrictStr, Field(description="discount line id identifier")],
        update_order_discount_lines_request: Annotated[UpdateOrderDiscountLinesRequest, Field(description="requested field for a discount lines")],
    ...
    def _orders_update_discount_lines_serialize(
        self,
        id,
        discount_lines_id,
        ...
        # process the form parameters
        # process the body parameter
        if update_order_discount_lines_request is not None:
            _body_params = update_order_discount_lines_request
