...
class ChargesApi:
    ...
    def orders_create_charge(
        ...
        _param = self._orders_create_charge_serialize(
            id=id,
    ...
    @validate_call
    def orders_create_charge_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        charge_request: Annotated[ChargeRequest, Field(description="requested field for a charge")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
    ...
    @validate_call
    def orders_create_charge_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        charge_request: Annotated[ChargeRequest, Field(description="requested field for a charge")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
    ...
    def _orders_create_charge_serialize(
        self,
        id,
        charge_request,
        accept_language,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/orders/{id}/charges',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_charge(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        charge_update_request: Annotated[ChargeUpdateRequest, Field(description="requested field for update a charge")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        x_child_company_id: Annotated[Optional[StrictStr], Field(description="In the case of a holding company, the company id of the child company to which will process the request.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param id: Identifier of the resource (required)
        :type id: str
        :param charge_update_request: requested field for update a charge (required)
        :type charge_update_request: ChargeUpdateRequest
        :param accept_language: Use for knowing which language to use
        :type accept_language: str
        :param x_child_company_id: In the case of a holding company, the company id of the child company to which will process the request.
        :type x_child_company_id: str
        ...
        _param = self._update_charge_serialize(
            id=id,
            charge_update_request=charge_update_request,
            accept_language=accept_language,
            x_child_company_id=x_child_company_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _update_charge_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if charge_update_request is not None:
            _body_params = charge_update_request
