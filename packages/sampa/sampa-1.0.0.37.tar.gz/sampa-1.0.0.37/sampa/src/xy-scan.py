...
displacement_A1 = replace_displacement_A1    # Deslocamentos a ser aplicado no 2º material, referente ao vetor A1 da rede
displacement_A2 = replace_displacement_A2    # Deslocamentos a ser aplicado no 2º material, referente ao vetor A2 da rede
