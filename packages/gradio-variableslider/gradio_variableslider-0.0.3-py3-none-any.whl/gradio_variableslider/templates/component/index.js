...
let Pe = st ? () => window.performance.now() : () => Date.now(), ft = st ? (l) => requestAnimationFrame(l) : pe;
...
const {
  ...
  transition_out: le,
  update_slot_base: Pl
} = window.__gradio__svelte__internal, { tick: Tl } = window.__gradio__svelte__internal, { onDestroy: Zl } = window.__gradio__svelte__internal, Bl = (l) => ({}), Ue = (l) => ({});
function Oe(l, t, e) {
  const n = l.slice();
...
function Wl(l, t, e) {
  let n, { $$slots: i = {}, $$scope: f } = t, { i18n: o } = t, { eta: _ = null } = t, { queue_position: s } = t, { queue_size: a } = t, { status: u } = t, { scroll_to_output: c = !1 } = t, { timer: k = !0 } = t, { show_progress: m = "full" } = t, { message: y = null } = t, { progress: S = null } = t, { variant: F = "default" } = t, { loading_text: N = "Loading..." } = t, { absolute: d = !0 } = t, { translucent: r = !1 } = t, { border: v = !1 } = t, { autoscroll: C } = t, b, G = !1, J = 0, R = 0, X = null, P = null, _e = 0, U = null, K, T = null, ae = !0;
  const g = () => {
...
function bn(l, t, e) {
  ...
  function P() {
    const g = Number(C.value) - Number(C.min), Z = Number(C.max) - Number(C.min), re = Z === 0 ? 0 : g / Z;
