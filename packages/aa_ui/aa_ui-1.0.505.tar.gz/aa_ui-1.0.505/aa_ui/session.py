...
if TYPE_CHECKING:
    ...
    from aa_ui.types import FileDict, FileReference
...
class HTTPSession(BaseSession):
    """Internal HTTP session object. Used to consume aa_ui through API (no websocket)."""
...
class WebsocketSession(BaseSession):
    ...
    @property
    def files_dir(self):
        from aa_ui.config import FILES_DIRECTORY
