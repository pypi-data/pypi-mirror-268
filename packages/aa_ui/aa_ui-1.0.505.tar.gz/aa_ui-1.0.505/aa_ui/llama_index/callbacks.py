...
from aa_ui.context import context_var
from aa_ui.element import Text
from aa_ui.step import Step, StepType
...
class LlamaIndexCallbackHandler(TokenCountingHandler):
    ...
    def _restore_context(self) -> None:
        """Restore aa_ui context in the current thread

        aa_ui context is local to the main thread, and LlamaIndex
        runs the callbacks in its own threads, so they don't have a
        aa_ui context by default.
