...
from aa_ui.auth import get_current_user, require_login
from aa_ui.config import config
from aa_ui.context import init_ws_context
from aa_ui.data import get_data_layer
from aa_ui.logger import logger
from aa_ui.message import ErrorMessage, Message
from aa_ui.server import socket
from aa_ui.session import WebsocketSession
from aa_ui.telemetry import trace_event
from aa_ui.types import UIMessagePayload
from aa_ui.user_session import user_sessions
...
async def connect(sid, environ, auth):
    ...
    session_id = environ.get("HTTP_X_aa_ui_SESSION_ID")
    ...
    client_type = environ.get("HTTP_X_aa_ui_CLIENT_TYPE")
    ...
    ws_session = WebsocketSession(
        ...
        user=user,
        token=token,
        chat_profile=environ.get("HTTP_X_aa_ui_CHAT_PROFILE"),
        thread_id=environ.get("HTTP_X_aa_ui_THREAD_ID"),
    )
