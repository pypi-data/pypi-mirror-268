...
#if !defined( _LIBHMAC_TYPES_H )
#define _LIBHMAC_TYPES_H
...
#define __USE_UNIX98
#define LIBHMAC_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBHMAC_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBHMAC_DEFINITION_UNIX98
#endif
...
#endif /* !defined( _LIBHMAC_TYPES_H ) */
