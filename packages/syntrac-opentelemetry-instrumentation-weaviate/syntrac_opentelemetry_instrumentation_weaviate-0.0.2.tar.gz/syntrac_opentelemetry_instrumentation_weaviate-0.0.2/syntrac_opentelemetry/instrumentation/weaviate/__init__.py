...
from syntrac_opentelemetry.instrumentation.weaviate.version import __version__
from syntrac_opentelemetry.instrumentation.weaviate.wrapper import _wrap
