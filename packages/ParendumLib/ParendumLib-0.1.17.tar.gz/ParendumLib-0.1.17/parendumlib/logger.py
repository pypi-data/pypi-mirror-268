...
class Logger:
    ...
    def success(self, message: str, save: bool = False):
        ...
        self._do_log('success', f"{caller_name}():{caller_line_no}", message, 0, save=save)
    ...
    def debug(self, message: str, save: bool = False):
        ...
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log('debug', f"{caller_name}():{caller_line_no}", message, 100, save=save)
    ...
    def info(self, message: str, save: bool = False):
        ...
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log('info', f"{caller_name}():{caller_line_no}", message, 200, save=save)
    ...
    def warning(self, message: str, save: bool = False):
        ...
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log('warning', f"{caller_name}():{caller_line_no}", message, 400, save=save)
    ...
    def error(self, message: str, save: bool = False):
        ...
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log('error', f"{caller_name}():{caller_line_no}", message, 500, save=save)
    ...
    def exception(self, message: str, save: bool = False):
        ...
        caller_name = caller_info.function
        caller_line_no = caller_info.lineno
        self._do_log('exception', f"{caller_name}():{caller_line_no}", message, 600, save=save)
