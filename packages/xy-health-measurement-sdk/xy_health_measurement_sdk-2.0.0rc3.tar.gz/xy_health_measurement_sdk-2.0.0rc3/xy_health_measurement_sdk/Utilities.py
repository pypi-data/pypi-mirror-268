...
class Utility(object):
    ...
    def get_validation(cls, code: Validation):
        ...
        v = cls.__validation
        return deepcopy(cls.__validation[Validation.Name(code)])
    ...
    def assure_adequate_frames(cls, duration, frames_cnt, measurement_duration=None):
        ...
        return duration >= measurement_duration and frames_cnt >= cls.get_config('min_frames_cnt') * measurement_duration / min_measurement_duration
