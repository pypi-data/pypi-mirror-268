  ...
  'syms': { 'bellek.hf.datasets.utils': { 'bellek.hf.datasets.utils.concatenate_dataset_dicts': ( 'hf.datasets.utils.html#concatenate_dataset_dicts',
            ...
            'bellek.jerx.prompt': { 'bellek.jerx.prompt.JERXChatFormatter': ('jerx.prompt.html#jerxchatformatter', 'bellek/jerx/prompt.py'),
                                    ...
                                    'bellek.jerx.prompt.JERXChatFormatter.make_system_message': ( 'jerx.prompt.html#jerxchatformatter.make_system_message',
                                                                                                  'bellek/jerx/prompt.py')},
            'bellek.jerx.reward.gpt': { 'bellek.jerx.reward.gpt.Result': ('jerx.reward.gpt.html#result', 'bellek/jerx/reward/gpt.py'),
            ...
            'bellek.llama_index.indices.knowledge_graph.retrievers': { 'bellek.llama_index.indices.knowledge_graph.retrievers.KGTableRetriever': ( 'llama_index.indices.knowledge_graph.retrievers.html#kgtableretriever',
                                                                       ...
                                                                       'bellek.llama_index.indices.knowledge_graph.retrievers.KGTableRetriever._retrieve': ( 'llama_index.indices.knowledge_graph.retrievers.html#kgtableretriever._retrieve',
                                                                                                                                                             'bellek/llama_index/indices/knowledge_graph/retrievers.py')},
            'bellek.llama_index.llms': { 'bellek.llama_index.llms.HuggingFaceTextGenInferenceLLM': ( 'llama_index.llms.html#huggingfacetextgeninferencellm',
                                                                                                     'bellek/llama_index/llms.py')},
            ...
            'bellek.ml.vision': { 'bellek.ml.vision.Make3Channel': ('ml.vision.html#make3channel', 'bellek/ml/vision.py'),
                                  ...
                                  'bellek.ml.vision.TorchVisionTransform.encodes': ( 'ml.vision.html#torchvisiontransform.encodes',
                                                                                     'bellek/ml/vision.py')},
            'bellek.musique.eval': { 'bellek.musique.eval.AnswerMetric': ('musique.eval.html#answermetric', 'bellek/musique/eval.py'),
                                     'bellek.musique.eval.AnswerMetric.__call__': ( 'musique.eval.html#answermetric.__call__',
                                                                                    'bellek/musique/eval.py'),
                                     'bellek.musique.eval.AnswerMetric.__init__': ( 'musique.eval.html#answermetric.__init__',
                                                                                    'bellek/musique/eval.py'),
                                     'bellek.musique.eval.AnswerMetric.get_metric': ( 'musique.eval.html#answermetric.get_metric',
                                                                                      'bellek/musique/eval.py'),
                                     'bellek.musique.eval.AnswerMetric.reset': ( 'musique.eval.html#answermetric.reset',
                                                                                 'bellek/musique/eval.py'),
                                     'bellek.musique.eval.compute_exact': ('musique.eval.html#compute_exact', 'bellek/musique/eval.py'),
