...
def main():
    args = ClientArgs.ParsePlatform(description="List projects", init=initParser)
    ...
    def getResponses():
        cursor = None
        while True:
            response = clientv3.GetProjectListV3(nameprefix=args.nameprefix, role=args.role, capability=args.capability, sortby=args.sortby, sortorder=args.sortorder, cursor=cursor, limit=args.limit)
            yield response
