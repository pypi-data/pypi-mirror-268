...
def ocrnet_transform(args):
    ...
    print(f"workspace_id: {workspace_id}, model_store_name:{model_store_name}, local_name:{local_name}, output_model_uri:{args.output_model_uri}")
