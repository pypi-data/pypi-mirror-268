...
from gaea_operator.metric.analysis import InferenceMetricAnalysis
...
class Metric(object):
    ...
    """
    def __init__(self,
                 metric: List[Union[EvalMetricAnalysis, InferenceMetricAnalysis, LabelStatisticMetricAnalysis]],
    ...
    def __call__(self, references: List[Dict] = None,
        ...
        metric_result.update(base_metric.dict())
