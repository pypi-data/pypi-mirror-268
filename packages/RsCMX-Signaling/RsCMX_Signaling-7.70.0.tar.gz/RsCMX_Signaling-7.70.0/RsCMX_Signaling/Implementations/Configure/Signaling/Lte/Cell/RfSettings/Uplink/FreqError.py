...
class FreqErrorCls:
	...
	def set(self, cell_name: str, frequency_error: float) -> None:
		...
		Snippet: driver.configure.signaling.lte.cell.rfSettings.uplink.freqError.set(cell_name = 'abc', frequency_error = 1.0) \n
		...
		self._core.io.write(f'CONFigure:SIGNaling:LTE:CELL:RFSettings:UL:FERRor {param}'.rstrip())
	...
	def get(self, cell_name: str) -> GetStruct:
		"""SCPI: [CONFigure]:SIGNaling:LTE:CELL:RFSettings:UL:FERRor \n
		Snippet: value: GetStruct = driver.configure.signaling.lte.cell.rfSettings.uplink.freqError.get(cell_name = 'abc') \n
		Configures a frequency error to be added to the configured UL carrier center frequency. \n
			:param cell_name: No help available
			:return: structure: for return value, see the help for GetStruct structure arguments."""
		param = Conversions.value_to_quoted_str(cell_name)
		return self._core.io.query_struct(f'CONFigure:SIGNaling:LTE:CELL:RFSettings:UL:FERRor? {param}', self.__class__.GetStruct())
