...
class ConfigCls:
	...
	def set(self, structure: SetStruct) -> None:
		...
		Defines settings of TRS <Index>, for the initial BWP. If there are several TRS configurations, a query returns the
		settings of all TRS configurations. \n
	...
	def get(self, cell_name: str) -> GetStruct:
		"""SCPI: [CONFigure]:SIGNaling:NRADio:CELL:CSI:TRS:CONFig \n
		Snippet: value: GetStruct = driver.configure.signaling.nradio.cell.csi.trs.config.get(cell_name = 'abc') \n
		Defines settings of TRS <Index>, for the initial BWP. If there are several TRS configurations, a query returns the
		settings of all TRS configurations. \n
