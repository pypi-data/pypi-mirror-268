...
class BeamsCls:
	...
	@property
	def activeBeam(self):
		"""activeBeam commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_activeBeam'):
			from .ActiveBeam import ActiveBeamCls
			self._activeBeam = ActiveBeamCls(self._core, self._cmd_group)
		return self._activeBeam
