...
class NradioCls:
	...
	@property
	def pdcchOrder(self):
		"""pdcchOrder commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_pdcchOrder'):
			from .PdcchOrder import PdcchOrderCls
			self._pdcchOrder = PdcchOrderCls(self._core, self._cmd_group)
		return self._pdcchOrder
