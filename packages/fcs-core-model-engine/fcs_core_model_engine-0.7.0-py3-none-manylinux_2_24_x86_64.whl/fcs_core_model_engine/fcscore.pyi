...
class MeshElementOrder(enum.Enum):
	...
	SECOND: MeshElementType

class MeshSettings:
	def __init__(self, mesh_size: float, element_type: MeshElementType, element_order: MeshElementOrder): ...
...
class MeshFactory:
	...
	def mesh_face(self, geom_object_face: GEOM_Object, mesh_settings: MeshSettings) -> Mesh: ...
...
class ModelBuilder:
	...
	def set_object_color(self, item_id: int, colour: Color) -> bool: ...
