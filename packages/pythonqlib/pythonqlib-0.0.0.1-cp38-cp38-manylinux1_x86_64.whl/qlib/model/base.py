...
class Model(BaseModel):
    ...
    def fit(self, df_train, df_valid, reweighter: Reweighter): #(self, dataset: Dataset, reweighter: Reweighter):
        """
...
class ModelFT(Model):
    ...
    @abc.abstractmethod
    def finetune(self, df_train, df_valid): #(self, dataset: Dataset):
