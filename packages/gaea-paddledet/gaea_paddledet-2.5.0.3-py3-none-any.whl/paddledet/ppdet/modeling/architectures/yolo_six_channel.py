...
from ppdet.modeling.architectures.meta_arch_pair import BaseArchPair
from .meta_arch import BaseArch
from ..post_process import JDEBBoxPostProcess

__all__ = ['YOLOv3SixChannel']


@register
class YOLOv3SixChannel(BaseArchPair):
    ...
    def __init__(self,
        ...
        """
        super(YOLOv3SixChannel, self).__init__(data_format=data_format)
    ...
    def _forward(self):
        ...
        if self.training:
            # print(f"scale_neck_feats[0].shape:{neck_feats[0].shape}")
            # print(f"scale_neck_feats[1].shape:{neck_feats[1].shape}")
            # print(f"scale_neck_feats[2].shape:{neck_feats[2].shape}")
