...
__all__ = ['DarkNetPair', 'ConvBNPairLayer']


class ConvBNPairLayer(nn.Layer):
    def __init__(self,
                 ch_in,
                 ch_out,
                 filter_size=3,
        ...
        """
        super(ConvBNPairLayer, self).__init__()
...
class DownSample(nn.Layer):
    def __init__(self,
        ...
        self.conv_bn_layer = ConvBNPairLayer(
            ch_in=ch_in,
            ch_out=ch_out,
...
class DarkNetPair(nn.Layer):
    ...
    def __init__(self,
        ...
        Args:
            ...
            data_format (str): data format, NCHW or NHWC
        """
        super(DarkNetPair, self).__init__()
        self.depth = depth
