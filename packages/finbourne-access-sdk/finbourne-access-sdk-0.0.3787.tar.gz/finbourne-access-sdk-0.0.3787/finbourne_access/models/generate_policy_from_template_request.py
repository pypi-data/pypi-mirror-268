...
"""
    ...
    The version of the OpenAPI document: 0.0.3787
...
class GeneratePolicyFromTemplateRequest(object):
    ...
    def selectors(self, selectors):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                selectors is not None and len(selectors) > 10):
            raise ValueError("Invalid value for `selectors`, number of items must be less than or equal to `10`")  # noqa: E501
