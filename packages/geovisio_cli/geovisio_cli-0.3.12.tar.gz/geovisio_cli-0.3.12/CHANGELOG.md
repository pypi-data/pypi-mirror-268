...
- Folder name appears in error output [https://gitlab.com/geovisio/cli/-/issues/38](#38)

### Fixed

- Automatic title associated to a sequence works also when uploading from a directory itself (`geovisio upload .`) [https://gitlab.com/geovisio/cli/-/issues/22](#22)
...
[Unreleased]: https://gitlab.com/geovisio/cli/-/compare/0.3.12...main
[0.3.12]: https://gitlab.com/geovisio/cli/-/compare/0.3.11...0.3.12
[0.3.11]: https://gitlab.com/geovisio/cli/-/compare/0.3.10...0.3.11
[0.3.10]: https://gitlab.com/geovisio/cli/-/compare/0.3.9...0.3.10
