...
class FakeInternalAPIClient:
    ...
    def create_compute_template_api_v2_compute_templates_post(
        ...
        compute_config_id = f"compute-template-{str(uuid.uuid4())}"
...
class TestComputeConfig:
    ...
    def test_create_compute_config(
        ...
        # Name provided.
        compute_config_id_1 = anyscale_client.create_compute_config(
        ...
        compute_config_id_2 = anyscale_client.create_compute_config(config)
