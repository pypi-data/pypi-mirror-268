...
@sdk_command(
    ...
    arg_docstrings={
        ...
        "in_place": "Perform an in-place upgrade without starting a new cluster. This can be used for faster iteration during development but is *not* currently recommended for production deploys. This cannot be used to changing cluster-level options such as image and compute config (they will be ignored).",
