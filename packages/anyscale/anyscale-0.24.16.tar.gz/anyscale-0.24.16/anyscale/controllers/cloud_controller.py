    ...
    def create_cloudformation_stack(  # noqa: PLR0913
        ...
        if is_anyscale_hosted:
            ...
            if anyscale_hosted_network_info is not None:
                ...
                for i, subnet_with_az in enumerate(
                    anyscale_hosted_network_info["subnet_ids"]
                ):
                    parameters.append(
                        {
                            "ParameterKey": f"Subnet{i}",
                            "ParameterValue": subnet_with_az["subnet_id"],
                        },
                    )
        ...
        *,
        ...
        if cloud.provider == "AWS":
            ...
            if (
                ...
                [aws_s3_id, aws_efs_id, aws_efs_mount_target_ip, memorydb_cluster_id]
            ):
                self.cloud_event_producer.produce(
                    CloudAnalyticsEventName.RESOURCES_EDITED,
                    succeeded=False,
