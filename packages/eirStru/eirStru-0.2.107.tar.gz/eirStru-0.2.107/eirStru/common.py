...
class EirTaskInfo(BaseModel):
    ...
    apply_ctntypedigit: Optional[str] = ''  # 需一次性申请的箱型箱量 todo cma？
...
class BillInfo(BaseModel):
    ...
    bookingagent_id: Optional[Any] = None  # 代理
    bill_no: Optional[Any] = None  # 提单
    booking_no: Optional[Any] = None  # 订舱号
    vessel: Optional[Any] = None  # 船名
    voyage: Optional[Any] = None  # 航次
    rel_vessel: Optional[Any] = None
    rel_voyage: Optional[Any] = None
    vessel_id: Optional[Any] = None
