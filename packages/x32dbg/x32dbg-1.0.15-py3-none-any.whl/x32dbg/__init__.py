...
class MyStruct(Structure):
    ...
    _fields_ = [
        ...
        ("Command_String_F", c_char * 256),
        ("Command_LongString_A", c_char * 1024),
        ("Command_LongString_B", c_char * 1024),
        ("Command_LongString_C", c_char * 1024),
        ("Command_LongString_D", c_char * 1024),
        ("Command_int_A", c_uint),
        ("Command_int_B", c_uint),
        ("Command_int_C", c_uint),
        ("Command_int_D", c_uint),
        ("Command_int_E", c_uint),
        ("Command_int_F", c_uint),
        ("ControllerId", c_int),
        ("Token", c_int),
        ("Count", c_int),
        ("Flag", c_int),
    ...
    # 打包成字节序
    def pack(self):
        buffer = struct.pack("< 256s 256s 256s 256s 256s 256s 1024s 1024s 1024s 1024s i i i i i i i i i i",
                             self.Command_String_A,
                             self.Command_String_B,
                             self.Command_String_C,
                             self.Command_String_D,
                             self.Command_String_E,
                             self.Command_String_F,
                             self.Command_LongString_A,
                             self.Command_LongString_B,
                             self.Command_LongString_C,
                             self.Command_LongString_D,
                             self.Command_int_A,
                             self.Command_int_B,
                             self.Command_int_C,
                             self.Command_int_D,
    ...
    def unpack(self, buffer):
        (
            ...
            self.Count,
            self.Flag
        ) = struct.unpack("< 256s 256s 256s 256s 256s 256s 1024s 1024s 1024s 1024s i i i i i i i i i i", buffer)
            ...
            try:
                ...
                if recv_count != 0:
                    for index in range(0, recv_count):
                        ...
                        dic.update(
                            {"base": base, "entry": entry, "name": decode_name, "path": decode_path, "size": size})
    ...
    def get_thread_list(self):
        ...
        try:
            ...
            try:
                ...
                if recv_count != 0:
                    for index in range(0, recv_count):
                        dic = {"thread_number": None, "thread_id": None, "thread_name": None, "local_base": None,
                               "start_address": None}
                        ...
                        dic.update({"thread_number": number, "thread_id": id, "thread_name": decode_name,
                                    "local_base": local_base, "start_address": start_addr})
