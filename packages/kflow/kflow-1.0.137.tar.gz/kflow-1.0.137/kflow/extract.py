...
def dms_path(date):
    ...
    elif ((date >= datetime(2023,7,4)) and (date < datetime(2024,3,28))):
        bucket = "klog-co-pro"
        logging.info(f"Set bucket: {bucket}")
    elif (date >= datetime(2024,3,28)) and (date < datetime(2024,4,13)):
        bucket = "klog-co-prod-202403"
        logging.info(f"Set bucket: {bucket}")
    elif (date >= datetime(2024,4,13)) and (date < datetime(2024,4,15)):
        bucket = "klog-co-prod-202404"
        logging.info(f"Set bucket: {bucket}")
    elif (date >= datetime(2024,4,15)):
