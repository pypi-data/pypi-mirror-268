...
class Config:
    ...
    @classmethod
    def default(cls, emr: bool = False, system_setting: dict = None):
        """
        ...
        """
        local_dir = f"{SystemSetting(system_setting).CACHE_DIR}/.cache/dataverse/tmp"
    ...
    @classmethod
    def set_default(cls, config: OmegaConf, emr: bool = False, system_setting=None):
        """
        ...
        """
        return OmegaConf.merge(cls.default(emr=emr, system_setting=system_setting), config)
