...
if __name__ == '__main__':
    ...
    if not os.path.exists(config_file):
        ...
        with open(MODULE_PATH / 'photogps.example.yaml') as f:
            with open(config_file, 'w') as f2:
                f2.write(f.read())
        print(f'{Fore.RED}Config file not found. {Fore.RESET}I created default config file {Fore.GREEN}{config_file}{Fore.RESET} for you. Please edit it and run the script again.')
        exit(1)
    ...
    # run('rm -f /Users/antonsilin/WWW/photo-gps-client/photo/test/*', shell=True)
    # run('cp /Users/antonsilin/WWW/photo-gps-client/photo/src/* /Users/antonsilin/WWW/photo-gps-client/photo/test/', shell=True)
