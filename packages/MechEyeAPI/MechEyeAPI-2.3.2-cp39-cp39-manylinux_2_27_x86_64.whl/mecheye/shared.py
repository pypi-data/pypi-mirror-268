...
class ErrorStatus(object):
    ...
    r"""
    The operation is not supported. Possible reasons include: 1. Firmware version
    is inconsistent with Mech-Eye API version; 2. Device model does not provide the
    ...
    settable value range of the device parameter.
    """
    ...
    r"""
    The set timeout period exceeded when performing operations such as connecting
    to the device and retrieving data.
    """
    ...
    r""" There are errors in the reply from device."""
    ...
    r"""
    The callback function registration is executed again
    before data acquisition is stopped.
    """
    ...
    def is_ok(self):
        r"""Returns true if the operation succeeds."""
...
class Size(object):
    r"""Describes a size with a width and a height."""
...
class ROI(object):
    ...
    upper_left_x = property(_shared.ROI_upper_left_x_get, _shared.ROI_upper_left_x_set, doc=r""" The column coordinate of the upper-left corner of ROI.""")
    upper_left_y = property(_shared.ROI_upper_left_y_get, _shared.ROI_upper_left_y_set, doc=r""" The row coordinate of the upper-left corner of ROI.""")
...
class UserSet(object):
    ...
    def rename(self, newName):
        ...
        :param [in]: newName The new user set name to rename.
        :rtype: :py:class:`ErrorStatus`
        :return: 
             'ErrorStatus.MMIND_STATUS_SUCCESS' Success.
    ...
    def get_parameter(self, parameterName):
        r"""Gets the pointer to the elements of a specific device parameter."""
...
class UserSetManager(object):
    ...
    def select_user_set(self, userSetName):
        ...
        :param [in]: userSetName The input user set name to select.
        :rtype: :py:class:`ErrorStatus`
        :return: 
             'ErrorStatus.MMIND_STATUS_SUCCESS' Success.
    ...
    def add_user_set(self, userSetName):
        ...
        :param [in]: userSetName The input user set name to add.
        :rtype: :py:class:`ErrorStatus`
        :return: 
             'ErrorStatus.MMIND_STATUS_SUCCESS' Success.
    ...
    def delete_user_set(self, userSetName):
        ...
        :param [in]: userSetName The input user set name to delete.
        :rtype: :py:class:`ErrorStatus`
        :return: 
             'ErrorStatus.MMIND_STATUS_SUCCESS' Success.
    ...
    def load_from_file(self, fileName):
        r"""
        Imports device user sets from a JSON file and overwrites existing device
        ...
        :return: 
             ...
             'ErrorStatus.MMIND_STATUS_FILE_IO_ERROR' Wrong file name passed; or fails to save user
             set file, or open file, or file format error.
        """
...
def get_api_version_info():
    r"""Gets the API version information."""
...
class Version(object):
    ...
    def to_string(self):
        r"""Converts a Version object to a string of Version."""
        return _shared.Version_to_string(self)

    def from_string(self, version):
        r"""Converts a string of version to a Version object."""
