...
class PointXYZ(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    x = property(_area_scan_3d_camera.PointXYZ_x_get, _area_scan_3d_camera.PointXYZ_x_set, doc=r"""x : float""")
    y = property(_area_scan_3d_camera.PointXYZ_y_get, _area_scan_3d_camera.PointXYZ_y_set, doc=r"""y : float""")
    z = property(_area_scan_3d_camera.PointXYZ_z_get, _area_scan_3d_camera.PointXYZ_z_set, doc=r"""z : float""")

    def __init__(self):
        r"""__init__(PointXYZ self) -> PointXYZ"""
        _area_scan_3d_camera.PointXYZ_swiginit(self, _area_scan_3d_camera.new_PointXYZ())
    __swig_destroy__ = _area_scan_3d_camera.delete_PointXYZ

# Register PointXYZ in _area_scan_3d_camera:
_area_scan_3d_camera.PointXYZ_swigregister(PointXYZ)
...
class PointXYZWithNormals(object):
    ...
    y, z) and normal vector coordinate (x, y, z) information.
    """
...
FileFormat_PLY = _area_scan_3d_camera.FileFormat_PLY

FileFormat_PCD = _area_scan_3d_camera.FileFormat_PCD

FileFormat_CSV = _area_scan_3d_camera.FileFormat_CSV
...
class Frame3D(object):
    ...
    def get_untextured_point_cloud(self):
        ...
        system. The X, Y, and Z data unit is in mm, and invalid data is in nan.
    ...
    def get_untextured_point_cloud_with_normals(self):
        ...
        coordinate system. The X, Y, and Z data unit is in mm, and invalid data is in nan. Normal
        vectors are computed for each point. If the 'Frame3D' is obtained by
    ...
    def get_depth_map(self):
        ...
        'DepthMap' contains the depth (z-coordinate) data in the camera refrence frame.
        If the application only requires the depth data, obtaining the 'DepthMap' is more
        efficient. The unit of the depth data is millimeter, and the invalid data is represented by
        "nan".
    ...
    def save_untextured_point_cloud(self, fileFormat, fileName, isOrganized=False):
        ...
        Each point contains x, y, and z fields. The unit of the coordinate data is millimeter. Point
        cloud can be saved in organized or unorganized structure with ACSII mode.
    ...
    def save_untextured_point_cloud_with_normals(self, fileFormat, fileName, isOrganized=False):
        r"""
        Saves the untextured point cloud to a file of the input file format and filename.
        Each point contains x, y, z, normalX, normalY, and normalZ fields. The unit of the coordinate
    ...
    @staticmethod
    def save_point_cloud(pointCloud, fileFormat, fileName, isOrganized=False):
        r"""
        Saves the untextured point cloud to a file of the input file format and filename.
        Each point contains x, y, and z fields. The unit of the coordinate data is millimeter. Point
        cloud can be saved in organized or unorganized structure with ACSII mode.
        ...
        :return: 
            ...
            file.
        """
        return _area_scan_3d_camera.Frame3D_save_point_cloud(pointCloud, fileFormat, fileName, isOrganized)

    @staticmethod
    def save_point_cloud_with_normals(pointCloud, fileFormat, fileName, isOrganized=False):
        r"""
        Saves the untextured point cloud to a file of the input file format and filename.
        Each point contains x, y, z, normalX, normalY, and normalZ fields. The unit of the coordinate
        data is millimeter. Point cloud can be saved in organized or unorganized structure with ACSII
        ...
        :return: 
            ...
            file.
        """
        return _area_scan_3d_camera.Frame3D_save_point_cloud_with_normals(pointCloud, fileFormat, fileName, isOrganized)
...
class UntexturedPointCloudWithNormals(object):
    ...
    def data(self):
        ...
        w = self.width()
        h = self.height()
        img = np.frombuffer((ctypes.c_float * w * h * 6).from_address(int(data.this)), np.float32)
        img = np.reshape(img, (h, w, 6))
        return img.copy()
...
class PointXYZBGR(object):
    ...
    (blue, green, and red) information.
    """

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    x = property(_area_scan_3d_camera.PointXYZBGR_x_get, _area_scan_3d_camera.PointXYZBGR_x_set, doc=r"""x : float""")
    y = property(_area_scan_3d_camera.PointXYZBGR_y_get, _area_scan_3d_camera.PointXYZBGR_y_set, doc=r"""y : float""")
    z = property(_area_scan_3d_camera.PointXYZBGR_z_get, _area_scan_3d_camera.PointXYZBGR_z_set, doc=r"""z : float""")
    b = property(_area_scan_3d_camera.PointXYZBGR_b_get, _area_scan_3d_camera.PointXYZBGR_b_set, doc=r"""b : uint8_t""")
    g = property(_area_scan_3d_camera.PointXYZBGR_g_get, _area_scan_3d_camera.PointXYZBGR_g_set, doc=r"""g : uint8_t""")
    r = property(_area_scan_3d_camera.PointXYZBGR_r_get, _area_scan_3d_camera.PointXYZBGR_r_set, doc=r"""r : uint8_t""")

    def __init__(self):
        r"""__init__(PointXYZBGR self) -> PointXYZBGR"""
        _area_scan_3d_camera.PointXYZBGR_swiginit(self, _area_scan_3d_camera.new_PointXYZBGR())
...
class PointXYZBGRWithNormals(object):
    ...
    z), texture (blue, green, red), and normal vector coordinate (x, y, z) information.
    """
...
class Frame2DAnd3D(object):
    ...
    def get_textured_point_cloud(self):
        ...
        camera reference frame and texture information. The unit of the coordinates is
        millimeter, and the invalid data is represented by "nan".
    ...
    def get_textured_point_cloud_with_normals(self):
        ...
        unit is in mm, and invalid data is in nan. Normal vectors are computed for each point. If the
        'Frame2DAnd3D' is obtained by 'Camera.capture2DAnd3DWithNormal', the normal vectors
        are computed at the camera side.
    ...
    def save_textured_point_cloud(self, fileFormat, fileName, isOrganized=False):
        ...
        Each point contains x, y, z, blue, green, and red fields. The unit of the coordinate data is
    ...
    def save_textured_point_cloud_with_normals(self, fileFormat, fileName, isOrganized=False):
        r"""
        Saves the textured point cloud to a file of the input file format and filename.
        Each point contains x, y, z, blue, green, red, normalX, normalY, and normalZ fields. The unit
        of the coordinate is millimeter. Point cloud can be saved in organized or unorganized
        structure with ACSII mode.
        :param [in]: fileFormat The format of the point cloud file. Possible values include PLY, PCD,
            and CSV. See 'FileFormat' for details. See 'FileFormat' for details.
        :param [in]: fileName The filename of the point cloud file.
        :param [in]: isOrganized Whether the point cloud is organized. An organized point cloud saves
            all points in order, with invalid data as nan, and an unorganized point cloud saves only
            valid points.
    ...
    def save_point_cloud(pointCloud, fileFormat, fileName, isOrganized=False):
        ...
        :return: 
            ...
            file.
        """
        return _area_scan_3d_camera.Frame2DAnd3D_save_point_cloud(pointCloud, fileFormat, fileName, isOrganized)
    ...
    def save_point_cloud_with_normals(pointCloud, fileFormat, fileName, isOrganized=False):
        ...
        Saves the textured point cloud to a file of the input file format and filename.
        Each point contains x, y, z, blue, green, red, normalX, normalY, and normalZ fields. The unit
        of the coordinate data is millimeter. Point cloud can be saved in organized or unorganized
        structure with ACSII mode.
        ...
        :return: 
            ...
            file.
        """
        return _area_scan_3d_camera.Frame2DAnd3D_save_point_cloud_with_normals(pointCloud, fileFormat, fileName, isOrganized)
...
class TexturedPointCloudWithNormals(object):
    ...
    def vertices(self):
        ...
        w = self.width()
        h = self.height()
        img = np.frombuffer((ctypes.c_float * w * h * 7).from_address(int(data.this)), np.float32).copy()
    ...
    def colors(self):
        ...
        w = self.width()
        h = self.height()
        img = np.frombuffer((ctypes.c_uint8 * w * h * 28).from_address(int(data.this)), np.uint8).copy()
        img = np.reshape(img, (h, w, 28))
        img = img[:, :, 12:15]
        return img.copy()
...
class Camera(object):
    ...
    def discover_cameras():
        ...
        """
        return _area_scan_3d_camera.Camera_discover_cameras()
    ...
    def capture_stereo_2d(self, left, right, isRectified=False, timeoutMs=5000):
        ...
        only available for DEEP, LSR S, LSR L, and PRO XS.
        Since: V2.2.1
        ...
        these 2D images. For DEEP, LSR S, and LSR L, adjust
...
class CameraEvent(object):
    ...
    def register_camera_event_callback(self, camera, func, events):
        r"""register_camera_event_callback(CameraEvent self, Camera camera, EventCallbackBase func, unsigned int events) -> ErrorStatus"""
        return _area_scan_3d_camera.CameraEvent_register_camera_event_callback(self, camera, func, events)
...
class HandEyeCalibration(object):
    ...
    r""" The camera is fixed mountedwith respect to the robot's base."""
    ...
    def calculate_extrinsics(self, camera, cameraToBase):
        ...
        :param [in]: camera The camera handle.
        :param [out]: cameraToBase The result of hand-eye calibration. See 'Transformation'.
        :rtype: :py:class:`ErrorStatus`
        :return: See 'ErrorStatus' for details.
        """
    ...
    def test_recognition(self, camera, testResult, timeoutMs=10000):
        ...
        :param [in]: camera The camera handle.
        :param [out]: testResult The current 2D image with feature recognition resul. See
            Color2DImage for details.
        :param [in]: timeoutMs The timeout for connecting a camera in ms unit. If the execution
            time of the connecting process is greater than the timeout, the function will immediately
            return 'ErrorStatus.MMIND_STATUS_TIMEOUT_ERROR'.
...
class LaserFringeCodingMode(object):
    ...
    r""" Fast mode has the minimum capture time."""
    Value_Accurate = _area_scan_3d_camera.LaserFringeCodingMode_Value_Accurate
    r""" Accurate mode is slower but produces better depth maps than Fast mode."""
    Value_Reflective = _area_scan_3d_camera.LaserFringeCodingMode_Value_Reflective
    r"""
    LSR S, LSR L, and DEEP only. Suitable for reflective objects, provides
...
class ProjectorPowerLevel(object):
    ...
    r""" High level is ofen used for scanning dark objects."""
