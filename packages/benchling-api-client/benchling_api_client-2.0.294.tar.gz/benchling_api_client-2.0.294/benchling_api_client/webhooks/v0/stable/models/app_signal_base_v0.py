...
T = TypeVar("T", bound="AppSignalBaseV0")


@attr.s(auto_attribs=True, repr=False)
class AppSignalBaseV0:
    """  """
    ...
    def __repr__(self):
        ...
        return "AppSignalBaseV0({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        app_signal_base_v0 = cls(
            deprecated=deprecated,
            excluded_properties=excluded_properties,
        )

        app_signal_base_v0.additional_properties = d
        return app_signal_base_v0
