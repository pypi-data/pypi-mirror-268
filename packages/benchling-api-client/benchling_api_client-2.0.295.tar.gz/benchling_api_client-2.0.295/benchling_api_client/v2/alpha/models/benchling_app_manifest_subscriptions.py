...
class BenchlingAppManifestSubscriptions:
    ...
    _messages: List[EventCreatedMessageSubscriptionV0Beta]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_messages() -> List[EventCreatedMessageSubscriptionV0Beta]:
            messages = []
            _messages = d.pop("messages")
            for messages_item_data in _messages:
                messages_item = EventCreatedMessageSubscriptionV0Beta.from_dict(
                    messages_item_data, strict=False
                )
        ...
        try:
            ...
            if strict:
                raise
            messages = cast(List[EventCreatedMessageSubscriptionV0Beta], UNSET)
    ...
    @property
    def messages(self) -> List[EventCreatedMessageSubscriptionV0Beta]:
        if isinstance(self._messages, Unset):
            raise NotPresentError(self, "messages")
        return self._messages

    @messages.setter
    def messages(self, value: List[EventCreatedMessageSubscriptionV0Beta]) -> None:
