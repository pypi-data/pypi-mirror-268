...
class ProjectShareGroup(
    ...
    def __init__(
        ...
        *,
        ...
        :param group_id: The id of the group. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/project_share_group#group_id ProjectShareGroup#group_id}
        :param project: The ID or URL-encoded path of the project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/project_share_group#project ProjectShareGroup#project}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ProjectShareGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/project_share_group#import import section} in the documentation of this resource for the id to use
