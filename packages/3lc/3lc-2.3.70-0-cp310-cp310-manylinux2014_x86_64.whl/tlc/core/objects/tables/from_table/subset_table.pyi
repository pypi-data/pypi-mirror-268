...
class SubsetTable(_InMemoryRowsTable):
    ...
    def __init__(self, url: Url | None = None, created: str | None = None, init_parameters: Any = None, row_cache_url: Url | None = None, row_cache_populated: bool | None = None, input_table_url: Url | Table | None = None, range_factor_min: float | None = None, range_factor_max: float | None = None, include_probability: float | None = None) -> None: ...
    @property
    def seed(self) -> int:
