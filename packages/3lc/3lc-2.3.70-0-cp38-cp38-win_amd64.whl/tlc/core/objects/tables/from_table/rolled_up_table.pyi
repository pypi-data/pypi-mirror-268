...
class RolledUpTable(_InMemoryRowsTable):
    ...
    def __init__(self, url: Url | None = None, created: str | None = None, row_cache_url: Url | None = None, row_cache_populated: bool | None = None, override_table_rows_schema: Any = None, input_table_url: Url | Table | None = None, roll_up_property: str | None = None, roll_up_columns: list[str] | None = None, init_parameters: Any = None) -> None: ...
    @staticmethod
