...
class ReducedTable(_InMemoryRowsTable):
    ...
    '''
    reduce_properties: Incomplete
    input_table_url: Incomplete
    def __init__(self, url: Url | None = None, created: str | None = None, row_cache_url: Url | None = None, row_cache_populated: bool | None = None, reduce_properties: list[str] | None = None, input_table_url: Url | Table | None = None, init_parameters: Any = None) -> None: ...
