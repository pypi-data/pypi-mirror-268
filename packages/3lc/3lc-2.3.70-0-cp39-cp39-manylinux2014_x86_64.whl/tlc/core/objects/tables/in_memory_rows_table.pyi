...
class _InMemoryRowsTable(Table):
    ...
    Derived InMemoryRowsTable types can chose between two implementation paths:
    ...
    method.
    """
    def __init__(self, url: Url | None = None, created: str | None = None, row_cache_url: Url | None = None, row_cache_populated: bool | None = None, override_table_rows_schema: Any = None, init_parameters: Mapping[str, object] | None = None) -> None: ...
    def __len__(self) -> int: ...
    row_count: Incomplete
    def ensure_data_production_is_ready(self) -> None:
        '''For an InMemoryRowsTable we produce the table rows in memory
