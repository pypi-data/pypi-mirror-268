...
from tlc.client.sample_type import Box as Box, CompositeSampleType as CompositeSampleType, SampleType as SampleType, _SampleTypeStructure
from tlc.client.utils import standardized_transforms as standardized_transforms
from tlc.core.builtins.constants.column_names import FOREIGN_TABLE_ID as FOREIGN_TABLE_ID
...
from tlc.core.schema import BoolValue as BoolValue, DictValue as DictValue, DimensionNumericValue as DimensionNumericValue, MapElement as MapElement, NumericValue as NumericValue, ScalarValue as ScalarValue, Schema as Schema, StringValue as StringValue, UrlStringValue as UrlStringValue
...
class Table(Object):
    ...
    **ALTERNATIVE INTERFACE/CACHING:**
    ...
    When this is the case, it is guaranteed that the {func}`schema<schema>` property of the table is fully populated,
    ...
    **STATE MUTABILITY:**
    ...
    override_table_rows_schema: Incomplete
    row_count: Incomplete
    rows: Incomplete
    def __init__(self, url: Url | None = None, created: str | None = None, row_cache_url: Url | None = None, row_cache_populated: bool | None = None, override_table_rows_schema: Any = None, init_parameters: Any = None) -> None: ...
    ...
    def transform_value(schema: Schema | None, item: object) -> object:
        """Transforms a single table value according to the schema.
    ...
    def get_rows_as_binary(self, exclude_bulk_data: bool = False) -> bytes:
        ...
        :param exclude_bulk_data: Whether to exclude bulk data columns from the serialized rows. This filter only
            applies to Tables that are fully cached on disk.
    ...
    def latest(self, use_new_columns: bool = True, wait_for_rescan: bool = True, timeout: float = 0) -> Table:
        ...
        :param rescan: Whether to rescan the TableIndexingTable (lineage) before trying to resolve latest revision.
                       Defaults to True.
        :param timeout_s: The timeout in seconds to wait for the next indexing run to complete. Defaults to 0 seconds
                          meaning that indexing can run forever.
        ...
        """
    def squash(self, output_url: Url, dataset_name: str | None = None, project_name: str | None = None) -> Table:
        ...
        but with no lineage. The new table is written to the output url.
    ...
    def bulk_data_url(self) -> Url:
        ...
        The root of the bulk data url can be overridden by setting the `TLC_BULK_DATA_URL` environment variable.
        """
    @staticmethod
    ...
    def to_pandas(self) -> pd.DataFrame:
        """
        Returns a pandas DataFrame for this table.
    ...
    def is_descendant_of(self, other: Table) -> bool:
        """Returns True if this table is a descendent of the other table."""
    ...
    def weights_column_name(self) -> str | None:
        """Returns the name of the column containing the weights for this table, or None if no such column exists."""
    def create_sampler(self, exclude_zero_weights: bool = True, weighted: bool = True) -> Sampler[int]:
        """Returns a sampler based on the weights column of the table. The type and behavior of the returned Sampler
        also depends on the values of the argument flags. The sampler is always shuffled.

        :param exclude_zero_weight: If True, rows with a weight of zero will be excluded from the sampler. This is
            useful for adjusting the length of the sampler, and thus the length of an epoch when using a PyTorch
            Dataloader, to the number of non-zero weighted rows in the table.
    ...
    def from_pandas(df: pd.DataFrame, structure: _SampleTypeStructure | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, *, table_url: Url | Path | str | None = None) -> TableFromPandas:
        ...
        """
    @staticmethod
    def from_dict(data: Mapping[str, dict[str, object] | list[object]], structure: _SampleTypeStructure | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, *, table_url: Url | Path | str | None = None) -> TableFromPydict:
    ...
    def from_parquet(parquet_file: str | Path | Url, structure: _SampleTypeStructure | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, *, table_url: Url | Path | str | None = None) -> TableFromParquet:
        ...
        """
    @staticmethod
    def from_yolo(dataset_yaml_file: str | Path | Url, split: str = 'train', structure: _SampleTypeStructure | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, *, table_url: Url | Path | str | None = None) -> TableFromYolo:
        """Create a Table from a YOLO annotations file.

        :param input_url: The url of the YOLO dataset .yaml file.
        :param image_folder_url: The url of the folder containing the images referenced in the YOLO annotations file.
        :param structure: The structure of a single sample in the table. This is used to infer the schema of the table,
            and perform any necessary conversions between the row representation and the sample representation of the
            data. If not provided, the structure will be inferred from the first sample in the table.
        :param table_name: The name of the table.
