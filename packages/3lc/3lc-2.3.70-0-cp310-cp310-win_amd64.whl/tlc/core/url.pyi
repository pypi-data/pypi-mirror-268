...
class UrlAliasRegistry(ABC):
    ...
    def register_url_alias(self, token: str, path: str, force: bool = False) -> None:
        ...
        """
    def unregister_url_alias(self, token: str) -> str:
        """Unregister an alias.
...
class Url(ABC):
    ...
    *Scheme is determined from the input string*
    ...
    def join(self, other: Url) -> Url:
        ...
        """
    def create_unique(self) -> Url:
        """Create a unique version of the Url.

        This method will create a unique Url by appending a unique identifier to the URL, if necessary. The unique URL
        will be identical to the original URL except for the path, which will be appended with a unique identifier.
