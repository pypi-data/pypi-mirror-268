...
from tlc.core.objects.tables.from_table.filtered_table_criteria import FilterCriterion as FilterCriterion, create_optional_filter as create_optional_filter
...
class FilteredTable(_InMemoryRowsTable):
    ...
    filter_criterion: Incomplete
    def __init__(self, url: Url | None = None, created: str | None = None, row_cache_url: Url | None = None, row_cache_populated: bool | None = None, override_table_rows_schema: Schema | None = None, input_table_url: Url | Table | None = None, filter_criterion: FilterCriterion | None = None, init_parameters: Any = None) -> None: ...
