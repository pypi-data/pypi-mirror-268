...
class TableFromTorchDataset(_InMemoryRowsTable):
    ...
    """
    def __init__(self, url: Url | None = None, created: str | None = None, row_cache_url: Url | None = None, row_cache_populated: bool | None = None, override_table_rows_schema: Schema | None = None, init_parameters: Any | None = None, input_dataset: Dataset | None = None, all_arrays_are_fixed_size: bool = False) -> None:
