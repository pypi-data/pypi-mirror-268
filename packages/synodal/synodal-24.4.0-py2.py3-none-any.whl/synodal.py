...
KNOWN_REPOS = REPOS_LIST = [Repository(nickname='atelier', package_name='atelier', git_repo='https://gitlab.com/lino-framework/atelier.git', settings_module='', front_end='', extra_deps=[], public_url='https://atelier.lino-framework.org', verbose_name=None, description=None),
 Repository(nickname='etgen', package_name='etgen', git_repo='https://github.com/lino-framework/etgen', settings_module='', front_end='', extra_deps=[], public_url='', verbose_name=None, description=None),
 ...
 Repository(nickname='react', package_name='lino-react', git_repo='https://gitlab.com/lino-framework/react.git', settings_module='', front_end='lino_react.react', extra_deps=[], public_url='', verbose_name=None, description=None),
 ...
 Repository(nickname='noi', package_name='lino-noi', git_repo='https://gitlab.com/lino-framework/noi', settings_module='lino_noi.lib.noi.settings', front_end='', extra_deps=['lino', 'xl'], public_url='', verbose_name='Lino Noi', description='Manage support tickets and working time.'),
 Repository(nickname='presto', package_name='lino-presto', git_repo='https://gitlab.com/lino-framework/presto', settings_module='lino_presto.lib.presto.settings', front_end='', extra_deps=['lino', 'xl'], public_url='', verbose_name='Lino Presto', description='A Lino for managing services'),
 Repository(nickname='pronto', package_name='lino-pronto', git_repo='https://gitlab.com/lino-framework/pronto', settings_module='lino_pronto.lib.pronto.settings', front_end='', extra_deps=['lino', 'xl'], public_url='', verbose_name='Lino Pronto', description='A Lino for assembling and selling products'),
 Repository(nickname='tera', package_name='lino-tera', git_repo='https://gitlab.com/lino-framework/tera', settings_module='lino_tera.lib.tera.settings', front_end='', extra_deps=['lino', 'xl'], public_url='', verbose_name='Lino Tera', description='A Lino for managing therapeutic centres'),
 Repository(nickname='shop', package_name='lino-shop', git_repo='https://gitlab.com/lino-framework/shop', settings_module='lino_shop.lib.shop.settings', front_end='', extra_deps=['lino', 'xl'], public_url='', verbose_name='Lino Shop', description='A Lino for managing a webshop'),
