 ...
 * compression options.
 * @param fapecOpts  Pointer to the FAPEC options
 * @param lossy      Lossy level for amplitude samples (0 for lossless, up to 16 for lossy)
 * @param phaselossy Lossy level for phase samples (0 for lossless, up to 16 for lossy)
 * @return Negative in case of problems (e.g. invalid options, null fapecOpts,
 * unsupported by license, etc.)
 */
WINDOWS_VISIBILITY int fapec_cmpopts_activate_kmall(void *fapecOpts, uint8_t lossy, uint8_t phaselossy) LINUX_VISIBILITY;
