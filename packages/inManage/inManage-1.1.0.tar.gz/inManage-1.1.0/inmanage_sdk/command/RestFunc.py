...
class NF5280M5_SensorDesc():
    ...
    def __init__(self):
        ...
        from inmanage_sdk.command.M5Log import eventLogString
        self.eventLogString = eventLogString.eventLogString

        from inmanage_sdk.command.M5Log import sensorSpecificEventStr
        self.sensorSpecificEventStr = sensorSpecificEventStr.sensorSpecificEventStr

        from inmanage_sdk.command.M5Log import biosPostEventStr
        self.biosPostEventStr = biosPostEventStr.biosPostEventStr

        from inmanage_sdk.command.M5Log import sensorEventStr
        self.sensorEventStr = sensorEventStr.sensorEventStr

        from inmanage_sdk.command.M5Log import commonInfoStr
