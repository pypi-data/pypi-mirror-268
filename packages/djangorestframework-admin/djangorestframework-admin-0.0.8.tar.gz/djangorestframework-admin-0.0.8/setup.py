...
have pip >= 9.0 and setuptools >= 24.2, then try again:
    ...
    $ python -m pip install djangorestframework-admin
...
version = get_version('rest_framework_admin')
...
if sys.argv[-1] == 'publish':
    ...
    shutil.rmtree('dist')
    shutil.rmtree('build')
    shutil.rmtree('djangorestframework-admin.egg-info')
    sys.exit()
...
setup(
    ...
    version=version,
    url='https://gitee.com/iamfengdy/djangorestframework-admin',
    license='BSD',
    description='Admin Backend Web APIs for DjangoRestFramework, made easy.',
