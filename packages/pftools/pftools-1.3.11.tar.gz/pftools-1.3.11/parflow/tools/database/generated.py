...
Generated on 2024/04/17 - 15:20:44
Created 180 classes
...
class ResetSurfacePressure(PFDBObj):
    '''
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self._value_ = False
        self.ThresholdPressure = 0.0
        self.ResetPressure = 0.0
        self._details_ = {
          "_value_": {
            "help": "[Type: boolean/string] Check surface pressure and reset values above a threshold to a different value.\n",
            "default": False,
            "domains": {
              "BoolDomain": None
            }
