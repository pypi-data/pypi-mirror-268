...
class QuestionsApi(object):
    ...
    def delete_the_question_for_question_id(self, question_id, **kwargs):  # noqa: E501
        """Delete Question  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_the_question_for_question_id(question_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_the_question_for_question_id_with_http_info(question_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_the_question_for_question_id_with_http_info(question_id, **kwargs)  # noqa: E501
            return data

    def delete_the_question_for_question_id_with_http_info(self, question_id, **kwargs):  # noqa: E501
        """Delete Question  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_the_question_for_question_id_with_http_info(question_id, async_req=True)
        >>> result = thread.get()
