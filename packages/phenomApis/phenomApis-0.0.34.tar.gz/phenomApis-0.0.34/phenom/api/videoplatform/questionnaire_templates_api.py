...
class QuestionnaireTemplatesApi(object):
    ...
    def publish_questionnaire(self, questionnaire_id, recruiter_user_id, **kwargs):  # noqa: E501
        """Publish Questionnaire  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.publish_questionnaire(questionnaire_id, recruiter_user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str questionnaire_id: (required)
        :param str recruiter_user_id: (required)
        :return: PublishQuestionnaireResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.publish_questionnaire_with_http_info(questionnaire_id, recruiter_user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.publish_questionnaire_with_http_info(questionnaire_id, recruiter_user_id, **kwargs)  # noqa: E501
            return data

    def publish_questionnaire_with_http_info(self, questionnaire_id, recruiter_user_id, **kwargs):  # noqa: E501
        """Publish Questionnaire  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.publish_questionnaire_with_http_info(questionnaire_id, recruiter_user_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['questionnaire_id', 'recruiter_user_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method publish_questionnaire" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'questionnaire_id' is set
        if ('questionnaire_id' not in params or
                params['questionnaire_id'] is None):
            raise ValueError("Missing the required parameter `questionnaire_id` when calling `publish_questionnaire`")  # noqa: E501
        ...
        if ('recruiter_user_id' not in params or
            ...
            raise ValueError("Missing the required parameter `recruiter_user_id` when calling `publish_questionnaire`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/questionnaire-templates/publish/{questionnaireId}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PublishQuestionnaireResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
