...
class CurrentCls:
	...
	def fetch(self) -> List[enums.PcdErrorPhase]:
		...
		Snippet: value: List[enums.PcdErrorPhase] = driver.wcdmaMeas.multiEval.listPy.pcde.phase.current.fetch() \n
		...
		response = self._core.io.query_str_suppressed(f'FETCh:WCDMa:MEASurement<Instance>:MEValuation:LIST:PCDE:PHASe:CURRent?', suppressed)
