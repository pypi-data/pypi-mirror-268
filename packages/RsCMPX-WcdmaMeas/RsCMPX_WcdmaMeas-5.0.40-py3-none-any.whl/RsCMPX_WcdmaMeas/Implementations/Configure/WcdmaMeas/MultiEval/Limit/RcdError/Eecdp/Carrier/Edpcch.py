...
class EdpcchCls:
	"""Edpcch commands group definition. 1 total commands, 0 Subgroups, 1 group commands"""
	...
	def set(self, enable: bool, beta_factor: int, spreading_factor: int, carrier=repcap.Carrier.Default) -> None:
		...
		self._core.io.write(f'CONFigure:WCDMa:MEASurement<Instance>:MEValuation:LIMit:RCDerror:EECDp:CARRier{carrier_cmd_val}:EDPCch {param}'.rstrip())
