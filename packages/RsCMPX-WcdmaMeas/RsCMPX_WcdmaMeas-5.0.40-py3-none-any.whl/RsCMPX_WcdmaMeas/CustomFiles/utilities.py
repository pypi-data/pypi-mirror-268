...
class Utilities:
	...
	Access snippet: ``utils = RsCMPX_WcdmaMeas.utilities``"""
	...
	def logger(self) -> ScpiLogger:
		...
		Access snippet: ``logger = RsCMPX_WcdmaMeas.utilities.logger``"""
	...
	def get_lock(self) -> threading.RLock:
		...
		By default:
			- If you create standard new RsCMPX_WcdmaMeas instance with new VISA session, the session gets a new thread lock. You can assign it to other RsCMPX_WcdmaMeas sessions in order to share one physical instrument with a multi-thread access.
			- If you create new RsCMPX_WcdmaMeas from an existing session, the thread lock is shared automatically making both instances multi-thread safe.
