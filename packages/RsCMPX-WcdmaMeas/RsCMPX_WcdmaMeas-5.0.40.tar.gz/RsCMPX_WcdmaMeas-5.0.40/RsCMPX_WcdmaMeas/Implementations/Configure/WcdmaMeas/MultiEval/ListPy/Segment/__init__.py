...
class SegmentCls:
	"""Segment commands group definition. 8 total commands, 8 Subgroups, 0 group commands
	...
	@property
	def cdPower(self):
		"""cdPower commands group. 0 Sub-classes, 1 commands."""
	...
	@property
	def uePower(self):
		"""uePower commands group. 0 Sub-classes, 1 commands."""
