...
class PeakCls:
	"""Peak commands group definition. 8 total commands, 5 Subgroups, 0 group commands"""
	...
	def sdeviaton(self):
		...
		if not hasattr(self, '_sdeviaton'):
			from .Sdeviaton import SdeviatonCls
			self._sdeviaton = SdeviatonCls(self._core, self._cmd_group)
