...
class MaximumCls:
	...
	def read(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.wcdmaMeas.multiEval.trace.evMagnitude.chip.maximum.read() \n
		Returns the values of the RMS EVM vs chip traces, measured in the preselected slot (see method RsCMPX_WcdmaMeas.Configure.
		WcdmaMeas.MultiEval.pslot) . One value per chip is returned. The results of the current, average and maximum traces can
		be retrieved. \n
		Suppressed linked return values: reliability \n
			:return: evm_chip: No help available"""
	...
	def fetch(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.wcdmaMeas.multiEval.trace.evMagnitude.chip.maximum.fetch() \n
		Returns the values of the RMS EVM vs chip traces, measured in the preselected slot (see method RsCMPX_WcdmaMeas.Configure.
		WcdmaMeas.MultiEval.pslot) . One value per chip is returned. The results of the current, average and maximum traces can
		be retrieved. \n
		Suppressed linked return values: reliability \n
