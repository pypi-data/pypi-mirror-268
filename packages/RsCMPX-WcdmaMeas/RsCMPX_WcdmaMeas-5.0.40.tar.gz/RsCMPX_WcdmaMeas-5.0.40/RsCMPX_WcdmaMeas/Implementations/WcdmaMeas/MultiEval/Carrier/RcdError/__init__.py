...
class RcdErrorCls:
	"""RcdError commands group definition. 16 total commands, 6 Subgroups, 0 group commands"""
	...
	@property
	def sf(self):
		"""sf commands group. 0 Sub-classes, 2 commands."""
	...
	@property
	def ocInfo(self):
		"""ocInfo commands group. 0 Sub-classes, 2 commands."""
		if not hasattr(self, '_ocInfo'):
			from .OcInfo import OcInfoCls
			self._ocInfo = OcInfoCls(self._core, self._cmd_group)
		return self._ocInfo
