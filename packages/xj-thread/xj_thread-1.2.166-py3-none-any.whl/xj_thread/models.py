...
class Thread(models.Model):
    ...
    user_uuid = models.UUIDField(verbose_name='用户UUID', unique=True, editable=True, blank=True, null=True, db_index=True)
    ...
    access_level = models.IntegerField(verbose_name='访问级别', blank=True, null=True, choices=access_level_choices,
    ...
    is_deleted = models.BooleanField(verbose_name='是否删除', blank=True, null=True, default=0, db_index=True)
    # 主表扩展字段
    field_1 = models.IntegerField(verbose_name='自定义字段-1', blank=True, null=True, help_text='')
    field_2 = models.IntegerField(verbose_name='自定义字段-2', blank=True, null=True, help_text='')
    field_3 = models.IntegerField(verbose_name='自定义字段-3', blank=True, null=True, help_text='')
    field_4 = models.IntegerField(verbose_name='自定义字段-4', blank=True, null=True, help_text='')
    field_5 = models.IntegerField(verbose_name='自定义字段-5', blank=True, null=True, help_text='')
    field_6 = models.CharField(verbose_name='自定义字段-6', max_length=255, blank=True, null=True, help_text='')
    field_7 = models.CharField(verbose_name='自定义字段-7', max_length=255, blank=True, null=True, help_text='')
    field_8 = models.CharField(verbose_name='自定义字段-8', max_length=255, blank=True, null=True, help_text='')
    field_9 = models.CharField(verbose_name='自定义字段-9', max_length=255, blank=True, null=True, help_text='')
    field_10 = models.CharField(verbose_name='自定义字段-10', max_length=255, blank=True, null=True, help_text='')
    field_11 = models.CharField(verbose_name='自定义字段-11', max_length=255, blank=True, null=True, help_text='')
    field_12 = models.CharField(verbose_name='自定义字段-12', max_length=255, blank=True, null=True, help_text='')
    field_13 = models.CharField(verbose_name='自定义字段-13', max_length=255, blank=True, null=True, help_text='')
    field_14 = models.CharField(verbose_name='自定义字段-14', max_length=255, blank=True, null=True, help_text='')
    field_15 = models.CharField(verbose_name='自定义字段-15', max_length=255, blank=True, null=True, help_text='')
    ...
    def user_name_query(self):
        user_set = BaseInfo.objects.filter(id=self.user_id).first()
        return format_html(
            '<span style="display: inline-block; width: 100px">{}</span>',
            f"{user_set.full_name} ({user_set.user_name})"
        ) if user_set else f"({self.user_id})"

    user_name_query.short_description = '用户'
...
class ThreadMainExtendField(models.Model):
    """ 1-1、Thread_Main_Extend_Field 主表扩展字段表 """
    ...
    category = models.ForeignKey(verbose_name='类别ID', to='ThreadCategory', null=False, blank=False,
                                 ...
                                 db_constraint=False, help_text='')
    field_index = models.CharField(verbose_name='映射的字段索引', max_length=8, help_text='',
                                   choices=main_field_index_choices)  # 眏射ThreadExtendData表的键名
    field = models.CharField(verbose_name='自定义字段', max_length=32, help_text='')  # 眏射ThreadExtendData表的键名
    value = models.CharField(verbose_name='字段标签', max_length=32, null=True, blank=True, help_text='')
    default = models.CharField(verbose_name='默认值', max_length=2048, blank=True, null=True, help_text='')
    type = models.CharField(verbose_name='字段类型', max_length=32, blank=True, null=True, choices=type_choices,
                            help_text='')
...
class ThreadCategory(models.Model):
    ...
    value = models.CharField(verbose_name='类别标识值', max_length=50, help_text='类别唯一标识值是标识类别的唯一选项')
    name = models.CharField(verbose_name='类别名称', max_length=255, blank=True, null=True, help_text='')
    need_auth = models.BooleanField(verbose_name="是否需登录权限", blank=True, null=True,
                                    help_text='类别是否登录后才能查看')
    config = models.JSONField(verbose_name='前端配置', blank=True, null=True, default=dict, help_text='')
    parent = models.ForeignKey(to="self", verbose_name='父类类别', db_column='parent_id', blank=True, null=True,
                               on_delete=models.DO_NOTHING, db_constraint=False, help_text='')
    description = models.CharField(verbose_name='描述', max_length=255, blank=True, null=True, help_text='')
...
class ThreadClassify(models.Model):
    ...
    value = models.CharField(verbose_name='分类标识值', max_length=50, unique=True, help_text='')
    name = models.CharField(verbose_name='分类名称', max_length=255, blank=True, null=True, help_text='')
...
field_index_choices = [
    ...
    ("field_14", "自定义字段14 (字符)"),
    ("field_15", "自定义字段15 (字符)"),
    ("field_16", "自定义字段16 (长文本)"),
    ("field_17", "自定义字段17 (长文本)"),
    ("field_18", "自定义字段18 (长文本)"),
    ("field_19", "自定义字段19 (长文本)"),
    ("field_20", "自定义字段20 (长文本)"),
]
...
class ThreadExtendField(models.Model):
    ...
    field_index = models.CharField(verbose_name='映射的字段索引', max_length=255, help_text='',
    ...
    value = models.CharField(verbose_name='字段标签', max_length=255, null=True, blank=True, help_text='')
    default = models.CharField(verbose_name='默认值', max_length=2048, blank=True, null=True, help_text='')
    type = models.CharField(verbose_name='字段类型', max_length=32, blank=True, null=True, choices=type_choices,
                            help_text='')
...
class ThreadExtendData(models.Model):
    ...
    field_1 = models.CharField(verbose_name='自定义字段_1 (文本)', max_length=255, blank=True, null=True, help_text='')
    field_2 = models.CharField(verbose_name='自定义字段_2 (文本)', max_length=255, blank=True, null=True, help_text='')
    field_3 = models.CharField(verbose_name='自定义字段_3 (文本)', max_length=255, blank=True, null=True, help_text='')
    field_4 = models.CharField(verbose_name='自定义字段_4 (文本)', max_length=255, blank=True, null=True, help_text='')
    field_5 = models.CharField(verbose_name='自定义字段_5 (文本)', max_length=255, blank=True, null=True, help_text='')
    field_6 = models.CharField(verbose_name='自定义字段_6 (文本)', max_length=255, blank=True, null=True, help_text='')
    field_7 = models.CharField(verbose_name='自定义字段_7 (文本)', max_length=255, blank=True, null=True, help_text='')
    field_8 = models.CharField(verbose_name='自定义字段_8 (文本)', max_length=255, blank=True, null=True, help_text='')
    field_9 = models.CharField(verbose_name='自定义字段_9 (文本)', max_length=255, blank=True, null=True, help_text='')
    field_10 = models.CharField(verbose_name='自定义字段_10 (文本)', max_length=255, blank=True, null=True, help_text='')
    ...
    field_16 = models.TextField(verbose_name='自定义字段_16 (长文本)', blank=True, null=True, help_text='')
    field_17 = models.TextField(verbose_name='自定义字段_17 (长文本)', blank=True, null=True, help_text='')
    field_18 = models.TextField(verbose_name='自定义字段_18 (长文本)', blank=True, null=True, help_text='')
    field_19 = models.TextField(verbose_name='自定义字段_19 (长文本)', blank=True, null=True, help_text='')
    field_20 = models.TextField(verbose_name='自定义字段_20 (长文本)', blank=True, null=True, help_text='')
...
class ThreadTag(models.Model):
    ...
    class Meta:
        db_table = 'thread_tag'
        verbose_name_plural = '07. 信息 - 标签类型'
...
class ThreadTagMapping(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = '08. 信息 - 标签映射'
