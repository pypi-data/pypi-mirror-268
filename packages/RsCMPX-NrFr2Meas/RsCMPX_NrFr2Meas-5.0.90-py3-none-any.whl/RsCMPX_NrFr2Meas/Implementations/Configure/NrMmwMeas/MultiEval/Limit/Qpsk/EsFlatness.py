...
class EsFlatnessCls:
	...
	def set(self, enable: bool, range_1: float, range_2: float, max_1_min_2: float, max_2_min_1: float) -> None:
		...
		Snippet: driver.configure.nrMmwMeas.multiEval.limit.qpsk.esFlatness.set(enable = False, range_1 = 1.0, range_2 = 1.0, max_1_min_2 = 1.0, max_2_min_1 = 1.0) \n
		...
		self._core.io.write(f'CONFigure:NRMMw:MEASurement<Instance>:MEValuation:LIMit:QPSK:ESFLatness {param}'.rstrip())
	...
	def get(self) -> EsFlatnessStruct:
		"""SCPI: CONFigure:NRMMw:MEASurement<Instance>:MEValuation:LIMit:QPSK:ESFLatness \n
		Snippet: value: EsFlatnessStruct = driver.configure.nrMmwMeas.multiEval.limit.qpsk.esFlatness.get() \n
		Defines limits for the equalizer spectrum flatness (QPSK modulation) . \n
			:return: structure: for return value, see the help for EsFlatnessStruct structure arguments."""
		return self._core.io.query_struct(f'CONFigure:NRMMw:MEASurement<Instance>:MEValuation:LIMit:QPSK:ESFLatness?', self.__class__.EsFlatnessStruct())
