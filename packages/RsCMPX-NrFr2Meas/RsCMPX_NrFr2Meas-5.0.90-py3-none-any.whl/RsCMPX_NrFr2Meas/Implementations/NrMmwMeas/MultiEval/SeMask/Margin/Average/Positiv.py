...
class PositivCls:
	...
	def fetch(self) -> FetchStruct:
		"""SCPI: FETCh:NRMMw:MEASurement<Instance>:MEValuation:SEMask:MARGin:AVERage:POSitiv \n
		Snippet: value: FetchStruct = driver.nrMmwMeas.multiEval.seMask.margin.average.positiv.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:NRMMw:MEASurement<Instance>:MEValuation:SEMask:MARGin:AVERage:POSitiv?', self.__class__.FetchStruct())
