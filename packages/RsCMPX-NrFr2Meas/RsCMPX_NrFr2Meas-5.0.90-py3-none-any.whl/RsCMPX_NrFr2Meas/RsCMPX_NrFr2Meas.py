...
class RsCMPX_NrFr2Meas:
	...
	_driver_options = "SupportedInstrModels = CMX/CMP/CMW, SupportedIdnPatterns = CMX/CMP/CMW, SimulationIdnString = 'Rohde&Schwarz,CMP200,100001,5.0.90.0014'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '5.0.90.0014'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '5.0.90.0014'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsCMPX_NrFr2Meas version failed. Current version: '5.0.90.0014', minimum required version: '{min_version}'")
