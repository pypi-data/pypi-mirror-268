...
class CcCls:
	"""Cc commands group definition. 35 total commands, 10 Subgroups, 0 group commands
	...
	def sassignment(self):
		"""sassignment commands group. 1 Sub-classes, 1 commands."""
	...
	@property
	def allocation(self):
		"""allocation commands group. 5 Sub-classes, 0 commands."""
