...
class NegativCls:
	...
	def fetch(self) -> FetchStruct:
		"""SCPI: FETCh:NRMMw:MEASurement<Instance>:MEValuation:SEMask:MARGin:MINimum:NEGativ \n
		Snippet: value: FetchStruct = driver.nrMmwMeas.multiEval.seMask.margin.minimum.negativ.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:NRMMw:MEASurement<Instance>:MEValuation:SEMask:MARGin:MINimum:NEGativ?', self.__class__.FetchStruct())
