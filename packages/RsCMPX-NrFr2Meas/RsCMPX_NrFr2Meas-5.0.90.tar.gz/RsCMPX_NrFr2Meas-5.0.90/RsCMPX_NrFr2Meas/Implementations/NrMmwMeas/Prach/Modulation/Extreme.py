...
class ExtremeCls:
	...
	class ResultData(StructBase):
		"""Response structure. Fields: \n
			...
			- Antenna_1_Pow_Min: float: No parameter help available
			- Antenna_1_Pow_Max: float: No parameter help available
			- Antenna_2_Pow_Min: float: No parameter help available
			- Antenna_2_Pow_Max: float: No parameter help available"""
		__meta_args_list = [
			...
			ArgStruct.scalar_float('Antenna_1_Pow_Min'),
			ArgStruct.scalar_float('Antenna_1_Pow_Max'),
			ArgStruct.scalar_float('Antenna_2_Pow_Min'),
			ArgStruct.scalar_float('Antenna_2_Pow_Max')]
		...
		def __init__(self):
			...
			self.Antenna_1_Pow_Min: float = None
			self.Antenna_1_Pow_Max: float = None
			self.Antenna_2_Pow_Min: float = None
			self.Antenna_2_Pow_Max: float = None
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Antenna_1_Pow_Min: float or bool: No parameter help available
			- Antenna_1_Pow_Max: float or bool: No parameter help available
			- Antenna_2_Pow_Min: float or bool: No parameter help available
			- Antenna_2_Pow_Max: float or bool: No parameter help available"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
			ArgStruct.scalar_int('Out_Of_Tolerance'),
			...
			ArgStruct.scalar_float_ext('Antenna_1_Pow_Min'),
			ArgStruct.scalar_float_ext('Antenna_1_Pow_Max'),
			ArgStruct.scalar_float_ext('Antenna_2_Pow_Min'),
			ArgStruct.scalar_float_ext('Antenna_2_Pow_Max')]
		...
		def __init__(self):
			...
			self.Antenna_1_Pow_Min: float or bool = None
			self.Antenna_1_Pow_Max: float or bool = None
			self.Antenna_2_Pow_Min: float or bool = None
			self.Antenna_2_Pow_Max: float or bool = None
