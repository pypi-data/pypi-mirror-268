"""Automatic generated by ToolBox v = 0.1.12"""
...
class GMAILPROVIDER(Enum):
    NAME = 'gmailProvider'
    GMAIL_AUTHENTICATE: str = 'gmail_authenticate'  # Input: (['name']), Output: <class 'inspect._empty'>
...
class DIFFUSER(Enum):
    ...
    ON_CLOSE: str = 'on_close'  # Input: (['self']), Output: <class 'inspect._empty'>
    ON_EXIT: str = 'on_exit'  # Input: (), Output: None
    START_UI: str = 'start_ui'  # Input: (['self']), Output: <class 'inspect._empty'>
    GET_PIPLINE_MANAGER: str = 'get_pipline_manager'  # Input: (['self']), Output: <class 'inspect._empty'>
    APP_INSTANCE: str = 'app_instance'  # Input: (), Output: None
    APP_INSTANCE_TYPE: str = 'app_instance_type'  # Input: (), Output: None
