...
class TestPageSetUp(unittest.TestCase):
  """Test the functionality of wikipedia-zh.page's __init__ and load functions."""
...
class TestPage(unittest.TestCase):
  """Test the functionality of the rest of wikipedia-zh.page."""

  def setUp(self):
    # shortest wikipedia-zh articles with images and sections
