...
class TestPageSetUp(unittest.TestCase):
  """Test the functionality of wikipedia_zh.page's __init__ and load functions."""
...
class TestPage(unittest.TestCase):
  """Test the functionality of the rest of wikipedia_zh.page."""

  def setUp(self):
    # shortest wikipedia_zh articles with images and sections
