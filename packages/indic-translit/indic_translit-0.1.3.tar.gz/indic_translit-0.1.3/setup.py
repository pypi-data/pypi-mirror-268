...
Tools to transliterate from and detransliterate to Dravidian languages
...
1. The (de)transliterations output for Malayalam are not one-to-one due to different representations for the same sound, such as ൿ and ക്, ർ and റ്, ൻ and ന്. Feedback is sought for the correctness of the current state and what needs to be done to make them correct. There are no known issues for the remaining languages. The community is encouraged to report more issues.
