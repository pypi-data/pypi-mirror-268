        ...
        try:
            ...
            if os.path.isdir(directoryToPushFrom):
                ...
                try:
                    ...
                    full_report_file_path = Path(full_report_file)
                    ...
                    full_report_file_path.write_text(junit_report.model_dump_xml())
                    print(f"Importing file: {full_report_file_path}")
                    call_import(str(full_report_file_path.resolve()))
                except Exception as e:
                    print(str(e))
            else:
                print("ERROR - Path to report is incorrect, please use the full path")
...
def runtestswithappsurify(*args):
    ...
    try:    
        ...
        if azureTest:
            ...
            commandToRun = vstestlocation + "vstest.console " + dll+ " /ListFullyQualifiedTests /ListTestsTargetPath:testlist.txt"
