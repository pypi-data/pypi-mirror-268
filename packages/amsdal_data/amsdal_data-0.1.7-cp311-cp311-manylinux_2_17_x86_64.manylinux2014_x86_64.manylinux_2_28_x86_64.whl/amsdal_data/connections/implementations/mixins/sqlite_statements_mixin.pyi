...
class SqlOperatorTemplate(BaseModel):
    build_statement: ClassVar[Callable[[Any, str, Any, str, str], str]]
    ...
    def build_statement(self, field_name: str, value: Any, table_name: str = '', column_separator: str = "'") -> str: ...
...
class SqliteStatementsMixin:
    ...
    SQL_OPERATOR_MAP: dict[Lookup, SqlOperatorTemplate]
    SUBSTITUTE_CHAR: str
    def _fields_map(self, table_name: str, field_name: str, class_version: str) -> str: ...
    def _field_reverse_map(self, table_name: str, field_name: str, class_version: str) -> str: ...
    ...
    def _process_result(self, table_name: str, result: dict[str, Any], table_description: dict[str, str]) -> dict[str, Any]: ...
    @staticmethod
