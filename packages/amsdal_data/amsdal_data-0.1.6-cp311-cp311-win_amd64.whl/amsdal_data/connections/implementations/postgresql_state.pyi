...
class PostgresStateConnection(SqlStateConnectionMixin, StateConnectionBase):
    ...
    @staticmethod
    def _resolve_nested_field_name(field_name: str, nested_fields: str, *, value_type: Any = ..., is_internal_table: bool = False, use_internal_meta_tables: bool = False) -> str: ...
    def _nested_filter_statement(self, field_name: str, nested_fields: str, sql_operator_template: SqlOperatorTemplate, value: Any, value_type: Any, *, is_internal_table: bool = False, use_internal_meta_tables: bool = False) -> tuple[str, Any]: ...
