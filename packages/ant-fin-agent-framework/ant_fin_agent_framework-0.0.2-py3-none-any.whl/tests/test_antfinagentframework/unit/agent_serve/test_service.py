...
from antfinagentframework.agent_serve.service import Service
from antfinagentframework.agent_serve.service_configer import ServiceConfiger
from tests.test_antfinagentframework.mock.agent_serve.mock_application_config_manager import MockApplicationConfigManager
from tests.test_antfinagentframework.mock.agent_serve.mock_agent import MockAgent


@patch('antfinagentframework.agent_serve.service.Agent', new=MockAgent)
@patch('antfinagentframework.agent_serve.service.ApplicationConfigManager', new=MockApplicationConfigManager)
def test_service():
