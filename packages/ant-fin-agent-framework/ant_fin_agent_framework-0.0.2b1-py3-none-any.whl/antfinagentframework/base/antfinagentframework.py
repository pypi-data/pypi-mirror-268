...
# @FileName: antfinagentframework.py
import importlib
import sys
from pathlib import Path

from antfinagentframework.base.annotation.singleton import singleton
from antfinagentframework.base.component.application_component_manager import ApplicationComponentManager
from antfinagentframework.base.component.component_base import ComponentBase
from antfinagentframework.base.config.application_configer.app_configer import AppConfiger
...
from antfinagentframework.base.component.component_configer_util import ComponentConfigerUtil
...
from antfinagentframework.base.config.custom_configer.custom_key_configer import CustomKeyConfiger
...
from antfinagentframework.base.util.logging.logging_util import init_loggers
from antfinagentframework.agent_serve.web.request_task import RequestLibrary
from antfinagentframework.agent_serve.web.web_booster import GunicornApplication


@singleton
class AntFinAgentFramework(object):
    """AntFinAgentFramework framework object, responsible for the framework initialization,
    ...
    def __init__(self):
        ...
        self.__system_default_package = ['antfinagentframework']

    def start(self, config_path: str = None):
        """Start the AntFinAgentFramework framework."""
