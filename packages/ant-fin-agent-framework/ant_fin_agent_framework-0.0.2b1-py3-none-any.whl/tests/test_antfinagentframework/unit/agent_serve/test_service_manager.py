...
from tests.test_antfinagentframework.mock.agent_serve.mock_simple_service import SimpleService
...
@patch("antfinagentframework.agent_serve.service_manager.Service", new=SimpleService)
@patch("antfinagentframework.base.component.component_manager_base.ApplicationConfigManager", new=MockApplicationConfigManager)
