...
class InlineResponse20026(object):
    ...
    swagger_types = {
        'status': 'int',
        'message': 'str',
        'response': 'InlineResponse20026Response'
    }
    ...
    @property
    def response(self):
        """Gets the response of this InlineResponse20026.  # noqa: E501


        :return: The response of this InlineResponse20026.  # noqa: E501
        :rtype: InlineResponse20026Response
        """
        return self._response

    @response.setter
    def response(self, response):
        """Sets the response of this InlineResponse20026.


        :param response: The response of this InlineResponse20026.  # noqa: E501
        :type: InlineResponse20026Response
        """
