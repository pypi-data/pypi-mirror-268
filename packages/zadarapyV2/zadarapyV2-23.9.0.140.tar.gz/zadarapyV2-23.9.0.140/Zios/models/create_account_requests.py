...
class CreateAccountRequests(object):
    ...
    def __init__(self, request_action=None, arguments=None, _configuration=None):  # noqa: E501
        """CreateAccountRequests - a model defined in Swagger"""  # noqa: E501
    ...
    def request_action(self):
        """Gets the request_action of this CreateAccountRequests.  # noqa: E501


        :return: The request_action of this CreateAccountRequests.  # noqa: E501
        :rtype: str
        """
    ...
    def request_action(self, request_action):
        """Sets the request_action of this CreateAccountRequests.


        :param request_action: The request_action of this CreateAccountRequests.  # noqa: E501
        :type: str
        """
        ...
        allowed_values = ["register_account"]  # noqa: E501
        if (self._configuration.client_side_validation and
                request_action not in allowed_values):
            raise ValueError(
                "Invalid value for `request_action` ({0}), must be one of {1}"  # noqa: E501
                .format(request_action, allowed_values)
            )
    ...
    @property
    def arguments(self):
        """Gets the arguments of this CreateAccountRequests.  # noqa: E501

        Object containing username, account, email and password.  # noqa: E501

        :return: The arguments of this CreateAccountRequests.  # noqa: E501
        :rtype: object
        """
    ...
    def arguments(self, arguments):
        """Sets the arguments of this CreateAccountRequests.

        Object containing username, account, email and password.  # noqa: E501

        :param arguments: The arguments of this CreateAccountRequests.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateAccountRequests, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAccountRequests):
            return False
