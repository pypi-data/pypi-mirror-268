...
class InlineResponse20048(object):
    ...
    swagger_types = {
        'status': 'int',
        'message': 'str',
        'response': 'InlineResponse20048Response'
    }
    ...
    @property
    def response(self):
        """Gets the response of this InlineResponse20048.  # noqa: E501


        :return: The response of this InlineResponse20048.  # noqa: E501
        :rtype: InlineResponse20048Response
        """
        return self._response

    @response.setter
    def response(self, response):
        """Sets the response of this InlineResponse20048.


        :param response: The response of this InlineResponse20048.  # noqa: E501
        :type: InlineResponse20048Response
        """
