...
class InlineResponse20032(object):
    ...
    swagger_types = {
        'status': 'int',
        'message': 'str',
        'response': 'InlineResponse20032Response'
    }
    ...
    @property
    def response(self):
        """Gets the response of this InlineResponse20032.  # noqa: E501


        :return: The response of this InlineResponse20032.  # noqa: E501
        :rtype: InlineResponse20032Response
        """
        return self._response

    @response.setter
    def response(self, response):
        """Sets the response of this InlineResponse20032.


        :param response: The response of this InlineResponse20032.  # noqa: E501
        :type: InlineResponse20032Response
        """
