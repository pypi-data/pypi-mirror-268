...
class DeleteProxyVirtualController(object):
    ...
    def __init__(self, quantity=None, region_id=None, _configuration=None):  # noqa: E501
        """DeleteProxyVirtualController - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def quantity(self):
        """Gets the quantity of this DeleteProxyVirtualController.  # noqa: E501

        Number of VCs to remove  # noqa: E501

        :return: The quantity of this DeleteProxyVirtualController.  # noqa: E501
        :rtype: int
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this DeleteProxyVirtualController.

        Number of VCs to remove  # noqa: E501

        :param quantity: The quantity of this DeleteProxyVirtualController.  # noqa: E501
        :type: int
        """
    ...
    @property
    def region_id(self):
        """Gets the region_id of this DeleteProxyVirtualController.  # noqa: E501

        Region ID (For Multi Region VPSA object storage)  # noqa: E501

        :return: The region_id of this DeleteProxyVirtualController.  # noqa: E501
        :rtype: int
        """
    ...
    def region_id(self, region_id):
        """Sets the region_id of this DeleteProxyVirtualController.

        Region ID (For Multi Region VPSA object storage)  # noqa: E501

        :param region_id: The region_id of this DeleteProxyVirtualController.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeleteProxyVirtualController, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteProxyVirtualController):
            return False
