...
class InlineResponse20049Response(object):
    ...
    swagger_types = {
        'message': 'str',
        'user': 'InlineResponse20049ResponseUser',
        'status': 'int'
    }
    ...
    @property
    def user(self):
        """Gets the user of this InlineResponse20049Response.  # noqa: E501


        :return: The user of this InlineResponse20049Response.  # noqa: E501
        :rtype: InlineResponse20049ResponseUser
        """
        return self._user

    @user.setter
    def user(self, user):
        """Sets the user of this InlineResponse20049Response.


        :param user: The user of this InlineResponse20049Response.  # noqa: E501
        :type: InlineResponse20049ResponseUser
        """
