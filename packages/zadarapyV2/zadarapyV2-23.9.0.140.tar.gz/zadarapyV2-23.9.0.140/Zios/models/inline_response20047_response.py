...
class InlineResponse20047Response(object):
    ...
    swagger_types = {
        'message': 'str',
        'count': 'int',
        'users': 'list[InlineResponse20047ResponseUsers]'
    }
    ...
    @property
    def users(self):
        """Gets the users of this InlineResponse20047Response.  # noqa: E501


        :return: The users of this InlineResponse20047Response.  # noqa: E501
        :rtype: list[InlineResponse20047ResponseUsers]
        """
        return self._users

    @users.setter
    def users(self, users):
        """Sets the users of this InlineResponse20047Response.


        :param users: The users of this InlineResponse20047Response.  # noqa: E501
        :type: list[InlineResponse20047ResponseUsers]
        """
