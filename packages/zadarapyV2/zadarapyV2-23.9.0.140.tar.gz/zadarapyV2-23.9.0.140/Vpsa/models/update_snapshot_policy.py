...
class UpdateSnapshotPolicy(object):
    ...
    def __init__(self, displayname=None, create_policy=None, delete_policy=None, destination_policy=None, empty=None, _configuration=None):  # noqa: E501
        """UpdateSnapshotPolicy - a model defined in Swagger"""  # noqa: E501
    ...
    def displayname(self):
        """Gets the displayname of this UpdateSnapshotPolicy.  # noqa: E501

        Snapshot policy name  # noqa: E501

        :return: The displayname of this UpdateSnapshotPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def displayname(self, displayname):
        """Sets the displayname of this UpdateSnapshotPolicy.

        Snapshot policy name  # noqa: E501

        :param displayname: The displayname of this UpdateSnapshotPolicy.  # noqa: E501
        :type: str
        """
    ...
    def create_policy(self):
        """Gets the create_policy of this UpdateSnapshotPolicy.  # noqa: E501
        ...
        :return: The create_policy of this UpdateSnapshotPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def create_policy(self, create_policy):
        """Sets the create_policy of this UpdateSnapshotPolicy.

        Define the minimal interval of snapshot creation. The format is similar to a cron job - Minute, Hour, Day of Month, Month, Day Of Week (Minute supports random value - D0)  # noqa: E501

        :param create_policy: The create_policy of this UpdateSnapshotPolicy.  # noqa: E501
        :type: str
        """
    ...
    def delete_policy(self):
        """Gets the delete_policy of this UpdateSnapshotPolicy.  # noqa: E501

        minutes hours days or N number_of_snapshots_to_keep.  # noqa: E501

        :return: The delete_policy of this UpdateSnapshotPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def delete_policy(self, delete_policy):
        """Sets the delete_policy of this UpdateSnapshotPolicy.

        minutes hours days or N number_of_snapshots_to_keep.  # noqa: E501

        :param delete_policy: The delete_policy of this UpdateSnapshotPolicy.  # noqa: E501
        :type: str
        """
    ...
    def destination_policy(self):
        """Gets the destination_policy of this UpdateSnapshotPolicy.  # noqa: E501
        ...
        :return: The destination_policy of this UpdateSnapshotPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def destination_policy(self, destination_policy):
        """Sets the destination_policy of this UpdateSnapshotPolicy.

        Relevant only for Remote Mirroring where the remote Volume snapshot deletion policy is different than the source Volume. Set N number_of_snapshots_to_keep.  # noqa: E501

        :param destination_policy: The destination_policy of this UpdateSnapshotPolicy.  # noqa: E501
        :type: str
        """
    ...
    @property
    def empty(self):
        """Gets the empty of this UpdateSnapshotPolicy.  # noqa: E501

        Allow empty creation snapshots (snapshot even when no data has changed)  # noqa: E501

        :return: The empty of this UpdateSnapshotPolicy.  # noqa: E501
        :rtype: str
        """
        return self._empty
    ...
    def empty(self, empty):
        """Sets the empty of this UpdateSnapshotPolicy.

        Allow empty creation snapshots (snapshot even when no data has changed)  # noqa: E501

        :param empty: The empty of this UpdateSnapshotPolicy.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateSnapshotPolicy, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSnapshotPolicy):
            return False
