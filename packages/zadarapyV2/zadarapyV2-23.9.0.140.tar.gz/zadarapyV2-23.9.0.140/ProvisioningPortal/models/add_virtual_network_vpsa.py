...
class AddVirtualNetworkVpsa(object):
    ...
    def __init__(self, virtual_network_id=None, _configuration=None):  # noqa: E501
        """AddVirtualNetworkVpsa - a model defined in Swagger"""  # noqa: E501
    ...
    def virtual_network_id(self):
        """Gets the virtual_network_id of this AddVirtualNetworkVpsa.  # noqa: E501

        Virtual Network ID.  # noqa: E501

        :return: The virtual_network_id of this AddVirtualNetworkVpsa.  # noqa: E501
        :rtype: str
        """
    ...
    def virtual_network_id(self, virtual_network_id):
        """Sets the virtual_network_id of this AddVirtualNetworkVpsa.

        Virtual Network ID.  # noqa: E501

        :param virtual_network_id: The virtual_network_id of this AddVirtualNetworkVpsa.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and virtual_network_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddVirtualNetworkVpsa, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddVirtualNetworkVpsa):
            return False
