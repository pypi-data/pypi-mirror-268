...
class InlineResponse2006DataIoengines(object):
    ...
    """
    swagger_types = {
        'provider9': 'InlineResponse2006DataIoenginesProvider9'
    }
    ...
    def __init__(self, provider9=None, _configuration=None):  # noqa: E501
        """InlineResponse2006DataIoengines - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._provider9 = None
        self.discriminator = None

        if provider9 is not None:
            self.provider9 = provider9

    @property
    def provider9(self):
        """Gets the provider9 of this InlineResponse2006DataIoengines.  # noqa: E501


        :return: The provider9 of this InlineResponse2006DataIoengines.  # noqa: E501
        :rtype: InlineResponse2006DataIoenginesProvider9
        """
        return self._provider9

    @provider9.setter
    def provider9(self, provider9):
        """Sets the provider9 of this InlineResponse2006DataIoengines.


        :param provider9: The provider9 of this InlineResponse2006DataIoengines.  # noqa: E501
        :type: InlineResponse2006DataIoenginesProvider9
        """

        self._provider9 = provider9
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse2006DataIoengines, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse2006DataIoengines):
            return False
