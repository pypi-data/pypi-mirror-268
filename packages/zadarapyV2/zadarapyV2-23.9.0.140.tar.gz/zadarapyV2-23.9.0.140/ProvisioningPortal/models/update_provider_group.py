...
class UpdateProviderGroup(object):
    ...
    def __init__(self, name=None, _configuration=None):  # noqa: E501
        """UpdateProviderGroup - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this UpdateProviderGroup.  # noqa: E501


        :return: The name of this UpdateProviderGroup.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateProviderGroup.


        :param name: The name of this UpdateProviderGroup.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateProviderGroup, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateProviderGroup):
            return False
