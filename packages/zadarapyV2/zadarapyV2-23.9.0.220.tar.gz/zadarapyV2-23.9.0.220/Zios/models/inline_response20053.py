...
class InlineResponse20053(object):
    ...
    swagger_types = {
        'status': 'int',
        'message': 'str',
        'response': 'InlineResponse20053Response'
    }
    ...
    @property
    def response(self):
        """Gets the response of this InlineResponse20053.  # noqa: E501


        :return: The response of this InlineResponse20053.  # noqa: E501
        :rtype: InlineResponse20053Response
        """
        return self._response

    @response.setter
    def response(self, response):
        """Sets the response of this InlineResponse20053.


        :param response: The response of this InlineResponse20053.  # noqa: E501
        :type: InlineResponse20053Response
        """
