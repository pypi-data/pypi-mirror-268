...
class InlineResponse20062(object):
    ...
    swagger_types = {
        'status': 'int',
        'message': 'str',
        'response': 'InlineResponse20062Response'
    }
    ...
    @property
    def response(self):
        """Gets the response of this InlineResponse20062.  # noqa: E501


        :return: The response of this InlineResponse20062.  # noqa: E501
        :rtype: InlineResponse20062Response
        """
        return self._response

    @response.setter
    def response(self, response):
        """Sets the response of this InlineResponse20062.


        :param response: The response of this InlineResponse20062.  # noqa: E501
        :type: InlineResponse20062Response
        """
