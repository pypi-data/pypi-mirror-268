...
class SetApiHostname(object):
    ...
    def __init__(self, api_hostname=None, _configuration=None):  # noqa: E501
        """SetApiHostname - a model defined in Swagger"""  # noqa: E501
    ...
    def api_hostname(self):
        """Gets the api_hostname of this SetApiHostname.  # noqa: E501


        :return: The api_hostname of this SetApiHostname.  # noqa: E501
        :rtype: str
        """
    ...
    def api_hostname(self, api_hostname):
        """Sets the api_hostname of this SetApiHostname.


        :param api_hostname: The api_hostname of this SetApiHostname.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and api_hostname is None:
            raise ValueError("Invalid value for `api_hostname`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SetApiHostname, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetApiHostname):
            return False
