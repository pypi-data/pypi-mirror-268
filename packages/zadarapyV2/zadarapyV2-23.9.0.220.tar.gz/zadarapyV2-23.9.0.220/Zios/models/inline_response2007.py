...
class InlineResponse2007(object):
    ...
    swagger_types = {
        'status': 'int',
        'message': 'str',
        'response': 'InlineResponse2007Response'
    }
    ...
    @property
    def response(self):
        """Gets the response of this InlineResponse2007.  # noqa: E501


        :return: The response of this InlineResponse2007.  # noqa: E501
        :rtype: InlineResponse2007Response
        """
        return self._response

    @response.setter
    def response(self, response):
        """Sets the response of this InlineResponse2007.


        :param response: The response of this InlineResponse2007.  # noqa: E501
        :type: InlineResponse2007Response
        """
