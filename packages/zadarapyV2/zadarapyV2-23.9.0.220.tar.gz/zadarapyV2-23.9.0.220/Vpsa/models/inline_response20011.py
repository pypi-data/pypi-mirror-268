...
class InlineResponse20011(object):
    ...
    swagger_types = {
        'status': 'int',
        'message': 'str',
        'response': 'InlineResponse20011Response'
    }
    ...
    @property
    def response(self):
        """Gets the response of this InlineResponse20011.  # noqa: E501


        :return: The response of this InlineResponse20011.  # noqa: E501
        :rtype: InlineResponse20011Response
        """
        return self._response

    @response.setter
    def response(self, response):
        """Sets the response of this InlineResponse20011.


        :param response: The response of this InlineResponse20011.  # noqa: E501
        :type: InlineResponse20011Response
        """
