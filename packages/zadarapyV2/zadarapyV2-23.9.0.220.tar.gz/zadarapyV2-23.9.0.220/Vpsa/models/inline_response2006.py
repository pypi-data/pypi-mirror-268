...
class InlineResponse2006(object):
    ...
    swagger_types = {
        'status': 'int',
        'message': 'str',
        'response': 'InlineResponse2006Response'
    }
    ...
    @property
    def response(self):
        """Gets the response of this InlineResponse2006.  # noqa: E501


        :return: The response of this InlineResponse2006.  # noqa: E501
        :rtype: InlineResponse2006Response
        """
        return self._response

    @response.setter
    def response(self, response):
        """Sets the response of this InlineResponse2006.


        :param response: The response of this InlineResponse2006.  # noqa: E501
        :type: InlineResponse2006Response
        """
