...
class DiscoverRemoteVpsa(object):
    ...
    def __init__(self, ip=None, user=None, password=None, interface='fe', proxyhost=None, proxyport=None, proxytype=None, proxyusername=None, proxypassword=None, _configuration=None):  # noqa: E501
    ...
    @property
    def proxytype(self):
        """Gets the proxytype of this DiscoverRemoteVpsa.  # noqa: E501

        If using proxy, the proxy type  # noqa: E501

        :return: The proxytype of this DiscoverRemoteVpsa.  # noqa: E501
        :rtype: str
        """
    ...
    def proxytype(self, proxytype):
        """Sets the proxytype of this DiscoverRemoteVpsa.

        If using proxy, the proxy type  # noqa: E501

        :param proxytype: The proxytype of this DiscoverRemoteVpsa.  # noqa: E501
        :type: str
        """
        allowed_values = ["http", "http10", "socks4_hostname", "socks5", "socks4", "socks4a"]  # noqa: E501
        if (self._configuration.client_side_validation and
                proxytype not in allowed_values):
            raise ValueError(
                "Invalid value for `proxytype` ({0}), must be one of {1}"  # noqa: E501
                .format(proxytype, allowed_values)
            )
