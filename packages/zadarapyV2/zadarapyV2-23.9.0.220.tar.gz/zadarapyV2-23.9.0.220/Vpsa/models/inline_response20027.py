...
class InlineResponse20027(object):
    ...
    swagger_types = {
        'status': 'int',
        'message': 'str',
        'response': 'InlineResponse20027Response'
    }
    ...
    @property
    def response(self):
        """Gets the response of this InlineResponse20027.  # noqa: E501


        :return: The response of this InlineResponse20027.  # noqa: E501
        :rtype: InlineResponse20027Response
        """
        return self._response

    @response.setter
    def response(self, response):
        """Sets the response of this InlineResponse20027.


        :param response: The response of this InlineResponse20027.  # noqa: E501
        :type: InlineResponse20027Response
        """
