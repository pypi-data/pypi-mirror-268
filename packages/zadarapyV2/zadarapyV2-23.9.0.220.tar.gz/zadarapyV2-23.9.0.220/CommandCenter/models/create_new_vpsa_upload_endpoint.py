...
class CreateNewVpsaUploadEndpoint(object):
    ...
    def __init__(self, endpoint_name=None, endpoint_method=None, config=None, _configuration=None):  # noqa: E501
        """CreateNewVpsaUploadEndpoint - a model defined in Swagger"""  # noqa: E501
    ...
    def endpoint_name(self):
        """Gets the endpoint_name of this CreateNewVpsaUploadEndpoint.  # noqa: E501

        Endpoint name  # noqa: E501

        :return: The endpoint_name of this CreateNewVpsaUploadEndpoint.  # noqa: E501
        :rtype: str
        """
    ...
    def endpoint_name(self, endpoint_name):
        """Sets the endpoint_name of this CreateNewVpsaUploadEndpoint.

        Endpoint name  # noqa: E501

        :param endpoint_name: The endpoint_name of this CreateNewVpsaUploadEndpoint.  # noqa: E501
        :type: str
        """
    ...
    def endpoint_method(self):
        """Gets the endpoint_method of this CreateNewVpsaUploadEndpoint.  # noqa: E501

        Endpoint upload method  # noqa: E501

        :return: The endpoint_method of this CreateNewVpsaUploadEndpoint.  # noqa: E501
        :rtype: str
        """
    ...
    def endpoint_method(self, endpoint_method):
        """Sets the endpoint_method of this CreateNewVpsaUploadEndpoint.

        Endpoint upload method  # noqa: E501

        :param endpoint_method: The endpoint_method of this CreateNewVpsaUploadEndpoint.  # noqa: E501
        :type: str
        """
    ...
    @property
    def config(self):
        """Gets the config of this CreateNewVpsaUploadEndpoint.  # noqa: E501
        ...
        :return: The config of this CreateNewVpsaUploadEndpoint.  # noqa: E501
        :rtype: str
        """
        return self._config
    ...
    def config(self, config):
        """Sets the config of this CreateNewVpsaUploadEndpoint.

        Endpoint configuration JSON, depending on the chosen upload method. For 's3_aws' and 's3_zios' methods, config should include 'access_key', 'secret_key' and 'region'. For 's3_zios' method, config should also include 'endpoint'. For 'ftp' method, config should include 'server', 'user', 'password', 'use_proxy' (boolean '0' or '1').  # noqa: E501

        :param config: The config of this CreateNewVpsaUploadEndpoint.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateNewVpsaUploadEndpoint, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateNewVpsaUploadEndpoint):
            return False
