...
class ContractToCreatePayAsYouGoTimeBasedType(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ContractToCreatePayAsYouGoTimeBasedType._member_map_.values(),
            )
        )


@JsonMap({})
class ContractToCreatePayAsYouGoTimeBasedCompensationDetails(BaseModel):
...
class ContractToCreatePayAsYouGoTimeBased(BaseModel):
    ...
    :param client: client
    :type client: ContractToCreatePayAsYouGoTimeBasedClient
    ...
    :type job_title: ContractToCreatePayAsYouGoTimeBasedJobTitle
    ...
    :type seniority: ContractToCreatePayAsYouGoTimeBasedSeniority, optional
    :param notice_period: Days before to notice the termination of contract for eather party., defaults to None
    :type notice_period: float, optional
    ...
    :type worker: ContractToCreatePayAsYouGoTimeBasedWorker, optional
    :param type_: type_
    :type type_: ContractToCreatePayAsYouGoTimeBasedType
    ...
    :type compensation_details: ContractToCreatePayAsYouGoTimeBasedCompensationDetails
    """
    ...
    def __init__(
        ...
        type_: ContractToCreatePayAsYouGoTimeBasedType,
        start_date: str,
        ...
        seniority: ContractToCreatePayAsYouGoTimeBasedSeniority = None,
        notice_period: float = None,
        who_reports: ContractWhoReportsEnum = None,
        external_id: str = None,
        worker: ContractToCreatePayAsYouGoTimeBasedWorker = None,
    ):
        self.title = title
        ...
        if seniority is not None:
            self.seniority = self._define_object(
                seniority, ContractToCreatePayAsYouGoTimeBasedSeniority
            )
        if notice_period is not None:
            self.notice_period = notice_period
        ...
        if worker is not None:
            self.worker = self._define_object(
                worker, ContractToCreatePayAsYouGoTimeBasedWorker
            )
        self.type_ = self._enum_matching(
            type_, ContractToCreatePayAsYouGoTimeBasedType.list(), "type_"
        )
