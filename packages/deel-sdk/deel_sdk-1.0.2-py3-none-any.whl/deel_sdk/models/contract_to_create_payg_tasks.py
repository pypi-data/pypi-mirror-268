...
class ContractToCreatePaygTasksClient(BaseModel):
    ...
    :type legal_entity: ClientLegalEntity6
    :param team: Choose the Deel team for this contract. Use teams endpoint to retrieve a list of teams in your organization.
    :type team: ClientTeam3
    """

    def __init__(self, legal_entity: ClientLegalEntity6, team: ClientTeam3):
        self.legal_entity = self._define_object(legal_entity, ClientLegalEntity6)
...
class ContractToCreatePaygTasksType(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, ContractToCreatePaygTasksType._member_map_.values())
        )
...
class ContractToCreatePaygTasks(BaseModel):
    ...
    :param client: client
    :type client: ContractToCreatePaygTasksClient
    ...
    :type job_title: ContractToCreatePaygTasksJobTitle
    ...
    :type seniority: ContractToCreatePaygTasksSeniority, optional
    ...
    :type worker: ContractToCreatePaygTasksWorker, optional
    :param type_: type_
    :type type_: ContractToCreatePaygTasksType
    ...
    def __init__(
        ...
        seniority: ContractToCreatePaygTasksSeniority = None,
        notice_period: float = None,
        who_reports: ContractWhoReportsEnum = None,
        external_id: str = None,
        worker: ContractToCreatePaygTasksWorker = None,
    ):
        self.title = title
        ...
        if worker is not None:
            self.worker = self._define_object(worker, ContractToCreatePaygTasksWorker)
        self.type_ = self._enum_matching(
            type_, ContractToCreatePaygTasksType.list(), "type_"
        )
