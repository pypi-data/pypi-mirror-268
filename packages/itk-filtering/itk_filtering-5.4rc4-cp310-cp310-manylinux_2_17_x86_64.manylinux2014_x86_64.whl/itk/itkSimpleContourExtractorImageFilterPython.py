...
def simple_contour_extractor_image_filter(*args: itkt.ImageLike,  input_foreground_value: float=..., input_background_value: float=..., output_foreground_value: float=..., output_background_value: float=..., radius: Union[Sequence[int], int]=...,**kwargs)-> itkt.ImageSourceReturn:
