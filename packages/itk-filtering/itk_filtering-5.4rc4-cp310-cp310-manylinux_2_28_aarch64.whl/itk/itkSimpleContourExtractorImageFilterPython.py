...
def simple_contour_extractor_image_filter(*args: itkt.ImageLike,  input_foreground_value: int=..., input_background_value: int=..., output_foreground_value: int=..., output_background_value: int=..., radius: Union[int, Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
