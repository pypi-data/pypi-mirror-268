...
def grayscale_dilate_image_filter(*args: itkt.ImageLike,  kernel: Union[itkt.FlatStructuringElement, itkt.FlatStructuringElement]=..., boundary: int=..., algorithm=..., radius: Union[int, Sequence[int], Sequence[int], int]=...,**kwargs)-> itkt.ImageSourceReturn:
