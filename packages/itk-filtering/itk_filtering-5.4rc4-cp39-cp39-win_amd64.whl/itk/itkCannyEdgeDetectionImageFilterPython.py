...
def canny_edge_detection_image_filter(*args: itkt.ImageLike,  variance: Union[Sequence[float], float]=..., maximum_error: Union[Sequence[float], float]=..., upper_threshold: float=..., lower_threshold: float=...,**kwargs)-> itkt.ImageSourceReturn:
