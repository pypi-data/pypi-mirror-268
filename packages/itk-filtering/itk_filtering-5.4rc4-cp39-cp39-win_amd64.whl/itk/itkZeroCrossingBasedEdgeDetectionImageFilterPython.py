...
def zero_crossing_based_edge_detection_image_filter(*args: itkt.ImageLike,  variance: Union[float, Sequence[float]]=..., maximum_error: Union[float, Sequence[float]]=..., background_value: float=..., foreground_value: float=...,**kwargs)-> itkt.ImageSourceReturn:
