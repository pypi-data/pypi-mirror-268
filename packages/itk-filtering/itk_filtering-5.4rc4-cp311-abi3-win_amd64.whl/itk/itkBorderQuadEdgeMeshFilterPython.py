...
class itkBorderQuadEdgeMeshFilterQEMD2(itk.itkQuadEdgeMeshToQuadEdgeMeshFilterPython.itkQuadEdgeMeshToQuadEdgeMeshFilterQEMD2QEMD2):
    ...
    def GetBoundaryPtMap(self):
        r"""GetBoundaryPtMap(self) -> std::map< unsigned long long,unsigned long long,std::less< unsigned long long >,std::allocator< std::pair< unsigned long long const,unsigned long long > > >"""
        return _itkBorderQuadEdgeMeshFilterPython.itkBorderQuadEdgeMeshFilterQEMD2_GetBoundaryPtMap(self)

    def GetBorder(self):
        r"""GetBorder(self) -> std::vector< itkQuadEdgeMeshPointF2GQEULLULLBBT,std::allocator< itkQuadEdgeMeshPointF2GQEULLULLBBT > >"""
...
class itkBorderQuadEdgeMeshFilterQEMD3(itk.itkQuadEdgeMeshToQuadEdgeMeshFilterPython.itkQuadEdgeMeshToQuadEdgeMeshFilterQEMD3QEMD3):
    ...
    def GetBorder(self):
        r"""GetBorder(self) -> std::vector< itkQuadEdgeMeshPointF3GQEULLULLBBT,std::allocator< itkQuadEdgeMeshPointF3GQEULLULLBBT > >"""
...
class itkBorderQuadEdgeMeshFilterQEMD4(itk.itkQuadEdgeMeshToQuadEdgeMeshFilterPython.itkQuadEdgeMeshToQuadEdgeMeshFilterQEMD4QEMD4):
    ...
    def GetBorder(self):
        r"""GetBorder(self) -> std::vector< itkQuadEdgeMeshPointF4GQEULLULLBBT,std::allocator< itkQuadEdgeMeshPointF4GQEULLULLBBT > >"""
