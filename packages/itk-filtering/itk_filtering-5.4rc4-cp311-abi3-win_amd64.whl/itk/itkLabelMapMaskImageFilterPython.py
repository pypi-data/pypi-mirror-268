...
def label_map_mask_image_filter(*args: itkt.ImageLike,  feature_image: itkt.Image=..., background_value: int=..., label: int=..., negated: bool=..., crop: bool=..., crop_border: Sequence[int]=...,**kwargs)-> itkt.ImageSourceReturn:
