...
def discrete_gaussian_derivative_image_filter(*args: itkt.ImageLike,  order: Union[int, Sequence[int]]=..., variance: Union[float, Sequence[float]]=..., maximum_error: Union[float, Sequence[float]]=..., maximum_kernel_width: int=..., internal_number_of_stream_divisions: int=..., use_image_spacing: bool=..., normalize_across_scale: bool=...,**kwargs)-> itkt.ImageSourceReturn:
