...
def morphological_gradient_image_filter(*args: itkt.ImageLike,  kernel: Union[itkt.FlatStructuringElement, itkt.FlatStructuringElement]=..., algorithm=..., radius: Union[Sequence[int], int, Sequence[int], int]=...,**kwargs)-> itkt.ImageSourceReturn:
