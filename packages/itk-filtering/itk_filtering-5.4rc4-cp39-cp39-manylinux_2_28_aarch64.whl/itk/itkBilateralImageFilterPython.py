...
def bilateral_image_filter(*args: itkt.ImageLike,  domain_sigma: Union[float, Sequence[float]]=..., domain_mu: float=..., range_sigma: float=..., filter_dimensionality: int=..., automatic_kernel_size: bool=..., radius: Union[Sequence[int], int]=..., number_of_range_gaussian_samples: int=...,**kwargs)-> itkt.ImageSourceReturn:
