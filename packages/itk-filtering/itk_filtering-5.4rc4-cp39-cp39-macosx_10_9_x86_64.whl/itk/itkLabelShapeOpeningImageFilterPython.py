...
def label_shape_opening_image_filter(*args: itkt.ImageLike,  background_value: int=..., reverse_ordering: bool=..., attribute: Union[str, int]=...,**kwargs)-> itkt.ImageSourceReturn:
