...
class itkShapeKeepNObjectsLabelMapFilterLM2(itk.itkInPlaceLabelMapFilterPython.itkInPlaceLabelMapFilterLM2):
    ...
    def GetNumberOfObjects(self):
        r"""GetNumberOfObjects(self) -> unsigned long long const &"""
...
def shape_keep_n_objects_label_map_filter(*args: itkt.ImageLike,  reverse_ordering: bool=..., number_of_objects: int=..., attribute: Union[int, str]=...,**kwargs)-> itkt.ImageSourceReturn:
