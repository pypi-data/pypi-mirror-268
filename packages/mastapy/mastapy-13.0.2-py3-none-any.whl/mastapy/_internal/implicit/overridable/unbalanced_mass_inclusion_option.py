...
class Overridable_UnbalancedMassInclusionOption(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2485.UnbalancedMassInclusionOption":
        ...
        return _2485.UnbalancedMassInclusionOption

    @classmethod
    def implicit_type(cls) -> "_2485.UnbalancedMassInclusionOption.type_()":
        ...
        return _2485.UnbalancedMassInclusionOption.type_()

    @property
    def value(self: Self) -> "_2485.UnbalancedMassInclusionOption":
    ...
    @property
    def override_value(self: Self) -> "_2485.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption
    ...
    @property
    def calculated_value(self: Self) -> "_2485.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption
