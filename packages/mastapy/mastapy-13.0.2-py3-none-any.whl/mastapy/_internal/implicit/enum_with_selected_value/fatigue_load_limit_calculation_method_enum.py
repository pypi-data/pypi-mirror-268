...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2159.FatigueLoadLimitCalculationMethodEnum":
        ...
        return _2159.FatigueLoadLimitCalculationMethodEnum

    @classmethod
    def implicit_type(cls) -> "_2159.FatigueLoadLimitCalculationMethodEnum.type_()":
        ...
        return _2159.FatigueLoadLimitCalculationMethodEnum.type_()

    @property
    def selected_value(self: Self) -> "_2159.FatigueLoadLimitCalculationMethodEnum":
    ...
    def available_values(
        self: Self,
    ) -> "List[_2159.FatigueLoadLimitCalculationMethodEnum]":
