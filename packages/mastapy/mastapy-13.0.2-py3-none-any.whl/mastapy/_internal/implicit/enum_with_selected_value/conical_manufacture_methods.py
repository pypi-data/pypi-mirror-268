...
class EnumWithSelectedValue_ConicalManufactureMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1164.ConicalManufactureMethods":
        ...
        return _1164.ConicalManufactureMethods

    @classmethod
    def implicit_type(cls) -> "_1164.ConicalManufactureMethods.type_()":
        ...
        return _1164.ConicalManufactureMethods.type_()

    @property
    def selected_value(self: Self) -> "_1164.ConicalManufactureMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_1164.ConicalManufactureMethods]":
