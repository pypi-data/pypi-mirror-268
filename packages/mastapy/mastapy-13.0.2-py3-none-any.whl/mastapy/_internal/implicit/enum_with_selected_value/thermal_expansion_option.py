...
from mastapy.system_model.fe import _2418
...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2418.ThermalExpansionOption":
        ...
        return _2418.ThermalExpansionOption

    @classmethod
    def implicit_type(cls) -> "_2418.ThermalExpansionOption.type_()":
        ...
        return _2418.ThermalExpansionOption.type_()

    @property
    def selected_value(self: Self) -> "_2418.ThermalExpansionOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2418.ThermalExpansionOption]":
