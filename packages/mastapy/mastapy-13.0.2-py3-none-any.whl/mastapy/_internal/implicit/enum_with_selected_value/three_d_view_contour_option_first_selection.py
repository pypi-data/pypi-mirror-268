...
from mastapy.utility.enums import _1829
...
class EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1829.ThreeDViewContourOptionFirstSelection":
        ...
        return _1829.ThreeDViewContourOptionFirstSelection

    @classmethod
    def implicit_type(cls) -> "_1829.ThreeDViewContourOptionFirstSelection.type_()":
        ...
        return _1829.ThreeDViewContourOptionFirstSelection.type_()

    @property
    def selected_value(self: Self) -> "_1829.ThreeDViewContourOptionFirstSelection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1829.ThreeDViewContourOptionFirstSelection]":
