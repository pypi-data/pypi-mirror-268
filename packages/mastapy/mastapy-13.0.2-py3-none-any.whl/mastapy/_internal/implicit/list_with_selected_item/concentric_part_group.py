...
class ListWithSelectedItem_ConcentricPartGroup(
    _2494.ConcentricPartGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def __init__(
        self, instance_to_wrap: "ListWithSelectedItem_ConcentricPartGroup.TYPE"
    ):
        try:
    ...
    @classmethod
    def implicit_type(cls) -> "_2494.ConcentricPartGroup.TYPE":
        ...
        return _2494.ConcentricPartGroup.TYPE

    @property
    def selected_value(self: Self) -> "_2494.ConcentricPartGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_2494.ConcentricPartGroup]":
