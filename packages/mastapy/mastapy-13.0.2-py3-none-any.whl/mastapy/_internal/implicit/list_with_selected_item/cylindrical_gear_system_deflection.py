...
class ListWithSelectedItem_CylindricalGearSystemDeflection(
    _2753.CylindricalGearSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2753.CylindricalGearSystemDeflection.TYPE":
        ...
        return _2753.CylindricalGearSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2753.CylindricalGearSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2753.CylindricalGearSystemDeflection]":
