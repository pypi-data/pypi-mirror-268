...
class ListWithSelectedItem_ElectricMachineResults(
    _1333.ElectricMachineResults, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1333.ElectricMachineResults.TYPE":
        ...
        return _1333.ElectricMachineResults.TYPE

    @property
    def selected_value(self: Self) -> "_1333.ElectricMachineResults":
    ...
    @property
    def available_values(self: Self) -> "List[_1333.ElectricMachineResults]":
