...
class ListWithSelectedItem_GearSet(_2539.GearSet, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2539.GearSet.TYPE":
        ...
        return _2539.GearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2539.GearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2539.GearSet]":
