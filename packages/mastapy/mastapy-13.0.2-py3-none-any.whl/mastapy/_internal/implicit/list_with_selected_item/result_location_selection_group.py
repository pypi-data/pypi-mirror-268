...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5859
...
class ListWithSelectedItem_ResultLocationSelectionGroup(
    _5859.ResultLocationSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5859.ResultLocationSelectionGroup.TYPE":
        ...
        return _5859.ResultLocationSelectionGroup.TYPE

    @property
    def selected_value(self: Self) -> "_5859.ResultLocationSelectionGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_5859.ResultLocationSelectionGroup]":
