...
class ListWithSelectedItem_MeasurementBase(
    _1612.MeasurementBase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1612.MeasurementBase.TYPE":
        ...
        return _1612.MeasurementBase.TYPE

    @property
    def selected_value(self: Self) -> "_1612.MeasurementBase":
    ...
    @property
    def available_values(self: Self) -> "List[_1612.MeasurementBase]":
