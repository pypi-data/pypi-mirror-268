...
class ListWithSelectedItem_FEPart(_2460.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2460.FEPart.TYPE":
        ...
        return _2460.FEPart.TYPE

    @property
    def selected_value(self: Self) -> "_2460.FEPart":
    ...
    @property
    def available_values(self: Self) -> "List[_2460.FEPart]":
