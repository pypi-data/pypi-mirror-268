...
class ListWithSelectedItem_SystemDirectory(
    _1607.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1607.SystemDirectory.TYPE":
        ...
        return _1607.SystemDirectory.TYPE

    @property
    def selected_value(self: Self) -> "_1607.SystemDirectory":
    ...
    @property
    def available_values(self: Self) -> "List[_1607.SystemDirectory]":
