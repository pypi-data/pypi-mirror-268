...
class RootAssemblyCompoundParametricStudyTool(
    ...
    @property
    def compound_load_case(self: Self) -> "_5667.AbstractLoadCaseGroup":
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6957.RootAssemblyLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4416.RootAssemblyParametricStudyTool]":
