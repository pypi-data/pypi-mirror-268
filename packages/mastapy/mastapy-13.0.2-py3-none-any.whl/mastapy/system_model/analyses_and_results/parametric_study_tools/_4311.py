...
class AssemblyParametricStudyTool(_4304.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    def all_duty_cycle_results(
        self: Self,
    ) -> "List[_4358.DutyCycleResultsForAllComponents]":
    ...
    @property
    def bearings(self: Self) -> "List[_4312.BearingParametricStudyTool]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4314.BeltDriveParametricStudyTool]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4317.BevelDifferentialGearSetParametricStudyTool]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4323.BoltedJointParametricStudyTool]":
    ...
    @property
    def bolts(self: Self) -> "List[_4324.BoltParametricStudyTool]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4345.CVTParametricStudyTool]":
    ...
    @property
    def clutches(self: Self) -> "List[_4327.ClutchParametricStudyTool]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_4332.ConceptCouplingParametricStudyTool]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4347.CycloidalAssemblyParametricStudyTool]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4349.CycloidalDiscParametricStudyTool]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4367.FEPartParametricStudyTool]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4366.FaceGearSetParametricStudyTool]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4375.HypoidGearSetParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4382.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4385.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4386.MassDiscParametricStudyTool]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4390.OilSealParametricStudyTool]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4407.PlanetCarrierParametricStudyTool]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4408.PointLoadParametricStudyTool]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4409.PowerLoadParametricStudyTool]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4411.RingPinsParametricStudyTool]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4413.RollingRingAssemblyParametricStudyTool]":
    ...
    @property
    def shafts(self: Self) -> "List[_4418.ShaftParametricStudyTool]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4426.SpringDamperParametricStudyTool]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4436.SynchroniserParametricStudyTool]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4440.TorqueConverterParametricStudyTool]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4447.WormGearSetParametricStudyTool]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4450.ZerolBevelGearSetParametricStudyTool]":
