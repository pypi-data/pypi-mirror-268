...
class RootAssemblyParametricStudyTool(_4311.AssemblyParametricStudyTool):
    """RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self: Self) -> "_4396.ParametricStudyTool":
    ...
    def root_assembly_duty_cycle_results(
        self: Self,
    ) -> "List[_2911.DutyCycleEfficiencyResults]":
