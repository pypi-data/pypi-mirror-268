...
class SpiralBevelGearSetCompoundPowerFlow(_4193.BevelGearSetCompoundPowerFlow):
    """SpiralBevelGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4146.SpiralBevelGearSetPowerFlow]":
    ...
    def spiral_bevel_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4274.SpiralBevelGearCompoundPowerFlow]":
    ...
    def spiral_bevel_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4275.SpiralBevelGearMeshCompoundPowerFlow]":
