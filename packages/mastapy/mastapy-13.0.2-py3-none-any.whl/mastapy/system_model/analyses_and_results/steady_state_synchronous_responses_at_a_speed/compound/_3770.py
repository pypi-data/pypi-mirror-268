...
class ZerolBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3640.ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def zerol_bevel_gears_compound_steady_state_synchronous_response_at_a_speed(
        self: Self,
    ) -> "List[_3768.ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def zerol_bevel_meshes_compound_steady_state_synchronous_response_at_a_speed(
        self: Self,
    ) -> "List[_3769.ZerolBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]":
