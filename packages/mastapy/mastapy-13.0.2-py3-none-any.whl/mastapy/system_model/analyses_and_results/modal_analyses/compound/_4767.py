...
class ConceptGearSetCompoundModalAnalysis(_4796.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4611.ConceptGearSetModalAnalysis]":
    ...
    def concept_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4765.ConceptGearCompoundModalAnalysis]":
    ...
    def concept_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4766.ConceptGearMeshCompoundModalAnalysis]":
