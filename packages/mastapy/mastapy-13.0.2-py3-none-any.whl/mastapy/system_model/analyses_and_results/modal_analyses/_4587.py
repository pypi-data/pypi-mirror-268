...
class AssemblyModalAnalysis(_4580.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_4588.BearingModalAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4590.BeltDriveModalAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4593.BevelDifferentialGearSetModalAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4599.BoltedJointModalAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_4600.BoltModalAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4622.CVTModalAnalysis]":
    ...
    def calculate_full_fe_results_by_mode(
        self: Self,
    ) -> "List[_4724.CalculateFullFEResultsForMode]":
    ...
    @property
    def clutches(self: Self) -> "List[_4603.ClutchModalAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_4608.ConceptCouplingModalAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_4611.ConceptGearSetModalAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4626.CycloidalDiscModalAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4640.FEPartModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4639.FaceGearSetModalAnalysis]":
    ...
    def full_fe_meshes_for_calculating_modes(
        self: Self,
    ) -> "List[_4640.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4649.HypoidGearSetModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4656.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4660.MassDiscModalAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4661.MeasurementComponentModalAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4668.OilSealModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4673.PartToPartShearCouplingModalAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4676.PlanetCarrierModalAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4677.PointLoadModalAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4678.PowerLoadModalAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4680.RingPinsModalAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_4687.ShaftModalAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4696.SpringDamperModalAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4706.SynchroniserModalAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_4710.TorqueConverterModalAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_4713.UnbalancedMassModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4720.WormGearSetModalAnalysis]":
