...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.fe import _2414
...
class RootAssemblyCompoundSystemDeflection(_2866.AssemblyCompoundSystemDeflection):
    """RootAssemblyCompoundSystemDeflection
    ...
    @property
    def duty_cycle_efficiency_results(self: Self) -> "_2911.DutyCycleEfficiencyResults":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_2808.RootAssemblySystemDeflection]":
    ...
    @property
    def bearing_race_f_es(self: Self) -> "List[_2414.RaceBearingFESystemDeflection]":
    ...
    def peak_to_peak_transmission_error_chart(
        self: Self,
        mesh_duty_cycles: "List[_1105.CylindricalGearMeshMicroGeometryDutyCycle]",
        header: "str",
        x_axis_title: "str",
        y_axis_title: "str",
