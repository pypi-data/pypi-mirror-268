...
class AssemblySystemDeflection(_2693.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4047.AssemblyPowerFlow":
    ...
    @property
    def bearings(self: Self) -> "List[_2706.BearingSystemDeflection]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_2708.BeltDriveSystemDeflection]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_2717.BoltedJointSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_2718.BoltSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_2742.CVTSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_2721.ClutchSystemDeflection]":
    ...
    @property
    def component_details(self: Self) -> "List[_2723.ComponentSystemDeflection]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_2727.ConceptCouplingSystemDeflection]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_2729.ConceptGearSetSystemDeflection]":
    ...
    @property
    def connection_details(self: Self) -> "List[_2735.ConnectionSystemDeflection]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_2746.CycloidalDiscSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_2765.FEPartSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_2763.FaceGearSetSystemDeflection]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_2772.HypoidGearSetSystemDeflection]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_2787.MassDiscSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_2792.OilSealSystemDeflection]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_2798.PlanetCarrierSystemDeflection]":
    ...
    @property
    def point_loads(self: Self) -> "List[_2799.PointLoadSystemDeflection]":
    ...
    @property
    def power_loads(self: Self) -> "List[_2800.PowerLoadSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_2802.RingPinsSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: Self) -> "List[_2706.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    @property
    def shafts(self: Self) -> "List[_2812.ShaftSystemDeflection]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_2820.SpringDamperSystemDeflection]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_2832.SynchroniserSystemDeflection]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_2838.TorqueConverterSystemDeflection]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_2842.UnbalancedMassSystemDeflection]":
    ...
    def unconverged_gear_meshes_sorted_by_power(
        self: Self,
    ) -> "List[_2767.GearMeshSystemDeflection]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_2845.WormGearSetSystemDeflection]":
