...
class PartHarmonicAnalysis(_7556.PartStaticLoadAnalysisCase):
    """PartHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: Self) -> "_4670.PartModalAnalysis":
    ...
    def create_viewable(self: Self) -> "_2256.HarmonicAnalysisViewable":
