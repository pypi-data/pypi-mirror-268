...
class WormGearSetHarmonicAnalysis(_5766.GearSetHarmonicAnalysis):
    """WormGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: Self) -> "List[_5846.WormGearHarmonicAnalysis]":
    ...
    def worm_gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5846.WormGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.WormGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5847.WormGearMeshHarmonicAnalysis]":
