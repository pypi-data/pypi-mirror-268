...
class ShaftCompoundHarmonicAnalysis(_5888.AbstractShaftCompoundHarmonicAnalysis):
    """ShaftCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_5814.ShaftHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5814.ShaftHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.ShaftHarmonicAnalysis]
