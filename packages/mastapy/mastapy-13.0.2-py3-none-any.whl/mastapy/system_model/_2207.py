...
from mastapy.system_model.part_model import _2479, _2482
...
if TYPE_CHECKING:
    from mastapy.system_model_gui import _1853
    from mastapy.gears import _325, _331
    from mastapy.system_model import _2230, _2231, _2215, _2212, _2229, _2219
    ...
    from mastapy.utility import _1589, _1590
    from mastapy.gears.materials import _601
    from mastapy.shafts import _35
    from mastapy.system_model.optimization.system_optimiser import _2247, _2246
    from mastapy.system_model.part_model.configurations import _2623, _2620, _2622
    from mastapy.bearings.bearing_results.rolling import _1983
    from mastapy.system_model.database_access import _2271
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6813, _6812
    from mastapy.utility.model_validation import _1800
    from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2990
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self: Self) -> "_1853.MASTAGUI":
    ...
    @property
    def axial_contact_ratio_requirement(self: Self) -> "_325.ContactRatioRequirements":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._325", "ContactRatioRequirements"
        )(value)

    @axial_contact_ratio_requirement.setter
    @enforce_parameter_types
    def axial_contact_ratio_requirement(
        self: Self, value: "_325.ContactRatioRequirements"
    ):
    ...
    def efficiency_rating_method_for_bearings(
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials.efficiency._295", "BearingEfficiencyRatingMethod"
        )(value)

    @efficiency_rating_method_for_bearings.setter
    @enforce_parameter_types
    def efficiency_rating_method_for_bearings(
        self: Self, value: "_295.BearingEfficiencyRatingMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def gear_set_configuration(
        self: Self, value: "_2519.ActiveGearSetDesignSelectionGroup"
    ):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def input_power_load(self: Self, value: "_2479.PowerLoad"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def output_power_load(self: Self, value: "_2479.PowerLoad"):
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_PowerLoad.wrapper_type()
        )
        enclosed_type = (
    ...
    @enforce_parameter_types
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        self: Self, value: "_2482.ShaftDiameterModificationDueToRollingBearingRing"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def thermal_expansion_for_grounded_nodes(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2230", "ThermalExpansionOptionForGroundedNodes"
        )(value)

    @thermal_expansion_for_grounded_nodes.setter
    @enforce_parameter_types
    def thermal_expansion_for_grounded_nodes(
        self: Self, value: "_2230.ThermalExpansionOptionForGroundedNodes"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def unbalanced_mass_inclusion(self: Self) -> "_2485.UnbalancedMassInclusionOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2485", "UnbalancedMassInclusionOption"
        )(value)

    @unbalanced_mass_inclusion.setter
    @enforce_parameter_types
    def unbalanced_mass_inclusion(
        self: Self, value: "_2485.UnbalancedMassInclusionOption"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def default_system_temperatures(self: Self) -> "_2231.TransmissionTemperatureSet":
    ...
    @property
    def detailed_spline_settings(self: Self) -> "_1398.DetailedSplineJointSettings":
    ...
    @property
    def electric_machine_group(self: Self) -> "_2215.ElectricMachineGroup":
    ...
    @property
    def fe_batch_operations(self: Self) -> "_2368.BatchOperations":
    ...
    @property
    def file_save_details_all(self: Self) -> "_1589.FileHistory":
    ...
    @property
    def file_save_details_most_recent(self: Self) -> "_1590.FileHistoryItem":
    ...
    @property
    def gear_set_design_group(self: Self) -> "_331.GearSetDesignGroup":
    ...
    @property
    def settings(self: Self) -> "_2212.DesignSettings":
    ...
    @property
    def system(self: Self) -> "_2229.SystemReporting":
    ...
    @property
    def system_optimiser_details(self: Self) -> "_2247.SystemOptimiserDetails":
    ...
    def bearing_detail_configurations(
        self: Self,
    ) -> "List[_2623.BearingDetailConfiguration]":
    ...
    def fe_substructure_configurations(
        self: Self,
    ) -> "List[_2620.ActiveFESubstructureSelectionGroup]":
    ...
    def gear_set_configurations(
        self: Self,
    ) -> "List[_2519.ActiveGearSetDesignSelectionGroup]":
    ...
    def iso14179_settings_per_bearing_type(
        self: Self,
    ) -> "List[_1983.ISO14179SettingsPerBearingType]":
    ...
    def shaft_detail_configurations(
        self: Self,
    ) -> "List[_2622.ActiveShaftDesignSelectionGroup]":
    ...
    @property
    def databases(self: Self) -> "_2271.Databases":
    ...
    @property
    def design_states(self: Self) -> "List[_5671.DesignState]":
    ...
    @property
    def duty_cycles(self: Self) -> "List[_5672.DutyCycle]":
    ...
    @property
    def gear_set_config(self: Self) -> "_2540.GearSetConfiguration":
    ...
    @enforce_parameter_types
    def gear_set_config(self: Self, value: "_2540.GearSetConfiguration"):
        self.wrapped.GearSetConfig = value.wrapped

    @property
    def masta_settings(self: Self) -> "_2219.MASTASettings":
    ...
    @property
    def root_assembly(self: Self) -> "_2481.RootAssembly":
    ...
    @property
    def system_optimiser(self: Self) -> "_2246.SystemOptimiser":
    ...
    def time_series_load_case_groups(
        self: Self,
    ) -> "List[_5679.TimeSeriesLoadCaseGroup]":
    ...
    @enforce_parameter_types
    def add_duty_cycle(self: Self, name: "str" = "New Duty Cycle") -> "_5672.DutyCycle":
    ...
    def add_synchroniser_shift_empty(self: Self) -> "_2990.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: Self, name: "str") -> "_2990.SynchroniserShift":
        """mastapy.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: Self, name: "str") -> "_5671.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: Self, name: "str") -> "_5672.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def remove_bearing_from_database(
        self: Self, rolling_bearing: "_2172.RollingBearing"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_synchroniser_shift(self: Self, shift: "_2990.SynchroniserShift"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def save(self: Self, file_name: "str", save_results: "bool") -> "_1800.Status":
        """mastapy.utility.model_validation.Status
    ...
    def save_load_case_results(
        self: Self, file_name: "str", load_cases: "List[_6812.LoadCase]"
    ):
        """Method does not return.
    ...
    def all_parts(self: Self) -> "List[_2475.Part]":
    ...
    def all_parts_of_type_assembly(self: Self) -> "List[_2440.Assembly]":
    ...
    def all_parts_of_type_abstract_shaft(self: Self) -> "List[_2442.AbstractShaft]":
    ...
    def all_parts_of_type_abstract_shaft_or_housing(
        self: Self,
    ) -> "List[_2443.AbstractShaftOrHousing]":
    ...
    def all_parts_of_type_fe_part(self: Self) -> "List[_2460.FEPart]":
    ...
    def all_parts_of_type_flexible_pin_assembly(
        self: Self,
    ) -> "List[_2461.FlexiblePinAssembly]":
    ...
    def all_parts_of_type_guide_dxf_model(self: Self) -> "List[_2462.GuideDxfModel]":
    ...
    def all_parts_of_type_mass_disc(self: Self) -> "List[_2469.MassDisc]":
    ...
    def all_parts_of_type_measurement_component(
        self: Self,
    ) -> "List[_2470.MeasurementComponent]":
    ...
    def all_parts_of_type_oil_seal(self: Self) -> "List[_2473.OilSeal]":
        """List[mastapy.system_model.part_model.OilSeal]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "OilSeal")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_planet_carrier(self: Self) -> "List[_2476.PlanetCarrier]":
    ...
    def all_parts_of_type_specialised_assembly(
        self: Self,
    ) -> "List[_2483.SpecialisedAssembly]":
    ...
    def all_parts_of_type_unbalanced_mass(self: Self) -> "List[_2484.UnbalancedMass]":
    ...
    def all_parts_of_type_shaft(self: Self) -> "List[_2489.Shaft]":
    ...
    def all_parts_of_type_agma_gleason_conical_gear(
        self: Self,
    ) -> "List[_2520.AGMAGleasonConicalGear]":
    ...
    def all_parts_of_type_agma_gleason_conical_gear_set(
        self: Self,
    ) -> "List[_2521.AGMAGleasonConicalGearSet]":
    ...
    def all_parts_of_type_bevel_differential_gear(
        self: Self,
    ) -> "List[_2522.BevelDifferentialGear]":
    ...
    def all_parts_of_type_bevel_differential_gear_set(
        self: Self,
    ) -> "List[_2523.BevelDifferentialGearSet]":
    ...
    def all_parts_of_type_bevel_differential_planet_gear(
        self: Self,
    ) -> "List[_2524.BevelDifferentialPlanetGear]":
    ...
    def all_parts_of_type_bevel_differential_sun_gear(
        self: Self,
    ) -> "List[_2525.BevelDifferentialSunGear]":
    ...
    def all_parts_of_type_bevel_gear(self: Self) -> "List[_2526.BevelGear]":
    ...
    def all_parts_of_type_bevel_gear_set(self: Self) -> "List[_2527.BevelGearSet]":
    ...
    def all_parts_of_type_concept_gear(self: Self) -> "List[_2528.ConceptGear]":
    ...
    def all_parts_of_type_concept_gear_set(self: Self) -> "List[_2529.ConceptGearSet]":
    ...
    def all_parts_of_type_conical_gear(self: Self) -> "List[_2530.ConicalGear]":
    ...
    def all_parts_of_type_conical_gear_set(self: Self) -> "List[_2531.ConicalGearSet]":
    ...
    def all_parts_of_type_cylindrical_gear(self: Self) -> "List[_2532.CylindricalGear]":
    ...
    def all_parts_of_type_cylindrical_planet_gear(
        self: Self,
    ) -> "List[_2534.CylindricalPlanetGear]":
    ...
    def all_parts_of_type_face_gear(self: Self) -> "List[_2535.FaceGear]":
    ...
    def all_parts_of_type_face_gear_set(self: Self) -> "List[_2536.FaceGearSet]":
    ...
    def all_parts_of_type_gear(self: Self) -> "List[_2537.Gear]":
    ...
    def all_parts_of_type_gear_set(self: Self) -> "List[_2539.GearSet]":
    ...
    def all_parts_of_type_hypoid_gear(self: Self) -> "List[_2541.HypoidGear]":
    ...
    def all_parts_of_type_hypoid_gear_set(self: Self) -> "List[_2542.HypoidGearSet]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear(
        self: Self,
    ) -> "List[_2543.KlingelnbergCycloPalloidConicalGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear_set(
        self: Self,
    ) -> "List[_2544.KlingelnbergCycloPalloidConicalGearSet]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(
        self: Self,
    ) -> "List[_2546.KlingelnbergCycloPalloidHypoidGearSet]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(
        self: Self,
    ) -> "List[_2548.KlingelnbergCycloPalloidSpiralBevelGearSet]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear(
        self: Self,
    ) -> "List[_2552.StraightBevelDiffGear]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear_set(
        self: Self,
    ) -> "List[_2553.StraightBevelDiffGearSet]":
    ...
    def all_parts_of_type_straight_bevel_gear_set(
        self: Self,
    ) -> "List[_2555.StraightBevelGearSet]":
    ...
    def all_parts_of_type_straight_bevel_planet_gear(
        self: Self,
    ) -> "List[_2556.StraightBevelPlanetGear]":
    ...
    def all_parts_of_type_straight_bevel_sun_gear(
        self: Self,
    ) -> "List[_2557.StraightBevelSunGear]":
    ...
    def all_parts_of_type_worm_gear(self: Self) -> "List[_2558.WormGear]":
    ...
    def all_parts_of_type_worm_gear_set(self: Self) -> "List[_2559.WormGearSet]":
    ...
    def all_parts_of_type_zerol_bevel_gear(self: Self) -> "List[_2560.ZerolBevelGear]":
    ...
    def all_parts_of_type_cycloidal_disc(self: Self) -> "List[_2576.CycloidalDisc]":
    ...
    def all_parts_of_type_ring_pins(self: Self) -> "List[_2577.RingPins]":
    ...
    def all_parts_of_type_belt_drive(self: Self) -> "List[_2583.BeltDrive]":
    ...
    def all_parts_of_type_clutch(self: Self) -> "List[_2585.Clutch]":
    ...
    def all_parts_of_type_clutch_half(self: Self) -> "List[_2586.ClutchHalf]":
    ...
    def all_parts_of_type_concept_coupling(self: Self) -> "List[_2588.ConceptCoupling]":
    ...
    def all_parts_of_type_concept_coupling_half(
        self: Self,
    ) -> "List[_2589.ConceptCouplingHalf]":
    ...
    def all_parts_of_type_coupling(self: Self) -> "List[_2591.Coupling]":
    ...
    def all_parts_of_type_coupling_half(self: Self) -> "List[_2592.CouplingHalf]":
    ...
    def all_parts_of_type_cvt(self: Self) -> "List[_2594.CVT]":
    ...
    def all_parts_of_type_cvt_pulley(self: Self) -> "List[_2595.CVTPulley]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling(
        self: Self,
    ) -> "List[_2596.PartToPartShearCoupling]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling_half(
        self: Self,
    ) -> "List[_2597.PartToPartShearCouplingHalf]":
    ...
    def all_parts_of_type_pulley(self: Self) -> "List[_2598.Pulley]":
    ...
    def all_parts_of_type_rolling_ring(self: Self) -> "List[_2604.RollingRing]":
    ...
    def all_parts_of_type_rolling_ring_assembly(
        self: Self,
    ) -> "List[_2605.RollingRingAssembly]":
    ...
    def all_parts_of_type_spring_damper(self: Self) -> "List[_2608.SpringDamper]":
    ...
    def all_parts_of_type_synchroniser(self: Self) -> "List[_2610.Synchroniser]":
    ...
    def all_parts_of_type_torque_converter(self: Self) -> "List[_2615.TorqueConverter]":
    ...
    def all_parts_of_type_torque_converter_pump(
        self: Self,
    ) -> "List[_2616.TorqueConverterPump]":
    ...
    def all_parts_of_type_torque_converter_turbine(
        self: Self,
    ) -> "List[_2618.TorqueConverterTurbine]":
    ...
    def load(
        file_path: "str",
        load_full_fe_option: "_1588.ExternalFullFEFileOption" = _1588.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS,
    ) -> "Design":
        """mastapy.system_model.Design
