...
if TYPE_CHECKING:
    from mastapy.gears.cylindrical import _1215
...
class GearLTCAContactCharts(_0.APIBase):
    ...
    _CastSelf = TypeVar("_CastSelf", bound="_Cast_GearLTCAContactCharts")

    class _Cast_GearLTCAContactCharts:
        """Special nested class for casting GearLTCAContactCharts to subclasses."""

        def __init__(
            self: "GearLTCAContactCharts._Cast_GearLTCAContactCharts",
            parent: "GearLTCAContactCharts",
        ):
            self._parent = parent
        ...
        def cylindrical_gear_ltca_contact_charts(
            ...
            return self._parent._cast(_1215.CylindricalGearLTCAContactCharts)
        ...
        def __getattr__(
            self: "GearLTCAContactCharts._Cast_GearLTCAContactCharts", name: str
        ):
            try:
    ...
    def __init__(self: Self, instance_to_wrap: "GearLTCAContactCharts.TYPE"):
    ...
    @property
    def cast_to(self: Self) -> "GearLTCAContactCharts._Cast_GearLTCAContactCharts":
        return self._Cast_GearLTCAContactCharts(self)
