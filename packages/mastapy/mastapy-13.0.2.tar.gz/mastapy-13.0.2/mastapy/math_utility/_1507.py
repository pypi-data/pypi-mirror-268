...
if TYPE_CHECKING:
    from mastapy.math_utility import _1508, _1509, _1535, _1506
...
class CoordinateSystemEditor(_0.APIBase):
    ...
    def coordinate_system_for_rotation_axes(
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1508", "CoordinateSystemForRotation"
        )(value)

    @coordinate_system_for_rotation_axes.setter
    @enforce_parameter_types
    def coordinate_system_for_rotation_axes(
        self: Self, value: "_1508.CoordinateSystemForRotation"
    ):
    ...
    def coordinate_system_for_rotation_origin(
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1509", "CoordinateSystemForRotationOrigin"
        )(value)

    @coordinate_system_for_rotation_origin.setter
    @enforce_parameter_types
    def coordinate_system_for_rotation_origin(
        self: Self, value: "_1509.CoordinateSystemForRotationOrigin"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def rotation_axis(self: Self) -> "_1535.RotationAxis":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1535", "RotationAxis"
        )(value)

    @rotation_axis.setter
    @enforce_parameter_types
    def rotation_axis(self: Self, value: "_1535.RotationAxis"):
