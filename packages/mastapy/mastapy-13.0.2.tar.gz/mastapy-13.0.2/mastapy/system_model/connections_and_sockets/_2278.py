...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.connections_and_sockets import _2277, _2282, _2284
...
class ComponentMeasurer(_0.APIBase):
    ...
    class _Cast_ComponentMeasurer:
        ...
        def component_connection(
            ...
            return self._parent._cast(_2277.ComponentConnection)
        ...
        def datum_measurement(
            ...
            return self._parent._cast(_2284.DatumMeasurement)
    ...
    @property
    def component(self: Self) -> "_2451.Component":
