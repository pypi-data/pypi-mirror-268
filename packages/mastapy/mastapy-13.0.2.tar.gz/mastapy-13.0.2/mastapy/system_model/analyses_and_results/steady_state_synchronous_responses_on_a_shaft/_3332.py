...
class PartSteadyStateSynchronousResponseOnAShaft(_7556.PartStaticLoadAnalysisCase):
    """PartSteadyStateSynchronousResponseOnAShaft
    ...
    def create_viewable(self: Self) -> "_2265.SteadyStateSynchronousResponseViewable":
