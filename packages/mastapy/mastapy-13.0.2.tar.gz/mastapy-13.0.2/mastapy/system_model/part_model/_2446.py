...
from mastapy.bearings.bearing_results import _1949, _1968
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1880, _1893, _1876
...
class Bearing(_2454.Connector):
    ...
    class _Cast_Bearing:
        ...
        @property
        def connector(self: "Bearing._Cast_Bearing") -> "_2454.Connector":
        ...
        @property
        def component(self: "Bearing._Cast_Bearing") -> "_2451.Component":
            from mastapy.system_model.part_model import _2451

            return self._parent._cast(_2451.Component)

        @property
        def part(self: "Bearing._Cast_Bearing") -> "_2475.Part":
            from mastapy.system_model.part_model import _2475

            return self._parent._cast(_2475.Part)

        @property
        def design_entity(self: "Bearing._Cast_Bearing") -> "_2210.DesignEntity":
            from mastapy.system_model import _2210
    ...
    @enforce_parameter_types
    def bearing_tolerance_class(self: Self, value: "_1910.BearingToleranceClass"):
    ...
    def bearing_tolerance_definition(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1911", "BearingToleranceDefinitionOptions"
        )(value)

    @bearing_tolerance_definition.setter
    @enforce_parameter_types
    def bearing_tolerance_definition(
        self: Self, value: "_1911.BearingToleranceDefinitionOptions"
    ):
    ...
    @property
    def damping_options(self: Self) -> "_1880.BearingDampingMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1880", "BearingDampingMatrixOption"
        )(value)

    @damping_options.setter
    @enforce_parameter_types
    def damping_options(self: Self, value: "_1880.BearingDampingMatrixOption"):
        value = conversion.mp_to_pn_enum(
    ...
    def efficiency_rating_method(
        self: Self,
        value: "Union[_295.BearingEfficiencyRatingMethod, Tuple[_295.BearingEfficiencyRatingMethod, bool]]",
    ):
        wrapper_type = (
    ...
    def force_at_zero_displacement_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2447", "BearingF0InputMethod"
        )(value)

    @force_at_zero_displacement_input_method.setter
    @enforce_parameter_types
    def force_at_zero_displacement_input_method(
        self: Self, value: "_2447.BearingF0InputMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_fitting_chart(self: Self) -> "_1793.SimpleChartDefinition":
    ...
    @property
    def journal_bearing_type(self: Self) -> "_1893.JournalBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1893", "JournalBearingType"
        )(value)

    @journal_bearing_type.setter
    @enforce_parameter_types
    def journal_bearing_type(self: Self, value: "_1893.JournalBearingType"):
        value = conversion.mp_to_pn_enum(
    ...
    @model.setter
    @enforce_parameter_types
    def model(self: Self, value: "_1884.BearingModel"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def outer_fitting_chart(self: Self) -> "_1793.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    def permissible_axial_load_calculation_method(
        self: Self,
        value: "Union[_1949.CylindricalRollerMaxAxialLoadMethod, Tuple[_1949.CylindricalRollerMaxAxialLoadMethod, bool]]",
    ):
        wrapper_type = (
    ...
    @preload.setter
    @enforce_parameter_types
    def preload(self: Self, value: "_1968.PreloadType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def detail(self: Self) -> "_2137.BearingDesign":
    ...
    @property
    def friction_coefficients(self: Self) -> "_2077.RollingBearingFrictionCoefficients":
    ...
    @property
    def inner_support_detail(self: Self) -> "_1927.SupportDetail":
    ...
    @property
    def left_support_detail(self: Self) -> "_1927.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def outer_support_detail(self: Self) -> "_1927.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def overridden_lubrication_detail(self: Self) -> "_270.LubricationDetail":
    ...
    @property
    def right_support_detail(self: Self) -> "_1927.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def ring_tolerance_inner(self: Self) -> "_1913.InnerRingTolerance":
    ...
    @property
    def ring_tolerance_left(self: Self) -> "_1924.RingTolerance":
    ...
    @property
    def ring_tolerance_outer(self: Self) -> "_1919.OuterRingTolerance":
    ...
    @property
    def ring_tolerance_right(self: Self) -> "_1924.RingTolerance":
        """mastapy.bearings.tolerances.RingTolerance
    ...
    @property
    def simple_bearing_detail_property(self: Self) -> "_2137.BearingDesign":
        """mastapy.bearings.bearing_designs.BearingDesign
    ...
    @property
    def support_tolerance_inner(self: Self) -> "_1914.InnerSupportTolerance":
        """mastapy.bearings.tolerances.InnerSupportTolerance
    ...
    @property
    def support_tolerance_left(self: Self) -> "_1929.SupportTolerance":
    ...
    @property
    def support_tolerance_outer(self: Self) -> "_1920.OuterSupportTolerance":
        """mastapy.bearings.tolerances.OuterSupportTolerance
    ...
    @property
    def support_tolerance_right(self: Self) -> "_1929.SupportTolerance":
        """mastapy.bearings.tolerances.SupportTolerance
    ...
    @property
    def tolerance_combinations(self: Self) -> "List[_1931.ToleranceCombination]":
    ...
    def set_detail_from_catalogue(
        self: Self, catalogue: "_1876.BearingCatalog", designation: "str"
    ):
