...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2526, _2521, _2531, _2539
...
class BevelDifferentialGearSet(_2527.BevelGearSet):
    """BevelDifferentialGearSet
    ...
    @property
    def conical_gear_set_design(self: Self) -> "_1188.BevelGearSetDesign":
    ...
    @property
    def bevel_gear_set_design(self: Self) -> "_1188.BevelGearSetDesign":
        """mastapy.gears.gear_designs.bevel.BevelGearSetDesign
    ...
    @property
    def bevel_gears(self: Self) -> "List[_2526.BevelGear]":
    ...
    @property
    def bevel_meshes(self: Self) -> "List[_2310.BevelGearMesh]":
