...
class ListWithSelectedItem_FELink(_2425.FELink, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2425.FELink.TYPE":
        ...
        return _2425.FELink.TYPE

    @property
    def selected_value(self: Self) -> "_2425.FELink":
    ...
    @property
    def available_values(self: Self) -> "List[_2425.FELink]":
