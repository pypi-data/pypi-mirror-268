...
class ListWithSelectedItem_DutyCycle(_5672.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_5672.DutyCycle.TYPE":
        ...
        return _5672.DutyCycle.TYPE

    @property
    def selected_value(self: Self) -> "_5672.DutyCycle":
    ...
    @property
    def available_values(self: Self) -> "List[_5672.DutyCycle]":
