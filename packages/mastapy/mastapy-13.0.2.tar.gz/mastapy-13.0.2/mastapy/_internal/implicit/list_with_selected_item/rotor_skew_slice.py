...
class ListWithSelectedItem_RotorSkewSlice(
    _1302.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1302.RotorSkewSlice.TYPE":
        ...
        return _1302.RotorSkewSlice.TYPE

    @property
    def selected_value(self: Self) -> "_1302.RotorSkewSlice":
    ...
    @property
    def available_values(self: Self) -> "List[_1302.RotorSkewSlice]":
