...
class ListWithSelectedItem_CylindricalGearSet(
    _2533.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    def __init__(
        self, instance_to_wrap: "ListWithSelectedItem_CylindricalGearSet.TYPE"
    ):
        try:
    ...
    @classmethod
    def implicit_type(cls) -> "_2533.CylindricalGearSet.TYPE":
        ...
        return _2533.CylindricalGearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2533.CylindricalGearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2533.CylindricalGearSet]":
