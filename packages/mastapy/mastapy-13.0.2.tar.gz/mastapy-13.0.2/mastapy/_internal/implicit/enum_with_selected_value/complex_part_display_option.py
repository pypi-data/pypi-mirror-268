...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1502.ComplexPartDisplayOption":
        ...
        return _1502.ComplexPartDisplayOption

    @classmethod
    def implicit_type(cls) -> "_1502.ComplexPartDisplayOption.type_()":
        ...
        return _1502.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: Self) -> "_1502.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1502.ComplexPartDisplayOption]":
