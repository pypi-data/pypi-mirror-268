...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2603.RigidConnectorTypes":
        ...
        return _2603.RigidConnectorTypes

    @classmethod
    def implicit_type(cls) -> "_2603.RigidConnectorTypes.type_()":
        ...
        return _2603.RigidConnectorTypes.type_()

    @property
    def selected_value(self: Self) -> "_2603.RigidConnectorTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_2603.RigidConnectorTypes]":
