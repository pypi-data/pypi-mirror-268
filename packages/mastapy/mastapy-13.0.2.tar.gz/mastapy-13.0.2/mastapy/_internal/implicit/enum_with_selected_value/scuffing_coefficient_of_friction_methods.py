...
class EnumWithSelectedValue_ScuffingCoefficientOfFrictionMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1077.ScuffingCoefficientOfFrictionMethods":
        ...
        return _1077.ScuffingCoefficientOfFrictionMethods

    @classmethod
    def implicit_type(cls) -> "_1077.ScuffingCoefficientOfFrictionMethods.type_()":
        ...
        return _1077.ScuffingCoefficientOfFrictionMethods.type_()

    @property
    def selected_value(self: Self) -> "_1077.ScuffingCoefficientOfFrictionMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1077.ScuffingCoefficientOfFrictionMethods]":
