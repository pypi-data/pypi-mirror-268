...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1902.RollingBearingRaceType":
        ...
        return _1902.RollingBearingRaceType

    @classmethod
    def implicit_type(cls) -> "_1902.RollingBearingRaceType.type_()":
        ...
        return _1902.RollingBearingRaceType.type_()

    @property
    def selected_value(self: Self) -> "_1902.RollingBearingRaceType":
    ...
    @property
    def available_values(self: Self) -> "List[_1902.RollingBearingRaceType]":
