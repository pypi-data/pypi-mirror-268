...
from mastapy.gears.cylindrical import _1219
...
class CylindricalGearLTCAContactCharts(_1219.GearLTCAContactCharts):
    """CylindricalGearLTCAContactCharts
    ...
    _CastSelf = TypeVar("_CastSelf", bound="_Cast_CylindricalGearLTCAContactCharts")
    ...
    class _Cast_CylindricalGearLTCAContactCharts:
        ...
        def __init__(
            self: "CylindricalGearLTCAContactCharts._Cast_CylindricalGearLTCAContactCharts",
            parent: "CylindricalGearLTCAContactCharts",
        ):
            self._parent = parent

        @property
        def gear_ltca_contact_charts(
            self: "CylindricalGearLTCAContactCharts._Cast_CylindricalGearLTCAContactCharts",
        ) -> "_1219.GearLTCAContactCharts":
            return self._parent._cast(_1219.GearLTCAContactCharts)
    ...
    def __init__(self: Self, instance_to_wrap: "CylindricalGearLTCAContactCharts.TYPE"):
    ...
    def cast_to(
        self: Self,
    ) -> "CylindricalGearLTCAContactCharts._Cast_CylindricalGearLTCAContactCharts":
        return self._Cast_CylindricalGearLTCAContactCharts(self)
