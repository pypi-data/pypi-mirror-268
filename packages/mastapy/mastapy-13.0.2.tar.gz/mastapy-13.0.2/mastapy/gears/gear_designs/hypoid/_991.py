...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.hypoid import _989, _990
...
class HypoidGearSetDesign(_1201.AGMAGleasonConicalGearSetDesign):
    """HypoidGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_989.HypoidGearDesign]":
    ...
    @property
    def meshes(self: Self) -> "List[_990.HypoidGearMeshDesign]":
    ...
    @property
    def hypoid_meshes(self: Self) -> "List[_990.HypoidGearMeshDesign]":
        """List[mastapy.gears.gear_designs.hypoid.HypoidGearMeshDesign]
