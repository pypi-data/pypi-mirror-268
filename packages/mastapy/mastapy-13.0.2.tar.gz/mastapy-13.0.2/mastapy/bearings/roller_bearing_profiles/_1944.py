...
if TYPE_CHECKING:
    from mastapy.bearings.roller_bearing_profiles import _1934, _1936, _1946
...
class RollerBearingUserSpecifiedProfile(_1943.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    @property
    def data_to_use(self: Self) -> "_1934.ProfileDataToUse":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.roller_bearing_profiles._1934", "ProfileDataToUse"
        )(value)

    @data_to_use.setter
    @enforce_parameter_types
    def data_to_use(self: Self, value: "_1934.ProfileDataToUse"):
    ...
    @property
    def profile_to_fit(self: Self) -> "_1936.ProfileToFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.roller_bearing_profiles._1936", "ProfileToFit"
        )(value)

    @profile_to_fit.setter
    @enforce_parameter_types
    def profile_to_fit(self: Self, value: "_1936.ProfileToFit"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def points(self: Self) -> "List[_1946.UserSpecifiedProfilePoint]":
