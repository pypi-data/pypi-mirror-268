...
class GetConnectionsPaginator(Paginator):
    ...
    ) -> _PageIterator[GetConnectionsResponsePaginatorTypeDef]:
        """
...
class GetDatabasesPaginator(Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...,
    ) -> _PageIterator[GetDatabasesResponsePaginatorTypeDef]:
        """
...
class GetPartitionIndexesPaginator(Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        CatalogId: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...,
    ) -> _PageIterator[GetPartitionIndexesResponsePaginatorTypeDef]:
        """
...
class GetPartitionsPaginator(Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...,
    ) -> _PageIterator[GetPartitionsResponsePaginatorTypeDef]:
        """
...
class GetSecurityConfigurationsPaginator(Paginator):
    ...
    def paginate(
        self, *, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> _PageIterator[GetSecurityConfigurationsResponsePaginatorTypeDef]:
        """
