...
class TableComputeOp(_message.Message):
    __slots__ = ("empty", "select_from_staging", "rename_columns", "join", "select_columns", "limit_rows", "order_by", "filter_rows", "distinct_rows", "update_metadata", "set_metadata", "remove_from_metadata", "update_feature_types", "rollup_by_aggregation", "embed_node2vec_from_edge_lists", "embedding_metrics", "embedding_coordinates")
...
class SelectFromStagingOp(_message.Message):
    __slots__ = ("blob_names", "columns", "expected_rows", "arrow_schema", "feature_types")
    ...
    def __init__(self, blob_names: _Optional[_Iterable[str]] = ..., columns: _Optional[_Iterable[str]] = ..., expected_rows: _Optional[int] = ..., arrow_schema: _Optional[bytes] = ..., feature_types: _Optional[_Iterable[_Union[FeatureType, _Mapping]]] = ...) -> None: ...
...
class EmbeddingMetricsOp(_message.Message):
    ...
    TABLE_FIELD_NUMBER: _ClassVar[int]
    table: TableComputeOp
    def __init__(self, table: _Optional[_Union[TableComputeOp, _Mapping]] = ...) -> None: ...
...
class ExecuteRequest(_message.Message):
    __slots__ = ("table", "output_url_prefix")
    TABLE_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_URL_PREFIX_FIELD_NUMBER: _ClassVar[int]
    table: TableComputeOp
    output_url_prefix: str
    def __init__(self, table: _Optional[_Union[TableComputeOp, _Mapping]] = ..., output_url_prefix: _Optional[str] = ...) -> None: ...

class ExecuteResponse(_message.Message):
    __slots__ = ("output_urls",)
    OUTPUT_URLS_FIELD_NUMBER: _ClassVar[int]
    output_urls: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, output_urls: _Optional[_Iterable[str]] = ...) -> None: ...
