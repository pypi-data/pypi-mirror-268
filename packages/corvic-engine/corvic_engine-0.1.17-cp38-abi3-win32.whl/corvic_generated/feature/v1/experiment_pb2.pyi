...
class EmbeddingMetrics(_message.Message):
    __slots__ = ("ne_sum", "condition_number", "stable_rank")
    ...
    stable_rank: float
    def __init__(self, ne_sum: _Optional[float] = ..., condition_number: _Optional[float] = ..., stable_rank: _Optional[float] = ...) -> None: ...
...
class EmbeddingRowData(_message.Message):
    __slots__ = ("row_ids", "embedding")
    ROW_IDS_FIELD_NUMBER: _ClassVar[int]
    EMBEDDING_FIELD_NUMBER: _ClassVar[int]
    row_ids: _struct_pb2.Struct
    embedding: _containers.RepeatedScalarFieldContainer[float]
    def __init__(self, row_ids: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., embedding: _Optional[_Iterable[float]] = ...) -> None: ...
...
class GetExperimentVisualizationResponse(_message.Message):
    ...
    def __init__(self, coordinates: _Optional[_Union[EmbeddingTableData, _Mapping]] = ...) -> None: ...
