...
from libcomcat.search import count, get_authoritative_info, search
from libcomcat.utils import CombinedFormatter, maketime
...
def get_parser():
    ...
    parser.add_argument(
        ...
        nargs=3,
        help=(
            "Search radius in kilometers (radius and bounding options "
