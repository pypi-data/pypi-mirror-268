...
class itkSimilarity2DTransformD(itk.itkRigid2DTransformPython.itkRigid2DTransformD):
    r"""Proxy of C++ itkSimilarity2DTransformD class."""
    ...
    @staticmethod
    def __New_orig__():
        r"""__New_orig__() -> itkSimilarity2DTransformD_Pointer"""
        return _itkSimilarity2DTransformPython.itkSimilarity2DTransformD___New_orig__()

    def Clone(self):
        r"""Clone(self) -> itkSimilarity2DTransformD_Pointer"""
    ...
    def CloneInverseTo(self, result):
        ...
        Parameters
        ----------
        result: itkSimilarity2DTransformD_Pointer &

        """
        return _itkSimilarity2DTransformPython.itkSimilarity2DTransformD_CloneInverseTo(self, result)
    ...
    def GetInverse(self, inverse):
        ...
        Parameters
        ----------
        inverse: itkSimilarity2DTransformD *
    ...
    def CloneTo(self, result):
        ...
        """
        return _itkSimilarity2DTransformPython.itkSimilarity2DTransformD_CloneTo(self, result)
    ...
    def cast(obj):
        r"""
        cast(obj) -> itkSimilarity2DTransformD
