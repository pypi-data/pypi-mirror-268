...
class itkMetaDataObjectBase(itkLightObject):
    ...
    def GetMetaDataObjectTypeInfo(self):
        r"""GetMetaDataObjectTypeInfo(self) -> type_info const &"""
...
class itkProcessObject(itkObject):
    ...
    def GetNumberOfIndexedOutputs(self):
        r"""GetNumberOfIndexedOutputs(self) -> unsigned long long"""
...
class itkProgressReporter(object):
    ...
    def __init__(self, filter, threadId, numberOfPixels, numberOfUpdates=100, initialProgress=0., progressWeight=1.):
        ...
        filter: itkProcessObject *
        threadId: unsigned int
        numberOfPixels: unsigned long long
        numberOfUpdates: unsigned long long
...
class itkDirectory(itkObject):
    ...
    def GetNumberOfFiles(self):
        r"""GetNumberOfFiles(self) -> unsigned long long"""
...
class itkImageIORegion(itkRegion):
    ...
    def GetModifiableIndex(self):
        r"""GetModifiableIndex(self) -> std::vector< long long,std::allocator< long long > > &"""
        return _ITKCommonBasePython.itkImageIORegion_GetModifiableIndex(self)

    def GetModifiableSize(self):
        r"""GetModifiableSize(self) -> std::vector< unsigned long long,std::allocator< unsigned long long > > &"""
        return _ITKCommonBasePython.itkImageIORegion_GetModifiableSize(self)

    def GetSize(self, *args):
        r"""
        GetSize(self) -> std::vector< unsigned long long,std::allocator< unsigned long long > > const
        GetSize(self, i) -> unsigned long long
    ...
    def GetIndex(self, *args):
        r"""
        GetIndex(self) -> std::vector< long long,std::allocator< long long > > const
        GetIndex(self, i) -> long long
    ...
    def SetSize(self, *args):
        ...
        Parameters
        ----------
        size: std::vector< unsigned long long,std::allocator< unsigned long long > > const &

        SetSize(self, i, size)

        Parameters
        ----------
        i: unsigned long const
    ...
    def SetIndex(self, *args):
        ...
        Parameters
        ----------
        index: std::vector< long long,std::allocator< long long > > const &
    ...
    def GetNumberOfPixels(self):
        r"""GetNumberOfPixels(self) -> unsigned long long"""
...
class itkMersenneTwisterRandomVariateGenerator(itkRandomVariateGeneratorBase):
    ...
    def SetSeed(self, *args):
        r"""
        SetSeed(self, oneSeed)

        Parameters
        ----------
        oneSeed: unsigned int const
...
class itkMeshRegion(itkRegion):
    ...
    def GetNumberOfRegions(self):
        r"""GetNumberOfRegions(self) -> unsigned long long"""
    ...
    def GetRegion(self):
        r"""GetRegion(self) -> unsigned long long"""
