...
class itkHistogramD(itk.itkSamplePython.itkSampleAD):
    ...
    def GetInstanceIdentifier(self, index):
        r"""
        GetInstanceIdentifier(self, index) -> unsigned long long
    ...
    def GetSize(self, *args):
        r"""
        GetSize(self) -> itkArrayULL
        GetSize(self, dimension) -> unsigned long long
    ...
    def GetFrequency(self, *args):
        ...
        GetFrequency(self, index) -> unsigned long long

        Parameters
        ----------
        index: itkArraySLL const &

        GetFrequency(self, n, dimension) -> unsigned long long
