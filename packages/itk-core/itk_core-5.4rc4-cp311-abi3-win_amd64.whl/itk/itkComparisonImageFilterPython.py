...
class itkComparisonImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    def GetNumberOfPixelsWithDifferences(self):
        r"""GetNumberOfPixelsWithDifferences(self) -> unsigned long long"""
...
def comparison_image_filter(*args: itkt.ImageLike,  valid_input: itkt.Image=..., test_input: itkt.Image=..., verify_input_information: bool=..., tolerance_radius: int=..., difference_threshold: float=..., ignore_boundary_pixels: bool=...,**kwargs)-> itkt.ImageSourceReturn:
