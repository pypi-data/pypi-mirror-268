...
class itkHistogramToEntropyImageFilterHDID2_Superclass(itk.itkImageSourcePython.itkImageSourceID2):
    ...
    def SetFunctor(self, functor):
        ...
        Parameters
        ----------
        functor: itk::Function::HistogramEntropyFunction< unsigned long > const &
    ...
    def GetFunctor(self, *args):
        r"""
        GetFunctor(self) -> itk::Function::HistogramEntropyFunction< unsigned long >
        GetFunctor(self) -> itk::Function::HistogramEntropyFunction< unsigned long > const &
        """
...
class itkHistogramToEntropyImageFilterHDIF2_Superclass(itk.itkImageSourcePython.itkImageSourceIF2):
    ...
    def SetFunctor(self, functor):
        ...
        Parameters
        ----------
        functor: itk::Function::HistogramEntropyFunction< unsigned long,float > const &
    ...
    def GetFunctor(self, *args):
        r"""
        GetFunctor(self) -> itk::Function::HistogramEntropyFunction< unsigned long,float >
        GetFunctor(self) -> itk::Function::HistogramEntropyFunction< unsigned long,float > const &
        """
