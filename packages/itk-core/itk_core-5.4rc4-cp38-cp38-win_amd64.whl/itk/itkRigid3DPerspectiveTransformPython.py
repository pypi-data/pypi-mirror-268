...
class itkRigid3DPerspectiveTransformD(itk.itkTransformBasePython.itkTransformD32):
    ...
    @staticmethod
    def __New_orig__():
        r"""__New_orig__() -> itkRigid3DPerspectiveTransformD_Pointer"""
        return _itkRigid3DPerspectiveTransformPython.itkRigid3DPerspectiveTransformD___New_orig__()

    def Clone(self):
        r"""Clone(self) -> itkRigid3DPerspectiveTransformD_Pointer"""
    ...
    def SetFocalDistance(self, focalDistance):
        r"""
        SetFocalDistance(self, focalDistance)
    ...
    def GetFocalDistance(self):
        r"""GetFocalDistance(self) -> double"""
    ...
    def SetCenterOfRotation(self, _arg):
        r"""
        SetCenterOfRotation(self, _arg)
    ...
    def GetCenterOfRotation(self):
        r"""GetCenterOfRotation(self) -> itkPointD3"""
    ...
    def cast(obj):
        r"""
        cast(obj) -> itkRigid3DPerspectiveTransformD
