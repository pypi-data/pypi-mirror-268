...
class itkNormalVariateGenerator(itk.ITKCommonBasePython.itkRandomVariateGeneratorBase):
    r"""Proxy of C++ itkNormalVariateGenerator class."""
    ...
    def cast(obj):
        r"""
        cast(obj) -> itkNormalVariateGenerator
