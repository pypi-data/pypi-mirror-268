...
class itkEuler2DTransformD(itk.itkRigid2DTransformPython.itkRigid2DTransformD):
    r"""Proxy of C++ itkEuler2DTransformD class."""
    ...
    @staticmethod
    def __New_orig__():
        r"""__New_orig__() -> itkEuler2DTransformD_Pointer"""
        return _itkEuler2DTransformPython.itkEuler2DTransformD___New_orig__()

    def Clone(self):
        r"""Clone(self) -> itkEuler2DTransformD_Pointer"""
    ...
    def CloneInverseTo(self, result):
        ...
        Parameters
        ----------
        result: itkEuler2DTransformD_Pointer &

        """
        return _itkEuler2DTransformPython.itkEuler2DTransformD_CloneInverseTo(self, result)
    ...
    def CloneTo(self, result):
        ...
        """
        return _itkEuler2DTransformPython.itkEuler2DTransformD_CloneTo(self, result)

    def ComputeAngleFromMatrix(self):
        r"""ComputeAngleFromMatrix(self)"""
