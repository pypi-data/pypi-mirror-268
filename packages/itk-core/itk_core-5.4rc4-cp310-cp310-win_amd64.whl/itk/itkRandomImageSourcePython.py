...
def random_image_source(*args,  size: Sequence[int]=..., spacing: Sequence[float]=..., origin: Sequence[float]=..., direction=..., min: float=..., max: float=...,**kwargs)-> itkt.ImageSourceReturn:
