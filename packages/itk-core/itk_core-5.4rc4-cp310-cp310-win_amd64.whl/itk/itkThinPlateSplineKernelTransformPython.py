...
class itkThinPlateSplineKernelTransformD2(itk.itkKernelTransformPython.itkKernelTransformD2):
    ...
    @staticmethod
    def __New_orig__():
        r"""__New_orig__() -> itkThinPlateSplineKernelTransformD2_Pointer"""
        return _itkThinPlateSplineKernelTransformPython.itkThinPlateSplineKernelTransformD2___New_orig__()

    def Clone(self):
        r"""Clone(self) -> itkThinPlateSplineKernelTransformD2_Pointer"""
    ...
    def cast(obj):
        r"""
        cast(obj) -> itkThinPlateSplineKernelTransformD2
...
class itkThinPlateSplineKernelTransformD3(itk.itkKernelTransformPython.itkKernelTransformD3):
    ...
    @staticmethod
    def __New_orig__():
        r"""__New_orig__() -> itkThinPlateSplineKernelTransformD3_Pointer"""
        return _itkThinPlateSplineKernelTransformPython.itkThinPlateSplineKernelTransformD3___New_orig__()

    def Clone(self):
        r"""Clone(self) -> itkThinPlateSplineKernelTransformD3_Pointer"""
    ...
    def cast(obj):
        r"""
        cast(obj) -> itkThinPlateSplineKernelTransformD3
...
def itkThinPlateSplineKernelTransformD4_New():
    return itkThinPlateSplineKernelTransformD4.New()

class itkThinPlateSplineKernelTransformD4(itk.itkKernelTransformPython.itkKernelTransformD4):
    r"""Proxy of C++ itkThinPlateSplineKernelTransformD4 class."""
    ...
    @staticmethod
    def __New_orig__():
        r"""__New_orig__() -> itkThinPlateSplineKernelTransformD4_Pointer"""
        return _itkThinPlateSplineKernelTransformPython.itkThinPlateSplineKernelTransformD4___New_orig__()

    def Clone(self):
        r"""Clone(self) -> itkThinPlateSplineKernelTransformD4_Pointer"""
        return _itkThinPlateSplineKernelTransformPython.itkThinPlateSplineKernelTransformD4_Clone(self)
    __swig_destroy__ = _itkThinPlateSplineKernelTransformPython.delete_itkThinPlateSplineKernelTransformD4

    @staticmethod
    def cast(obj):
        r"""
        cast(obj) -> itkThinPlateSplineKernelTransformD4
        ...
        """
        return _itkThinPlateSplineKernelTransformPython.itkThinPlateSplineKernelTransformD4_cast(obj)

    def New(*args, **kargs):
        """New() -> itkThinPlateSplineKernelTransformD4

        Create a new object of the class itkThinPlateSplineKernelTransformD4 and set the input and the parameters if some
        named or non-named arguments are passed to that method.
        ...
        Ex:
          ...
          itkThinPlateSplineKernelTransformD4.New(reader, threshold=10)

        is (most of the time) equivalent to:

          obj = itkThinPlateSplineKernelTransformD4.New()
          obj.SetInput(0, reader.GetOutput())
          obj.SetThreshold(10)
        """
        obj = itkThinPlateSplineKernelTransformD4.__New_orig__()
        from itk.support import template_class
        template_class.New(obj, *args, **kargs)
        return obj
    New = staticmethod(New)
...
# Register itkThinPlateSplineKernelTransformD4 in _itkThinPlateSplineKernelTransformPython:
_itkThinPlateSplineKernelTransformPython.itkThinPlateSplineKernelTransformD4_swigregister(itkThinPlateSplineKernelTransformD4)
