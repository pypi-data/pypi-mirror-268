...
def expand_image_filter(*args: itkt.ImageLike,  interpolator: itkt.InterpolateImageFunction=..., expand_factors: Union[Sequence[int], int]=...,**kwargs)-> itkt.ImageSourceReturn:
