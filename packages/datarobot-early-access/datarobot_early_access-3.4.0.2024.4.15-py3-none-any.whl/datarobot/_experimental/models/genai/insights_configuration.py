...
sidecar_model_metric_metadata = t.Dict(
    {
        ...
        t.Key("target_column_type", optional=True): t.Or(t.String, t.Null),
...
class Insights(APIObject):
    ...
    @classmethod
    def get(cls, playground_id: str, with_aggregation_types_only: bool = False) -> Insights:
    ...
    def create(
        ...
        payload = {
            ...
            "insights_configuration": [config.__dict__ for config in insights_configuration],
