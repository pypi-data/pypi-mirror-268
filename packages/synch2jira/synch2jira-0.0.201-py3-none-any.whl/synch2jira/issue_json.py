...
class  IssueJSON():
    ...
    def json_to_issue(issue_data,json_data,state1,state2):
        ...
        #creator_data = fields["creator"] or {}
    ...
    def json_to_data_frame(file_data = config.json_issues_file ):
        ...
        issue_list = [IssueJSON.json_to_issue(issue_data,json_data,config.workflow_status1,config.workflow_status2) for issue_data in json_data]
