...
from syntrac_opentelemetry.instrumentation.langchain.task_wrapper import (
    task_wrapper,
    atask_wrapper,
)
from syntrac_opentelemetry.instrumentation.langchain.workflow_wrapper import (
    workflow_wrapper,
    aworkflow_wrapper,
)
...
WRAPPED_METHODS = [
    ...
    },
    {
        ...
        "kind": SyntracSpanKindValues.AGENT.value,
        "wrapper": workflow_wrapper,
    },
    {
        ...
        "kind": SyntracSpanKindValues.TOOL.value,
        "wrapper": task_wrapper,
    },
    {
        "package": "langchain.chains",
    ...
    {
        "package": "langchain_community.llms.ollama",
        "object": "Ollama",
        "method": "_generate",
        "span_name": "llm.generate",
        "wrapper": llm_wrapper,
