    ...
    def query_table(
        ...
        if self.generate_response:
            ...
            if generative_prompt:
                ...
                generative_prompt_to_use = f"Using only this list of strings: {result}, return the answer to this question: {query}. Don't reference yourself."
