...
def apply_expression(df, userExpression, selectedColumnNames, castDataType, addPrefix, addSuffix, sparkSession) -> DataFrame:
    return ProphecyDataFrame(df, sparkSession).apply_expression(userExpression, selectedColumnNames, castDataType, addPrefix, addSuffix, sparkSession)
