...
class TxFilterCls:
	...
	def fetch(self, slot=repcap.Slot.Default, txFilter=repcap.TxFilter.Default) -> List[float]:
		...
		Snippet: value: List[float] = driver.base.correction.ifEqualizer.trace.magnitude.uncorrected.slot.txFilter.fetch(slot = repcap.Slot.Default, txFilter = repcap.TxFilter.Default) \n
