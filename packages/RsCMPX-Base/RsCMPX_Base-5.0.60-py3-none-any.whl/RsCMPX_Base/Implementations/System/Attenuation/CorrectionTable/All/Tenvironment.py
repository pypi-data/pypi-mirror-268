...
class TenvironmentCls:
	...
	def delete(self) -> None:
		...
		Snippet: driver.system.attenuation.correctionTable.all.tenvironment.delete() \n
		Deletes all channel-specific correction tables. \n
		"""
		self._core.io.write(f'DELete:SYSTem:ATTenuation:CTABle:ALL:TENVironment')

	def delete_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: DELete:SYSTem:ATTenuation:CTABle:ALL[:TENVironment] \n
		Snippet: driver.system.attenuation.correctionTable.all.tenvironment.delete_with_opc() \n
		Deletes all channel-specific correction tables. \n
		...
		self._core.io.write_with_opc(f'DELete:SYSTem:ATTenuation:CTABle:ALL:TENVironment', opc_timeout_ms)
