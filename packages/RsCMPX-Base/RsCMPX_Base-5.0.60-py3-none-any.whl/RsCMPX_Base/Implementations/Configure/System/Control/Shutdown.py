...
class ShutdownCls:
	...
	def set(self) -> None:
		...
		Snippet: driver.configure.system.control.shutdown.set() \n
		Brings the instrument into the standby state. \n
		"""
		self._core.io.write(f'CONFigure:SYSTem:CONTrol:SHUTdown')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: [CONFigure]:SYSTem:CONTrol:SHUTdown \n
		Snippet: driver.configure.system.control.shutdown.set_with_opc() \n
		Brings the instrument into the standby state. \n
		...
		self._core.io.write_with_opc(f'CONFigure:SYSTem:CONTrol:SHUTdown', opc_timeout_ms)
