...
class ModelInterface:
    ...
    def train(self,
        ...
        if hyperparameters is not None:
            new_model_job_to_run.config.container_config.hyperparameters = hyperparameters
            new_model_job_to_run.config.container_config.hyperparameter_default_behavior = hyperparameter_default_behavior
