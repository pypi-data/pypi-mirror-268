...
from regscale.core.app.public.fedramp.reporting import log_error, log_event
from regscale.core.app.public.fedramp.resources import parse_backmatter
...
def post_SSP(api: Api, new_ssp: dict):
    ...
    new_ssp_id = ssp.create_new_ssp(api=api, return_id=True)
