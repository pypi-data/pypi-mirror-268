...
from regscale.integrations.commercial.stigv2 import stigv2
...
from regscale.integrations.commercial.aqua import aqua
from regscale.integrations.commercial.aws import aws
from regscale.integrations.commercial.azure import azure
from regscale.integrations.commercial.burp import burp
...
from regscale.integrations.commercial.gcp import gcp
from regscale.integrations.commercial.gitlab import gitlab
from regscale.integrations.commercial.jira import jira
from regscale.integrations.commercial.nexpose import nexpose
from regscale.integrations.commercial.okta import okta
from regscale.integrations.commercial.prisma import prisma
...
from regscale.integrations.commercial.sicura import sicura
from regscale.integrations.commercial.snyk import snyk
...
from regscale.integrations.commercial.xray import xray
...
def about_display():
    ...
    console.print("Pre-Requisite: Python 3.9, 3.10 or 3.11")
...
cli.add_command(stigv2)  # add STIGv2 support
