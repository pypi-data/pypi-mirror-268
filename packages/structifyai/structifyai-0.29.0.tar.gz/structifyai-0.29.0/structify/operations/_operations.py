...
def build_structure_run_request(*, dataset_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_structure_run_async_request(*, dataset_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_structure_wait_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class DocumentsOperations:
    ...
    def upload(  # pylint: disable=inconsistent-return-statements
        ...
        :paramtype path: str
        :keyword doctype: Known values are: "Text" and "Pdf". Required.
...
class StructureOperations:
    ...
    @overload
    def run(self, body: JSON, *, dataset_name: str, content_type: str = "application/json", **kwargs: Any) -> Any:
    ...
    @overload
    def run(self, body: IO[bytes], *, dataset_name: str, content_type: str = "application/json", **kwargs: Any) -> Any:
        """Structure an unstructured data source into the given dataset.
    ...
    def run(self, body: Union[JSON, IO[bytes]], *, dataset_name: str, **kwargs: Any) -> Any:
        """Structure an unstructured data source into the given dataset.
    ...
    @overload
    def run_async(self, body: JSON, *, dataset_name: str, content_type: str = "application/json", **kwargs: Any) -> Any:
    ...
    @overload
    def run_async(
        self, body: IO[bytes], *, dataset_name: str, content_type: str = "application/json", **kwargs: Any
    ) -> Any:
        """Structure an unstructured data source into the given dataset in an async fashion.
    ...
    def run_async(self, body: Union[JSON, IO[bytes]], *, dataset_name: str, **kwargs: Any) -> Any:
        """Structure an unstructured data source into the given dataset in an async fashion.
    ...
    @overload
    def wait(self, body: List[str], *, content_type: str = "application/json", **kwargs: Any) -> Any:
    ...
    @overload
    def wait(self, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> Any:
        """Wait for all specified async tasks to be completed.
    ...
    def wait(self, body: Union[List[str], IO[bytes]], **kwargs: Any) -> Any:
        """Wait for all specified async tasks to be completed.
        ...
        _request = build_structure_wait_request(
            content_type=content_type,
            json=_json,
            content=_content,
            headers=_headers,
