...
class StructureOperations:
    ...
    @overload
    async def run(self, body: JSON, *, dataset_name: str, content_type: str = "application/json", **kwargs: Any) -> Any:
    ...
    async def run(self, body: Union[JSON, IO[bytes]], *, dataset_name: str, **kwargs: Any) -> Any:
        """Structure an unstructured data source into the given dataset.
    ...
    @overload
    async def run_async(
        self, body: JSON, *, dataset_name: str, content_type: str = "application/json", **kwargs: Any
    ) -> Any:
    ...
    async def run_async(self, body: Union[JSON, IO[bytes]], *, dataset_name: str, **kwargs: Any) -> Any:
        """Structure an unstructured data source into the given dataset in an async fashion.
    ...
    @overload
    async def wait(self, body: List[str], *, content_type: str = "application/json", **kwargs: Any) -> Any:
    ...
    @overload
    async def wait(self, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> Any:
        """Wait for all specified async tasks to be completed.
    ...
    async def wait(self, body: Union[List[str], IO[bytes]], **kwargs: Any) -> Any:
        """Wait for all specified async tasks to be completed.
