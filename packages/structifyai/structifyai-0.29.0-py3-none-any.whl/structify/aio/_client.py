...
class Structify:  # pylint: disable=client-accepts-api-version-keyword
    """Structure all your unstructured data into one place.

    :ivar dataset: DatasetOperations operations
    :vartype dataset: structify.aio.operations.DatasetOperations
    :ivar documents: DocumentsOperations operations
    :vartype documents: structify.aio.operations.DocumentsOperations
    :ivar server: ServerOperations operations
    :vartype server: structify.aio.operations.ServerOperations
    :ivar source: SourceOperations operations
    :vartype source: structify.aio.operations.SourceOperations
    :ivar structure: StructureOperations operations
    :vartype structure: structify.aio.operations.StructureOperations
    :ivar user: UserOperations operations
    :vartype user: structify.aio.operations.UserOperations
    ...
    async def __aenter__(self) -> "Structify":
