...
def main():
    ...
    # dir = r'D:\Documente\Masina\Hyundai Ioniq\Consum\benzina'
    # all = os.listdir(dir)
    # for fl in all:
    #     # print(fl)
    #     date_str = fl[:10]
    ...
    #     # print(date_d)
    #     matches = [('type', 'benzina'), ('data', date_d)]
    #     ids = active_table.returnCellsWhere('id', matches)
    #     print('....', ids)
    #     if len(ids) == 1:
    #         id_i = ids[0]
    ...
    # inpFile = r"D:\Documente\Masina\Hyundai Ioniq\Consum\benzina\2023_08_12_104810_chitanta.jpg"
    # v = active_table.convertToBinaryData(inpFile)
    # active_table.changeCellContent('file', v, 'id', 521)
    # #todo upload in db the jpg files with benzina
