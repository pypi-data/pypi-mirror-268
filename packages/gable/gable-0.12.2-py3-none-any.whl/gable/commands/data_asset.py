...
def register_data_asset(
    ...
    if source_type in SCHEMA_SOURCE_TYPE_VALUES:
        ...
        response_pydantic, success, _status_code = register_pyspark_data_asset(
            ctx,
        ...
        response_pydantic, success, _status_code = register_typescript_data_asset(
            ctx,
            library,
            project_root,
            dry_run,
