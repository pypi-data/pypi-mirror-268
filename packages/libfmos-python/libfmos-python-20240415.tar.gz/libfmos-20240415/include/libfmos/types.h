...
#if !defined( _LIBFMOS_TYPES_H )
#define _LIBFMOS_TYPES_H
...
#define __USE_UNIX98
#define LIBFMOS_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBFMOS_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBFMOS_DEFINITION_UNIX98
#endif
...
#endif /* !defined( _LIBFMOS_TYPES_H ) */
