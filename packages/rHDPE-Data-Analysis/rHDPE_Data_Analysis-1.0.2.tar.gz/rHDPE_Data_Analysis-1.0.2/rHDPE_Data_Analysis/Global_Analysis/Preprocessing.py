...
def read_files_and_preprocess( directory, datasets_to_read, sample_mask ):
    ...
    dataset_names = ["FTIR", "DSC", "TGA", "Rheology", "TT", "Colour", "TLS", "FTIR2", "FTIR3", "TGA_SB", "SHM", "ESCR"]
    ...
    for n in dataset_names:
        ...
        if n == "FTIR2":
            ...
            df = pd.read_csv( directory + n + "/Output/Features/Mean_Features.csv" )
    ...
    for n in dataset_names:
        ...
        if n == "FTIR2":
            ...
            df = pd.read_csv( directory + n + "/Output/Features/Std_of_Features.csv" )
