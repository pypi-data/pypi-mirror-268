...
class NrmseCls:
	...
	def set(self, enable: bool, limit: float) -> None:
		"""SCPI: CONFigure:UWB:MEASurement<Instance>:MEValuation:MODulation:LIMit:SHR:NRMSe \n
		Snippet: driver.configure.uwbMeas.multiEval.modulation.limit.shr.nrmse.set(enable = False, limit = 1.0) \n
		Activates and defines an upper limit for the NRMSE of the SHR. \n
		...
		self._core.io.write(f'CONFigure:UWB:MEASurement<Instance>:MEValuation:MODulation:LIMit:SHR:NRMSe {param}'.rstrip())
	...
	def get(self) -> NrmseStruct:
		"""SCPI: CONFigure:UWB:MEASurement<Instance>:MEValuation:MODulation:LIMit:SHR:NRMSe \n
		Snippet: value: NrmseStruct = driver.configure.uwbMeas.multiEval.modulation.limit.shr.nrmse.get() \n
		Activates and defines an upper limit for the NRMSE of the SHR. \n
			:return: structure: for return value, see the help for NrmseStruct structure arguments."""
		return self._core.io.query_struct(f'CONFigure:UWB:MEASurement<Instance>:MEValuation:MODulation:LIMit:SHR:NRMSe?', self.__class__.NrmseStruct())
