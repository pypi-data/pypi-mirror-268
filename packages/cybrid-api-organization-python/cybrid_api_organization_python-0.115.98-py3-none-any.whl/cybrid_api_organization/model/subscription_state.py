"""
    ...
    The version of the OpenAPI document: v0.115.98
...
class SubscriptionState(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["storing", "completed", "failed", "deleting", "deleted", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["storing", "completed", "failed", "deleting", "deleted", ]  # noqa: E501
