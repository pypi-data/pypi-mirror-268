...
#     APIManager-DM-2024 = APIManipulator("https://fakestoreapi.com")
#     response = APIManager-DM-2024.request_get("users")
#     response_json = response.json()
#
#     # for item in response_json:
#     #     print(item)
#
#     send_obj_status = APIManager-DM-2024.request_post("users", {
#         "name": "David",
#         "age": 20,
#     })
#
