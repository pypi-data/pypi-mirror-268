...
* 'configure.py --minimized-build --enable-modules=auto_rng,blake2,sha2_32,sha2_64,system_rng --amalgamation --disable-shared --cc-bin /usr/bin/c++ --with-build-dir /mnt/c/Daten/repos/fsc/build-linux/vendor/botan --cc gcc'
*
* Target
*  - Compiler: /usr/bin/c++ -fstack-protector -m64 -pthread -std=c++11 -D_REENTRANT -O3
*  - Arch: x86_64
*  - OS: linux
*/
...
#define BOTAN_VERSION_VC_REVISION "git:8e84bccbc7b1534115758f498aca622785eaeb4a"
