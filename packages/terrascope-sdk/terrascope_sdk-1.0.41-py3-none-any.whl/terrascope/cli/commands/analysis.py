...
from terrascope.cli.commands.analysis_version import version
from terrascope.cli.commands.analysis_computation import computation
from terrascope.cli.commands.analysis_config import config
