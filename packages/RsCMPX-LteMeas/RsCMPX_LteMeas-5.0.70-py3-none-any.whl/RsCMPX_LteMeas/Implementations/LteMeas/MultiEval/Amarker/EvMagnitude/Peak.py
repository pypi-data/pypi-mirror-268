...
class PeakCls:
	...
	def fetch(self, xvalue: int or bool, trace_select: enums.TraceSelect, absMarker=repcap.AbsMarker.Default) -> float:
		...
		Snippet: value: float = driver.lteMeas.multiEval.amarker.evMagnitude.peak.fetch(xvalue = 1, trace_select = enums.TraceSelect.AVERage, absMarker = repcap.AbsMarker.Default) \n
