...
class AverageCls:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Eutra_Positiv: float: ACLR for the first E-UTRA channel above the carrier frequency
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Eutra_Positiv: enums.ResultStatus2: ACLR for the first E-UTRA channel above the carrier frequency
