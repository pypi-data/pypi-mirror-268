...
class MeltPool(google.protobuf.message.Message):
    ...
    THERMAL_HISTORY_VTK_FIELD_NUMBER: builtins.int
    @property
    def time_steps(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MeltPoolTimeStep]: ...
    @property
    def thermal_history_vtk(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.bytes]: ...
    def __init__(self,
        *,
        time_steps : typing.Optional[typing.Iterable[global___MeltPoolTimeStep]] = ...,
        thermal_history_vtk : typing.Optional[typing.Iterable[builtins.bytes]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["thermal_history_vtk",b"thermal_history_vtk","time_steps",b"time_steps"]) -> None: ...
