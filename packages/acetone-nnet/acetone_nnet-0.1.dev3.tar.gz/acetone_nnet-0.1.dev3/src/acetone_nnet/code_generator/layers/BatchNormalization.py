...
class BatchNormalization(Layer):
    ...
    def __init__(self, idx, input_shape, epsilon, scale, biases, mean, var, activation_function):
    ...
    def generate_inference_code_layer(self):
        ...
        mustach_hash['channel_size'] = self.input_height*self.input_width
        mustach_hash['epsilon'] = self.epsilon

        with open(self.template_path+'layer/tempalte_BatchNormalization.c.tpl','r') as template_file:
    ...
    def forward_path_layer(self,input):
        input = np.reshape(input, (self.input_channels, self.input_height, self.input_width))
        output = []
