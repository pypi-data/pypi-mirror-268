...
class TestDataRead(unittest.TestCase):
    ...
    def test_00c_prepare_connection_to_SQL_Server(self):
        ...
        TestDataRead.db_connection_id = self.api_client.connections.get_uid(connection_details)
    ...
    def test_00e_prepare_db_DataConnections(self):
        ...
        asset_details = self.api_client.data_assets.store({
            self.api_client.data_assets.ConfigurationMetaNames.CONNECTION_ID: self.db_connection_id,
            self.api_client.data_assets.ConfigurationMetaNames.NAME: f"BLANK TABLE {self.database_name}",
            self.api_client.data_assets.ConfigurationMetaNames.DATA_CONTENT_NAME: join(self.schema_name,
                                                                                       self.table_name)
        })
        TestDataRead.db_data_asset_id = self.api_client.data_assets.get_id(asset_details)
    ...
    def test_03e_get_empty_sql_table(self):
        ...
        for db_data_conn in self.db_data_connections:
            db_data_conn.set_client(self.api_client)
    ...
    def test_04j_sampling_stratified_missing_values_in_target_column_data_stats(self):
        ...
        data_conn.set_client(self.api_client)
