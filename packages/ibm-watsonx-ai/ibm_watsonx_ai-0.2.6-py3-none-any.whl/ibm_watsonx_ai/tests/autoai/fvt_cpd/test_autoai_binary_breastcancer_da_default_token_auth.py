...
class TestAutoAIRemote(AbstractTestAutoAIAsync, unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        tmp_client = APIClient(wml_credentials=cls.credentials.copy())
        try:
            del cls.credentials['username']
        except:
            pass
        try:
        ...
        try:
            ...
            pass
        cls.credentials['token'] = tmp_client.wml_token
