...
class TestDataConnection(unittest.TestCase):
    ...
    def test_00b_create_normal_data_asset_xlsx_default_sheet(self):
        ...
        TestDataConnection.default_sheet_data_asset_id = self.api_client.data_assets.get_id(asset_details)
    ...
    def test_00c_create_normal_data_asset_xlsx_non_default_sheet(self):
        ...
        TestDataConnection.non_default_sheet_data_asset_id = self.api_client.data_assets.get_id(asset_details)
    ...
    def test_00f_create_connection_connection_id_created(self):
        ...
        TestDataConnection.cos_connection_id = self.api_client.connections.get_uid(connection_details)
    ...
    def test_00g_prepare_connected_data_asset_COS_default_sheet_file(self):
        asset_details = self.api_client.data_assets.store({
            self.api_client.data_assets.ConfigurationMetaNames.CONNECTION_ID: self.cos_connection_id,
            self.api_client.data_assets.ConfigurationMetaNames.NAME: f"{self.default_xlsx_data_location.split('/')[-1]} - connected data asset",
        ...
        TestDataConnection.default_sheet_connected_data_asset_cos_id = self.api_client.data_assets.get_id(asset_details)
    ...
    def test_00h_prepare_connected_data_asset_COS_default_sheet_file(self):
        asset_details = self.api_client.data_assets.store({
            self.api_client.data_assets.ConfigurationMetaNames.CONNECTION_ID: self.cos_connection_id,
            self.api_client.data_assets.ConfigurationMetaNames.NAME: f"{self.non_default_xlsx_data_location.split('/')[-1]} - connected data asset",
            self.api_client.data_assets.ConfigurationMetaNames.DATA_CONTENT_NAME: '/' + self.bucket_name + '/' +
                                                                                  self.non_default_xlsx_data_location.split(
                                                                                      '/')[-1]
        })

        TestDataConnection.non_default_sheet_connected_data_asset_cos_id = self.api_client.data_assets.get_id(
            asset_details)
    ...
    def tearDownClass(cls) -> None:
        response = cls.api_client.data_assets.delete(cls.default_sheet_data_asset_id)
        print(response)
        response = cls.api_client.data_assets.delete(cls.non_default_sheet_data_asset_id)
        print(response)

        response = cls.api_client.connections.delete(cls.cos_csv_connection_id)
        print(response)

        response = cls.api_client.data_assets.delete(cls.default_sheet_connected_data_asset_cos_id)
        print(response)

        response = cls.api_client.data_assets.delete(cls.non_default_sheet_connected_data_asset_cos_id)
        print(response)
