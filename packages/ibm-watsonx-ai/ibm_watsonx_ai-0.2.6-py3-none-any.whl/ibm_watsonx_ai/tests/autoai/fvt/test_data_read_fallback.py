...
class TestAutoAIRemote(unittest.TestCase):
    ...
    def test_00d_prepare_connected_data_asset(self):
        for connection_id, cos_path in zip(self.connections_ids, self.data_cos_paths):
            asset_details = self.api_client.data_assets.store({
                self.api_client.data_assets.ConfigurationMetaNames.CONNECTION_ID: connection_id,
                self.api_client.data_assets.ConfigurationMetaNames.NAME: "training asset",
                self.api_client.data_assets.ConfigurationMetaNames.DATA_CONTENT_NAME: join(self.bucket_name,
                                                                                           cos_path)
            })

            self.assets_ids.append(self.api_client.data_assets.get_id(asset_details))
    ...
    def test_03a_get_train_data_autoai_exp_cfpb_Small(self):  # test data
        self.data_connections[0].set_client(self.api_client)
    ...
    def test_03b_get_train_data_height(self):  # test data
        self.data_connections[1].set_client(self.api_client)
    ...
    def test_03c_get_train_data_japanese_gb18030(self):  # test data
        self.data_connections[2].set_client(self.api_client)
    ...
    def test_06a_sampling_truncate_with_timestamp(self):
        ...
        self.data_connections[3].set_client(self.api_client)
    ...
    def test_99_delete_connection_and_connected_data_asset(self):
        for asset_id, connection_id in zip(self.assets_ids, self.connections_ids):
            ...
            self.api_client.connections.delete(connection_id)

            with self.assertRaises(WMLClientError):
                self.api_client.data_assets.get_details(asset_id)
                self.api_client.connections.get_details(connection_id)
