...
class TestAutoAIRemote(AbstractTestAutoAIRemote, unittest.TestCase):
    ...
    def test_00d_prepare_connected_data_asset(self):
        ...
        asset_jap_details = self.api_client.data_assets.store({
            self.api_client.data_assets.ConfigurationMetaNames.CONNECTION_ID: self.connection_id,
            self.api_client.data_assets.ConfigurationMetaNames.NAME: "Japanese",
            self.api_client.data_assets.ConfigurationMetaNames.DATA_CONTENT_NAME: '/' + self.bucket_name + '/' + self.data_cos_path
        })

        TestAutoAIRemote.asset_id = self.api_client.data_assets.get_id(asset_jap_details)
    ...
    def test_00e_prepare_connected_data_asset_for_test_result_references(self):
        ...
        asset_details = self.api_client.data_assets.store({
            self.api_client.data_assets.ConfigurationMetaNames.CONNECTION_ID: self.connection_id,
            self.api_client.data_assets.ConfigurationMetaNames.NAME: "Iris - test asset",
            self.api_client.data_assets.ConfigurationMetaNames.DATA_CONTENT_NAME: '/' + self.bucket_name + '/' + self.data_cos_path
        })
