...
class AbstractTestBatch(abc.ABC):
    ...
    def test_40_deployment_target_space_setup(self):
        ...
        self.api_client.set.default_space(AbstractTestBatch.target_space_id)
    ...
    def test_41_batch_deployment_setup_and_preparation(self):
        ...
        if self.SPACE_ONLY:
            AbstractTestBatch.service_batch = Batch(source_instance_credentials=self.credentials,
    ...
    def test_46_run_job_batch_deployed_model_with_data_assets_with_cos_connection(self):
        ...
        asset_details = self.api_client.data_assets.store({
            self.api_client.data_assets.ConfigurationMetaNames.CONNECTION_ID: AbstractTestBatch.connection_id,
    ...
    def test_49_delete_deployment_batch(self):
        ...
        self.api_client.repository.delete(AbstractTestBatch.service_batch.asset_id)
    ...
    def test_99a_delete_created_assets_with_batch_name(self):
        ...
        all_assets = self.api_client.data_assets.get_details()
        ...
        for asset in assets_sorted_by_file_name:
            assets_id = self.api_client.data_assets.get_id(asset)
            self.api_client.data_assets.delete(assets_id)
