...
class AbstractTestAutoAIDatabaseConnection(AbstractTestAutoAIRemote, abc.ABC):
    ...
    def test_00c_prepare_connection_to_DATABASE(self):
        ...
        AbstractTestAutoAIDatabaseConnection.connection_id = self.api_client.connections.get_uid(connection_details)
    ...
    def test_01_initialize_AutoAI_experiment__pass_credentials__object_initialized(self):
        AbstractTestAutoAIDatabaseConnection.experiment = AutoAI(credentials=self.credentials.copy(),
    ...
    def test_02a_test_data_connection_setup(self):
        if self.TEST_DATA:
            ...
            self.test_data_connection.set_client(self.api_client)
