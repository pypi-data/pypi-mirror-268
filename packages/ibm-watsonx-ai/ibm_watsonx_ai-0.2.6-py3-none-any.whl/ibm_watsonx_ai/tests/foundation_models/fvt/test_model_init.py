...
from ibm_watsonx_ai.foundation_models.utils.utils import LifecycleWarning
...
class TestTextGeneration:
    ...
    def test_02_create_mt0_model(self, api_client, project_id):
    ...
    def test_03_create_flan_t5_model(self, api_client, project_id):
    ...
    def test_04_create_llama2_70b_chat_model(self, api_client, project_id):
    ...
    def test_05_create_granite_13b_instruct_model(self, api_client, project_id):
    ...
    def test_06_create_granite_13b_chat_model(self, api_client, project_id):
    ...
    def test_07_generate_text_with_raw_response(self, api_client, project_id):
    ...
    def test_08_generate_text_stream(self, api_client, project_id):
    ...
    def test_09_create_flan_t5_xl_model(self, api_client, project_id):
        model_id = ModelTypes.FLAN_T5_XL
    ...
    def test_10_generate_text_stream_with_raw_response(self, api_client, project_id):
        raw_response = True
        text_params = {
            GenParams.DECODING_METHOD: DecodingMethods.GREEDY,
            GenParams.MIN_NEW_TOKENS: 0,
    ...
    def test_11_generate_async(self, api_client, project_id):
        model_id = ModelTypes.FLAN_UL2
        text_params = {
            GenParams.DECODING_METHOD: DecodingMethods.GREEDY,
            GenParams.MIN_NEW_TOKENS: 0,
    ...
    def test_12_tokenize_without_return_tokens(self, model_id, api_client, project_id):
    ...
    @pytest.mark.parametrize('model_id', available_models)
    def test_13_tokenize_with_return_tokens(self, model_id, api_client, project_id):
    ...
    @pytest.mark.parametrize('model_id', available_models)
    def test_14_tokenize_input_token(self, model_id, api_client, project_id):
    ...
    def test_15a_create_elyza_japanese_llama_2_7b_instruct_model(self, api_client, project_id):
    ...
    def test_16_create_mixtral_8x7b_instruct_v01_q_model(self, api_client, project_id):
