...
class DictClassifier:
    def __init__(self):
        self.__root_filepath = "D:/workspace/pythonMyCode/django_project/near-synonym/tet/SentimentPolarityAnalysis/spa/f_dict/"

        jieba.load_userdict(self.__root_filepath + "user.dict")  # 准备分词词典
...
model_dc = DictClassifier()
sentence = "讨厌你"
res_1 = model_dc.analyse_sentence(sentence)
res_2 = model_dc.classify(sentence)
print(res_1)
print(res_2)
