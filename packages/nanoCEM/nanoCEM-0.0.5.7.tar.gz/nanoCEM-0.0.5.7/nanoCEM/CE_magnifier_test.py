...
def init_parser():
    ...
    # parser.set_defaults(function='tombo', chrom="NR_103073.1", pos=2524, len=5, strand='+', cpu=8,norm=True,
    #                         input_fast5 = '../example/data/reverse/wt/single/', \
    #                         control_fast5='../example/data/reverse/ivt/single/', output='tombo_result_rna_2524',
    #                         subsample_ratio=1, \
    #                         ref="../example/data/23S_rRNA.fasta", \
    #                          basecall_group="RawGenomeCorrected_000", basecall_subgroup="BaseCalled_template", rna=True)
