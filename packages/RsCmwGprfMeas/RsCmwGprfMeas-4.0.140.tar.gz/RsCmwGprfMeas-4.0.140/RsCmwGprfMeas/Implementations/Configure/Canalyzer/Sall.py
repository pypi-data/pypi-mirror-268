...
class SallCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("sall", core, parent)

	def get_iq_folder(self) -> str:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:CANalyzer:SALL:IQFolder \n
		Snippet: value: str = driver.configure.canalyzer.sall.get_iq_folder() \n
		No command help available \n
			:return: folder_name: No help available
		"""
	...
	def set_iq_folder(self, folder_name: str) -> None:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:CANalyzer:SALL:IQFolder \n
		Snippet: driver.configure.canalyzer.sall.set_iq_folder(folder_name = 'abc') \n
		No command help available \n
			:param folder_name: No help available
		"""
	...
	def get_wt_folder(self) -> bool:
		...
		Snippet: value: bool = driver.configure.canalyzer.sall.get_wt_folder() \n
		No command help available \n
	...
	def set_wt_folder(self, write_to_folder: bool) -> None:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:CANalyzer:SALL:WTFolder \n
		Snippet: driver.configure.canalyzer.sall.set_wt_folder(write_to_folder = False) \n
		No command help available \n
