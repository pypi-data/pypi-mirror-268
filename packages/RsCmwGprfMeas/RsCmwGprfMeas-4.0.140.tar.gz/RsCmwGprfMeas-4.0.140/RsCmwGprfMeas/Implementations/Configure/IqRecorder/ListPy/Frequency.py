...
class FrequencyCls:
	...
	def set(self, index: int, frequency: float) -> None:
		...
		Snippet: driver.configure.iqRecorder.listPy.frequency.set(index = 1, frequency = 1.0) \n
	...
	def get(self, index: int) -> float:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:IQRecorder:LIST:FREQuency \n
		Snippet: value: float = driver.configure.iqRecorder.listPy.frequency.get(index = 1) \n
		No command help available \n
			:param index: No help available
	...
	def get_all(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.configure.iqRecorder.listPy.frequency.get_all() \n
		No command help available \n
			:return: frequency: No help available
		"""
	...
	def set_all(self, frequency: List[float]) -> None:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:IQRecorder:LIST:FREQuency:ALL \n
		Snippet: driver.configure.iqRecorder.listPy.frequency.set_all(frequency = [1.1, 2.2, 3.3]) \n
		No command help available \n
			:param frequency: No help available
		"""
