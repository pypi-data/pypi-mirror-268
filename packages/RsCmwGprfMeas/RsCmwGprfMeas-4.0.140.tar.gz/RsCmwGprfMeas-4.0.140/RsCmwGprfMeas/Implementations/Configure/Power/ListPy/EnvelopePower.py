...
class EnvelopePowerCls:
	...
	def get_all(self) -> List[float]:
		...
		Defines the expected nominal power for all segments. \n
			:return: exp_nom_power: numeric Comma-separated list of expected powers, one value per segment The range of the expected nominal power can be calculated as follows: Range (Expected Nominal Power) = Range (Input Power) + External Attenuation - User Margin The input power range is stated in the data sheet. Unit: dBm
		"""
	...
	def set_all(self, exp_nom_power: List[float]) -> None:
		...
		Defines the expected nominal power for all segments. \n
			:param exp_nom_power: numeric Comma-separated list of expected powers, one value per segment The range of the expected nominal power can be calculated as follows: Range (Expected Nominal Power) = Range (Input Power) + External Attenuation - User Margin The input power range is stated in the data sheet. Unit: dBm
		"""
