...
class CurrentCls:
	...
	def calculate(self) -> List[enums.ResultStatus2]:
		...
		Snippet: value: List[enums.ResultStatus2] = driver.power.maximum.current.calculate() \n
		...
		Use RsCmwGprfMeas.reliability.last_value to read the updated reliability indicator. \n
			:return: power_current_max: float Comma-separated list of power values, one value per measured segment Unit: dBm (SDEViation: dB)"""
