...
class StandardDevCls:
	...
	def calculate(self, list_index: int) -> List[enums.ResultStatus2]:
		...
		Snippet: value: List[enums.ResultStatus2] = driver.power.listPy.standardDev.calculate(list_index = 1) \n
		...
		response = self._core.io.query_str_suppressed(f'CALCulate:GPRF:MEASurement<Instance>:POWer:LIST:SDEViation? {param}', suppressed)
