...
class IqDataCls:
	...
	def get_capture(self) -> bool:
		...
		Snippet: value: bool = driver.configure.power.listPy.iqData.get_capture() \n
	...
	def set_capture(self, capture_iq_data: bool) -> None:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:POWer:LIST:IQData:CAPTure \n
		Snippet: driver.configure.power.listPy.iqData.set_capture(capture_iq_data = False) \n
		No command help available \n
	...
	def set(self, index: int, iq_data: bool) -> None:
		...
		Snippet: driver.configure.power.listPy.iqData.set(index = 1, iq_data = False) \n
		No command help available \n
	...
	def get(self, index: int) -> bool:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:POWer:LIST:IQData \n
		Snippet: value: bool = driver.configure.power.listPy.iqData.get(index = 1) \n
		No command help available \n
			:param index: No help available
	...
	def get_all(self) -> List[bool]:
		...
		Snippet: value: List[bool] = driver.configure.power.listPy.iqData.get_all() \n
		No command help available \n
			:return: iq_data: No help available
		"""
	...
	def set_all(self, iq_data: List[bool]) -> None:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:POWer:LIST:IQData:ALL \n
		Snippet: driver.configure.power.listPy.iqData.set_all(iq_data = [True, False, True]) \n
		No command help available \n
			:param iq_data: No help available
		"""
