...
class PeakSearchCls:
	...
	def get_noa_markers(self) -> int:
		...
		Snippet: value: int = driver.configure.fftSpecAn.peakSearch.get_noa_markers() \n
		Defines the number of active markers for the peak search. \n
			:return: no_active_markers: numeric Range: 0 to 5
		"""
	...
	def set_noa_markers(self, no_active_markers: int) -> None:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:FFTSanalyzer:PSEarch:NOAMarkers \n
		Snippet: driver.configure.fftSpecAn.peakSearch.set_noa_markers(no_active_markers = 1) \n
		Defines the number of active markers for the peak search. \n
			:param no_active_markers: numeric Range: 0 to 5
		"""
	...
	def get_value(self) -> ValueStruct:
		...
		Snippet: value: ValueStruct = driver.configure.fftSpecAn.peakSearch.get_value() \n
