...
class LrStartCls:
	...
	def set(self) -> None:
		...
		"""
		self._core.io.write(f'CONFigure:GPRF:MEASurement<Instance>:RFSettings:LRSTart')
	...
	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		...
		self._core.io.write_with_opc(f'CONFigure:GPRF:MEASurement<Instance>:RFSettings:LRSTart', opc_timeout_ms)
