...
#def duplicate_slide(ppt: Presentation, slide_index: int):
def duplicate_slide(ppt: Presentation, source: Slide):
    ...
    dest = _exp_add_slide(ppt, _get_blank_slide_layout(source))
...
if __name__ == '__main__':
 ...
 #   duplicate_slide(output,template.slides[1])
    move_slides(output,template)
