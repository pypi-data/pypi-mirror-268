...
from quant.football.transforms import table20240415 as table_factory
...
name_suffix = "_train_2301_2312_2403_lb_5_15_label_whole_c20_maxabs_direct"

points = [i + 0.5 for i in range(15, 90)]
# points = None

preprocess_args = [[5, 15], "label", True, 20, "maxabs", "direct"]
