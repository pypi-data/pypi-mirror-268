...
class RobotoDomainException(Exception):
    ...
    # I promise you that if you ask me how this works, I will respond honestly that I have absolutely no fucking
    # idea, and that I'm just glad that it works at all.
    @classmethod
