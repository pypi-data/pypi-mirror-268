...
def run_strudel(full_modelpath, full_mappath, motif_libpath, output_path, platform=None):
    ...
    if platform == 'emdb' and bsub_bin:
        strudel_cmd = 'sbatch --mem=26G --time 48:00:00 -p production -J strudel --ntasks=8 --mail-user=zhe@ebi.ac.uk '
        '--mail-type=END --mail-type=FAIL-e {}/strudel_stderr.txt -o {}/strudel_stdout.txt '
        '--wrap="strudel_mapMotifValidation.py -p {} -m {} -l {} -o {} -np 8 '
        '-log {}/strudel.log -r -rs"'.format(output_path,
                                             output_path,
                                             full_modelpath,
                                             full_mappath,
                                             motif_libpath,
