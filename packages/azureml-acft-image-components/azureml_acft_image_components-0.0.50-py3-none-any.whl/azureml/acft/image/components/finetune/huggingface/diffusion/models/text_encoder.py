...
class RobertaSeriesModelWithTransformation(AzmlTextEncoder):
    """RobertaSeriesModelWithTransformation class."""

    @classmethod
    def get_text_encoder(
        cls, text_encoder_name_or_path: Union[str, os.PathLike], subfolder: str
    ) -> "RobertaSeriesModelWithTransformation":
        """Get RobertaSeriesModelWithTransformation text encoder.
        ...
        :param subfolder: subfolder where text encoder is stored
        :type subfolder: str
        :return: RobertaSeriesModelWithTransformation instance
        :rtype: RobertaSeriesModelWithTransformation
        """
        from diffusers.pipelines.alt_diffusion.modeling_roberta_series import RobertaSeriesModelWithTransformation

        return RobertaSeriesModelWithTransformation.from_pretrained(text_encoder_name_or_path, subfolder=subfolder)
...
TEXT_ENCODER_MAPPING = {
    Literals.ROBERTA_SERIES_MODEL_WITH_TRANSFORMATION: RobertaSeriesModelWithTransformation,
