...
def sd_generate_validation_images(component_args: Namespace, azml_sd_pipeline: AzuremlStableDiffusionPipeline):
    ...
    num_class_images = 5
    generate_class_images(model_name_or_path=component_args.model_name_or_path,
