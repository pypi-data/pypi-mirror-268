...
class AzuremlStableDiffusionPipeline(nn.Module):
    ...
    def forward(self, **data):
        ...
        if self.vae is not None:
            ...
            model_input = self.vae.encode(pixel_values.to(dtype=self.weight_dtype)).latent_dist.sample()
    ...
    def from_pretrained(
        ...
        scheduler_type = kwargs.get(Literals.NOISE_SCHEDULER_NAME, DefaultSettings.scheduler_type)
