# -*- coding: utf-8 -*-
"""Installer for the plonetheme.deliberations package."""
...
setup(
    ...
    url='https://github.com/collective/plonetheme.deliberations',
    project_urls={
        ...
        # 'Documentation': 'https://plonetheme.deliberations.readthedocs.io/en/latest/',
    },
    ...
    target = plone
    [console_scripts]
    update_locale = plonetheme.deliberations.locales.update:update_locale
    """,
)
