...
class ServiceRoles(ServiceRoleBase):
    ...
    POLIBASE_APP = ServiceDescription(
        name="PolibaseApp", description="Polibase Application service"
    )
    ...
    POLIBASE_PERSON_NOTIFICATION = ServiceDescription(name="PolibasePersonNotification")

    POLIBASE_PERSON_REVIEW_NOTIFICATION = ServiceDescription(
