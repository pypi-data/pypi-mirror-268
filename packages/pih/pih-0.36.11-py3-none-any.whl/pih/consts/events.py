...
class Events(Enum):
    ...
    #
    POLIBASE_CREATION_DB_DUMP_START = EventDescription(
        "Базы данных Polibase: Начато создание дампа",
        LogMessageChannels.BACKUP,
        (LogMessageFlags.NORMAL, LogMessageFlags.SAVE),
    )

    POLIBASE_CREATION_DB_DUMP_COMPLETE = EventDescription(
    ...
    POLIBASE_CREATION_ARCHIVED_DB_DUMP_START = EventDescription(
        "Базы данных Polibase: Начато архивирование дампа",
        LogMessageChannels.BACKUP,
        LogMessageFlags.NORMAL,
    )

    POLIBASE_CREATION_ARCHIVED_DB_DUMP_COMPLETE = EventDescription(
    ...
    POLIBASE_COPING_ARCHIVED_DB_DUMP_START = EventDescription(
    ...
    POLIBASE_COPING_ARCHIVED_DB_DUMP_COMPLETE = EventDescription(
    ...
    POLIBASE_COPING_DB_DUMP_START = EventDescription(
    ...
    POLIBASE_COPING_DB_DUMP_COMPLETE = EventDescription(
