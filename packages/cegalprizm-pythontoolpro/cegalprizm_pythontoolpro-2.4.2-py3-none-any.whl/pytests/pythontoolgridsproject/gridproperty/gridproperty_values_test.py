...
class TestGridPropertyValues:
    ...
    def test_grid_property_values_match_indices_cont(self, grid, prop, request, petrel_context):
    ...
    def test_grid_property_values_match_indices_disc(self, grid, prop, request, petrel_context):
        grid = request.getfixturevalue(grid)
        prop = request.getfixturevalue(prop)
        assert self.check_all_values(grid, prop)
        self.update_values(grid, prop)
