...
class Settings(Page_BM):
    def __init__(self, window, THEFrame, parent, on_TC_func = None):
        ...
        # Section Units (options)
        self.WS_Var = ctk.BooleanVar(value=self.menu_page_frame.pages_dict["Workspace"].openable)
    ...
    def WS_openable_func(self):
        self.menu_page_frame.pages_dict["Workspace"].openable = self.Dev_mode.gval()
