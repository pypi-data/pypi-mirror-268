...
'''
import euphoria.clouds.supp_NIH.nature.form.serving_size.amount as serving_size_amount_calculator
...
import euphoria.measures.number.integer.string_is_integer as string_is_integer
import euphoria.mixes.insure.equality as equality

import euphoria.clouds.supp_NIH.interpret.ingredientRows.for_each as for_each_IR	
...
def calc (
	...
	if (
		...
		try:
			...
			traceback.print_exc ()
			print ("Exception found in unit amount check 1:", E)
			pass;
