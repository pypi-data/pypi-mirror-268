...
'''
	python3 insurance.py "clouds/food_USDA/interpret/packageWeight/interpret/status_1.py"
'''
...
from euphoria.clouds.food_USDA.nature_v2._interpret.packageWeight.interpret import interpret_amount
