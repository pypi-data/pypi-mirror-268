...
'''
	import euphoria.clouds.food_USDA.nature.form as calculate_form
...
import euphoria.measures._interpret.unit_kind as unit_kind
...
'''	
'''
def calculate_labelNutrient_per_package_multiplier_for_mass ():
	return
	
def calculate_labelNutrient_per_package_multiplier_for_volume ():
	return
'''	
