...
'''
	...
	#	cautionary
	#
	import euphoria.shows.ingredient_scan.DB.path as DB_paths
	import euphoria.shows.ingredient_scan.DB.access as access
...
import euphoria.shows.ingredient_scan.grove.nurture as grove_nurture
import euphoria.shows.ingredient_scan.land.build.measures as build_land_measures
