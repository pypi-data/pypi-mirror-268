...
'''
	caution, not checked.
		...
		import euphoria.shows.ingredient_scan.DB.sculpt.erase as erase_essential_nutrient
...
import euphoria.shows.ingredient_scan.DB.access as access
import euphoria.shows.ingredient_scan.DB.scan.seek_next_region as seek_next_region
