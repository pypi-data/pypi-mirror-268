...
class ProfitAndLoss(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, report_name, currency, income, expenses, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, report_name, currency, income, expenses, *args, **kwargs):  # noqa: E501
        """ProfitAndLoss - a model defined in OpenAPI
