...
class LeadEventType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """LeadEventType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["*", "lead.lead.created", "lead.lead.updated", "lead.lead.deleted", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["*", "lead.lead.created", "lead.lead.updated", "lead.lead.deleted", ]  # noqa: E501
