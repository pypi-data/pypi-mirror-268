...
class Status(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The status of the webhook.., must be one of ["enabled", "disabled", ]  # noqa: E501

        Keyword Args:
            value (str): The status of the webhook.., must be one of ["enabled", "disabled", ]  # noqa: E501
