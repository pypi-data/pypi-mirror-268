...
class GetConsumersResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([GetConsumersResponseData],),  # noqa: E501
            'meta': (Meta,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status_code, status, data, *args, **kwargs):  # noqa: E501
        """GetConsumersResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, status_code, status, data, *args, **kwargs):  # noqa: E501
        """GetConsumersResponse - a model defined in OpenAPI
