...
class GetAccountingLocationsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([AccountingLocation],),  # noqa: E501
            'meta': (Meta,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status_code, status, service, resource, operation, data, *args, **kwargs):  # noqa: E501
        """GetAccountingLocationsResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, status_code, status, service, resource, operation, data, *args, **kwargs):  # noqa: E501
        """GetAccountingLocationsResponse - a model defined in OpenAPI
