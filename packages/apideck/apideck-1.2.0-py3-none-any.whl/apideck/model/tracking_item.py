...
class TrackingItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, provider, number, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            url (str, none_type): The URL of the carrier's tracking page, which can be used to view detailed information about the shipment's progress.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, provider, number, *args, **kwargs):  # noqa: E501
        """TrackingItem - a model defined in OpenAPI
