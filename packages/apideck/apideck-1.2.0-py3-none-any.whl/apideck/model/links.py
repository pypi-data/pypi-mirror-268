...
class Links(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            previous (str, none_type): Link to navigate to the previous page through the API. [optional]  # noqa: E501
            current (str): Link to navigate to the current page through the API. [optional]  # noqa: E501
            next (str, none_type): Link to navigate to the previous page through the API. [optional]  # noqa: E501
        """
