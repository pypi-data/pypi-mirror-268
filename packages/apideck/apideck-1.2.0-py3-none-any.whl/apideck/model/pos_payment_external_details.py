...
class PosPaymentExternalDetails(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'source_fee_amount': (float,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'source_fee_amount': 'source_fee_amount',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, source, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            source_id (str): An ID to associate the payment to its originating source.. [optional]  # noqa: E501
            source_fee_amount (float): The fees paid to the source. The amount minus this field is the net amount seller receives.. [optional]  # noqa: E501
        """
