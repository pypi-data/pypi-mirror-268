...
setuptools.setup(
    ...
    version="5.5.0",
    description='',
    url='https://github.com/mtdev/mtthrift',
    author='mtdev',
    author_email='wuuuuusmall@outlook.com',
    long_description='A Python library that provides support for multi-threaded communication using the Apache Thrift framework.',
