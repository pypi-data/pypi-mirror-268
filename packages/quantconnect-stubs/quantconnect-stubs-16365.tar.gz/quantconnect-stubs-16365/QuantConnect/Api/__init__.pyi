...
class LiveAlgorithmResults(QuantConnect.Api.RestResponse):
    ...
    @property
    def live_results(self) -> QuantConnect.Api.LiveResultsData:
...
class Api(System.Object, QuantConnect.Interfaces.IApi, QuantConnect.Interfaces.IDownloadProvider):
    ...
    @overload
    def create_live_algorithm(self, project_id: int, compile_id: str, node_id: str, brokerage_settings: System.Collections.Generic.Dictionary[str, System.Object], version_id: str = "-1", data_providers: System.Collections.Generic.Dictionary[str, System.Object] = None) -> QuantConnect.Api.LiveAlgorithm:
        """
    ...
    @overload
    def create_live_algorithm(self, project_id: int, compile_id: str, node_id: str, brokerage_settings: typing.Any, version_id: str = "-1", data_providers: typing.Any = None) -> QuantConnect.Api.LiveAlgorithm:
        """
        Create a live algorithm.
    ...
    def read_live_logs(self, project_id: int, algorithm_id: str, start_time: typing.Optional[datetime.datetime] = None, end_time: typing.Optional[datetime.datetime] = None) -> QuantConnect.Api.LiveLog:
        """
        ...
        :param start_time: No logs will be returned before this time
        :param end_time: No logs will be returned after this time
