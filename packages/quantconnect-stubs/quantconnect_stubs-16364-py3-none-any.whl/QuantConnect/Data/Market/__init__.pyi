...
class Tick(QuantConnect.Data.BaseData):
    ...
    @overload
    def reader(self, config: QuantConnect.Data.SubscriptionDataConfig, reader: System.IO.StreamReader, date: typing.Union[datetime.datetime, datetime.date], is_live_mode: bool) -> QuantConnect.Data.BaseData:
        """
        Tick implementation of reader method: read a line of data from the source and convert it to a tick object.
...
class OptionContract(System.Object):
    ...
    def __init__(self, security: QuantConnect.Interfaces.ISecurityPrice, underlyingSymbol: typing.Union[QuantConnect.Symbol, str]) -> None:
        """
    ...
    @staticmethod
    @overload
    def create(base_data: QuantConnect.Data.BaseData, security: QuantConnect.Interfaces.ISecurityPrice, underlying_last_price: float) -> QuantConnect.Data.Market.OptionContract:
        """
        Creates a OptionContract
        
        :param security: provides price properties for a Security
        :param underlying_last_price: last price the underlying security traded at
    ...
    @staticmethod
    @overload
    def create(underlying_symbol: typing.Union[QuantConnect.Symbol, str], end_time: typing.Union[datetime.datetime, datetime.date], security: QuantConnect.Interfaces.ISecurityPrice, underlying_last_price: float) -> QuantConnect.Data.Market.OptionContract:
        """
        Creates a OptionContract
        
        :param underlying_symbol: The symbol of the underlying security
