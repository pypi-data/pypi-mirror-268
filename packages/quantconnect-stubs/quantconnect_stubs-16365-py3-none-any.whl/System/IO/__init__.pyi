...
class TextWriter(System.MarshalByRefObject, System.IDisposable, System.IAsyncDisposable, metaclass=abc.ABCMeta):
    ...
    @overload
    def write_line(self, format: str, arg0: typing.Any) -> None:
        ...

    @overload
    def write_line(self, format: str, arg0: typing.Any, arg1: typing.Any) -> None:
        ...

    @overload
    def write_line(self, format: str, arg0: typing.Any, arg1: typing.Any, arg2: typing.Any) -> None:
        ...
...
class UnmanagedMemoryAccessor(System.Object, System.IDisposable):
    ...
    def read_int16(self, position: int) -> int:
        ...

    def read_int32(self, position: int) -> int:
        ...

    def read_int64(self, position: int) -> int:
        ...
    ...
    def read_u_int16(self, position: int) -> int:
        ...

    def read_u_int32(self, position: int) -> int:
        ...

    def read_u_int64(self, position: int) -> int:
        ...
...
class Path(System.Object):
    ...
    @staticmethod
    @overload
    def try_join(path1: System.ReadOnlySpan[str], path2: System.ReadOnlySpan[str], destination: System.Span[str], chars_written: typing.Optional[int]) -> typing.Union[bool, int]:
        ...

    @staticmethod
    @overload
    def try_join(path1: System.ReadOnlySpan[str], path2: System.ReadOnlySpan[str], path3: System.ReadOnlySpan[str], destination: System.Span[str], chars_written: typing.Optional[int]) -> typing.Union[bool, int]:
        ...
...
class BinaryWriter(System.Object, System.IDisposable, System.IAsyncDisposable):
    ...
    def write7bit_encoded_int(self, value: int) -> None:
        ...

    def write7bit_encoded_int64(self, value: int) -> None:
        ...
...
class BinaryReader(System.Object, System.IDisposable):
    ...
    def read7bit_encoded_int64(self) -> int:
        ...
