...
class FileSystemName(System.Object):
    ...
    @staticmethod
    def matches_win32expression(expression: System.ReadOnlySpan[str], name: System.ReadOnlySpan[str], ignore_case: bool = True) -> bool:
        """
    ...
    @staticmethod
    def translate_win32expression(expression: str) -> str:
        """
