...
class SubscriptionDataConfig(System.Object, System.IEquatable[QuantConnect_Data_SubscriptionDataConfig]):
    ...
    @property
    def data_normalization_mode(self) -> int:
        """
    ...
    @property
    def data_mapping_mode(self) -> int:
        """
...
class SubscriptionDataConfigExtensions(System.Object):
    ...
    @staticmethod
    def data_normalization_mode(subscription_data_configs: System.Collections.Generic.IEnumerable[QuantConnect.Data.SubscriptionDataConfig]) -> int:
        """
    ...
    @staticmethod
    def get_highest_resolution(subscription_data_configs: System.Collections.Generic.IEnumerable[QuantConnect.Data.SubscriptionDataConfig]) -> int:
        """
...
class SliceExtensions(System.Object):
    ...
    @staticmethod
    def push_through(slices: System.Collections.Generic.IEnumerable[QuantConnect.Data.Slice], handler: typing.Callable[[QuantConnect.Data.BaseData], None]) -> None:
        """
...
class InterestRateProvider(System.Object, QuantConnect.Data.IRiskFreeInterestRateModel):
    ...
    def load_interest_rate_provider(self) -> None:
        """
...
class DividendYieldProvider(System.Object, QuantConnect.Data.IDividendYieldModel):
    ...
    _dividend_yield_rate_provider: System.Collections.Generic.Dictionary[QuantConnect.Symbol, System.Collections.Generic.Dictionary[datetime.datetime, float]]
    """This field is protected."""
    ...
    @staticmethod
    def from_corporate_factor_row(corporate_factors: System.Collections.Generic.IEnumerable[QuantConnect.Data.Auxiliary.CorporateFactorRow], symbol: typing.Union[QuantConnect.Symbol, str]) -> System.Collections.Generic.Dictionary[datetime.datetime, float]:
        """
        Returns a dictionary of historical dividend yield from collection of corporate factor rows
        
        :param corporate_factors: The corporate factor rows containing factor data
    ...
    def load_dividend_yield_provider(self, symbol: typing.Union[QuantConnect.Symbol, str]) -> System.Collections.Generic.Dictionary[datetime.datetime, float]:
        """
...
class HistoryRequestFactory(System.Object):
    ...
    def get_start_time_algo_tz(self, symbol: typing.Union[QuantConnect.Symbol, str], periods: int, resolution: QuantConnect.Resolution, exchange: QuantConnect.Securities.SecurityExchangeHours, data_time_zone: typing.Any, extended_market_hours: typing.Optional[bool] = None) -> datetime.datetime:
        """
