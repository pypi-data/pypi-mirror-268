...
class SpinWait:
    ...
    @overload
    def spin_once(self, sleep1threshold: int) -> None:
        """
        Performs a single spin.
...
class CancellationTokenSource(System.Object, System.IDisposable):
    ...
    @staticmethod
    @overload
    def create_linked_token_source(token1: System.Threading.CancellationToken, token2: System.Threading.CancellationToken) -> System.Threading.CancellationTokenSource:
        """
...
class Interlocked(System.Object):
    ...
    @staticmethod
    @overload
    def compare_exchange(location1: int, value: int, comparand: int) -> int:
        ...
    ...
    @staticmethod
    @overload
    def compare_exchange(location1: float, value: float, comparand: float) -> float:
        """
    ...
    @staticmethod
    @overload
    def compare_exchange(location1: System.IntPtr, value: System.IntPtr, comparand: System.IntPtr) -> System.IntPtr:
        """
    ...
    @staticmethod
    @overload
    def compare_exchange(location1: System.UIntPtr, value: System.UIntPtr, comparand: System.UIntPtr) -> System.UIntPtr:
        """
        Compares two platform-specific handles or pointers for equality and, if they are equal, replaces the first one.
    ...
    @staticmethod
    @overload
    def compare_exchange(location1: typing.Any, value: typing.Any, comparand: typing.Any) -> System.Object:
        ...
    ...
    @staticmethod
    @overload
    def compare_exchange(location1: System_Threading_Interlocked_CompareExchange_T, value: System_Threading_Interlocked_CompareExchange_T, comparand: System_Threading_Interlocked_CompareExchange_T) -> System_Threading_Interlocked_CompareExchange_T:
        ...
