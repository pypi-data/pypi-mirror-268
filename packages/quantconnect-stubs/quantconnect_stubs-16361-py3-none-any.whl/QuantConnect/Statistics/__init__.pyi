...
class TradeBuilder(System.Object, QuantConnect.Interfaces.ITradeBuilder):
    ...
    def process_fill(self, fill: QuantConnect.Orders.OrderEvent, conversion_rate: float, fee_in_account_currency: float, multiplier: float = 1.0) -> None:
        """
        Processes a new fill, eventually creating new trades
        
        :param fill: The new fill order event
        :param conversion_rate: The current security market conversion rate into the account currency
...
class PortfolioStatistics(System.Object):
    ...
    @property
    def value_at_risk99(self) -> float:
        """
    ...
    @property
    def value_at_risk95(self) -> float:
        """
        The 1-day VaR for the portfolio, using the Variance-covariance approach.
