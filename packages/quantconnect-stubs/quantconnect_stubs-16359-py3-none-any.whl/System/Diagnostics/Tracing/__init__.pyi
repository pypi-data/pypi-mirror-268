...
class EventSource(System.Object, System.IDisposable):
    ...
    @staticmethod
    @overload
    def set_current_thread_activity_id(activity_id: System.Guid, old_activity_that_will_continue: typing.Optional[System.Guid]) -> typing.Union[None, System.Guid]:
        """
        When a thread starts work that is on behalf of 'something else' (typically another
        thread or network request) it should mark the thread as working on that other work.
    ...
    @overload
    def write_event(self, event_id: int, arg1: int) -> None:
        """This method is protected."""
        ...

    @overload
    def write_event(self, event_id: int, arg1: int, arg2: int) -> None:
        """This method is protected."""
        ...

    @overload
    def write_event(self, event_id: int, arg1: int, arg2: int, arg3: int) -> None:
        """This method is protected."""
        ...
    ...
    @overload
    def write_event(self, event_id: int, arg1: str) -> None:
        """This method is protected."""
        ...

    @overload
    def write_event(self, event_id: int, arg1: str, arg2: str) -> None:
        """This method is protected."""
        ...

    @overload
    def write_event(self, event_id: int, arg1: str, arg2: str, arg3: str) -> None:
        """This method is protected."""
        ...

    @overload
    def write_event(self, event_id: int, arg1: str, arg2: int) -> None:
        """This method is protected."""
        ...

    @overload
    def write_event(self, event_id: int, arg1: str, arg2: int, arg3: int) -> None:
        """This method is protected."""
        ...
    ...
    @overload
    def write_event(self, event_id: int, arg1: int, arg2: str) -> None:
        """This method is protected."""
        ...
    ...
    @overload
    def write_event(self, event_id: int, arg1: typing.List[int]) -> None:
        """This method is protected."""
        ...

    @overload
    def write_event(self, event_id: int, arg1: int, arg2: typing.List[int]) -> None:
        """This method is protected."""
        ...
