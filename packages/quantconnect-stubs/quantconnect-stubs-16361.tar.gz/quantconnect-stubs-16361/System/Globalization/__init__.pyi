...
class Calendar(System.Object, System.ICloneable, metaclass=abc.ABCMeta):
    ...
    def get_day_of_week(self, time: typing.Union[datetime.datetime, datetime.date]) -> int:
        """
...
class IdnMapping(System.Object):
    ...
    @property
    def use_std3ascii_rules(self) -> bool:
        ...
...
class CompareInfo(System.Object, System.Runtime.Serialization.IDeserializationCallback):
    ...
    @overload
    def index_of(self, source: System.ReadOnlySpan[str], value: System.ReadOnlySpan[str], options: System.Globalization.CompareOptions, match_length: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Searches for the first occurrence of a substring within a source string.
    ...
    @overload
    def is_prefix(self, source: System.ReadOnlySpan[str], prefix: System.ReadOnlySpan[str], options: System.Globalization.CompareOptions, match_length: typing.Optional[int]) -> typing.Union[bool, int]:
        """
        Determines whether a string starts with a specific prefix.
    ...
    @overload
    def is_suffix(self, source: System.ReadOnlySpan[str], suffix: System.ReadOnlySpan[str], options: System.Globalization.CompareOptions, match_length: typing.Optional[int]) -> typing.Union[bool, int]:
        """
        Determines whether a string ends with a specific suffix.
    ...
    @overload
    def last_index_of(self, source: System.ReadOnlySpan[str], value: System.ReadOnlySpan[str], options: System.Globalization.CompareOptions, match_length: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Searches for the last occurrence of a substring within a source string.
...
class NumberFormatInfo(System.Object, System.IFormatProvider, System.ICloneable):
    ...
    @property
    def digit_substitution(self) -> int:
...
class DateTimeFormatInfo(System.Object, System.IFormatProvider, System.ICloneable):
    ...
    @property
    def calendar_week_rule(self) -> int:
