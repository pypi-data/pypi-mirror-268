...
class Rune(System.IComparable[System_Text_Rune], System.IEquatable[System_Text_Rune]):
    ...
    @property
    def utf16sequence_length(self) -> int:
        """
    ...
    @property
    def utf8sequence_length(self) -> int:
        """
    ...
    @staticmethod
    def decode_from_utf16(source: System.ReadOnlySpan[str], result: typing.Optional[System.Text.Rune], chars_consumed: typing.Optional[int]) -> typing.Union[int, System.Text.Rune, int]:
        """
    ...
    @staticmethod
    def decode_from_utf8(source: System.ReadOnlySpan[int], result: typing.Optional[System.Text.Rune], bytes_consumed: typing.Optional[int]) -> typing.Union[int, System.Text.Rune, int]:
        """
    ...
    @staticmethod
    def decode_last_from_utf16(source: System.ReadOnlySpan[str], result: typing.Optional[System.Text.Rune], chars_consumed: typing.Optional[int]) -> typing.Union[int, System.Text.Rune, int]:
        """
    ...
    @staticmethod
    def decode_last_from_utf8(source: System.ReadOnlySpan[int], value: typing.Optional[System.Text.Rune], bytes_consumed: typing.Optional[int]) -> typing.Union[int, System.Text.Rune, int]:
        """
    ...
    def encode_to_utf16(self, destination: System.Span[str]) -> int:
        """
    ...
    def encode_to_utf8(self, destination: System.Span[int]) -> int:
        """
    ...
    def try_encode_to_utf16(self, destination: System.Span[str], chars_written: typing.Optional[int]) -> typing.Union[bool, int]:
        """
        Encodes this Rune to a UTF-16 destination buffer.
    ...
    def try_encode_to_utf8(self, destination: System.Span[int], bytes_written: typing.Optional[int]) -> typing.Union[bool, int]:
        """
...
class Ascii(System.Object):
    ...
    @staticmethod
    def from_utf16(source: System.ReadOnlySpan[str], destination: System.Span[int], bytes_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
    ...
    @staticmethod
    def to_utf16(source: System.ReadOnlySpan[int], destination: System.Span[str], chars_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
        Copies text from a source buffer to a destination buffer, converting
...
class StringBuilder(System.Object, System.Runtime.Serialization.ISerializable):
    ...
    @overload
    def append_format(self, format: str, arg0: typing.Any) -> System.Text.StringBuilder:
        ...

    @overload
    def append_format(self, format: str, arg0: typing.Any, arg1: typing.Any) -> System.Text.StringBuilder:
        ...

    @overload
    def append_format(self, format: str, arg0: typing.Any, arg1: typing.Any, arg2: typing.Any) -> System.Text.StringBuilder:
        ...
    ...
    @overload
    def append_format(self, provider: System.IFormatProvider, format: str, arg0: typing.Any) -> System.Text.StringBuilder:
        ...

    @overload
    def append_format(self, provider: System.IFormatProvider, format: str, arg0: typing.Any, arg1: typing.Any) -> System.Text.StringBuilder:
        ...

    @overload
    def append_format(self, provider: System.IFormatProvider, format: str, arg0: typing.Any, arg1: typing.Any, arg2: typing.Any) -> System.Text.StringBuilder:
        ...
    ...
    @overload
    def append_format(self, provider: System.IFormatProvider, format: System.Text.CompositeFormat, arg0: System_Text_StringBuilder_AppendFormat_TArg0) -> System.Text.StringBuilder:
        """
    ...
    @overload
    def append_format(self, provider: System.IFormatProvider, format: System.Text.CompositeFormat, arg0: System_Text_StringBuilder_AppendFormat_TArg0, arg1: System_Text_StringBuilder_AppendFormat_TArg1) -> System.Text.StringBuilder:
        """
        Appends the string returned by processing a composite format string, which contains zero or more format items, to this instance.
        Each format item is replaced by the string representation of any of the arguments using a specified format provider.
    ...
    @overload
    def append_format(self, provider: System.IFormatProvider, format: System.Text.CompositeFormat, arg0: System_Text_StringBuilder_AppendFormat_TArg0, arg1: System_Text_StringBuilder_AppendFormat_TArg1, arg2: System_Text_StringBuilder_AppendFormat_TArg2) -> System.Text.StringBuilder:
        """
        Appends the string returned by processing a composite format string, which contains zero or more format items, to this instance.
        Each format item is replaced by the string representation of any of the arguments using a specified format provider.
    ...
    @overload
    def append_format(self, provider: System.IFormatProvider, format: System.Text.CompositeFormat, args: System.ReadOnlySpan[System.Object]) -> System.Text.StringBuilder:
        """
        Appends the string returned by processing a composite format string, which contains zero or more format items, to this instance.
        Each format item is replaced by the string representation of any of the arguments using a specified format provider.
