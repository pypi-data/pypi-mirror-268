...
class Base64(System.Object):
    ...
    @staticmethod
    def decode_from_utf8(utf8: System.ReadOnlySpan[int], bytes: System.Span[int], bytes_consumed: typing.Optional[int], bytes_written: typing.Optional[int], is_final_block: bool = True) -> typing.Union[int, int, int]:
        """
    ...
    @staticmethod
    def decode_from_utf8in_place(buffer: System.Span[int], bytes_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
    ...
    @staticmethod
    def encode_to_utf8(bytes: System.ReadOnlySpan[int], utf8: System.Span[int], bytes_consumed: typing.Optional[int], bytes_written: typing.Optional[int], is_final_block: bool = True) -> typing.Union[int, int, int]:
        """
    ...
    @staticmethod
    def encode_to_utf8in_place(buffer: System.Span[int], data_length: int, bytes_written: typing.Optional[int]) -> typing.Union[int, int]:
        """
    ...
    @staticmethod
    def get_max_decoded_from_utf8length(length: int) -> int:
    ...
    @staticmethod
    @overload
    def is_valid(base64text: System.ReadOnlySpan[str], decoded_length: typing.Optional[int]) -> typing.Union[bool, int]:
        """
        Validates that the specified span of text is comprised of valid base-64 encoded data.
    ...
    @staticmethod
    @overload
    def is_valid(base64text_utf8: System.ReadOnlySpan[int]) -> bool:
        """
        Validates that the specified span of UTF-8 text is comprised of valid base-64 encoded data.
        
        :param base64text_utf8: A span of UTF-8 text to validate.
        :returns: true if  contains a valid, decodable sequence of base-64 encoded data; otherwise, false.
        """
        ...
    ...
    @staticmethod
    @overload
    def is_valid(base64text_utf8: System.ReadOnlySpan[int], decoded_length: typing.Optional[int]) -> typing.Union[bool, int]:
        """
        Validates that the specified span of UTF-8 text is comprised of valid base-64 encoded data.
...
class Utf8Formatter(System.Object):
    ...
    @staticmethod
    @overload
    def try_format(value: int, destination: System.Span[int], bytes_written: typing.Optional[int], format: System.Buffers.StandardFormat = ...) -> typing.Union[bool, int]:
        """
    ...
    @staticmethod
    @overload
    def try_format(value: float, destination: System.Span[int], bytes_written: typing.Optional[int], format: System.Buffers.StandardFormat = ...) -> typing.Union[bool, int]:
        """
    ...
    @staticmethod
    @overload
    def try_format(value: System.DateTimeOffset, destination: System.Span[int], bytes_written: typing.Optional[int], format: System.Buffers.StandardFormat = ...) -> typing.Union[bool, int]:
        """
    ...
    @staticmethod
    @overload
    def try_format(value: typing.Union[datetime.datetime, datetime.date], destination: System.Span[int], bytes_written: typing.Optional[int], format: System.Buffers.StandardFormat = ...) -> typing.Union[bool, int]:
        """
    ...
    @staticmethod
    @overload
    def try_format(value: System.Guid, destination: System.Span[int], bytes_written: typing.Optional[int], format: System.Buffers.StandardFormat = ...) -> typing.Union[bool, int]:
        """
    ...
    @staticmethod
    @overload
    def try_format(value: datetime.timedelta, destination: System.Span[int], bytes_written: typing.Optional[int], format: System.Buffers.StandardFormat = ...) -> typing.Union[bool, int]:
        """
    ...
    @staticmethod
    @overload
    def try_format(value: bool, destination: System.Span[int], bytes_written: typing.Optional[int], format: System.Buffers.StandardFormat = ...) -> typing.Union[bool, int]:
        """
...
class Utf8Parser(System.Object):
    ...
    @staticmethod
    @overload
    def try_parse(source: System.ReadOnlySpan[int], value: typing.Optional[float], bytes_consumed: typing.Optional[int], standard_format: str = ...) -> typing.Union[bool, float, int]:
        """
    ...
    @staticmethod
    @overload
    def try_parse(source: System.ReadOnlySpan[int], value: typing.Optional[typing.Union[datetime.datetime, datetime.date]], bytes_consumed: typing.Optional[int], standard_format: str = ...) -> typing.Union[bool, typing.Union[datetime.datetime, datetime.date], int]:
        """
    ...
    @staticmethod
    @overload
    def try_parse(source: System.ReadOnlySpan[int], value: typing.Optional[System.DateTimeOffset], bytes_consumed: typing.Optional[int], standard_format: str = ...) -> typing.Union[bool, System.DateTimeOffset, int]:
        """
    ...
    @staticmethod
    @overload
    def try_parse(source: System.ReadOnlySpan[int], value: typing.Optional[datetime.timedelta], bytes_consumed: typing.Optional[int], standard_format: str = ...) -> typing.Union[bool, datetime.timedelta, int]:
        """
    ...
    @staticmethod
    @overload
    def try_parse(source: System.ReadOnlySpan[int], value: typing.Optional[int], bytes_consumed: typing.Optional[int], standard_format: str = ...) -> typing.Union[bool, int, int]:
        """
    ...
    @staticmethod
    @overload
    def try_parse(source: System.ReadOnlySpan[int], value: typing.Optional[bool], bytes_consumed: typing.Optional[int], standard_format: str = ...) -> typing.Union[bool, bool, int]:
        """
    ...
    @staticmethod
    @overload
    def try_parse(source: System.ReadOnlySpan[int], value: typing.Optional[System.Guid], bytes_consumed: typing.Optional[int], standard_format: str = ...) -> typing.Union[bool, System.Guid, int]:
        """
