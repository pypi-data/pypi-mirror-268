...
class MethodBase(System.Reflection.MemberInfo, metaclass=abc.ABCMeta):
    ...
    @property
    def method_implementation_flags(self) -> int:
    ...
    def get_method_implementation_flags(self) -> int:
...
class AssemblyName(System.Object, System.ICloneable, System.Runtime.Serialization.IDeserializationCallback, System.Runtime.Serialization.ISerializable):
    ...
    @property
    def version_compatibility(self) -> int:
        """
...
class Assembly(System.Object, System.Reflection.ICustomAttributeProvider, System.Runtime.Serialization.ISerializable, metaclass=abc.ABCMeta):
    ...
    @property
    def security_rule_set(self) -> int:
...
class NullabilityInfo(System.Object):
    ...
    @property
    def element_type(self) -> System.Reflection.NullabilityInfo:
        """If the member type is an array, gives the NullabilityInfo of the elements of the array, null otherwise"""
        ...

    @property
    def generic_type_arguments(self) -> typing.List[System.Reflection.NullabilityInfo]:
...
class ManifestResourceInfo(System.Object):
    ...
    @property
    def resource_location(self) -> int:
...
class NullabilityInfoContext(System.Object):
    ...
    @overload
    def create(self, parameter_info: System.Reflection.ParameterInfo) -> System.Reflection.NullabilityInfo:
        """
        ...
        :param parameter_info: The parameter which nullability info gets populated
        :returns: NullabilityInfo.
        """
        ...

    @overload
    def create(self, property_info: System.Reflection.PropertyInfo) -> System.Reflection.NullabilityInfo:
        """
        Populates NullabilityInfo for the given PropertyInfo.
        If the nullablePublicOnly feature is set for an assembly, like it does in .NET SDK, the private and/or internal member's
        nullability attributes are omitted, in this case the API will return NullabilityState.Unknown state.
        
        :param property_info: The parameter which nullability info gets populated
        :returns: NullabilityInfo.
        """
        ...

    @overload
    def create(self, event_info: System.Reflection.EventInfo) -> System.Reflection.NullabilityInfo:
        """
        Populates NullabilityInfo for the given EventInfo.
        If the nullablePublicOnly feature is set for an assembly, like it does in .NET SDK, the private and/or internal member's
        nullability attributes are omitted, in this case the API will return NullabilityState.Unknown state.
        
        :param event_info: The parameter which nullability info gets populated
        :returns: NullabilityInfo.
        """
        ...

    @overload
    def create(self, field_info: System.Reflection.FieldInfo) -> System.Reflection.NullabilityInfo:
        """
        Populates NullabilityInfo for the given FieldInfo
        If the nullablePublicOnly feature is set for an assembly, like it does in .NET SDK, the private and/or internal member's
        nullability attributes are omitted, in this case the API will return NullabilityState.Unknown state.
        
        :param field_info: The parameter which nullability info gets populated
        :returns: NullabilityInfo.
        """
        ...
