...
import resemble.cloud.v1alpha1.auth.auth_pb2
import resemble.cloud.v1alpha1.auth.auth_pb2_grpc
import resemble.v1alpha1.options_pb2
# Additionally re-export all messages from the pb2 module.
from resemble.cloud.v1alpha1.auth.auth_pb2 import (
    APIKeyState,
    AuthenticateRequest,
...
class APIKeyServicerMiddleware(Middleware):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            service_name='resemble.cloud.v1alpha1.auth.APIKey',
        ...
        self.request_type_by_method_name: dict[str, type[google.protobuf.message.Message]] = {
            'Create': resemble.cloud.v1alpha1.auth.auth_pb2.CreateRequest,
            'Revoke': resemble.cloud.v1alpha1.auth.auth_pb2.RevokeRequest,
            'Authenticate': resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest,
        }
        ...
        if self._token_verifier is not None and self._authorizer is None:
            raise RuntimeError(
                ...
                f"'resemble.cloud.v1alpha1.auth.APIKey'"
            )

    def add_to_server(self, server: grpc.aio.Server) -> None:
        resemble.cloud.v1alpha1.auth.auth_pb2_grpc.add_APIKeyServicer_to_server(
            self, server
        )
    ...
    async def react_query(
        ...
        if method == 'Create':
            ...
            try:
                ...
                request = resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest()
                ...
                async with self._state_manager.reactively(
                    ...
                    async for (state, idempotency_keys) in states:
                        ...
                        await self._maybe_authorize(
                            method_name=
                            'resemble.cloud.v1alpha1.auth.APIKey.Authenticate',
                            headers=headers,
                            auth=context.auth,
                            state=state,
                            request=request,
    ...
    async def react_mutate(
        ...
        if method == 'Create':
            request = resemble.cloud.v1alpha1.auth.auth_pb2.CreateRequest()
            request.ParseFromString(request_bytes)
            ...
            request = resemble.cloud.v1alpha1.auth.auth_pb2.RevokeRequest()
            request.ParseFromString(request_bytes)
        ...
        try:
            ...
            if isinstance(aborted, resemble.aio.aborted.SystemAborted):
                if context.task is None:
                    logger.warning(
                        f"Unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Create') {aborted}; propagating as 'Unknown'\n" +
                ...
                raise resemble.aio.aborted.SystemAborted(
                    ...
                    # information.
                    message=f"unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Create') {aborted}"
                )
            else:
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Create') {aborted}"
                        )
                elif (
            ...
            if context.task is None:
                logger.warning(
                    f"Unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Create') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
            ...
            raise resemble.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Create') {type(exception).__name__}: {exception}"
            )
    ...
    async def _Create(
        ...
        *,
    ...
    ) -> resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse:
        ...
        if idempotent_mutation is not None:
            response = resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse()
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'resemble.cloud.v1alpha1.auth.APIKey.Create',
    ...
    async def __Revoke(
        self,
        context: WriterContext,
        state: resemble.cloud.v1alpha1.auth.auth_pb2.APIKeyState,
        request: resemble.cloud.v1alpha1.auth.auth_pb2.RevokeRequest,
        *,
        validating_effects: bool,
        ...
        try:
            ...
            if isinstance(aborted, resemble.aio.aborted.SystemAborted):
                if context.task is None:
                    logger.warning(
                        f"Unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Revoke') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(traceback.format_exception(aborted))
                    )
                raise resemble.aio.aborted.SystemAborted(
                    resemble.v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Revoke') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Revoke') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if context.task is None:
                logger.warning(
                    f"Unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Revoke') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(traceback.format_exception(exception))
                )
            raise resemble.aio.aborted.SystemAborted(
                resemble.v1alpha1.errors_pb2.Unknown(),
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Revoke') {type(exception).__name__}: {exception}"
            )
    ...
    async def _Revoke(
        ...
        *,
        validating_effects: bool,
        grpc_context: Optional[grpc.aio.ServicerContext] = None,
    ) -> resemble.cloud.v1alpha1.auth.auth_pb2.RevokeResponse:
        # Try to verify the token if a token verifier exists.
        context.auth = await self._maybe_verify_token(context._headers)
        ...
        if idempotent_mutation is not None:
            response = resemble.cloud.v1alpha1.auth.auth_pb2.RevokeResponse()
            response.ParseFromString(idempotent_mutation.response)
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'resemble.cloud.v1alpha1.auth.APIKey.Revoke',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
    ...
    async def __Authenticate(
        ...
        *,
        validating_effects: bool,
    ) -> resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse:
        try:
            response = (
            ...
            if isinstance(aborted, resemble.aio.aborted.SystemAborted):
                if context.task is None:
                    logger.warning(
                        f"Unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Authenticate') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(traceback.format_exception(aborted))
                    )
                raise resemble.aio.aborted.SystemAborted(
                    resemble.v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Authenticate') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Authenticate') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if context.task is None:
                logger.warning(
                    f"Unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Authenticate') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(traceback.format_exception(exception))
                )
            raise resemble.aio.aborted.SystemAborted(
                resemble.v1alpha1.errors_pb2.Unknown(),
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'resemble.cloud.v1alpha1.auth.APIKey.Authenticate') {type(exception).__name__}: {exception}"
            )
    ...
    async def _maybe_authorize(
        ...
        *,
        ...
        state: Optional[APIKeyStateType] = None,
        request: Optional[APIKeyRequestTypes] = None,
    ) -> None:
    ...
    def __init__(
        ...
        *,
        ...
        channel = self._channel_manager.get_channel_for(
            'resemble.cloud.v1alpha1.auth.APIKey', actor_id
        )
        self._stub = resemble.cloud.v1alpha1.auth.auth_pb2_grpc.APIKeyStub(channel)
    ...
    async def Authenticate(
        ...
        *,
        ...
        async with self._call(
            ...
            unary=True,
            reader=True,
            response_type=resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse,
            aborted_type=APIKey.AuthenticateAborted,
            metadata=metadata,
            bearer_token=bearer_token,
        ) as call:
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                unary=True,
                reader=False,
                response_type=resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse,
                aborted_type=APIKey.CreateAborted,
                metadata=metadata,
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                unary=True,
                reader=False,
                response_type=resemble.cloud.v1alpha1.auth.auth_pb2.RevokeResponse,
                aborted_type=APIKey.RevokeAborted,
                metadata=metadata,
                idempotency_key=idempotency_key,
                bearer_token=bearer_token,
...
APIKeyStateType: TypeAlias = resemble.cloud.v1alpha1.auth.auth_pb2.APIKeyState
APIKeyRequestTypes: TypeAlias = \
        resemble.cloud.v1alpha1.auth.auth_pb2.CreateRequest \
        | resemble.cloud.v1alpha1.auth.auth_pb2.RevokeRequest \
        | resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest


class APIKeyAuthorizer(
    APIKeyAuthorizerMixin,
    resemble.aio.auth.authorizers.Authorizer[APIKeyStateType, APIKeyRequestTypes],
):
    StateType: TypeAlias = APIKeyStateType
    RequestTypes: TypeAlias = APIKeyRequestTypes
    ...
    async def authorize(
        ...
        *,
        ...
        if method_name == 'resemble.cloud.v1alpha1.auth.APIKey.Create':
            return await self.Create(
                context,
                cast(resemble.cloud.v1alpha1.auth.auth_pb2.CreateRequest, request),
            )
        elif method_name == 'resemble.cloud.v1alpha1.auth.APIKey.Revoke':
            return await self.Revoke(
                context,
                cast(resemble.cloud.v1alpha1.auth.auth_pb2.APIKeyState, state),
                cast(resemble.cloud.v1alpha1.auth.auth_pb2.RevokeRequest, request),
            )
        elif method_name == 'resemble.cloud.v1alpha1.auth.APIKey.Authenticate':
            return await self.Authenticate(
                context,
                cast(resemble.cloud.v1alpha1.auth.auth_pb2.APIKeyState, state),
                cast(resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest, request),
            )
        else:
    ...
    # Off-the shelf authorizers for APIKey:

    class AllowAllIfAuthenticated(
        APIKeyAuthorizerMixin,
        resemble.aio.auth.authorizers.Authorizer,
    ):
        """An authorizer for APIKey that allows all requests if the
...
class APIKeyServicer(Servicer):
    Authorizer: TypeAlias = APIKeyAuthorizer

    __service_name__ = 'resemble.cloud.v1alpha1.auth.APIKey'
    __file_descriptor__ = resemble.cloud.v1alpha1.auth.auth_pb2.DESCRIPTOR
    __state_type__ = resemble.cloud.v1alpha1.auth.auth_pb2.APIKeyState
    ...
    def __init__(self):
        ...
        # 'create_middleware()'.
        self._middleware: Optional[APIKeyServicerMiddleware] = None
    ...
    class Effects(resemble.aio.state_managers.Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [resemble.cloud.v1alpha1.auth.auth_pb2.APIKeyState])
    ...
    class CreateEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [resemble.cloud.v1alpha1.auth.auth_pb2.APIKeyState])
            assert_type(response, [resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse])
    ...
    class RevokeEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [resemble.cloud.v1alpha1.auth.auth_pb2.APIKeyState])
            assert_type(response, [resemble.cloud.v1alpha1.auth.auth_pb2.RevokeResponse])
    ...
    class InlineWriterCallable(typing.Protocol):
        async def __call__(
            ...
            context: WriterContext,
            state: resemble.cloud.v1alpha1.auth.auth_pb2.APIKeyState
        ) -> APIKeyServicer.Effects:
            ...

    async def read(
        self, context: TransactionContext | WorkflowContext
    ) -> resemble.cloud.v1alpha1.auth.auth_pb2.APIKeyState:
            ...
            with self._middleware.use_context(
                ...
                async with self._middleware._state_manager.transactionally(
                    ...
                    async with self._middleware._state_manager.writer(
                        ...
                        effects: APIKeyServicer.Effects = await writer(
...
class APIKey:
    ...
    Interface: TypeAlias = APIKeyServicer

    Effects: TypeAlias = APIKeyServicer.Effects
    ...
    class CreateAborted(resemble.aio.aborted.Aborted):
        ...
        MethodError = Union[
resemble.cloud.v1alpha1.auth.auth_pb2.InvalidInputError        ]
...
resemble.cloud.v1alpha1.auth.auth_pb2.InvalidInputError        ]
        ...
        def is_declared_error(cls, message: google.protobuf.message.Message) -> bool:
            if message.DESCRIPTOR.full_name == 'resemble.cloud.v1alpha1.auth.InvalidInputError':
                return True
            return False


    RevokeEffects: TypeAlias = Interface.RevokeEffects

    class RevokeAborted(resemble.aio.aborted.Aborted):
    ...
    class AuthenticateAborted(resemble.aio.aborted.Aborted):
        ...
        *,
    ...
    ) -> tuple[APIKey.WeakReference, resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse]:
        if user_id is not None and not isinstance(
            ...
            raise TypeError(
                ...
                f"'resemble.cloud.v1alpha1.auth.auth_pb2.CreateRequest': field 'user_id' is not "
        ...
        return (
            reference,
            await reference._writer(__context_or_workflow__).Create(
                request,
                idempotency=idempotency,
                metadata=metadata,
                bearer_token=bearer_token,
    ...
    class WeakReference:
        ...
        def __init__(
            ...
            *,
            ...
            self._reader_stub: Optional[APIKeyReaderStub] = None
            self._writer_stub: Optional[APIKeyWriterStub] = None
            self._workflow_stub: Optional[APIKeyWorkflowStub] = None
            self._tasks_stub: Optional[APIKeyTasksStub] = None
        ...
        def _writer(
            ...
            if self._writer_stub._idempotency_manager != context_or_workflow:
                raise MixedContextsError(
                    ...
                    f"`APIKey.lookup('{self._actor_id}')`."
                )
        ...
        def schedule(
            ...
            *,
            ...
            class Tasks:
                def __init__(
                    self,
                    tasks: Callable[[TransactionContext | WorkflowContext | Workflow], APIKeyTasksStub],
                    *,
                    when: Optional[datetime | timedelta] = None,
                ):
                    self._tasks = tasks
        ...
        async def Create(
            ...
            *,
            ...
            return await self._writer(__context_or_workflow__).Create(
                request,
                idempotency=idempotency,
                metadata=metadata,
                bearer_token=bearer_token,
        ...
        async def Revoke(
            ...
            return await self._writer(__context_or_workflow__).Revoke(
                request,
                idempotency=idempotency,
                metadata=metadata,
                bearer_token=bearer_token,
        ...
        async def Authenticate(
            ...
            *,
            ...
            if secret is not None and not isinstance(
                ...
                raise TypeError(
                    f"Can not construct protobuf message of type "
                    f"'resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest': field 'secret' is not "
                    f"of required type 'str'"
                )
            # TODO: mypy-protobuf declares that
            # `google.protobuf.message.Message` constructor arguments are
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    bearer_token = __options__.bearer_token
            return await self._reader(__context_or_workflow__).Authenticate(
                request,
                metadata=metadata,
                bearer_token=bearer_token,
            )
...
class APIKeyNodeAdaptor(APIKey.WeakReference):
