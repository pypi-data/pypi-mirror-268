...
from AstecManager.libs.lineage_distance import compare_cells_by_name
import datetime
from AstecManager.libs.lineage import Get_Cell_Names,AddNodeToXML,SaveTabToTxtInfo,LoadCellList,GetCellLifetime,GetCellWholeLifetime,GetAllCellLifeFutur
def get_atlas():
    """ """
    properties_files = []
