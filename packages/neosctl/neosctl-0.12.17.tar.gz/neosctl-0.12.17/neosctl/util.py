...
def dumps_formatted_json(
    payload: typing.Union[dict, list],
    *,
    sort_keys: bool = True,
) -> str:
    """Dump formatted json.
...
def prettify_json(payload: typing.Union[dict, list]) -> str:
...
def prettify_json_no_sort(payload: typing.Union[dict, list]) -> str:
    """Dump formatted json with colour highlighting and no keys sort."""
    return highlight(dumps_formatted_json(payload, sort_keys=False), lexers.JsonLexer(), formatters.TerminalFormatter())
...
def process_response(
    ...
    render_callable: typing.Callable[[typing.Union[dict, list]], str] = prettify_json,
) -> None:
...
def _request_and_process(ctx: typer.Context, method: str, service: str, url: str, **kwargs: ...) -> None:
    render_callable = kwargs.pop("render_callable", prettify_json)
    ...
    process_response(response, render_callable)
