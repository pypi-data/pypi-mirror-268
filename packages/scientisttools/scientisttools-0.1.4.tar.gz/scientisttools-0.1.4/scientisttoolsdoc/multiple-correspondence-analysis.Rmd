---
title: '**ACM sous Python avec scientisttools**'
...
Ce tutoriel a pour objectif de présenter rapidement les principales fonctionnalités offertes par le package \og scientisttools \fg{} pour réaliser une Analyse des Correspondances Multiples. 
...
\href{https://github.com/enfantbenidedieu/scientisttools/blob/master/notebooks/mca_example.ipynb}{https://github.com/enfantbenidedieu/scientisttools/blob/master/notebooks/mca\_example.ipynb}.
