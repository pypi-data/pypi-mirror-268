---
title: '**AFDM sous Python avec scientisttools**'
...
Ce tutoriel a pour objectif de présenter rapidement les principales fonctionnalités offertes par le package \og scientisttools \fg{} pour réaliser une Analyse Factorielle des Données Mixtes. 
...
```{python,out.width="65%"}
# Carte des modalités
print(fviz_famd_mod(my_famd2,color="blue",repel=True))
```
...
\href{https://github.com/enfantbenidedieu/scientisttools/blob/master/notebooks/famd_example.ipynb}{https://github.com/enfantbenidedieu/scientisttools/blob/master/notebooks/famd\_example.ipynb}.
