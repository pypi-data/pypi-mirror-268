...
class _EWSSettings(Configuration):
    def __init__(self, create_if_inexistent: bool = True, update: bool = True) -> None:
        ...
        # TODO: This is bad with multiple processes, need to think of a better solution
        if filename.is_file():
            filename.unlink()
...
def read_settings(create_if_inexistent: bool = False, update: bool = False) -> _EWSSettings:
