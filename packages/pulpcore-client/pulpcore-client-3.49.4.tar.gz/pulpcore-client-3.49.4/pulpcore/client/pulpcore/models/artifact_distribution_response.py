...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_href=None, content_guard=None, base_path=None, pulp_created=None, base_url=None, pulp_last_updated=None, name=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
