...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_url=None, pulp_href=None, pulp_last_updated=None, pulp_labels=None, base_path=None, hidden=False, name=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
