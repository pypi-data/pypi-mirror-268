...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, content_guard=None, hidden=False, pulp_created=None, pulp_labels=None, base_path=None, base_url=None, pulp_href=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
