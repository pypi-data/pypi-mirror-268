...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, name=None, pulp_labels=None, base_path=None, base_url=None, content_guard=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
