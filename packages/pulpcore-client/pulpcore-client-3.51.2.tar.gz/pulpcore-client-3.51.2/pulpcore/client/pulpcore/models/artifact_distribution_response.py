...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, name=None, base_path=None, pulp_href=None, pulp_labels=None, hidden=False, pulp_created=None, base_url=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
