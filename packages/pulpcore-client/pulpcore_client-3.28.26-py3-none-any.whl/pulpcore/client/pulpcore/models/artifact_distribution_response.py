...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, base_url=None, content_guard=None, name=None, pulp_labels=None, pulp_created=None, pulp_href=None, base_path=None, local_vars_configuration=None):  # noqa: E501
