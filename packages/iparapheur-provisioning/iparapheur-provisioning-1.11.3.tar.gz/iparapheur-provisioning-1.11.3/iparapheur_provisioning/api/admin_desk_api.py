...
class AdminDeskApi:
    ...
    def create_desk(
        ...
        :type tenant_id: str
        :param desk_dto: (required)
        :type desk_dto: DeskDto
        ...
        _param = self._create_desk_serialize(
            tenant_id=tenant_id,
            desk_dto=desk_dto,
    ...
    @validate_call
    def create_desk_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        desk_dto: DeskDto,
        _request_timeout: Union[
    ...
    @validate_call
    def create_desk_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        desk_dto: DeskDto,
        _request_timeout: Union[
    ...
    def _create_desk_serialize(
        ...
        if desk_dto is not None:
            _body_params = desk_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/provisioning/v1/admin/tenant/{tenantId}/desk',
    ...
    def delete_desk(
        ...
        _param = self._delete_desk_serialize(
            tenant_id=tenant_id,
            desk_id=desk_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_desk_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        desk_id: Annotated[StrictStr, Field(description="Desk id")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_desk_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        desk_id: Annotated[StrictStr, Field(description="Desk id")],
        _request_timeout: Union[
    ...
    def _delete_desk_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/provisioning/v1/admin/tenant/{tenantId}/desk/{deskId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def edit_desk(
        ...
        _param = self._edit_desk_serialize(
            tenant_id=tenant_id,
            desk_id=desk_id,
            desk_dto=desk_dto,
            _request_auth=_request_auth,
    ...
    @validate_call
    def edit_desk_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        desk_id: Annotated[StrictStr, Field(description="Desk id")],
        desk_dto: DeskDto,
    ...
    def get_desk_as_admin(
        ...
        _param = self._get_desk_as_admin_serialize(
            tenant_id=tenant_id,
            desk_id=desk_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_desk_as_admin_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        desk_id: Annotated[StrictStr, Field(description="Desk id")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_desk_as_admin_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        desk_id: Annotated[StrictStr, Field(description="Desk id")],
        _request_timeout: Union[
    ...
    def _get_desk_as_admin_serialize(
        self,
        tenant_id,
        desk_id,
        _request_auth,
    ...
    def list_desks(
        ...
        _param = self._list_desks_serialize(
            tenant_id=tenant_id,
            page=page,
            size=size,
            sort=sort,
    ...
    @validate_call
    def list_desks_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
