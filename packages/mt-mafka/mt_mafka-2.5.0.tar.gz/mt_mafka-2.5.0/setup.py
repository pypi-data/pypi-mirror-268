...
setuptools.setup(
    ...
    version="2.5.0",
    description='',
    url='https://github.com/mtdev/mtkafka',
    author='mtdev',
    author_email='wuuuuusmall@outlook.com',
    long_description='A Python package that facilitates communication and interaction with Apache Kafka clusters in a multi-threaded environment.',
