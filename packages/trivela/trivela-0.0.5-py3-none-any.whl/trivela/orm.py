...
class Table:
    ...
    def __getattribute__(self, key):
        _data = super().__getattribute__(
            "_data"
        )  # avoid infinite recursion while accessing "_data" in conventional way i.e self._data
        if key in _data:
            return _data[key]
        return super().__getattribute__(key)  # avoid infinite recursion
