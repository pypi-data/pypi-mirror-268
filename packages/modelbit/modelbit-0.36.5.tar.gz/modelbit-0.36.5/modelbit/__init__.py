...
def add_models(models: Dict[str, Any],
  ...
  m_registry.set_many(_mbApi(), models=models, metrics=metrics, serializer=serializer)
...
def add_model(name: str,
  ...
  import modelbit.internal.registry as m_registry
  m_registry.set(_mbApi(), name, model=model, metrics=metrics, serializer=serializer)
