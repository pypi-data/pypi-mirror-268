...
from typing import Any, Callable, Sequence, Tuple, TypedDict, overload
...
class Viewer:
    ...
    def replay(self, evolution_robot: Sequence[State], time_interval: np.ndarray | Tuple[float, float] = ..., speed_ratio: float = 1.0, xyz_offset: np.ndarray | None = None, update_hook: Callable[[float, np.ndarray, np.ndarray], None] | None = None, enable_clock: bool = False, wait: bool = False) -> None: ...
