...
class EncoderSensor(AbstractSensor):
    def __init__(self, name: str) -> None: ...
    def initialize(self, joint_name: str) -> None: ...
    @property
    def joint_index(self) -> int:
        """
        :type: int
