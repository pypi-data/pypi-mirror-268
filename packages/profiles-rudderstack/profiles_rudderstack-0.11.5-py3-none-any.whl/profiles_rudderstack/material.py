...
from profiles_rudderstack.wht_context import WhtContextStore, WhtContext
...
class WhtMaterial:
    ...
    def get_output_folder(self) -> str:
        ...
        return output_folder_res.output_folder
    ...
    def de_ref(self, model_path: Optional[str] = None, **kwargs):
        ...
        return WhtMaterial(self.__project_id, de_ref_res.material_ref)
