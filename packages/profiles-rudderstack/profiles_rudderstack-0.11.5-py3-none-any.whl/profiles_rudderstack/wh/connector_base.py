...
class ConnectorBase:
    ...
    def get_table_data_batches(
      ...
      batch_size: int,
        ...
        to get the results in the specified batch_size

        Args:
            query: Query to be executed on the table
            batch_size: Size of the desired result set
