...
class Auth:
    ...
    def _get_tokens(self):
        ...
        response = requests.post(ACCESS_TOKEN_URL, json=json, timeout=self.REQUEST_TIMEOUT)
        try:
    ...
    def refresh_access_token(self):
        ...
        response = requests.post(REFRESH_TOKEN_URL, json=json, timeout=self.REQUEST_TIMEOUT)
        response.raise_for_status()
