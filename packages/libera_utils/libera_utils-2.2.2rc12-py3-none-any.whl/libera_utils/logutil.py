...
class JsonLogFormatter(logging.Formatter):
    ...
    _default_log_record_attrs = ('created', 'module', 'funcName', 'lineno', 'levelname')
    ...
    def __init__(
        ...
        if add_log_record_attrs is not None:
            self.add_log_record_attrs = self._default_log_record_attrs
...
def configure_task_logging(task_id: str,
                           ...
                           log_dir: Optional[str | Path | S3Path] = None,
