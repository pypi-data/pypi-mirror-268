...
from typing import Any, Union, Sequence, Optional, Generator
...
:param str|os.PathLike|Sequence[str] location: The file(s) to import. This can be a local file path or a remote *sftp://* or *https://* URL (see below).
...
:returns: The new :py:class:`Pipeline` that has been created for the imported data.
...
Note that the :py:class:`Pipeline` is not automatically inserted into the three-dimensional scene.
...
``"mmcif"``, ``"netcdf/amber"``, ``"obj"``, ``"oxdna"``, ``"parcas"``, ``"pdb"``, ``"quantumespresso"``, ``"reaxff/bonds"``,
...
def export_file(data: Union[ovito.pipeline.Pipeline, ovito.data.DataObject, None], file: Union[str, os.PathLike], format: str, **params: Any) -> None:
...
:param str|os.PathLike file: The output file path.
:param str format: The kind of file to write. See available options below.
...
``"txt/table"``               Export a :py:class:`DataTable` to a text file
