...
setup(
    ...
    description="Type annotations for aioboto3 12.4.0 generated with mypy-boto3-builder 7.23.2",
    classifiers=[
    ...
    extras_require={
        ...
        "aioboto3": ["aioboto3==12.4.0", "botocore==1.34.69"],
        ...
        "backupstorage": ["types-aiobotocore-backupstorage"],
