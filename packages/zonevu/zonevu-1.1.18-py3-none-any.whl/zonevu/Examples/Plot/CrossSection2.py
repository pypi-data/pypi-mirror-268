...
from ...DataModels.Geosteering.Calcs import make_blocks, calc_percent_in_zone
    ...
    if plot_geosteering:
        ...
        for block in blocks:
            for layer in block.layers:
                ...
                ax.plot(x, y, color=horz_color, linewidth=line_width, zorder=1, linestyle=line_style)
