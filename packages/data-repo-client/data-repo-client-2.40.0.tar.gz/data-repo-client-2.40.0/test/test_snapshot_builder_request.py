...
from data_repo_client.models.snapshot_builder_request import SnapshotBuilderRequest  # noqa: E501
from data_repo_client.rest import ApiException

class TestSnapshotBuilderRequest(unittest.TestCase):
    """SnapshotBuilderRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SnapshotBuilderRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = data_repo_client.models.snapshot_builder_request.SnapshotBuilderRequest()  # noqa: E501
        if include_optional :
            return SnapshotBuilderRequest(
                cohorts = [
                ...
                value_sets = [
                    data_repo_client.models.snapshot_builder_feature_value_group.SnapshotBuilderFeatureValueGroup(
                        name = '0', 
                        values = [
                            '0'
                            ], )
    ...
    def testSnapshotBuilderRequest(self):
        """Test SnapshotBuilderRequest"""
