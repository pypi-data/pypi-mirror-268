...
from syntrac_opentelemetry.instrumentation.openai.shared import (
    _set_span_attribute,
    model_as_dict,
)
...
from syntrac_opentelemetry.semconv.ai import SpanAttributes, LLMRequestTypeValues

from syntrac_opentelemetry.instrumentation.openai.utils import _with_tracer_wrapper
from syntrac_opentelemetry.instrumentation.openai.shared.config import Config
...
def runs_create_and_stream_wrapper(tracer, wrapped, instance, args, kwargs):
    ...
    from syntrac_opentelemetry.instrumentation.openai.v1.event_handler_wrapper import (
        EventHandleWrapper,
    )
