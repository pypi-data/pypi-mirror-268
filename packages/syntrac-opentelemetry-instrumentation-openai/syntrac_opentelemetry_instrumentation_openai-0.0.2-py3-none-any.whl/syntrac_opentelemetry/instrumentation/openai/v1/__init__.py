...
from syntrac_opentelemetry.instrumentation.openai.shared.image_gen_wrappers import (
    image_gen_metrics_wrapper,
)
from syntrac_opentelemetry.instrumentation.openai.v1.assistant_wrappers import (
...
from syntrac_opentelemetry.instrumentation.openai.utils import is_metrics_enabled
