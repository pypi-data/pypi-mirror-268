...
class AppServiceApi:
    ...
    def create_app(
        ...
        **kwargs,
        ...
        >>> thread = api.create_app(app_name, body, async_req=True)
        >>> result = thread.get()

        :param app_name: app name (required)
        :type app_name: str
        :param body: (required)
        :type body: AppServiceCreateBody
    ...
    def create_app_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.create_app_with_http_info(app_name, body, async_req=True)
        >>> result = thread.get()
    ...
    def deploy_app(
        ...
        **kwargs,
        ...
        >>> thread = api.deploy_app(app_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the deploy_app_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.deploy_app_with_http_info(
            app_name,
            **kwargs,
        )
    ...
    def deploy_app_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.deploy_app_with_http_info(app_name, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/apps/v1/{appName}/deploy', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def get_app(
        ...
        **kwargs,
        ...
        >>> thread = api.get_app(app_name, async_req=True)
        >>> result = thread.get()
    ...
    def get_app_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.get_app_with_http_info(app_name, async_req=True)
        >>> result = thread.get()
    ...
    def pause_app(
        ...
        **kwargs,
        ...
        >>> thread = api.pause_app(app_name, async_req=True)
        >>> result = thread.get()
    ...
    def pause_app_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.pause_app_with_http_info(app_name, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/apps/v1/{appName}/pause', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def setup_auto_scaling_policy(
        ...
        **kwargs,
        ...
        >>> thread = api.setup_auto_scaling_policy(app_name, body, async_req=True)
        >>> result = thread.get()

        :param app_name: app name (required)
        :type app_name: str
        :param body: (required)
        :type body: AppServiceSetupAutoScalingPolicyBody
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the setup_auto_scaling_policy_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.setup_auto_scaling_policy_with_http_info(
            app_name,
            body,
            **kwargs,
        )
    ...
    @validate_call
    def setup_auto_scaling_policy_with_http_info(
        self,
        app_name: Annotated[StrictStr, Field(description="app name")],
        body: AppServiceSetupAutoScalingPolicyBody,
        **kwargs,
        ...
        >>> thread = api.setup_auto_scaling_policy_with_http_info(app_name, body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method setup_auto_scaling_policy" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/apps/v1/{appName}/setup/auto_scaling', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def setup_image(
        ...
        **kwargs,
        ...
        >>> thread = api.setup_image(app_name, body, async_req=True)
        >>> result = thread.get()

        :param app_name: app name (required)
        :type app_name: str
        :param body: (required)
        :type body: V1AppServiceSetupImageBody
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
    ...
    def setup_image_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.setup_image_with_http_info(app_name, body, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/apps/v1/{appName}/setup/image', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def setup_resources(
        ...
        **kwargs,
        ...
        >>> thread = api.setup_resources(app_name, body, async_req=True)
        >>> result = thread.get()
    ...
    def setup_resources_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.setup_resources_with_http_info(app_name, body, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/apps/v1/{appName}/setup/resource', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def setup_secrets(
        self,
        app_name: Annotated[StrictStr, Field(description="app name")],
        body: AppServiceSetupSecretsBody,
        **kwargs,
    ) -> object:
        ...
        >>> thread = api.setup_secrets(app_name, body, async_req=True)
        >>> result = thread.get()

        :param app_name: app name (required)
        :type app_name: str
        :param body: (required)
        :type body: AppServiceSetupSecretsBody
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the setup_secrets_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.setup_secrets_with_http_info(
            app_name,
            body,
            **kwargs,
        )
    ...
    @validate_call
    def setup_secrets_with_http_info(
        self,
        app_name: Annotated[StrictStr, Field(description="app name")],
        body: AppServiceSetupSecretsBody,
        **kwargs,
        ...
        >>> thread = api.setup_secrets_with_http_info(app_name, body, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/apps/v1/{appName}/setup/secrets', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def setup_volumes(
        ...
        **kwargs,
        ...
        >>> thread = api.setup_volumes(app_name, body, async_req=True)
        >>> result = thread.get()
    ...
    def setup_volumes_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.setup_volumes_with_http_info(app_name, body, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/apps/v1/{appName}/setup/volumes', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
