...
class NewAudioSourceRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_options", b"_options", "num_channels", b"num_channels", "options", b"options", "sample_rate", b"sample_rate", "type", b"type"]) -> None: ...
