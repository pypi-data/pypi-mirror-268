...
'''
	Details about this can be found in "vegan.shows.nature".
'''
...
#
import vegan.shows.natures.assertions as natures_assertions
#
import vegan.clouds.food_USDA.interpret.packageWeight as package_weight
import vegan.clouds.food_USDA.interpret.packageWeight.assertions as package_weight_assertions
#
import vegan.clouds.food_USDA.nature.cautionary_ingredients as calculate_cautionary_ingredients
import vegan.clouds.food_USDA.nature.form as recommendation_builder
import vegan.clouds.food_USDA.nature.measured_ingredients_list as measured_ingredients_list_builder
import vegan.clouds.food_USDA.nature.measured_ingredients_list.seek as mil_seek
import vegan.clouds.food_USDA.nature.essential_nutrients as calculate_essential_nutrients
import vegan.clouds.food_USDA.nature.form as calculate_form
#
import copy
