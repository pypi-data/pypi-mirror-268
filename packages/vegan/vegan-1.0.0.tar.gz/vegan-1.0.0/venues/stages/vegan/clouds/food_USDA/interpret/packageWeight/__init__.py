...
import vegan.clouds.food_USDA.interpret.packageWeight.interpret as interpreter
import vegan.clouds.food_USDA.interpret.packageWeight.assertions as assertions
