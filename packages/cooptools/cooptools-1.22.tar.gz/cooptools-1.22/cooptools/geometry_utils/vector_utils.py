...
def rads(a: FloatVec) -> float:
    if a[0] == 0:
        return float('inf')
    return math.atan(a[1] / a[0])

def degrees(a: FloatVec) -> float:
    return rads_to_degrees(rads(a))

def rads_between(a: FloatVec, b: FloatVec) -> float:
    return rads(a) - rads(b)


    # return math.acos(dot(a, b) / (vector_len(a) * vector_len(b)))

def degrees_between(a: FloatVec, b: FloatVec) -> float:
    return rads_to_degrees(rads_between(a, b))
...
if __name__ == "__main__":
    ...
    def test_1():
        ...
        print(rads_between(v1, v2))
        print(rads_between(v2, v1))
