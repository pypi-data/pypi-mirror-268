...
def resolve_from_json_file(config_filepath: str,
    ...
    if config not in file_config.keys() and fallback_val is not None:
        return fallback_val
...
class JsonConfigHandler:
    ...
    def resolve(self,
                ...
                fallback_None: bool = False):
        self.file_handler.verify_config_set()
        val = resolve_from_json_file(self.file_handler.FilePath, config, is_bool=is_bool, fallback_val=fallback_val, fallback_None=fallback_None)
