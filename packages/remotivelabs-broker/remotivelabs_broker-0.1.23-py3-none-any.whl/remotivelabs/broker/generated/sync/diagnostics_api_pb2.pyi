...
class PublisherConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["link", b"link", "linkTimers", b"linkTimers", "payload", b"payload"]) -> None: ...
...
class SubscriberConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["link", b"link", "linkTimers", b"linkTimers", "rawPayload", b"rawPayload"]) -> None: ...
