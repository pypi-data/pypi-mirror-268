...
class DatasetRevision(Protocol):
    ...
    def to_polars(
        ...
        output_ts
            ...
            If set to a non-empty `str`, used as the timestamp column name.
        ignore_errors
    ...
    def ingest(self, store_online: bool = False, store_offline: bool = True) -> None:
        """
...
class Dataset(Protocol):
    ...
    def resolver_replay(
        self, resolver: ResolverProtocol, show_progress: bool = True, timeout: float | timedelta | ellipsis | None = ...
    ) -> Union[pl.DataFrame, pl.LazyFrame, Mapping[str, pl.DataFrame], Mapping[str, pl.LazyFrame]]:
        """
