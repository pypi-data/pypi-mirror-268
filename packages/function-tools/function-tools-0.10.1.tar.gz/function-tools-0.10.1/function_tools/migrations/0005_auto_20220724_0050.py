...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Entity',
            fields=[
                ('uuid', models.UUIDField(primary_key=True, serialize=False, unique=True, verbose_name='Уникальный идентификатор')),
                ...
                ('verbose_name', models.CharField(default='Имя сущности не определено', max_length=512, verbose_name='Человеко читаемое название')),
                ('tags', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=128), default=list, size=None)),
        ...
        migrations.AddField(
            model_name='entity',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='function_tools.EntityType', verbose_name='Тип сущности'),
        ),
    ]
