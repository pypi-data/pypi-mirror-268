...
setup(
    ...
    extras_require={
        "tests": [
            ...
            "dbt-postgres",
            "dbt-duckdb",
            "dagster-dbt==0.23.2rc1",
            "dagster_k8s==0.23.2rc1",
        ],
        "insights": ["pyarrow"],
        "docker": ["docker", "dagster_docker==0.23.2rc1"],
        "kubernetes": ["kubernetes", "dagster_k8s==0.23.2rc1"],
        "ecs": ["dagster_aws==0.23.2rc1", "boto3"],
        "sandbox": ["supervisor"],
        "pex": ["boto3"],
        "serverless": ["boto3"],
    },
