...
setup(
    ...
    extras_require={
        "tests": [
            ...
            "dbt-postgres",
            "dbt-duckdb",
            "dagster-dbt==0.23.2rc4",
            "dagster_k8s==0.23.2rc4",
        ],
        "insights": ["pyarrow"],
        "docker": ["docker", "dagster_docker==0.23.2rc4"],
        "kubernetes": ["kubernetes", "dagster_k8s==0.23.2rc4"],
        "ecs": ["dagster_aws==0.23.2rc4", "boto3"],
        "sandbox": ["supervisor"],
        "pex": ["boto3"],
        "serverless": ["boto3"],
    },
