...
from openapi_client import V1Autoscaling
from openapi_client import V1Autoscaling as Autoscaling
from vessl import vessl_api
from vessl.cli._util import print_error, print_info, print_success, print_warning
...
def read_service(service_name: str) -> ResponseModelServiceInfo:
...
def update_revision_autoscaler_config(
    ...
    Args:
        ...
        service_name(str): The name of the service.
        revision_number(int): The revision number of the service.
        autoscaling(AutoScalerConfig): The autoscaler config of the service(servev1/Autoscaling).
    ...
    Example:
        ...
        vessl.update_revision_autoscaler_config(
            ...
            service_name="my-service",
            revision_number=1,
            auto_scaler_config=Autoscaling(
                min=1,
                max=2,
...
def update_revision_autoscaling_v2(
    ...
    Args:
        ...
        autoscaling(Autoscaling): The autoscaler config of the serving.
...
def update_gateway_for_revision(
    ...
    Examples:
        ...
        ```
    """
    gateway_current = read_gateway(organization=organization, service_name=service_name)
...
def abort_in_progress_rollout_by_name(service_name: str) -> bool:
    service = read_service(service_name)
