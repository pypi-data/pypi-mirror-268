...
def plot_embedding(
    ...
    if dimensions == 3:  # if input dimension is 3
        ...
        ax_style_x = dict(showbackground =False,
        ...
        ax_style_y = dict(showbackground =False,
                backgroundcolor="rgb(240, 240, 240)",
                showgrid=True,
                showline=True,
                linecolor='black',
        ...
        ax_style_z = dict(showbackground =False,
                backgroundcolor="rgb(240, 240, 240)",
                showgrid=True,
                showline=True,
                linecolor='black',
        ...
        if z_axis is not None:
            ...
            for i in range(len(SETS)):  # number of different traces in plot
                ...
                fig.data[i].hovertemplate = (
                    ...
                    + "PCo1: %{x}<br>"
                    + "PCo2: %{y}<br>"
                    + f"{z_axis}: %{metadata[z_axis][idx_meta]}<br>"
                )
    ...
    # ─── 2d Plot ──────────────────────────────────────────────────────────
        ...
        fig.update_layout(
            ...
            xaxis2=dict(
                zeroline=True, linecolor='black',
                linewidth=2, showticklabels=True,
                domain=[0.85, 1], showgrid=True
            ),
            yaxis2=dict(
                zeroline=True, linecolor='black',
                linewidth=2, showticklabels=True,
