...
def main():
    ...
    try:
        ...
        # ─── Normal Pear ──────────────────────────────────────────────────────
            ...
            if method not in ("hashrf_RF", "hashrf_wRF", "smart_RF", "tqdist_quartet", "tqdist_triplet", None):
                sys.exit("Invalid method - choose among: hashrf_RF, hashrf_wRF, smart_RF, tqdist_quartet, tqdist_triplet")
