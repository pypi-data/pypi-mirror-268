...
def user_decision_on_suggestions(detailed_patient_data):
    """
    ...
    # Otherwise, allow the user to adjust the endpoints manually.
        ...
        return select_and_adjust_files(detailed_patient_data)
...
def select_and_adjust_files(detailed_patient_data):
    """
    ...
    # BUG This should actually come dynamically from the JSON config file rather than being hardcoded.
    endpoint_mapping = {'1': 'AVAILITY', '2': 'OPTUMEDI', '3': 'PNT_DATA'}
...
def handle_submission(detailed_patient_data, config):
    ...
    adjusted_data = user_decision_on_suggestions(detailed_patient_data)
