...
class ImporterDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, programManager: ghidra.app.services.ProgramManager, loaderMap: ghidra.app.util.opinion.LoaderMap, byteProvider: ghidra.app.util.bin.ByteProvider, suggestedDestinationPath: unicode):
        """
    ...
    def setDestinationFolder(self, folder: ghidra.framework.model.DomainFolder) -> None:
        """
    ...
    @property
    def destinationFolder(self) -> None: ...  # No getter available.

    @destinationFolder.setter
    def destinationFolder(self, value: ghidra.framework.model.DomainFolder) -> None: ...