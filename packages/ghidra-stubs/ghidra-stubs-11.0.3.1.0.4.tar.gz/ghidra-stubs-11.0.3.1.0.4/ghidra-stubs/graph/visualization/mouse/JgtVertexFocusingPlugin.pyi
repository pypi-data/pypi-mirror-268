...
class JgtVertexFocusingPlugin(ghidra.graph.visualization.mouse.AbstractJgtGraphMousePlugin):




    def __init__(self, __a0: int, __a1: ghidra.graph.visualization.DefaultGraphDisplay): ...
