...
class GraphExporterDialog(docking.DialogComponentProvider):




    def __init__(self, __a0: ghidra.service.graph.AttributedGraph, __a1: List[object]): ...
    ...
    def setExporter(self, __a0: ghidra.service.graph.AttributedGraphExporter) -> None: ...

    def setFilePath(self, __a0: unicode) -> None: ...
    ...
    def setOutputFile(self, __a0: unicode) -> None: ...
    ...
    @property
    def exporter(self) -> None: ...  # No getter available.

    @exporter.setter
    def exporter(self, value: ghidra.service.graph.AttributedGraphExporter) -> None: ...

    @property
    def filePath(self) -> None: ...  # No getter available.

    @filePath.setter
    def filePath(self, value: unicode) -> None: ...

    @property
    def outputFile(self) -> None: ...  # No getter available.

    @outputFile.setter
    def outputFile(self, value: unicode) -> None: ...