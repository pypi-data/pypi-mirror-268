...
class BlockGraphTask(ghidra.util.task.Task):
    ...
    def __init__(self, __a0: ghidra.graph.ProgramGraphType, __a1: bool, __a2: bool, __a3: bool, __a4: ghidra.framework.plugintool.PluginTool, __a5: ghidra.program.util.ProgramSelection, __a6: ghidra.program.util.ProgramLocation, __a7: ghidra.program.model.block.CodeBlockModel, __a8: ghidra.service.graph.GraphDisplayProvider): ...
