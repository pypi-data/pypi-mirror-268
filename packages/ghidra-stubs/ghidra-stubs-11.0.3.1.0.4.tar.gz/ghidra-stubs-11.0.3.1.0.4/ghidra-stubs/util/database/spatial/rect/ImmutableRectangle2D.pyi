...
class ImmutableRectangle2D(object, ghidra.util.database.spatial.rect.Rectangle2D):




    def __init__(self, __a0: object, __a1: object, __a2: object, __a3: object, __a4: ghidra.util.database.spatial.rect.EuclideanSpace2D): ...
