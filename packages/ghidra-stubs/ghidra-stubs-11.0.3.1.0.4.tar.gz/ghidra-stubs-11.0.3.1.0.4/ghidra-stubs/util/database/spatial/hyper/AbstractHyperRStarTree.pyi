...
class AbstractHyperRStarTree(ghidra.util.database.spatial.AbstractRStarConstraintsTree):




    def __init__(self, __a0: ghidra.util.database.DBCachedObjectStoreFactory, __a1: unicode, __a2: ghidra.util.database.spatial.hyper.EuclideanHyperSpace, __a3: java.lang.Class, __a4: java.lang.Class, __a5: bool, __a6: int): ...
