...
class DBCachedObjectStoreFoundKeysValueCollection(object, java.util.Collection):




    def __init__(self, __a0: ghidra.util.database.DBCachedObjectStore, __a1: db.util.ErrorHandler, __a2: java.util.concurrent.locks.ReadWriteLock, __a3: List[db.Field]): ...
