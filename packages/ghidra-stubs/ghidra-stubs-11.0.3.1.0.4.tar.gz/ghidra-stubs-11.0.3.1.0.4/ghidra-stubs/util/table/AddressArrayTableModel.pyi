...
class AddressArrayTableModel(ghidra.util.table.AddressPreviewTableModel):
    """
    ...
    @overload
    def __init__(self, title: unicode, serviceProvider: ghidra.framework.plugintool.ServiceProvider, prog: ghidra.program.model.listing.Program, addrs: List[ghidra.program.model.address.Address]):
        """
        Constructor.
    ...
    @overload
    def __init__(self, title: unicode, serviceProvider: ghidra.framework.plugintool.ServiceProvider, prog: ghidra.program.model.listing.Program, addrs: List[ghidra.program.model.address.Address], monitor: ghidra.util.task.TaskMonitor):
        """
        Constructor.
        @param title title of the query
        @param serviceProvider from which to get services
    ...
    def getHeaderRenderer(self, index: int) -> javax.swing.table.TableCellRenderer:
        """
    ...
    def setAddresses(self, addresses: List[ghidra.program.model.address.Address]) -> None: ...
    ...
    @property
    def addresses(self) -> None: ...  # No getter available.

    @addresses.setter
    def addresses(self, value: List[ghidra.program.model.address.Address]) -> None: ...