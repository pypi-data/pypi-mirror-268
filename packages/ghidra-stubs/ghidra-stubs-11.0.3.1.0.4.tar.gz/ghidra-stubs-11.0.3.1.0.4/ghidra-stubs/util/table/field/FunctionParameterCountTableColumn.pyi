...
class FunctionParameterCountTableColumn(ghidra.util.table.field.ProgramLocationTableColumnExtensionPoint):
    ...
    @overload
    def getValue(self, rowObject: ghidra.program.model.address.Address, settings: ghidra.docking.settings.Settings, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> int: ...
