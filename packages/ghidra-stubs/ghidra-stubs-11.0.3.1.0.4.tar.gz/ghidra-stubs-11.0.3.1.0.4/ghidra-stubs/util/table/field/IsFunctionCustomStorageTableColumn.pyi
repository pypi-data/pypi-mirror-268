...
class IsFunctionCustomStorageTableColumn(ghidra.util.table.field.ProgramBasedDynamicTableColumnExtensionPoint):
    ...
    @overload
    def getValue(self, rowObject: ghidra.program.model.listing.Function, settings: ghidra.docking.settings.Settings, data: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> bool: ...
