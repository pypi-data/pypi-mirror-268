...
class TwoWayBreakdownAddressRangeIterator(ghidra.util.AbstractPeekableIterator):
    ...
    class Which(java.lang.Enum):
        BOTH: ghidra.util.TwoWayBreakdownAddressRangeIterator.Which = BOTH
        LEFT: ghidra.util.TwoWayBreakdownAddressRangeIterator.Which = LEFT
        RIGHT: ghidra.util.TwoWayBreakdownAddressRangeIterator.Which = RIGHT
        includesLeft: bool
        includesRight: bool
