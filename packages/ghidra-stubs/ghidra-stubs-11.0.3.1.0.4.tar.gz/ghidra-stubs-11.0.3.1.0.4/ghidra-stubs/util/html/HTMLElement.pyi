...
class HTMLElement(java.util.ArrayList):
    ...
    def addElement(self, elementName: unicode) -> ghidra.util.html.HTMLElement: ...

    def addFirst(self, __a0: object) -> None: ...

    def addHTMLContent(self, htmlContent: unicode) -> None: ...
    ...
    def putAttribute(self, key: unicode, value: unicode) -> unicode: ...
