...
class DebuggerModelTypeException(ghidra.dbg.error.DebuggerRuntimeException):
    ...
    @staticmethod
    def linkForbidden(__a0: ghidra.dbg.target.TargetObject, __a1: List[object]) -> ghidra.dbg.error.DebuggerModelTypeException: ...
    ...
    @staticmethod
    def typeRequired(__a0: object, __a1: List[object], __a2: java.lang.Class) -> ghidra.dbg.error.DebuggerModelTypeException: ...
