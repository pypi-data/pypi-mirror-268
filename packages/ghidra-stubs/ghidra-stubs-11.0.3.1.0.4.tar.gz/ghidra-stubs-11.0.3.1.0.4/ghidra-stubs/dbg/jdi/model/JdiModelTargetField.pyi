...
class JdiModelTargetField(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl):




    def __init__(self, __a0: ghidra.dbg.jdi.model.iface2.JdiModelTargetObject, __a1: com.sun.jdi.Field, __a2: bool): ...



    def acceptsElement(self, __a0: unicode) -> bool: ...

    def addAccessWatchpoint(self) -> ghidra.dbg.jdi.manager.breakpoint.JdiBreakpointInfo: ...

    def addModificationWatchpoint(self) -> ghidra.dbg.jdi.manager.breakpoint.JdiBreakpointInfo: ...
