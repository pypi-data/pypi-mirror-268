...
class JdiModelTargetMethodContainer(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl):
    ...
    def getMethodsByName(self) -> java.util.Map: ...
    ...
    def getTargetMethodIfPresent(self, __a0: unicode) -> ghidra.dbg.jdi.model.JdiModelTargetMethod: ...
    ...
    @property
    def methodsByName(self) -> java.util.Map: ...