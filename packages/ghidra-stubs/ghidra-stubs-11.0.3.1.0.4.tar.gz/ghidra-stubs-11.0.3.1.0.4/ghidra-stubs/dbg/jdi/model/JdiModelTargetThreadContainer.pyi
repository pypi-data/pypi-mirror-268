...
class JdiModelTargetThreadContainer(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl, ghidra.dbg.jdi.model.iface1.JdiModelTargetEventScope, ghidra.dbg.jdi.manager.JdiEventsListenerAdapter):




    def __init__(self, __a0: ghidra.dbg.jdi.model.iface2.JdiModelTargetObject, __a1: unicode, __a2: List[object]): ...
    ...
    def getTargetThread(self, __a0: com.sun.jdi.ThreadReference) -> ghidra.dbg.jdi.model.JdiModelTargetThread: ...

    def getTargetThreadIfPresent(self, __a0: unicode) -> ghidra.dbg.jdi.model.JdiModelTargetThread: ...
    ...
    def threadCreated(self, __a0: com.sun.jdi.ThreadReference) -> ghidra.dbg.jdi.model.JdiModelTargetThread: ...

    @overload
    def threadExited(self, __a0: com.sun.jdi.ThreadReference) -> None: ...
