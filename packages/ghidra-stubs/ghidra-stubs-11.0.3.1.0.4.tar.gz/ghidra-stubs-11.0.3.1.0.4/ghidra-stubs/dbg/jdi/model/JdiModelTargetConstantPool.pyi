...
class JdiModelTargetConstantPool(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl, ghidra.dbg.target.TargetMemoryRegion, ghidra.dbg.target.TargetSection):




    def __init__(self, __a0: ghidra.dbg.jdi.model.JdiModelTargetSectionContainer, __a1: List[int], __a2: bool): ...
