...
class JdiModelTargetValueContainer(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl):
    ...
    def getTargetValueIfPresent(self, __a0: unicode) -> ghidra.dbg.jdi.model.JdiModelTargetValue: ...
