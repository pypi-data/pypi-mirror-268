...
class JdiModelTargetBreakpointContainer(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl, ghidra.dbg.target.TargetBreakpointSpecContainer, ghidra.dbg.jdi.manager.JdiEventsListenerAdapter):




    def __init__(self, __a0: ghidra.dbg.jdi.model.JdiModelTargetVM): ...
    ...
    def getTargetBreakpointSpec(self, __a0: ghidra.dbg.jdi.manager.breakpoint.JdiBreakpointInfo) -> ghidra.dbg.jdi.model.JdiModelTargetBreakpointSpec: ...
    ...
    def requestElements(self, __a0: ghidra.dbg.DebuggerObjectModel.RefreshBehavior) -> java.util.concurrent.CompletableFuture: ...
