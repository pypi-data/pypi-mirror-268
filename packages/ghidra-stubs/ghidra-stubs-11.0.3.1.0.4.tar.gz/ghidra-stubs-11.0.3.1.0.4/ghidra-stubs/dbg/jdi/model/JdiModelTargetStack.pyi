...
class JdiModelTargetStack(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl, ghidra.dbg.target.TargetStack):
    ...
    @overload
    def getTargetFrame(self, __a0: int) -> ghidra.dbg.jdi.model.JdiModelTargetStackFrame: ...

    @overload
    def getTargetFrame(self, __a0: com.sun.jdi.StackFrame) -> ghidra.dbg.jdi.model.JdiModelTargetStackFrame: ...
