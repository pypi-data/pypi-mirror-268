...
class JdiModelTargetClassContainer(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl):
    ...
    def getClassesByName(self) -> java.util.Map: ...
    ...
    def getTargetModuleIfPresent(self, __a0: unicode) -> ghidra.dbg.jdi.model.JdiModelTargetReferenceType: ...
    ...
    @property
    def classesByName(self) -> java.util.Map: ...