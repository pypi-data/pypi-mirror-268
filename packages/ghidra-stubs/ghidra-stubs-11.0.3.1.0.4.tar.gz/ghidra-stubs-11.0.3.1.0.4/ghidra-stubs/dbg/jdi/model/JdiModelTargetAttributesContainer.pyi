...
class JdiModelTargetAttributesContainer(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl, ghidra.dbg.jdi.manager.JdiEventsListenerAdapter):




    def __init__(self, __a0: ghidra.dbg.jdi.model.iface2.JdiModelTargetObject, __a1: unicode): ...
    ...
    def addAttributes(self, __a0: java.util.Map) -> None: ...
