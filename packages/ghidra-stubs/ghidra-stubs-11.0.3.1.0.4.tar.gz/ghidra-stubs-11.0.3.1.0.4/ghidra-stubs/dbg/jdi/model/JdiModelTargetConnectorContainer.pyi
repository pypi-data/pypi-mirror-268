...
class JdiModelTargetConnectorContainer(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl):




    def __init__(self, __a0: ghidra.dbg.jdi.model.JdiModelTargetRoot): ...
    ...
    def getDefaultConnector(self) -> ghidra.dbg.jdi.model.JdiModelTargetConnector: ...
    ...
    def getTargetConnectorIfPresent(self, __a0: unicode) -> ghidra.dbg.jdi.model.JdiModelTargetConnector: ...
    ...
    def refreshInternal(self) -> java.util.concurrent.CompletableFuture: ...
    ...
    def setDefaultConnector(self, __a0: ghidra.dbg.jdi.model.JdiModelTargetConnector) -> None: ...
    ...
    @property
    def defaultConnector(self) -> ghidra.dbg.jdi.model.JdiModelTargetConnector: ...

    @defaultConnector.setter
    def defaultConnector(self, value: ghidra.dbg.jdi.model.JdiModelTargetConnector) -> None: ...