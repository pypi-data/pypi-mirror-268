...
class PathUtils(java.lang.Enum):
    ...
    class TargetObjectKeyComparator(java.lang.Enum, java.util.Comparator):
        ATTRIBUTE: ghidra.dbg.util.PathUtils.TargetObjectKeyComparator = ATTRIBUTE
        CHILD: ghidra.dbg.util.PathUtils.TargetObjectKeyComparator = CHILD
        ELEMENT: ghidra.dbg.util.PathUtils.TargetObjectKeyComparator = ELEMENT
        ELEMENT_DIM: ghidra.dbg.util.PathUtils.TargetObjectKeyComparator = ELEMENT_DIM
    ...
    class PathComparator(java.lang.Enum, java.util.Comparator):
        KEYED: ghidra.dbg.util.PathUtils.PathComparator = KEYED
        LONGEST_FIRST: ghidra.dbg.util.PathUtils.PathComparator = LONGEST_FIRST
