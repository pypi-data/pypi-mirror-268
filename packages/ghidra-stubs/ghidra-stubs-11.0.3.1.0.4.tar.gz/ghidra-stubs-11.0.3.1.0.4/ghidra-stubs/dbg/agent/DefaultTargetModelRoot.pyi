...
class DefaultTargetModelRoot(ghidra.dbg.agent.DefaultTargetObject, ghidra.dbg.target.TargetAggregate):




    @overload
    def __init__(self, __a0: ghidra.dbg.agent.AbstractDebuggerObjectModel, __a1: unicode): ...

    @overload
    def __init__(self, __a0: ghidra.dbg.agent.AbstractDebuggerObjectModel, __a1: unicode, __a2: ghidra.dbg.target.schema.TargetObjectSchema): ...
