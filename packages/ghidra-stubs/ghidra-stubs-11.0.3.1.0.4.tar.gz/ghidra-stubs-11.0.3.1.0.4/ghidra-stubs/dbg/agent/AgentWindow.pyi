...
class AgentWindow(javax.swing.JFrame, java.awt.event.WindowListener, log.LogListener):
    MAX_LOG_CHARS: int = 100000



    def __init__(self, __a0: unicode, __a1: java.net.SocketAddress): ...
    ...
    @staticmethod
    def getFrames() -> List[java.awt.Frame]: ...
    ...
    def getMaximizedBounds(self) -> java.awt.Rectangle: ...

    def getMaximumSize(self) -> java.awt.Dimension: ...

    def getMenuBar(self) -> java.awt.MenuBar: ...
    ...
    def messageLogged(self, __a0: unicode, __a1: bool) -> None: ...
    ...
    @overload
    def setCursor(self, __a0: int) -> None: ...
    ...
    def setExtendedState(self, __a0: int) -> None: ...
    ...
    def setMaximizedBounds(self, __a0: java.awt.Rectangle) -> None: ...

    def setMaximumSize(self, __a0: java.awt.Dimension) -> None: ...

    def setMenuBar(self, __a0: java.awt.MenuBar) -> None: ...
    ...
    def windowActivated(self, __a0: java.awt.event.WindowEvent) -> None: ...

    def windowClosed(self, __a0: java.awt.event.WindowEvent) -> None: ...

    def windowClosing(self, __a0: java.awt.event.WindowEvent) -> None: ...

    def windowDeactivated(self, __a0: java.awt.event.WindowEvent) -> None: ...

    def windowDeiconified(self, __a0: java.awt.event.WindowEvent) -> None: ...

    def windowIconified(self, __a0: java.awt.event.WindowEvent) -> None: ...

    def windowOpened(self, __a0: java.awt.event.WindowEvent) -> None: ...
