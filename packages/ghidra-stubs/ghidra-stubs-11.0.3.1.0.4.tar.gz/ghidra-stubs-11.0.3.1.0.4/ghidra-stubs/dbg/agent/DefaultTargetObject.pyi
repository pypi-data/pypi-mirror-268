...
class DefaultTargetObject(ghidra.dbg.agent.AbstractTargetObject):




    @overload
    def __init__(self, __a0: ghidra.dbg.agent.AbstractDebuggerObjectModel, __a1: ghidra.dbg.target.TargetObject, __a2: unicode, __a3: unicode): ...
    ...
    @overload
    def __init__(self, __a0: ghidra.dbg.agent.AbstractTargetObject.ProxyFactory, __a1: object, __a2: ghidra.dbg.agent.AbstractDebuggerObjectModel, __a3: ghidra.dbg.target.TargetObject, __a4: unicode, __a5: unicode): ...
