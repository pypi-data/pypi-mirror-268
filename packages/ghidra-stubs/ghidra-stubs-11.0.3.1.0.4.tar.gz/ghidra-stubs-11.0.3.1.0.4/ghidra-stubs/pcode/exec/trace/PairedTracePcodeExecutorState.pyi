...
class PairedTracePcodeExecutorState(ghidra.pcode.exec.PairedPcodeExecutorState, ghidra.pcode.exec.trace.TracePcodeExecutorState):




    @overload
    def __init__(self, __a0: ghidra.pcode.exec.trace.PairedTracePcodeExecutorStatePiece): ...

    @overload
    def __init__(self, __a0: ghidra.pcode.exec.trace.TracePcodeExecutorState, __a1: ghidra.pcode.exec.trace.TracePcodeExecutorStatePiece): ...
