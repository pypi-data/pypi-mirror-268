...
class DirectBytesTracePcodeExecutorState(ghidra.pcode.exec.trace.DefaultTracePcodeExecutorState):




    @overload
    def __init__(self, __a0: ghidra.pcode.exec.trace.data.PcodeTraceDataAccess): ...

    @overload
    def __init__(self, __a0: ghidra.trace.model.guest.TracePlatform, __a1: long, __a2: ghidra.trace.model.thread.TraceThread, __a3: int): ...
    ...
    @staticmethod
    def getDefaultThreadAccess(__a0: ghidra.trace.model.guest.TracePlatform, __a1: long, __a2: ghidra.trace.model.thread.TraceThread, __a3: int) -> ghidra.pcode.exec.trace.data.PcodeTraceDataAccess: ...
    ...
    def withMemoryState(self) -> ghidra.pcode.exec.PcodeExecutorState: ...
