...
class PcodeExecutionException(java.lang.RuntimeException):
    ...
    @overload
    def __init__(self, message: unicode, frame: ghidra.pcode.exec.PcodeFrame): ...

    @overload
    def __init__(self, message: unicode, cause: java.lang.Throwable): ...

    @overload
    def __init__(self, message: unicode, frame: ghidra.pcode.exec.PcodeFrame, cause: java.lang.Throwable):
        """
