...
class TaintPcodeExecutorState(ghidra.pcode.exec.PairedPcodeExecutorState):




    def __init__(self, __a0: ghidra.program.model.lang.Language, __a1: ghidra.pcode.exec.BytesPcodeExecutorStatePiece): ...
