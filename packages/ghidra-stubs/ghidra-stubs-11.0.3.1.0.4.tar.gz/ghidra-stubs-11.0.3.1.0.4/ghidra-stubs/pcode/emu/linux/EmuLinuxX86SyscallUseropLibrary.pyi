...
class EmuLinuxX86SyscallUseropLibrary(ghidra.pcode.emu.linux.AbstractEmuLinuxSyscallUseropLibrary):
    ...
    def swi(self, __a0: ghidra.pcode.exec.PcodeExecutor, __a1: ghidra.pcode.exec.PcodeUseropLibrary, __a2: object) -> object: ...
