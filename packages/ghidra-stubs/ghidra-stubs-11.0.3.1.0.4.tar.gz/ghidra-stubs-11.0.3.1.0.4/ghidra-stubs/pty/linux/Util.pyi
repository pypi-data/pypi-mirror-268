...
class Util(com.sun.jna.Library, object):
    ...
    BARE: ghidra.pty.linux.Util = Proxy interface to Native Library <libutil.so@139761066430192>
    INSTANCE: ghidra.pty.linux.Util = ghidra.pty.linux.Util$1@533466c5
