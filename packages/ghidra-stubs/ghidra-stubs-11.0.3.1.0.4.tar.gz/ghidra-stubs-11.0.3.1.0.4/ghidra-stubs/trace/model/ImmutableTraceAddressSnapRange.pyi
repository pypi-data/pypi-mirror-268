...
class ImmutableTraceAddressSnapRange(object, ghidra.trace.model.TraceAddressSnapRange):
    ...
    @overload
    def __init__(self, __a0: ghidra.program.model.address.AddressRange, __a1: long): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.trace.model.Lifespan): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.address.AddressRange, __a1: ghidra.trace.model.Lifespan): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.program.model.address.Address, __a2: ghidra.trace.model.Lifespan): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.program.model.address.Address, __a2: long, __a3: long): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.program.model.address.Address, __a2: ghidra.trace.model.Lifespan, __a3: ghidra.util.database.spatial.rect.EuclideanSpace2D): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.program.model.address.Address, __a2: long, __a3: long, __a4: ghidra.trace.model.TraceAddressSnapSpace): ...



    @staticmethod
    def centered(__a0: ghidra.program.model.address.Address, __a1: long, __a2: int, __a3: int) -> ghidra.trace.model.ImmutableTraceAddressSnapRange: ...
    ...
    @staticmethod
    def rangeCentered(__a0: ghidra.program.model.address.Address, __a1: int) -> ghidra.program.model.address.AddressRange: ...

    @staticmethod
    def spanCentered(__a0: long, __a1: int) -> ghidra.trace.model.Lifespan: ...
