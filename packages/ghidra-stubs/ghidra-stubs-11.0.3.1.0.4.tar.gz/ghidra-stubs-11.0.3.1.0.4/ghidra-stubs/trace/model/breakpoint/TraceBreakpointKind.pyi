...
class TraceBreakpointKind(java.lang.Enum):
    COUNT: int = 4
    HW_EXECUTE: ghidra.trace.model.breakpoint.TraceBreakpointKind = HW_EXECUTE
    READ: ghidra.trace.model.breakpoint.TraceBreakpointKind = READ
    SW_EXECUTE: ghidra.trace.model.breakpoint.TraceBreakpointKind = SW_EXECUTE
    WRITE: ghidra.trace.model.breakpoint.TraceBreakpointKind = WRITE




    class TraceBreakpointKindSet(org.apache.commons.collections4.set.AbstractSetDecorator):
        ACCESS: ghidra.trace.model.breakpoint.TraceBreakpointKind.TraceBreakpointKindSet = READ,WRITE
        HW_EXECUTE: ghidra.trace.model.breakpoint.TraceBreakpointKind.TraceBreakpointKindSet = HW_EXECUTE
        READ: ghidra.trace.model.breakpoint.TraceBreakpointKind.TraceBreakpointKindSet = READ
        SW_EXECUTE: ghidra.trace.model.breakpoint.TraceBreakpointKind.TraceBreakpointKindSet = SW_EXECUTE
        WRITE: ghidra.trace.model.breakpoint.TraceBreakpointKind.TraceBreakpointKindSet = WRITE
