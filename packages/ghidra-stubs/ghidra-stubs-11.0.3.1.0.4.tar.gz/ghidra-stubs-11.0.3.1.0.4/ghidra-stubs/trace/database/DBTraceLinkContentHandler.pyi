...
class DBTraceLinkContentHandler(ghidra.framework.data.LinkHandler):
    TRACE_LINK_CONTENT_TYPE: unicode = u'TraceLink'
    ...
    def getImmutableObject(self, __a0: ghidra.framework.store.FolderItem, __a1: object, __a2: int, __a3: int, __a4: ghidra.util.task.TaskMonitor) -> ghidra.framework.data.DomainObjectAdapterDB: ...
    ...
    def getReadOnlyObject(self, __a0: ghidra.framework.store.FolderItem, __a1: int, __a2: bool, __a3: object, __a4: ghidra.util.task.TaskMonitor) -> ghidra.framework.data.DomainObjectAdapterDB: ...

    @staticmethod
    def getURL(__a0: ghidra.framework.model.DomainFile) -> java.net.URL: ...
