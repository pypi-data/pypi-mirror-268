...
class DBTracePlatformManager(object, ghidra.trace.database.DBTraceManager, ghidra.trace.model.guest.TracePlatformManager):
    ...
    def __init__(self, __a0: db.DBHandle, __a1: ghidra.util.database.DBOpenMode, __a2: java.util.concurrent.locks.ReadWriteLock, __a3: ghidra.util.task.TaskMonitor, __a4: ghidra.program.model.lang.CompilerSpec, __a5: ghidra.trace.database.DBTrace): ...



    def addGuestPlatform(self, __a0: ghidra.program.model.lang.CompilerSpec) -> ghidra.trace.database.guest.DBTraceGuestPlatform: ...
    ...
    def getOrAddPlatform(self, __a0: ghidra.program.model.lang.CompilerSpec) -> ghidra.trace.database.guest.InternalTracePlatform: ...
