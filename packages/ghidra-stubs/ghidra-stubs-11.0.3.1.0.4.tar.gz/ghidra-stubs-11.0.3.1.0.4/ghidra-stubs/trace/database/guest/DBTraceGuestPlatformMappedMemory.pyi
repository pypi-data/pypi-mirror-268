...
class DBTraceGuestPlatformMappedMemory(object, ghidra.program.model.mem.Memory):
    ...
    def __init__(self, __a0: ghidra.trace.database.memory.DBTraceMemoryManager, __a1: ghidra.trace.database.guest.DBTraceGuestPlatform, __a2: long): ...
