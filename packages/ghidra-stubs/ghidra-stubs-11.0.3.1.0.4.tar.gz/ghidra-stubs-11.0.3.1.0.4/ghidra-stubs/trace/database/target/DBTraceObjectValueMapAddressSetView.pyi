...
class DBTraceObjectValueMapAddressSetView(ghidra.util.AbstractAddressSetView):
    ...
    def __init__(self, __a0: ghidra.program.model.address.AddressFactory, __a1: java.util.concurrent.locks.ReadWriteLock, __a2: ghidra.util.database.spatial.SpatialMap, __a3: java.util.function.Predicate): ...
