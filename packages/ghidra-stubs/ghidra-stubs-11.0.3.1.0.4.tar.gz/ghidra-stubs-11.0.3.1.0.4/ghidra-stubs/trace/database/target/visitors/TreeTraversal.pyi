...
class TreeTraversal(java.lang.Enum):
    INSTANCE: ghidra.trace.database.target.visitors.TreeTraversal = INSTANCE
    ...
    class VisitResult(java.lang.Enum):
        EXCLUDE_DESCEND: ghidra.trace.database.target.visitors.TreeTraversal.VisitResult = EXCLUDE_DESCEND
        EXCLUDE_PRUNE: ghidra.trace.database.target.visitors.TreeTraversal.VisitResult = EXCLUDE_PRUNE
        INCLUDE_DESCEND: ghidra.trace.database.target.visitors.TreeTraversal.VisitResult = INCLUDE_DESCEND
        INCLUDE_PRUNE: ghidra.trace.database.target.visitors.TreeTraversal.VisitResult = INCLUDE_PRUNE
