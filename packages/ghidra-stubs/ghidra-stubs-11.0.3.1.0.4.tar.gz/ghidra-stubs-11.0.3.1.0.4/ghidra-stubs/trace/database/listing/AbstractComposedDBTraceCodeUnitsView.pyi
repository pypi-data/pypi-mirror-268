...
class AbstractComposedDBTraceCodeUnitsView(ghidra.trace.database.listing.AbstractBaseDBTraceCodeUnitsView):




    def __init__(self, __a0: ghidra.trace.database.listing.DBTraceCodeSpace, __a1: java.util.Collection): ...
