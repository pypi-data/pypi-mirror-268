...
class DBTraceDataMemoryView(ghidra.trace.database.listing.AbstractWithUndefinedDBTraceCodeUnitsMemoryView, ghidra.trace.model.listing.TraceDataView, ghidra.trace.database.listing.InternalBaseCodeUnitsView):
