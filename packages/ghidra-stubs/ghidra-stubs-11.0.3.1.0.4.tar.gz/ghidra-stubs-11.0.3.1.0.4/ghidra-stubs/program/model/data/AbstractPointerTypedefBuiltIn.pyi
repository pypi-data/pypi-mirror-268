...
class AbstractPointerTypedefBuiltIn(ghidra.program.model.data.BuiltIn, ghidra.program.model.data.TypeDef):
    """
    AbstractPointerTypedefDataType provides an abstract BuiltIn datatype 
    ...
    def getBuiltInSettingsDefinitions(self) -> List[ghidra.docking.settings.SettingsDefinition]: ...
    ...
    @property
    def builtInSettingsDefinitions(self) -> List[ghidra.docking.settings.SettingsDefinition]: ...
