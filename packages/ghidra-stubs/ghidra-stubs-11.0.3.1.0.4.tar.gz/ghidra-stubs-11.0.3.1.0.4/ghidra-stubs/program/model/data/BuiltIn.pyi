...
class BuiltIn(ghidra.program.model.data.DataTypeImpl, ghidra.program.model.data.BuiltInDataType):
    """
    ...
    def __init__(self, path: ghidra.program.model.data.CategoryPath, name: unicode, dataMgr: ghidra.program.model.data.DataTypeManager): ...
