...
class VoidDataType(ghidra.program.model.data.BuiltIn):
    ...
    @staticmethod
    def isVoidDataType(dt: ghidra.program.model.data.DataType) -> bool:
        """
