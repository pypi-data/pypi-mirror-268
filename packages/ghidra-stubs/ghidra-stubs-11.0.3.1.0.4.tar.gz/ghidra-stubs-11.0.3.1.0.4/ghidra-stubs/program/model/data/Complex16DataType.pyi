...
class Complex16DataType(ghidra.program.model.data.AbstractComplexDataType):
    """
    Provides a definition of a  built-in data type consisting of two 64-bit floating point
     numbers in the IEEE 754 double precision format.
    """

    dataType: ghidra.program.model.data.Complex16DataType = complex16
