...
class ShortDataType(ghidra.program.model.data.AbstractSignedIntegerDataType):
    """
    Basic implementation for a Short Integer dataType
    """

    dataType: ghidra.program.model.data.ShortDataType = short
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.ShortDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedShortDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedShortDataType: ...