...
class PascalUnicodeDataType(ghidra.program.model.data.AbstractStringDataType):
    """
    A length-prefixed string DataType (max 64k bytes) with char size of 2 bytes,
     CharsetSettingsDefinition charset, unbounded
     (ignores containing field size, relies on embedded length value).
 
    """

    dataType: ghidra.program.model.data.PascalUnicodeDataType = PascalUnicode
