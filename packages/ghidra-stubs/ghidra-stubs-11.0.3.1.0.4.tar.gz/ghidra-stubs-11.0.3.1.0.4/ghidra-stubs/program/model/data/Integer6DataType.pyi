...
class Integer6DataType(ghidra.program.model.data.AbstractSignedIntegerDataType):
    dataType: ghidra.program.model.data.Integer6DataType = int6
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.Integer6DataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedInteger6DataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedInteger6DataType: ...