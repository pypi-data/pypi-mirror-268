...
class UnsignedLeb128DataType(ghidra.program.model.data.AbstractLeb128DataType):
    """
    An Unsigned Little Endian Base 128 integer data type.
    """

    dataType: ghidra.program.model.data.UnsignedLeb128DataType = uleb128
    ...
    def getValue(self, buf: ghidra.program.model.mem.MemBuffer, settings: ghidra.docking.settings.Settings, maxLength: int) -> object: ...
