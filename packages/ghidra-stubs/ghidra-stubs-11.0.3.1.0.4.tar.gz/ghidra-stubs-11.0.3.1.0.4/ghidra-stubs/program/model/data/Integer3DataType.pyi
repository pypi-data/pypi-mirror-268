...
class Integer3DataType(ghidra.program.model.data.AbstractSignedIntegerDataType):
    dataType: ghidra.program.model.data.Integer3DataType = int3
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.Integer3DataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedInteger3DataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedInteger3DataType: ...