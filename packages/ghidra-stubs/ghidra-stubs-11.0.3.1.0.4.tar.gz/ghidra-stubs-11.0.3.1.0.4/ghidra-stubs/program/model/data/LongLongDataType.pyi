...
class LongLongDataType(ghidra.program.model.data.AbstractSignedIntegerDataType):
    """
    Basic implementation for an Signed LongLong Integer dataType
    """

    dataType: ghidra.program.model.data.LongLongDataType = longlong
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.LongLongDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedLongLongDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedLongLongDataType: ...