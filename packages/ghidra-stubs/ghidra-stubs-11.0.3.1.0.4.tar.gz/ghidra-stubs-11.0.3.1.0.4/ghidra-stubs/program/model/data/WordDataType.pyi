...
class WordDataType(ghidra.program.model.data.AbstractUnsignedIntegerDataType):
    """
    Provides a basic implementation of a word datatype
    """

    dataType: ghidra.program.model.data.WordDataType = word
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.WordDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.SignedWordDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.SignedWordDataType: ...