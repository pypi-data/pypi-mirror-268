...
class FloatComplexDataType(ghidra.program.model.data.AbstractComplexDataType):
    """
    Provides a definition of a  built-in data type consisting of two floating point
    ...
    dataType: ghidra.program.model.data.FloatComplexDataType = floatcomplex
