...
class DWordDataType(ghidra.program.model.data.AbstractUnsignedIntegerDataType):
    """
    Provides a definition of a Double Word within a program.
    """

    dataType: ghidra.program.model.data.DWordDataType = dword
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.DWordDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.SignedDWordDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.SignedDWordDataType: ...