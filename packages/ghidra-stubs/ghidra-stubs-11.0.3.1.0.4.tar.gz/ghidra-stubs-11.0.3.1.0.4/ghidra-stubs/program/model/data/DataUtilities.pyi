...
class DataUtilities(object):
    ...
    class ClearDataMode(java.lang.Enum):
        ...
        CLEAR_ALL_DEFAULT_CONFLICT_DATA: ghidra.program.model.data.DataUtilities.ClearDataMode = CLEAR_ALL_DEFAULT_CONFLICT_DATA
    ...
    @overload
    @staticmethod
    def createData(program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, newType: ghidra.program.model.data.DataType, length: int, clearMode: ghidra.program.model.data.DataUtilities.ClearDataMode) -> ghidra.program.model.listing.Data:
        """
    ...
    @overload
    @staticmethod
    def createData(program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, newType: ghidra.program.model.data.DataType, length: int, stackPointers: bool, clearMode: ghidra.program.model.data.DataUtilities.ClearDataMode) -> ghidra.program.model.listing.Data:
        """
