...
class CodeUnitLocation(ghidra.program.util.ProgramLocation):
    ...
    @staticmethod
    def getTranslatedCopy(loc: ghidra.program.util.ProgramLocation, program: ghidra.program.model.listing.Program, translatedAddress: ghidra.program.model.address.Address) -> ghidra.program.util.ProgramLocation:
        """
