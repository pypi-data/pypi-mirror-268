...
class FlatProgramAPI(object):
    ...
    @property
    def memoryBlocks(self) -> List[ghidra.program.model.mem.MemoryBlock]: ...
    ...
    @property
    def referencePrimary(self) -> None: ...  # No getter available.

    @referencePrimary.setter
    def referencePrimary(self, value: ghidra.program.model.symbol.Reference) -> None: ...