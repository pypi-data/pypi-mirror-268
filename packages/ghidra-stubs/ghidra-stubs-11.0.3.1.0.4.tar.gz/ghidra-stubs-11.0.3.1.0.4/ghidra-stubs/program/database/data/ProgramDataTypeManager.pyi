...
class ProgramDataTypeManager(ghidra.program.database.data.ProgramBasedDataTypeManagerDB, ghidra.program.database.ManagerDB):
    """
    ...
    def __init__(self, handle: db.DBHandle, addrMap: ghidra.program.database.map.AddressMap, openMode: int, errHandler: db.util.ErrorHandler, lock: ghidra.util.Lock, monitor: ghidra.util.task.TaskMonitor):
        """
        Constructor
    ...
    def languageChanged(self, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
    ...
    def saveDataOrganization(self) -> None:
        """
