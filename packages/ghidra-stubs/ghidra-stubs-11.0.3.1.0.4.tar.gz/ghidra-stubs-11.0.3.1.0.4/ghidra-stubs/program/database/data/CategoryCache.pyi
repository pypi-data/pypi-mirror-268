...
class CategoryCache(ghidra.util.datastruct.FixedSizeHashMap):
    ...
    @staticmethod
    def newHashMap(__a0: int) -> java.util.HashMap: ...

    @staticmethod
    def newLinkedHashMap(__a0: int) -> java.util.LinkedHashMap: ...
