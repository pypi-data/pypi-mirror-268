...
class DataTypeArchiveContentHandler(ghidra.framework.data.DBContentHandler):
    ...
    def getDomainObject(self, item: ghidra.framework.store.FolderItem, userfs: ghidra.framework.store.FileSystem, checkoutId: long, okToUpgrade: bool, recover: bool, consumer: object, monitor: ghidra.util.task.TaskMonitor) -> ghidra.program.database.DataTypeArchiveDB: ...

    def getDomainObjectClass(self) -> java.lang.Class: ...

    def getIcon(self) -> javax.swing.Icon: ...

    def getImmutableObject(self, item: ghidra.framework.store.FolderItem, consumer: object, version: int, minChangeVersion: int, monitor: ghidra.util.task.TaskMonitor) -> ghidra.program.database.DataTypeArchiveDB: ...

    def getLinkHandler(self) -> ghidra.program.database.DataTypeArchiveLinkContentHandler: ...
    ...
    def getReadOnlyObject(self, item: ghidra.framework.store.FolderItem, version: int, okToUpgrade: bool, consumer: object, monitor: ghidra.util.task.TaskMonitor) -> ghidra.program.database.DataTypeArchiveDB: ...
    ...
    @property
    def linkHandler(self) -> ghidra.program.database.DataTypeArchiveLinkContentHandler: ...
