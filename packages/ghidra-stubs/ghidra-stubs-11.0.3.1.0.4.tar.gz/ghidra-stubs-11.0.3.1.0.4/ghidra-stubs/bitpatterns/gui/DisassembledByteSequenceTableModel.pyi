...
class DisassembledByteSequenceTableModel(ghidra.bitpatterns.gui.ByteSequenceTableModel):




    def __init__(self, __a0: ghidra.bitpatterns.gui.FunctionBitPatternsExplorerPlugin, __a1: List[object]): ...
    ...
    def mergeSelectedRows(self) -> ghidra.util.bytesearch.DittedBitSequence: ...
