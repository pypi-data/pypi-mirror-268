...
class TaintVec(object):
    ...
    class ShiftMode(java.lang.Enum):
        CIRCULAR: ghidra.taint.model.TaintVec.ShiftMode = CIRCULAR
        REMAINDER: ghidra.taint.model.TaintVec.ShiftMode = REMAINDER
        UNBOUNDED: ghidra.taint.model.TaintVec.ShiftMode = UNBOUNDED
