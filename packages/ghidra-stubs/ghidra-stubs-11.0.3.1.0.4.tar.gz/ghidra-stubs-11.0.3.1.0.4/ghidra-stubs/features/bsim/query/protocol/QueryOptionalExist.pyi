...
class QueryOptionalExist(ghidra.features.bsim.query.protocol.BSimQuery):
    attemptCreation: bool
    clearTable: bool
    keyType: int
    optionalresponse: ghidra.features.bsim.query.protocol.ResponseOptionalExist
    tableName: unicode
    valueType: int
