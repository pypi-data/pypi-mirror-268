...
class ResponseNearest(ghidra.features.bsim.query.protocol.QueryResponseRecord):
    manage: ghidra.features.bsim.query.description.DescriptionManager
    qnear: ghidra.features.bsim.query.protocol.QueryNearest
    result: List[object]
    totalfunc: int
    totalmatch: int
    uniquematch: int
    ...
    def __init__(self, __a0: ghidra.features.bsim.query.protocol.QueryNearest): ...
