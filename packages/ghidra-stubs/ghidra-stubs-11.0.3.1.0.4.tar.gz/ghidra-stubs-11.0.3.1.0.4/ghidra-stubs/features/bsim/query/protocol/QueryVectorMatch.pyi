...
class QueryVectorMatch(ghidra.features.bsim.query.protocol.BSimQuery):
    DEFAULT_MAX_FUNCTIONS: int = 200
    bsimFilter: ghidra.features.bsim.query.protocol.BSimFilter
    fillinCategories: bool
    matchresponse: ghidra.features.bsim.query.protocol.ResponseVectorMatch
    max: int
    vectorIds: List[object]
