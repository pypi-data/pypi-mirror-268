...
class PrewarmRequest(ghidra.features.bsim.query.protocol.BSimQuery):
    mainIndexConfig: int
    prewarmresponse: ghidra.features.bsim.query.protocol.ResponsePrewarm
    secondaryIndexConfig: int
    vectorTableConfig: int
