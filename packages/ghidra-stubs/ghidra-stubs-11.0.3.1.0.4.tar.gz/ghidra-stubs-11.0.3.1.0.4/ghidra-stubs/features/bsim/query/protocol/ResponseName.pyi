...
class ResponseName(ghidra.features.bsim.query.protocol.QueryResponseRecord):
    manage: ghidra.features.bsim.query.description.DescriptionManager
    printjustexe: bool
    printselfsig: bool
    uniqueexecutable: bool
    ...
    def printRaw(self, __a0: java.io.PrintStream, __a1: generic.lsh.vector.LSHVectorFactory, __a2: int) -> None: ...
