...
class ResponseCluster(ghidra.features.bsim.query.protocol.QueryResponseRecord):
    notes: List[object]
    query: ghidra.features.bsim.query.protocol.QueryCluster



    def __init__(self, __a0: ghidra.features.bsim.query.protocol.QueryCluster): ...
