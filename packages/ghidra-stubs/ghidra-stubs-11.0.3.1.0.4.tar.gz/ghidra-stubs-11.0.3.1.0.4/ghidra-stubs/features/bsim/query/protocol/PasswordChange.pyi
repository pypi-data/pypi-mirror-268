...
class PasswordChange(ghidra.features.bsim.query.protocol.BSimQuery):
    newPassword: List[int]
    passwordResponse: ghidra.features.bsim.query.protocol.ResponsePassword
    username: unicode
