...
class InsertRequest(ghidra.features.bsim.query.protocol.BSimQuery):
    insertresponse: ghidra.features.bsim.query.protocol.ResponseInsert
    manage: ghidra.features.bsim.query.description.DescriptionManager
    path_override: unicode
    repo_override: unicode
    ...
    @property
    def localStagingCopy(self) -> ghidra.features.bsim.query.protocol.InsertRequest: ...