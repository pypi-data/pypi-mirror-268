...
class BSimMatchResultsModel(ghidra.util.table.AddressBasedTableModel):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.features.bsim.query.description.DatabaseInformation, __a2: generic.lsh.vector.LSHVectorFactory): ...
    ...
    @staticmethod
    def recoverAddress(__a0: ghidra.features.bsim.query.description.FunctionDescription, __a1: ghidra.program.model.listing.Program) -> ghidra.program.model.address.Address: ...
