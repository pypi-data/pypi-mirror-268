...
class FunctionSymbolToFunctionTableRowMapper(ghidra.util.table.ProgramLocationTableRowMapper):
    ...
    @overload
    def map(self, __a0: ghidra.program.database.symbol.FunctionSymbol, __a1: ghidra.program.model.listing.Program, __a2: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.model.listing.Function: ...
