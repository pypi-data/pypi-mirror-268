...
class FilterWidget(javax.swing.JPanel):
    ...
    def __init__(self, __a0: List[object], __a1: java.util.function.Consumer, __a2: utility.function.Callback): ...
    ...
    def setFilter(self, __a0: ghidra.features.bsim.gui.filters.BSimFilterType, __a1: List[object]) -> None: ...
