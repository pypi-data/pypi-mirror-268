...
class BSimFilterPanel(javax.swing.JPanel):
    ...
    @overload
    def __init__(self, __a0: utility.function.Callback): ...

    @overload
    def __init__(self, __a0: List[object], __a1: ghidra.features.bsim.gui.search.dialog.BSimFilterSet, __a2: utility.function.Callback): ...
    ...
    def getFilterSet(self) -> ghidra.features.bsim.gui.search.dialog.BSimFilterSet: ...
    ...
    def setFilterSet(self, __a0: ghidra.features.bsim.gui.search.dialog.BSimFilterSet) -> None: ...

    def setFilters(self, __a0: List[object]) -> None: ...
    ...
    @property
    def filterSet(self) -> ghidra.features.bsim.gui.search.dialog.BSimFilterSet: ...

    @filterSet.setter
    def filterSet(self, value: ghidra.features.bsim.gui.search.dialog.BSimFilterSet) -> None: ...

    @property
    def filters(self) -> None: ...  # No getter available.

    @filters.setter
    def filters(self, value: List[object]) -> None: ...