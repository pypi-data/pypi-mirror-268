...
class BSimOverviewProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, __a0: ghidra.features.bsim.gui.BSimSearchPlugin, __a1: ghidra.features.bsim.query.BSimServerInfo, __a2: ghidra.program.model.listing.Program, __a3: generic.lsh.vector.LSHVectorFactory, __a4: ghidra.features.bsim.gui.search.dialog.BSimSearchSettings): ...
    ...
    def overviewResultAdded(self, __a0: ghidra.features.bsim.query.protocol.ResponseNearestVector) -> None: ...
    ...
    def setFinalOverviewResults(self, __a0: ghidra.features.bsim.query.protocol.ResponseNearestVector) -> None: ...
    ...
    @property
    def finalOverviewResults(self) -> None: ...  # No getter available.

    @finalOverviewResults.setter
    def finalOverviewResults(self, value: ghidra.features.bsim.query.protocol.ResponseNearestVector) -> None: ...
