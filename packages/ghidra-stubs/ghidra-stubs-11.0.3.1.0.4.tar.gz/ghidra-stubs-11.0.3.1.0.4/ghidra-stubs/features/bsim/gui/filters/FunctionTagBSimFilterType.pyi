...
class FunctionTagBSimFilterType(ghidra.features.bsim.gui.filters.BSimFilterType):
    HAS_BADDATA_MASK: int
    HAS_UNIMPLEMENTED_MASK: int
    KNOWN_LIBRARY_MASK: int
    MAX_TAG_COUNT: int
    RESERVED_BITS: int
    XML_VALUE: unicode = u'functiontag'
    ...
    @overload
    def __init__(self, __a0: unicode, __a1: ghidra.features.bsim.query.facade.SimilarFunctionQueryService): ...
