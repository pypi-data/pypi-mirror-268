...
class BSimSearchPlugin(ghidra.app.plugin.ProgramPlugin):
    HELP_TOPIC: unicode = u'BSimSearchPlugin'
    ...
    def closeAllProviders(self) -> None: ...
    ...
    def doBSimSearch(self, __a0: ghidra.program.model.listing.Program, __a1: List[object], __a2: bool) -> None: ...
    ...
    @overload
    def providerClosed(self, __a0: ghidra.features.bsim.gui.overview.BSimOverviewProvider) -> None: ...

    @overload
    def providerClosed(self, __a0: ghidra.features.bsim.gui.search.results.BSimSearchResultsProvider) -> None: ...
