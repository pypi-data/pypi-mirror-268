...
class BSimStatusRenderer(ghidra.util.table.column.AbstractGColumnRenderer):
    ...
    @overload
    def getFilterString(self, __a0: ghidra.features.bsim.gui.search.results.BSimResultStatus, __a1: ghidra.docking.settings.Settings) -> unicode: ...
