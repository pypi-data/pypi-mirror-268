...
class DateBSimFilterType(ghidra.features.bsim.gui.filters.BSimFilterType):
    FORMATTERS: List[object] = [Value(YearOfEra,4,19,EXCEEDS_PAD)' 'Value(MonthOfYear,2)' 'Value(DayOfMonth,2), Value(YearOfEra,4,19,EXCEEDS_PAD)'-'Value(MonthOfYear,2)'-'Value(DayOfMonth,2), Value(YearOfEra,4,19,EXCEEDS_PAD)'/'Value(MonthOfYear,2)'/'Value(DayOfMonth,2), Text(MonthOfYear,SHORT)' 'Value(DayOfMonth,2)','' 'Value(YearOfEra,4,19,EXCEEDS_PAD), Text(MonthOfYear)' 'Value(DayOfMonth,2)','' 'Value(YearOfEra,4,19,EXCEEDS_PAD), Value(MonthOfYear,2)' 'Value(DayOfMonth,2)' 'Value(YearOfEra,4,19,EXCEEDS_PAD), Value(MonthOfYear,2)'-'Value(DayOfMonth,2)'-'Value(YearOfEra,4,19,EXCEEDS_PAD), Value(MonthOfYear,2)'/'Value(DayOfMonth,2)'/'Value(YearOfEra,4,19,EXCEEDS_PAD), Value(YearOfEra,4,19,EXCEEDS_PAD)]
