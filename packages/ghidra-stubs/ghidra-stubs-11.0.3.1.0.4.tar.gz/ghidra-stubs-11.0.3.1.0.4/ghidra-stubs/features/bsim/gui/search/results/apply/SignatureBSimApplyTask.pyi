...
class SignatureBSimApplyTask(ghidra.features.bsim.gui.search.results.apply.AbstractBSimApplyTask):




    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: List[object], __a2: bool, __a3: ghidra.framework.plugintool.ServiceProvider): ...
