...
class SelectedFunctionsTableDialog(docking.DialogComponentProvider):
    ...
    @overload
    def __init__(self, __a0: java.util.Set, __a1: ghidra.app.services.GoToService, __a2: ghidra.util.HelpLocation): ...

    @overload
    def __init__(self, __a0: java.util.Set, __a1: ghidra.app.services.GoToService, __a2: ghidra.util.HelpLocation, __a3: java.util.Map): ...
