...
class BSimSearchDialog(ghidra.features.bsim.gui.search.dialog.AbstractBSimSearchDialog):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.features.bsim.gui.search.dialog.BSimSearchService, __a2: ghidra.features.bsim.gui.search.dialog.BSimServerManager, __a3: java.util.Set): ...
