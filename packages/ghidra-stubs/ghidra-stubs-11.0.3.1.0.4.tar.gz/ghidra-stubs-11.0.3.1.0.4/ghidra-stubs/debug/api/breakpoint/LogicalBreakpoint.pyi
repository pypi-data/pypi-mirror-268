...
class LogicalBreakpoint(object):
    ...
    ICON_MARKER_DISABLED: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/11.0.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    ICON_MARKER_ENABLED: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/11.0.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    ICON_MARKER_INCON_DIS: javax.swing.Icon = MultiIcon[icon.debugger.breakpoint.marker.disabled, icon.debugger.breakpoint.overlay.inconsistent]
    ICON_MARKER_INCON_EN: javax.swing.Icon = MultiIcon[icon.debugger.breakpoint.marker.enabled, icon.debugger.breakpoint.overlay.inconsistent]
    ICON_MARKER_INCON_MIX: javax.swing.Icon = MultiIcon[icon.debugger.breakpoint.marker.mixed, icon.debugger.breakpoint.overlay.inconsistent]
    ICON_MARKER_INEFF_DIS: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/11.0.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    ICON_MARKER_INEFF_EN: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/11.0.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    ICON_MARKER_INEFF_MIX: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/11.0.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    ICON_MARKER_MIXED: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/11.0.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    ICON_OVERLAY_INCONSISTENT: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/11.0.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    ...
    class ProgramMode(java.lang.Enum):
        DISABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.ProgramMode = DISABLED
        ENABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.ProgramMode = ENABLED
        MISSING: ghidra.debug.api.breakpoint.LogicalBreakpoint.ProgramMode = MISSING
        NONE: ghidra.debug.api.breakpoint.LogicalBreakpoint.ProgramMode = NONE
    ...
    class Consistency(java.lang.Enum):
        INCONSISTENT: ghidra.debug.api.breakpoint.LogicalBreakpoint.Consistency = INCONSISTENT
        INEFFECTIVE: ghidra.debug.api.breakpoint.LogicalBreakpoint.Consistency = INEFFECTIVE
        NORMAL: ghidra.debug.api.breakpoint.LogicalBreakpoint.Consistency = NORMAL
    ...
    class State(java.lang.Enum):
        DISABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.State = DISABLED
        ENABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.State = ENABLED
        INCONSISTENT_DISABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.State = INCONSISTENT_DISABLED
        INCONSISTENT_ENABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.State = INCONSISTENT_ENABLED
        INCONSISTENT_MIXED: ghidra.debug.api.breakpoint.LogicalBreakpoint.State = INCONSISTENT_MIXED
        INEFFECTIVE_DISABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.State = INEFFECTIVE_DISABLED
        INEFFECTIVE_ENABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.State = INEFFECTIVE_ENABLED
        INEFFECTIVE_MIXED: ghidra.debug.api.breakpoint.LogicalBreakpoint.State = INEFFECTIVE_MIXED
        MIXED: ghidra.debug.api.breakpoint.LogicalBreakpoint.State = MIXED
        NONE: ghidra.debug.api.breakpoint.LogicalBreakpoint.State = NONE
    ...
    class Perspective(java.lang.Enum):
        LOGICAL: ghidra.debug.api.breakpoint.LogicalBreakpoint.Perspective = LOGICAL
        TRACE: ghidra.debug.api.breakpoint.LogicalBreakpoint.Perspective = TRACE
    ...
    class Mode(java.lang.Enum):
        DISABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.Mode = DISABLED
        ENABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.Mode = ENABLED
        MIXED: ghidra.debug.api.breakpoint.LogicalBreakpoint.Mode = MIXED
    ...
    class TraceMode(java.lang.Enum):
        DISABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.TraceMode = DISABLED
        ENABLED: ghidra.debug.api.breakpoint.LogicalBreakpoint.TraceMode = ENABLED
        MISSING: ghidra.debug.api.breakpoint.LogicalBreakpoint.TraceMode = MISSING
        MIXED: ghidra.debug.api.breakpoint.LogicalBreakpoint.TraceMode = MIXED
        NONE: ghidra.debug.api.breakpoint.LogicalBreakpoint.TraceMode = NONE
