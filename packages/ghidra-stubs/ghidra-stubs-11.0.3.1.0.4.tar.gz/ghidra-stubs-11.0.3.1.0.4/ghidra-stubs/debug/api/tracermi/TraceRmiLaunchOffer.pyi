...
class TraceRmiLaunchOffer(object):
    ...
    class LaunchConfigurator(object):
        NOP: ghidra.debug.api.tracermi.TraceRmiLaunchOffer.LaunchConfigurator = ghidra.debug.api.tracermi.TraceRmiLaunchOffer$LaunchConfigurator$1@142010b1
    ...
    class RelPrompt(java.lang.Enum):
        AFTER: ghidra.debug.api.tracermi.TraceRmiLaunchOffer.RelPrompt = AFTER
        BEFORE: ghidra.debug.api.tracermi.TraceRmiLaunchOffer.RelPrompt = BEFORE
        NONE: ghidra.debug.api.tracermi.TraceRmiLaunchOffer.RelPrompt = NONE
    ...
    class PromptMode(java.lang.Enum):
        ALWAYS: ghidra.debug.api.tracermi.TraceRmiLaunchOffer.PromptMode = ALWAYS
        NEVER: ghidra.debug.api.tracermi.TraceRmiLaunchOffer.PromptMode = NEVER
        ON_ERROR: ghidra.debug.api.tracermi.TraceRmiLaunchOffer.PromptMode = ON_ERROR
    ...
    class LaunchResult(java.lang.Record, java.lang.AutoCloseable):
        ...
        def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: java.util.Map, __a2: ghidra.debug.api.tracermi.TraceRmiConnection, __a3: ghidra.trace.model.Trace, __a4: java.lang.Throwable): ...
