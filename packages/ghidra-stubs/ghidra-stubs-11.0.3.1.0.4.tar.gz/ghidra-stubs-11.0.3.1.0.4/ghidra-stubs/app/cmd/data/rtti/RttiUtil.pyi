...
class RttiUtil(object):
    ...
    @staticmethod
    def promoteToClassNamespace(__a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.symbol.Namespace) -> ghidra.program.model.symbol.Namespace: ...
