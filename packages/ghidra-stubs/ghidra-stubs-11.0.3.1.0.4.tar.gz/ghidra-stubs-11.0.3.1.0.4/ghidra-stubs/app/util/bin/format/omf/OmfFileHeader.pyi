...
class OmfFileHeader(ghidra.app.util.bin.format.omf.OmfRecord):
    ...
    @staticmethod
    def parse(reader: ghidra.app.util.bin.BinaryReader, monitor: ghidra.util.task.TaskMonitor, log: ghidra.app.util.importer.MessageLog) -> ghidra.app.util.bin.format.omf.OmfFileHeader:
        """
    ...
    @staticmethod
    def scan(reader: ghidra.app.util.bin.BinaryReader, monitor: ghidra.util.task.TaskMonitor, fastscan: bool) -> ghidra.app.util.bin.format.omf.OmfFileHeader:
        """
