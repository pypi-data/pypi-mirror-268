...
class ObjectiveC2_Implementation(object, ghidra.app.util.bin.StructConverter):
    ...
    @overload
    def __init__(self, state: ghidra.app.util.bin.format.objc2.ObjectiveC2_State, reader: ghidra.app.util.bin.BinaryReader, isSmall: bool): ...
