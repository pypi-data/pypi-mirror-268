...
class CliBlobCustomAttrib(ghidra.app.util.bin.format.pe.cli.blobs.CliBlob):




    def __init__(self, blob: ghidra.app.util.bin.format.pe.cli.blobs.CliBlob, row: ghidra.app.util.bin.format.pe.cli.tables.CliTableCustomAttribute.CliCustomAttributeRow, metadataStream: ghidra.app.util.bin.format.pe.cli.streams.CliStreamMetadata): ...
