...
class AARCH64_ElfExtension(ghidra.app.util.bin.format.elf.extend.ElfExtension):
    PT_AARCH64_ARCHEXT: ghidra.app.util.bin.format.elf.ElfProgramHeaderType = PT_AARCH64_ARCHEXT(0x70000000)
    SHT_AARCH64_ATTRIBUTES: ghidra.app.util.bin.format.elf.ElfSectionHeaderType = SHT_AARCH64_ATTRIBUTES(0x70000003)
