...
class DelayImportDataDirectory(ghidra.app.util.bin.format.pe.DataDirectory):
    """
    ...
    def getDelayImportDescriptors(self) -> List[ghidra.app.util.bin.format.pe.DelayImportDescriptor]:
        """
    ...
    @property
    def delayImportDescriptors(self) -> List[ghidra.app.util.bin.format.pe.DelayImportDescriptor]: ...
