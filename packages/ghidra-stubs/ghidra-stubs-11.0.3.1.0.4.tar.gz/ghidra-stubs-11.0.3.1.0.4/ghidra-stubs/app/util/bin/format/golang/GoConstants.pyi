...
class GoConstants(object):
    ...
    GOLANG_BOOTSTRAP_FUNCS_CATEGORYPATH: ghidra.program.model.data.CategoryPath = /golang/functions
    ...
    GOLANG_RECOVERED_TYPES_CATEGORYPATH: ghidra.program.model.data.CategoryPath = /golang-recovered
