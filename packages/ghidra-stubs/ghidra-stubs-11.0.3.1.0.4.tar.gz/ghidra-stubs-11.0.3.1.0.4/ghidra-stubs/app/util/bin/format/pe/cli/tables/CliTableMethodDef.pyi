...
class CliTableMethodDef(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTable):
    """
    ...
    class CliMethodDefRow(ghidra.app.util.bin.format.pe.cli.tables.CliAbstractTableRow):
        Flags: int
        ImplFlags: int
        RVA: int
        nameIndex: int
        ...
        def __init__(self, __a0: ghidra.app.util.bin.format.pe.cli.tables.CliTableMethodDef, __a1: int, __a2: int, __a3: int, __a4: int, __a5: int, __a6: int): ...
