...
class FaultTolerantInputStream(java.io.InputStream):
    """
    An InputStream wrapper that suppresses any IOExceptions thrown by the wrapped stream
    ...
    def __init__(self, delegate: java.io.InputStream, length: long, errorConsumer: java.util.function.BiConsumer):
        """
        Creates instance.
