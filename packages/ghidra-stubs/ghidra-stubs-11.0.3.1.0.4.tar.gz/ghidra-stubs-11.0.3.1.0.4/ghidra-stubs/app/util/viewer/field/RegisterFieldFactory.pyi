...
class RegisterFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    """
    Field to show register values at the function entry point.
    """

    DISPLAY_DEFAULT_REGISTER_VALUES_OPTION_NAME: unicode = u'Register Field.Display Default Register Values'
    DISPLAY_HIDDEN_REGISTERS_OPTION_NAME: unicode = u'Register Field.Display Hidden Registers'
    FIELD_NAME: unicode = u'Register'
    REGISTER_GROUP_NAME: unicode = u'Register Field'
    ...
    def newInstance(self, formatModel: ghidra.app.util.viewer.format.FieldFormatModel, highlightProvider: ghidra.app.util.ListingHighlightProvider, toolOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
