...
class VariableLocFieldFactory(ghidra.app.util.viewer.field.AbstractVariableFieldFactory):
    """
    Generates VariableOffset Fields.
    """

    FIELD_NAME: unicode = u'Variable Location'
    ...
    def getOffsetString(self, offset: int) -> unicode:
        """
