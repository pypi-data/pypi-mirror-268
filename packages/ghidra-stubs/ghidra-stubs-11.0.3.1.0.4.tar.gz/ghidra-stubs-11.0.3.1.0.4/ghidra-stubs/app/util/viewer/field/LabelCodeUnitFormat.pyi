...
class LabelCodeUnitFormat(ghidra.app.util.viewer.field.BrowserCodeUnitFormat):
    ...
    def getOffcutLabelString(self, offcutAddress: ghidra.program.model.address.Address, cu: ghidra.program.model.listing.CodeUnit, markupAddress: ghidra.program.model.address.Address) -> unicode: ...
