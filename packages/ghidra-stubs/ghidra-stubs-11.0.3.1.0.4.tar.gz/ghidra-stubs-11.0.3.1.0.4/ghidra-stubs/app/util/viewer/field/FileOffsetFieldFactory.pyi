...
class FileOffsetFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    """
    Generates File Offset fields
    """

    COLOR: generic.theme.GColor = #00ffff
    FIELD_NAME: unicode = u'File Offset'
    FILE_OFFSET_DISPLAY_OPTIONS_NAME: unicode = u'File Offset Field.File Offset Display Options'
    GROUP_TITLE: unicode = u'File Offset Field'
