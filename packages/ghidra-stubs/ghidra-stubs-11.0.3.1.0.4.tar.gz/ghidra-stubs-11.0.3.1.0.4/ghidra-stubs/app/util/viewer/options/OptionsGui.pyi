...
class OptionsGui(javax.swing.JPanel):
    ...
    ADDRESS: ghidra.app.util.viewer.options.ScreenElement = Address
    BACKGROUND: ghidra.app.util.viewer.options.ScreenElement = Background
    BAD_REF_ADDR: ghidra.app.util.viewer.options.ScreenElement = Bad Reference Address
    BYTES: ghidra.app.util.viewer.options.ScreenElement = Bytes
    COMMENT_AUTO: ghidra.app.util.viewer.options.ScreenElement = Comment, Automatic
    COMMENT_EOL: ghidra.app.util.viewer.options.ScreenElement = Comment, EOL
    COMMENT_PLATE: ghidra.app.util.viewer.options.ScreenElement = Comment, Plate
    COMMENT_POST: ghidra.app.util.viewer.options.ScreenElement = Comment, Post
    COMMENT_PRE: ghidra.app.util.viewer.options.ScreenElement = Comment, Pre
    COMMENT_REF_REPEAT: ghidra.app.util.viewer.options.ScreenElement = Comment, Referenced Repeatable
    COMMENT_REPEATABLE: ghidra.app.util.viewer.options.ScreenElement = Comment, Repeatable
    CONSTANT: ghidra.app.util.viewer.options.ScreenElement = Constant
    ENTRY_POINT: ghidra.app.util.viewer.options.ScreenElement = Entry Point
    EXT_REF_RESOLVED: ghidra.app.util.viewer.options.ScreenElement = External Reference, Resolved
    FIELD_NAME: ghidra.app.util.viewer.options.ScreenElement = Field Name
    FLOW_ARROW_ACTIVE: ghidra.app.util.viewer.options.ScreenElement = Flow Arrow, Active
    FLOW_ARROW_NON_ACTIVE: ghidra.app.util.viewer.options.ScreenElement = Flow Arrow, Not Active
    FLOW_ARROW_SELECTED: ghidra.app.util.viewer.options.ScreenElement = Flow Arrow, Selected
    FUN_AUTO_PARAMS: ghidra.app.util.viewer.options.ScreenElement = Function Auto-Parameters
    FUN_CALL_FIXUP: ghidra.app.util.viewer.options.ScreenElement = Function Call-Fixup
    FUN_NAME: ghidra.app.util.viewer.options.ScreenElement = Function Name
    FUN_PARAMS: ghidra.app.util.viewer.options.ScreenElement = Function Parameters
    FUN_RET_TYPE: ghidra.app.util.viewer.options.ScreenElement = Function Return Type
    FUN_TAG: ghidra.app.util.viewer.options.ScreenElement = Function Tag
    LABELS_LOCAL: ghidra.app.util.viewer.options.ScreenElement = Labels, Local
    LABELS_NON_PRIMARY: ghidra.app.util.viewer.options.ScreenElement = Labels, Non-primary
    LABELS_PRIMARY: ghidra.app.util.viewer.options.ScreenElement = Labels, Primary
    LABELS_UNREFD: ghidra.app.util.viewer.options.ScreenElement = Labels, Unreferenced
    MNEMONIC: ghidra.app.util.viewer.options.ScreenElement = Mnemonic
    MNEMONIC_OVERRIDE: ghidra.app.util.viewer.options.ScreenElement = Mnemonic, Override
    MNEMONIC_UNIMPL: ghidra.app.util.viewer.options.ScreenElement = Unimplemented Mnemonic
    PARAMETER_CUSTOM: ghidra.app.util.viewer.options.ScreenElement = Parameter, Custom Storage
    PARAMETER_DYNAMIC: ghidra.app.util.viewer.options.ScreenElement = Parameter, Dynamic Storage
    PCODE_ADDR_SPACE: ghidra.app.util.viewer.options.ScreenElement = P-code Address Space
    PCODE_LINE_LABEL: ghidra.app.util.viewer.options.ScreenElement = P-code Line Label
    PCODE_RAW_VARNODE: ghidra.app.util.viewer.options.ScreenElement = P-code Raw Varnode
    PCODE_USEROP: ghidra.app.util.viewer.options.ScreenElement = P-code Userop
    REGISTERS: ghidra.app.util.viewer.options.ScreenElement = Registers
    SEPARATOR: ghidra.app.util.viewer.options.ScreenElement = Separator
    UNDERLINE: ghidra.app.util.viewer.options.ScreenElement = Underline
    VARIABLE: ghidra.app.util.viewer.options.ScreenElement = Variable
    XREF: ghidra.app.util.viewer.options.ScreenElement = XRef
    XREF_OFFCUT: ghidra.app.util.viewer.options.ScreenElement = XRef, Offcut
    XREF_OTHER: ghidra.app.util.viewer.options.ScreenElement = XRef Other
    XREF_READ: ghidra.app.util.viewer.options.ScreenElement = XRef Read
    XREF_WRITE: ghidra.app.util.viewer.options.ScreenElement = XRef Write
    ...
    def setBaseFont(self, font: java.awt.Font) -> None: ...
    ...
    @baseFont.setter
    def baseFont(self, value: java.awt.Font) -> None: ...