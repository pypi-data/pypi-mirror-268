...
class PreCommentFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    """
    Generates pre-comment fields.
    """

    ENABLE_ALWAYS_SHOW_AUTOMATIC_MSG: unicode = u'Pre-comments Field.Always Show the Automatic Comment'
    ENABLE_WORD_WRAP_MSG: unicode = u'Pre-comments Field.Enable Word Wrapping'
    FIELD_NAME: unicode = u'Pre-Comment'
