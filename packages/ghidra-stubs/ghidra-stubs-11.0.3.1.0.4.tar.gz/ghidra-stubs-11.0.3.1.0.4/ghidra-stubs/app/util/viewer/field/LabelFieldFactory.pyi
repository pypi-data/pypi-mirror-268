...
class LabelFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    """
    Generates label Fields.
    """

    DISPLAY_FUNCTION_LABEL: unicode = u'Labels Field.Display Function Label'
    FIELD_NAME: unicode = u'Label'
    GROUP_TITLE: unicode = u'Labels Field'
    OFFCUT_STYLE: unicode = u'XRef Offcut Style'
    ...
    def newInstance(self, formatModel: ghidra.app.util.viewer.format.FieldFormatModel, provider: ghidra.app.util.ListingHighlightProvider, pDisplayOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
