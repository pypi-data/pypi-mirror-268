...
class ImageFactoryField(docking.widgets.fieldpanel.field.SimpleImageField, ghidra.app.util.viewer.field.ListingField):
    ...
    @overload
    def __init__(self, factory: ghidra.app.util.viewer.field.FieldFactory, icon: javax.swing.Icon, proxy: ghidra.app.util.viewer.proxy.ProxyObj, metrics: java.awt.FontMetrics, x: int, width: int):
        """
        Constructor
    ...
    @overload
    def __init__(self, factory: ghidra.app.util.viewer.field.FieldFactory, icon: javax.swing.Icon, proxy: ghidra.app.util.viewer.proxy.ProxyObj, metrics: java.awt.FontMetrics, x: int, width: int, center: bool):
        """
        Constructor
        @param factory the FieldFactory that generated this field.
        @param icon the ImageIcon to display.
