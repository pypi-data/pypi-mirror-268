...
class ElfProgramBuilder(ghidra.app.util.opinion.MemorySectionResolver, ghidra.app.util.bin.format.elf.ElfLoadHelper):
    ...
    def addArtificialRelocTableEntry(self, address: ghidra.program.model.address.Address, length: int) -> bool: ...
    ...
    def getOption(self, optionName: unicode, defaultValue: object) -> object: ...

    def getOriginalValue(self, addr: ghidra.program.model.address.Address, signExtend: bool) -> long: ...
