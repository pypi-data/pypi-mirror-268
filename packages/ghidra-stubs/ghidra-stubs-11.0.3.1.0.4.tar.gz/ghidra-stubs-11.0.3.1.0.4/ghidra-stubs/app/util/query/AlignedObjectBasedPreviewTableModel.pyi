...
class AlignedObjectBasedPreviewTableModel(ghidra.util.table.AddressBasedTableModel):
    ...
    def addAlignmentListener(self, alignmentListener: ghidra.app.util.query.AddressAlignmentListener) -> None: ...
    ...
    def doFilter(self, __a0: List[object], __a1: docking.widgets.table.TableSortingContext, __a2: ghidra.util.task.TaskMonitor) -> List[object]: ...
    ...
    def removeAlignmentListener(self, alignmentListener: ghidra.app.util.query.AddressAlignmentListener) -> None: ...
