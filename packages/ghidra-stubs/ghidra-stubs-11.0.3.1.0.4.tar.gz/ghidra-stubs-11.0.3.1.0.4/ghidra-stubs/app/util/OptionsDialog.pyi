...
class OptionsDialog(docking.DialogComponentProvider, ghidra.app.util.OptionListener):
    """
    ...
    def __init__(self, __a0: List[object], __a1: ghidra.app.util.OptionValidator, __a2: ghidra.app.util.AddressFactoryService): ...
    ...
    def getOptions(self) -> List[ghidra.app.util.Option]:
        """
