...
class RTTI3DataType(ghidra.app.util.datatype.microsoft.RTTIDataType):
    """
    ...
    def getRtti1Count(self, memory: ghidra.program.model.mem.Memory, rtti3Address: ghidra.program.model.address.Address) -> long:
        """
