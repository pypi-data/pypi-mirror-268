...
class DataTypeSelectionDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, pluginTool: ghidra.framework.plugintool.PluginTool, dtm: ghidra.program.model.data.DataTypeManager, maxSize: int, allowedTypes: ghidra.util.data.DataTypeParser.AllowedDataTypes): ...
    ...
    def setInitialDataType(self, dataType: ghidra.program.model.data.DataType) -> None:
        """
    ...
    @property
    def editor(self) -> ghidra.app.util.datatype.DataTypeSelectionEditor: ...

    @property
    def initialDataType(self) -> None: ...  # No getter available.

    @initialDataType.setter
    def initialDataType(self, value: ghidra.program.model.data.DataType) -> None: ...
