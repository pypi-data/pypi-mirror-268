...
class DecompInterface(object):
    ...
    def debugSignatures(self, func: ghidra.program.model.listing.Function, timeoutSecs: int, monitor: ghidra.util.task.TaskMonitor) -> List[ghidra.app.decompiler.signature.DebugSignature]:
        """
    ...
    def generateSignatures(self, func: ghidra.program.model.listing.Function, keepcalllist: bool, timeoutSecs: int, monitor: ghidra.util.task.TaskMonitor) -> ghidra.app.decompiler.signature.SignatureResult:
        """
        Generate a signature, using the current signature settings, for the given function.
    ...
    def setSignatureSettings(self, value: int) -> bool:
        """
    ...
    @property
    def signatureSettings(self) -> int: ...

    @signatureSettings.setter
    def signatureSettings(self, value: int) -> None: ...
