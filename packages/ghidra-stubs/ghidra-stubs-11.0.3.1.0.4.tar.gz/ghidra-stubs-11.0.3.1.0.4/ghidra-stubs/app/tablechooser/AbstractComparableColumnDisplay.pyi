...
class AbstractComparableColumnDisplay(ghidra.app.tablechooser.AbstractColumnDisplay):
    """
    A version of ColumnDisplay to be used when the column value returned from
     #getColumnValue(AddressableRowObject) is Comparable
    """
