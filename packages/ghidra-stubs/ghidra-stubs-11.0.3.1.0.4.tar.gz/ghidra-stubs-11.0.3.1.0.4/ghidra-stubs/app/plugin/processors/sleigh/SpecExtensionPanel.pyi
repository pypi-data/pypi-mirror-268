...
class SpecExtensionPanel(javax.swing.JPanel):
    PREFERENCES_FILE_EXTENSION: unicode = u'.xml'
    ...
    class ChangeExtensionTask(ghidra.util.task.Task):
        ...
        def __init__(self, __a0: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel): ...
    ...
    class Status(java.lang.Enum):
        CORE: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status = CORE
        EXTENSION: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status = EXTENSION
        EXTENSION_ERROR: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status = EXTENSION_ERROR
        EXTENSION_INSTALL: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status = EXTENSION_INSTALL
        EXTENSION_OVERPENDING: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status = EXTENSION_OVERPENDING
        EXTENSION_OVERRIDE: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status = EXTENSION_OVERRIDE
        EXTENSION_REMOVE: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status = EXTENSION_REMOVE
        EXTENSION_REPLACE: ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status = EXTENSION_REPLACE
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status: ...
        ...
        @staticmethod
        def values() -> List[ghidra.app.plugin.processors.sleigh.SpecExtensionPanel.Status]: ...
    ...
    def apply(self, monitor: ghidra.util.task.TaskMonitor) -> None: ...
