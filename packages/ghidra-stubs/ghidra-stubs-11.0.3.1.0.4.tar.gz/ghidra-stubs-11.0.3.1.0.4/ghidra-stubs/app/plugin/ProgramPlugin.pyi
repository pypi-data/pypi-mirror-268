...
class ProgramPlugin(ghidra.framework.plugintool.Plugin):
    ...
    @overload
    def __init__(self, plugintool: ghidra.framework.plugintool.PluginTool, consumeLocationChange: bool, consumeSelectionChange: bool):
        """
    ...
    @overload
    def __init__(self, plugintool: ghidra.framework.plugintool.PluginTool, consumeLocationChange: bool, consumeSelectionChange: bool, consumeHighlightChange: bool):
        """
        Calling this constructor is works the same as calling {@link ProgramPlugin}.
        @deprecated call {@link #ProgramPlugin(PluginTool)} instead
        @param plugintool the tool
