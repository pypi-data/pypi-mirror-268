...
class ScalarSearchModel(ghidra.util.table.AddressBasedTableModel):
    ...
    class Signedness(java.lang.Enum):
        Signed: ghidra.app.plugin.core.scalartable.ScalarSearchModel.Signedness = Signed
        Unsigned: ghidra.app.plugin.core.scalartable.ScalarSearchModel.Signedness = Unsigned
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.app.plugin.core.scalartable.ScalarSearchModel.Signedness: ...
        ...
        @staticmethod
        def values() -> List[ghidra.app.plugin.core.scalartable.ScalarSearchModel.Signedness]: ...
