...
class AbstractTraceRmiManagerNode(docking.widgets.tree.GTreeNode, ghidra.app.plugin.core.debug.gui.tracermi.connection.tree.TraceRmiManagerNode):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.tracermi.connection.TraceRmiConnectionManagerProvider, __a1: unicode): ...
