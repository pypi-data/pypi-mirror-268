...
class ProjectArchiveNode(ghidra.app.plugin.core.datamgr.tree.DomainFileArchiveNode):




    def __init__(self, __a0: ghidra.app.plugin.core.datamgr.archive.ProjectArchive, __a1: ghidra.app.plugin.core.datamgr.tree.ArrayPointerFilterState): ...
