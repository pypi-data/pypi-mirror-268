...
class InterpreterPanel(javax.swing.JPanel, ghidra.framework.options.OptionsChangeListener):
    ...
    class TextType(java.lang.Enum):
        STDERR: ghidra.app.plugin.core.interpreter.InterpreterPanel.TextType = STDERR
        STDIN: ghidra.app.plugin.core.interpreter.InterpreterPanel.TextType = STDIN
        STDOUT: ghidra.app.plugin.core.interpreter.InterpreterPanel.TextType = STDOUT
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.app.plugin.core.interpreter.InterpreterPanel.TextType: ...
        ...
        @staticmethod
        def values() -> List[ghidra.app.plugin.core.interpreter.InterpreterPanel.TextType]: ...
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.plugin.core.interpreter.InterpreterConnection): ...
    ...
    def insertCompletion(self, __a0: ghidra.app.plugin.core.console.CodeCompletion) -> None: ...
    ...
    def setTextPaneFont(self, __a0: javax.swing.JTextPane, __a1: java.awt.Font) -> None: ...
