...
class MonitorCellRenderer(javax.swing.JPanel, ghidra.util.table.column.GColumnRenderer):
    ...
    @overload
    def getFilterString(self, __a0: ghidra.debug.api.progress.MonitorReceiver, __a1: ghidra.docking.settings.Settings) -> unicode: ...
