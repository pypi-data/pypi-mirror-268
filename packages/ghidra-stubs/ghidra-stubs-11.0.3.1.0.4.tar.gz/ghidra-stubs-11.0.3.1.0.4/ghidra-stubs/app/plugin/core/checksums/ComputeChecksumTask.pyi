...
class ComputeChecksumTask(ghidra.util.task.Task):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.checksums.ComputeChecksumsProvider, __a1: ghidra.program.model.mem.Memory, __a2: ghidra.program.model.address.AddressSetView): ...
