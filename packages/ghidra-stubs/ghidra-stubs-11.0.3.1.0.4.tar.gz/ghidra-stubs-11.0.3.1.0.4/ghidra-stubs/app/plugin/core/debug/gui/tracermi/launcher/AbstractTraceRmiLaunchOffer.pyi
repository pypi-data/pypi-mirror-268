...
class AbstractTraceRmiLaunchOffer(object, ghidra.debug.api.tracermi.TraceRmiLaunchOffer):
    PARAM_DISPLAY_IMAGE: unicode = u'Image'
    PREFIX_DBGLAUNCH: unicode = u'DBGLAUNCH_'



    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.tracermi.launcher.TraceRmiLauncherServicePlugin, __a1: ghidra.program.model.listing.Program): ...
