...
class SourceTagsPanel(ghidra.app.plugin.core.function.tags.TagListPanel):




    def __init__(self, __a0: ghidra.app.plugin.core.function.tags.FunctionTagProvider, __a1: ghidra.framework.plugintool.PluginTool, __a2: unicode): ...
    ...
    def getTable(self) -> ghidra.app.plugin.core.function.tags.FunctionTagTable: ...
    ...
    def refresh(self, __a0: ghidra.program.model.listing.Function) -> None: ...
    ...
    def tagExists(self, __a0: unicode) -> bool: ...
