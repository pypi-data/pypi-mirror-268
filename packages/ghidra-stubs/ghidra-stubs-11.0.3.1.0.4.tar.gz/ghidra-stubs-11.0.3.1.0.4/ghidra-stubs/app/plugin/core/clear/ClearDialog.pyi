...
class ClearDialog(docking.DialogComponentProvider):
    ...
    def setProgramActionContext(self, __a0: ghidra.app.context.ListingActionContext) -> None: ...
    ...
    @property
    def programActionContext(self) -> None: ...  # No getter available.

    @programActionContext.setter
    def programActionContext(self, value: ghidra.app.context.ListingActionContext) -> None: ...