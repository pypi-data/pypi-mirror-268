...
class AddressTableDialog(docking.ReusableDialogComponentProvider):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.disassembler.AutoTableDisassemblerPlugin): ...
    ...
    def setSelectedRows(self, __a0: List[int]) -> None: ...
    ...
    @property
    def selectedRows(self) -> None: ...  # No getter available.

    @selectedRows.setter
    def selectedRows(self, value: List[int]) -> None: ...