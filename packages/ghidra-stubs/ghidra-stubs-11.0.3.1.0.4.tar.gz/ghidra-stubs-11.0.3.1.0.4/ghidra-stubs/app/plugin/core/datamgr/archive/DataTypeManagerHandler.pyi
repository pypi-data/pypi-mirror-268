...
class DataTypeManagerHandler(object):
    ...
    def getArchive(self, __a0: ghidra.program.model.data.DataTypeManager) -> ghidra.app.plugin.core.datamgr.archive.Archive: ...
    ...
    @overload
    def openArchive(self, __a0: generic.jar.ResourceFile, __a1: bool, __a2: bool) -> ghidra.app.plugin.core.datamgr.archive.FileArchive: ...
