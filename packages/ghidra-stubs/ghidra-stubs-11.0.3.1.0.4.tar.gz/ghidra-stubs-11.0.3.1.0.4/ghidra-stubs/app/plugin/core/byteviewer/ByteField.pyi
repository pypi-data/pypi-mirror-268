...
class ByteField(docking.widgets.fieldpanel.field.SimpleTextField):
    ...
    def __init__(self, __a0: unicode, __a1: java.awt.FontMetrics, __a2: int, __a3: int, __a4: bool, __a5: int, __a6: long, __a7: docking.widgets.fieldpanel.support.FieldHighlightFactory): ...
