...
class AllFunctionsPanel(javax.swing.JPanel):
    ...
    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.framework.plugintool.ComponentProviderAdapter, __a2: unicode): ...
    ...
    def getTableModel(self) -> ghidra.app.plugin.core.function.tags.FunctionTableModel: ...
    ...
    @overload
    def refresh(self, __a0: java.util.Set) -> None: ...
    ...
    def setSelectedTags(self, __a0: java.util.Set) -> None: ...
    ...
    @property
    def selectedTags(self) -> None: ...  # No getter available.

    @selectedTags.setter
    def selectedTags(self, value: java.util.Set) -> None: ...

    @property
    def tableModel(self) -> ghidra.app.plugin.core.function.tags.FunctionTableModel: ...