...
class DebuggerPlaceBreakpointDialog(docking.DialogComponentProvider):
    ...
    def prompt(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.services.DebuggerLogicalBreakpointService, __a2: unicode, __a3: ghidra.program.util.ProgramLocation, __a4: long, __a5: java.util.Collection, __a6: unicode) -> None: ...
