...
class ReferenceUtils(object):
    ...
    @staticmethod
    def findDataTypeFieldReferences(__a0: ghidra.util.datastruct.Accumulator, __a1: ghidra.app.services.FieldMatcher, __a2: ghidra.program.model.listing.Program, __a3: bool, __a4: ghidra.util.task.TaskMonitor) -> None: ...

    @staticmethod
    def findDataTypeMatchesInDefinedData(__a0: ghidra.util.datastruct.Accumulator, __a1: ghidra.program.model.listing.Program, __a2: java.util.function.Predicate, __a3: ghidra.app.services.FieldMatcher, __a4: ghidra.util.task.TaskMonitor) -> None: ...

    @overload
    @staticmethod
    def findDataTypeReferences(__a0: ghidra.util.datastruct.Accumulator, __a1: ghidra.program.model.data.DataType, __a2: ghidra.program.model.listing.Program, __a3: bool, __a4: ghidra.util.task.TaskMonitor) -> None: ...
