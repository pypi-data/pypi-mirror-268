...
class BreakpointsDecompilerMarginProvider(javax.swing.JPanel, ghidra.app.decompiler.component.margin.DecompilerMarginProvider, docking.widgets.fieldpanel.listener.LayoutModelListener):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.breakpoint.DebuggerBreakpointMarkerPlugin): ...
    ...
    def setOptions(self, __a0: ghidra.app.decompiler.DecompileOptions) -> None: ...

    def setPreferredSize(self, __a0: java.awt.Dimension) -> None: ...

    def setProgram(self, __a0: ghidra.program.model.listing.Program, __a1: docking.widgets.fieldpanel.LayoutModel, __a2: ghidra.app.decompiler.component.margin.LayoutPixelIndexMap) -> None: ...
