...
class DebuggerTimeSelectionDialog(docking.DialogComponentProvider):
    ...
    def promptTime(self, __a0: ghidra.trace.model.Trace, __a1: ghidra.trace.model.time.schedule.TraceSchedule) -> ghidra.trace.model.time.schedule.TraceSchedule: ...
    ...
    def setScheduleText(self, __a0: unicode) -> None: ...
    ...
    @property
    def scheduleText(self) -> None: ...  # No getter available.

    @scheduleText.setter
    def scheduleText(self, value: unicode) -> None: ...
