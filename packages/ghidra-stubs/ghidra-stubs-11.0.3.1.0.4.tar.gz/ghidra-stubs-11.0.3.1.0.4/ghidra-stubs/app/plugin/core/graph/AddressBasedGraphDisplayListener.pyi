...
class AddressBasedGraphDisplayListener(object, ghidra.service.graph.GraphDisplayListener, ghidra.framework.plugintool.util.PluginEventListener, ghidra.framework.model.DomainObjectListener):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.program.model.listing.Program, __a2: ghidra.service.graph.GraphDisplay): ...
