...
class UnixShellScriptTraceRmiLaunchOffer(ghidra.app.plugin.core.debug.gui.tracermi.launcher.AbstractScriptTraceRmiLaunchOffer):
    SHEBANG: unicode = u'#!'
    ...
    @staticmethod
    def create(__a0: ghidra.app.plugin.core.debug.gui.tracermi.launcher.TraceRmiLauncherServicePlugin, __a1: ghidra.program.model.listing.Program, __a2: java.io.File) -> ghidra.app.plugin.core.debug.gui.tracermi.launcher.UnixShellScriptTraceRmiLaunchOffer: ...
