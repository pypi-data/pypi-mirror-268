...
class FunctionTagPlugin(ghidra.app.plugin.ProgramPlugin):
    ...
    def getProvider(self) -> ghidra.app.plugin.core.function.tags.FunctionTagProvider: ...
    ...
    @property
    def provider(self) -> ghidra.app.plugin.core.function.tags.FunctionTagProvider: ...