...
class DataTypeSettingsDialog(ghidra.app.plugin.core.data.AbstractSettingsDialog):




    def __init__(self, __a0: ghidra.program.model.data.DataType, __a1: List[ghidra.docking.settings.SettingsDefinition]): ...
