...
class PathTableModel(ghidra.app.plugin.core.debug.gui.model.AbstractQueryTableModel):





    class PathRow(object):




        def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.model.PathTableModel, __a1: ghidra.trace.model.target.TraceObjectValPath): ...



        def computeValue(self) -> object: ...
    ...
    def findTraceObject(self, __a0: ghidra.trace.model.target.TraceObject) -> ghidra.app.plugin.core.debug.gui.model.PathTableModel.PathRow: ...
