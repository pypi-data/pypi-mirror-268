...
class FunctionGraphPlugin(ghidra.app.plugin.ProgramPlugin, ghidra.framework.options.OptionsChangeListener, ghidra.app.plugin.core.functiongraph.FunctionGraphMarginService):
