...
class TraceValueObjectEditableAttributeColumn(ghidra.app.plugin.core.debug.gui.model.columns.TraceValueObjectAttributeColumn, ghidra.app.plugin.core.debug.gui.model.columns.EditableColumn):
    ...
    @overload
    def isEditable(self, __a0: ghidra.app.plugin.core.debug.gui.model.ObjectTableModel.ValueRow, __a1: ghidra.docking.settings.Settings, __a2: ghidra.trace.model.Trace, __a3: ghidra.framework.plugintool.ServiceProvider) -> bool: ...

    @overload
    def isEditable(self, __a0: object, __a1: ghidra.docking.settings.Settings, __a2: object, __a3: ghidra.framework.plugintool.ServiceProvider) -> bool: ...
    ...
    @overload
    def setValue(self, __a0: ghidra.app.plugin.core.debug.gui.model.ObjectTableModel.ValueRow, __a1: ghidra.app.plugin.core.debug.gui.model.ObjectTableModel.ValueProperty, __a2: ghidra.docking.settings.Settings, __a3: ghidra.trace.model.Trace, __a4: ghidra.framework.plugintool.ServiceProvider) -> None: ...

    @overload
    def setValue(self, __a0: object, __a1: object, __a2: ghidra.docking.settings.Settings, __a3: object, __a4: ghidra.framework.plugintool.ServiceProvider) -> None: ...
