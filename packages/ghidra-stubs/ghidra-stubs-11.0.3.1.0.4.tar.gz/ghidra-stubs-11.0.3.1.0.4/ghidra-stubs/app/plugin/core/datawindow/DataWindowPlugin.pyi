...
class DataWindowPlugin(ghidra.app.plugin.ProgramPlugin, ghidra.framework.model.DomainObjectListener):
    ...
    def getLimitedAddresses(self) -> ghidra.program.model.address.AddressSet: ...
    ...
    def typeEnabled(self, __a0: unicode) -> bool: ...
    ...
    @property
    def limitedAddresses(self) -> ghidra.program.model.address.AddressSet: ...