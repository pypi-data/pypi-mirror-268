...
class OverviewColorComponent(javax.swing.JPanel, ghidra.app.util.viewer.listingpanel.OverviewProvider):
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.plugin.core.overview.OverviewColorService): ...
    ...
    def refresh(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.program.model.address.Address) -> None: ...
    ...
    def uninstallActions(self) -> None: ...
