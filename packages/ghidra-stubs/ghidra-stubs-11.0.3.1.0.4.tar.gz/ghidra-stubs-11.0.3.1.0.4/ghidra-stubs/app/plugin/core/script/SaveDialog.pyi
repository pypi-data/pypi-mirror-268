...
class SaveDialog(docking.DialogComponentProvider, javax.swing.event.ListSelectionListener):
    ...
    def __init__(self, __a0: java.awt.Component, __a1: unicode, __a2: ghidra.app.plugin.core.script.GhidraScriptComponentProvider, __a3: List[object], __a4: generic.jar.ResourceFile, __a5: ghidra.util.HelpLocation): ...
