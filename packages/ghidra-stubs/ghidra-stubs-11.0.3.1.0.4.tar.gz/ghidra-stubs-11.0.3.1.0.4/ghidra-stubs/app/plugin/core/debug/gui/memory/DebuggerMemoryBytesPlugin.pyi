...
class DebuggerMemoryBytesPlugin(ghidra.app.plugin.core.byteviewer.AbstractByteViewerPlugin):
    ...
    def createViewerIfMissing(self, __a0: ghidra.debug.api.action.LocationTrackingSpec, __a1: bool) -> ghidra.app.plugin.core.debug.gui.memory.DebuggerMemoryBytesProvider: ...
