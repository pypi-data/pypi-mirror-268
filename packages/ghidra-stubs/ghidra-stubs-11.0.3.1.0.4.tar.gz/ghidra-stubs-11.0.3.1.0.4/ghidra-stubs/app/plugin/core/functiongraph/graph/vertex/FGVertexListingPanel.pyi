...
class FGVertexListingPanel(ghidra.app.util.viewer.listingpanel.ListingPanel):
    ...
    def addHighlightProvider(self, __a0: ghidra.app.util.ListingHighlightProvider) -> None: ...
    ...
    def removeHighlightProvider(self, __a0: ghidra.app.util.ListingHighlightProvider) -> None: ...
    ...
    @overload
    def setSelection(self, __a0: ghidra.program.util.ProgramSelection, __a1: docking.widgets.EventTrigger) -> None: ...
