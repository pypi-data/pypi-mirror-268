...
class MarkerManager(object, ghidra.app.services.MarkerService):
    ...
    @overload
    def createPointMarker(self, __a0: unicode, __a1: unicode, __a2: ghidra.program.model.listing.Program, __a3: int, __a4: bool, __a5: bool, __a6: bool, __a7: java.awt.Color, __a8: javax.swing.Icon) -> ghidra.app.services.MarkerSet: ...

    @overload
    def createPointMarker(self, __a0: unicode, __a1: unicode, __a2: ghidra.program.model.listing.Program, __a3: int, __a4: bool, __a5: bool, __a6: bool, __a7: java.awt.Color, __a8: javax.swing.Icon, __a9: bool) -> ghidra.app.services.MarkerSet: ...
    ...
    def getMarginProvider(self) -> ghidra.app.plugin.core.marker.MarkerMarginProvider: ...
    ...
    def isActiveMarkerForGroup(self, __a0: unicode, __a1: ghidra.app.services.MarkerSet, __a2: ghidra.program.model.listing.Program) -> bool: ...
    ...
    def setMarkerClickedListener(self, __a0: ghidra.app.util.viewer.listingpanel.MarkerClickedListener) -> None: ...
    ...
    @property
    def marginProvider(self) -> ghidra.app.plugin.core.marker.MarkerMarginProvider: ...
