...
class DebuggerMemoryBytesPanel(ghidra.app.plugin.core.byteviewer.ByteViewerPanel):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.memory.DebuggerMemoryBytesProvider): ...
    ...
    def getProvider(self) -> ghidra.app.plugin.core.debug.gui.memory.DebuggerMemoryBytesProvider: ...
    ...
    @property
    def provider(self) -> ghidra.app.plugin.core.debug.gui.memory.DebuggerMemoryBytesProvider: ...