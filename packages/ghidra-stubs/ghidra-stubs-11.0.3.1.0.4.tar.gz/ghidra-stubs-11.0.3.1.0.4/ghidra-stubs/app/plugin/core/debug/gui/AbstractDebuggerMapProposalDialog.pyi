...
class AbstractDebuggerMapProposalDialog(docking.ReusableDialogComponentProvider):
    ...
    def adjustCollection(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: java.util.Collection) -> java.util.Collection: ...
    ...
    def getAdjusted(self) -> java.util.Collection: ...
    ...
    def getTableModel(self) -> docking.widgets.table.EnumeratedColumnTableModel: ...
    ...
    @property
    def adjusted(self) -> java.util.Collection: ...

    @property
    def table(self) -> docking.widgets.table.GTable: ...

    @property
    def tableModel(self) -> docking.widgets.table.EnumeratedColumnTableModel: ...