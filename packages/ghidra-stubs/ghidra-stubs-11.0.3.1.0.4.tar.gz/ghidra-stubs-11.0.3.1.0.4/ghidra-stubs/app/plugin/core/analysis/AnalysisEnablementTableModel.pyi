...
class AnalysisEnablementTableModel(docking.widgets.table.GDynamicColumnTableModel):




    def __init__(self, __a0: ghidra.app.plugin.core.analysis.AnalysisPanel, __a1: List[object]): ...
    ...
    def setData(self, __a0: List[object]) -> None: ...
    ...
    @property
    def data(self) -> None: ...  # No getter available.

    @data.setter
    def data(self, value: List[object]) -> None: ...
