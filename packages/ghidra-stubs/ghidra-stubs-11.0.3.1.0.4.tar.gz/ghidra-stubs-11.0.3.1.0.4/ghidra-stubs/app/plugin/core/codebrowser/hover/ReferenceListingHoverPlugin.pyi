...
class ReferenceListingHoverPlugin(ghidra.framework.plugintool.Plugin):
    ...
    def getReferenceHoverService(self) -> ghidra.app.plugin.core.codebrowser.hover.ReferenceListingHover: ...
    ...
    @property
    def referenceHoverService(self) -> ghidra.app.plugin.core.codebrowser.hover.ReferenceListingHover: ...