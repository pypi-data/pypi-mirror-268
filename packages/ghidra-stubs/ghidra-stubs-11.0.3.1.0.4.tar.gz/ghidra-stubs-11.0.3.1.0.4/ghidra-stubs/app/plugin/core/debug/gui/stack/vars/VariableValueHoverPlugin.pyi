...
class VariableValueHoverPlugin(ghidra.framework.plugintool.Plugin):
    ...
    def getHoverService(self) -> ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueHoverService: ...
    ...
    @property
    def hoverService(self) -> ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueHoverService: ...