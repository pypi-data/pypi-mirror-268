...
class TableServicePlugin(ghidra.app.plugin.ProgramPlugin, ghidra.app.util.query.TableService, ghidra.framework.model.DomainObjectListener):
    ...
    def showTableWithMarkers(self, __a0: unicode, __a1: unicode, __a2: ghidra.util.table.GhidraProgramTableModel, __a3: java.awt.Color, __a4: javax.swing.Icon, __a5: unicode, __a6: ghidra.app.nav.Navigatable) -> ghidra.app.plugin.core.table.TableComponentProvider: ...
