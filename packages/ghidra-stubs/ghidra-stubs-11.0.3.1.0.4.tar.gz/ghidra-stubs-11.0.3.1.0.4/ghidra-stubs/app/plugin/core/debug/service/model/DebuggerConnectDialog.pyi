...
class DebuggerConnectDialog(docking.ReusableDialogComponentProvider, java.beans.PropertyChangeListener):
    ...
    def setFactoryByBrief(self, __a0: unicode) -> None: ...
    ...
    @property
    def factoryByBrief(self) -> None: ...  # No getter available.

    @factoryByBrief.setter
    def factoryByBrief(self, value: unicode) -> None: ...
