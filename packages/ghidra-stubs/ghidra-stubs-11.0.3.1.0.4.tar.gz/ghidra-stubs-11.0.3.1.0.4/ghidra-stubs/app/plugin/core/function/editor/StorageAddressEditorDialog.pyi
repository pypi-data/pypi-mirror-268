...
class StorageAddressEditorDialog(docking.DialogComponentProvider, ghidra.app.plugin.core.function.editor.ModelChangeListener):




    @overload
    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.app.services.DataTypeManagerService, __a2: ghidra.program.model.listing.Variable, __a3: int): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.app.services.DataTypeManagerService, __a2: ghidra.program.model.listing.VariableStorage, __a3: ghidra.app.plugin.core.function.editor.FunctionVariableData): ...
    ...
    def tableRowsChanged(self) -> None: ...
