...
class TraceEventListener(ghidra.dbg.AnnotatedDebuggerAttributeListener):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.service.model.TraceObjectManager): ...
    ...
    def executionStateChanged(self, __a0: ghidra.dbg.target.TargetObject, __a1: ghidra.dbg.target.TargetExecutionStateful.TargetExecutionState) -> None: ...

    def flushEvents(self) -> java.util.concurrent.CompletableFuture: ...

    def focusChanged(self, __a0: ghidra.dbg.target.TargetObject, __a1: ghidra.dbg.target.TargetObject) -> None: ...
