...
class InterpreterPanelPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.plugin.core.interpreter.InterpreterPanelService):
    ...
    def createInterpreterPanel(self, __a0: ghidra.app.plugin.core.interpreter.InterpreterConnection, __a1: bool) -> ghidra.app.plugin.core.interpreter.InterpreterConsole: ...
