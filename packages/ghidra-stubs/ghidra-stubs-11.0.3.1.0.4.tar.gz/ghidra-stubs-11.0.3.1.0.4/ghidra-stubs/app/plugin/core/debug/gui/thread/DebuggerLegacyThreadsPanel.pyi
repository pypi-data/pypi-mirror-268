...
class DebuggerLegacyThreadsPanel(javax.swing.JPanel):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.thread.DebuggerThreadsPlugin, __a1: ghidra.app.plugin.core.debug.gui.thread.DebuggerThreadsProvider): ...
