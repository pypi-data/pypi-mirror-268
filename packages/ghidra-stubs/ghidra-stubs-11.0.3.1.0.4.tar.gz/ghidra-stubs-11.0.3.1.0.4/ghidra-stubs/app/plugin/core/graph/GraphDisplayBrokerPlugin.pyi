...
class GraphDisplayBrokerPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.GraphDisplayBroker, ghidra.framework.options.OptionsChangeListener):
    ...
    def addGraphDisplayBrokerListener(self, __a0: ghidra.app.plugin.core.graph.GraphDisplayBrokerListener) -> None: ...
    ...
    def getDefaultGraphDisplay(self, __a0: bool, __a1: ghidra.util.task.TaskMonitor) -> ghidra.service.graph.GraphDisplay: ...

    def getDefaultGraphDisplayProvider(self) -> ghidra.service.graph.GraphDisplayProvider: ...

    def getGraphDisplayProvider(self, __a0: unicode) -> ghidra.service.graph.GraphDisplayProvider: ...

    @overload
    def getGraphExporters(self) -> List[object]: ...

    @overload
    def getGraphExporters(self, __a0: unicode) -> ghidra.service.graph.AttributedGraphExporter: ...
    ...
    def removeGraphDisplayBrokerLisetener(self, __a0: ghidra.app.plugin.core.graph.GraphDisplayBrokerListener) -> None: ...
    ...
    def setDefaultGraphDisplayProvider(self, __a0: ghidra.service.graph.GraphDisplayProvider) -> None: ...
    ...
    @defaultGraphDisplayProvider.setter
    def defaultGraphDisplayProvider(self, value: ghidra.service.graph.GraphDisplayProvider) -> None: ...
