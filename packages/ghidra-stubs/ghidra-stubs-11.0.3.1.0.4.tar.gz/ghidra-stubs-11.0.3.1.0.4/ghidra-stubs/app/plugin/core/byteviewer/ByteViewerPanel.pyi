...
class ByteViewerPanel(javax.swing.JPanel, javax.swing.event.TableColumnModelListener, docking.widgets.fieldpanel.LayoutModel, docking.widgets.fieldpanel.listener.LayoutListener):
    ...
    def getCurrentComponent(self) -> ghidra.app.plugin.core.byteviewer.ByteViewerComponent: ...
    ...
    def getViewList(self) -> List[object]: ...
    ...
    def setViewerBackgroundColorModel(self, __a0: docking.widgets.fieldpanel.support.BackgroundColorModel) -> None: ...

    def setViewerPosition(self, __a0: docking.widgets.fieldpanel.support.ViewerPosition) -> None: ...
    ...
    @property
    def currentComponent(self) -> ghidra.app.plugin.core.byteviewer.ByteViewerComponent: ...
    ...
    @property
    def viewList(self) -> List[object]: ...

    @property
    def viewerBackgroundColorModel(self) -> None: ...  # No getter available.

    @viewerBackgroundColorModel.setter
    def viewerBackgroundColorModel(self, value: docking.widgets.fieldpanel.support.BackgroundColorModel) -> None: ...
