...
class DebuggerBlockChooserDialog(docking.ReusableDialogComponentProvider):
    ...
    class MemoryBlockRow(object):
        ...
        @overload
        def score(self, __a0: ghidra.trace.model.memory.TraceMemoryRegion, __a1: ghidra.app.services.DebuggerStaticMappingService) -> float: ...

        @overload
        def score(self, __a0: ghidra.trace.model.modules.TraceSection, __a1: ghidra.app.services.DebuggerStaticMappingService) -> float: ...
    ...
    @overload
    def chooseBlock(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.trace.model.memory.TraceMemoryRegion, __a2: java.util.Collection) -> java.util.Map.Entry: ...

    @overload
    def chooseBlock(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.trace.model.modules.TraceSection, __a2: java.util.Collection) -> java.util.Map.Entry: ...
    ...
    def getChosen(self) -> java.util.Map.Entry: ...
    ...
    def getTableFilterPanel(self) -> ghidra.util.table.GhidraTableFilterPanel: ...
    ...
    @property
    def chosen(self) -> java.util.Map.Entry: ...

    @property
    def tableFilterPanel(self) -> ghidra.util.table.GhidraTableFilterPanel: ...
