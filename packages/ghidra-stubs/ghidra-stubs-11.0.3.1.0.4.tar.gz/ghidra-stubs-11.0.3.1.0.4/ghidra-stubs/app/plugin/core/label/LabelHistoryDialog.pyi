...
class LabelHistoryDialog(docking.DialogComponentProvider, ghidra.app.plugin.core.label.LabelHistoryListener):




    @overload
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.program.model.listing.Program, __a2: unicode, __a3: List[object]): ...

    @overload
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.program.model.listing.Program, __a2: ghidra.program.model.address.Address, __a3: List[object]): ...



    def addAction(self, __a0: docking.action.DockingActionIf) -> None: ...

    def addressSelected(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.address.Address) -> None: ...
