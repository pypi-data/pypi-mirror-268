...
class DebuggerListingPlugin(ghidra.app.plugin.core.codebrowser.AbstractCodeBrowserPlugin, ghidra.app.services.DebuggerListingService):
    ...
    def createListingIfMissing(self, __a0: ghidra.debug.api.action.LocationTrackingSpec, __a1: bool) -> ghidra.app.plugin.core.debug.gui.listing.DebuggerListingProvider: ...
