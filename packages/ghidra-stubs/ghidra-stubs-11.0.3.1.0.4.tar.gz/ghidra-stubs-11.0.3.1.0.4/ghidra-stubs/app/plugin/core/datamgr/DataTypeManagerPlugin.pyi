...
class DataTypeManagerPlugin(ghidra.app.plugin.ProgramPlugin, ghidra.framework.model.DomainObjectListener, ghidra.app.services.DataTypeManagerService, ghidra.app.services.DataTypeArchiveService, docking.actions.PopupActionProvider):
