...
class TerminalProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.terminal.TerminalPlugin, __a1: java.nio.charset.Charset): ...
    ...
    def getTerminalPanel(self) -> ghidra.app.plugin.core.terminal.TerminalPanel: ...
    ...
    @property
    def terminalPanel(self) -> ghidra.app.plugin.core.terminal.TerminalPanel: ...
