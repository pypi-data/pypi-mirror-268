...
class DataSettingsDialog(ghidra.app.plugin.core.data.AbstractSettingsDialog):




    @overload
    def __init__(self, __a0: ghidra.program.model.listing.Data): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.util.ProgramSelection): ...
