...
class LaunchAction(docking.menu.MultiActionDockingAction):
    ...
    HELP_ANCHOR: unicode = u'launch_tracermi'
    ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/11.0.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    NAME: unicode = u'Launch'



    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.tracermi.launcher.TraceRmiLauncherServicePlugin): ...
