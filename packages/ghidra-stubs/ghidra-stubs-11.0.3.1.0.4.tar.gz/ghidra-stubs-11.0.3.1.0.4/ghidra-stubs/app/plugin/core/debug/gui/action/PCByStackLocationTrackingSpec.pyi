...
class PCByStackLocationTrackingSpec(java.lang.Enum, ghidra.debug.api.action.LocationTrackingSpec, ghidra.debug.api.action.LocationTracker):
    ...
    def doComputeTraceAddress(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> ghidra.program.model.address.Address: ...
