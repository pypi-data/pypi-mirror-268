...
class TraceValueValColumn(docking.widgets.table.AbstractDynamicTableColumn):
    ...
    @overload
    def getValue(self, __a0: ghidra.app.plugin.core.debug.gui.model.ObjectTableModel.ValueRow, __a1: ghidra.docking.settings.Settings, __a2: ghidra.trace.model.Trace, __a3: ghidra.framework.plugintool.ServiceProvider) -> ghidra.app.plugin.core.debug.gui.model.ObjectTableModel.ValueRow: ...
