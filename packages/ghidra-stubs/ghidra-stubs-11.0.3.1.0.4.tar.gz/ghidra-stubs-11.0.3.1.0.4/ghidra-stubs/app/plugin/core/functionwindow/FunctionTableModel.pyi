...
class FunctionTableModel(ghidra.util.table.AddressBasedTableModel):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.program.model.listing.Program): ...
    ...
    @overload
    def reload(self, __a0: ghidra.program.model.listing.Program) -> None: ...
