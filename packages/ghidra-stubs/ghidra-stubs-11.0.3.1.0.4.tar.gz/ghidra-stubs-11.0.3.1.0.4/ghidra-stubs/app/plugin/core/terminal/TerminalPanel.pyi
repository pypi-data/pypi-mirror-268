...
class TerminalPanel(javax.swing.JPanel, docking.widgets.fieldpanel.listener.FieldLocationListener, docking.widgets.fieldpanel.listener.FieldSelectionListener, docking.widgets.fieldpanel.listener.LayoutListener, ghidra.app.plugin.core.terminal.vt.AnsiColorResolver):





    class FindOptions(java.lang.Enum):
        CASE_SENSITIVE: ghidra.app.plugin.core.terminal.TerminalPanel.FindOptions = CASE_SENSITIVE
        REGEX: ghidra.app.plugin.core.terminal.TerminalPanel.FindOptions = REGEX
        WHOLE_WORD: ghidra.app.plugin.core.terminal.TerminalPanel.FindOptions = WHOLE_WORD
        WRAP: ghidra.app.plugin.core.terminal.TerminalPanel.FindOptions = WRAP
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.app.plugin.core.terminal.TerminalPanel.FindOptions: ...
        ...
        @staticmethod
        def values() -> List[ghidra.app.plugin.core.terminal.TerminalPanel.FindOptions]: ...
    ...
    def find(self, __a0: unicode, __a1: java.util.Set, __a2: docking.widgets.fieldpanel.support.FieldLocation, __a3: bool) -> docking.widgets.fieldpanel.support.FieldRange: ...
    ...
    def getFieldPanel(self) -> ghidra.app.plugin.core.terminal.TerminalPanel.TerminalFieldPanel: ...
    ...
    def paste(self, __a0: unicode) -> None: ...
    ...
    def selectWordAt(self, __a0: docking.widgets.fieldpanel.support.FieldLocation, __a1: docking.widgets.EventTrigger) -> None: ...
    ...
    def setDynamicTerminalSize(self) -> None: ...

    def setEnabled(self, __a0: bool) -> None: ...

    def setFixedTerminalSize(self, __a0: int, __a1: int) -> None: ...
    ...
    def setOutputCallback(self, __a0: ghidra.app.plugin.core.terminal.vt.VtOutput) -> None: ...
    ...
    @property
    def fieldPanel(self) -> ghidra.app.plugin.core.terminal.TerminalPanel.TerminalFieldPanel: ...
    ...
    @property
    def outputCallback(self) -> None: ...  # No getter available.

    @outputCallback.setter
    def outputCallback(self, value: ghidra.app.plugin.core.terminal.vt.VtOutput) -> None: ...
