...
class TraceValueObjectPropertyColumn(docking.widgets.table.AbstractDynamicTableColumn):





    class PropertyRenderer(ghidra.util.table.column.AbstractGColumnRenderer, ghidra.app.plugin.core.debug.gui.model.ColorsModified.InTable):




        def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.model.columns.TraceValueObjectPropertyColumn): ...
        ...
        @overload
        def getDiffForeground(self, __a0: javax.swing.JTable) -> java.awt.Color: ...

        @overload
        def getDiffForeground(self, __a0: javax.swing.JComponent) -> java.awt.Color: ...

        @overload
        def getDiffSelForeground(self, __a0: javax.swing.JTable) -> java.awt.Color: ...
        ...
        @overload
        def getFilterString(self, __a0: ghidra.app.plugin.core.debug.gui.model.ObjectTableModel.ValueProperty, __a1: ghidra.docking.settings.Settings) -> unicode: ...
    ...
    class BooleanPropertyRenderer(ghidra.app.plugin.core.debug.gui.model.columns.TraceValueObjectPropertyColumn.PropertyRenderer):
