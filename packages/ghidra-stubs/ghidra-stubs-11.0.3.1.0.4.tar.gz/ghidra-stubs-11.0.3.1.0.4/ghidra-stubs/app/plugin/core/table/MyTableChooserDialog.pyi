...
class MyTableChooserDialog(ghidra.app.tablechooser.TableChooserDialog):
    ...
    def contains(self, __a0: ghidra.app.tablechooser.AddressableRowObject) -> bool: ...
    ...
    def setSortColumn(self, __a0: int) -> None: ...

    def setSortState(self, __a0: docking.widgets.table.TableSortState) -> None: ...
