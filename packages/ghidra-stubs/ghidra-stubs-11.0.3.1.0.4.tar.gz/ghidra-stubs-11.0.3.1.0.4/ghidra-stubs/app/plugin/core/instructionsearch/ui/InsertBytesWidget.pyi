...
class InsertBytesWidget(docking.ReusableDialogComponentProvider, java.awt.event.KeyListener):
    ...
    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.app.plugin.core.instructionsearch.ui.InstructionSearchDialog): ...
    ...
    def getSelectionModeWidget(self) -> ghidra.app.plugin.core.instructionsearch.ui.SelectionModeWidget: ...
    ...
    def setInputInvalid(self) -> None: ...

    def setInputString(self, __a0: unicode) -> None: ...
    ...
    @overload
    def validateInput(self, __a0: unicode) -> bool: ...
    ...
    @inputString.setter
    def inputString(self, value: unicode) -> None: ...

    @property
    def selectionModeWidget(self) -> ghidra.app.plugin.core.instructionsearch.ui.SelectionModeWidget: ...