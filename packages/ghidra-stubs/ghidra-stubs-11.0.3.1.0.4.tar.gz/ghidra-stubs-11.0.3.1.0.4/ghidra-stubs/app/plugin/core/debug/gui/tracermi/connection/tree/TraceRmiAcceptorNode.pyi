...
class TraceRmiAcceptorNode(ghidra.app.plugin.core.debug.gui.tracermi.connection.tree.AbstractTraceRmiManagerNode):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.tracermi.connection.TraceRmiConnectionManagerProvider, __a1: ghidra.debug.api.tracermi.TraceRmiAcceptor): ...
