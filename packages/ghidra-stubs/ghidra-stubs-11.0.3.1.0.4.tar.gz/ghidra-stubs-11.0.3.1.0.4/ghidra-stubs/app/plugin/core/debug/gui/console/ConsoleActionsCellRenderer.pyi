...
class ConsoleActionsCellRenderer(ghidra.util.table.column.AbstractGhidraColumnRenderer):
    ...
    @overload
    def getFilterString(self, __a0: ghidra.app.plugin.core.debug.gui.console.DebuggerConsoleProvider.ActionList, __a1: ghidra.docking.settings.Settings) -> unicode: ...
