...
class MinusExpressionSolver(ghidra.app.plugin.assembler.sleigh.expr.AbstractUnaryExpressionSolver):
    """
    ...
    @overload
    def getInstructionLength(self, __a0: ghidra.app.plugin.processors.sleigh.expression.UnaryExpression) -> int: ...

    @overload
    def getInstructionLength(self, __a0: ghidra.app.plugin.processors.sleigh.expression.PatternExpression) -> int: ...

    @overload
    def getValue(self, __a0: ghidra.app.plugin.processors.sleigh.expression.UnaryExpression, __a1: java.util.Map, __a2: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns) -> ghidra.app.plugin.assembler.sleigh.expr.MaskedLong: ...
    ...
    @overload
    def solve(self, __a0: ghidra.app.plugin.processors.sleigh.expression.UnaryExpression, __a1: ghidra.app.plugin.assembler.sleigh.expr.MaskedLong, __a2: java.util.Map, __a3: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns, __a4: java.util.Set, __a5: unicode) -> ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolution: ...
    ...
    @overload
    def valueForResolution(self, __a0: ghidra.app.plugin.processors.sleigh.expression.UnaryExpression, __a1: java.util.Map, __a2: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns) -> ghidra.app.plugin.assembler.sleigh.expr.MaskedLong: ...
