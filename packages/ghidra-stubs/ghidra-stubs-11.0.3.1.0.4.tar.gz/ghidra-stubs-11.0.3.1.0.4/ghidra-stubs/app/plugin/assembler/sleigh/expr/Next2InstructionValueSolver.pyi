...
class Next2InstructionValueSolver(ghidra.app.plugin.assembler.sleigh.expr.AbstractExpressionSolver):
    ...
    @overload
    def solve(self, iv: ghidra.app.plugin.processors.sleigh.expression.Next2InstructionValue, goal: ghidra.app.plugin.assembler.sleigh.expr.MaskedLong, vals: java.util.Map, cur: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns, hints: java.util.Set, description: unicode) -> ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolution: ...
