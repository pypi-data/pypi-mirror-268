...
class EndInstructionValueSolver(ghidra.app.plugin.assembler.sleigh.expr.AbstractExpressionSolver):
    """
    ...
    @overload
    def getInstructionLength(self, iv: ghidra.app.plugin.processors.sleigh.expression.EndInstructionValue) -> int: ...

    @overload
    def getInstructionLength(self, __a0: ghidra.app.plugin.processors.sleigh.expression.PatternExpression) -> int: ...

    @overload
    def getValue(self, iv: ghidra.app.plugin.processors.sleigh.expression.EndInstructionValue, vals: java.util.Map, cur: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns) -> ghidra.app.plugin.assembler.sleigh.expr.MaskedLong: ...
    ...
    @overload
    def solve(self, iv: ghidra.app.plugin.processors.sleigh.expression.EndInstructionValue, goal: ghidra.app.plugin.assembler.sleigh.expr.MaskedLong, vals: java.util.Map, cur: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns, hints: java.util.Set, description: unicode) -> ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolution: ...
    ...
    @overload
    def valueForResolution(self, exp: ghidra.app.plugin.processors.sleigh.expression.EndInstructionValue, vals: java.util.Map, rc: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns) -> ghidra.app.plugin.assembler.sleigh.expr.MaskedLong: ...
