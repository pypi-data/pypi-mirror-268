...
class XorExpressionSolver(ghidra.app.plugin.assembler.sleigh.expr.AbstractBinaryExpressionSolver):
    """
    ...
    def computeLeft(self, other: ghidra.app.plugin.assembler.sleigh.expr.MaskedLong, goal: ghidra.app.plugin.assembler.sleigh.expr.MaskedLong) -> ghidra.app.plugin.assembler.sleigh.expr.MaskedLong: ...
