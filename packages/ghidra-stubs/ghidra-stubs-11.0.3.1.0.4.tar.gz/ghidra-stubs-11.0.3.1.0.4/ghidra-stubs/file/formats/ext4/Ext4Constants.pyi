...
class Ext4Constants(object):
    ...
    EXT4_INODE_INDEX_BADBLOCKS: int = 1
    EXT4_INODE_INDEX_BOOTLOADER: int = 5
    EXT4_INODE_INDEX_EXCLUDEINODE: int = 9
    EXT4_INODE_INDEX_GROUPQUOTA: int = 4
    EXT4_INODE_INDEX_JOURNALINODE: int = 8
    EXT4_INODE_INDEX_NORMAL_FIRSTUSED: int = 11
    EXT4_INODE_INDEX_NULL: int = 0
    EXT4_INODE_INDEX_REPLICAINODE: int = 10
    EXT4_INODE_INDEX_RESERVED_GROUPDESCRIPTORS: int = 7
    EXT4_INODE_INDEX_ROOTDIR: int = 2
    EXT4_INODE_INDEX_UNDELETEDIR: int = 6
    EXT4_INODE_INDEX_USERQUOTA: int = 3
    ...
    EXT4_UNRM_FL: int = 2
    EXT4_XATTR_MAGIC: int = -368967680
    EXT4_XATTR_NAMEINDEX_STRINGS: List[unicode] = array(java.lang.String, [u'', u'user.', u'system.posix_acl_access.', u'system.posix_acl_default', u'trusted.', u'lustre.', u'security.', u'system.', u'system.richacl'])
