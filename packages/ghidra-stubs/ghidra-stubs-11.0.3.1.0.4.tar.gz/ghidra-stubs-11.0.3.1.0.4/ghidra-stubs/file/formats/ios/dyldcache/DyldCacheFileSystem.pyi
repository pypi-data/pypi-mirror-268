...
class DyldCacheFileSystem(ghidra.formats.gfilesystem.GFileSystemBase):
    DYLD_CACHE_FSTYPE: unicode = u'dyldcachev1'
    ...
    @staticmethod
    def getDyldDataPath(__a0: unicode, __a1: int) -> unicode: ...
    ...
    def getSplitDyldCache(self) -> ghidra.app.util.opinion.DyldCacheUtils.SplitDyldCache: ...

    @staticmethod
    def getStubPath(__a0: unicode) -> unicode: ...
    ...
    @property
    def splitDyldCache(self) -> ghidra.app.util.opinion.DyldCacheUtils.SplitDyldCache: ...