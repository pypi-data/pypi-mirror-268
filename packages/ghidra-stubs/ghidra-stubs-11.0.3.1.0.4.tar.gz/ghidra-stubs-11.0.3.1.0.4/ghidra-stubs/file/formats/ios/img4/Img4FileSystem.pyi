...
class Img4FileSystem(ghidra.formats.gfilesystem.GFileSystemBase):
    ...
    def isDirectory(self, __a0: ghidra.formats.gfilesystem.GFileImpl) -> bool: ...

    def isFile(self, __a0: ghidra.formats.gfilesystem.GFileImpl) -> bool: ...
