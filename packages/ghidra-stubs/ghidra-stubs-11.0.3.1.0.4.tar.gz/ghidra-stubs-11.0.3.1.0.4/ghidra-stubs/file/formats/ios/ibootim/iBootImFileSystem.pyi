...
class iBootImFileSystem(ghidra.formats.gfilesystem.GFileSystemBase, ghidra.formats.gfilesystem.GIconProvider):
    ...
    def getIcon(self, __a0: ghidra.formats.gfilesystem.GFile, __a1: ghidra.util.task.TaskMonitor) -> javax.swing.Icon: ...

    @staticmethod
    def getIconForFile(__a0: ghidra.formats.gfilesystem.GFile, __a1: ghidra.util.task.TaskMonitor) -> javax.swing.Icon: ...
