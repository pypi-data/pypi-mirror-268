...
class MachoPrelinkFileSystem(ghidra.formats.gfilesystem.GFileSystemBase, ghidra.formats.gfilesystem.GFileSystemProgramProvider):
    IOS_PRELINK_FSTYPE: unicode = u'iosprelink'
    ...
    def canProvideProgram(self, __a0: ghidra.formats.gfilesystem.GFile) -> bool: ...
    ...
    def getProgram(self, __a0: ghidra.formats.gfilesystem.GFile, __a1: ghidra.program.model.lang.LanguageService, __a2: ghidra.util.task.TaskMonitor, __a3: object) -> ghidra.program.model.listing.Program: ...
