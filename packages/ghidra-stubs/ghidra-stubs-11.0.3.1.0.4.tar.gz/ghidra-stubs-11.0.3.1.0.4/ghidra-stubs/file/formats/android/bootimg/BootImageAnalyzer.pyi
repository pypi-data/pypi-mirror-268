...
class BootImageAnalyzer(ghidra.file.analyzers.FileFormatAnalyzer, ghidra.app.plugin.core.analysis.AnalysisWorker):
    ...
    def analyze(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.address.AddressSetView, __a2: ghidra.util.task.TaskMonitor, __a3: ghidra.app.util.importer.MessageLog) -> bool: ...
