...
class OatHeader_064(ghidra.file.formats.android.oat.OatHeader):
    ...
    @property
    def instructionSetFeaturesBitmap(self) -> int: ...
    ...
    @property
    def quickGenericJniTrampolineOffset(self) -> int: ...

    @property
    def quickImtConflictTrampolineOffset(self) -> int: ...

    @property
    def quickResolutionTrampolineOffset(self) -> int: ...

    @property
    def quickToInterpreterBridgeOffset(self) -> int: ...