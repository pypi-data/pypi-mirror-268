...
class LZ4ArchiveFileSystem(ghidra.formats.gfilesystem.GFileSystemBase):
    ARCHIVE_MAGIC: int = 407642370
    ARCHIVE_MAGIC_BYTES: List[int] = array('b', [2, 33, 76, 24])
    LZ4_DEFAULT_UNCOMPRESSED_CHUNK_SIZE: int = 8388608
    NAME: unicode = u'lz4_decompressed'
