...
class GProgressBar(javax.swing.JPanel):
    ...
    def __init__(self, cancelledListener: ghidra.util.task.CancelledListener, includeTextField: bool, includeCancelButton: bool, includeAnimatedIcon: bool, fontSize: float): ...
    ...
    def initialize(self, maximum: long) -> None: ...
    ...
    @property
    def backgroundColor(self) -> None: ...  # No getter available.

    @backgroundColor.setter
    def backgroundColor(self, value: java.awt.Color) -> None: ...

    @property
    def cancelledListener(self) -> None: ...  # No getter available.

    @cancelledListener.setter
    def cancelledListener(self, value: ghidra.util.task.CancelledListener) -> None: ...

    @property
    def indeterminate(self) -> None: ...  # No getter available.
    ...
    @property
    def maximum(self) -> None: ...  # No getter available.
