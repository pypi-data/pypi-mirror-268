...
class ToolOptions(ghidra.framework.options.AbstractOptions):
    ...
    PRIMITIVE_CLASSES: java.util.Set = [class java.lang.Float, class java.lang.Double, class java.lang.Integer, class java.lang.Long, class java.lang.String, class java.lang.Short, class java.lang.Byte, class java.lang.Boolean]
    WRAPPABLE_CLASSES: java.util.Set = [class java.awt.Font, class java.io.File, class java.awt.Color, class javax.swing.KeyStroke]
    ...
    @overload
    def registerOption(self, optionName: unicode, type: ghidra.framework.options.OptionType, defaultValue: object, help: ghidra.util.HelpLocation, description: unicode, editorSupplier: java.util.function.Supplier) -> None: ...
    ...
    @overload
    def registerOptionsEditor(self, editor: java.util.function.Supplier) -> None: ...

    @overload
    def registerOptionsEditor(self, categoryPath: unicode, editorSupplier: java.util.function.Supplier) -> None: ...
