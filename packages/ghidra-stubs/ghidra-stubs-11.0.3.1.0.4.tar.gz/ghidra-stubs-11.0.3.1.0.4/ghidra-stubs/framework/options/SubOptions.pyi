...
class SubOptions(object, ghidra.framework.options.Options):
    ...
    @overload
    def registerOption(self, optionName: unicode, type: ghidra.framework.options.OptionType, defaultValue: object, help: ghidra.util.HelpLocation, description: unicode, editor: java.util.function.Supplier) -> None: ...
