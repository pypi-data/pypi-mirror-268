...
class PluginInstallerTableModel(docking.widgets.table.threaded.ThreadedTableModel):
    """
    Table model for the PluginInstallerDialog dialog. This defines the table columns and
     their values.
    """
    ...
    def getDataSource(self) -> List[ghidra.framework.plugintool.util.PluginDescription]: ...
