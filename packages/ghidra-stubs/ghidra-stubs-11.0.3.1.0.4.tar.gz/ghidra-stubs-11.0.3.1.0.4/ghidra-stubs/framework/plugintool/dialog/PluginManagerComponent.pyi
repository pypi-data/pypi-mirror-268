...
class PluginManagerComponent(javax.swing.JPanel, javax.swing.Scrollable):
    ...
    def getScrollableBlockIncrement(self, visibleRect: java.awt.Rectangle, orientation: int, direction: int) -> int: ...

    def getScrollableTracksViewportHeight(self) -> bool: ...

    def getScrollableTracksViewportWidth(self) -> bool: ...

    def getScrollableUnitIncrement(self, visibleRect: java.awt.Rectangle, orientation: int, direction: int) -> int: ...
