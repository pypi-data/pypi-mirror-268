...
class DataTreeDialog(docking.DialogComponentProvider, docking.widgets.tree.support.GTreeSelectionListener, java.awt.event.ActionListener):
    ...
    @overload
    def __init__(self, parent: java.awt.Component, title: unicode, type: int, filter: ghidra.framework.model.DomainFileFilter, project: ghidra.framework.model.Project):
        """
    ...
    def selectFolder(self, folder: ghidra.framework.model.DomainFolder) -> None:
        """
