...
class FrontEndPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.main.FrontEndService, ghidra.framework.client.RemoteAdapterListener, ghidra.framework.model.ProjectViewListener, ghidra.framework.main.ProgramaticUseOnly):
    """
    ...
    def openDomainFile(self, domainFile: ghidra.framework.model.DomainFile) -> None: ...
