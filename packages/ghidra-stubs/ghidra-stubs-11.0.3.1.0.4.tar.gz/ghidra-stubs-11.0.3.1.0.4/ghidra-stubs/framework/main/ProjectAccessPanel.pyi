...
class ProjectAccessPanel(docking.wizard.AbstractWizardJPanel):
    """
    ...
    @overload
    def __init__(self, knownUsers: List[unicode], repository: ghidra.framework.client.RepositoryAdapter, tool: ghidra.framework.plugintool.PluginTool):
        """
    ...
    @overload
    def __init__(self, __a0: List[unicode], __a1: unicode, __a2: List[object], __a3: unicode, __a4: bool, __a5: bool, __a6: ghidra.framework.plugintool.PluginTool): ...
    ...
    def addWizardPanelListener(self, l: docking.wizard.WizardPanelListener) -> None:
        """
    ...
    def notifyListenersOfStatusMessage(self, msg: unicode) -> None:
        """
    ...
    def notifyListenersOfValidityChanged(self) -> None:
        """
    ...
    def removeWizardPanelListener(self, l: docking.wizard.WizardPanelListener) -> None:
        """
    ...
    @property
    def validInformation(self) -> bool: ...