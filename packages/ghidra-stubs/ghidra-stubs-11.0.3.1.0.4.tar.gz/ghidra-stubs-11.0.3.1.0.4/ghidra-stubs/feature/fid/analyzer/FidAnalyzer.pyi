...
class FidAnalyzer(ghidra.app.services.AbstractAnalyzer):
    APPLY_ALL_FID_LABELS_OPTION_NAME: unicode = u'Always Apply FID Labels'
    OPTION_NAME_CREATE_BOOKMARKS: unicode = u'Create Analysis Bookmarks'
