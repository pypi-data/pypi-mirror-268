...
class CreateManualMatchTask(ghidra.feature.vt.gui.task.VtTask):




    @overload
    def __init__(self, __a0: ghidra.feature.vt.api.main.VTSession, __a1: ghidra.program.model.listing.Function, __a2: ghidra.program.model.listing.Function): ...

    @overload
    def __init__(self, __a0: unicode, __a1: ghidra.feature.vt.api.main.VTSession, __a2: ghidra.program.model.listing.Function, __a3: ghidra.program.model.listing.Function): ...
    ...
    def getNewMatch(self) -> ghidra.feature.vt.api.main.VTMatch: ...
    ...
    @property
    def newMatch(self) -> ghidra.feature.vt.api.main.VTMatch: ...