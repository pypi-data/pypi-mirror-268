...
class TagFilterEditorDialog(docking.DialogComponentProvider, ghidra.feature.vt.gui.filters.TagFilterChooser):
    ...
    def getExcludedTags(self, __a0: java.util.Map, __a1: java.util.Map) -> java.util.Map: ...
