...
class VTControllerImpl(object, ghidra.framework.model.DomainObjectListener, ghidra.framework.options.OptionsChangeListener, ghidra.framework.model.TransactionListener, ghidra.feature.vt.gui.plugin.VTController):
    ...
    def transactionEnded(self, __a0: ghidra.framework.data.DomainObjectAdapterDB) -> None: ...

    def transactionStarted(self, __a0: ghidra.framework.data.DomainObjectAdapterDB, __a1: ghidra.framework.model.TransactionInfo) -> None: ...

    def undoRedoOccurred(self, __a0: ghidra.framework.data.DomainObjectAdapterDB) -> None: ...

    def undoStackChanged(self, __a0: ghidra.framework.data.DomainObjectAdapterDB) -> None: ...
