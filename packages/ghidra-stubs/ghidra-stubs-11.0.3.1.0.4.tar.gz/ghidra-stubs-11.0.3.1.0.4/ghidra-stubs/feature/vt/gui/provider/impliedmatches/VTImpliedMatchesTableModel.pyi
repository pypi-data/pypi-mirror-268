...
class VTImpliedMatchesTableModel(ghidra.util.table.AddressBasedTableModel):





    class DestinationReferenceAddressTableColumn(ghidra.util.table.field.AbstractProgramBasedDynamicTableColumn):
        ...
        @overload
        def getValue(self, __a0: ghidra.feature.vt.gui.provider.impliedmatches.ImpliedMatchWrapperRowObject, __a1: ghidra.docking.settings.Settings, __a2: ghidra.program.model.listing.Program, __a3: ghidra.framework.plugintool.ServiceProvider) -> unicode: ...
    ...
    class SourceReferenceAddressTableColumn(ghidra.util.table.field.AbstractProgramBasedDynamicTableColumn):
