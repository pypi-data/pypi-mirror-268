...
class MatchTagComboBox(docking.widgets.combobox.GhidraComboBox):




    def __init__(self, __a0: ghidra.feature.vt.api.main.VTSession, __a1: List[object], __a2: javax.swing.JComponent, __a3: ghidra.feature.vt.api.main.VTMatchTag): ...
    ...
    def addEditorKeyListener(self, __a0: java.awt.event.KeyListener) -> None: ...
    ...
    def addPopupMenuListener(self, __a0: javax.swing.event.PopupMenuListener) -> None: ...
    ...
    @overload
    def addToModel(self, __a0: java.util.Collection) -> None: ...

    @overload
    def addToModel(self, __a0: object) -> None: ...
    ...
    def associateLabel(self, __a0: javax.swing.JLabel) -> None: ...
    ...
    def configureEditor(self, __a0: javax.swing.ComboBoxEditor, __a1: object) -> None: ...
    ...
    def containsItem(self, __a0: object) -> bool: ...

    def contentsChanged(self, __a0: javax.swing.event.ListDataEvent) -> None: ...
    ...
    def firePopupMenuCanceled(self) -> None: ...

    def firePopupMenuWillBecomeInvisible(self) -> None: ...

    def firePopupMenuWillBecomeVisible(self) -> None: ...
    ...
    def getEditor(self) -> javax.swing.ComboBoxEditor: ...
    ...
    def getItemAt(self, __a0: int) -> object: ...
    ...
    def getKeySelectionManager(self) -> javax.swing.JComboBox.KeySelectionManager: ...
    ...
    def getModel(self) -> javax.swing.ComboBoxModel: ...
    ...
    def getPopupMenuListeners(self) -> List[javax.swing.event.PopupMenuListener]: ...
    ...
    def getPrototypeDisplayValue(self) -> object: ...

    def getRegisteredKeyStrokes(self) -> List[javax.swing.KeyStroke]: ...

    def getRenderer(self) -> javax.swing.ListCellRenderer: ...
    ...
    def insertItemAt(self, __a0: object, __a1: int) -> None: ...

    def inside(self, __a0: int, __a1: int) -> bool: ...

    def intervalAdded(self, __a0: javax.swing.event.ListDataEvent) -> None: ...

    def intervalRemoved(self, __a0: javax.swing.event.ListDataEvent) -> None: ...
    ...
    def processKeyEvent(self, __a0: java.awt.event.KeyEvent) -> None: ...
    ...
    def removeEditorKeyListener(self, __a0: java.awt.event.KeyListener) -> None: ...
    ...
    def removeItemAt(self, __a0: int) -> None: ...
    ...
    def removePopupMenuListener(self, __a0: javax.swing.event.PopupMenuListener) -> None: ...
    ...
    def selectWithKeyChar(self, __a0: int) -> bool: ...
    ...
    def setEditor(self, __a0: javax.swing.ComboBoxEditor) -> None: ...

    def setEnabled(self, __a0: bool) -> None: ...

    def setEnterKeyForwarding(self, __a0: bool) -> None: ...
    ...
    def setKeySelectionManager(self, __a0: javax.swing.JComboBox.KeySelectionManager) -> None: ...

    def setLayout(self, __a0: java.awt.LayoutManager) -> None: ...

    def setLightWeightPopupEnabled(self, __a0: bool) -> None: ...
    ...
    def setMaximumRowCount(self, __a0: int) -> None: ...
    ...
    def setModel(self, __a0: javax.swing.ComboBoxModel) -> None: ...
    ...
    def setPopupVisible(self, __a0: bool) -> None: ...

    def setPreferredSize(self, __a0: java.awt.Dimension) -> None: ...

    def setPrototypeDisplayValue(self, __a0: object) -> None: ...

    def setRenderer(self, __a0: javax.swing.ListCellRenderer) -> None: ...

    def setRequestFocusEnabled(self, __a0: bool) -> None: ...

    def setSelectedIndex(self, __a0: int) -> None: ...
    ...
    def setUI(self, __a0: javax.swing.plaf.ComboBoxUI) -> None: ...
