...
class AbstractMatchedTokensAction(docking.action.DockingAction):




    def __init__(self, __a0: unicode, __a1: unicode, __a2: ghidra.codecompare.DecompilerDiffCodeComparisonPanel, __a3: bool): ...
