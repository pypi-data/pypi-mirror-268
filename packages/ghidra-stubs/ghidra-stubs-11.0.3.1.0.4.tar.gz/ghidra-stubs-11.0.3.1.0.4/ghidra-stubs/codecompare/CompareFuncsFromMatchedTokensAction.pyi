...
class CompareFuncsFromMatchedTokensAction(ghidra.codecompare.AbstractMatchedTokensAction):




    def __init__(self, __a0: ghidra.codecompare.DecompilerDiffCodeComparisonPanel, __a1: ghidra.framework.plugintool.PluginTool): ...
