...
class GhidraOptions(object):
    ...
    DEFAULT_CURSOR_LINE_COLOR: generic.theme.GColor = #00ffff
    DEFAULT_HIGHLIGHT_COLOR: generic.theme.GColor = #00ffff
    DEFAULT_SELECTION_COLOR: generic.theme.GColor = #00ffff
    DELIMITER: int = '.'
