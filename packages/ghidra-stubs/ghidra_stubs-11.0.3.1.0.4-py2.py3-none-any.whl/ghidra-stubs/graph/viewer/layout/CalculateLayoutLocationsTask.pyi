...
class CalculateLayoutLocationsTask(ghidra.util.task.Task):




    def __init__(self, graph: ghidra.graph.VisualGraph, layout: ghidra.graph.viewer.layout.VisualGraphLayout): ...
    ...
    def getLocations(self) -> ghidra.graph.viewer.layout.LayoutPositions: ...
    ...
    @property
    def locations(self) -> ghidra.graph.viewer.layout.LayoutPositions: ...