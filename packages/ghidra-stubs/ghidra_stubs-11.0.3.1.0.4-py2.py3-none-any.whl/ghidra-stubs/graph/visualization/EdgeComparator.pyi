...
class EdgeComparator(object, java.util.Comparator):




    def __init__(self, __a0: ghidra.graph.visualization.GraphRenderer): ...



    @overload
    def compare(self, __a0: ghidra.service.graph.AttributedEdge, __a1: ghidra.service.graph.AttributedEdge) -> int: ...
