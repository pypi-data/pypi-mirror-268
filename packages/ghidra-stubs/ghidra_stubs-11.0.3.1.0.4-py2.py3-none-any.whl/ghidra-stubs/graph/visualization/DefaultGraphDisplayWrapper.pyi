...
class DefaultGraphDisplayWrapper(object, ghidra.service.graph.GraphDisplay, java.lang.Comparable):
    ...
    @overload
    def compareTo(self, __a0: ghidra.graph.visualization.DefaultGraphDisplayWrapper) -> int: ...
