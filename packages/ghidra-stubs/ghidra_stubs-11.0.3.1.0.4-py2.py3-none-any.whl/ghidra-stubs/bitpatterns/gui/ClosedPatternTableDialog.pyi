...
class ClosedPatternTableDialog(docking.DialogComponentProvider):




    def __init__(self, __a0: ghidra.bitpatterns.gui.FunctionBitPatternsExplorerPlugin, __a1: List[object], __a2: java.awt.Component, __a3: ghidra.bitpatterns.info.PatternType, __a4: ghidra.bitpatterns.info.ContextRegisterFilter): ...
