...
class FunctionBitPatternsExplorerPlugin(ghidra.app.plugin.ProgramPlugin):
    ...
    def addPattern(self, __a0: ghidra.bitpatterns.gui.PatternInfoRowObject) -> None: ...

    def clearPatterns(self) -> None: ...
    ...
    def getPatterns(self) -> java.util.Set: ...
    ...
    def removePatterns(self, __a0: java.util.Collection) -> None: ...
    ...
    @property
    def patterns(self) -> java.util.Set: ...