...
class ByteSequenceLengthFilterInputDialog(ghidra.bitpatterns.gui.InputDialogComponentProvider):
    ...
    def getValue(self) -> ghidra.bitpatterns.info.ByteSequenceLengthFilter: ...
    ...
    @property
    def value(self) -> ghidra.bitpatterns.info.ByteSequenceLengthFilter: ...