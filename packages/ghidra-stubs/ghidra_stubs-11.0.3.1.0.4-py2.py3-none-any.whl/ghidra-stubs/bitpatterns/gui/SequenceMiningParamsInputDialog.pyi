...
class SequenceMiningParamsInputDialog(ghidra.bitpatterns.gui.InputDialogComponentProvider):




    def __init__(self, __a0: unicode, __a1: java.awt.Component): ...
    ...
    def getSequenceMiningParams(self) -> ghidra.closedpatternmining.SequenceMiningParams: ...
    ...
    @property
    def sequenceMiningParams(self) -> ghidra.closedpatternmining.SequenceMiningParams: ...