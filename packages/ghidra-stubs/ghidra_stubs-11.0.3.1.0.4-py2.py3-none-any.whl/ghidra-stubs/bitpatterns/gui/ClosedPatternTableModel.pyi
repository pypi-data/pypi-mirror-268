...
class ClosedPatternTableModel(docking.widgets.table.threaded.ThreadedTableModelStub):




    def __init__(self, __a0: List[object], __a1: ghidra.framework.plugintool.ServiceProvider): ...
