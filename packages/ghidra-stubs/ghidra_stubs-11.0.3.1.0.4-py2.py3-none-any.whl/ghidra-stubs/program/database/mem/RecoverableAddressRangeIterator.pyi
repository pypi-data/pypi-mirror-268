...
class RecoverableAddressRangeIterator(object, ghidra.program.model.address.AddressRangeIterator):
    """
    RecoverableAddressRangeIterator provides the ability to iterator over an AddressSet
     which is getting modified concurrent with the iteration of AddressRangees contained within it.  Do to 
     multiple levels of prefetch caching, the results returned may be stale relative to the actual
     AddressSet at any point in time.  The primary intent is to return address ranges in proper order
