...
class TypedefDB(ghidra.program.database.data.DataTypeDB, ghidra.program.model.data.TypeDef):
    """
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.TypeDef: ...
