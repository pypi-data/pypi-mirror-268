...
class StringPropertyMapDB(ghidra.program.database.properties.PropertyMapDB, ghidra.program.model.util.StringPropertyMap):
    """
    ...
    def get(self, addr: ghidra.program.model.address.Address) -> unicode: ...
