...
class UnsignedCharDataType(ghidra.program.model.data.CharDataType):
    """
    ...
    dataType: ghidra.program.model.data.UnsignedCharDataType = uchar
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.UnsignedCharDataType: ...
    ...
    @overload
    def getDefaultLabelPrefix(self, buf: ghidra.program.model.mem.MemBuffer, settings: ghidra.docking.settings.Settings, length: int, options: ghidra.program.model.data.DataTypeDisplayOptions) -> unicode: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.CharDataType: ...
