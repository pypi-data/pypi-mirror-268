...
class Integer16DataType(ghidra.program.model.data.AbstractSignedIntegerDataType):
    """
    A fixed size 16 byte signed integer (commonly referred to in C as int128_t)
    """

    dataType: ghidra.program.model.data.Integer16DataType = int16
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.Integer16DataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedInteger16DataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedInteger16DataType: ...