...
class LongDataType(ghidra.program.model.data.AbstractSignedIntegerDataType):
    """
    Basic implementation for a Signed Long Integer dataType
    """

    dataType: ghidra.program.model.data.LongDataType = long
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.LongDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedLongDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.UnsignedLongDataType: ...