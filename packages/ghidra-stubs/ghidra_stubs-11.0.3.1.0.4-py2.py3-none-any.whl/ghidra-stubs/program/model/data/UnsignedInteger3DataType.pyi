...
class UnsignedInteger3DataType(ghidra.program.model.data.AbstractUnsignedIntegerDataType):
    dataType: ghidra.program.model.data.UnsignedInteger3DataType = uint3
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.UnsignedInteger3DataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.Integer3DataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.Integer3DataType: ...