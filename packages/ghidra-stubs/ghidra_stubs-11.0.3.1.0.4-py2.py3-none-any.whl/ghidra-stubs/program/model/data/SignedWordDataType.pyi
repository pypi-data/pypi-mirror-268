...
class SignedWordDataType(ghidra.program.model.data.AbstractSignedIntegerDataType):
    """
    Provides a basic implementation of a signed word datatype
    """

    dataType: ghidra.program.model.data.SignedWordDataType = sword
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.SignedWordDataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.WordDataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.WordDataType: ...