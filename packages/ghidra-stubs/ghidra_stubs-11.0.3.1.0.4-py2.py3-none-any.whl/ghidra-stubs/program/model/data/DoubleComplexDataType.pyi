...
class DoubleComplexDataType(ghidra.program.model.data.AbstractComplexDataType):
    """
    Provides a definition of a  built-in data type consisting of two double point
    ...
    dataType: ghidra.program.model.data.DoubleComplexDataType = doublecomplex
    ...
    @staticmethod
    def getComplexDataType(size: int, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.DataType: ...
