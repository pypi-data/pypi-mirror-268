...
class AbstractComplexDataType(ghidra.program.model.data.BuiltIn):
    """
    ...
    def __init__(self, name: unicode, floats: ghidra.program.model.data.AbstractFloatDataType, dtm: ghidra.program.model.data.DataTypeManager): ...
