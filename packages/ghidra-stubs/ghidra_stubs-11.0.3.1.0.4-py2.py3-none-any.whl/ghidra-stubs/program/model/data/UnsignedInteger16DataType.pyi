...
class UnsignedInteger16DataType(ghidra.program.model.data.AbstractUnsignedIntegerDataType):
    """
    A fixed size 16 byte unsigned integer (commonly referred to in C as uint128_t)
    """

    dataType: ghidra.program.model.data.UnsignedInteger16DataType = uint16
    ...
    def clone(self, dtm: ghidra.program.model.data.DataTypeManager) -> ghidra.program.model.data.UnsignedInteger16DataType: ...
    ...
    def getOppositeSignednessDataType(self) -> ghidra.program.model.data.Integer16DataType: ...
    ...
    @property
    def oppositeSignednessDataType(self) -> ghidra.program.model.data.Integer16DataType: ...