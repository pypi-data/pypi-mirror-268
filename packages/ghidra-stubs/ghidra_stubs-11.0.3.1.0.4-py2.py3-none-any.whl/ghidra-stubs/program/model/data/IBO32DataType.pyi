...
class IBO32DataType(ghidra.program.model.data.AbstractPointerTypedefBuiltIn):
    """
    ...
    dataType: ghidra.program.model.data.IBO32DataType = IBO32DataType: typedef ImageBaseOffset32 pointer32
    ...
    @staticmethod
    def createIBO32PointerTypedef(referencedDataType: ghidra.program.model.data.DataType) -> ghidra.program.model.data.PointerTypedef:
        """
