...
class ToolIconUrlRenderer(docking.widgets.list.GListCellRenderer):
    ...
    @staticmethod
    def createDefaultCellTextRenderer(cellToTextMappingFunction: java.util.function.Function) -> docking.widgets.list.GListCellRenderer:
        """
