...
class ThemeColorOption(ghidra.framework.options.Option):
    """
    ...
    def __init__(self, optionName: unicode, colorId: unicode, description: unicode, help: ghidra.util.HelpLocation): ...
    ...
    def getCurrentValue(self) -> java.awt.Color: ...
    ...
    @property
    def currentValue(self) -> java.awt.Color: ...
