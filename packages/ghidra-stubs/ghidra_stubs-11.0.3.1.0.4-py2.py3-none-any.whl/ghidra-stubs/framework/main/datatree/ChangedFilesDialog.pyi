...
class ChangedFilesDialog(docking.DialogComponentProvider):
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: List[object]): ...
    ...
    def setCancelToolTipText(self, toolTip: unicode) -> None:
        """
    ...
    @property
    def cancelToolTipText(self) -> None: ...  # No getter available.

    @cancelToolTipText.setter
    def cancelToolTipText(self, value: unicode) -> None: ...