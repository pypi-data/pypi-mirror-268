...
class FindCheckoutsTableModel(docking.widgets.table.threaded.ThreadedTableModelStub):
    """
    ...
    @overload
    def __init__(self, modelName: unicode, serviceProvider: ghidra.framework.plugintool.ServiceProvider): ...

    @overload
    def __init__(self, modelName: unicode, serviceProvider: ghidra.framework.plugintool.ServiceProvider, monitor: ghidra.util.task.TaskMonitor): ...

    @overload
    def __init__(self, modelName: unicode, serviceProvider: ghidra.framework.plugintool.ServiceProvider, monitor: ghidra.util.task.TaskMonitor, loadIncrementally: bool): ...
