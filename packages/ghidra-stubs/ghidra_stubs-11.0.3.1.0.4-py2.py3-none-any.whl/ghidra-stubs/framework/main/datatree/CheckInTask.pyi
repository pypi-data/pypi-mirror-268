...
class CheckInTask(ghidra.framework.main.datatree.VersionControlTask, ghidra.framework.data.CheckinHandler):
    """
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: List[object], __a2: java.awt.Component): ...
    ...
    def run(self, myMonitor: ghidra.util.task.TaskMonitor) -> None: ...
