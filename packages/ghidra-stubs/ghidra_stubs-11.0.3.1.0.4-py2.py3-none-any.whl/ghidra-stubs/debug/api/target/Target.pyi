...
class Target(object):
    ...
    class ActionEntry(java.lang.Record):




        def __init__(self, __a0: unicode, __a1: ghidra.debug.api.target.ActionName, __a2: unicode, __a3: bool, __a4: java.util.function.BooleanSupplier, __a5: java.util.function.Function): ...



        def action(self) -> java.util.function.Function: ...
        ...
        def enabled(self) -> java.util.function.BooleanSupplier: ...

        def equals(self, __a0: object) -> bool: ...

        def get(self, __a0: bool) -> object: ...

        def getClass(self) -> java.lang.Class: ...

        def hashCode(self) -> int: ...

        def invokeAsync(self, __a0: bool) -> java.util.concurrent.CompletableFuture: ...

        def isEnabled(self) -> bool: ...

        def name(self) -> ghidra.debug.api.target.ActionName: ...
