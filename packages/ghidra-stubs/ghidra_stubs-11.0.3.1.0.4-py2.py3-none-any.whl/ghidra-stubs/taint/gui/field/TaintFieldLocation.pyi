...
class TaintFieldLocation(ghidra.program.util.CodeUnitLocation):
    ...
    @staticmethod
    def getTranslatedCopy(__a0: ghidra.program.util.ProgramLocation, __a1: ghidra.program.model.listing.Program, __a2: ghidra.program.model.address.Address) -> ghidra.program.util.ProgramLocation: ...
