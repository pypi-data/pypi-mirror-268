...
class ResponseUpdate(ghidra.features.bsim.query.protocol.QueryResponseRecord):
    badexe: List[object]
    badfunc: List[object]
    exeupdate: int
    funcupdate: int
    qupdate: ghidra.features.bsim.query.protocol.QueryUpdate



    def __init__(self, __a0: ghidra.features.bsim.query.protocol.QueryUpdate): ...
