...
class QueryChildren(ghidra.features.bsim.query.protocol.BSimQuery):
    arch: unicode
    childrenresponse: ghidra.features.bsim.query.protocol.ResponseChildren
    functionKeys: List[object]
    md5sum: unicode
    name_compiler: unicode
    name_exec: unicode
