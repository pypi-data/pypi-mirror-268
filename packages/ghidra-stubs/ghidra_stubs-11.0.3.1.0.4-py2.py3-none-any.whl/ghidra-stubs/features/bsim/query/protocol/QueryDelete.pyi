...
class QueryDelete(ghidra.features.bsim.query.protocol.BSimQuery):
    exelist: List[object]
    respdelete: ghidra.features.bsim.query.protocol.ResponseDelete
    ...
    def addSpecifier(self, __a0: ghidra.features.bsim.query.protocol.ExeSpecifier) -> None: ...
