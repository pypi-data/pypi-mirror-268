...
class CreateDatabase(ghidra.features.bsim.query.protocol.BSimQuery):
    config_template: unicode
    info: ghidra.features.bsim.query.description.DatabaseInformation
    inforesponse: ghidra.features.bsim.query.protocol.ResponseInfo
