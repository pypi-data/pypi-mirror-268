...
class ResponseNearestVector(ghidra.features.bsim.query.protocol.QueryResponseRecord):
    qnear: ghidra.features.bsim.query.protocol.QueryNearestVector
    result: List[object]
    totalmatch: int
    totalvec: int
    uniquematch: int
    ...
    def __init__(self, __a0: ghidra.features.bsim.query.protocol.QueryNearestVector): ...
