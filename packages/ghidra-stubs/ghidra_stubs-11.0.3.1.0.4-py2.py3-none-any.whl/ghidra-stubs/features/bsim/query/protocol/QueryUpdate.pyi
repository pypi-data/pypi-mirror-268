...
class QueryUpdate(ghidra.features.bsim.query.protocol.BSimQuery):
    manage: ghidra.features.bsim.query.description.DescriptionManager
    updateresponse: ghidra.features.bsim.query.protocol.ResponseUpdate
    ...
    @property
    def localStagingCopy(self) -> ghidra.features.bsim.query.protocol.QueryUpdate: ...