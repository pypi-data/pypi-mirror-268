...
class BSimQuery(object):
    ...
    @property
    def localStagingCopy(self) -> ghidra.features.bsim.query.protocol.BSimQuery: ...

    @property
    def name(self) -> unicode: ...

    @property
    def response(self) -> ghidra.features.bsim.query.protocol.QueryResponseRecord: ...