...
class QueryNearestVector(ghidra.features.bsim.query.protocol.BSimQuery):
    manage: ghidra.features.bsim.query.description.DescriptionManager
    nearresponse: ghidra.features.bsim.query.protocol.ResponseNearestVector
    signifthresh: float
    thresh: float
    vectormax: int
    ...
    @property
    def localStagingCopy(self) -> ghidra.features.bsim.query.protocol.QueryNearestVector: ...