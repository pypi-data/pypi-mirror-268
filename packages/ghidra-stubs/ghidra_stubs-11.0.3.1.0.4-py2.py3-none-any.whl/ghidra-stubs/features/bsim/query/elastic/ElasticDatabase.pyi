...
class ElasticDatabase(object, ghidra.features.bsim.query.FunctionDatabase):
    LAYOUT_VERSION: int = 3
    MAX_FUNCTIONUPDATE_WINDOW: int = 500
    MAX_FUNCTION_BULK: int = 200
    MAX_FUNCTION_WINDOW: int = 500
    MAX_VECTORCOUNT_WINDOW: int = 100
    MAX_VECTORDELETE_WINDOW: int = 100
    MAX_VECTOR_BULK: int = 200
    MAX_VECTOR_OVERALL: int = 9000
    ...
    def recoverExternalFunctionId(self, __a0: unicode, __a1: unicode, __a2: unicode) -> unicode: ...
