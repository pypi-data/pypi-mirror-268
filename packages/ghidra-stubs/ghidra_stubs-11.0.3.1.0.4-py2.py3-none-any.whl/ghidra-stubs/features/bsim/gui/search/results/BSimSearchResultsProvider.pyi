...
class BSimSearchResultsProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, __a0: ghidra.features.bsim.gui.BSimSearchPlugin, __a1: ghidra.framework.plugintool.PluginTool, __a2: ghidra.features.bsim.query.BSimServerInfo, __a3: ghidra.features.bsim.query.description.DatabaseInformation, __a4: generic.lsh.vector.LSHVectorFactory, __a5: ghidra.features.bsim.query.facade.SFQueryInfo, __a6: ghidra.features.bsim.gui.search.dialog.BSimSearchSettings): ...
    ...
    def setFinalQueryResults(self, __a0: ghidra.features.bsim.query.facade.SFQueryResult) -> None: ...
    ...
    @property
    def finalQueryResults(self) -> None: ...  # No getter available.

    @finalQueryResults.setter
    def finalQueryResults(self, value: ghidra.features.bsim.query.facade.SFQueryResult) -> None: ...
