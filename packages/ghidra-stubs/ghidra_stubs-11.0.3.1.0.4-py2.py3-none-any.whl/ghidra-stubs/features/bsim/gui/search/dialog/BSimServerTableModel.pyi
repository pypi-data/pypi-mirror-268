...
class BSimServerTableModel(docking.widgets.table.GDynamicColumnTableModel):




    def __init__(self, __a0: ghidra.features.bsim.gui.search.dialog.BSimServerManager): ...
