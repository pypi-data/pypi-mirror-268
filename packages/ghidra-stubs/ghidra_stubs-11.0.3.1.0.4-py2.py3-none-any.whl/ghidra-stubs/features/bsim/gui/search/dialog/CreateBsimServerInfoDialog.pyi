...
class CreateBsimServerInfoDialog(docking.DialogComponentProvider):
    ...
    def acceptServer(self, __a0: ghidra.features.bsim.query.BSimServerInfo) -> bool: ...
    ...
    def getBsimServerInfo(self) -> ghidra.features.bsim.query.BSimServerInfo: ...
    ...
    @property
    def bsimServerInfo(self) -> ghidra.features.bsim.query.BSimServerInfo: ...
