...
class MultiChoiceSelectionDialog(docking.DialogComponentProvider):




    @overload
    def __init__(self, __a0: unicode, __a1: List[object], __a2: java.util.Set): ...

    @overload
    def __init__(self, __a0: unicode, __a1: List[object], __a2: java.util.Set, __a3: docking.widgets.DataToStringConverter): ...
    ...
    def getSelectedChoices(self) -> List[object]: ...
    ...
    @property
    def selectedChoices(self) -> List[object]: ...