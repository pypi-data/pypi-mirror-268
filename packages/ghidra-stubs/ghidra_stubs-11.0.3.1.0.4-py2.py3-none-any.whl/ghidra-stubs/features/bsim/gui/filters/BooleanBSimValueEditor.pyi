...
class BooleanBSimValueEditor(object, ghidra.features.bsim.gui.filters.BSimValueEditor):
    FILTER_DELIMETER: unicode = u','
    INVALID_COLOR: java.awt.Color = #00ffff
    VALID_COLOR: java.awt.Color = #00ffff



    def __init__(self, __a0: ghidra.features.bsim.gui.filters.BSimFilterType, __a1: List[object], __a2: utility.function.Callback): ...
