...
class PythonScript(ghidra.app.script.GhidraScript):
    ...
    @overload
    def askProgram(self, title: unicode, upgradeIfNeeded: bool) -> ghidra.program.model.listing.Program:
        """
    ...
    def askValues(self, title: unicode, optionalMessage: unicode, values: ghidra.features.base.values.GhidraValuesMap) -> ghidra.features.base.values.GhidraValuesMap:
        """
