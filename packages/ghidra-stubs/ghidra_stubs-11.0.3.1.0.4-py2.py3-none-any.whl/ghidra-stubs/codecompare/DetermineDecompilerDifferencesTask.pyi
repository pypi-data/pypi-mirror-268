...
class DetermineDecompilerDifferencesTask(ghidra.util.task.Task):




    def __init__(self, __a0: ghidra.codecompare.DecompileDataDiff, __a1: bool, __a2: ghidra.codecompare.DiffClangHighlightController, __a3: ghidra.codecompare.DiffClangHighlightController, __a4: ghidra.codecompare.CodeDiffFieldPanelCoordinator): ...
