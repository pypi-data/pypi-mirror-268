...
class DecompilerDiffCodeComparisonPanel(ghidra.app.decompiler.component.DecompilerCodeComparisonPanel, ghidra.app.decompiler.component.DualDecompileResultsListener, ghidra.framework.options.OptionsChangeListener):
    CODE_DIFF_VIEW: unicode = u'Decompiler Diff View'




    class MyToggleExactConstantMatching(docking.action.ToggleDockingAction):




        def __init__(self, __a0: ghidra.codecompare.DecompilerDiffCodeComparisonPanel, __a1: unicode): ...
    ...
    def addDualDecompileResultsListener(self, __a0: ghidra.app.decompiler.component.DualDecompileResultsListener) -> bool: ...
    ...
    def decompileResultsSet(self, __a0: ghidra.app.decompiler.component.DecompileData, __a1: ghidra.app.decompiler.component.DecompileData) -> None: ...
    ...
    def getActionContext(self, __a0: docking.ComponentProvider, __a1: java.awt.event.MouseEvent) -> docking.ActionContext: ...
    ...
    def loadAddresses(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.listing.Program, __a2: ghidra.program.model.address.AddressSetView, __a3: ghidra.program.model.address.AddressSetView) -> None: ...

    def loadData(self, __a0: ghidra.program.model.listing.Data, __a1: ghidra.program.model.listing.Data) -> None: ...

    def loadFunctions(self, __a0: ghidra.program.model.listing.Function, __a1: ghidra.program.model.listing.Function) -> None: ...
    ...
    def removeDualDecompileResultsListener(self, __a0: ghidra.app.decompiler.component.DualDecompileResultsListener) -> bool: ...
    ...
    def setBottomComponent(self, __a0: javax.swing.JComponent) -> None: ...
    ...
    @overload
    def setFieldPanelCoordinator(self, __a0: ghidra.app.decompiler.component.DualDecompilerFieldPanelCoordinator) -> None: ...
    ...
    def setHighlightControllers(self, __a0: ghidra.app.decompiler.component.ClangHighlightController, __a1: ghidra.app.decompiler.component.ClangHighlightController) -> None: ...
    ...
    def setLeftTitle(self, __a0: unicode) -> None: ...
    ...
    def setMouseNavigationEnabled(self, __a0: bool) -> None: ...
    ...
    def setRightTitle(self, __a0: unicode) -> None: ...

    def setScrollingSyncState(self, __a0: bool) -> None: ...

    def setShowTitles(self, __a0: bool) -> None: ...
    ...
    def setTitlePrefixes(self, __a0: unicode, __a1: unicode) -> None: ...

    def setToolTipText(self, __a0: unicode) -> None: ...

    def setTopComponent(self, __a0: javax.swing.JComponent) -> None: ...
