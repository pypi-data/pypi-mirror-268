...
class ArtHeader_005(ghidra.file.formats.android.art.ArtHeader):
    ...
    def getImageBitmapOffset(self) -> int: ...

    def getImageBitmapSize(self) -> int: ...
    ...
    @property
    def imageBitmapOffset(self) -> int: ...

    @property
    def imageBitmapSize(self) -> int: ...
