...
class ImageSections_OreoMR1(ghidra.file.formats.android.art.ArtImageSections):
    kSectionArtFields: int = 1
    kSectionArtMethods: int = 2
    kSectionClassTable: int = 8
    kSectionCount: int = 10
    kSectionDexCacheArrays: int = 6
    kSectionIMTConflictTables: int = 5
    kSectionImTables: int = 4
    kSectionImageBitmap: int = 9
    kSectionInternedStrings: int = 7
