...
class Ext4Inode(object, ghidra.app.util.bin.StructConverter):
    ...
    def getInlineDataValue(self) -> List[int]: ...
    ...
    def isFlagExtents(self) -> bool: ...

    def isFlagInlineData(self) -> bool: ...
    ...
    @property
    def flagExtents(self) -> bool: ...

    @property
    def flagInlineData(self) -> bool: ...
    ...
    @property
    def inlineDataValue(self) -> List[int]: ...
