...
class CartV1StreamHasher(ghidra.file.formats.cart.CartV1StreamProcessor):




    def __init__(self, __a0: java.io.InputStream, __a1: ghidra.file.formats.cart.CartV1File): ...



    def available(self) -> int: ...

    def checkHashes(self) -> bool: ...
