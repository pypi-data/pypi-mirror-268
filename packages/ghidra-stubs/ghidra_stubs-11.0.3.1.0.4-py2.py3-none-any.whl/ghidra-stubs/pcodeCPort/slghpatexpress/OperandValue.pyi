...
class OperandValue(ghidra.pcodeCPort.slghpatexpress.PatternValue):
    ...
    @overload
    def __init__(self, __a0: ghidra.sleigh.grammar.Location, __a1: int, __a2: ghidra.pcodeCPort.slghsymbol.Constructor): ...



    def changeIndex(self, __a0: int) -> None: ...
    ...
    @property
    def constructorRelative(self) -> bool: ...
