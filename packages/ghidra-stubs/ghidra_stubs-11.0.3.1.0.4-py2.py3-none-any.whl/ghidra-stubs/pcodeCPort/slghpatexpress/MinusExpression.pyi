...
class MinusExpression(ghidra.pcodeCPort.slghpatexpress.UnaryExpression):
    ...
    @overload
    def __init__(self, __a0: ghidra.sleigh.grammar.Location, __a1: ghidra.pcodeCPort.slghpatexpress.PatternExpression): ...
    ...
    def getUnary(self) -> ghidra.pcodeCPort.slghpatexpress.PatternExpression: ...
