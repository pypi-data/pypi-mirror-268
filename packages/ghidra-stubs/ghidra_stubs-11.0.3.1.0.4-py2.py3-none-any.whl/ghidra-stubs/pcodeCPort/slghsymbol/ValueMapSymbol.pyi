...
class ValueMapSymbol(ghidra.pcodeCPort.slghsymbol.ValueSymbol):
    ...
    @overload
    def __init__(self, __a0: ghidra.sleigh.grammar.Location, __a1: unicode, __a2: ghidra.pcodeCPort.slghpatexpress.PatternValue, __a3: generic.stl.VectorSTL): ...
