...
class SleighCompile(ghidra.pcodeCPort.sleighbase.SleighBase):
    ...
    def addContextField(self, __a0: ghidra.sleigh.grammar.Location, __a1: ghidra.pcodeCPort.slghsymbol.VarnodeSymbol, __a2: ghidra.pcodeCPort.slgh_compile.FieldQuality) -> bool: ...
    ...
    def compareMacroParams(self, __a0: ghidra.pcodeCPort.slghsymbol.MacroSymbol, __a1: generic.stl.VectorSTL) -> None: ...
    ...
    def getPreprocValue(self, __a0: unicode) -> generic.stl.Pair: ...
    ...
    def run_compilation(self, __a0: unicode, __a1: unicode) -> int: ...
    ...
    def setAllNopWarning(self, __a0: bool) -> None: ...

    def setAllOptions(self, __a0: java.util.Map, __a1: bool, __a2: bool, __a3: bool, __a4: bool, __a5: bool, __a6: bool, __a7: bool, __a8: bool, __a9: bool) -> None: ...

    def setDeadTempWarning(self, __a0: bool) -> None: ...

    def setDefaultSpace(self, __a0: int) -> None: ...

    def setEndian(self, __a0: int) -> None: ...

    def setEnforceLocalKeyWord(self, __a0: bool) -> None: ...

    def setInsensitiveDuplicateError(self, __a0: bool) -> None: ...

    def setLanguage(self, __a0: unicode) -> None: ...

    def setLargeTemporaryWarning(self, __a0: bool) -> None: ...

    def setLenientConflict(self, __a0: bool) -> None: ...

    def setLocalCollisionWarning(self, __a0: bool) -> None: ...

    def setPreprocValue(self, __a0: unicode, __a1: unicode) -> None: ...

    def setUnnecessaryPcodeWarning(self, __a0: bool) -> None: ...

    def setUnusedFieldWarning(self, __a0: bool) -> None: ...

    def toString(self) -> unicode: ...

    def undefinePreprocValue(self, __a0: unicode) -> bool: ...
    ...
    @property
    def allNopWarning(self) -> None: ...  # No getter available.

    @allNopWarning.setter
    def allNopWarning(self, value: bool) -> None: ...

    @property
    def deadTempWarning(self) -> None: ...  # No getter available.

    @deadTempWarning.setter
    def deadTempWarning(self, value: bool) -> None: ...
    ...
    @property
    def enforceLocalKeyWord(self) -> None: ...  # No getter available.

    @enforceLocalKeyWord.setter
    def enforceLocalKeyWord(self, value: bool) -> None: ...

    @property
    def insensitiveDuplicateError(self) -> None: ...  # No getter available.

    @insensitiveDuplicateError.setter
    def insensitiveDuplicateError(self, value: bool) -> None: ...

    @property
    def largeTemporaryWarning(self) -> None: ...  # No getter available.

    @largeTemporaryWarning.setter
    def largeTemporaryWarning(self, value: bool) -> None: ...

    @property
    def lenientConflict(self) -> None: ...  # No getter available.

    @lenientConflict.setter
    def lenientConflict(self, value: bool) -> None: ...

    @property
    def localCollisionWarning(self) -> None: ...  # No getter available.

    @localCollisionWarning.setter
    def localCollisionWarning(self, value: bool) -> None: ...

    @property
    def unnecessaryPcodeWarning(self) -> None: ...  # No getter available.

    @unnecessaryPcodeWarning.setter
    def unnecessaryPcodeWarning(self, value: bool) -> None: ...

    @property
    def unusedFieldWarning(self) -> None: ...  # No getter available.

    @unusedFieldWarning.setter
    def unusedFieldWarning(self, value: bool) -> None: ...