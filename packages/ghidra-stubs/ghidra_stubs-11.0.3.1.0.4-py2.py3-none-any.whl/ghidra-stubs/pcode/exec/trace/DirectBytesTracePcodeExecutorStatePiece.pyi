...
class DirectBytesTracePcodeExecutorStatePiece(ghidra.pcode.exec.AbstractLongOffsetPcodeExecutorStatePiece, ghidra.pcode.exec.trace.TracePcodeExecutorStatePiece):
    ...
    def withMemoryState(self) -> ghidra.pcode.exec.PcodeExecutorStatePiece: ...
