...
class AuxDebuggerPcodeEmulator(ghidra.pcode.exec.trace.auxiliary.AuxTracePcodeEmulator, ghidra.debug.api.emulation.DebuggerPcodeMachine):




    def __init__(self, __a0: ghidra.debug.api.emulation.PcodeDebuggerAccess): ...
