...
class InternalTraceRmiService(ghidra.app.services.TraceRmiService, object):
    ...
    def acceptOne(self, __a0: java.net.SocketAddress) -> ghidra.app.plugin.core.debug.service.tracermi.DefaultTraceRmiAcceptor: ...
