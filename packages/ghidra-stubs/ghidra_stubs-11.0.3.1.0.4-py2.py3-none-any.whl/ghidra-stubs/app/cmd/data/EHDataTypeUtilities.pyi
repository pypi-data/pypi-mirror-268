...
class EHDataTypeUtilities(object):
    ...
    @overload
    @staticmethod
    def createSymbolIfNeeded(__a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.symbol.Namespace, __a2: unicode, __a3: ghidra.program.model.address.Address, __a4: ghidra.app.util.datatype.microsoft.DataApplyOptions) -> ghidra.program.model.symbol.Symbol: ...
