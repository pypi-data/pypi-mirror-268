...
class AddressInput(javax.swing.JPanel, docking.widgets.table.FocusableEditor):
    ...
    INCLUDE_ALL_MEMORY_SPACES: java.util.function.Predicate = ghidra.app.util.AddressInput$$Lambda/0x0000000100f29290@2d91b746
    INCLUDE_LOADED_MEMORY_SPACES: java.util.function.Predicate = ghidra.app.util.AddressInput$$Lambda/0x0000000100f29048@431ec877
    ...
    @overload
    def setAddressFactory(self, factory: ghidra.program.model.address.AddressFactory, predicate: java.util.function.Predicate) -> None:
        """
    ...
    @overload
    def setValue(self, addr: ghidra.program.model.address.Address) -> None:
        """
