...
class DWARFCompileUnit(object):
    ...
    def __init__(self, name: unicode, producer: unicode, comp_dir: unicode, low_pc: java.lang.Number, high_pc: java.lang.Number, language: java.lang.Number, identifier_case: ghidra.app.util.bin.format.dwarf4.encoding.DWARFIdentifierCase, hasDWO: bool, line: ghidra.app.util.bin.format.dwarf4.DWARFLine): ...
    ...
    @staticmethod
    def read(diea: ghidra.app.util.bin.format.dwarf4.DIEAggregate) -> ghidra.app.util.bin.format.dwarf4.DWARFCompileUnit: ...
