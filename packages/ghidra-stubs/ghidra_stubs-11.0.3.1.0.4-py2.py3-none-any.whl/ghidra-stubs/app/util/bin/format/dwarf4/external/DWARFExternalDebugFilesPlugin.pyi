...
class DWARFExternalDebugFilesPlugin(ghidra.framework.plugintool.Plugin):
    ...
    @staticmethod
    def getExternalDebugFilesService(context: ghidra.app.util.bin.format.dwarf4.external.SearchLocationCreatorContext) -> ghidra.app.util.bin.format.dwarf4.external.ExternalDebugFilesService:
        """
    ...
    @staticmethod
    def saveExternalDebugFilesService(service: ghidra.app.util.bin.format.dwarf4.external.ExternalDebugFilesService) -> None:
        """
