...
class LoadConfigDataDirectory(ghidra.app.util.bin.format.pe.DataDirectory):
    ...
    def getLoadConfigDirectory(self) -> ghidra.app.util.bin.format.pe.LoadConfigDirectory:
        """
    ...
    @property
    def loadConfigDirectory(self) -> ghidra.app.util.bin.format.pe.LoadConfigDirectory: ...