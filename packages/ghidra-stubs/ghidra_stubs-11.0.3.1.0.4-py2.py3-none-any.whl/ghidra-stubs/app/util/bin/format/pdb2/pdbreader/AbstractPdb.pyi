...
class AbstractPdb(object, java.lang.AutoCloseable):
    ...
    @property
    def itemProgramInterface(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.TypeProgramInterface: ...
    ...
    @property
    def typeProgramInterface(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.TypeProgramInterface: ...
