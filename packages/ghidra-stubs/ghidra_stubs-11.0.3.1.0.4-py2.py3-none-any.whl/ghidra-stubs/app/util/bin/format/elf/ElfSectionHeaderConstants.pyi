...
class ElfSectionHeaderConstants(object):
    ...
    SHT_LLVM_ADDRSIG: int = 1879002115
    SHT_LLVM_BB_ADDR_MAP: int = 1879002122
    SHT_LLVM_BB_ADDR_MAP_V0: int = 1879002120
    SHT_LLVM_CALL_GRAPH_PROFILE: int = 1879002121
    SHT_LLVM_DEPENDENT_LIBRARIES: int = 1879002116
    SHT_LLVM_LINKER_OPTIONS: int = 1879002113
    SHT_LLVM_LTO: int = 1879002124
    SHT_LLVM_ODRTAB: int = 1879002112
    SHT_LLVM_OFFLOADING: int = 1879002123
    SHT_LLVM_PART_EHDR: int = 1879002118
    SHT_LLVM_PART_PHDR: int = 1879002119
    SHT_LLVM_SYMPART: int = 1879002117
    SHT_NOBITS: int = 8
    SHT_NOTE: int = 7
    SHT_NULL: int = 0
