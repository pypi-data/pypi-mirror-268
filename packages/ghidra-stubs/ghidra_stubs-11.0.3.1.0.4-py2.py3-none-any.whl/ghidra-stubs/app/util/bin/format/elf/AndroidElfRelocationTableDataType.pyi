...
class AndroidElfRelocationTableDataType(ghidra.program.model.data.DynamicDataType):
    ...
    @overload
    @staticmethod
    def getLEB128Component(leb128: ghidra.app.util.bin.LEB128Info, parent: ghidra.program.model.data.DynamicDataType, ordinal: int, name: unicode, comment: unicode) -> ghidra.program.model.data.DataTypeComponent: ...

    @overload
    @staticmethod
    def getLEB128Component(leb128: ghidra.app.util.bin.LEB128Info, parent: ghidra.program.model.data.DynamicDataType, ordinal: int, name: unicode, comment: unicode, relocOffset: long) -> ghidra.program.model.data.DataTypeComponent: ...
