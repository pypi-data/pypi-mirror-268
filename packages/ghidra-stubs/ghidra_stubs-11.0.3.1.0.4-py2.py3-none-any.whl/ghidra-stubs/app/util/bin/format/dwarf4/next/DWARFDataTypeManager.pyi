...
class DWARFDataTypeManager(object):
    ...
    def __init__(self, prog: ghidra.app.util.bin.format.dwarf4.next.DWARFProgram, dataTypeManager: ghidra.program.model.data.DataTypeManager):
        """
    ...
    def getDataTypeForVariable(self, diea: ghidra.app.util.bin.format.dwarf4.DIEAggregate) -> ghidra.program.model.data.DataType: ...
