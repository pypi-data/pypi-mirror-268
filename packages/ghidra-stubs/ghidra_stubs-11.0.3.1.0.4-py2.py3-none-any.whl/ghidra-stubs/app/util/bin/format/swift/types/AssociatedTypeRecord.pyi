...
class AssociatedTypeRecord(object, ghidra.app.util.bin.format.swift.SwiftStructure):
    """
    ...
    def getSubstitutedTypeName(self) -> unicode:
        """
    ...
    @property
    def substitutedTypeName(self) -> unicode: ...