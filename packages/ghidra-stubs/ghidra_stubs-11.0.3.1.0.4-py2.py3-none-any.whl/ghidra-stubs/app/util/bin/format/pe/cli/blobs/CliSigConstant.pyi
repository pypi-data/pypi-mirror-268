...
class CliSigConstant(ghidra.app.util.bin.format.pe.cli.blobs.CliAbstractSig):




    def __init__(self, blob: ghidra.app.util.bin.format.pe.cli.blobs.CliBlob, elementType: ghidra.app.util.bin.format.pe.cli.blobs.CliAbstractSig.CliElementType): ...
