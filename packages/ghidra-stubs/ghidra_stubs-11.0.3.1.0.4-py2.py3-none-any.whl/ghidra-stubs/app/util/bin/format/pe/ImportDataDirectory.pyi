...
class ImportDataDirectory(ghidra.app.util.bin.format.pe.DataDirectory):
    """
    ...
    def getImportDescriptors(self) -> List[ghidra.app.util.bin.format.pe.ImportDescriptor]:
        """
    ...
    def getImports(self) -> List[ghidra.app.util.bin.format.pe.ImportInfo]:
        """
    ...
    @property
    def importDescriptors(self) -> List[ghidra.app.util.bin.format.pe.ImportDescriptor]: ...

    @property
    def imports(self) -> List[ghidra.app.util.bin.format.pe.ImportInfo]: ...