...
class COMDescriptorDataDirectory(ghidra.app.util.bin.format.pe.DataDirectory):
    """
    ...
    def getHeader(self) -> ghidra.app.util.bin.format.pe.ImageCor20Header: ...
    ...
    @property
    def header(self) -> ghidra.app.util.bin.format.pe.ImageCor20Header: ...