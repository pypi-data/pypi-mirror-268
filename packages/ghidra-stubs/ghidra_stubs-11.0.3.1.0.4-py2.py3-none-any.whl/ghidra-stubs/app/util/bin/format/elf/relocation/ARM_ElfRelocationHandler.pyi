...
class ARM_ElfRelocationHandler(ghidra.app.util.bin.format.elf.relocation.ElfRelocationHandler):
    ...
    def createRelocationContext(self, __a0: ghidra.app.util.bin.format.elf.ElfLoadHelper, __a1: java.util.Map) -> ghidra.app.util.bin.format.elf.relocation.ARM_ElfRelocationContext: ...
