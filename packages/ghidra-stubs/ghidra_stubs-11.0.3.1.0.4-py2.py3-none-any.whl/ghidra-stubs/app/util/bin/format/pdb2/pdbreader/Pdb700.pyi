...
class Pdb700(ghidra.app.util.bin.format.pdb2.pdbreader.AbstractPdb):
    ...
    def getItemProgramInterface(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.TypeProgramInterface: ...
    ...
    def getTypeProgramInterface(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.TypeProgramInterface: ...
