...
class PowerPC64_ElfRelocationHandler(ghidra.app.util.bin.format.elf.relocation.ElfRelocationHandler):
    ...
    def createRelocationContext(self, __a0: ghidra.app.util.bin.format.elf.ElfLoadHelper, __a1: java.util.Map) -> ghidra.app.util.bin.format.elf.relocation.ElfRelocationContext: ...
    ...
    def relocate(self, __a0: ghidra.app.util.bin.format.elf.relocation.ElfRelocationContext, __a1: ghidra.app.util.bin.format.elf.ElfRelocation, __a2: ghidra.program.model.address.Address) -> ghidra.program.model.reloc.RelocationResult: ...
