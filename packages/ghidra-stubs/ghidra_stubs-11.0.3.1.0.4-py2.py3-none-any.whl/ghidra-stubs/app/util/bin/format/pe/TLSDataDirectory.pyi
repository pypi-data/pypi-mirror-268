...
class TLSDataDirectory(ghidra.app.util.bin.format.pe.DataDirectory):
    """
    ...
    def getTLSDirectory(self) -> ghidra.app.util.bin.format.pe.TLSDirectory:
        """
    ...
    @property
    def TLSDirectory(self) -> ghidra.app.util.bin.format.pe.TLSDirectory: ...
