...
class PowerPC_ElfExtension(ghidra.app.util.bin.format.elf.extend.ElfExtension):
    DT_PPC_GOT: ghidra.app.util.bin.format.elf.ElfDynamicType = DT_PPC_GOT(0x70000000)
    DT_PPC_OPT: ghidra.app.util.bin.format.elf.ElfDynamicType = DT_PPC_OPT(0x70000001)
    GOT_THUNK_NAME: unicode
