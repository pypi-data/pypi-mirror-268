...
class DWARFAttribute(object):
    DW_AT_APPLE_omit_frame_ptr: int = 16359
    DW_AT_APPLE_optimized: int = 16353
    DW_AT_APPLE_ptrauth_address_discriminated: int = 15877
    DW_AT_APPLE_ptrauth_extra_discriminator: int = 15878
    DW_AT_APPLE_ptrauth_key: int = 15876
    ...
    DW_AT_addr_base: int = 115
    DW_AT_address_class: int = 51
    DW_AT_alignment: int = 136
    ...
    DW_AT_call_all_calls: int = 122
    DW_AT_call_all_source_calls: int = 123
    DW_AT_call_all_tail_calls: int = 124
    DW_AT_call_column: int = 87
    DW_AT_call_data_location: int = 133
    DW_AT_call_data_value: int = 134
    DW_AT_call_file: int = 88
    DW_AT_call_line: int = 89
    DW_AT_call_origin: int = 127
    DW_AT_call_parameter: int = 128
    DW_AT_call_pc: int = 129
    DW_AT_call_return_pc: int = 125
    DW_AT_call_tail_call: int = 130
    DW_AT_call_target: int = 131
    DW_AT_call_target_clobbered: int = 132
    DW_AT_call_value: int = 126
    ...
    DW_AT_export_symbols: int = 137
    DW_AT_extension: int = 84
    DW_AT_external: int = 63
    DW_AT_frame_base: int = 64
    DW_AT_friend: int = 65
    DW_AT_go_dict_index: int = 10502
    DW_AT_go_elem: int = 10498
    DW_AT_go_embedded_field: int = 10499
    DW_AT_go_key: int = 10497
    DW_AT_go_kind: int = 10496
    DW_AT_go_package_name: int = 10501
    DW_AT_go_runtime_type: int = 10500
    ...
    DW_AT_reference: int = 119
    DW_AT_return_addr: int = 42
    DW_AT_rnglists_base: int = 116
    DW_AT_rvalue_reference: int = 120
    ...
    DW_AT_str_offsets_base: int = 114
    DW_AT_string_length: int = 25
    DW_AT_string_length_bit_size: int = 111
    DW_AT_string_length_byte_size: int = 112
