...
class CliBlobMarshalSpec(ghidra.app.util.bin.format.pe.cli.blobs.CliBlob):
    ...
    class CliSafeArrayElemType(java.lang.Enum):
        VT_BOOL: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_BOOL
        VT_BSTR: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_BSTR
        VT_CY: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_CY
        VT_DATE: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_DATE
        VT_DECIMAL: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_DECIMAL
        VT_DISPATCH: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_DISPATCH
        VT_ERROR: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_ERROR
        VT_I1: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_I1
        VT_I2: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_I2
        VT_I4: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_I4
        VT_INT: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_INT
        VT_R4: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_R4
        VT_R8: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_R8
        VT_UI1: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_UI1
        VT_UI2: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_UI2
        VT_UI4: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_UI4
        VT_UINT: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_UINT
        VT_UNKNOWN: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_UNKNOWN
        VT_VARIANT: ghidra.app.util.bin.format.pe.cli.blobs.CliBlobMarshalSpec.CliSafeArrayElemType = VT_VARIANT
