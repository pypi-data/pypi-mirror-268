...
class FormatManager(object, ghidra.framework.options.OptionsChangeListener):
    ...
    def addHighlightProvider(self, provider: ghidra.app.util.ListingHighlightProvider) -> None:
        """
    ...
    def getHighlightProviders(self) -> List[ghidra.app.util.ListingHighlightProvider]:
        """
    ...
    def removeHighlightProvider(self, provider: ghidra.app.util.ListingHighlightProvider) -> None:
        """
