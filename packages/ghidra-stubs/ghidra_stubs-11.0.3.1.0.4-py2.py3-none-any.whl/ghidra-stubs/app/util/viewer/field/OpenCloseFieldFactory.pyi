...
class OpenCloseFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    """
    Generates Open/Close Fields.
    """

    FIELD_NAME: unicode = u'+'
    ...
    def newInstance(self, fieldModel: ghidra.app.util.viewer.format.FieldFormatModel, provider: ghidra.app.util.ListingHighlightProvider, displayOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
