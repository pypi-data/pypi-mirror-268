...
class PlateFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    """
    Class for showing plate comments
    """

    DEFAULT_COLOR: java.awt.Color = #0000ff
    ENABLE_WORD_WRAP_MSG: unicode = u'Plate Comments Field.Enable Word Wrapping'
    FIELD_NAME: unicode = u'Plate Comment'
    FUNCTION_PLATE_COMMENT: unicode = u'FUNCTION'
    ...
    def newInstance(self, formatModel: ghidra.app.util.viewer.format.FieldFormatModel, hsProvider: ghidra.app.util.ListingHighlightProvider, toolOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
