...
class OperandFieldHelper(ghidra.app.util.viewer.field.FieldFactory):
    ...
    class UNDERLINE_CHOICE(java.lang.Enum):
        All: ghidra.app.util.viewer.field.OperandFieldHelper.UNDERLINE_CHOICE = All
        Hidden: ghidra.app.util.viewer.field.OperandFieldHelper.UNDERLINE_CHOICE = Hidden
        None: ghidra.app.util.viewer.field.OperandFieldHelper.UNDERLINE_CHOICE = None
