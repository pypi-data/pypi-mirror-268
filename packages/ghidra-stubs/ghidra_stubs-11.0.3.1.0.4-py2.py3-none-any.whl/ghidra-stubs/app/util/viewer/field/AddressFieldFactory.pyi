...
class AddressFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    ...
    def newInstance(self, newModel: ghidra.app.util.viewer.format.FieldFormatModel, highlightStringProvider: ghidra.app.util.ListingHighlightProvider, toolOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
