...
class BytesFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    """
    Generates Bytes Fields.
    """

    BYTE_GROUP_SIZE_MSG: unicode = u'Bytes Field.Byte Group Size'
    DELIMITER_MSG: unicode = u'Bytes Field.Delimiter'
    DISPLAY_STRUCTURE_ALIGNMENT_BYTES_MSG: unicode = u'Bytes Field.Display Structure Alignment Bytes'
    DISPLAY_UCASE_MSG: unicode = u'Bytes Field.Display in Upper Case'
    FIELD_NAME: unicode = u'Bytes'
    GROUP_TITLE: unicode = u'Bytes Field'
    MAX_DISPLAY_LINES_MSG: unicode = u'Bytes Field.Maximum Lines To Display'
    REVERSE_INSTRUCTION_BYTE_ORDERING: unicode = u'Bytes Field.Reverse Instruction Byte Ordering'
    ...
    def newInstance(self, formatModel: ghidra.app.util.viewer.format.FieldFormatModel, provider: ghidra.app.util.ListingHighlightProvider, displayOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
