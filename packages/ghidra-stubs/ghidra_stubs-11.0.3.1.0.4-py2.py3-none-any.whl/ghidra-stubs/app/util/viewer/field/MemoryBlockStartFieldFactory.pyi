...
class MemoryBlockStartFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    """
    Generates a text label on each CodeUnit that marks the start of a memory block. The
