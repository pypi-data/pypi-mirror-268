...
class PostCommentFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    """
    Generates post comment Fields.
    """

    ENABLE_ALWAYS_SHOW_AUTOMATIC_MSG: unicode = u'Post-comments Field.Always Show the Automatic Comment'
    ENABLE_WORD_WRAP_MSG: unicode = u'Post-comments Field.Enable Word Wrapping'
    FIELD_NAME: unicode = u'Post-Comment'
    ...
    def newInstance(self, formatModel: ghidra.app.util.viewer.format.FieldFormatModel, provider: ghidra.app.util.ListingHighlightProvider, toolOptions: ghidra.framework.options.ToolOptions, fieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
