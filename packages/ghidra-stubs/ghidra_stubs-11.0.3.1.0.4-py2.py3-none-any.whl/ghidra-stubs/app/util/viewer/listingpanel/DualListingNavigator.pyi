...
class DualListingNavigator(object, ghidra.app.nav.Navigatable):
    """
    ...
    def removeHighlightProvider(self, highlightProvider: ghidra.app.util.ListingHighlightProvider, program: ghidra.program.model.listing.Program) -> None: ...
    ...
    def setHighlightProvider(self, highlightProvider: ghidra.app.util.ListingHighlightProvider, program: ghidra.program.model.listing.Program) -> None: ...
