...
class WindowsResourceReferenceAnalyzer(ghidra.app.services.AbstractAnalyzer):
    ...
    def runScript(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.address.AddressSetView, __a2: unicode, __a3: ghidra.util.task.TaskMonitor) -> bool: ...
