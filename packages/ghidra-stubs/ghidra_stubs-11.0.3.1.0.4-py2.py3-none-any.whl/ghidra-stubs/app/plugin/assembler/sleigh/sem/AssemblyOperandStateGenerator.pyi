...
class AssemblyOperandStateGenerator(ghidra.app.plugin.assembler.sleigh.sem.AbstractAssemblyStateGenerator):
    ...
    def __init__(self, resolver: ghidra.app.plugin.assembler.sleigh.sem.AssemblyTreeResolver, node: ghidra.app.plugin.assembler.sleigh.tree.AssemblyParseNumericToken, opSym: ghidra.app.plugin.processors.sleigh.symbol.OperandSymbol, fromLeft: ghidra.app.plugin.assembler.sleigh.sem.AssemblyResolvedPatterns):
        """
