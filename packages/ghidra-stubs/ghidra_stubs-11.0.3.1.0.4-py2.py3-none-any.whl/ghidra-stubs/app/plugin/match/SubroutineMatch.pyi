...
class SubroutineMatch(object):
    ...
    def __init__(self, reason: unicode): ...



    def add(self, addr: ghidra.program.model.address.Address, isA: bool) -> bool: ...
    ...
    def remove(self, addr: ghidra.program.model.address.Address, isA: bool) -> bool: ...
