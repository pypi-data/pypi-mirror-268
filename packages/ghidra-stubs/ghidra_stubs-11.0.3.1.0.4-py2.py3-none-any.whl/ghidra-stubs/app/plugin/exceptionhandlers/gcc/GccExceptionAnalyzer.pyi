...
class GccExceptionAnalyzer(ghidra.app.services.AbstractAnalyzer):
    ...
    DESCRIPTION: unicode = u'Locates and annotates exception-handling infrastructure installed by the GCC compiler'
    NAME: unicode = u'GCC Exception Handlers'
    ...
    def added(self, program: ghidra.program.model.listing.Program, addedLocationAddresses: ghidra.program.model.address.AddressSetView, monitor: ghidra.util.task.TaskMonitor, log: ghidra.app.util.importer.MessageLog) -> bool: ...
