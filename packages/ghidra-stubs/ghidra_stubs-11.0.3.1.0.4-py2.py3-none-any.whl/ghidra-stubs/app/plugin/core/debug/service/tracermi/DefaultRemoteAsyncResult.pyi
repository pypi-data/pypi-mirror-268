...
class DefaultRemoteAsyncResult(java.util.concurrent.CompletableFuture, ghidra.debug.api.tracermi.RemoteAsyncResult):
    ...
    @overload
    def __init__(self, __a0: ghidra.app.plugin.core.debug.service.tracermi.OpenTrace): ...
    ...
    def applyToEither(self, __a0: java.util.concurrent.CompletionStage, __a1: java.util.function.Function) -> java.util.concurrent.CompletableFuture: ...
    ...
    @overload
    def exceptionallyAsync(self, __a0: java.util.function.Function, __a1: java.util.concurrent.Executor) -> java.util.concurrent.CompletableFuture: ...

    def exceptionallyCompose(self, __a0: java.util.function.Function) -> java.util.concurrent.CompletionStage: ...

    @overload
    def exceptionallyComposeAsync(self, __a0: java.util.function.Function) -> java.util.concurrent.CompletableFuture: ...
    ...
    @overload
    def thenAcceptAsync(self, __a0: java.util.function.Consumer) -> java.util.concurrent.CompletableFuture: ...
    ...
    @overload
    def thenAcceptBothAsync(self, __a0: java.util.concurrent.CompletionStage, __a1: java.util.function.BiConsumer, __a2: java.util.concurrent.Executor) -> java.util.concurrent.CompletableFuture: ...
