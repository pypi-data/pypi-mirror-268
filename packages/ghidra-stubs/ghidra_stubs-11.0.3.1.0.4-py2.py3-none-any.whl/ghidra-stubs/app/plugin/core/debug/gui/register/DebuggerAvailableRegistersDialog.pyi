...
class DebuggerAvailableRegistersDialog(docking.ReusableDialogComponentProvider):
    ...
    def setKnown(self, __a0: java.util.Collection) -> None: ...

    def setLanguage(self, __a0: ghidra.program.model.lang.Language) -> None: ...
    ...
    def setSelection(self, __a0: java.util.Collection) -> None: ...
    ...
    @property
    def known(self) -> None: ...  # No getter available.

    @known.setter
    def known(self, value: java.util.Collection) -> None: ...
    ...
    @selection.setter
    def selection(self, value: java.util.Collection) -> None: ...