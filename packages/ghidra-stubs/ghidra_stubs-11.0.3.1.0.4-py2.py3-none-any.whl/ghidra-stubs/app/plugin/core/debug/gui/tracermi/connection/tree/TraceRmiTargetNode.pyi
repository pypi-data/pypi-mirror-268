...
class TraceRmiTargetNode(ghidra.app.plugin.core.debug.gui.tracermi.connection.tree.AbstractTraceRmiManagerNode):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.tracermi.connection.TraceRmiConnectionManagerProvider, __a1: ghidra.app.plugin.core.debug.gui.tracermi.connection.tree.TraceRmiConnectionNode, __a2: ghidra.debug.api.target.Target): ...
    ...
    def getConnectionNode(self) -> ghidra.app.plugin.core.debug.gui.tracermi.connection.tree.TraceRmiConnectionNode: ...
    ...
    @property
    def connectionNode(self) -> ghidra.app.plugin.core.debug.gui.tracermi.connection.tree.TraceRmiConnectionNode: ...
