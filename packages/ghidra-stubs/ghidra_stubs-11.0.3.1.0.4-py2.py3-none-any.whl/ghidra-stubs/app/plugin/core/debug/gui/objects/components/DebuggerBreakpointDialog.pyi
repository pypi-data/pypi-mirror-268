...
class DebuggerBreakpointDialog(docking.DialogComponentProvider):
    ...
    def setContainer(self, __a0: ghidra.dbg.target.TargetBreakpointSpecContainer) -> None: ...
    ...
    @property
    def container(self) -> None: ...  # No getter available.

    @container.setter
    def container(self, value: ghidra.dbg.target.TargetBreakpointSpecContainer) -> None: ...
