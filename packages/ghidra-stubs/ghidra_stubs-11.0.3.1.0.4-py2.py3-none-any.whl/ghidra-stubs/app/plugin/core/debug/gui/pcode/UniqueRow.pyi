...
class UniqueRow(object):
    ...
    class RefType(java.lang.Enum):
        NONE: ghidra.app.plugin.core.debug.gui.pcode.UniqueRow.RefType = NONE
        READ: ghidra.app.plugin.core.debug.gui.pcode.UniqueRow.RefType = READ
        READ_WRITE: ghidra.app.plugin.core.debug.gui.pcode.UniqueRow.RefType = READ_WRITE
        WRITE: ghidra.app.plugin.core.debug.gui.pcode.UniqueRow.RefType = WRITE
