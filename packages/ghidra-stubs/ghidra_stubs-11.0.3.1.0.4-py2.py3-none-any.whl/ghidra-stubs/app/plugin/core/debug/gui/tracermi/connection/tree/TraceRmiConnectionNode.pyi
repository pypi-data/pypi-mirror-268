...
class TraceRmiConnectionNode(ghidra.app.plugin.core.debug.gui.tracermi.connection.tree.AbstractTraceRmiManagerNode):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.tracermi.connection.TraceRmiConnectionManagerProvider, __a1: ghidra.debug.api.tracermi.TraceRmiConnection): ...
    ...
    def targetPublished(self, __a0: ghidra.debug.api.target.Target) -> ghidra.app.plugin.core.debug.gui.tracermi.connection.tree.TraceRmiTargetNode: ...
