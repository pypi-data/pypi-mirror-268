...
class DebuggerWrappedConsoleConnection(ghidra.app.plugin.core.debug.gui.interpreters.AbstractDebuggerWrappedConsoleConnection):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.interpreters.DebuggerInterpreterPlugin, __a1: ghidra.dbg.target.TargetConsole): ...
