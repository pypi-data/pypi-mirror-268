...
class DebuggerAttachDialogOld(docking.DialogComponentProvider):
    ...
    def setLauncher(self, __a0: ghidra.dbg.target.TargetAttacher) -> None: ...
    ...
    @property
    def launcher(self) -> None: ...  # No getter available.

    @launcher.setter
    def launcher(self, value: ghidra.dbg.target.TargetAttacher) -> None: ...