...
class DebuggerConnectionsNode(ghidra.app.plugin.core.debug.gui.DebuggerResources.AbstractDebuggerConnectionsNode, docking.widgets.tree.SearchableByObjectGTreeNode):




    def __init__(self, __a0: ghidra.app.services.DebuggerModelService, __a1: ghidra.app.plugin.core.debug.gui.target.DebuggerTargetsProvider): ...
    ...
    def findNodeForObject(self, __a0: object) -> docking.widgets.tree.GTreeNode: ...
    ...
    def getObjectNodeMap(self) -> java.util.Map: ...

    def getParent(self) -> docking.widgets.tree.GTreeNode: ...

    def getRoot(self) -> docking.widgets.tree.GTreeNode: ...

    def getTargetService(self) -> ghidra.app.services.DebuggerModelService: ...
    ...
    @property
    def objectNodeMap(self) -> java.util.Map: ...

    @property
    def targetService(self) -> ghidra.app.services.DebuggerModelService: ...