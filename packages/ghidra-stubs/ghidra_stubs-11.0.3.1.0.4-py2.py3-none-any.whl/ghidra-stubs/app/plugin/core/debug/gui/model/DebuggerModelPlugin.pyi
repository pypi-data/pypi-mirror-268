...
class DebuggerModelPlugin(ghidra.framework.plugintool.Plugin):
    ...
    def getConnectedProvider(self) -> ghidra.app.plugin.core.debug.gui.model.DebuggerModelProvider: ...

    def getData(self) -> List[ghidra.framework.model.DomainFile]: ...

    def getDisconnectedProviders(self) -> List[object]: ...
    ...
    @property
    def connectedProvider(self) -> ghidra.app.plugin.core.debug.gui.model.DebuggerModelProvider: ...

    @property
    def disconnectedProviders(self) -> List[object]: ...