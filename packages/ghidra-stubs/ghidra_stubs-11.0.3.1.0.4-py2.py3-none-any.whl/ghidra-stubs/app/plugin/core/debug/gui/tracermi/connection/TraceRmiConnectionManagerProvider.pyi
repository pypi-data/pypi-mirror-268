...
class TraceRmiConnectionManagerProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    HELP: ghidra.util.HelpLocation = TraceRmiConnectionManagerPlugin_plugin
    TITLE: unicode = u'Connections'



    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.tracermi.connection.TraceRmiConnectionManagerPlugin): ...
