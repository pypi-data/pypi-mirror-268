...
class DebuggerModulesProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def getAutoMapSpec(self) -> ghidra.app.plugin.core.debug.gui.action.AutoMapSpec: ...
    ...
    def setAutoMapSpec(self, __a0: ghidra.app.plugin.core.debug.gui.action.AutoMapSpec) -> None: ...
    ...
    @property
    def autoMapSpec(self) -> ghidra.app.plugin.core.debug.gui.action.AutoMapSpec: ...

    @autoMapSpec.setter
    def autoMapSpec(self, value: ghidra.app.plugin.core.debug.gui.action.AutoMapSpec) -> None: ...
