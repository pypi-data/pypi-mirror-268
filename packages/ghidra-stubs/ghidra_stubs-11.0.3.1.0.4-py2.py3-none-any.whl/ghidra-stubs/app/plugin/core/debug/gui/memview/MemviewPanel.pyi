...
class MemviewPanel(javax.swing.JPanel, java.awt.event.MouseListener, java.awt.event.MouseMotionListener):
    ...
    def getAddr(self, __a0: int, __a1: int) -> long: ...
    ...
    def getBoxesAt(self, __a0: int, __a1: int) -> java.util.Set: ...

    def getBoxesIn(self, __a0: java.awt.Rectangle) -> java.util.Set: ...
    ...
    def getTagForAddr(self, __a0: long) -> unicode: ...

    def getTagForTick(self, __a0: long) -> unicode: ...

    def getTick(self, __a0: int, __a1: int) -> long: ...

    def getTitleAnnotation(self) -> unicode: ...
    ...
    def paintComponent(self, __a0: java.awt.Graphics) -> None: ...
    ...
    def scaleCurrentPixelAddr(self, __a0: float) -> None: ...

    def scaleCurrentPixelTime(self, __a0: float) -> None: ...
    ...
    def setVerticalMode(self, __a0: bool) -> None: ...
    ...
    @property
    def titleAnnotation(self) -> unicode: ...

    @property
    def verticalMode(self) -> bool: ...

    @verticalMode.setter
    def verticalMode(self, value: bool) -> None: ...