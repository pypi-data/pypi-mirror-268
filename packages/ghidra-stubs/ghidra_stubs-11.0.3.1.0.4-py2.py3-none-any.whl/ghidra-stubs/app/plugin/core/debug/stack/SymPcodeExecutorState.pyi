...
class SymPcodeExecutorState(object, ghidra.pcode.exec.PcodeExecutorState):
    ...
    def computeMapUsingRegisters(self) -> java.util.Map: ...

    def computeMapUsingStack(self) -> java.util.Map: ...

    def computeStackDepth(self) -> long: ...
    ...
    def forkRegs(self) -> ghidra.app.plugin.core.debug.stack.SymPcodeExecutorState: ...
    ...
    @overload
    def getVar(self, __a0: ghidra.program.model.address.AddressSpace, __a1: ghidra.app.plugin.core.debug.stack.Sym, __a2: int, __a3: bool, __a4: ghidra.pcode.exec.PcodeExecutorStatePiece.Reason) -> ghidra.app.plugin.core.debug.stack.Sym: ...
    ...
    @overload
    def setVar(self, __a0: ghidra.program.model.address.AddressSpace, __a1: ghidra.app.plugin.core.debug.stack.Sym, __a2: int, __a3: bool, __a4: ghidra.app.plugin.core.debug.stack.Sym) -> None: ...
