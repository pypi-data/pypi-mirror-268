...
class FakeUnwoundFrame(ghidra.app.plugin.core.debug.stack.AbstractUnwoundFrame):
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.debug.api.tracemgr.DebuggerCoordinates, __a2: ghidra.pcode.exec.PcodeExecutorState): ...
