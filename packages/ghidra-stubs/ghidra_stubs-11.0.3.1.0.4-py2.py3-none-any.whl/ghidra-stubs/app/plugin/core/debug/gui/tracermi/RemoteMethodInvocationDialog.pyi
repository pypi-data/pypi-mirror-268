...
class RemoteMethodInvocationDialog(docking.DialogComponentProvider, java.beans.PropertyChangeListener):
    ...
    def promptArguments(self, __a0: ghidra.dbg.target.schema.SchemaContext, __a1: java.util.Map, __a2: java.util.Map) -> java.util.Map: ...
    ...
    def setDefaults(self, __a0: java.util.Map) -> None: ...
    ...
    def setParameters(self, __a0: ghidra.dbg.target.schema.SchemaContext, __a1: java.util.Map) -> None: ...
    ...
    @property
    def defaults(self) -> None: ...  # No getter available.

    @defaults.setter
    def defaults(self, value: java.util.Map) -> None: ...
