...
class DebuggerSnapshotTablePanel(javax.swing.JPanel):
    ...
    def getSelectedSnapshot(self) -> long: ...
    ...
    def setHideScratchSnapshots(self, __a0: bool) -> None: ...
    ...
    def setSelectedSnapshot(self, __a0: long) -> None: ...
    ...
    @property
    def hideScratchSnapshots(self) -> None: ...  # No getter available.

    @hideScratchSnapshots.setter
    def hideScratchSnapshots(self, value: bool) -> None: ...

    @property
    def selectedSnapshot(self) -> long: ...

    @selectedSnapshot.setter
    def selectedSnapshot(self, value: long) -> None: ...
