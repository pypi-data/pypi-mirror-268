...
class DebuggerAttachDialog(docking.ReusableDialogComponentProvider):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.objects.DebuggerObjectsProvider): ...
    ...
    def fetchAndDisplayAttachable(self) -> None: ...
    ...
    def setAttacher(self, __a0: ghidra.dbg.target.TargetAttacher) -> None: ...
    ...
    @property
    def attacher(self) -> None: ...  # No getter available.

    @attacher.setter
    def attacher(self, value: ghidra.dbg.target.TargetAttacher) -> None: ...