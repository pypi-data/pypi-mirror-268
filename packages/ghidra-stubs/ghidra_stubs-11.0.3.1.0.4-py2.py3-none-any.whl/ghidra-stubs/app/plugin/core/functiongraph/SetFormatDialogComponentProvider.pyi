...
class SetFormatDialogComponentProvider(docking.DialogComponentProvider):




    def __init__(self, __a0: ghidra.app.util.viewer.format.FormatManager, __a1: ghidra.app.util.viewer.format.FormatManager, __a2: ghidra.framework.plugintool.ServiceProvider, __a3: ghidra.program.model.listing.Program, __a4: ghidra.program.model.address.AddressSetView): ...
    ...
    def getNewFormatManager(self) -> ghidra.app.util.viewer.format.FormatManager: ...
    ...
    @property
    def newFormatManager(self) -> ghidra.app.util.viewer.format.FormatManager: ...