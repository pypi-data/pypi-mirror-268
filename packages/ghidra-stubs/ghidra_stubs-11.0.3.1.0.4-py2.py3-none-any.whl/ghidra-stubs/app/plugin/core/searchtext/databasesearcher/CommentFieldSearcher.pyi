...
class CommentFieldSearcher(ghidra.app.plugin.core.searchtext.databasesearcher.ProgramDatabaseFieldSearcher):




    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.util.ProgramLocation, __a2: ghidra.program.model.address.AddressSetView, __a3: bool, __a4: java.util.regex.Pattern, __a5: int): ...
