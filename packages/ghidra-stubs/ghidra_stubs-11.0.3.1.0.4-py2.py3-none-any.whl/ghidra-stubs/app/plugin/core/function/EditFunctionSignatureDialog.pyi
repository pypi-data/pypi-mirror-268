...
class EditFunctionSignatureDialog(ghidra.app.plugin.core.function.AbstractEditFunctionSignatureDialog):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: unicode, __a2: ghidra.program.model.listing.Function): ...
