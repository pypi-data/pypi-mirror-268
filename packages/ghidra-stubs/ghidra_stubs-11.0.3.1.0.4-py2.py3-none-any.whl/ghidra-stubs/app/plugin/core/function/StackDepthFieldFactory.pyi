...
class StackDepthFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    COLOR: generic.theme.GColor = #00ffff
    ...
    def newInstance(self, __a0: ghidra.app.util.viewer.format.FieldFormatModel, __a1: ghidra.app.util.ListingHighlightProvider, __a2: ghidra.framework.options.ToolOptions, __a3: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
    ...
    def supportsLocation(self, __a0: ghidra.app.util.viewer.field.ListingField, __a1: ghidra.program.util.ProgramLocation) -> bool: ...
