...
class TerminalPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.TerminalService):
    ...
    def cleanTerminated(self) -> None: ...

    def createNullTerminal(self, __a0: java.nio.charset.Charset, __a1: ghidra.app.plugin.core.terminal.vt.VtOutput) -> ghidra.app.services.Terminal: ...

    def createProvider(self, __a0: java.nio.charset.Charset, __a1: ghidra.app.plugin.core.terminal.vt.VtOutput) -> ghidra.app.plugin.core.terminal.TerminalProvider: ...

    def createWithStreams(self, __a0: java.nio.charset.Charset, __a1: java.io.InputStream, __a2: java.io.OutputStream) -> ghidra.app.services.Terminal: ...
