...
class CreateStructureDialog(docking.ReusableDialogComponentProvider):
    ...
    def showCreateStructureDialog(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.data.Structure) -> ghidra.program.model.data.Structure: ...
