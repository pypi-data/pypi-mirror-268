...
class FunctionComparisonProvider(ghidra.framework.plugintool.ComponentProviderAdapter, docking.actions.PopupActionProvider, ghidra.app.plugin.core.functioncompare.FunctionComparisonModelListener):
    ...
    @overload
    def __init__(self, __a0: ghidra.app.plugin.core.functioncompare.FunctionComparisonPlugin, __a1: unicode, __a2: unicode): ...

    @overload
    def __init__(self, __a0: ghidra.app.plugin.core.functioncompare.FunctionComparisonPlugin, __a1: unicode, __a2: unicode, __a3: java.lang.Class): ...
    ...
    def removeAddFunctionsAction(self) -> None: ...
    ...
    def setCloseListener(self, __a0: utility.function.Callback) -> None: ...
    ...
    @property
    def closeListener(self) -> None: ...  # No getter available.

    @closeListener.setter
    def closeListener(self, value: utility.function.Callback) -> None: ...
