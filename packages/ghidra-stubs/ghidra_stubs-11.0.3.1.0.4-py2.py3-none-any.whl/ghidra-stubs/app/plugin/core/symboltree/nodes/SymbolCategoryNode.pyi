...
class SymbolCategoryNode(ghidra.app.plugin.core.symboltree.nodes.SymbolTreeNode):
    MAX_NODES_BEFORE_CLOSING: int = 200
    MAX_NODES_BEFORE_ORGANIZING: int = 40



    def __init__(self, __a0: ghidra.app.plugin.core.symboltree.SymbolCategory, __a1: ghidra.program.model.listing.Program): ...
