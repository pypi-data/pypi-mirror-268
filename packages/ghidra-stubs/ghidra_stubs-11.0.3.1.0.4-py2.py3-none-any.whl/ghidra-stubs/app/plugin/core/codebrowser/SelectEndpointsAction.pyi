...
class SelectEndpointsAction(docking.action.DockingAction):
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.Plugin, __a1: ghidra.program.model.listing.Program, __a2: ghidra.app.plugin.core.codebrowser.AddressRangeTableModel, __a3: ghidra.app.plugin.core.codebrowser.SelectEndpointsAction.RangeEndpoint): ...
