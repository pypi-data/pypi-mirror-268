...
class AddressRangeCodeUnitTableColumn(docking.widgets.table.AbstractDynamicTableColumn):
    ...
    @overload
    def getValue(self, __a0: ghidra.app.plugin.core.codebrowser.AddressRangeInfo, __a1: ghidra.docking.settings.Settings, __a2: ghidra.program.model.listing.Program, __a3: ghidra.framework.plugintool.ServiceProvider) -> ghidra.util.table.field.CodeUnitTableCellData: ...
