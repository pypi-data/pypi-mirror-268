...
class UnionEditorPanel(ghidra.app.plugin.core.compositeeditor.CompEditorPanel):




    def __init__(self, __a0: ghidra.app.plugin.core.compositeeditor.UnionEditorModel, __a1: ghidra.app.plugin.core.compositeeditor.CompositeEditorProvider): ...
