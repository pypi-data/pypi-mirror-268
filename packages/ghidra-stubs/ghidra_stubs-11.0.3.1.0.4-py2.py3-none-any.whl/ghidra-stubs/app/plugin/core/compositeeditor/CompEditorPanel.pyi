...
class CompEditorPanel(ghidra.app.plugin.core.compositeeditor.CompositeEditorPanel):




    def __init__(self, __a0: ghidra.app.plugin.core.compositeeditor.CompEditorModel, __a1: ghidra.app.plugin.core.compositeeditor.CompositeEditorProvider): ...
    ...
    def refreshGUIActualAlignmentValue(self) -> None: ...

    def refreshGUIMinimumAlignmentValue(self) -> None: ...

    def refreshGUIPackingValue(self) -> None: ...
    ...
    def setCategoryName(self, __a0: unicode) -> None: ...
    ...
    def setCompositeName(self, __a0: unicode) -> None: ...

    def setCompositeSize(self, __a0: int) -> None: ...
    ...
    @categoryName.setter
    def categoryName(self, value: unicode) -> None: ...

    @property
    def compositeName(self) -> unicode: ...

    @compositeName.setter
    def compositeName(self, value: unicode) -> None: ...

    @property
    def compositeSize(self) -> int: ...

    @compositeSize.setter
    def compositeSize(self, value: int) -> None: ...
