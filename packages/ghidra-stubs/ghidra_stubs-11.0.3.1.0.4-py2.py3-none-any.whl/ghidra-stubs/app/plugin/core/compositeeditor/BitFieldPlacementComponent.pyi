...
class BitFieldPlacementComponent(javax.swing.JPanel, javax.swing.Scrollable):
    ...
    def isWithinBitCell(self, __a0: java.awt.Point) -> bool: ...
    ...
    def setComposite(self, __a0: ghidra.program.model.data.Composite) -> None: ...
    ...
    def setShowOffsetsInHex(self, __a0: bool) -> None: ...
    ...
    @composite.setter
    def composite(self, value: ghidra.program.model.data.Composite) -> None: ...

    @property
    def preferredHeight(self) -> int: ...

    @property
    def preferredScrollableViewportSize(self) -> java.awt.Dimension: ...

    @property
    def scrollableTracksViewportHeight(self) -> bool: ...

    @property
    def scrollableTracksViewportWidth(self) -> bool: ...

    @property
    def showOffsetsInHex(self) -> bool: ...

    @showOffsetsInHex.setter
    def showOffsetsInHex(self, value: bool) -> None: ...