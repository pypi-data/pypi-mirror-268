...
class KnotLabelPanel(javax.swing.JPanel):
    ...
    def setPalette(self, __a0: ghidra.app.plugin.core.overview.entropy.OverviewPalette) -> None: ...
    ...
    @palette.setter
    def palette(self, value: ghidra.app.plugin.core.overview.entropy.OverviewPalette) -> None: ...