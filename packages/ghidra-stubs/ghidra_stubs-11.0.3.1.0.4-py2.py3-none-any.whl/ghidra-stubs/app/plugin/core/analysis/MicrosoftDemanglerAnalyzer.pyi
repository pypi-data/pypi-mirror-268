...
class MicrosoftDemanglerAnalyzer(ghidra.app.plugin.core.analysis.AbstractDemanglerAnalyzer):
    OPTION_NAME_APPLY_CALLING_CONVENTION: unicode = u'Apply Function Calling Conventions'
    OPTION_NAME_APPLY_SIGNATURE: unicode = u'Apply Function Signatures'
