...
class ProgramStartingLocationPlugin(ghidra.app.plugin.ProgramPlugin):
    ...
    class NonActiveProgramState(java.lang.Enum):
        FIRST_ANALYSIS_COMPLETED: ghidra.app.plugin.core.navigation.ProgramStartingLocationPlugin.NonActiveProgramState = FIRST_ANALYSIS_COMPLETED
        NEWLY_OPENED: ghidra.app.plugin.core.navigation.ProgramStartingLocationPlugin.NonActiveProgramState = NEWLY_OPENED
        RESTORED: ghidra.app.plugin.core.navigation.ProgramStartingLocationPlugin.NonActiveProgramState = RESTORED
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.app.plugin.core.navigation.ProgramStartingLocationPlugin.NonActiveProgramState: ...
        ...
        @staticmethod
        def values() -> List[ghidra.app.plugin.core.navigation.ProgramStartingLocationPlugin.NonActiveProgramState]: ...
