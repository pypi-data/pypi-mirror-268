...
class ExporterDialog(docking.DialogComponentProvider, ghidra.app.util.AddressFactoryService):
    ...
    @overload
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.framework.model.DomainFile): ...

    @overload
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.framework.model.DomainFile, __a2: ghidra.framework.model.DomainObject, __a3: ghidra.program.util.ProgramSelection): ...
    ...
    def getOptions(self) -> List[object]: ...
