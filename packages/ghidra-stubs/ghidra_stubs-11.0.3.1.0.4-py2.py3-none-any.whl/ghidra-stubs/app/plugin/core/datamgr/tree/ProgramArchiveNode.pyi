...
class ProgramArchiveNode(ghidra.app.plugin.core.datamgr.tree.DomainFileArchiveNode):




    def __init__(self, __a0: ghidra.app.plugin.core.datamgr.archive.ProgramArchive, __a1: ghidra.app.plugin.core.datamgr.tree.ArrayPointerFilterState): ...
