...
class DataTypesProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def setFilterOnNameOnly(self, __a0: bool) -> None: ...

    def setFilterOnNameOnlyCallback(self, __a0: bool) -> None: ...
    ...
    @property
    def filterOnNameOnly(self) -> bool: ...

    @filterOnNameOnly.setter
    def filterOnNameOnly(self, value: bool) -> None: ...

    @property
    def filterOnNameOnlyCallback(self) -> None: ...  # No getter available.

    @filterOnNameOnlyCallback.setter
    def filterOnNameOnlyCallback(self, value: bool) -> None: ...
