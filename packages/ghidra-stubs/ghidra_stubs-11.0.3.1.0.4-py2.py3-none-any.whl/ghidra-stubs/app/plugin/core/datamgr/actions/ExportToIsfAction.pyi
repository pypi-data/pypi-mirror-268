...
class ExportToIsfAction(docking.action.DockingAction):
    ...
    class DataTypeWriterTask(ghidra.util.task.Task):
        ...
        def __init__(self, __a0: ghidra.app.plugin.core.datamgr.actions.ExportToIsfAction, __a1: docking.widgets.tree.GTree, __a2: ghidra.program.model.data.DataTypeManager, __a3: List[object], __a4: java.io.File): ...
