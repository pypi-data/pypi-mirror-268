...
class ChecksumTableModel(docking.widgets.table.GDynamicColumnTableModel):
    NAME_COL: int = 0
    VALUE_COL: int = 1



    def __init__(self, __a0: ghidra.framework.plugintool.ServiceProvider, __a1: List[object]): ...
