...
class ByteViewerOptionsDialog(docking.DialogComponentProvider, javax.swing.event.ChangeListener, java.awt.event.ActionListener):




    def __init__(self, __a0: ghidra.app.plugin.core.byteviewer.ByteViewerComponentProvider): ...
