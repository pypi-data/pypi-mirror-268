...
class MergeManagerPlugin(ghidra.framework.plugintool.Plugin, ghidra.framework.main.ProgramaticUseOnly, ghidra.framework.model.DomainObjectListener):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, mergeManager: ghidra.app.merge.MergeManager, domainObject: ghidra.framework.model.UndoableDomainObject):
        """
    ...
    @property
    def allOpenDomainObjects(self) -> List[ghidra.framework.model.UndoableDomainObject]: ...

    @property
    def currentDomainObject(self) -> ghidra.framework.model.UndoableDomainObject: ...

    @currentDomainObject.setter
    def currentDomainObject(self, value: ghidra.framework.model.UndoableDomainObject) -> None: ...