...
class BatchImportDialog(docking.DialogComponentProvider):
    ...
    @staticmethod
    def showAndImport(__a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.plugins.importer.batch.BatchInfo, __a2: List[object], __a3: ghidra.framework.model.DomainFolder, __a4: ghidra.app.services.ProgramManager) -> None: ...
