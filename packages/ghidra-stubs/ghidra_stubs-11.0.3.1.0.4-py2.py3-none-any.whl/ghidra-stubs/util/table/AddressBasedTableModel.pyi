...
class AddressBasedTableModel(ghidra.util.table.GhidraProgramTableModel):




    @overload
    def __init__(self, title: unicode, serviceProvider: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor): ...

    @overload
    def __init__(self, title: unicode, serviceProvider: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor, loadIncrementally: bool): ...
