...
class ReferencesFromTableModel(ghidra.util.table.AddressBasedTableModel):
    """
    ...
    def __init__(self, refs: java.util.Collection, sp: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program): ...
