...
class CodeUnitTableColumn(ghidra.util.table.field.ProgramLocationTableColumnExtensionPoint):
    """
    ...
    @overload
    def getValue(self, rowObject: ghidra.program.util.ProgramLocation, settings: ghidra.docking.settings.Settings, data: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> ghidra.util.table.field.CodeUnitTableCellData: ...
