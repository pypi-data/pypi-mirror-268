...
class MonospacedByteRenderer(ghidra.util.table.column.AbstractGColumnRenderer):
    ...
    @overload
    def getFilterString(self, t: List[int], settings: ghidra.docking.settings.Settings) -> unicode: ...
