...
class ReferenceFromBytesTableColumn(ghidra.util.table.field.AbstractReferenceBytesTableColumn):
    """
    ...
    @overload
    def getValue(self, rowObject: ghidra.app.plugin.core.analysis.ReferenceAddressPair, settings: ghidra.docking.settings.Settings, pgm: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> List[int]: ...
