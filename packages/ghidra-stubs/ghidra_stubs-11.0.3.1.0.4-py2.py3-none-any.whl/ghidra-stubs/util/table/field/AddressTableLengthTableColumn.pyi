...
class AddressTableLengthTableColumn(ghidra.util.table.field.ProgramLocationTableColumnExtensionPoint):
    """
    ...
    @overload
    def getValue(self, rowObject: ghidra.app.plugin.core.disassembler.AddressTable, settings: ghidra.docking.settings.Settings, pgm: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> int: ...
