...
class BytesTableColumn(ghidra.util.table.field.ProgramLocationTableColumnExtensionPoint):
    """
    ...
    def getColumnRenderer(self) -> List[ghidra.util.table.column.GColumnRenderer]: ...
    ...
    @overload
    def getProgramLocation(self, rowObject: ghidra.program.model.address.Address, settings: ghidra.docking.settings.Settings, program: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> ghidra.program.util.ProgramLocation: ...
    ...
    @overload
    def getValue(self, rowObject: ghidra.program.model.address.Address, settings: ghidra.docking.settings.Settings, pgm: ghidra.program.model.listing.Program, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> List[int]: ...
