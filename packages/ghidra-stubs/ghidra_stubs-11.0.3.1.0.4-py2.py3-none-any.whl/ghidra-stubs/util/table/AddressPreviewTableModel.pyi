...
class AddressPreviewTableModel(ghidra.util.table.AddressBasedTableModel):
    """
    ...
    @property
    def selectionSize(self) -> None: ...  # No getter available.

    @selectionSize.setter
    def selectionSize(self, value: int) -> None: ...