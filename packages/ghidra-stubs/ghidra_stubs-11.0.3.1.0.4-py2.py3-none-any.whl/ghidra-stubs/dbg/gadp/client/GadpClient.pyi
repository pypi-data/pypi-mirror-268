...
class GadpClient(ghidra.dbg.agent.AbstractDebuggerObjectModel, ghidra.dbg.agent.AbstractTargetObject.ProxyFactory):
    cbLock: object
    lock: object



    def __init__(self, __a0: unicode, __a1: java.nio.channels.AsynchronousByteChannel): ...
    ...
    def connect(self) -> java.util.concurrent.CompletableFuture: ...

    @overload
    def createProxy(self, __a0: ghidra.dbg.agent.AbstractTargetObject, __a1: List[object]) -> ghidra.dbg.agent.SpiTargetObject: ...
