...
class DelegateGadpClientTargetObject(ghidra.dbg.agent.DefaultTargetObject, ghidra.dbg.gadp.client.GadpClientTargetObject):




    def __init__(self, __a0: ghidra.dbg.gadp.client.GadpClient, __a1: ghidra.dbg.gadp.client.GadpClientTargetObject, __a2: unicode, __a3: unicode, __a4: ghidra.dbg.target.schema.TargetObjectSchema, __a5: List[object], __a6: List[object], __a7: List[object]): ...
    ...
    def doInvalidate(self, __a0: ghidra.dbg.target.TargetObject, __a1: unicode) -> None: ...
    ...
    def updateWithDeltas(self, __a0: ghidra.dbg.gadp.protocol.Gadp.ModelObjectDelta, __a1: ghidra.dbg.gadp.protocol.Gadp.ModelObjectDelta) -> None: ...
    ...
    @property
    def proxy(self) -> ghidra.dbg.gadp.client.GadpClientTargetObject: ...