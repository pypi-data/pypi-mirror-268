...
class JdiModelTargetElementsContainer(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl, ghidra.dbg.jdi.manager.JdiEventsListenerAdapter):
    ...
    def addElements(self, __a0: List[object]) -> None: ...
