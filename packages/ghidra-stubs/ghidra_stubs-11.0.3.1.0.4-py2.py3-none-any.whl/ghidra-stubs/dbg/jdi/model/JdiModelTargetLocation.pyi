...
class JdiModelTargetLocation(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl):




    def __init__(self, __a0: ghidra.dbg.jdi.model.iface2.JdiModelTargetObject, __a1: com.sun.jdi.Location, __a2: bool): ...



    def acceptsElement(self, __a0: unicode) -> bool: ...

    def addBreakpoint(self) -> ghidra.dbg.jdi.manager.breakpoint.JdiBreakpointInfo: ...
    ...
    @staticmethod
    def getAddressFromLocation(__a0: ghidra.dbg.jdi.model.JdiModelImpl, __a1: com.sun.jdi.Location) -> ghidra.program.model.address.Address: ...
    ...
    @staticmethod
    def getUniqueId(__a0: com.sun.jdi.Location) -> unicode: ...
