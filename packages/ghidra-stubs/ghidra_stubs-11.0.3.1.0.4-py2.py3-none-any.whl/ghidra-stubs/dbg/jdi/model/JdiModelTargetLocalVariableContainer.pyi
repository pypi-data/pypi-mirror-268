...
class JdiModelTargetLocalVariableContainer(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl):
    ...
    def getTargetVariableIfPresent(self, __a0: unicode) -> ghidra.dbg.jdi.model.JdiModelTargetLocalVariable: ...
