...
class JdiModelTargetSection(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl, ghidra.dbg.target.TargetMemoryRegion, ghidra.dbg.target.TargetSection):




    @overload
    def __init__(self, __a0: ghidra.dbg.jdi.model.JdiModelTargetSectionContainer): ...

    @overload
    def __init__(self, __a0: ghidra.dbg.jdi.model.JdiModelTargetSectionContainer, __a1: com.sun.jdi.Method, __a2: bool): ...
