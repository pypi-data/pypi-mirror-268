...
class JdiModelTargetThread(ghidra.dbg.jdi.model.JdiModelTargetObjectReference, ghidra.dbg.target.TargetThread, ghidra.dbg.jdi.model.iface1.JdiModelTargetAccessConditioned, ghidra.dbg.jdi.model.iface1.JdiModelTargetExecutionStateful, ghidra.dbg.jdi.model.iface1.JdiModelTargetInterruptible, ghidra.dbg.jdi.model.iface1.JdiModelTargetKillable, ghidra.dbg.jdi.model.iface1.JdiModelTargetResumable, ghidra.dbg.jdi.model.iface1.JdiModelTargetSteppable, ghidra.dbg.jdi.manager.JdiEventsListenerAdapter, ghidra.dbg.jdi.model.iface1.JdiModelSelectableObject):




    def __init__(self, __a0: ghidra.dbg.jdi.model.iface2.JdiModelTargetObject, __a1: com.sun.jdi.ThreadReference, __a2: bool): ...
    ...
    def getLocation(self) -> com.sun.jdi.Location: ...
    ...
    def getStack(self) -> ghidra.dbg.jdi.model.JdiModelTargetStack: ...
    ...
    def popFrame(self, __a0: com.sun.jdi.StackFrame) -> java.util.concurrent.CompletableFuture: ...
    ...
    def setLocation(self, __a0: com.sun.jdi.Location) -> None: ...
    ...
    @overload
    def threadStateChanged(self, __a0: ghidra.dbg.target.TargetExecutionStateful.TargetExecutionState) -> None: ...
    ...
    @property
    def location(self) -> com.sun.jdi.Location: ...

    @location.setter
    def location(self, value: com.sun.jdi.Location) -> None: ...

    @property
    def stack(self) -> ghidra.dbg.jdi.model.JdiModelTargetStack: ...