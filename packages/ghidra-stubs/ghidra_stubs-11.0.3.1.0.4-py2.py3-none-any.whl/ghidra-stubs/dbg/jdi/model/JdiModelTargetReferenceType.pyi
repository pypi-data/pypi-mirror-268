...
class JdiModelTargetReferenceType(ghidra.dbg.jdi.model.JdiModelTargetType, ghidra.dbg.target.TargetModule):




    @overload
    def __init__(self, __a0: ghidra.dbg.jdi.model.iface2.JdiModelTargetObject, __a1: com.sun.jdi.ReferenceType, __a2: bool): ...

    @overload
    def __init__(self, __a0: ghidra.dbg.jdi.model.iface2.JdiModelTargetObject, __a1: unicode, __a2: com.sun.jdi.ReferenceType, __a3: bool): ...
    ...
    def getAllMethods(self) -> ghidra.dbg.jdi.model.JdiModelTargetMethodContainer: ...
    ...
    @property
    def allMethods(self) -> ghidra.dbg.jdi.model.JdiModelTargetMethodContainer: ...
