...
class JdiModelTargetTypeContainer(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl):
    ...
    def getTargetTypeIfPresent(self, __a0: unicode) -> ghidra.dbg.jdi.model.JdiModelTargetType: ...
