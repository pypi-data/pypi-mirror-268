...
class JdiModelTargetSectionContainer(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl, ghidra.dbg.target.TargetMemory):




    def __init__(self, __a0: ghidra.dbg.jdi.model.JdiModelTargetReferenceType): ...



    def acceptsElement(self, __a0: unicode) -> bool: ...

    def addSection(self, __a0: com.sun.jdi.Method) -> None: ...
    ...
    def getClassType(self) -> ghidra.dbg.jdi.model.JdiModelTargetReferenceType: ...
    ...
    def getTargetSectionIfPresent(self, __a0: unicode) -> ghidra.dbg.jdi.model.JdiModelTargetSection: ...
    ...
    @property
    def classType(self) -> ghidra.dbg.jdi.model.JdiModelTargetReferenceType: ...