...
class JdiModelTargetStackFrame(ghidra.dbg.jdi.model.JdiModelTargetObjectImpl, ghidra.dbg.target.TargetStackFrame, ghidra.dbg.jdi.manager.JdiEventsListenerAdapter, ghidra.dbg.jdi.model.iface1.JdiModelSelectableObject):
    FROM_ATTRIBUTE_NAME: unicode = u'_from'
    FUNC_ATTRIBUTE_NAME: unicode = u'_function'



    def __init__(self, __a0: ghidra.dbg.jdi.model.JdiModelTargetStack, __a1: ghidra.dbg.jdi.model.JdiModelTargetThread, __a2: int, __a3: com.sun.jdi.StackFrame, __a4: bool): ...
    ...
    @staticmethod
    def getUniqueId(__a0: int) -> unicode: ...
    ...
    def setFrame(self, __a0: int, __a1: com.sun.jdi.StackFrame) -> None: ...

    def setFrameLevel(self, __a0: long) -> None: ...
    ...
    @property
    def frameLevel(self) -> long: ...

    @frameLevel.setter
    def frameLevel(self, value: long) -> None: ...