...
class MarkupItemValueRenderer(ghidra.util.table.column.AbstractGhidraColumnRenderer):
    ...
    @overload
    def getFilterString(self, __a0: ghidra.feature.vt.api.util.Stringable, __a1: ghidra.docking.settings.Settings) -> unicode: ...
