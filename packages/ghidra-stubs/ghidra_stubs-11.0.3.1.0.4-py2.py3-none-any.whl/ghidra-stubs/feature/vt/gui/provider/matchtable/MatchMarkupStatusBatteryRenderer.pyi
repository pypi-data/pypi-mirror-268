...
class MatchMarkupStatusBatteryRenderer(ghidra.util.table.column.AbstractGColumnRenderer):
    ...
    @overload
    def getFilterString(self, __a0: ghidra.feature.vt.api.main.VTMatch, __a1: ghidra.docking.settings.Settings) -> unicode: ...
