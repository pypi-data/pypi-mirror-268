...
class MarkupItemStatusRenderer(ghidra.util.table.column.AbstractGhidraColumnRenderer):
    ...
    @overload
    def getFilterString(self, __a0: ghidra.feature.vt.api.main.VTMarkupItemStatus, __a1: ghidra.docking.settings.Settings) -> unicode: ...
