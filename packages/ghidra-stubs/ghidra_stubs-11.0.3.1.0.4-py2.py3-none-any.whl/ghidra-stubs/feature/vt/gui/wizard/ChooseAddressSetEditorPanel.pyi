...
class ChooseAddressSetEditorPanel(javax.swing.JPanel):





    class AddressSetChoice(java.lang.Enum):
        ENTIRE_PROGRAM: ghidra.feature.vt.gui.wizard.ChooseAddressSetEditorPanel.AddressSetChoice = ENTIRE_PROGRAM
        MANUALLY_DEFINED: ghidra.feature.vt.gui.wizard.ChooseAddressSetEditorPanel.AddressSetChoice = MANUALLY_DEFINED
        SELECTION: ghidra.feature.vt.gui.wizard.ChooseAddressSetEditorPanel.AddressSetChoice = SELECTION
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.feature.vt.gui.wizard.ChooseAddressSetEditorPanel.AddressSetChoice: ...
        ...
        @staticmethod
        def values() -> List[ghidra.feature.vt.gui.wizard.ChooseAddressSetEditorPanel.AddressSetChoice]: ...
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: unicode, __a2: ghidra.program.model.listing.Program, __a3: ghidra.program.model.address.AddressSetView, __a4: ghidra.program.model.address.AddressSetView, __a5: ghidra.feature.vt.gui.wizard.ChooseAddressSetEditorPanel.AddressSetChoice): ...
    ...
    def getAddressSetChoice(self) -> ghidra.feature.vt.gui.wizard.ChooseAddressSetEditorPanel.AddressSetChoice: ...
    ...
    def isUsingSelection(self) -> bool: ...
    ...
    @property
    def addressSetChoice(self) -> ghidra.feature.vt.gui.wizard.ChooseAddressSetEditorPanel.AddressSetChoice: ...

    @property
    def addressSetView(self) -> ghidra.program.model.address.AddressSetView: ...

    @property
    def usingSelection(self) -> bool: ...