...
class ApplyMarkupAtDestinationAddressTask(ghidra.feature.vt.gui.task.VtTask):




    def __init__(self, __a0: ghidra.feature.vt.api.main.VTSession, __a1: List[object], __a2: ghidra.program.model.address.Address, __a3: ghidra.framework.options.ToolOptions): ...
