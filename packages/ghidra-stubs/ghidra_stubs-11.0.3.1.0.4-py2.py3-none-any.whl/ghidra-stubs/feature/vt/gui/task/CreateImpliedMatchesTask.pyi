...
class CreateImpliedMatchesTask(ghidra.feature.vt.gui.task.VtTask):




    def __init__(self, __a0: ghidra.feature.vt.gui.plugin.VTController, __a1: List[object]): ...
    ...
    def getCreatedMatches(self) -> List[object]: ...
    ...
    @property
    def createdMatches(self) -> List[object]: ...