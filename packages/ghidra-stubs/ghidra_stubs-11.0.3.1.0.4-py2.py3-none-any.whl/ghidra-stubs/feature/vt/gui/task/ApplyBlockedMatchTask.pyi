...
class ApplyBlockedMatchTask(ghidra.feature.vt.gui.task.VtTask):




    def __init__(self, __a0: ghidra.feature.vt.gui.plugin.VTController, __a1: ghidra.feature.vt.api.main.VTMatch, __a2: List[object]): ...
