...
class SymbolNameProgramCorrelator(ghidra.feature.vt.api.util.VTAbstractProgramCorrelator):
    ...
    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.address.AddressSetView, __a2: ghidra.program.model.listing.Program, __a3: ghidra.program.model.address.AddressSetView, __a4: ghidra.framework.options.ToolOptions, __a5: unicode, __a6: bool): ...
