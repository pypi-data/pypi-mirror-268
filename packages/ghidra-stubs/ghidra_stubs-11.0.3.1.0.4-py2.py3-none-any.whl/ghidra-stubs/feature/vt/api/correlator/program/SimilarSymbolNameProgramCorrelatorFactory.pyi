...
class SimilarSymbolNameProgramCorrelatorFactory(ghidra.feature.vt.api.util.VTAbstractProgramCorrelatorFactory):
    MEMORY_MODEL: unicode = u'Memory model'
    MEMORY_MODEL_DEFAULT: generic.lsh.LSHMemoryModel = Large (faster)
    MIN_NAME_LENGTH: unicode = u'Minimum name length'
    MIN_NAME_LENGTH_DEFAULT: int = 6
    NAME: unicode = u'Similar Symbol Name Match'
