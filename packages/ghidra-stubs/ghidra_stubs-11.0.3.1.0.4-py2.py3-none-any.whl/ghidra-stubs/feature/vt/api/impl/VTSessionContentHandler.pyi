...
class VTSessionContentHandler(ghidra.framework.data.DBContentHandler):
    ...
    def getDomainObject(self, __a0: ghidra.framework.store.FolderItem, __a1: ghidra.framework.store.FileSystem, __a2: long, __a3: bool, __a4: bool, __a5: object, __a6: ghidra.util.task.TaskMonitor) -> ghidra.feature.vt.api.db.VTSessionDB: ...

    def getDomainObjectClass(self) -> java.lang.Class: ...

    def getIcon(self) -> javax.swing.Icon: ...

    def getImmutableObject(self, __a0: ghidra.framework.store.FolderItem, __a1: object, __a2: int, __a3: int, __a4: ghidra.util.task.TaskMonitor) -> ghidra.feature.vt.api.db.VTSessionDB: ...
