...
class VTOptions(ghidra.framework.options.ToolOptions):
    ...
    @overload
    def registerOption(self, __a0: unicode, __a1: ghidra.framework.options.OptionType, __a2: object, __a3: ghidra.util.HelpLocation, __a4: unicode, __a5: java.util.function.Supplier) -> None: ...
    ...
    @overload
    def registerOptionsEditor(self, __a0: java.util.function.Supplier) -> None: ...

    @overload
    def registerOptionsEditor(self, __a0: unicode, __a1: java.util.function.Supplier) -> None: ...
