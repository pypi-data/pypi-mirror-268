...
class FidSearchDebugDialog(docking.DialogComponentProvider):




    def __init__(self, __a0: ghidra.feature.fid.service.FidService): ...
    ...
    def setDomainPathText(self, __a0: unicode) -> None: ...

    def setFocusComponent(self, __a0: java.awt.Component) -> None: ...

    def setFullHashText(self, __a0: unicode) -> None: ...

    def setFunctionIdText(self, __a0: unicode) -> None: ...
    ...
    def setNameText(self, __a0: unicode) -> None: ...
    ...
    def setSpecificHashText(self, __a0: unicode) -> None: ...
    ...
    @property
    def domainPathText(self) -> None: ...  # No getter available.

    @domainPathText.setter
    def domainPathText(self, value: unicode) -> None: ...

    @property
    def fullHashText(self) -> None: ...  # No getter available.

    @fullHashText.setter
    def fullHashText(self, value: unicode) -> None: ...

    @property
    def functionIdText(self) -> None: ...  # No getter available.

    @functionIdText.setter
    def functionIdText(self, value: unicode) -> None: ...

    @property
    def nameText(self) -> None: ...  # No getter available.

    @nameText.setter
    def nameText(self, value: unicode) -> None: ...

    @property
    def specificHashText(self) -> None: ...  # No getter available.

    @specificHashText.setter
    def specificHashText(self, value: unicode) -> None: ...