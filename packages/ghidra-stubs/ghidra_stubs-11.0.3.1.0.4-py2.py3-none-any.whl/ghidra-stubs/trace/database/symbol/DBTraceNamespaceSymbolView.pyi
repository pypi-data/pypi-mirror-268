...
class DBTraceNamespaceSymbolView(ghidra.trace.database.symbol.AbstractDBTraceSymbolSingleTypeView, ghidra.trace.model.symbol.TraceNamespaceSymbolView):
    ...
    def add(self, __a0: unicode, __a1: ghidra.trace.model.symbol.TraceNamespaceSymbol, __a2: ghidra.program.model.symbol.SourceType) -> ghidra.trace.database.symbol.DBTraceNamespaceSymbol: ...
