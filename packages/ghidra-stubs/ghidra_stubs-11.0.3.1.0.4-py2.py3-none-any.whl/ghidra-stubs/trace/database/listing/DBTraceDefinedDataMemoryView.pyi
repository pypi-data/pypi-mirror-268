...
class DBTraceDefinedDataMemoryView(ghidra.trace.database.listing.AbstractBaseDBTraceCodeUnitsMemoryView, ghidra.trace.database.listing.InternalTraceDefinedDataView):
    ...
    @overload
    def create(self, __a0: ghidra.trace.model.Lifespan, __a1: ghidra.program.model.address.Address, __a2: ghidra.program.model.data.DataType) -> ghidra.trace.database.listing.DBTraceDataAdapter: ...
