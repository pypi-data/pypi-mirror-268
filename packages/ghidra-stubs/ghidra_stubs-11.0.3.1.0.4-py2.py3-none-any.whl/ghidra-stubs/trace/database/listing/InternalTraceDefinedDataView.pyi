...
class InternalTraceDefinedDataView(ghidra.trace.model.listing.TraceDefinedDataView, ghidra.trace.database.listing.InternalTraceBaseDefinedUnitsView, object):
    ...
    @overload
    def create(self, __a0: ghidra.trace.model.Lifespan, __a1: ghidra.program.model.address.Address, __a2: ghidra.program.model.data.DataType, __a3: int) -> ghidra.trace.model.listing.TraceData: ...
