...
class PatchStep(object, ghidra.trace.model.time.schedule.Step):




    def __init__(self, __a0: long, __a1: unicode): ...
    ...
    @staticmethod
    def generateSleigh(__a0: ghidra.program.model.lang.Language, __a1: ghidra.program.model.address.Address, __a2: List[int]) -> List[object]: ...

    @overload
    @staticmethod
    def generateSleighLine(__a0: ghidra.program.model.lang.Language, __a1: ghidra.program.model.address.Address, __a2: List[int]) -> unicode: ...

    @overload
    @staticmethod
    def generateSleighLine(__a0: ghidra.program.model.lang.Language, __a1: ghidra.program.model.address.Address, __a2: List[int], __a3: int) -> unicode: ...
    ...
    @staticmethod
    def parse(__a0: long, __a1: unicode) -> ghidra.trace.model.time.schedule.PatchStep: ...
