...
def main():
    ...
    if args.version:
        ...
        Cellist(platform = platform, resolution = resolution, props_file = props_file, nucleus_count_h5_file = nucleus_count_h5_file, 
            watershed_coord_file = watershed_coord_file, all_spot_count_h5_file = all_spot_count_h5_file, 
        ...
        min_distance = min_distance, no_local_threshold = no_local_threshold)
