...
class SCIMApi(object):
    ...
    def generate_token(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.generate_token(datasource_class=datasource_class_value, datasource_id=datasource_id_value, callback=callback_function)
    ...
    def generate_token_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.generate_token_with_http_info(datasource_class=datasource_class_value, datasource_id=datasource_id_value, callback=callback_function)
