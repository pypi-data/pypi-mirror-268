...
class GetTestResultFileList200ResponseFilesInner(BaseModel):
    """
    GetTestResultFileList200ResponseFilesInner
    """ # noqa: E501
    file_name: Optional[StrictStr] = None
    file_size: Optional[StrictInt] = None
    file_date: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["file_name", "file_size", "file_date"]
