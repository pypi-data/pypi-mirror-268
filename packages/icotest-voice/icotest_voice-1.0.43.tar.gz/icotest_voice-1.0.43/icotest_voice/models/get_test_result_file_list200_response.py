...
class GetTestResultFileList200Response(BaseModel):
    """
    GetTestResultFileList200Response
    """ # noqa: E501
    files: Optional[List[GetTestResultFileList200ResponseFilesInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "files": [GetTestResultFileList200ResponseFilesInner.from_dict(_item) for _item in obj.get("files")] if obj.get("files") is not None else None
        })
        return _obj
