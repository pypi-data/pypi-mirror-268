...
class TestBOA(TestCase):
    ...
    def test_constructor(self):
        n_variables = 3
        eda = BOA(size_gen=300, max_iter=100, dead_iter=20, n_variables=n_variables, alpha=0.5,
    ...
    def test_new_generation(self):
        n_variables = 3
        eda = BOA(size_gen=20, max_iter=10, dead_iter=10, n_variables=n_variables, alpha=0.5,
                  possible_values=self.possible_values, frequency=self.frequency)
    ...
    def test_data_init(self):
        ...
        n_variables = 3
        eda = BOA(size_gen=20, max_iter=1, dead_iter=1, n_variables=n_variables, alpha=0.5,
