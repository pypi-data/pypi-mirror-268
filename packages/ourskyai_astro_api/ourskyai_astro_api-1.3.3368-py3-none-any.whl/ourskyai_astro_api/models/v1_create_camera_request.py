...
class V1CreateCameraRequest(BaseModel):
    ...
    __properties = ["model", "pixelSizeMicrons", "fullWellCapacity", "pixelsX", "pixelsY", "megapixels", "chilled", "shutterType", "gpsTimestamps", "sensorXmm", "sensorYmm", "unityGain", "optimalNighttimeGain", "optimalNighttimeGainOffset", "optimalNighttimeGainMode", "supportsVideoMode", "adcBitDepth", "quantumEfficiency", "gainCurves", "setupActions", "isColor", "videoModeFramerateProperties"]
