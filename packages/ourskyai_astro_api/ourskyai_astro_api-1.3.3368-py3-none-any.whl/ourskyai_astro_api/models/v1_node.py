...
class V1Node(BaseModel):
    ...
    id: StrictStr = Field(...)
    __properties = ["name", "observatoryId", "organizationId", "cameraId", "opticalTubeId", "mountId", "filterWheelId", "minAltitude", "elevationMask", "slewTiming", "createdAt", "updatedAt", "state", "id"]
