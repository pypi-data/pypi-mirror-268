...
class IdfAnnotation():
    def __init__(self, name, value):
        ...
        if isinstance(value, str):
            ...
            #   "pattern": "^(readwrite|readonly|writeonly|deprecated|private|emits_changes|emits_invalidates|refval|refobj)(,(readwrite|readonly|writeonly|deprecated|private|emits_changes|emits_invalidates|refobj|refval))*$"
ANNOTATION_MAP = {
