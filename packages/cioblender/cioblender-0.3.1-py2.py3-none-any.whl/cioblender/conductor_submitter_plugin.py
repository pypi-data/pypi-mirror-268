...
class AdditionalRenderingOptionsPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(scene, "update_camera")
        layout.prop(scene, "render_layers")
...
def create_raw_data():
    ...
    kwargs = {
        ...
        "update_camera": scene.update_camera,
        "render_layers": scene.render_layers,
...
def register():
    ...
    bpy.types.Scene.update_camera = bpy.props.BoolProperty(
    ...
    bpy.types.Scene.render_layers = bpy.props.BoolProperty(
        name="Render all active render layers",
        description="Render all active render layers",
        default=False
    )
...
def unregister():
    try:
        ...
        props_to_remove = [
            ...
            'submission_tab', 'disable_audio', 'update_camera', 'render_layers',
