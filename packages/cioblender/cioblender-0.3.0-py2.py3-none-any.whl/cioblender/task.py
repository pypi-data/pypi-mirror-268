...
def get_task_template(**kwargs):
    ...
    camera = f'"{camera}"'
    update_camera = kwargs.get("update_camera", False)
    render_layers = kwargs.get("render_layers", False)
    ...
    if update_camera:
        extra_args += " --update_camera=True"
    else:
        extra_args += " --update_camera=False"
    if render_layers:
        extra_args += " --render_layers=True"
    else:
        extra_args += " --render_layers=False"
