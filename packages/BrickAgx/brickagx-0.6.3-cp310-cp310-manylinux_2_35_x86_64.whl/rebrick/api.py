...
class BrickToAgxMapper(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(BrickToAgxMapper self, Simulation simulation, std::string const & source_id, std::shared_ptr< BrickAgx::AgxCache > agx_cache=0, std::string const & debug_tnc_path="", std::shared_ptr< Brick::ErrorReporter > error_reporter=std::make_shared< Brick::ErrorReporter >()) -> BrickToAgxMapper
...
class EnsureUniqueId(object):
    ...
    def ensureUniqueId(self, name, uuid, names):
        r"""
        ensureUniqueId(EnsureUniqueId self, std::string const & name, Uuid uuid, std::unordered_set< std::string > & names) -> std::string
        ...
        """
        return _BrickAgxPyApi.EnsureUniqueId_ensureUniqueId(self, name, uuid, names)
...
class AgxToBrickMapper(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(AgxToBrickMapper self, Simulation simulation, BrickAgx::AgxToBrickTrimeshMode trimesh_mode, uint32_t precision=6, bool discard_rigid_body_positions=False, bool regenerate_shape_uuids=False) -> AgxToBrickMapper
...
class Signals(object):
    ...
    def sendInputSignal(signal):
        r"""
        sendInputSignal(std::shared_ptr< Brick::Physics::Signals::InputSignal > signal) -> bool

        Parameters
        ----------
        signal: std::shared_ptr< Brick::Physics::Signals::InputSignal >
    ...
    def sendOutputSignal(signal):
        r"""
        sendOutputSignal(std::shared_ptr< Brick::Physics::Signals::OutputSignal > signal) -> bool

        Parameters
        ----------
        signal: std::shared_ptr< Brick::Physics::Signals::OutputSignal >
...
def Signals_sendInputSignal(signal):
    r"""
    Signals_sendInputSignal(std::shared_ptr< Brick::Physics::Signals::InputSignal > signal) -> bool
...
def Signals_sendOutputSignal(signal):
    r"""
    Signals_sendOutputSignal(std::shared_ptr< Brick::Physics::Signals::OutputSignal > signal) -> bool
...
class OutputSignalListener(agxSDK.StepEventListener):
    ...
    def __init__(self, assembly, brick_scene):
        r"""
        __init__(OutputSignalListener self, AssemblyRef assembly, std::shared_ptr< Brick::Core::Object > const & brick_scene) -> OutputSignalListener
...
class ClickInputListener(object):
    ...
    def preFrame(self, arg2):
        r"""
        preFrame(ClickInputListener self, agx::TimeStamp const & arg2)
...
class ClickKeyboardEventListener(agxSDK.GuiEventListener):
    ...
    def __init__(self, click_input_listener, app, click_adapter):
        r"""
        __init__(ClickKeyboardEventListener self, OsgClickInputListener click_input_listener, agxOSG::ExampleApplication * app, ClickAdapter click_adapter) -> ClickKeyboardEventListener

        Parameters
        ----------
        click_input_listener: BrickAgx::OsgClickInputListener *
        app: agxOSG::ExampleApplication *
        click_adapter: BrickAgx::ClickAdapter *
...
class ClickAdapter(object):
    ...
    def add_listeners(self, app, simulation, click_server_addr, brick_scene, output_signal_listener):
        r"""
        add_listeners(ClickAdapter self, agxOSG::ExampleApplication * app, Simulation simulation, std::string const & click_server_addr, std::shared_ptr< Brick::Core::Object > const & brick_scene, OutputSignalListener output_signal_listener)
        ...
        """
        return _BrickAgxPyApi.ClickAdapter_add_listeners(self, app, simulation, click_server_addr, brick_scene, output_signal_listener)

    def sendResetMessage(self):
        r"""sendResetMessage(ClickAdapter self)"""
        return _BrickAgxPyApi.ClickAdapter_sendResetMessage(self)

    def willSendResetMessage(self):
        r"""willSendResetMessage(ClickAdapter self) -> bool"""
        return _BrickAgxPyApi.ClickAdapter_willSendResetMessage(self)

    def __init__(self):
        r"""__init__(ClickAdapter self) -> ClickAdapter"""
        _BrickAgxPyApi.ClickAdapter_swiginit(self, _BrickAgxPyApi.new_ClickAdapter())
    __swig_destroy__ = _BrickAgxPyApi.delete_ClickAdapter

# Register ClickAdapter in _BrickAgxPyApi:
_BrickAgxPyApi.ClickAdapter_swigregister(ClickAdapter)
...
class Result(object):
    ...
    def __init__(self, assembly, brick_object, errors, brick_to_agx_mapper):
        r"""
        __init__(Result self, Assembly assembly, std::shared_ptr< Brick::Core::Object > brick_object, Brick::Errors errors, std::shared_ptr< BrickAgx::BrickToAgxMapper > brick_to_agx_mapper) -> Result
    ...
    def errors(self):
        r"""errors(Result self) -> Brick::Errors"""
...
def load_brick_string(*args):
    r"""
    load_brick_string(Simulation simulation, std::string const & source, std::string const & bundle_paths, std::string const & modelname="", std::string const & debug_tnc_path="") -> Result
...
def validate_brickfile(*args):
    r"""
    validate_brickfile(Simulation simulation, std::string const & brick_file, std::string const & bundle_paths, std::string const & modelname="", std::string const & debug_tnc_path="") -> bool
    ...
    """
    return _BrickAgxPyApi.validate_brickfile(*args)
...
def register_plugins(brick_ctx):
    r"""
    register_plugins(BrickContext brick_ctx)
    ...
    """
    return _BrickAgxPyApi.register_plugins(brick_ctx)
...
def addVisuals(result, osg_root):
    r"""
    addVisuals(Result result, osg::Group * osg_root) -> bool
    ...
    """
    return _BrickAgxPyApi.addVisuals(result, osg_root)
