...
class AdditionalS3DataSourceDataType(str):
    S3Object = "S3Object"
    S3Prefix = "S3Prefix"


class AggregationTransformationValue(str):
    sum = "sum"
    avg = "avg"
    first = "first"
    min = "min"
...
class AsyncNotificationTopicTypes(str):
...
class AutoMLProblemTypeConfigName(str):
...
class AutoMLProcessingUnit(str):
    CPU = "CPU"
    GPU = "GPU"
...
class AwsManagedHumanLoopRequestSource(str):
    ...
    AWS_Textract_AnalyzeExpense = "AWS/Textract/AnalyzeExpense"
    AWS_Handshake_VerifyIdentity = "AWS/Handshake/VerifyIdentity"
    AWS_Bedrock_ModelEvaluation = "AWS/Bedrock/ModelEvaluation"
...
class ClusterInstanceStatus(str):
    Running = "Running"
    Failure = "Failure"
    Pending = "Pending"
...
class CompleteOnConvergence(str):
    Disabled = "Disabled"
    Enabled = "Enabled"
...
class CrossAccountFilterOption(str):
...
class InferenceComponentSortKey(str):
    Name = "Name"
    CreationTime = "CreationTime"
    Status = "Status"


class InferenceComponentStatus(str):
    InService = "InService"
    Creating = "Creating"
    Updating = "Updating"
    Failed = "Failed"
...
class ManagedInstanceScalingStatus(str):
    ENABLED = "ENABLED"
    DISABLED = "DISABLED"
...
class ModelCompressionType(str):
    None_ = "None"
    Gzip = "Gzip"
...
class OutputCompressionType(str):
    GZIP = "GZIP"
    NONE = "NONE"
...
class RecommendationJobSupportedEndpointType(str):
    RealTime = "RealTime"
...
class ResourceCatalogSortBy(str):
    CreationTime = "CreationTime"


class ResourceCatalogSortOrder(str):
    Ascending = "Ascending"
    Descending = "Descending"
...
class SharingType(str):
    Private = "Private"
    Shared = "Shared"


class SkipModelValidation(str):
    All = "All"
    None_ = "None"
...
class SagemakerApi:
    ...
    @handler("DeleteHub")
    def delete_hub(self, context: RequestContext, hub_name: HubName, **kwargs) -> None:
        """Delete a hub.
    ...
    def describe_cluster_node(
        ...
        **kwargs,
        ...
        :param node_id: The ID of the instance.
    ...
    @handler("DescribeHub")
    def describe_hub(
        self, context: RequestContext, hub_name: HubName, **kwargs
    ) -> DescribeHubResponse:
        """Describe a hub.
