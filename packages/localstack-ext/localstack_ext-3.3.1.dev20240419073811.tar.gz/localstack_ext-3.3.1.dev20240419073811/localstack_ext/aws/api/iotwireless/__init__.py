...
class AggregationPeriod(str):
    OneHour = "OneHour"
    OneDay = "OneDay"
    OneWeek = "OneWeek"


class ApplicationConfigType(str):
...
class MetricQueryStatus(str):
    Succeeded = "Succeeded"
    Failed = "Failed"


class MulticastFrameInfo(str):
    ENABLED = "ENABLED"
    DISABLED = "DISABLED"


class OnboardStatus(str):
    INITIALIZED = "INITIALIZED"
    PENDING = "PENDING"
    ONBOARDED = "ONBOARDED"
    FAILED = "FAILED"
...
class PositionConfigurationFec(str):
    ROSE = "ROSE"
    NONE = "NONE"


class PositionConfigurationStatus(str):
    Enabled = "Enabled"
    Disabled = "Disabled"


class PositionResourceType(str):
    WirelessDevice = "WirelessDevice"
    WirelessGateway = "WirelessGateway"


class PositionSolverProvider(str):
    Semtech = "Semtech"


class PositionSolverType(str):
    GNSS = "GNSS"


class PositioningConfigStatus(str):
    Enabled = "Enabled"
    Disabled = "Disabled"
...
class SummaryMetricConfigurationStatus(str):
    Enabled = "Enabled"
    Disabled = "Disabled"
...
class WirelessDeviceSidewalkStatus(str):
    PROVISIONED = "PROVISIONED"
...
class IotwirelessApi:
    ...
    def get_metrics(
        ...
        :param summary_metric_queries: The list of queries to retrieve summary metrics.
