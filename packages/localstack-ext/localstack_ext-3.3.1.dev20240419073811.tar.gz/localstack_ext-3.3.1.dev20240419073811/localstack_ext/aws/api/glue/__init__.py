...
class AdditionalOptionKeys(str):
...
class ColumnStatisticsState(str):
    STARTING = "STARTING"
    RUNNING = "RUNNING"
    SUCCEEDED = "SUCCEEDED"
    FAILED = "FAILED"
...
class CsvSerdeOption(str):
    OpenCSVSerDe = "OpenCSVSerDe"
    LazySimpleSerDe = "LazySimpleSerDe"
    None_ = "None"


class DQStopJobOnFailureTiming(str):
    Immediate = "Immediate"
    AfterDataLoad = "AfterDataLoad"


class DQTransformOutput(str):
...
class DataQualityRuleResultStatus(str):
    PASS = "PASS"
    FAIL = "FAIL"
    ERROR = "ERROR"
...
class DeltaTargetCompressionType(str):
...
class FederationSourceErrorCode(str):
...
class HudiTargetCompressionType(str):
    gzip = "gzip"
    lzo = "lzo"
    uncompressed = "uncompressed"
    snappy = "snappy"
...
class SourceControlAuthStrategy(str):
    PERSONAL_ACCESS_TOKEN = "PERSONAL_ACCESS_TOKEN"
    AWS_SECRETS_MANAGER = "AWS_SECRETS_MANAGER"


class SourceControlProvider(str):
    GITHUB = "GITHUB"
    GITLAB = "GITLAB"
    BITBUCKET = "BITBUCKET"
...
class TableOptimizerEventType(str):
    starting = "starting"
    completed = "completed"
    failed = "failed"
