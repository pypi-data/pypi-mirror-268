...
CONNECTION_SOURCE_FIELDS = {
    ...
    "Trino": [
        ["host", "Desired Trino host."],
        ["port", "Trino port to connect on (e.g. 8080)"],
        ["user", "Username to connect to"],
        ["password", "Password for authentication of user"],
        ["database", "Catalog in Trino to connect to (default lakehouse_hive)"],
        ["schema", "Schema in Trino to connect to (default information_schema)"],
    ],
    "Redshift": [
