...
class ElengthCls:
	...
	def set(self, evaluation_length_chips: int, skip_ph: bool = None) -> None:
		...
		Snippet: driver.configure.isignal.dsss.elength.set(evaluation_length_chips = 1, skip_ph = False) \n
		Specifies the evaluation length of the burst for DSSS signals. \n
			:param evaluation_length_chips: numeric Number of payload chips Range: 1000 chips to 270000 chips, Unit: chip
			:param skip_ph: OFF | ON OFF: measure also preamble and header ON: skip preamble and header
		"""
	...
	def get(self) -> ElengthStruct:
		"""SCPI: CONFigure:WLAN:MEASurement<Instance>:ISIGnal:DSSS:ELENgth \n
		Snippet: value: ElengthStruct = driver.configure.isignal.dsss.elength.get() \n
		Specifies the evaluation length of the burst for DSSS signals. \n
