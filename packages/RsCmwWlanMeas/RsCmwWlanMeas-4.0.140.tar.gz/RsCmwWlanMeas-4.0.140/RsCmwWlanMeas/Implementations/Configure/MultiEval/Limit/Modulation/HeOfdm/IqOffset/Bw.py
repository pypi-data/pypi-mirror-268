...
class BwCls:
	...
	def set(self, offset_value_rel: float or bool, offset_value_abs: float or bool = None, bandwidthE=repcap.BandwidthE.Default) -> None:
		"""SCPI: CONFigure:WLAN:MEASurement<Instance>:MEValuation:LIMit:MODulation:HEOFdm:IQOFfset:BW<BW> \n
		Snippet: driver.configure.multiEval.limit.modulation.heOfdm.iqOffset.bw.set(offset_value_rel = 1.0, offset_value_abs = 1.0, bandwidthE = repcap.BandwidthE.Default) \n
		Defines and activates upper limits for the I/Q origin offset for 802.11ax and channel bandwidth <BW>. \n
			:param offset_value_rel: (float or boolean) numeric | ON | OFF Relative limit Range: -100 dB to 0 dB, Unit: dB Additional parameters: OFF | ON (disables | enables the limit check)
			:param offset_value_abs: (float or boolean) numeric | ON | OFF Absolute limit Range: -100 dBm to 0 dBm, Unit: dBm Additional parameters: OFF | ON (disables | enables the limit check)
		...
		self._core.io.write(f'CONFigure:WLAN:MEASurement<Instance>:MEValuation:LIMit:MODulation:HEOFdm:IQOFfset:BW{bandwidthE_cmd_val} {param}'.rstrip())
	...
	class BwStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Offset_Value_Abs: float or bool: numeric | ON | OFF Absolute limit Range: -100 dBm to 0 dBm, Unit: dBm Additional parameters: OFF | ON (disables | enables the limit check)"""
		__meta_args_list = [
