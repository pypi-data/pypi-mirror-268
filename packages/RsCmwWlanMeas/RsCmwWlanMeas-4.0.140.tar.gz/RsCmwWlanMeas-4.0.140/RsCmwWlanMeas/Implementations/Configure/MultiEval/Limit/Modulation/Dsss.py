...
class DsssCls:
	...
	def get_evm_ems(self) -> float or bool:
		...
		scheme DSSS) . \n
			:return: evm_rms: (float or boolean) numeric | ON | OFF Range: 0 % to 100 % Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def set_evm_ems(self, evm_rms: float or bool) -> None:
		...
		Defines and activates upper limits for the error vector magnitude (EVM) RMS values of the data carriers (transmission
		scheme DSSS) . \n
			:param evm_rms: (float or boolean) numeric | ON | OFF Range: 0 % to 100 % Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def get_evm_peak(self) -> float or bool:
		...
		scheme DSSS) . \n
			:return: evm_peak: (float or boolean) numeric | ON | OFF Range: 0 % to 100 % Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def set_evm_peak(self, evm_peak: float or bool) -> None:
		...
		Defines and activates upper limits for the error vector magnitude (EVM) peak values of the data carriers (transmission
		scheme DSSS) . \n
			:param evm_peak: (float or boolean) numeric | ON | OFF Range: 0 % to 100 % Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def get_iq_offset(self) -> float or bool:
		...
		Defines and activates an upper limit for the I/Q origin offset (transmission scheme DSSS) . \n
			:return: iq_offset: (float or boolean) numeric | ON | OFF Range: -100 dB to 0 dB, Unit: dB Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def set_iq_offset(self, iq_offset: float or bool) -> None:
		...
		Defines and activates an upper limit for the I/Q origin offset (transmission scheme DSSS) . \n
			:param iq_offset: (float or boolean) numeric | ON | OFF Range: -100 dB to 0 dB, Unit: dB Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def get_cf_error(self) -> float or bool:
		...
		Defines and activates an upper limit for the center frequency error (transmission scheme DSSS) . \n
			:return: freq_error: (float or boolean) numeric | ON | OFF Range: 0 Hz to 100 MHz, Unit: Hz Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def set_cf_error(self, freq_error: float or bool) -> None:
		...
		Defines and activates an upper limit for the center frequency error (transmission scheme DSSS) . \n
			:param freq_error: (float or boolean) numeric | ON | OFF Range: 0 Hz to 100 MHz, Unit: Hz Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def get_cc_error(self) -> float or bool:
		...
		Defines and activates an upper limit for the chip clock error (transmission scheme DSSS) . \n
			:return: clock_error: (float or boolean) numeric | ON | OFF Range: 0 ppm to 100 ppm, Unit: ppm Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def set_cc_error(self, clock_error: float or bool) -> None:
		...
		Defines and activates an upper limit for the chip clock error (transmission scheme DSSS) . \n
			:param clock_error: (float or boolean) numeric | ON | OFF Range: 0 ppm to 100 ppm, Unit: ppm Additional parameters: OFF | ON (disables | enables the limit check)
		"""
