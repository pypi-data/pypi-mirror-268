...
class BandwidthCls:
	...
	def set(self, bandwidth: enums.Bandwidth, segmentB=repcap.SegmentB.Default) -> None:
		...
		Snippet: driver.configure.multiEval.listPy.segment.bandwidth.set(bandwidth = enums.Bandwidth.BW05mhz, segmentB = repcap.SegmentB.Default) \n
		Specifies the channel bandwidth for segment <no> in list mode. \n
			:param bandwidth: BW05mhz | BW10mhz | BW20mhz | BW40mhz | BW80mhz | BW88mhz | BW16mhz BW05mhz: 5 MHz BW10mhz: 10 MHz BW20mhz: 20 MHz BW40mhz: 40 MHz BW80mhz: 80 MHz BW88mhz: 80+80 MHz BW16mhz: 160 MHz
	...
	def get(self, segmentB=repcap.SegmentB.Default) -> enums.Bandwidth:
		...
		Specifies the channel bandwidth for segment <no> in list mode. \n
			:param segmentB: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Segment')
			:return: bandwidth: BW05mhz | BW10mhz | BW20mhz | BW40mhz | BW80mhz | BW88mhz | BW16mhz BW05mhz: 5 MHz BW10mhz: 10 MHz BW20mhz: 20 MHz BW40mhz: 40 MHz BW80mhz: 80 MHz BW88mhz: 80+80 MHz BW16mhz: 160 MHz"""
		segmentB_cmd_val = self._cmd_group.get_repcap_cmd_value(segmentB, repcap.SegmentB)
