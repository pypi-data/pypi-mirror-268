...
class SaloneCls:
	...
	def set(self, rx_connector: enums.RxConnector, rx_converter: enums.RxConverter) -> None:
		"""SCPI: ROUTe:WLAN:MEASurement<Instance>:SCENario:SALone \n
		Snippet: driver.route.scenario.salone.set(rx_connector = enums.RxConnector.I11I, rx_converter = enums.RxConverter.IRX1) \n
		...
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle('rx_connector', rx_connector, DataType.Enum, enums.RxConnector), ArgSingle('rx_converter', rx_converter, DataType.Enum, enums.RxConverter))
