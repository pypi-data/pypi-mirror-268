...
class ChannelCls:
	"""Channel commands group definition. 14 total commands, 2 Subgroups, 0 group commands
	...
	def cfield(self):
		...
		if not hasattr(self, '_cfield'):
			from .Cfield import CfieldCls
			self._cfield = CfieldCls(self._core, self._cmd_group)
		return self._cfield
	...
	def ufield(self):
		...
		if not hasattr(self, '_ufield'):
			from .Ufield import UfieldCls
			self._ufield = UfieldCls(self._core, self._cmd_group)
		return self._ufield
