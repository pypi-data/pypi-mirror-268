...
class StbCodingCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("stbCoding", core, parent)
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.multiEval.sinfo.htsig.stbCoding.fetch() \n
		Queries the value of STBC field signaled in high throughput signal field for 802.11n signal (HT-SIG) . \n
			:return: structure: for return value, see the help for FetchStruct structure arguments."""
		return self._core.io.query_struct(f'FETCh:WLAN:MEASurement<Instance>:MEValuation:SINFo:HTSig:STBCoding?', self.__class__.FetchStruct())
