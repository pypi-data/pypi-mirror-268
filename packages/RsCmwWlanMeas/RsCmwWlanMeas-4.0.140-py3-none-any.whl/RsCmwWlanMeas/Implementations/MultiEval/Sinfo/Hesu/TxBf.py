...
class TxBfCls:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.multiEval.sinfo.hesu.txBf.fetch() \n
		Queries the value of TxBF field signaled in HE signal field for single user MIMO (HE-SIG-A) . \n
			:return: structure: for return value, see the help for FetchStruct structure arguments."""
		return self._core.io.query_struct(f'FETCh:WLAN:MEASurement<Instance>:MEValuation:SINFo:HESU:TXBF?', self.__class__.FetchStruct())
