...
class EvmPilotCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("evmPilot", core, parent)
	...
	def get_tb_high(self) -> float or bool:
		...
		Sets EVM limits for a pilot subcarrier in 802.11ax trigger-based signals, when transmit power is larger than the maximum
		power of MCS 7. \n
			:return: evm_pilot: (float or boolean) numeric | ON | OFF Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def set_tb_high(self, evm_pilot: float or bool) -> None:
		...
		Sets EVM limits for a pilot subcarrier in 802.11ax trigger-based signals, when transmit power is larger than the maximum
		power of MCS 7. \n
			:param evm_pilot: (float or boolean) numeric | ON | OFF Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def get_tb_low(self) -> float or bool:
		...
		Sets EVM limits for a pilot subcarrier in 802.11ax trigger-based signals, when transmit power is less than or equal to
		the maximum power of MCS 7. \n
			:return: evm_pilot: (float or boolean) numeric | ON | OFF Range: -100 dB to 0 dB Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def set_tb_low(self, evm_pilot: float or bool) -> None:
		...
		Sets EVM limits for a pilot subcarrier in 802.11ax trigger-based signals, when transmit power is less than or equal to
		the maximum power of MCS 7. \n
			:param evm_pilot: (float or boolean) numeric | ON | OFF Range: -100 dB to 0 dB Additional parameters: OFF | ON (disables | enables the limit check)
		"""
		param = Conversions.decimal_or_bool_value_to_str(evm_pilot)
	...
	def get_value(self) -> float or bool:
		...
		Defines and activates an upper limit for the error vector magnitude (EVM) of the pilot carriers in 802.11ax signals. \n
			:return: evm_pilot: (float or boolean) numeric | ON | OFF Range: -100 dB to 0 dB, Unit: dB Additional parameters: OFF | ON (disables | enables the limit check)
		"""
	...
	def set_value(self, evm_pilot: float or bool) -> None:
		...
		Defines and activates an upper limit for the error vector magnitude (EVM) of the pilot carriers in 802.11ax signals. \n
			:param evm_pilot: (float or boolean) numeric | ON | OFF Range: -100 dB to 0 dB, Unit: dB Additional parameters: OFF | ON (disables | enables the limit check)
		"""
		param = Conversions.decimal_or_bool_value_to_str(evm_pilot)
