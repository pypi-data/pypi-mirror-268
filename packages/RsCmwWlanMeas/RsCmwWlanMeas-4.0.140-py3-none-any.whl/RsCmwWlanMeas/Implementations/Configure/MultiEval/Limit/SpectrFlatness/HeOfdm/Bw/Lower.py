...
class LowerCls:
	...
	def set(self, center: float, side: float, bandwidthD=repcap.BandwidthD.Default) -> None:
		...
		Snippet: driver.configure.multiEval.limit.spectrFlatness.heOfdm.bw.lower.set(center = 1.0, side = 1.0, bandwidthD = repcap.BandwidthD.Default) \n
		...
		11ax signals with the specified <bandwidth>. The lower limits must be smaller than the upper limit. \n
			:param center: numeric Range: -20 dB to 4 dB, Unit: dB
			:param side: numeric Range: -20 dB to 4 dB, Unit: dB
