...
class S3API:
    ...
    def upload_file(self, path, object_key, acl = 'private'):
        return self.s3.upload_file_path(self.bucket_name, path, object_key, acl)
    ...
    def create_presigned_url_put_object(self, object_key, content_type, acl='private', expiration=3600):
        """
