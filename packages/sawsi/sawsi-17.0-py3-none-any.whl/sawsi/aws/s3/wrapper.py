...
class S3:
    ...
    def upload_file_path(self, bucket_name, upload_path, object_key, acl="public-read"):
        self.client.upload_file(upload_path, bucket_name, object_key, ExtraArgs={'ACL': acl})
