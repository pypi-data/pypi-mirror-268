...
class ExtremeCls:
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.nrSubMeas.srs.modulation.extreme.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:NRSub:MEASurement<Instance>:SRS:MODulation:EXTReme?', self.__class__.ResultData())

	def fetch(self) -> ResultData:
		"""SCPI: FETCh:NRSub:MEASurement<Instance>:SRS:MODulation:EXTReme \n
		Snippet: value: ResultData = driver.nrSubMeas.srs.modulation.extreme.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:NRSub:MEASurement<Instance>:SRS:MODulation:EXTReme?', self.__class__.ResultData())
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Tx_Power_Minimum: float or bool: No parameter help available
			- Tx_Power_Maximum: float or bool: No parameter help available
			- Peak_Power_Min: float or bool: No parameter help available
			- Peak_Power_Max: float or bool: No parameter help available"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
			ArgStruct.scalar_int('Out_Of_Tolerance'),
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.nrSubMeas.srs.modulation.extreme.calculate() \n
		No command help available \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:NRSub:MEASurement<Instance>:SRS:MODulation:EXTReme?', self.__class__.CalculateStruct())
