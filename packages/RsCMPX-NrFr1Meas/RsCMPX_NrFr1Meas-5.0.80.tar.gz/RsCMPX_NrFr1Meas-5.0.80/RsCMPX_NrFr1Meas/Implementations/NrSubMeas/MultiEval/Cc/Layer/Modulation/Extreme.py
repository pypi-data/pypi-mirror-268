...
class ExtremeCls:
	...
	class ResultData(StructBase):
		"""Response structure. Fields: \n
			...
			- Ant_1_Pow_Min: float: Minimum power at antenna 1
			- Ant_1_Pow_Max: float: Maximum power at antenna 1
			- Ant_2_Pow_Min: float: Minimum power at antenna 2
			- Ant_2_Pow_Max: float: Maximum power at antenna 2"""
		__meta_args_list = [
	...
	def read(self, carrierComponent=repcap.CarrierComponent.Default, layer=repcap.Layer.Default) -> ResultData:
		"""SCPI: READ:NRSub:MEASurement<Instance>:MEValuation[:CC<no>][:LAYer<layer>]:MODulation:EXTReme \n
	...
	def fetch(self, carrierComponent=repcap.CarrierComponent.Default, layer=repcap.Layer.Default) -> ResultData:
		"""SCPI: FETCh:NRSub:MEASurement<Instance>:MEValuation[:CC<no>][:LAYer<layer>]:MODulation:EXTReme \n
	...
	def calculate(self, carrierComponent=repcap.CarrierComponent.Default, layer=repcap.Layer.Default) -> CalculateStruct:
		"""SCPI: CALCulate:NRSub:MEASurement<Instance>:MEValuation[:CC<no>][:LAYer<layer>]:MODulation:EXTReme \n
