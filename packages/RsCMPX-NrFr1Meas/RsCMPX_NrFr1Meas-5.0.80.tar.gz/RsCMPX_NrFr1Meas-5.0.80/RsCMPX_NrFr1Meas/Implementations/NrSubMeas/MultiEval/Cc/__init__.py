...
class CcCls:
	"""Cc commands group definition. 78 total commands, 2 Subgroups, 0 group commands
	...
	@property
	def layer(self):
		"""layer commands group. 9 Sub-classes, 0 commands."""
	...
	@property
	def modulation(self):
		"""modulation commands group. 3 Sub-classes, 0 commands."""
