...
class EosAPIResponse(BaseModel):
    """
    EosAPIResponse
    """ # noqa: E501
    success: StrictBool
    ...
    data: Optional[EosTransactionOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": EosTransactionOutput.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
