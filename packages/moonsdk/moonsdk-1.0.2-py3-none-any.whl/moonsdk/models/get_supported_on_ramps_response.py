...
class GetSupportedOnRampsResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "message": [GetSupportedOnRampsResponseMessageInner.from_dict(_item) for _item in obj["message"]] if obj.get("message") is not None else None
        })
        return _obj
