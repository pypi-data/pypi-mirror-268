...
class ENSApi:
    ...
    async def resolve(
        ...
        ens_resolve_input: EnsResolveInput,
        ...
        :param ens_resolve_input: (required)
        :type ens_resolve_input: EnsResolveInput
        ...
        _param = self._resolve_serialize(
            ...
            ens_resolve_input=ens_resolve_input,
    ...
    @validate_call
    async def resolve_with_http_info(
        self,
        authorization: StrictStr,
        ens_resolve_input: EnsResolveInput,
        _request_timeout: Union[
    ...
    @validate_call
    async def resolve_without_preload_content(
        self,
        authorization: StrictStr,
        ens_resolve_input: EnsResolveInput,
        _request_timeout: Union[
    ...
    def _resolve_serialize(
        ...
        if ens_resolve_input is not None:
            _body_params = ens_resolve_input
