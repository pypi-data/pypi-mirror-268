...
class RippleAPIResponse(BaseModel):
    """
    RippleAPIResponse
    """ # noqa: E501
    success: StrictBool
    ...
    data: Optional[RippleTransactionOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": RippleTransactionOutput.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
