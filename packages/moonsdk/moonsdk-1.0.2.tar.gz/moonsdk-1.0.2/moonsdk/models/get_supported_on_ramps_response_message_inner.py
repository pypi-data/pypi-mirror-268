...
class GetSupportedOnRampsResponseMessageInner(BaseModel):
    """
    ...
    icon: StrictStr
    __properties: ClassVar[List[str]] = ["id", "displayName", "icons", "icon"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icons": GetSupportedOnRampsResponseMessageInnerIcons.from_dict(obj["icons"]) if obj.get("icons") is not None else None,
            "icon": obj.get("icon")
        })
        return _obj
