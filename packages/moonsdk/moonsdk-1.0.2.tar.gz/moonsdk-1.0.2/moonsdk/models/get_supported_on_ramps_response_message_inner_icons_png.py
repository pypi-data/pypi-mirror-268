...
class GetSupportedOnRampsResponseMessageInnerIconsPng(BaseModel):
    """
    GetSupportedOnRampsResponseMessageInnerIconsPng
    """ # noqa: E501
    var_160x160: StrictStr = Field(alias="160x160")
    var_32x32: StrictStr = Field(alias="32x32")
    __properties: ClassVar[List[str]] = ["160x160", "32x32"]
