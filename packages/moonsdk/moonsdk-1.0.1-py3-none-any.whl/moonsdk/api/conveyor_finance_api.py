...
class ConveyorFinanceApi:
    ...
    async def swap(
        ...
        name: StrictStr,
        token_swap_params: TokenSwapParams,
        ...
        :param name: (required)
        :type name: str
        :param token_swap_params: (required)
        :type token_swap_params: TokenSwapParams
        ...
        _param = self._swap_serialize(
            ...
            name=name,
            token_swap_params=token_swap_params,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ConveyorFinanceControllerResponse",
        }
    ...
    async def swap_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConveyorFinanceControllerResponse]:
        """swap
    ...
    def _swap_serialize(
        ...
        if token_swap_params is not None:
            _body_params = token_swap_params
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/conveyorfinance/{name}/swap',
