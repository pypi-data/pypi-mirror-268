...
class PositivCls:
	...
	def fetch(self) -> FetchStruct:
		"""SCPI: FETCh:NIOT:MEASurement<Instance>:MEValuation:SEMask:MARGin:AVERage:POSitiv \n
		Snippet: value: FetchStruct = driver.niotMeas.multiEval.seMask.margin.average.positiv.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:NIOT:MEASurement<Instance>:MEValuation:SEMask:MARGin:AVERage:POSitiv?', self.__class__.FetchStruct())
