...
class CurrentCls:
	...
	def fetch(self, segment=repcap.Segment.Default) -> FetchStruct:
		"""SCPI: FETCh:NIOT:MEASurement<Instance>:MEValuation:LIST:SEGMent<nr>:SEMask:CURRent \n
		Snippet: value: FetchStruct = driver.niotMeas.multiEval.listPy.segment.seMask.current.fetch(segment = repcap.Segment.Default) \n
		...
		return self._core.io.query_struct(f'FETCh:NIOT:MEASurement<Instance>:MEValuation:LIST:SEGMent{segment_cmd_val}:SEMask:CURRent?', self.__class__.FetchStruct())
