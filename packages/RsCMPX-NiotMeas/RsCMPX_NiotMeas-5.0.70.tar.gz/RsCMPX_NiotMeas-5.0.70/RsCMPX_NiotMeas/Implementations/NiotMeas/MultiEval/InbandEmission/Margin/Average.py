...
class AverageCls:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.niotMeas.multiEval.inbandEmission.margin.average.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:NIOT:MEASurement<Instance>:MEValuation:IEMission:MARGin:AVERage?', self.__class__.FetchStruct())
