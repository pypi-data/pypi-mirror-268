...
class ModulationCls:
	...
	@property
	def scsGroup(self):
		"""scsGroup commands group. 1 Sub-classes, 1 commands."""
		if not hasattr(self, '_scsGroup'):
			from .ScsGroup import ScsGroupCls
			self._scsGroup = ScsGroupCls(self._core, self._cmd_group)
		return self._scsGroup
