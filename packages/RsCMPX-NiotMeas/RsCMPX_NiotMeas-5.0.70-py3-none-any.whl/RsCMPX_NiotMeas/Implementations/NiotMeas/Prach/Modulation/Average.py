...
class AverageCls:
	...
	class ResultData(StructBase):
		...
		__meta_args_list = [
			...
			ArgStruct.scalar_float('Mag_Err_Peak_Low'),
		...
		def __init__(self):
			...
			self.Mag_Err_Peak_Low: float = None
	...
	def read(self) -> ResultData:
		"""SCPI: READ:NIOT:MEASurement<Instance>:PRACh:MODulation:AVERage \n
		Snippet: value: ResultData = driver.niotMeas.prach.modulation.average.read() \n
		...
		return self._core.io.query_struct(f'READ:NIOT:MEASurement<Instance>:PRACh:MODulation:AVERage?', self.__class__.ResultData())

	def fetch(self) -> ResultData:
		"""SCPI: FETCh:NIOT:MEASurement<Instance>:PRACh:MODulation:AVERage \n
		Snippet: value: ResultData = driver.niotMeas.prach.modulation.average.fetch() \n
		Return the current, average and standard deviation single value results. The values described below are returned by FETCh
		and READ commands. CALCulate commands return limit check results instead, one value for each result listed below. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:NIOT:MEASurement<Instance>:PRACh:MODulation:AVERage?', self.__class__.ResultData())
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Mag_Err_Peak_Low: float or bool: Magnitude error peak value, low EVM window position
		...
		__meta_args_list = [
			...
			ArgStruct.scalar_float_ext('Mag_Err_Peak_Low'),
		...
		def __init__(self):
			...
			self.Mag_Err_Peak_Low: float or bool = None
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.niotMeas.prach.modulation.average.calculate() \n
		Return the current, average and standard deviation single value results. The values described below are returned by FETCh
		and READ commands. CALCulate commands return limit check results instead, one value for each result listed below. \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:NIOT:MEASurement<Instance>:PRACh:MODulation:AVERage?', self.__class__.CalculateStruct())
