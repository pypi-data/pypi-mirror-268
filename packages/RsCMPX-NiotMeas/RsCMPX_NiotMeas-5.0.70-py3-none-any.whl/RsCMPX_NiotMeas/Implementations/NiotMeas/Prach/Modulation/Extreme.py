...
class ExtremeCls:
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.niotMeas.prach.modulation.extreme.read() \n
		...
		return self._core.io.query_struct(f'READ:NIOT:MEASurement<Instance>:PRACh:MODulation:EXTReme?', self.__class__.ResultData())

	def fetch(self) -> ResultData:
		"""SCPI: FETCh:NIOT:MEASurement<Instance>:PRACh:MODulation:EXTReme \n
		Snippet: value: ResultData = driver.niotMeas.prach.modulation.extreme.fetch() \n
		Returns the extreme single value results. The values described below are returned by FETCh and READ commands. CALCulate
		commands return limit check results instead, one value for each result listed below. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:NIOT:MEASurement<Instance>:PRACh:MODulation:EXTReme?', self.__class__.ResultData())
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.niotMeas.prach.modulation.extreme.calculate() \n
		Returns the extreme single value results. The values described below are returned by FETCh and READ commands. CALCulate
		commands return limit check results instead, one value for each result listed below. \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:NIOT:MEASurement<Instance>:PRACh:MODulation:EXTReme?', self.__class__.CalculateStruct())
