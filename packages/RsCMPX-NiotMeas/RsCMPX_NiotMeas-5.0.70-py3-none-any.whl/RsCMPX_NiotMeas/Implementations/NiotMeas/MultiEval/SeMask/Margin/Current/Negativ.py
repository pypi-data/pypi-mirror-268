...
class NegativCls:
	...
	def fetch(self) -> FetchStruct:
		"""SCPI: FETCh:NIOT:MEASurement<Instance>:MEValuation:SEMask:MARGin:CURRent:NEGativ \n
		Snippet: value: FetchStruct = driver.niotMeas.multiEval.seMask.margin.current.negativ.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:NIOT:MEASurement<Instance>:MEValuation:SEMask:MARGin:CURRent:NEGativ?', self.__class__.FetchStruct())
