...
class NegativCls:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.niotMeas.multiEval.seMask.margin.average.negativ.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:NIOT:MEASurement<Instance>:MEValuation:SEMask:MARGin:AVERage:NEGativ?', self.__class__.FetchStruct())
