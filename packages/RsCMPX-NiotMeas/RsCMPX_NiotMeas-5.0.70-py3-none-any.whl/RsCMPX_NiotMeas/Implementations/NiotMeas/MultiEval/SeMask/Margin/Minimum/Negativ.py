...
class NegativCls:
	...
	def fetch(self) -> FetchStruct:
		"""SCPI: FETCh:NIOT:MEASurement<Instance>:MEValuation:SEMask:MARGin:MINimum:NEGativ \n
		Snippet: value: FetchStruct = driver.niotMeas.multiEval.seMask.margin.minimum.negativ.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:NIOT:MEASurement<Instance>:MEValuation:SEMask:MARGin:MINimum:NEGativ?', self.__class__.FetchStruct())
