...
class PositivCls:
	...
	def fetch(self) -> FetchStruct:
		"""SCPI: FETCh:NIOT:MEASurement<Instance>:MEValuation:SEMask:MARGin:MINimum:POSitiv \n
		Snippet: value: FetchStruct = driver.niotMeas.multiEval.seMask.margin.minimum.positiv.fetch() \n
		...
		(resulting in MINimum margins) , for NEGative and POSitive offset frequencies. Each command returns pairs of X and Y
		values of the margins for emission mask areas 1 to 12. Result array structure: <Reliability>, <OutOfTolerance>,
		{<MarginX>, <MarginY>}area 1, {...}area 2, ..., {...}area 12 For inactive areas, NCAP is returned. \n
			:return: structure: for return value, see the help for FetchStruct structure arguments."""
		return self._core.io.query_struct(f'FETCh:NIOT:MEASurement<Instance>:MEValuation:SEMask:MARGin:MINimum:POSitiv?', self.__class__.FetchStruct())
