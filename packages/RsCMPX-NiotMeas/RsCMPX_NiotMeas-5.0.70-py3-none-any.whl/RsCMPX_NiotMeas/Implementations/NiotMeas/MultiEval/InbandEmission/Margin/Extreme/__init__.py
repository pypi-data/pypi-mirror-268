...
class ExtremeCls:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.niotMeas.multiEval.inbandEmission.margin.extreme.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:NIOT:MEASurement<Instance>:MEValuation:IEMission:MARGin:EXTReme?', self.__class__.FetchStruct())
