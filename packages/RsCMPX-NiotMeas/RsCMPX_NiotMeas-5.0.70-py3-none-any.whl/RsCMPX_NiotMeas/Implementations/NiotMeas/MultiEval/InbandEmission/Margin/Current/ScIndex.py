...
class ScIndexCls:
	...
	def fetch(self) -> FetchStruct:
		"""SCPI: FETCh:NIOT:MEASurement<Instance>:MEValuation:IEMission:MARGin:CURRent:SCINdex \n
		Snippet: value: FetchStruct = driver.niotMeas.multiEval.inbandEmission.margin.current.scIndex.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:NIOT:MEASurement<Instance>:MEValuation:IEMission:MARGin:CURRent:SCINdex?', self.__class__.FetchStruct())
