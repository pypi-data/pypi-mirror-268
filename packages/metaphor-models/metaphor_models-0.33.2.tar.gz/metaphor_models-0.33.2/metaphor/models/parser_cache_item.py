...
class Entity:
    ...
    def from_dict(obj: Any) -> 'Entity':
        ...
        return Entity(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, entity_created_at, dashboard_info, deleted_at, display_name, entity_type, entity_upstream, force_shown, entity_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, overall_data_quality, parsed_upstream, source_info, structure, system_contacts, system_tags, system_tag_values, entity_versioned_id, custom_metadata, data_quality, description_assignment, documentation, field_associations, field_statistics, ownership_assignment, pipeline_info, schema, snowflake_stream_info, soda_data_quality, statistics, tag_assignment, unity_catalog, usage, dbt_metric, azure_data_factory_pipeline, fivetran, power_bi_dataflow, spark, dbt_model, full_name, looker_explore, looker_view, power_bi_dataset, tableau_datasource, thought_spot, level, segments, browse_paths, display_name_without_fallback, hierarchy_info, asset_likes, organization)
...
class MapStringString:
    ...
    to_string_tag_4940: Optional[str] = None
    size: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'MapStringString':
        assert isinstance(obj, dict)
        to_string_tag_4940 = from_union([from_str, from_none], obj.get("__@toStringTag@4940"))
        size = from_union([from_float, from_none], obj.get("size"))
        return MapStringString(to_string_tag_4940, size)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_4940 is not None:
            result["__@toStringTag@4940"] = from_union([from_str, from_none], self.to_string_tag_4940)
