...
class ParsedSource:
    ...
    def from_dict(obj: Any) -> 'ParsedSource':
        ...
        transformation = from_union([from_str, from_none], obj.get("transformation"))
        return ParsedSource(field_mappings, last_parsed, source_entities, source_unique_id, transformation)
...
class SourceInfo:
    ...
    def from_dict(obj: Any) -> 'SourceInfo':
        ...
        return SourceInfo(created_at, aspect_type, source_info_created_at, created_at_source, entity_id, id, last_updated, main_url)
...
class SystemContactSource(Enum):
    POWER_BI = "POWER_BI"
    TABLEAU = "TABLEAU"
    UNKNOWN = "UNKNOWN"
...
class SystemContact:
    ...
    system_contact_source: Optional[SystemContactSource] = None

    @staticmethod
    def from_dict(obj: Any) -> 'SystemContact':
        assert isinstance(obj, dict)
        email = from_union([from_str, from_none], obj.get("email"))
        system_contact_source = from_union([SystemContactSource, from_none], obj.get("systemContactSource"))
    ...
    def to_dict(self) -> dict:
        ...
        if self.system_contact_source is not None:
            result["systemContactSource"] = from_union([lambda x: to_enum(SystemContactSource, x), from_none], self.system_contact_source)
        return result
...
class Dashboard:
    ...
    def from_dict(obj: Any) -> 'Dashboard':
        ...
        return Dashboard(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, dashboard_created_at, dashboard_info, deleted_at, display_name, entity_type, entity_upstream, force_shown, dashboard_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, overall_data_quality, parsed_upstream, source_info, structure, system_contacts, system_tags, system_tag_values, dashboard_versioned_id)
...
class UnityCatalog:
    ...
    table_type: Optional[UnityCatalogTableType] = None
    ...
    def from_dict(obj: Any) -> 'UnityCatalog':
        ...
        table_type = from_union([UnityCatalogTableType, from_none], obj.get("tableType"))
        return UnityCatalog(created_at, aspect_type, unity_catalog_created_at, data_source_format, entity_id, id, owner, properties, storage_location, table_type)
    ...
    def to_dict(self) -> dict:
        ...
        if self.table_type is not None:
            result["tableType"] = from_union([lambda x: to_enum(UnityCatalogTableType, x), from_none], self.table_type)
        return result
...
class Index(Enum):
    """Predefined elasticsearch index names"""
    ASSETS = "assets"
...
class HierarchyInfo:
    ...
    def from_dict(obj: Any) -> 'HierarchyInfo':
        ...
        return HierarchyInfo(created_at, aspect_type, hierarchy_info_created_at, description, entity_id, id, metabase_collection, power_bi_workspace, type)
...
class Hierarchy:
    ...
    def from_dict(obj: Any) -> 'Hierarchy':
        ...
        return Hierarchy(created_at, id, level, segments, versioned_id, asset_contacts, asset_followers, asset_governed_tags, browse_paths, hierarchy_created_at, deleted_at, display_name, display_name_without_fallback, entity_type, hierarchy_info, hierarchy_id, is_deleted, last_ingested_at, last_modified_at, logical_id, system_tags, hierarchy_versioned_id)
...
class Metric:
    ...
    def from_dict(obj: Any) -> 'Metric':
        ...
        return Metric(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, metric_created_at, dbt_metric, deleted_at, display_name, entity_type, entity_upstream, force_shown, metric_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, metric_info, parsed_upstream, system_contacts, system_tags, system_tag_values, metric_versioned_id)
...
class Pipeline:
    ...
    def from_dict(obj: Any) -> 'Pipeline':
        ...
        return Pipeline(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, azure_data_factory_pipeline, pipeline_created_at, deleted_at, display_name, entity_type, entity_upstream, fivetran, force_shown, pipeline_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, parsed_upstream, power_bi_dataflow, spark, system_contacts, system_tags, system_tag_values, pipeline_versioned_id)
