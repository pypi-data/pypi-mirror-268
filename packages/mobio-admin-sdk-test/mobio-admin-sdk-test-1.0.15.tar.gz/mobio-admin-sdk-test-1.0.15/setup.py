...
class Readme(object):
    ...
    def get():
        ...
        :return:
        """
        print(Readme.__readme_path)
        print(os.path.exists(Readme.__readme_path))
        print(os.getcwd())
        long_description = ""
...
class Requirements(object):
    requirements_path = "requirements_sdk.txt"
...
setup(
    ...
    # larger catalog.
    keywords="mobio, admin sdk, verify token",  # Optional
