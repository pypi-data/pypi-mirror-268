...
class LogStream(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream okta_log_stream}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream okta_log_stream} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Unique name for the Log Stream object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#name LogStream#name}
        :param type: Streaming provider used - 'aws_eventbridge' or 'splunk_cloud_logstreaming'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#type LogStream#type}
        :param settings: settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#settings LogStream#settings}
        :param status: Stream status. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#status LogStream#status}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing LogStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#import import section} in the documentation of this resource for the id to use
    ...
    def put_settings(
        ...
        *,
        ...
        '''
        :param account_id: AWS account ID. Required only for 'aws_eventbridge' type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#account_id LogStream#account_id}
        :param edition: Edition of the Splunk Cloud instance. Could be one of: 'aws', 'aws_govcloud', 'gcp'. Required only for 'splunk_cloud_logstreaming' type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#edition LogStream#edition}
        :param event_source_name: An alphanumeric name (no spaces) to identify this event source in AWS EventBridge. Required only for 'aws_eventbridge' type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#event_source_name LogStream#event_source_name}
        :param host: The domain name for Splunk Cloud instance. Don't include http or https in the string. For example: 'acme.splunkcloud.com'. Required only for 'splunk_cloud_logstreaming' type Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#host LogStream#host}
        :param region: The destination AWS region where event source is located. Required only for 'aws_eventbridge' type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#region LogStream#region}
        :param token: The HEC token for your Splunk Cloud HTTP Event Collector. Required only for 'splunk_cloud_logstreaming' type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#token LogStream#token}
        '''
...
class LogStreamConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#name LogStream#name}
        '''
    ...
    def type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#type LogStream#type}
        '''
    ...
    def settings(self) -> typing.Optional["LogStreamSettings"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#settings LogStream#settings}
        '''
    ...
    def status(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#status LogStream#status}
        '''
...
class LogStreamSettings:
    ...
    def account_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#account_id LogStream#account_id}
        '''
    ...
    def edition(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#edition LogStream#edition}
        '''
    ...
    def event_source_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#event_source_name LogStream#event_source_name}
        '''
    ...
    def host(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#host LogStream#host}
        '''
    ...
    def region(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#region LogStream#region}
        '''
    ...
    def token(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/log_stream#token LogStream#token}
        '''
