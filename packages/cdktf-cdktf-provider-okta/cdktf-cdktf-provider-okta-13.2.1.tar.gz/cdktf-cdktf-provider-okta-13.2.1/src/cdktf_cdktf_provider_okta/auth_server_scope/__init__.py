...
class AuthServerScope(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope okta_auth_server_scope}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope okta_auth_server_scope} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param auth_server_id: Auth server ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#auth_server_id AuthServerScope#auth_server_id}
        :param name: Auth server scope name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#name AuthServerScope#name}
        :param consent: Indicates whether a consent dialog is needed for the scope. It can be set to ``REQUIRED`` or ``IMPLICIT``. Default: ``IMPLICIT`` Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#consent AuthServerScope#consent}
        :param default: A default scope will be returned in an access token when the client omits the scope parameter in a token request, provided this scope is allowed as part of the access policy rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#default AuthServerScope#default}
        :param description: Description of the Auth Server Scope. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#description AuthServerScope#description}
        :param display_name: Name of the end user displayed in a consent dialog box. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#display_name AuthServerScope#display_name}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#id AuthServerScope#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param metadata_publish: Whether to publish metadata or not. It can be set to ``ALL_CLIENTS`` or ``NO_CLIENTS``. Default: ``ALL_CLIENTS``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#metadata_publish AuthServerScope#metadata_publish}
        :param optional: Whether the scope optional. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#optional AuthServerScope#optional}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing AuthServerScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#import import section} in the documentation of this resource for the id to use
...
class AuthServerScopeConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def auth_server_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#auth_server_id AuthServerScope#auth_server_id}
        '''
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#name AuthServerScope#name}
        '''
    ...
    def consent(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#consent AuthServerScope#consent}
        '''
    ...
    def default(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#default AuthServerScope#default}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#description AuthServerScope#description}
        '''
    ...
    def display_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#display_name AuthServerScope#display_name}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#id AuthServerScope#id}.
    ...
    def metadata_publish(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#metadata_publish AuthServerScope#metadata_publish}
        '''
    ...
    def optional(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.8.1/docs/resources/auth_server_scope#optional AuthServerScope#optional}
        '''
