...
def setup(app):
    ...
    app.add_object_type('command', 'cmd', 'pair: %s; command', command_parse)

    add(directivename='xfile',
        rolename='xfile',
        indextemplate='pair: %s; file')
    add(directivename='setting',
        rolename='setting',
    ...
    app.add_config_value('blogref_format',
                         "https://luc.lino-framework.org/blog/%Y/%m%d.html",
                         'html')
