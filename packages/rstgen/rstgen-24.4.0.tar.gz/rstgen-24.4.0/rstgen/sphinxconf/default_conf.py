...
public_url = html_context.setdefault('public_url',
                                     rstgen.get_config_var('public_url'))
...
if html_theme == "sphinx_rtd_theme":
    html_theme_options = {
        ...
        False,  # disadvantage: line spacing increases for lines with a link
        "includehidden": False,
    }
    html_sidebars = {
    ...
    html_sidebars = {
        '**': [
            'languages.html', 'globaltoc.html', 'separator.html',
            'searchbox.html', 'indices.html', 'links.html'
        ]
    }
