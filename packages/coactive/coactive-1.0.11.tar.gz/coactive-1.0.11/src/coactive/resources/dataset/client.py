...
class DatasetClient:
    ...
    def create(
        self, *, name: str, description: typing.Optional[str] = OMIT, credentials_id: typing.Optional[str] = OMIT
    ) -> Dataset:
        """
    ...
    def add_assets(
        ...
        *,
        ...
        Parameters:
            ...
            - videos: typing.Optional[typing.List[AddVideoRequest]]. Videos to add to the dataset
