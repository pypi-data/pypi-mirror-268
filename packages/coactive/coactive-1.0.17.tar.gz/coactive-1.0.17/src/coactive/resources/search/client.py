...
class SearchClient:
    ...
    def search_dataset(
        ...
        *,
        ...
        dataset_id: str,
        encoder: typing.Optional[str] = None,
        ...
        Parameters:
            ...
            - encoder: typing.Optional[str]. The encoder to use to search within this dataset.Only applicable if dataset has multiple embeddings.Will use default dataset embedding if None.
