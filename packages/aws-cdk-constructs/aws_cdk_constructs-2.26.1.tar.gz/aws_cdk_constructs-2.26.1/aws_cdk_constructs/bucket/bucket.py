...
class Bucket(Construct):
    ...
    @property
    def get_s3_bucket(self) -> aws_cdk.aws_s3.Bucket:
    ...
    def create_bucket(
        ...
        encryption_allowed_principals_arns: [str, List[str]] = None,
    ...
    def __init__(
        ...
        versioned: bool = False,
        encryption_allowed_principals_arns: Union[str, List[str]] = None,
        cdn_http_headers: Dict[str, str] = None,
        ...
        **kwargs,
        ...
        if public_read_access:
            ...
            s3_resource = self.bucket.node.default_child
        ...
        if include_cdn:
            ...
            self.bucket.add_to_resource_policy(
                _iam.PolicyStatement(
                    ...
                    conditions={
                        'NotIpAddress': {'aws:SourceIp': cloudflare_ips}
                    },
                )
            )
            self.bucket.add_to_resource_policy(
        ...
        if has_authentication:
            ...
            static_distribution = StaticSiteDistribution(
                self,
                'Distribution',
            ...
            distribution_config = static_distribution.node.find_child(
                'Distribution'
            ).node.find_child('Resource')

            distribution_config.add_override(
                'Properties.DistributionConfig.Aliases', [bucket_name]
            )
            distribution_config.add_override(
                'Properties.DistributionConfig.ViewerCertificate.AcmCertificateArn',
                self.aws_account['ssl_certificate_star_fao_org_arn'],
            )
            distribution_config.add_override(
                'Properties.DistributionConfig.ViewerCertificate.SslSupportMethod',
                'sni-only',
            )
