...
if TYPE_CHECKING:
    from ..models.patch_project_settings_body_custom_settings import (
        PatchProjectSettingsBodyCustomSettings,
    )


T = TypeVar("T", bound="PatchProjectSettingsBody")
...
class PatchProjectSettingsBody:
    ...
    Attributes:
        ...
        custom_settings (Union[Unset, PatchProjectSettingsBodyCustomSettings]): Dictionary of custom organization
            settings
    ...
    custom_settings: Union[Unset, "PatchProjectSettingsBodyCustomSettings"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_settings: Union[Unset, PatchProjectSettingsBodyCustomSettings]
        if isinstance(_custom_settings, Unset):
            custom_settings = UNSET
        else:
            custom_settings = PatchProjectSettingsBodyCustomSettings.from_dict(_custom_settings)
        ...
        patch_project_settings_body = cls(
            name=name,
        ...
        patch_project_settings_body.additional_properties = d
        return patch_project_settings_body
