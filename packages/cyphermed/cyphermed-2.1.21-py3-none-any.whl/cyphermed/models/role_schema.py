...
if TYPE_CHECKING:
    ...
    from ..models.role_schema_custom_attributes import RoleSchemaCustomAttributes
    from ..models.role_schema_restricted_custom_attributes import (
        RoleSchemaRestrictedCustomAttributes,
    )


T = TypeVar("T", bound="RoleSchema")
...
class RoleSchema:
    ...
    Attributes:
        ...
        restricted_custom_attributes (RoleSchemaRestrictedCustomAttributes): Custom attributes only admins can update
        ...
        custom_attributes (Union[Unset, RoleSchemaCustomAttributes]): Custom attributes for this user
    ...
    custom_attributes: Union[Unset, "RoleSchemaCustomAttributes"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        restricted_custom_attributes = RoleSchemaRestrictedCustomAttributes.from_dict(
        ...
        custom_attributes: Union[Unset, RoleSchemaCustomAttributes]
        if isinstance(_custom_attributes, Unset):
            custom_attributes = UNSET
        else:
            custom_attributes = RoleSchemaCustomAttributes.from_dict(_custom_attributes)
        ...
        role_schema.additional_properties = d
        return role_schema
