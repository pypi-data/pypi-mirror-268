...
if TYPE_CHECKING:
    from ..models.role_schema import RoleSchema
...
class RoleList:
    ...
    Attributes:
        roles (Union[Unset, List['RoleSchema']]):
        page_count (Union[Unset, int]):
        object_count (Union[Unset, int]):
    """

    roles: Union[Unset, List["RoleSchema"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for roles_item_data in _roles or []:
            roles_item = RoleSchema.from_dict(roles_item_data)
