...
def _get_links(actions: list[dict[str, Any]], tvars: dict[str, Any] = None,
               link_callback: Callable[[int, Link], None] = None) -> Generator[dict[str, Any], None, None]:
    """
    Get top-level links.
...
def _get_items(request: Request, wstl_obj: dict[str, Any], link_callback: Callable[[int, Link], None] = None,
               tvars: dict[str, Any] | None = None) -> Generator[list[dict[str, Any]], None, None]:
...
def _is_in_target(str_: str, action: dict[str, Any]) -> bool:
