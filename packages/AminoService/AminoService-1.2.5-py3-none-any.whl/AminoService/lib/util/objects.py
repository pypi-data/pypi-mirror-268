...
class UserProfile:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.fanClub = FanClubList([])
...
class UserProfileList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _fanClub.append(FanClubList([]))
...
class BlogList:
    def __init__(self, data, nextPageToken = None, prevPageToken = None):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _author.append({})
            try: _quizQuestionList.append(QuizQuestionList(y["quizQuestionList"]).QuizQuestionList)
            except (KeyError, TypeError): _quizQuestionList.append([])
...
class Blog:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.author = UserProfile({})
        try: self.quizQuestionList = QuizQuestionList(data["quizQuestionList"]).QuizQuestionList
        except (KeyError, TypeError): self.quizQuestionList = QuizQuestionList([])
        self.createdTime = None
...
class Wiki:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.labels = WikiLabelList([])
        self.createdTime = None
        self.modifiedTime = None
        self.wikiId = None
        self.status = None
...
class WikiList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _labels.append(WikiLabelList([]))
        self.author = UserProfileList(_author).UserProfileList
        self.labels = _labels
        self.createdTime = []
        self.modifiedTime = []
...
class Community:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.agent = UserProfile({})
        try: self.rankingTable = RankingTableList(data["advancedSettings"]["rankingTable"]).RankingTableList
        except (KeyError, TypeError): self.rankingTable = RankingTableList([])
...
class CommunityList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _agent.append({})
            try: _rankingTable.append(RankingTableList(y["advancedSettings"]["rankingTable"]).RankingTableList)
            except (KeyError, TypeError): _rankingTable.append(RankingTableList([]))
...
class VisitorsList:
    def __init__(self, data):
        ...
        for y in data["visitors"]:
            ...
            except (KeyError, TypeError): _profile.append({})
...
class FromCode:
    def __init__(self, data):
        self.json = data
        try: self.community = Community(data["extensions"]["community"]).Community
        except (KeyError, TypeError): self.community = Community({})
        self.path = None
...
class UserProfileCountList:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.profile = UserProfileList([])
    ...
    def __init__(self, data):
        ...
        for y in data:
            if y["refObjectType"] == 1:
                ...
                except (KeyError, TypeError): _object.append(Blog({}))
            elif y["refObjectType"] == 2:
                try: _object.append(Wiki(y["refObject"]).Wiki)
                except (KeyError, TypeError): _object.append(Wiki({}))
            else:
                try: _object.append(y["refObject"])
                except (KeyError, TypeError): _object.append({})
        self.object = _object
        self.objectType = []
        self.bookmarkedTime = []
        self.objectId = []
...
class GetWikiInfo:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.wiki = Wiki({})
...
class GetBlogInfo:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.blog = Blog({})
        self.isBookmarked = None
...
class WikiCategory:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.subCategory = WikiCategoryList([])
        self.itemsCount = None
...
class Thread:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.membersSummary = UserProfileList([])
        self.userAddedTopicList = None
...
class ThreadList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _membersSummary.append(UserProfileList([]))
        self.author = UserProfileList(_author).UserProfileList
...
class Sticker:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.collection = StickerCollection({})
        self.status = None
        self.icon = None
        self.iconV2 = None
        self.name = None
...
class StickerList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _collection.append([])
...
class StickerCollection:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.originalAuthor = UserProfile({})
        try: self.originalCommunity = Community(data["extensions"]["originalCommunity"]).Community
        except (KeyError, TypeError): self.originalCommunity = Community({})
        self.status = None
...
class StickerCollectionList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _originalAuthor.append({})
            try: _originalCommunity.append(y["extensions"]["originalCommunity"])
            except (KeyError, TypeError): _originalCommunity.append({})
        self.author = UserProfileList(_author).UserProfileList
...
class Message:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.sticker = Sticker({})
        self.content = None
...
class MessageList:
    def __init__(self, data, nextPageToken = None, prevPageToken = None):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _sticker.append({})
        self.author = UserProfileList(_author).UserProfileList
...
class CommunityStickerCollection:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.sticker = StickerCollectionList([])
...
class FanClubList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _targetUserProfile.append({})
        self.profile = UserProfileList(_profile).UserProfileList
...
class InfluencerFans:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.influencerProfile = UserProfile({})
        try: self.fanClubList = FanClubList(data["fanClubList"]).FanClubList
        except (KeyError, TypeError): self.fanClubList = FanClubList([])
        self.myFanClub = None
...
class QuizQuestionList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _answersList.append(QuizAnswers([]))
        self.status = []
        self.parentType = []
        self.title = []
        self.createdTime = []
...
class QuizRankings:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _rankingList.append(QuizRanking({}))
...
class Event:
    def __init__(self, data):
        ...
        except (KeyError, TypeError): self.message = Message({})
...
class WikiRequestList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _wiki.append({})
            try: _originalWiki.append(y["originalItem"])
            except (KeyError, TypeError): _originalWiki.append({})
        self.author = UserProfileList(_author).UserProfileList
...
class NoticeList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _targetUser.append({})
        self.author = UserProfileList(_author).UserProfileList
...
class Bubble:
    def __init__(self, data):
        try: self.config = BubbleConfig(data["config"])
        except (KeyError, TypeError): self.config = BubbleConfig({})
        self.json = data
        self.uid = None
        self.isActivated = None
        self.isNew = None
...
class BubbleList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            except (KeyError, TypeError): _config.append({})
