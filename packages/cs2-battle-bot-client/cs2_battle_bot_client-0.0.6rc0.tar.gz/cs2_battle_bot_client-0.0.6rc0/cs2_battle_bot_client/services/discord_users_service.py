...
def discord_users_create(data: DiscordUser, api_config_override: Optional[APIConfig] = None) -> DiscordUser:
    api_config = api_config_override if api_config_override else APIConfig()
...
def discord_users_retrieve(id: str, api_config_override: Optional[APIConfig] = None) -> DiscordUser:
    api_config = api_config_override if api_config_override else APIConfig()
...
def discord_users_update(id: str, data: DiscordUser, api_config_override: Optional[APIConfig] = None) -> DiscordUser:
    api_config = api_config_override if api_config_override else APIConfig()
...
def discord_users_destroy(id: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def discord_users_partial_update(
