...
async def servers_create(data: Server, api_config_override: Optional[APIConfig] = None) -> Server:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def servers_retrieve(id: str, api_config_override: Optional[APIConfig] = None) -> Server:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def servers_update(id: str, data: Server, api_config_override: Optional[APIConfig] = None) -> Server:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def servers_destroy(id: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def servers_partial_update(
    id: str, data: PatchedServer, api_config_override: Optional[APIConfig] = None
) -> Server:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def servers_join_retrieve(id: str, api_config_override: Optional[APIConfig] = None) -> Server:
    api_config = api_config_override if api_config_override else APIConfig()
