...
export class Sanitizer implements IRenderMime.ISanitizer {
  ...
  /**
   * Set the allowed iframe hostnames
   *
   * @param scheme Allowed iframe hostnames
   */
  setAllowedIframeHostnames(iframeHostnames: Array<string>): void {
    // Force copy of `iframe hostnames`
    this._options.allowedIframeHostnames = [...iframeHostnames];
  }

  /**
   * Set the allowed iframe domains
   *
   * @param scheme Allowed iframe domains
   */
  setAllowedIframeDomains(iframeDomains: Array<string>): void {
    // Force copy of `iframe domains`
    this._options.allowedIframeDomains = [...iframeDomains];
  }
