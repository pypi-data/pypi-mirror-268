...
class SunstsCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("sunsts", core, parent)
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.wlanMeas.multiEval.sinfo.vhtSig.sunsts.fetch() \n
		Queries the value of NSTS field signaled in very high throughput signal field for 802.11ac signal (VHT-SIG) . For the
		filed Partial AID refer to: method RsCMPX_WlanMeas.WlanMeas.MultiEval.Sinfo.VhtSig.Paid.fetch \n
