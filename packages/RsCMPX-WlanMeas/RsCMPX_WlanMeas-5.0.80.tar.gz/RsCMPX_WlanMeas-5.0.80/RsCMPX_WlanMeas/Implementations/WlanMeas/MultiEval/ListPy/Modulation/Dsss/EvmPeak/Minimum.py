...
class MinimumCls:
	...
	def fetch(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.wlanMeas.multiEval.listPy.modulation.dsss.evmPeak.minimum.fetch() \n
		...
		response = self._core.io.query_bin_or_ascii_float_list_suppressed(f'FETCh:WLAN:MEASurement<Instance>:MEValuation:LIST:MODulation:DSSS:EVMPeak:MINimum?', suppressed)
		return response
