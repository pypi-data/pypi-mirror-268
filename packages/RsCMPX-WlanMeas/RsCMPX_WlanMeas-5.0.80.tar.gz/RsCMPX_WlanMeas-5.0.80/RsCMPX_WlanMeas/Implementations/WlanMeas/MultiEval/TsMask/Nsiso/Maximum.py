...
class MaximumCls:
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.wlanMeas.multiEval.tsMask.nsiso.maximum.read() \n
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.wlanMeas.multiEval.tsMask.nsiso.maximum.fetch() \n
		No command help available \n
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.wlanMeas.multiEval.tsMask.nsiso.maximum.calculate() \n
		No command help available \n
