...
class CurrentCls:
	...
	def fetch(self) -> List[float]:
		"""SCPI: FETCh:WLAN:MEASurement<Instance>:MEValuation:LIST:MODulation:DSSS:EVMPeak:CURRent \n
		Snippet: value: List[float] = driver.wlanMeas.multiEval.listPy.modulation.dsss.evmPeak.current.fetch() \n
		...
		response = self._core.io.query_bin_or_ascii_float_list_suppressed(f'FETCh:WLAN:MEASurement<Instance>:MEValuation:LIST:MODulation:DSSS:EVMPeak:CURRent?', suppressed)
		return response
