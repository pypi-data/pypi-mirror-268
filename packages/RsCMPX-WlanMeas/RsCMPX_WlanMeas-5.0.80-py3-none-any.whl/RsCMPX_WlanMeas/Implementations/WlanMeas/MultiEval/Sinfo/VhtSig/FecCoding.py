...
class FecCodingCls:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.wlanMeas.multiEval.sinfo.vhtSig.fecCoding.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:WLAN:MEASurement<Instance>:MEValuation:SINFo:VHTSig:FECCoding?', self.__class__.FetchStruct())
