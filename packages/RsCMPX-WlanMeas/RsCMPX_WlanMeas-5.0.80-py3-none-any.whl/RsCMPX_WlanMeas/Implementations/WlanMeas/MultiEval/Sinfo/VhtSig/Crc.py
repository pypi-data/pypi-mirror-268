...
class CrcCls:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.wlanMeas.multiEval.sinfo.vhtSig.crc.fetch() \n
		Queries the value of CRC field signaled in very high throughput signal field for 802.11ac signal (VHT-SIG) . \n
			:return: structure: for return value, see the help for FetchStruct structure arguments."""
		return self._core.io.query_struct(f'FETCh:WLAN:MEASurement<Instance>:MEValuation:SINFo:VHTSig:CRC?', self.__class__.FetchStruct())
