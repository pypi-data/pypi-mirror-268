...
class ReservedCls:
	...
	def fetch(self, reserved=repcap.Reserved.Default) -> FetchStruct:
		"""SCPI: FETCh:WLAN:MEASurement<instance>:MEValuation:SINFo:VHTSig:REServed<index> \n
		Snippet: value: FetchStruct = driver.wlanMeas.multiEval.sinfo.vhtSig.reserved.fetch(reserved = repcap.Reserved.Default) \n
		...
		return self._core.io.query_struct(f'FETCh:WLAN:MEASurement<Instance>:MEValuation:SINFo:VHTSig:REServed{reserved_cmd_val}?', self.__class__.FetchStruct())
