...
class StandardDevCls:
	...
	def fetch(self) -> List[float]:
		"""SCPI: FETCh:WLAN:MEASurement<Instance>:MEValuation:LIST:MODulation:CFACtor:SDEViation \n
		Snippet: value: List[float] = driver.wlanMeas.multiEval.listPy.modulation.cfactor.standardDev.fetch() \n
		...
		response = self._core.io.query_bin_or_ascii_float_list_suppressed(f'FETCh:WLAN:MEASurement<Instance>:MEValuation:LIST:MODulation:CFACtor:SDEViation?', suppressed)
		return response
