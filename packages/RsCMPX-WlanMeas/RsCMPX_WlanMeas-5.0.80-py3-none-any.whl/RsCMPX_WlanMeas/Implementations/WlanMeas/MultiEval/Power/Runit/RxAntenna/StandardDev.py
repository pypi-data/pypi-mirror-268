...
class StandardDevCls:
	...
	def fetch(self, resourceUnit=repcap.ResourceUnit.Default, rxAntenna=repcap.RxAntenna.Default) -> float:
		...
		Snippet: value: float = driver.wlanMeas.multiEval.power.runit.rxAntenna.standardDev.fetch(resourceUnit = repcap.ResourceUnit.Default, rxAntenna = repcap.RxAntenna.Default) \n
