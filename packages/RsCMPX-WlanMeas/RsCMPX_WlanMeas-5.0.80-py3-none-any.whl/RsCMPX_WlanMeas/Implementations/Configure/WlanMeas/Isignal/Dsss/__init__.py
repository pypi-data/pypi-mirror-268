...
class DsssCls:
	...
	@property
	def elength(self):
		"""elength commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_elength'):
			from .Elength import ElengthCls
			self._elength = ElengthCls(self._core, self._cmd_group)
		return self._elength
