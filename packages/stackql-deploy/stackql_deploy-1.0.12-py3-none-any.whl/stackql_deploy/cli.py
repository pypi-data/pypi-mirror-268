...
def create_project_structure(stack_name):
    ...
    template_files = {
        ...
        'stackql_docs/resource1.md.template': os.path.join(base_path,'stackql_docs', 'resource1.md'),
        'stackql_resources/resource1.iql.template': os.path.join(base_path,'stackql_resources', 'resource1.iql'),
        'stackql_tests/resource1.iql.template': os.path.join(base_path,'stackql_tests', 'resource1.iql')
    }
