...
from ...types.credential_input import CredentialInput
...
class CredentialsClient:
    ...
    def credential_create(
        ...
        *,
        ...
        ---
        from truvity_sdk import CredentialInput
        from truvity_sdk.client import TruvityApi

        client = TruvityApi(
            api_key="YOUR_API_KEY",
        )
        client.credentials.credential_create(
            blob_id="blob_id",
            request=CredentialInput(),
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "credentials"),
...
class AsyncCredentialsClient:
    ...
    async def credential_create(
        ...
        *,
        ...
        await client.credentials.credential_create(
            blob_id="blob_id",
            request=CredentialInput(),
        )
        """
