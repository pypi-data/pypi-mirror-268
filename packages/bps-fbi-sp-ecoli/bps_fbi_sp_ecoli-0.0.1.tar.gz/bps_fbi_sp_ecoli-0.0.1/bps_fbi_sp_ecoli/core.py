...
# %% ../nbs/00_core.ipynb 5
# Need the bps_fbi_sp_ecoli for a few functions, this can be considered a static var

import importlib
import importlib.util
import os

PACKAGE_NAME: str = "bps_fbi_sp_ecoli"  # Make sure to adjust this to your package name
DEV_MODE: bool = (
...
def get_config(config_path: str = None, overide_env_vars: bool = True) -> dict:
    ...
    if DEV_MODE:
        os.environ["CORE_CONFIG_FILE"] = f"{PACKAGE_DIR}/config/config.default.env"
        os.environ["CORE_YAML_CONFIG_FILE"] = (
