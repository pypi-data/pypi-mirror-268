...
torch_npu.reverse = torch.ops.npu.reverse
...
torch_npu.npu_indexing_trans_contiguous = torch.ops.npu.npu_indexing_trans_contiguous
...
torch_npu.image_normalize = torch.ops.npu.image_normalize
torch_npu.npu_transpose_trans_contiguous = torch.ops.npu.npu_transpose_trans_contiguous
...
torch_npu.decode_jpeg = torch.ops.npu.decode_jpeg
...
torch_npu.selu_backward = torch.ops.npu.selu_backward
...
torch_npu.img_to_tensor = torch.ops.npu.img_to_tensor
...
torch_npu.image_normalize_ = torch.ops.npu.image_normalize_
...
torch_npu.crop_and_resize = torch.ops.npu.crop_and_resize
...
torch_npu.npu_incre_flash_attention = torch.ops.npu.npu_incre_flash_attention
