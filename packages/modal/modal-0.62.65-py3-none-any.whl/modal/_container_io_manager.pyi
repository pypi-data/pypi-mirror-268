...
class _ContainerIOManager:
    ...
    async def get_app_objects(self) -> typing.List[modal_proto.api_pb2.AppGetObjectsItem]:
        ...
...
class ContainerIOManager:
    ...
    class __get_app_objects_spec(typing_extensions.Protocol):
        def __call__(self) -> typing.List[modal_proto.api_pb2.AppGetObjectsItem]:
            ...

        async def aio(self, *args, **kwargs) -> typing.List[modal_proto.api_pb2.AppGetObjectsItem]:
            ...
