...
class _Stub:
    ...
    def _set_local_app(self, client: modal.client._Client, app: modal.app._LocalApp) -> typing.AsyncContextManager[None]:
        ...
    ...
    def _init_container(self, client: modal.client._Client, container_app: modal.app._ContainerApp):
        ...
...
class Stub:
    ...
    class ___set_local_app_spec(typing_extensions.Protocol):
        def __call__(self, client: modal.client.Client, app: modal.app._LocalApp) -> synchronicity.combined_types.AsyncAndBlockingContextManager[None]:
            ...

        def aio(self, client: modal.client.Client, app: modal.app._LocalApp) -> typing.AsyncContextManager[None]:
            ...
    ...
    def _init_container(self, client: modal.client.Client, container_app: modal.app._ContainerApp):
        ...
