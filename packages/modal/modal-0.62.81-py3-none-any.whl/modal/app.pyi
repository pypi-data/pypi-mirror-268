...
class _App:
    ...
    _all_stubs: typing.ClassVar[typing.Dict[typing.Union[str, None], typing.List[_App]]]
...
class App:
    ...
    _all_stubs: typing.ClassVar[typing.Dict[typing.Union[str, None], typing.List[App]]]
