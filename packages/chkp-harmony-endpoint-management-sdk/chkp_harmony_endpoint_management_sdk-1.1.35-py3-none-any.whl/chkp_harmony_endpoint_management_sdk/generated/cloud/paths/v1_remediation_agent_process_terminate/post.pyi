...
# body param
SchemaForRequestBodyApplicationJson = PushOperationRequestWithMandatoryParamsTerminateProcessParams


request_body_push_operation_request_with_mandatory_params_terminate_process_params = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _agent_terminate_process_oapg(
        self,
        # GTO-EA-2-2
    ...
    def _agent_terminate_process_oapg(
        ...
        API Parameters:
         ...
         - body: PushOperationRequestWithMandatoryParamsTerminateProcessParams - Mandatory 
        """
        """
        Terminate the given process on computers matching the given query
        ...
        serialized_data = parameter.serialize('agent_terminate_process', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_push_operation_request_with_mandatory_params_terminate_process_params.serialize(body, content_type)
        ...
        logger(f'Sending operation "agent_terminate_process" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "agent_terminate_process" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "agent_terminate_process" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "agent_terminate_process" url "{final_url}" with "{response_options}"')
...
class AgentTerminateProcess(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names




    def agent_terminate_process(
        self,
        # GTO-EA-1-2
        body: SchemaForRequestBodyApplicationJson,
        ...
        return self._agent_terminate_process_oapg(
            body=body,
