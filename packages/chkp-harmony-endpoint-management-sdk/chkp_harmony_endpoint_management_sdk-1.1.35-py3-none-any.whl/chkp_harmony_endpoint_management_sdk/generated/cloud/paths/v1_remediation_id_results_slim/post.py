...
# body param
SchemaForRequestBodyApplicationJson = PushOperationResultsRequestSlim


request_body_push_operation_results_request_slim = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JobOrResultPushOperationClientResultSlimResponse
...
class HarmonyResponse:
    def __init__(self):
        self.payload: JobOrResultPushOperationClientResultSlimResponse = None
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_remediation_operation_slim_results_by_id_oapg(
        self,
        # GTO-EA-2-2
    ...
    def _get_remediation_operation_slim_results_by_id_oapg(
        ...
        """
        Gets the results of a given Remediation Operation.  <p>Remediation Operations may produce results such a Forensics Report or yield status updates such as an Anti-Malware scan progress.</p> <p>Note: this operation is a '<em>slim</em>' version, returning only essential information</p>
    
        API Parameters:
         - id: str - Mandatory placed in "path_params" param
         - x-mgmt-run-as-job: RunAsJobOn - Mandatory placed in "header_params" param
         - body: PushOperationResultsRequestSlim - Mandatory 
        """
        """
        Get the results of a given Remediation Operation.
        ...
        serialized_data = parameter.serialize('get_remediation_operation_slim_results_by_id', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_push_operation_results_request_slim.serialize(body, content_type)
        ...
        logger(f'Sending operation "get_remediation_operation_slim_results_by_id" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "get_remediation_operation_slim_results_by_id" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "get_remediation_operation_slim_results_by_id" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "get_remediation_operation_slim_results_by_id" url "{final_url}" with "{response_options}"')
...
class GetRemediationOperationSlimResultsById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names




    def get_remediation_operation_slim_results_by_id(
        self,
        # GTO-EA-1-2
        body: SchemaForRequestBodyApplicationJson,
        ...
        return self._get_remediation_operation_slim_results_by_id_oapg(
            body=body,
