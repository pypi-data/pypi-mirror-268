...
# body param
SchemaForRequestBodyApplicationJson = PushOperationRequestWithMandatoryParamsFetchQuarantinedFileParams


request_body_push_operation_request_with_mandatory_params_fetch_quarantined_file_params = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _quarantine_file_fetch_oapg(
        self,
        # GTO-EA-2-2
    ...
    def _quarantine_file_fetch_oapg(
        ...
        API Parameters:
         ...
         - body: PushOperationRequestWithMandatoryParamsFetchQuarantinedFileParams - Mandatory 
        """
        """
        ...
        serialized_data = parameter.serialize('quarantine_file_fetch', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_push_operation_request_with_mandatory_params_fetch_quarantined_file_params.serialize(body, content_type)
        ...
        logger(f'Sending operation "quarantine_file_fetch" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "quarantine_file_fetch" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "quarantine_file_fetch" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "quarantine_file_fetch" url "{final_url}" with "{response_options}"')
...
class QuarantineFileFetch(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names




    def quarantine_file_fetch(
        self,
        # GTO-EA-1-2
        body: SchemaForRequestBodyApplicationJson,
        ...
        return self._quarantine_file_fetch_oapg(
            body=body,
