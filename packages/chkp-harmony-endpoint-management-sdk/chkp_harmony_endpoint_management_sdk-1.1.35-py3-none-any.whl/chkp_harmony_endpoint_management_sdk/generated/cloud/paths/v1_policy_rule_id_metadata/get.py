...
SchemaFor200ResponseBodyApplicationJson = JobOrResultRuleMetadata
...
class HarmonyResponse:
    def __init__(self):
        self.payload: JobOrResultRuleMetadata = None
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_rule_metadata_by_id_oapg(
        self,
    ...
    def _get_rule_metadata_by_id_oapg(
        ...
        """
        Gets the given rule's metadata. <p>Metadata refers to all information relating to the rule except it's actual settings</p>
    
        API Parameters:
         - ruleId: str - Mandatory placed in "path_params" param, The ID of the rule to get the metadata of
        ...
        serialized_data = parameter.serialize('get_rule_metadata_by_id', prefix_separator_iterator)
        ...
        logger(f'Sending operation "get_rule_metadata_by_id" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "get_rule_metadata_by_id" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "get_rule_metadata_by_id" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "get_rule_metadata_by_id" url "{final_url}" with "{response_options}"')
...
class GetRuleMetadataById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names



    def get_rule_metadata_by_id(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        ...
        return self._get_rule_metadata_by_id_oapg(
