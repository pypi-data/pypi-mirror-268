...
# Query params
PageSizeSchema = PageSizeQuarantine
OffsetSchema = OffsetQuarantine
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'pageSize': typing.Union[PageSizeSchema, ],
        'offset': typing.Union[OffsetSchema, ],
    }
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_quarantine_file_data_oapg(
        self,
    ...
    def _get_quarantine_file_data_oapg(
        ...
        API Parameters:
         - pageSize: PageSizeQuarantine - Mandatory placed in "query_params" param
         - offset: OffsetQuarantine - Mandatory placed in "query_params" param
        ...
        serialized_data = parameter.serialize('get_quarantine_file_data', prefix_separator_iterator)
        for serialized_value in serialized_data.values():
            used_path += serialized_value
        ...
        logger(f'Sending operation "get_quarantine_file_data" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "get_quarantine_file_data" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "get_quarantine_file_data" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "get_quarantine_file_data" url "{final_url}" with "{response_options}"')
...
class GetQuarantineFileData(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names



    def get_quarantine_file_data(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        ...
        return self._get_quarantine_file_data_oapg(
