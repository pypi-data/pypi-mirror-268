...
# body param
SchemaForRequestBodyApplicationJson = QuarantineManagementFileByDeviceNameRequest


request_body_quarantine_management_file_by_device_name_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JobOrResultQuarantinedFileArray
...
class HarmonyResponse:
    def __init__(self):
        self.payload: JobOrResultQuarantinedFileArray = None
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_quarantine_file_data_by_device_oapg(
        self,
        # GTO-EA-2-2
    ...
    def _get_quarantine_file_data_by_device_oapg(
        ...
        API Parameters:
         ...
         - body: QuarantineManagementFileByDeviceNameRequest - Mandatory 
        """
        """
        ...
        serialized_data = parameter.serialize('get_quarantine_file_data_by_device', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_quarantine_management_file_by_device_name_request.serialize(body, content_type)
        ...
        logger(f'Sending operation "get_quarantine_file_data_by_device" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "get_quarantine_file_data_by_device" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "get_quarantine_file_data_by_device" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "get_quarantine_file_data_by_device" url "{final_url}" with "{response_options}"')
...
class GetQuarantineFileDataByDevice(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names




    def get_quarantine_file_data_by_device(
        self,
        # GTO-EA-1-2
        body: SchemaForRequestBodyApplicationJson,
        ...
        return self._get_quarantine_file_data_by_device_oapg(
            body=body,
