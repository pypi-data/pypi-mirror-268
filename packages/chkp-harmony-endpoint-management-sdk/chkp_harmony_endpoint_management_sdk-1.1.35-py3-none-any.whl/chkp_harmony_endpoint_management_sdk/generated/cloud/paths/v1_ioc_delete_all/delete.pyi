...
class BaseApi(api_client.Api):
    ...
    def _delete_all_ioc_oapg(
        ...
        """
        Deletes all existing Indicators of Compromise. <p>This action <b>permanently deletes</b> <b>all</b> Indicators of Compromise and <b>cannot be undone</b></p
    
        API Parameters:
         - x-mgmt-run-as-job: RunAsJob - Mandatory placed in "header_params" param
        """
        """
        Delete all existing Indicators of Compromise
        ...
        serialized_data = parameter.serialize('delete_all_ioc', prefix_separator_iterator)
        ...
        logger(f'Sending operation "delete_all_ioc" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "delete_all_ioc" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "delete_all_ioc" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "delete_all_ioc" url "{final_url}" with "{response_options}"')
...
class DeleteAllIoc(BaseApi):
    ...
    def delete_all_ioc(
        ...
        return self._delete_all_ioc_oapg(
