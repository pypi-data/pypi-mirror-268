...
SchemaFor200ResponseBodyApplicationJson = JobOrResultPushOperationStatus
...
class HarmonyResponse:
    def __init__(self):
        self.payload: JobOrResultPushOperationStatus = None
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_remediation_operation_status_by_id_oapg(
        self,
    ...
    def _get_remediation_operation_status_by_id_oapg(
        ...
        """
        """
        Get the status of a given Remediation Operation
        ...
        serialized_data = parameter.serialize('get_remediation_operation_status_by_id', prefix_separator_iterator)
        ...
        logger(f'Sending operation "get_remediation_operation_status_by_id" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "get_remediation_operation_status_by_id" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "get_remediation_operation_status_by_id" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "get_remediation_operation_status_by_id" url "{final_url}" with "{response_options}"')
...
class GetRemediationOperationStatusById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names



    def get_remediation_operation_status_by_id(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        ...
        return self._get_remediation_operation_status_by_id_oapg(
