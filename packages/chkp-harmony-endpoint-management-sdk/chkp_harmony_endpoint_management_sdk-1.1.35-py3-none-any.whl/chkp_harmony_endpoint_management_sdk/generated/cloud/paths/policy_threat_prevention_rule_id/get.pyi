...
# Query params
DetailsLevelSchema = DetailsLevel
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'detailsLevel': typing.Union[DetailsLevelSchema, ],
    },
    total=False
)
...
request_query_details_level = api_client.QueryParameter(
    name="detailsLevel",
    style=api_client.ParameterStyle.FORM,
    schema=DetailsLevelSchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = GetPolicyResult
...
class HarmonyResponse:
    def __init__(self):
        self.payload: GetPolicyResult = None
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_threat_prevention_policy_oapg(
        self,
    ...
    def _get_threat_prevention_policy_oapg(
        ...
        """
         Gets the Threat-Prevention policy of the given rule
    
        API Parameters:
         - ruleId: str - Mandatory placed in "path_params" param, The ID of the rule to get the Threat-Prevention policy of
         - x-mgmt-run-as-job: RunAsJobOn - Mandatory placed in "header_params" param
         - detailsLevel: DetailsLevel - placed in "query_params" param, The returned policy's detail level
        """
        """
        Get a rule&#x27;s Threat-Prevention policy
        ...
        serialized_data = parameter.serialize('get_threat_prevention_policy', prefix_separator_iterator)
        for serialized_value in serialized_data.values():
            used_path += serialized_value
        ...
        logger(f'Sending operation "get_threat_prevention_policy" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "get_threat_prevention_policy" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "get_threat_prevention_policy" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "get_threat_prevention_policy" url "{final_url}" with "{response_options}"')
...
class GetThreatPreventionPolicy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names



    def get_threat_prevention_policy(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        ...
        return self._get_threat_prevention_policy_oapg(
