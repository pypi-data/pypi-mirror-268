...
SchemaFor200ResponseBodyApplicationJson = PublicMachineStatusResponse
...
class HarmonyResponse:
    def __init__(self):
        self.payload: PublicMachineStatusResponse = None
...
class BaseApi(api_client.Api):
    @typing.overload
    def _public_machines_single_status_oapg(
        self,
    ...
    def _public_machines_single_status_oapg(
        ...
        """
        Return information about your tenant. Information will includes Endpoint servers status and other operational related data.
        ...
        serialized_data = parameter.serialize('public_machines_single_status', prefix_separator_iterator)
        ...
        logger(f'Sending operation "public_machines_single_status" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "public_machines_single_status" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "public_machines_single_status" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "public_machines_single_status" url "{final_url}" with "{response_options}"')
...
class PublicMachinesSingleStatus(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names



    def public_machines_single_status(
        self,
        ...
        return self._public_machines_single_status_oapg(
