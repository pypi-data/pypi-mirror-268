...
# body param
SchemaForRequestBodyApplicationJson = PublicManageEndpointsInput


request_body_public_manage_endpoints_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _manage_endpoint_instance_oapg(
        self,
        # GTO-EA-2-2
    ...
    def _manage_endpoint_instance_oapg(
        ...
        """
        Performs stop, start or restart operations on one or more endpoint servers. action can be one of [ 'START', 'STOP', 'RESTART' ]
    
        API Parameters:
         - body: PublicManageEndpointsInput - Mandatory 
        """
        """
        ...
        serialized_data = parameter.serialize('manage_endpoint_instance', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_public_manage_endpoints_input.serialize(body, content_type)
        ...
        logger(f'Sending operation "manage_endpoint_instance" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "manage_endpoint_instance" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "manage_endpoint_instance" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "manage_endpoint_instance" url "{final_url}" with "{response_options}"')
...
class ManageEndpointInstance(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names




    def manage_endpoint_instance(
        self,
        # GTO-EA-1-2
        body: SchemaForRequestBodyApplicationJson,
        ...
        return self._manage_endpoint_instance_oapg(
            body=body,
