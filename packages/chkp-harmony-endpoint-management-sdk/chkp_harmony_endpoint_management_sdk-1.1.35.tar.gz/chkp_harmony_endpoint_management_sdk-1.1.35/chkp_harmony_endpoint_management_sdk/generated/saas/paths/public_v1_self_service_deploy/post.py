...
# body param
SchemaForRequestBodyApplicationJson = DeploymentSingleInput


request_body_deployment_single_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PortalGeneralResponse
...
class HarmonyResponse:
    def __init__(self):
        self.payload: PortalGeneralResponse = None
...
class BaseApi(api_client.Api):
    @typing.overload
    def _public_deploy_single_endpoint_instance_oapg(
        self,
        # GTO-EA-2-2
    ...
    def _public_deploy_single_endpoint_instance_oapg(
        ...
        """
        Use to deploy Harmony Endpoint servers. machineName: is not mandatory, machine name will be part of server FQDN. appType: epsPlatform - for Harmony Endpoint, sba4b - for Browse only server. Warning! this operation limit for 5 in an hour.
    
        API Parameters:
         - body: DeploymentSingleInput - Mandatory 
        """
        """
        ...
        serialized_data = parameter.serialize('public_deploy_single_endpoint_instance', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_deployment_single_input.serialize(body, content_type)
        ...
        logger(f'Sending operation "public_deploy_single_endpoint_instance" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "public_deploy_single_endpoint_instance" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "public_deploy_single_endpoint_instance" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "public_deploy_single_endpoint_instance" url "{final_url}" with "{response_options}"')
...
class PublicDeploySingleEndpointInstance(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names




    def public_deploy_single_endpoint_instance(
        self,
        # GTO-EA-1-2
        body: SchemaForRequestBodyApplicationJson,
        ...
        return self._public_deploy_single_endpoint_instance_oapg(
            body=body,
