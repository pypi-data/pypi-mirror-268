...
class BaseApi(api_client.Api):
    @typing.overload
    def _abort_remediation_operation_by_id_oapg(
        self,
    ...
    def _abort_remediation_operation_by_id_oapg(
        ...
        """
        Aborts the given Remediation Operation. <p>Aborting an operation prevents it from being sent to further Harmony Endpoint Clients.</p> <p>Clients that have already received the operation are not affected</p>
        ...
        """
        """
        Abort a given Remediation Operation
        ...
        serialized_data = parameter.serialize('abort_remediation_operation_by_id', prefix_separator_iterator)
        ...
        logger(f'Sending operation "abort_remediation_operation_by_id" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "abort_remediation_operation_by_id" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "abort_remediation_operation_by_id" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "abort_remediation_operation_by_id" url "{final_url}" with "{response_options}"')
...
class AbortRemediationOperationById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names



    def abort_remediation_operation_by_id(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        ...
        return self._abort_remediation_operation_by_id_oapg(
