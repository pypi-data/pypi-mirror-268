...
# Query params
TemplateSchema = PolicyTemplateName
InstallPolicySchema = schemas.BoolSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'template': TemplateSchema # GTO-EPSAD-1-1,
    }
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_threat_prevention_policy_template_oapg(
        self,
    ...
    def _set_threat_prevention_policy_template_oapg(
        ...
        """
        Sets the Threat-Prevention policy template for the given rule.  <p> Setting a template instructs the policy to adhere to the Check Point's recommended configuration </p>
    
        API Parameters:
         - ruleId: str - Mandatory placed in "path_params" param, The ID of the rule to update the Threat-Prevention policy or template of
         - x-mgmt-run-as-job: RunAsJobOn - Mandatory placed in "header_params" param
         - template: PolicyTemplateName - Mandatory placed in "query_params" param, The template to which the given Threat-Prevention rule should adhere
        ...
        """
        """
        Sets a rule&#x27;s Threat-Prevention policy template
        ...
        serialized_data = parameter.serialize('set_threat_prevention_policy_template', prefix_separator_iterator)
        for serialized_value in serialized_data.values():
            used_path += serialized_value
        ...
        logger(f'Sending operation "set_threat_prevention_policy_template" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "set_threat_prevention_policy_template" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "set_threat_prevention_policy_template" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "set_threat_prevention_policy_template" url "{final_url}" with "{response_options}"')
...
class SetThreatPreventionPolicyTemplate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names



    def set_threat_prevention_policy_template(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        ...
        return self._set_threat_prevention_policy_template_oapg(
