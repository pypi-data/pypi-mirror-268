...
# body param
SchemaForRequestBodyApplicationJson = IocPagedRequest


request_body_ioc_paged_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JobOrResultPageOfIoc
...
class HarmonyResponse:
    def __init__(self):
        self.payload: JobOrResultPageOfIoc = None
...
class BaseApi(api_client.Api):
    ...
    def _get_ioc_paged_oapg(
        ...
        """
        Gets a list of Indicators of Compromise matching the given parameters
    
        API Parameters:
         - x-mgmt-run-as-job: RunAsJob - Mandatory placed in "header_params" param
         - body: IocPagedRequest - Mandatory 
        """
        """
        Get existing Indicators of Compromise
        ...
        serialized_data = parameter.serialize('get_ioc_paged', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ioc_paged_request.serialize(body, content_type)
        ...
        logger(f'Sending operation "get_ioc_paged" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "get_ioc_paged" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "get_ioc_paged" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "get_ioc_paged" url "{final_url}" with "{response_options}"')
...
class GetIocPaged(BaseApi):
    ...
    def get_ioc_paged(
        ...
        return self._get_ioc_paged_oapg(
            body=body,
