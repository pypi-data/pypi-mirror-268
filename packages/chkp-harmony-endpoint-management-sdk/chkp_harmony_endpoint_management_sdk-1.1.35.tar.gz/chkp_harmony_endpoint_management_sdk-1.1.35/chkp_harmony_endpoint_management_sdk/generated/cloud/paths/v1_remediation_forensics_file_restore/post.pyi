...
# body param
SchemaForRequestBodyApplicationJson = PushOperationRequestWithMandatoryParamsForensicsQuarantineOperationParams


request_body_push_operation_request_with_mandatory_params_forensics_quarantine_operation_params = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _restore_quarantined_file_oapg(
        self,
        # GTO-EA-2-2
    ...
    def _restore_quarantined_file_oapg(
        ...
        API Parameters:
         ...
         - body: PushOperationRequestWithMandatoryParamsForensicsQuarantineOperationParams - Mandatory 
        """
        """
        Restore given file from quarantine on computers matching a given query
        ...
        serialized_data = parameter.serialize('restore_quarantined_file', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_push_operation_request_with_mandatory_params_forensics_quarantine_operation_params.serialize(body, content_type)
        ...
        logger(f'Sending operation "restore_quarantined_file" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "restore_quarantined_file" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "restore_quarantined_file" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "restore_quarantined_file" url "{final_url}" with "{response_options}"')
...
class RestoreQuarantinedFile(BaseApi):
    ...
    def restore_quarantined_file(
        ...
        return self._restore_quarantined_file_oapg(
            body=body,
