...
# body param
SchemaForRequestBodyApplicationJson = PushOperationRequestWithMandatoryParamsDeleteFileParams


request_body_push_operation_request_with_mandatory_params_delete_file_params = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _agent_delete_file_oapg(
        ...
        API Parameters:
         ...
         - body: PushOperationRequestWithMandatoryParamsDeleteFileParams - Mandatory 
        """
        """
        Delete a given file on computers matching the given query
        ...
        serialized_data = parameter.serialize('agent_delete_file', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_push_operation_request_with_mandatory_params_delete_file_params.serialize(body, content_type)
        ...
        logger(f'Sending operation "agent_delete_file" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "agent_delete_file" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "agent_delete_file" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "agent_delete_file" url "{final_url}" with "{response_options}"')
...
class AgentDeleteFile(BaseApi):
    ...
    def agent_delete_file(
        ...
        return self._agent_delete_file_oapg(
            body=body,
