...
# body param
SchemaForRequestBodyApplicationJson = SearchInOrganizationRequest


request_body_search_in_organization_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = JobOrResultSlimEntityArray
...
class ApiResponseFor201(api_client.ApiResponse):
    ...
    # GTO-E-1-2
    body: SchemaFor201ResponseBodyApplicationJson
...
class HarmonyResponse:
    def __init__(self):
        self.payload: JobOrResultSlimEntityArray = None
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_in_organization_oapg(
        self,
        # GTO-EA-2-2
    ...
    def _search_in_organization_oapg(
        ...
        """
        Searches the organization for entities matching the given query
    
        API Parameters:
         - x-mgmt-run-as-job: RunAsJob - Mandatory placed in "header_params" param
         - body: SearchInOrganizationRequest - Mandatory 
        """
        """
        Search the organization for entities matching a query
        ...
        serialized_data = parameter.serialize('search_in_organization', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_search_in_organization_request.serialize(body, content_type)
        ...
        logger(f'Sending operation "search_in_organization" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "search_in_organization" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "search_in_organization" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "search_in_organization" url "{final_url}" with "{response_options}"')
...
class SearchInOrganization(BaseApi):
    ...
    def search_in_organization(
        ...
        return self._search_in_organization_oapg(
            body=body,
