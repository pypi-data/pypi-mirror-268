...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UpdateIoc']:
            return UpdateIoc

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UpdateIoc'], typing.List['UpdateIoc']],
    ...
    def __getitem__(self, i: int) -> 'UpdateIoc':
        return super().__getitem__(i)


request_body_update_ioc = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _edit_ioc_oapg(
        ...
        API Parameters:
         ...
         - body: [UpdateIoc] - Mandatory 
        """
        """
        Update existing Indicators of Compromise
        ...
        serialized_data = parameter.serialize('edit_ioc', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_ioc.serialize(body, content_type)
        ...
        logger(f'Sending operation "edit_ioc" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "edit_ioc" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "edit_ioc" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "edit_ioc" url "{final_url}" with "{response_options}"')
