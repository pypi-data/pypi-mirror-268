...
# body param
SchemaForRequestBodyApplicationJson = PushOperationRequestBasePushOperationParameters


request_body_push_operation_request_base_push_operation_parameters = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _repair_computer_oapg(
        ...
        API Parameters:
         ...
         - body: PushOperationRequestBasePushOperationParameters - Mandatory 
        """
        """
        Repair client installations on computers matching a given query
        ...
        serialized_data = parameter.serialize('repair_computer', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_push_operation_request_base_push_operation_parameters.serialize(body, content_type)
        ...
        logger(f'Sending operation "repair_computer" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "repair_computer" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "repair_computer" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "repair_computer" url "{final_url}" with "{response_options}"')
...
class RepairComputer(BaseApi):
    ...
    def repair_computer(
        ...
        return self._repair_computer_oapg(
            body=body,
