...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['IndicatorOfCompromiseDto']:
            return IndicatorOfCompromiseDto

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['IndicatorOfCompromiseDto'], typing.List['IndicatorOfCompromiseDto']],
    ...
    def __getitem__(self, i: int) -> 'IndicatorOfCompromiseDto':
        return super().__getitem__(i)


request_body_indicator_of_compromise_dto = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JobOrResultIndicatorOfCompromiseArray
...
class HarmonyResponse:
    def __init__(self):
        self.payload: JobOrResultIndicatorOfCompromiseArray = None
...
class BaseApi(api_client.Api):
    ...
    def _create_ioc_oapg(
        ...
        API Parameters:
         ...
         - body: [IndicatorOfCompromiseDto] - Mandatory 
        """
        """
        Create new Indicators of Compromise
        ...
        serialized_data = parameter.serialize('create_ioc', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_indicator_of_compromise_dto.serialize(body, content_type)
        ...
        logger(f'Sending operation "create_ioc" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "create_ioc" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "create_ioc" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "create_ioc" url "{final_url}" with "{response_options}"')
