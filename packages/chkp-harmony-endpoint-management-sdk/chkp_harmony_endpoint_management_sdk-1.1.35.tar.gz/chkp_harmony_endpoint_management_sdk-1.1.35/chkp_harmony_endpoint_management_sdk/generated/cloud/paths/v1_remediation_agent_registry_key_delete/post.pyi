...
# body param
SchemaForRequestBodyApplicationJson = PushOperationRequestWithMandatoryParamsRemoveRegistryKeyParams


request_body_push_operation_request_with_mandatory_params_remove_registry_key_params = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _agent_remove_registry_key_oapg(
        self,
        # GTO-EA-2-2
    ...
    def _agent_remove_registry_key_oapg(
        ...
        API Parameters:
         ...
         - body: PushOperationRequestWithMandatoryParamsRemoveRegistryKeyParams - Mandatory 
        """
        """
        Remove a registry key or value to computers matching the given query
        ...
        serialized_data = parameter.serialize('agent_remove_registry_key', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_push_operation_request_with_mandatory_params_remove_registry_key_params.serialize(body, content_type)
        ...
        logger(f'Sending operation "agent_remove_registry_key" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "agent_remove_registry_key" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "agent_remove_registry_key" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "agent_remove_registry_key" url "{final_url}" with "{response_options}"')
...
class AgentRemoveRegistryKey(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names




    def agent_remove_registry_key(
        self,
        # GTO-EA-1-2
        body: SchemaForRequestBodyApplicationJson,
        ...
        return self._agent_remove_registry_key_oapg(
            body=body,
