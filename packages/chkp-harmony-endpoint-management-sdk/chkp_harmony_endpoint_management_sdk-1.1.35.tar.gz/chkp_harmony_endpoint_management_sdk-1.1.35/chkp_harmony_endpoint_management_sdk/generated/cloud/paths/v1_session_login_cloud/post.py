...
x_mgmt_session_expiry_utc_epoch_parameter = api_client.HeaderParameter(
    name="x-mgmt-session-expiry-utc-epoch",
    style=api_client.ParameterStyle.SIMPLE,
    schema=XMgmtSessionExpiryUtcEpochSchema,
    required=True,
)
...
x_mgmt_api_token_parameter = api_client.HeaderParameter(
    name="x-mgmt-api-token",
    style=api_client.ParameterStyle.SIMPLE,
    schema=XMgmtApiTokenSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _login_cloud_oapg(
        ...
        serialized_data = parameter.serialize('login_cloud', prefix_separator_iterator)
