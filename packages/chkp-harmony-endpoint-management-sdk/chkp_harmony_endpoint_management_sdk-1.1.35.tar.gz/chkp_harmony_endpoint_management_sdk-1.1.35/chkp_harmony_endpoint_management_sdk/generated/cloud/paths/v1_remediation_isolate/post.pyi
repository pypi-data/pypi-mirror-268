...
class BaseApi(api_client.Api):
    ...
    def _isolate_computer_oapg(
        ...
        """
        Isolates the computers matching the given query. <p>Isolation is the act of denying all network access from a given computer</p>
        ...
        """
        """
        Isolate computers matching a given query
        ...
        serialized_data = parameter.serialize('isolate_computer', prefix_separator_iterator)
        ...
        logger(f'Sending operation "isolate_computer" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "isolate_computer" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "isolate_computer" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "isolate_computer" url "{final_url}" with "{response_options}"')
...
class IsolateComputer(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names




    def isolate_computer(
        self,
        # GTO-EA-1-2
        body: SchemaForRequestBodyApplicationJson,
        ...
        return self._isolate_computer_oapg(
            body=body,
