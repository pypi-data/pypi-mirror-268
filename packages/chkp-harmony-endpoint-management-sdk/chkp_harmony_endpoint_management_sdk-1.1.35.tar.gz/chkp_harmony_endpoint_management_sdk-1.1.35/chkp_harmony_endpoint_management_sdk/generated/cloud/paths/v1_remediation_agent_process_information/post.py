...
# body param
SchemaForRequestBodyApplicationJson = PushOperationRequestCollectProcessInformationParams


request_body_push_operation_request_collect_process_information_params = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _agent_collect_process_information_oapg(
        self,
        # GTO-EA-2-2
    ...
    def _agent_collect_process_information_oapg(
        ...
        API Parameters:
         ...
         - body: PushOperationRequestCollectProcessInformationParams - Mandatory 
        """
        """
        Collect information about processes on computers matching the given query
        ...
        serialized_data = parameter.serialize('agent_collect_process_information', prefix_separator_iterator)
        ...
        _fields = None
        _body = None
        serialized_data = request_body_push_operation_request_collect_process_information_params.serialize(body, content_type)
        ...
        logger(f'Sending operation "agent_collect_process_information" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "agent_collect_process_information" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "agent_collect_process_information" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "agent_collect_process_information" url "{final_url}" with "{response_options}"')
...
class AgentCollectProcessInformation(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names




    def agent_collect_process_information(
        self,
        # GTO-EA-1-2
        body: SchemaForRequestBodyApplicationJson,
        ...
        return self._agent_collect_process_information_oapg(
            body=body,
