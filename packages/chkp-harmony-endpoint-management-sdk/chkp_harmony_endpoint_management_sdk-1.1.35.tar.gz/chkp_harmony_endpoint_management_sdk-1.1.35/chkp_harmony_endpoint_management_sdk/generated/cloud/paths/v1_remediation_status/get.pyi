...
SchemaFor200ResponseBodyApplicationJson = JobOrResultPushOperationStatusArray
...
class HarmonyResponse:
    def __init__(self):
        self.payload: JobOrResultPushOperationStatusArray = None
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_remediation_operation_statuses_oapg(
        self,
    ...
    def _get_all_remediation_operation_statuses_oapg(
        ...
        """
        Gets the current statuses of all Remediation Operations
    
        API Parameters:
         - x-mgmt-run-as-job: RunAsJobOn - Mandatory placed in "header_params" param
        """
        """
        Get the status of all Remediation Operations
        ...
        serialized_data = parameter.serialize('get_all_remediation_operation_statuses', prefix_separator_iterator)
        ...
        logger(f'Sending operation "get_all_remediation_operation_statuses" url "{final_url}" ...')
        ...
        try:
            ...
            error_logger(f'Receiving operation "get_all_remediation_operation_statuses" communication error for url "{final_url}" with status, reason "{e.reason}"')
        ...
        logger(f'Receiving operation "get_all_remediation_operation_statuses" url "{final_url}" with status code "{response.status}"')
        network_logger(f'Receiving "{final_url}" with options: "{response_options}"')
    
        if not 200 <= response.status <= 299:
            error_logger(f'Receiving error operation "get_all_remediation_operation_statuses" url "{final_url}" with "{response_options}"')
...
class GetAllRemediationOperationStatuses(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names



    def get_all_remediation_operation_statuses(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        ...
        return self._get_all_remediation_operation_statuses_oapg(
