...
T = TypeVar("T", bound="BodyLoginForAccessTokenUsersTokenPost")


@_attrs_define
class BodyLoginForAccessTokenUsersTokenPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_login_for_access_token_users_token_post = cls(
            username=username,
            password=password,
        ...
        body_login_for_access_token_users_token_post.additional_properties = d
        return body_login_for_access_token_users_token_post
