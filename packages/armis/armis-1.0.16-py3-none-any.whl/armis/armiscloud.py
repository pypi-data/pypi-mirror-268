...
class ArmisCloud:
    ...
    def __init__(self, **kwargs) -> None:  # type: ignore[no-untyped-def]
        ...
        api_page_size : int
            Page size to use when talking to the Armis cloud, maximum is 5,000.
        tenant_hostname : str
            The hostname of the Armis cloud tenant, e.g. customer.armis.com
        log_level : {'INFO','CRITICAL','ERROR','WARNING','DEBUG','NOTSET'}
        ...
        Notes
        -----
        If you provide your own `temporary_directory`, you will need to empty this directory
        yourself.
        """
    ...
    def get_boundary(self, **kwargs):
        ...
        NB The cloud must be running at version >= R-23.3-S182.
    ...
    def get_collector(self, collector_id: int) -> dict:
        ...
        if collector_request.status_code != 200:
    ...
    def get_collectors(self):
        ...
        while url.args["from"] is not None:
            ...
            if get_collectors_request.status_code != 200:
                self.log.critical("STATUS CODE !=200")
                self.log.critical(
                    "status_code=%s",
