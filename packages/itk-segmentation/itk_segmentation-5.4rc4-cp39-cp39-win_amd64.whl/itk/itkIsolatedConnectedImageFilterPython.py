...
def isolated_connected_image_filter(*args: itkt.ImageLike,  seed1: Sequence[int]=..., seed2: Sequence[int]=..., lower: float=..., upper: float=..., isolated_value_tolerance: float=..., replace_value: float=..., find_upper_threshold: bool=...,**kwargs)-> itkt.ImageSourceReturn:
