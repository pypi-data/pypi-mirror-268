...
def create_acl_xml(event_id: str, role_right_tuples: List[Tuple[str, str]], output: Optional[str] = None):
    d = {"Policy": {"@PolicyId": event_id, "@Version": "2.0",
                    "@RuleCombiningAlgId": "urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:permit-overrides",
                    "@xmlns": "urn:oasis:names:tc:xacml:2.0:policy:schema:os",
                    "Target": {"Resources": {"Resource": {"ResourceMatch": {
                        "@MatchId": "urn:oasis:names:tc:xacml:1.0:function:string-equal",
                        "AttributeValue": {"@DataType": "http://www.w3.org/2001/XMLSchema#string", "#text": event_id},
...
def main():
    ...
    create_acl_xml("event_id", [("ROLE_USER_ADMIN", "read"), ("ROLE_USER_ADMIN", "write")], output="/tmp/test")
