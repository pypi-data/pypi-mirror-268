...
def index_flat_map_dataset(input_dataset: Annotated[Any, _atypes.Variant], map_func_other_args, index_map_func_other_args, map_func, index_map_func, output_types, output_shapes, metadata:str="", name=None) -> Annotated[Any, _atypes.Variant]:
  r"""TODO: add doc.
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        ...
        index_map_func_other_args, "map_func", map_func, "index_map_func",
        index_map_func, "output_types", output_types, "output_shapes",
    ...
    try:
      return index_flat_map_dataset_eager_fallback(
          ...
          map_func=map_func, index_map_func=index_map_func,
          output_types=output_types, output_shapes=output_shapes,
          metadata=metadata, name=name, ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
...
def index_flat_map_dataset_eager_fallback(input_dataset: Annotated[Any, _atypes.Variant], map_func_other_args, index_map_func_other_args, map_func, index_map_func, output_types, output_shapes, metadata: str, name, ctx) -> Annotated[Any, _atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'index_flat_map_dataset' Op, not %r." % output_types)
  ...
  input_dataset = _ops.convert_to_tensor(input_dataset, _dtypes.variant)
  _inputs_flat = [input_dataset] + list(map_func_other_args) + list(index_map_func_other_args)
