...
class _UniffiRustBuffer(ctypes.Structure):
    ...
    @staticmethod
    def alloc(size):
        return _rust_call(_UniffiLib.ffi_rgblibffi_rustbuffer_alloc, size)

    @staticmethod
    def reserve(rbuf, additional):
        return _rust_call(_UniffiLib.ffi_rgblibffi_rustbuffer_reserve, rbuf, additional)

    def free(self):
        return _rust_call(_UniffiLib.ffi_rgblibffi_rustbuffer_free, self)
...
def _uniffi_check_contract_api_version(lib):
    ...
    scaffolding_contract_version = lib.ffi_rgblibffi_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version:
        raise InternalError("UniFFI contract version mismatch: try cleaning and rebuilding your project")

def _uniffi_check_api_checksums(lib):
    if lib.uniffi_rgblibffi_checksum_func_generate_keys() != 64259:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_func_restore_backup() != 15101:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_func_restore_keys() != 42405:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_invoice_invoice_data() != 11706:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_invoice_invoice_string() != 49576:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_transportendpoint_transport_type() != 52347:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_backup() != 60293:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_backup_info() != 938:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_blind_receive() != 34365:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_create_utxos() != 59455:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_create_utxos_begin() != 58076:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_create_utxos_end() != 37296:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_delete_transfers() != 55560:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_drain_to() != 28781:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_drain_to_begin() != 37910:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_drain_to_end() != 19119:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_fail_transfers() != 24813:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_get_address() != 51506:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_get_asset_balance() != 34628:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_get_asset_metadata() != 33881:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_get_btc_balance() != 29947:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_go_online() != 36143:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_issue_asset_cfa() != 10376:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_issue_asset_nia() != 17069:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_issue_asset_uda() != 56590:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_list_assets() != 46965:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_list_transactions() != 56257:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_list_transfers() != 36467:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_list_unspents() != 4224:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_refresh() != 41719:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_send() != 54460:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_send_begin() != 21520:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_send_btc() != 47940:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_send_btc_begin() != 31034:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_send_btc_end() != 58866:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_send_end() != 34331:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_sign_psbt() != 29982:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_witness_receive() != 47965:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_constructor_invoice_from_invoice_data() != 43541:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_constructor_invoice_new() != 56538:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_constructor_recipientinfo_new() != 42681:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_constructor_transportendpoint_new() != 1325:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_constructor_wallet_new() != 55128:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_rgblibffi_fn_clone_invoice.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_clone_invoice.restype = ctypes.c_void_p
_UniffiLib.uniffi_rgblibffi_fn_free_invoice.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_free_invoice.restype = None
_UniffiLib.uniffi_rgblibffi_fn_constructor_invoice_from_invoice_data.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_constructor_invoice_from_invoice_data.restype = ctypes.c_void_p
_UniffiLib.uniffi_rgblibffi_fn_constructor_invoice_new.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_constructor_invoice_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_rgblibffi_fn_method_invoice_invoice_data.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_invoice_invoice_data.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_invoice_invoice_string.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_invoice_invoice_string.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_clone_recipientinfo.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_clone_recipientinfo.restype = ctypes.c_void_p
_UniffiLib.uniffi_rgblibffi_fn_free_recipientinfo.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_free_recipientinfo.restype = None
_UniffiLib.uniffi_rgblibffi_fn_constructor_recipientinfo_new.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_constructor_recipientinfo_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_rgblibffi_fn_clone_transportendpoint.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_clone_transportendpoint.restype = ctypes.c_void_p
_UniffiLib.uniffi_rgblibffi_fn_free_transportendpoint.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_free_transportendpoint.restype = None
_UniffiLib.uniffi_rgblibffi_fn_constructor_transportendpoint_new.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_constructor_transportendpoint_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_rgblibffi_fn_method_transportendpoint_transport_type.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_transportendpoint_transport_type.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_clone_wallet.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_clone_wallet.restype = ctypes.c_void_p
_UniffiLib.uniffi_rgblibffi_fn_free_wallet.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_free_wallet.restype = None
_UniffiLib.uniffi_rgblibffi_fn_constructor_wallet_new.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_constructor_wallet_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_backup.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_backup.restype = None
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_backup_info.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_backup_info.restype = ctypes.c_int8
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_blind_receive.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_blind_receive.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_create_utxos.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_int8,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_create_utxos.restype = ctypes.c_uint8
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_create_utxos_begin.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_int8,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_create_utxos_begin.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_create_utxos_end.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_create_utxos_end.restype = ctypes.c_uint8
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_delete_transfers.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_int8,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_delete_transfers.restype = ctypes.c_int8
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_drain_to.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.c_int8,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_drain_to.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_drain_to_begin.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.c_int8,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_drain_to_begin.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_drain_to_end.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_drain_to_end.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_fail_transfers.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.c_int8,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_fail_transfers.restype = ctypes.c_int8
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_address.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_address.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_asset_balance.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_asset_balance.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_asset_metadata.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_asset_metadata.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_btc_balance.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_btc_balance.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_go_online.argtypes = (
    ctypes.c_void_p,
    ctypes.c_int8,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_go_online.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_issue_asset_cfa.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_issue_asset_cfa.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_issue_asset_nia.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_issue_asset_nia.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_issue_asset_uda.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_issue_asset_uda.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_assets.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_assets.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_transactions.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_transactions.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_transfers.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_transfers.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_unspents.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_int8,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_unspents.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_refresh.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_refresh.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.c_int8,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_begin.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.c_int8,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_begin.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_btc.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.c_uint64,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_btc.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_btc_begin.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.c_uint64,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_btc_begin.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_btc_end.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_btc_end.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_end.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_end.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_sign_psbt.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_sign_psbt.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_witness_receive.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_witness_receive.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_func_generate_keys.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_func_generate_keys.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_func_restore_backup.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_func_restore_backup.restype = None
_UniffiLib.uniffi_rgblibffi_fn_func_restore_keys.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_func_restore_keys.restype = _UniffiRustBuffer
_UniffiLib.ffi_rgblibffi_rustbuffer_alloc.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rustbuffer_alloc.restype = _UniffiRustBuffer
_UniffiLib.ffi_rgblibffi_rustbuffer_from_bytes.argtypes = (
    _UniffiForeignBytes,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rustbuffer_from_bytes.restype = _UniffiRustBuffer
_UniffiLib.ffi_rgblibffi_rustbuffer_free.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rustbuffer_free.restype = None
_UniffiLib.ffi_rgblibffi_rustbuffer_reserve.argtypes = (
    _UniffiRustBuffer,
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rustbuffer_reserve.restype = _UniffiRustBuffer
_UniffiLib.ffi_rgblibffi_rust_future_poll_u8.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_u8.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_u8.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_u8.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_u8.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_u8.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_u8.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_u8.restype = ctypes.c_uint8
_UniffiLib.ffi_rgblibffi_rust_future_poll_i8.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_i8.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_i8.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_i8.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_i8.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_i8.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_i8.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_i8.restype = ctypes.c_int8
_UniffiLib.ffi_rgblibffi_rust_future_poll_u16.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_u16.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_u16.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_u16.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_u16.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_u16.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_u16.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_u16.restype = ctypes.c_uint16
_UniffiLib.ffi_rgblibffi_rust_future_poll_i16.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_i16.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_i16.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_i16.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_i16.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_i16.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_i16.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_i16.restype = ctypes.c_int16
_UniffiLib.ffi_rgblibffi_rust_future_poll_u32.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_u32.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_u32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_u32.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_u32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_u32.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_u32.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_u32.restype = ctypes.c_uint32
_UniffiLib.ffi_rgblibffi_rust_future_poll_i32.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_i32.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_i32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_i32.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_i32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_i32.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_i32.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_i32.restype = ctypes.c_int32
_UniffiLib.ffi_rgblibffi_rust_future_poll_u64.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_u64.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_u64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_u64.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_u64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_u64.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_u64.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_u64.restype = ctypes.c_uint64
_UniffiLib.ffi_rgblibffi_rust_future_poll_i64.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_i64.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_i64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_i64.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_i64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_i64.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_i64.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_i64.restype = ctypes.c_int64
_UniffiLib.ffi_rgblibffi_rust_future_poll_f32.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_f32.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_f32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_f32.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_f32.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_f32.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_f32.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_f32.restype = ctypes.c_float
_UniffiLib.ffi_rgblibffi_rust_future_poll_f64.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_f64.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_f64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_f64.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_f64.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_f64.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_f64.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_f64.restype = ctypes.c_double
_UniffiLib.ffi_rgblibffi_rust_future_poll_pointer.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_pointer.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_pointer.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_pointer.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_pointer.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_pointer.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_pointer.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_pointer.restype = ctypes.c_void_p
_UniffiLib.ffi_rgblibffi_rust_future_poll_rust_buffer.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_rust_buffer.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_rust_buffer.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_rust_buffer.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_rust_buffer.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_rust_buffer.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_rust_buffer.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_rust_buffer.restype = _UniffiRustBuffer
_UniffiLib.ffi_rgblibffi_rust_future_poll_void.argtypes = (
    ctypes.c_uint64,
    UNIFFI_RUST_FUTURE_CONTINUATION_CALLBACK,
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_poll_void.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_cancel_void.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_cancel_void.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_free_void.argtypes = (
    ctypes.c_uint64,
)
_UniffiLib.ffi_rgblibffi_rust_future_free_void.restype = None
_UniffiLib.ffi_rgblibffi_rust_future_complete_void.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.ffi_rgblibffi_rust_future_complete_void.restype = None
_UniffiLib.uniffi_rgblibffi_checksum_func_generate_keys.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_func_generate_keys.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_func_restore_backup.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_func_restore_backup.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_func_restore_keys.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_func_restore_keys.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_invoice_invoice_data.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_invoice_invoice_data.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_invoice_invoice_string.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_invoice_invoice_string.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_transportendpoint_transport_type.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_transportendpoint_transport_type.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_backup.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_backup.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_backup_info.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_backup_info.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_blind_receive.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_blind_receive.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_create_utxos.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_create_utxos.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_create_utxos_begin.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_create_utxos_begin.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_create_utxos_end.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_create_utxos_end.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_delete_transfers.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_delete_transfers.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_drain_to.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_drain_to.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_drain_to_begin.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_drain_to_begin.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_drain_to_end.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_drain_to_end.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_fail_transfers.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_fail_transfers.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_address.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_address.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_asset_balance.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_asset_balance.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_asset_metadata.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_asset_metadata.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_btc_balance.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_btc_balance.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_go_online.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_go_online.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_issue_asset_cfa.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_issue_asset_cfa.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_issue_asset_nia.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_issue_asset_nia.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_issue_asset_uda.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_issue_asset_uda.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_list_assets.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_list_assets.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_list_transactions.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_list_transactions.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_list_transfers.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_list_transfers.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_list_unspents.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_list_unspents.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_refresh.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_refresh.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send_begin.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send_begin.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send_btc.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send_btc.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send_btc_begin.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send_btc_begin.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send_btc_end.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send_btc_end.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send_end.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_send_end.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_sign_psbt.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_sign_psbt.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_witness_receive.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_witness_receive.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_constructor_invoice_from_invoice_data.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_constructor_invoice_from_invoice_data.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_constructor_invoice_new.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_constructor_invoice_new.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_constructor_recipientinfo_new.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_constructor_recipientinfo_new.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_constructor_transportendpoint_new.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_constructor_transportendpoint_new.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_constructor_wallet_new.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_constructor_wallet_new.restype = ctypes.c_uint16
_UniffiLib.ffi_rgblibffi_uniffi_contract_version.argtypes = (
)
_UniffiLib.ffi_rgblibffi_uniffi_contract_version.restype = ctypes.c_uint32
...
class Invoice:
    ...
    def __init__(self, invoice_string: "str"):
        ...
        self._pointer = _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_constructor_invoice_new,
    ...
    def __del__(self):
        ...
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_free_invoice, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_rgblibffi_fn_clone_invoice, self._pointer)
    ...
    def from_invoice_data(cls, invoice_data: "InvoiceData"):
        ...
        pointer = _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_constructor_invoice_from_invoice_data,
    ...
    def invoice_data(self, ) -> "InvoiceData":
        return _UniffiConverterTypeInvoiceData.lift(
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_method_invoice_invoice_data,self._uniffi_clone_pointer(),)
        )
    ...
    def invoice_string(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_method_invoice_invoice_string,self._uniffi_clone_pointer(),)
        )
...
class RecipientInfo:
    ...
    def __init__(self, recipient_id: "str"):
        ...
        self._pointer = _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_constructor_recipientinfo_new,
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_free_recipientinfo, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_rgblibffi_fn_clone_recipientinfo, self._pointer)
...
class TransportEndpoint:
    ...
    def __init__(self, transport_endpoint: "str"):
        ...
        self._pointer = _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_constructor_transportendpoint_new,
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_free_transportendpoint, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_rgblibffi_fn_clone_transportendpoint, self._pointer)
    ...
    def transport_type(self, ) -> "TransportType":
        return _UniffiConverterTypeTransportType.lift(
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_method_transportendpoint_transport_type,self._uniffi_clone_pointer(),)
        )
...
class WalletProtocol(typing.Protocol):
    ...
    def blind_receive(self, asset_id: "typing.Optional[str]",amount: "typing.Optional[int]",duration_seconds: "typing.Optional[int]",transport_endpoints: "typing.List[str]",min_confirmations: "int"):
        raise NotImplementedError
    def create_utxos(self, online: "Online",up_to: "bool",num: "typing.Optional[int]",size: "typing.Optional[int]",fee_rate: "float"):
        raise NotImplementedError
    def create_utxos_begin(self, online: "Online",up_to: "bool",num: "typing.Optional[int]",size: "typing.Optional[int]",fee_rate: "float"):
        raise NotImplementedError
    def create_utxos_end(self, online: "Online",signed_psbt: "str"):
        raise NotImplementedError
    def delete_transfers(self, batch_transfer_idx: "typing.Optional[int]",no_asset_only: "bool"):
        raise NotImplementedError
    def drain_to(self, online: "Online",address: "str",destroy_assets: "bool",fee_rate: "float"):
        raise NotImplementedError
    def drain_to_begin(self, online: "Online",address: "str",destroy_assets: "bool",fee_rate: "float"):
        raise NotImplementedError
    def drain_to_end(self, online: "Online",signed_psbt: "str"):
        raise NotImplementedError
    def fail_transfers(self, online: "Online",batch_transfer_idx: "typing.Optional[int]",no_asset_only: "bool"):
        raise NotImplementedError
    ...
    def get_asset_metadata(self, asset_id: "str"):
        raise NotImplementedError
    def get_btc_balance(self, online: "Online"):
        raise NotImplementedError
    ...
    def list_assets(self, filter_asset_schemas: "typing.List[AssetSchema]"):
        raise NotImplementedError
    def list_transactions(self, online: "typing.Optional[Online]"):
        raise NotImplementedError
    def list_transfers(self, asset_id: "typing.Optional[str]"):
        raise NotImplementedError
    def list_unspents(self, online: "typing.Optional[Online]",settled_only: "bool"):
        raise NotImplementedError
    def refresh(self, online: "Online",asset_id: "typing.Optional[str]",filter: "typing.List[RefreshFilter]"):
        raise NotImplementedError
    def send(self, online: "Online",recipient_map: "dict[str, typing.List[Recipient]]",donation: "bool",fee_rate: "float",min_confirmations: "int"):
        raise NotImplementedError
    def send_begin(self, online: "Online",recipient_map: "dict[str, typing.List[Recipient]]",donation: "bool",fee_rate: "float",min_confirmations: "int"):
        raise NotImplementedError
    def send_btc(self, online: "Online",address: "str",amount: "int",fee_rate: "float"):
        raise NotImplementedError
    def send_btc_begin(self, online: "Online",address: "str",amount: "int",fee_rate: "float"):
        raise NotImplementedError
    def send_btc_end(self, online: "Online",signed_psbt: "str"):
        raise NotImplementedError
    def send_end(self, online: "Online",signed_psbt: "str"):
        raise NotImplementedError
...
class Wallet:
    ...
    def __init__(self, wallet_data: "WalletData"):
        ...
        self._pointer = _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_constructor_wallet_new,
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_free_wallet, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_rgblibffi_fn_clone_wallet, self._pointer)
    ...
    def backup(self, backup_path: "str",password: "str") -> None:
        ...
        _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_backup,self._uniffi_clone_pointer(),
    ...
    def backup_info(self, ) -> "bool":
        return _UniffiConverterBool.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_backup_info,self._uniffi_clone_pointer(),)
        )
    ...
    def blind_receive(self, asset_id: "typing.Optional[str]",amount: "typing.Optional[int]",duration_seconds: "typing.Optional[int]",transport_endpoints: "typing.List[str]",min_confirmations: "int") -> "ReceiveData":
        ...
        return _UniffiConverterTypeReceiveData.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_blind_receive,self._uniffi_clone_pointer(),
    ...
    def create_utxos(self, online: "Online",up_to: "bool",num: "typing.Optional[int]",size: "typing.Optional[int]",fee_rate: "float") -> "int":
        ...
        return _UniffiConverterUInt8.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_create_utxos,self._uniffi_clone_pointer(),
    ...
    def create_utxos_begin(self, online: "Online",up_to: "bool",num: "typing.Optional[int]",size: "typing.Optional[int]",fee_rate: "float") -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_create_utxos_begin,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
        _UniffiConverterBool.lower(up_to),
        _UniffiConverterOptionalUInt8.lower(num),
        _UniffiConverterOptionalUInt32.lower(size),
    ...
    def create_utxos_end(self, online: "Online",signed_psbt: "str") -> "int":
        ...
        return _UniffiConverterUInt8.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_create_utxos_end,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
    ...
    def delete_transfers(self, batch_transfer_idx: "typing.Optional[int]",no_asset_only: "bool") -> "bool":
        ...
        return _UniffiConverterBool.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_delete_transfers,self._uniffi_clone_pointer(),
    ...
    def drain_to(self, online: "Online",address: "str",destroy_assets: "bool",fee_rate: "float") -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_drain_to,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
    ...
    def drain_to_begin(self, online: "Online",address: "str",destroy_assets: "bool",fee_rate: "float") -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_drain_to_begin,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
        _UniffiConverterString.lower(address),
        _UniffiConverterBool.lower(destroy_assets),
        _UniffiConverterFloat.lower(fee_rate))
    ...
    def drain_to_end(self, online: "Online",signed_psbt: "str") -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_drain_to_end,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
        _UniffiConverterString.lower(signed_psbt))
        )
    ...
    def fail_transfers(self, online: "Online",batch_transfer_idx: "typing.Optional[int]",no_asset_only: "bool") -> "bool":
        _UniffiConverterTypeOnline.check_lower(online)
        ...
        return _UniffiConverterBool.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_fail_transfers,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
        _UniffiConverterOptionalInt32.lower(batch_transfer_idx),
        _UniffiConverterBool.lower(no_asset_only))
        )
    ...
    def get_address(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_address,self._uniffi_clone_pointer(),)
        )
    ...
    def get_asset_balance(self, asset_id: "str") -> "Balance":
        ...
        return _UniffiConverterTypeBalance.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_asset_balance,self._uniffi_clone_pointer(),
    ...
    def get_asset_metadata(self, asset_id: "str") -> "Metadata":
        ...
        return _UniffiConverterTypeMetadata.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_asset_metadata,self._uniffi_clone_pointer(),
        _UniffiConverterString.lower(asset_id))
        )
    ...
    def get_btc_balance(self, online: "Online") -> "BtcBalance":
        ...
        return _UniffiConverterTypeBtcBalance.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_btc_balance,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online))
        )
    ...
    def go_online(self, skip_consistency_check: "bool",indexer_url: "str") -> "Online":
        ...
        return _UniffiConverterTypeOnline.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_go_online,self._uniffi_clone_pointer(),
    ...
    def issue_asset_cfa(self, online: "Online",name: "str",details: "typing.Optional[str]",precision: "int",amounts: "typing.List[int]",file_path: "typing.Optional[str]") -> "AssetCfa":
        ...
        return _UniffiConverterTypeAssetCFA.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_issue_asset_cfa,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
    ...
    def issue_asset_nia(self, online: "Online",ticker: "str",name: "str",precision: "int",amounts: "typing.List[int]") -> "AssetNia":
        ...
        return _UniffiConverterTypeAssetNIA.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_issue_asset_nia,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
    ...
    def issue_asset_uda(self, online: "Online",ticker: "str",name: "str",details: "typing.Optional[str]",precision: "int",media_file_path: "typing.Optional[str]",attachments_file_paths: "typing.List[str]") -> "AssetUda":
        ...
        return _UniffiConverterTypeAssetUDA.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_issue_asset_uda,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
        _UniffiConverterString.lower(ticker),
        _UniffiConverterString.lower(name),
        _UniffiConverterOptionalString.lower(details),
    ...
    def list_assets(self, filter_asset_schemas: "typing.List[AssetSchema]") -> "Assets":
        ...
        return _UniffiConverterTypeAssets.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_assets,self._uniffi_clone_pointer(),
    ...
    def list_transactions(self, online: "typing.Optional[Online]") -> "typing.List[Transaction]":
        ...
        return _UniffiConverterSequenceTypeTransaction.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_transactions,self._uniffi_clone_pointer(),
    ...
    def list_transfers(self, asset_id: "typing.Optional[str]") -> "typing.List[Transfer]":
        ...
        return _UniffiConverterSequenceTypeTransfer.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_transfers,self._uniffi_clone_pointer(),
        _UniffiConverterOptionalString.lower(asset_id))
        )
    ...
    def list_unspents(self, online: "typing.Optional[Online]",settled_only: "bool") -> "typing.List[Unspent]":
        ...
        return _UniffiConverterSequenceTypeUnspent.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_list_unspents,self._uniffi_clone_pointer(),
        _UniffiConverterOptionalTypeOnline.lower(online),
    ...
    def refresh(self, online: "Online",asset_id: "typing.Optional[str]",filter: "typing.List[RefreshFilter]") -> "dict[int, RefreshedTransfer]":
        _UniffiConverterTypeOnline.check_lower(online)
        ...
        return _UniffiConverterMapInt32TypeRefreshedTransfer.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_refresh,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
        _UniffiConverterOptionalString.lower(asset_id),
    ...
    def send(self, online: "Online",recipient_map: "dict[str, typing.List[Recipient]]",donation: "bool",fee_rate: "float",min_confirmations: "int") -> "SendResult":
        _UniffiConverterTypeOnline.check_lower(online)
        ...
        return _UniffiConverterTypeSendResult.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
    ...
    def send_begin(self, online: "Online",recipient_map: "dict[str, typing.List[Recipient]]",donation: "bool",fee_rate: "float",min_confirmations: "int") -> "str":
        _UniffiConverterTypeOnline.check_lower(online)
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_begin,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
        _UniffiConverterMapStringSequenceTypeRecipient.lower(recipient_map),
        _UniffiConverterBool.lower(donation),
        _UniffiConverterFloat.lower(fee_rate),
    ...
    def send_btc(self, online: "Online",address: "str",amount: "int",fee_rate: "float") -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_btc,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
        _UniffiConverterString.lower(address),
    ...
    def send_btc_begin(self, online: "Online",address: "str",amount: "int",fee_rate: "float") -> "str":
        _UniffiConverterTypeOnline.check_lower(online)
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_btc_begin,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
        _UniffiConverterString.lower(address),
        _UniffiConverterUInt64.lower(amount),
        _UniffiConverterFloat.lower(fee_rate))
    ...
    def send_btc_end(self, online: "Online",signed_psbt: "str") -> "str":
        _UniffiConverterTypeOnline.check_lower(online)
        
        _UniffiConverterString.check_lower(signed_psbt)
        
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_btc_end,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
        _UniffiConverterString.lower(signed_psbt))
        )
    ...
    def send_end(self, online: "Online",signed_psbt: "str") -> "SendResult":
        _UniffiConverterTypeOnline.check_lower(online)
        
        _UniffiConverterString.check_lower(signed_psbt)
        
        return _UniffiConverterTypeSendResult.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_send_end,self._uniffi_clone_pointer(),
        _UniffiConverterTypeOnline.lower(online),
        _UniffiConverterString.lower(signed_psbt))
        )
    ...
    def sign_psbt(self, unsigned_psbt: "str") -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_sign_psbt,self._uniffi_clone_pointer(),
    ...
    def witness_receive(self, asset_id: "typing.Optional[str]",amount: "typing.Optional[int]",duration_seconds: "typing.Optional[int]",transport_endpoints: "typing.List[str]",min_confirmations: "int") -> "ReceiveData":
        ...
        return _UniffiConverterTypeReceiveData.lift(
            _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_method_wallet_witness_receive,self._uniffi_clone_pointer(),
        _UniffiConverterOptionalString.lower(asset_id),
        _UniffiConverterOptionalUInt64.lower(amount),
        _UniffiConverterOptionalUInt32.lower(duration_seconds),
        _UniffiConverterSequenceString.lower(transport_endpoints),
...
class Transaction:
    ...
    @typing.no_type_check
    def __init__(self, *, transaction_type: "TransactionType", txid: "str", received: "int", sent: "int", fee: "typing.Optional[int]", confirmation_time: "typing.Optional[BlockTime]"):
...
class RgbLibError:  # type: ignore
    ...
    class InvalidScript(_UniffiTempRgbLibError):
    ...
    _UniffiTempRgbLibError.InvalidScript = InvalidScript # type: ignore
    ...
    class MinRelayFeeNotMet(_UniffiTempRgbLibError):
        ...
        def __init__(self, txid):
            ...
            self.txid = txid
        def __repr__(self):
            return "RgbLibError.MinRelayFeeNotMet({})".format(str(self))
    _UniffiTempRgbLibError.MinRelayFeeNotMet = MinRelayFeeNotMet # type: ignore
    ...
    class UnsupportedInvoice(_UniffiTempRgbLibError):

        def __init__(self):
            pass
        def __repr__(self):
            return "RgbLibError.UnsupportedInvoice({})".format(str(self))
    _UniffiTempRgbLibError.UnsupportedInvoice = UnsupportedInvoice # type: ignore
...
class _UniffiConverterTypeRgbLibError(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        ...
        if variant == 47:
            return RgbLibError.MinRelayFeeNotMet(
                txid=_UniffiConverterString.read(buf),
            )
        if variant == 48:
        ...
        if variant == 56:
            return RgbLibError.UnknownRgbInterface(
                interface=_UniffiConverterString.read(buf),
            )
        if variant == 57:
        ...
        if variant == 60:
            return RgbLibError.UnsupportedLayer1(
                layer_1=_UniffiConverterString.read(buf),
            )
        if variant == 61:
    ...
    def check_lower(value):
        ...
        if isinstance(value, RgbLibError.InvalidVanillaKeychain):
            return
        if isinstance(value, RgbLibError.MinRelayFeeNotMet):
            _UniffiConverterString.check_lower(value.txid)
            return
...
def generate_keys(bitcoin_network: "BitcoinNetwork") -> "Keys":
    ...
    return _UniffiConverterTypeKeys.lift(_rust_call(_UniffiLib.uniffi_rgblibffi_fn_func_generate_keys,
...
def restore_backup(backup_path: "str",password: "str",data_dir: "str") -> None:
    ...
    _rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_func_restore_backup,
        _UniffiConverterString.lower(backup_path),
        _UniffiConverterString.lower(password),
...
def restore_keys(bitcoin_network: "BitcoinNetwork",mnemonic: "str") -> "Keys":
    ...
    return _UniffiConverterTypeKeys.lift(_rust_call_with_error(_UniffiConverterTypeRgbLibError,_UniffiLib.uniffi_rgblibffi_fn_func_restore_keys,
        _UniffiConverterTypeBitcoinNetwork.lower(bitcoin_network),
