...
from postnl.configuration import Configuration
from postnl.controllers.base_controller import BaseController
from postnl.configuration import Environment
from postnl.http.auth.custom_header_authentication import CustomHeaderAuthentication
from postnl.controllers.barcode_controller import BarcodeController
from postnl.controllers.checkout_controller import CheckoutController
from postnl.controllers.confirming_controller import ConfirmingController
from postnl.controllers.deliverydate_controller import DeliverydateController
from postnl.controllers.labelling_controller import LabellingController
from postnl.controllers.locations_controller import LocationsController
from postnl.controllers.postalcode_check_controller\
    import PostalcodeCheckController
from postnl.controllers.shipment_controller import ShipmentController
from postnl.controllers.track_trace_controller import TrackTraceController
from postnl.controllers.timeframes_controller import TimeframesController


class PostnlClient(object):
    @LazyProperty
    def barcode(self):
