...
from postnl.models.merged_label import MergedLabel
from postnl.models.response_shipment_1 import ResponseShipment1
...
class LabellingResponse(object):
    ...
    Attributes:
        ...
        response_shipments (List[ResponseShipment1]): TODO: type description
            here.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('ResponseShipments') is not None:
            response_shipments = [ResponseShipment1.from_dictionary(x) for x in dictionary.get('ResponseShipments')]
        else:
            response_shipments = APIHelper.SKIP
