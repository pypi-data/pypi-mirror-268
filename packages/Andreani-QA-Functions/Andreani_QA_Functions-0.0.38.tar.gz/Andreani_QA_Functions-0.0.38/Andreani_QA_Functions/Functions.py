...
class Functions(Parameters):
    ...
    def set_proyect(self, project_name=None):
        ...
        if os.environ.get("env"):
            ...
            Parameters.env = "DataTest"
        Functions.set_resources(self, None, Parameters.env)
    ...
    def get_data_resource(self, key: str):
        ...
        if value is None:
            print(
                f"{Functions.color_message('YELLOW', 'ADVERTENCIA:')} La clave {key} consultada no existe en el diccionario de resources.")
        return value
    ...
    def set_data_cache(self, key: str, value: Any):
        ...
        print(f"{Functions.color_message('BLUE', 'Dato guardado en caché')}: key: {key} -> valor: {value}")
    ...
    def get_data_cache(self, key):
        ...
        if value is None:
            print(
                f"{Functions.color_message('RED', 'ADVERTENCIA:')} La clave {key} consultada no existe en el diccionario de cache.")
        return value
    @staticmethod
    ...
    def footer_signature_teams():
        ...
        signature = f'''<footer>
                          ...
                          <p class="member"><strong>Federico Blanco</strong> || fblanco@andreani.com</p>
                          <p class="member"><strong>Lucas Cariboni</strong> || lcariboni@andreani.com</p>
                          <p class="member"><strong>Bruno Rocha</strong> || brocha@andreani.com</p>
                        </footer>'''
        return signature
    ...
    def set_resources(self, file_name=None, specific_sheet=None, test_cases_name_list=None):
        ...
        try:
            ...
            try:
                ...
                print(f"{Functions.color_message('RED', 'Advertencia')}: El archivo de recursos no tiene la estructura esperada.")
            ...
            try:
                ...
                # No detenemos el caso de prueba, solo mostramos una advertencia
                print(f"{Functions.color_message('RED', 'Advertencia')}: No tiene datos cargados en el resource.")
