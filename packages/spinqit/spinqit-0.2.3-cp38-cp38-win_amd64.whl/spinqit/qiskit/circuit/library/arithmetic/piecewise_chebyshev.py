...
from spinqit.qiskit.circuit import QuantumRegister, AncillaRegister
from spinqit.qiskit.circuit.library.blueprintcircuit import BlueprintCircuit
...
class PiecewiseChebyshev(BlueprintCircuit):
    ...
    Examples:
        ...
        .. jupyter-execute::
            ...
            from spinqit.qiskit.circuit.library.arithmetic.piecewise_chebyshev import PiecewiseChebyshev
