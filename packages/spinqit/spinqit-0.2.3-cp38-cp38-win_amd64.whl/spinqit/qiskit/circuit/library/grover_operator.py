...
import numpy
from spinqit.qiskit.circuit import QuantumCircuit, QuantumRegister, AncillaRegister
# from spinqit.qiskit.quantum_info import Statevector, Operator, DensityMatrix
...
class GroverOperator(QuantumCircuit):
    ...
    Examples:
        ...
        >>> from spinqit.qiskit.circuit.library import GroverOperator
    ...
    def __init__(
        ...
        #     from spinqit.qiskit.circuit.library import Diagonal  # pylint: disable=cyclic-import
