...
from spinqit.qiskit.circuit import QuantumRegister, ClassicalRegister, QuantumCircuit
from spinqit.qiskit.circuit import Reset
...
def random_circuit(
    ...
    .. jupyter-execute::
        ...
        from spinqit.qiskit.circuit.random import random_circuit
