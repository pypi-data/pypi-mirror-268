...
from spinqit.qiskit.dagcircuit.exceptions import DAGDependencyError
from spinqit.qiskit.dagcircuit.dagdepnode import DAGDepNode
...
class DAGDependency:
    ...
    **Reference:**
    ...
    def global_phase(self, angle):
        ...
        """
        from spinqit.qiskit.circuit.parameterexpression import ParameterExpression  # needed?
    ...
    def draw(self, scale=0.7, filename=None, style="color"):
        ...
        Returns:
            Ipython.display.Image: if in Jupyter notebook and not saving to file,
                otherwise None.
        """
        from spinqit.qiskit.visualization.dag_visualization import dag_drawer
