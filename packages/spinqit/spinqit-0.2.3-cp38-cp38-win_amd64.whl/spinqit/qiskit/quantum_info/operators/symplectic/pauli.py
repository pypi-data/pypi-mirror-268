...
from spinqit.qiskit.utils.deprecation import deprecate_function
from spinqit.qiskit.exceptions import QiskitError
from spinqit.qiskit.quantum_info.operators.symplectic.base_pauli import BasePauli
from spinqit.qiskit.quantum_info.operators.scalar_op import ScalarOp
from spinqit.qiskit.circuit import QuantumCircuit, Instruction
from spinqit.qiskit.circuit.library.standard_gates import IGate, XGate, YGate, ZGate
from spinqit.qiskit.circuit.library.generalized_gates import PauliGate
...
class Pauli(BasePauli):
    ...
    **Data Access**
    ...
    def evolve(self, other, qargs=None):
        ...
        from spinqit.qiskit.quantum_info.operators.symplectic.clifford import Clifford
    ...
    def random(cls, num_qubits, seed=None):
        ...
        """
        # pylint: disable=cyclic-import
        from spinqit.qiskit.quantum_info.operators.symplectic.random import random_pauli
