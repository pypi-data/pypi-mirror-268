...
from spinqit.qiskit.circuit.library.standard_gates import IGate, XGate, YGate, ZGate, HGate, SGate
...
from spinqit.qiskit.quantum_info.synthesis.clifford_decompose import decompose_clifford
...
class Clifford(BaseOperator, AdjointMixin):
    ...
    * Rows *N* to *2N-1* are the *stabilizer* group generators.
    ...
    .. jupyter-execute::
        ...
        from spinqit.qiskit.quantum_info import Clifford
