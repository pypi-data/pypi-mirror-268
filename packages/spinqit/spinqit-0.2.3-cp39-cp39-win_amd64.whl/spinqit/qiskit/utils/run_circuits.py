...
from spinqit.qiskit.providers import Backend, BaseBackend, JobStatus, JobError, BaseJob
from spinqit.qiskit.providers.jobstatus import JOB_FINAL_STATES
from spinqit.qiskit.result import Result
from spinqit.qiskit.qobj import QasmQobj
    ...
    while True:
        try:
            ...
            if is_ibmq_provider(backend):
                try:
                    from spinqit.qiskit.providers.ibmq import IBMQBackendJobLimitError
