...
from spinqit.qiskit.circuit import Gate, ParameterVector, QuantumRegister
from spinqit.qiskit.dagcircuit import DAGCircuit
# from spinqit.qiskit.transpiler.basepasses import TransformationPass
from spinqit.qiskit.transpiler.exceptions import TranspilerError
        ...
        for node in dag.op_nodes():
            ...
            if (node.op.name, node.op.num_qubits) in instr_map:
                ...
                if node.op.params:
                    ...
                    from spinqit.qiskit.converters import dag_to_circuit, circuit_to_dag
    ...
    for gate_name, gate_num_qubits, equiv_params, equiv in basis_transforms:
        ...
        for mapped_instr_name, (dag_params, dag) in mapped_instrs.items():
            ...
            if doomed_nodes and logger.isEnabledFor(logging.DEBUG):
                from spinqit.qiskit.converters import dag_to_circuit
            ...
            for node in doomed_nodes:
                from spinqit.qiskit.converters import circuit_to_dag
