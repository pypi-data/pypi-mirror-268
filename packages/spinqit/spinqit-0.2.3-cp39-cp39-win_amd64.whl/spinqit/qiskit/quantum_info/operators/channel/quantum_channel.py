...
from spinqit.qiskit.quantum_info.operators.linear_op import LinearOp
from spinqit.qiskit.quantum_info.operators.operator import Operator
from spinqit.qiskit.quantum_info.operators.predicates import is_positive_semidefinite_matrix
from spinqit.qiskit.quantum_info.operators.channel.transformations import _transform_rep
from spinqit.qiskit.quantum_info.operators.channel.transformations import _to_choi
from spinqit.qiskit.quantum_info.operators.channel.transformations import _to_kraus
from spinqit.qiskit.quantum_info.operators.channel.transformations import _to_operator
from spinqit.qiskit.quantum_info.operators.scalar_op import ScalarOp
...
class QuantumChannel(LinearOp):
    ...
    def to_instruction(self):
        ...
        """
        from spinqit.qiskit.circuit.instruction import Instruction
