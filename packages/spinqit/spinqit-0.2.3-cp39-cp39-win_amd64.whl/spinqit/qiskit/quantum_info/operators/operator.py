...
from spinqit.qiskit.circuit.library.standard_gates import IGate, XGate, YGate, ZGate, HGate, SGate, TGate
from spinqit.qiskit.exceptions import QiskitError
from spinqit.qiskit.quantum_info.operators.predicates import is_unitary_matrix, matrix_equal
...
class Operator(LinearOp):
    ...
    def to_instruction(self):
        ...
        from spinqit.qiskit.extensions.unitary import UnitaryGate
