...
from spinqit.qiskit.quantum_info.operators.pauli import Pauli
from spinqit.qiskit.quantum_info.operators.scalar_op import ScalarOp
from spinqit.qiskit.quantum_info.synthesis.cnotdihedral_decompose import decompose_cnotdihedral
...
class CNOTDihedral(BaseOperator, AdjointMixin):
     ...
     **Representation**
     ...
     .. jupyter-execute::
         ...
         from spinqit.qiskit.quantum_info import CNOTDihedral
