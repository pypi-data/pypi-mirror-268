...
from spinqit.qiskit.quantum_info.operators.custom_iterator import CustomIterator
from spinqit.qiskit.quantum_info.operators.symplectic.pauli_table import PauliTable
from spinqit.qiskit.quantum_info.operators.mixins import generate_apidocs, AdjointMixin
    ...
    **Iteration**
    ...
    def sort(self, weight=False):
        ...
        .. jupyter-execute::
            ...
            from spinqit.qiskit.quantum_info.operators import StabilizerTable
