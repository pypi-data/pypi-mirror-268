...
from spinqit.qiskit.circuit import Gate, ControlledGate
from spinqit.qiskit.circuit import QuantumCircuit
from spinqit.qiskit.circuit import QuantumRegister, Qubit
from spinqit.qiskit.circuit.exceptions import CircuitError
from spinqit.qiskit.circuit._utils import _compute_control_matrix
from spinqit.qiskit.circuit.library.standard_gates import U3Gate
from spinqit.qiskit.extensions.quantum_initializer import isometry
from spinqit.qiskit.quantum_info.operators.predicates import matrix_equal
from spinqit.qiskit.quantum_info.operators.predicates import is_unitary_matrix
from spinqit.qiskit.quantum_info.synthesis.one_qubit_decompose import OneQubitEulerDecomposer
from spinqit.qiskit.quantum_info.synthesis.two_qubit_decompose import two_qubit_cnot_decompose
from spinqit.qiskit.extensions.exceptions import ExtensionError
...
class UnitaryGate(Gate):
    ...
    def control(self, num_ctrl_qubits=1, label=None, ctrl_state=None):
        ...
        from spinqit.qiskit.quantum_info import Operator
