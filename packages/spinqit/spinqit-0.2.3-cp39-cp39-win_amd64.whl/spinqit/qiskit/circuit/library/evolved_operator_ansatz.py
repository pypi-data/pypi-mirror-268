...
from spinqit.qiskit.circuit import Parameter, ParameterVector, QuantumRegister, QuantumCircuit
...
class EvolvedOperatorAnsatz(BlueprintCircuit):
    ...
    def __init__(
        ...
        if evolution is None:
            ...
            from spinqit.qiskit.opflow import PauliTrotterEvolution
    ...
    def _build(self):
        ...
        from spinqit.qiskit.opflow import PauliOp
