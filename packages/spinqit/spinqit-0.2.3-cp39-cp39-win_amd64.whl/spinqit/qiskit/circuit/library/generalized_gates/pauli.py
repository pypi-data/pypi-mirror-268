...
from spinqit.qiskit.circuit.library.standard_gates.i import IGate
from spinqit.qiskit.circuit.library.standard_gates.x import XGate
from spinqit.qiskit.circuit.library.standard_gates.y import YGate
from spinqit.qiskit.circuit.library.standard_gates.z import ZGate
...
class PauliGate(Gate):
    ...
    def __array__(self, dtype=None):
        ...
        # pylint: disable=cyclic-import
        from spinqit.qiskit.quantum_info.operators import Pauli
