...
from spinqit.qiskit.circuit import ControlledGate, Gate, Instruction, Qubit, QuantumRegister, QuantumCircuit
...
class MCMTVChain(MCMT):
    ...
    **Expanded Circuit:**
    ...
    .. jupyter-execute::
        ...
        from spinqit.qiskit.circuit.library import MCMTVChain, ZGate
    ...
    **Examples:**
        ...
        >>> from spinqit.qiskit.circuit.library import HGate
