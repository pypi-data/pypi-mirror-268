...
from spinqit.qiskit.utils.multiprocessing import is_main_process
...
# from spinqit.qiskit.qasm.qasm import Qasm
# from spinqit.qiskit.qasm.exceptions import QasmError
from spinqit.qiskit.circuit.exceptions import CircuitError
from spinqit.qiskit.utils.deprecation import deprecate_function, deprecate_arguments
...
try:
    ...
    # from spinqit.qiskit.qasm.pygments import OpenQASMLexer  # pylint: disable=ungrouped-imports
    # from spinqit.qiskit.qasm.pygments import QasmTerminalStyle  # pylint: disable=ungrouped-imports
...
class QuantumCircuit:
    ...
    def compose(self, other, qubits=None, clbits=None, front=False, inplace=False):
        ...
        for instr, qargs, cargs in instrs:
            ...
            if instr.condition is not None:
                from spinqit.qiskit.dagcircuit import DAGCircuit  # pylint: disable=cyclic-import
    ...
    def to_instruction(self, parameter_map=None):
        ...
        """
        from spinqit.qiskit.converters.circuit_to_instruction import circuit_to_instruction
    ...
    def to_gate(self, parameter_map=None, label=None):
        ...
        Returns:
            ...
            (can be decomposed back)
        """
        from spinqit.qiskit.converters.circuit_to_gate import circuit_to_gate
    ...
    def decompose(self):
        ...
        from spinqit.qiskit.transpiler.passes.basis.decompose import Decompose
        ...
        **latex_source**: raw uncompiled latex output.
        ...
        Example:
            .. jupyter-execute::
                ...
                from qiskit import QuantumRegister, ClassicalRegister, QuantumCircuit
                from spinqit.qiskit.tools.visualization import circuit_drawer
                q = QuantumRegister(1)
        ...
        # pylint: disable=cyclic-import
        from spinqit.qiskit.visualization import circuit_drawer
    ...
    def remove_final_measurements(self, inplace=True):
        ...
        """
        # pylint: disable=cyclic-import
        from spinqit.qiskit.transpiler.passes import RemoveFinalMeasurements
        from spinqit.qiskit.converters import circuit_to_dag
    ...
    def assign_parameters(
        ...
        Examples:
            ...
            .. jupyter-execute::
                ...
                from spinqit.qiskit.circuit import QuantumCircuit, Parameter
            ...
            .. jupyter-execute::
                ...
                from spinqit.qiskit.circuit import QuantumCircuit, ParameterVector
    ...
    def pauli(self, pauli_string, qubits):
        ...
        from spinqit.qiskit.circuit.library.generalized_gates.pauli import PauliGate
...
def _circuit_from_qasm(qasm):
    # pylint: disable=cyclic-import
    from spinqit.qiskit.converters import ast_to_dag
