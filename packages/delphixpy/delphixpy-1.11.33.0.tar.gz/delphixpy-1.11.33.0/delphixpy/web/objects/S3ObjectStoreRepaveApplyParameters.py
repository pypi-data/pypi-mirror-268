...
#     /delphix-repave-apply-parameters-aws-s3-object-store.json
#
# Do not edit this file manually!
#

from delphixpy.web.objects.RepaveApplyParameters import RepaveApplyParameters
...
class S3ObjectStoreRepaveApplyParameters(RepaveApplyParameters):
    """
    *(extends* :py:class:`delphixpy.web.vo.RepaveApplyParameters` *)* An Amazon
    Simple Storage Service (Amazon S3) object store.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("S3ObjectStoreRepaveApplyParameters", True)
    ...
    def is_dirty(self):
        return any([self._endpoint[1], self._region[1], self._bucket[1], self._access_credentials[1], self._domain0_pool_guid[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, S3ObjectStoreRepaveApplyParameters):
            return False
        return super().__eq__(other) and \
               self.endpoint == other.endpoint and \
               self.region == other.region and \
               self.bucket == other.bucket and \
               self.access_credentials == other.access_credentials and \
