...
from dagster_plus_cli.core.pex_builder.deps import BuildMethod
from dagster_plus_cli.utils import get_file_size
...
def build_upload_pex(
    ...
    with tempfile.TemporaryDirectory() as temp_folder:
        ...
        if deps_cache_tags.deps_cache_to_tag:
            ...
            logging.info(
                "Updated cached deps.pex for requirements_hash %r, cache_tag %r.",
                build.deps_requirements.hash,
