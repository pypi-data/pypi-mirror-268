...
def spatial_object_to_image_filter(*args,  spacing: Sequence[float]=..., direction=..., inside_value: float=..., outside_value: float=..., origin: Sequence[float]=..., index: Sequence[int]=..., children_depth: int=..., size: Sequence[int]=..., use_object_value: bool=...,**kwargs)-> itkt.ImageSourceReturn:
