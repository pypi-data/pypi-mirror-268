...
class itkContourSpatialObjectPoint2(itk.itkSpatialObjectPointPython.itkSpatialObjectPoint2):
    ...
    def __init__(self, *args):
        ...
        __init__(self, other) -> itkContourSpatialObjectPoint2

        Parameters
        ----------
        other: itkContourSpatialObjectPoint2 const &
...
class itkContourSpatialObjectPoint3(itk.itkSpatialObjectPointPython.itkSpatialObjectPoint3):
    ...
    def __init__(self, *args):
        ...
        __init__(self, other) -> itkContourSpatialObjectPoint3

        Parameters
        ----------
        other: itkContourSpatialObjectPoint3 const &
...
class itkContourSpatialObjectPoint4(itk.itkSpatialObjectPointPython.itkSpatialObjectPoint4):
    ...
    def __init__(self, *args):
        ...
        __init__(self, other) -> itkContourSpatialObjectPoint4

        Parameters
        ----------
        other: itkContourSpatialObjectPoint4 const &
