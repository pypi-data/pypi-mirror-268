...
def discrete_gaussian_image_filter(*args: itkt.ImageLike,  variance: Union[Sequence[float], float]=..., maximum_error: Union[Sequence[float], float]=..., maximum_kernel_width: int=..., filter_dimensionality: int=..., input_boundary_condition=..., real_boundary_condition: itkt.ImageBoundaryCondition=..., sigma: Union[float, Sequence[float]]=..., sigma_array: Sequence[float]=..., use_image_spacing: bool=...,**kwargs)-> itkt.ImageSourceReturn:
