...
def add_image_filter(*args: itkt.ImageLike,  constant1: Tuple[int, int, int]=..., constant2: Tuple[int, int, int]=..., constant: Tuple[int, int, int]=...,**kwargs)-> itkt.ImageSourceReturn:
