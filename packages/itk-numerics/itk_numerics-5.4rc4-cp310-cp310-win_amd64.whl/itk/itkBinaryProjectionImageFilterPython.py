...
def binary_projection_image_filter(*args: itkt.ImageLike,  foreground_value: float=..., background_value: float=..., projection_dimension: int=...,**kwargs)-> itkt.ImageSourceReturn:
