...
@helpers.accept_array_like_xarray_torch
def binary_threshold_image_filter(*args: itkt.ImageLike,  outside_value: int=..., inside_value: int=..., upper_threshold: float=..., upper_threshold_input=..., lower_threshold: float=..., lower_threshold_input=..., functor=...,**kwargs)-> itkt.ImageSourceReturn:
