...
def mask_image_filter(*args: itkt.ImageLike,  mask_image: itkt.Image=..., outside_value: float=..., masking_value: int=..., constant1: float=..., constant2: int=..., constant: int=...,**kwargs)-> itkt.ImageSourceReturn:
