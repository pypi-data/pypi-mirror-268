...
@helpers.accept_array_like_xarray_torch
def intensity_windowing_image_filter(*args: itkt.ImageLike,  output_minimum: int=..., output_maximum: int=..., window_minimum: int=..., window_maximum: int=..., window_level: int=..., functor=...,**kwargs)-> itkt.ImageSourceReturn:
