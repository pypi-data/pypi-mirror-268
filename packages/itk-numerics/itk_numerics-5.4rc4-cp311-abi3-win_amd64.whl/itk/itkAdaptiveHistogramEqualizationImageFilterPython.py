...
class itkKernelImageFilterID2ID2Neighborhood(itk.itkBoxImageFilterPython.itkBoxImageFilterID2ID2):
    ...
    def SetRadius(self, *args):
        ...
        Parameters
        ----------
        radius: unsigned long long const &
...
class itkMovingHistogramImageFilterBaseID2ID2Neighborhood(itkKernelImageFilterID2ID2Neighborhood):
    ...
    def GetPixelsPerTranslation(self):
        r"""GetPixelsPerTranslation(self) -> unsigned long long"""
...
def moving_histogram_image_filter(*args: itkt.ImageLike,  kernel=..., radius: Union[int, int, Sequence[int], Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
...
@helpers.accept_array_like_xarray_torch
def adaptive_histogram_equalization_image_filter(*args: itkt.ImageLike,  alpha: float=..., beta: float=..., use_lookup_table: bool=..., kernel=..., radius: Union[Sequence[int], Sequence[int], int, int]=...,**kwargs)-> itkt.ImageSourceReturn:
...
@helpers.accept_array_like_xarray_torch
def kernel_image_filter(*args: itkt.ImageLike,  kernel=..., radius: Union[int, int, Sequence[int], Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
...
@helpers.accept_array_like_xarray_torch
def moving_histogram_image_filter_base(*args: itkt.ImageLike,  kernel=..., radius: Union[int, int, Sequence[int], Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
