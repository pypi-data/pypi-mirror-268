...
def mask_negated_image_filter(*args: itkt.ImageLike,  outside_value: float=..., masking_value: int=..., mask_image: itkt.Image=..., constant1: float=..., constant2: int=..., constant: int=...,**kwargs)-> itkt.ImageSourceReturn:
