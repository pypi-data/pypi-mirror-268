...
class itkOtsuMultipleThresholdsImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    def GetNumberOfHistogramBins(self):
        r"""GetNumberOfHistogramBins(self) -> unsigned long"""
    ...
    def GetNumberOfThresholds(self):
        r"""GetNumberOfThresholds(self) -> unsigned long"""
...
def otsu_multiple_thresholds_image_filter(*args: itkt.ImageLike,  number_of_histogram_bins: int=..., number_of_thresholds: int=..., label_offset: float=..., valley_emphasis: bool=..., return_bin_midpoint: bool=...,**kwargs)-> itkt.ImageSourceReturn:
