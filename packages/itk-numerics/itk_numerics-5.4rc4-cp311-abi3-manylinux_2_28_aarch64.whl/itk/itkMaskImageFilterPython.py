...
def mask_image_filter(*args: itkt.ImageLike,  mask_image: itkt.Image=..., outside_value: Tuple[int, int, int, int]=..., masking_value: int=..., constant1: Tuple[int, int, int, int]=..., constant2: int=..., constant: int=...,**kwargs)-> itkt.ImageSourceReturn:
