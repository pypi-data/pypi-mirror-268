...
def threshold_labeler_image_filter(*args: itkt.ImageLike,  thresholds: Sequence[int]=..., real_thresholds: Sequence[float]=..., label_offset: int=..., functor=...,**kwargs)-> itkt.ImageSourceReturn:
