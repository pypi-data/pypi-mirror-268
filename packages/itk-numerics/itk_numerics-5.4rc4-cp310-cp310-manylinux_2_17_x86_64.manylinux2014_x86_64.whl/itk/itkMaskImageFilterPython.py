...
def mask_image_filter(*args: itkt.ImageLike,  mask_image: itkt.Image=..., outside_value=..., masking_value: int=..., constant1=..., constant2: int=..., constant: int=...,**kwargs)-> itkt.ImageSourceReturn:
