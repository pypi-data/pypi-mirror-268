...
def mask_negated_image_filter(*args: itkt.ImageLike,  outside_value: int=..., masking_value: int=..., mask_image: itkt.Image=..., constant1: int=..., constant2: int=..., constant: int=...,**kwargs)-> itkt.ImageSourceReturn:
