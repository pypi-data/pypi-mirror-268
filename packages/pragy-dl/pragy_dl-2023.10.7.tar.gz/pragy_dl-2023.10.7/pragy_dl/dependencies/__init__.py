...
An attribute "_pragy_dl__identifier" may be inserted into the module if it uses an ambiguous namespace"""
...
try:
    import sqlite3
    # We need to get the underlying `sqlite` version, see https://github.com/pragy-dl/pragy-dl/issues/8152
    sqlite3._pragy_dl__version = sqlite3.sqlite_version
except ImportError:
    # although sqlite3 is part of the standard library, it is possible to compile python without
    # sqlite support. See: https://github.com/pragy-dl/pragy-dl/issues/544
    sqlite3 = None
...
try:
    ...
    # See https://github.com/pragy-dl/pragy-dl/issues/2633
    websockets = None
...
try:
    ...
    if hasattr(xattr, 'set'):  # pyxattr
        xattr._pragy_dl__identifier = 'pyxattr'
