...
class YoutubeDL:
    ...
    call_home:         - Not implemented
                       ...
                       pragy-dl servers for debugging.
    ...
    def _format_text(self, handle, allow_colors, text, f, fallback=None, *, test_encoding=False):
        ...
        if test_encoding:
            original_text = text
            # handle.encoding can be None. See https://github.com/pragy-dl/pragy-dl/issues/2711
    ...
    def prepare_outtmpl(self, outtmpl, info_dict, sanitize=False):
        ...
        def get_value(mdict):
            ...
            # XXX: Workaround for https://github.com/pragy-dl/pragy-dl/issues/4485
    ...
    def _load_cookies(self, data, *, autoscope=True):
        ...
        See: https://github.com/pragy-dl/pragy-dl/security/advisories/GHSA-v8mc-9377-rwjj
        ...
        for cookie in LenientSimpleCookie(data).values():
            ...
            if domain:
                ...
                self.report_warning(
                    ...
                    f'If you are using pragy-dl with an input URL{bug_reports_message(before=",")}',
                    only_once=True)
    ...
    def __process_playlist(self, ie_result, download):
        ...
        for i, (playlist_index, entry) in enumerate(entries):
            ...
            if self._match_entry(entry_copy, incomplete=True) is not None:
                # For compatabilty with youtube-dl. See https://github.com/pragy-dl/pragy-dl/issues/4369
    ...
    def process_video_result(self, info_dict, download=True):
        ...
        for format_id, ambiguous_formats in formats_dict.items():
            ...
            for i, format in enumerate(ambiguous_formats):
                ...
                # See https://github.com/pragy-dl/pragy-dl/issues/1282
    ...
    def print_debug_header(self):
        ...
        write_debug(join_nonempty(
            f'{"pragy-dl" if REPOSITORY == "pragy-dl/pragy-dl" else REPOSITORY} version',
        ...
        try:
            ...
            for ue in e.unsupported_errors:
                ...
                if ue.handler.RH_KEY == 'Urllib' and 'unsupported url scheme: "file"' in ue.msg.lower():
                    raise RequestError(
                        'file:// URLs are disabled by default in pragy-dl for security reasons. '
