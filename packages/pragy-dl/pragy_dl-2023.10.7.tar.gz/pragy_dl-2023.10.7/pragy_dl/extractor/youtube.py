...
INNERTUBE_CLIENTS = {
    ...
    # See: https://github.com/pragy-dl/pragy-dl/pull/557
    'mweb': {
        'INNERTUBE_API_KEY': 'AIzaSyAO_FJ2SlqU8Q4STEHLGCilw_Y9_11qcW8',
        'INNERTUBE_CONTEXT': {
            'client': {
...
class YoutubeBaseInfoExtractor(InfoExtractor):
    ...
    def _generate_sapisidhash_header(self, origin='https://www.youtube.com'):
        ...
        if self._SAPISID is None:
            ...
            # See: https://github.com/pragy-dl/pragy-dl/issues/393
    ...
    def _extract_session_index(*data):
        ...
        See: https://github.com/pragy-dl/pragy-dl/pull/519
        """
        for ytcfg in data:
    ...
    def _extract_thumbnails(data, *path_list):
        ...
        for path in path_list or [()]:
            for thumbnail in traverse_obj(data, (*variadic(path), 'thumbnails', ...)):
                ...
                # https://github.com/pragy-dl/pragy-dl/issues/233
    ...
    def _extract_response(self, item_id, query, note='Downloading API JSON', headers=None,
        ...
        for _ in range(main_rm.retries + icd_rm.retries + 1):
            try:
                ...
                # See https://github.com/pragy-dl/pragy-dl/issues/507#issuecomment-880188210
            ...
            try:
                ...
                # See: https://github.com/pragy-dl/pragy-dl/issues/839
...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _TESTS = [
        ...
        # Age-gate videos. See https://github.com/pragy-dl/pragy-dl/pull/575#issuecomment-888837000
        {
    ...
    def _extract_from_webpage(cls, url, webpage):
        # Invidious Instances
        # https://github.com/pragy-dl/pragy-dl/issues/195
    ...
    def _comment_entries(self, root_continuation_data, ytcfg, video_id, parent=None, tracker=None):
        ...
        def extract_thread(contents):
            ...
            for content in contents:
                ...
                # See: https://github.com/pragy-dl/pragy-dl/issues/6290
                if comment_id in tracker['seen_comment_ids']:
                    if comment_id in tracker['pinned_comment_ids'] and not comment.get('is_pinned'):
                        ...
                        # See: https://github.com/pragy-dl/pragy-dl/issues/6712
                        continue
                    self.report_warning(
        ...
        for page_num in itertools.count(0):
            ...
            try:
                ...
                # See: https://github.com/pragy-dl/pragy-dl/issues/4669
    ...
    def _extract_player_responses(self, clients, video_id, webpage, master_ytcfg, smuggled_data):
        ...
        # See: https://github.com/pragy-dl/pragy-dl/issues/501
        if initial_pr:
            pr = dict(initial_pr)
    ...
    def _extract_formats_and_subtitles(self, streaming_data, video_id, player_url, live_status, duration):
        ...
        for fmt in streaming_formats:
            ...
            # E.g. 2-nOtRESiUc Ref: https://github.com/pragy-dl/pragy-dl/issues/2823
            ...
            dct = {
                ...
                'format_note': join_nonempty(
                    ...
                    delim=', '),
                # Format 22 is likely to be damaged. See https://github.com/pragy-dl/pragy-dl/issues/3372
    ...
    def _real_extract(self, url):
        ...
        # See: https://github.com/pragy-dl/pragy-dl/issues/340
        ...
        # See: https://github.com/pragy-dl/pragy-dl/pull/2223#issuecomment-1008485139
        upload_date = (
...
class YoutubeTabBaseInfoExtractor(YoutubeBaseInfoExtractor):
    ...
    def _extract_metadata_from_tabs(self, item_id, data):
        ...
        # See: https://github.com/pragy-dl/pragy-dl/issues/2237#issuecomment-1013694714
    ...
    def _extract_webpage(self, url, item_id, fatal=True):
        ...
        for retry in self.RetryManager(fatal=fatal):
            ...
            # See: https://github.com/pragy-dl/pragy-dl/issues/116
...
class YoutubeTabIE(YoutubeTabBaseInfoExtractor):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            ...
            'title': 'pragy-dl unlisted playlist test',
            'availability': 'unlisted',
            'tags': [],
        ...
        'info_dict': {
            ...
            'title': 'pragy-dl test - collaborative playlist',
            'view_count': int,
    ...
    def _real_extract(self, url, smuggled_data):
        ...
        # See: https://github.com/pragy-dl/pragy-dl/issues/2694
