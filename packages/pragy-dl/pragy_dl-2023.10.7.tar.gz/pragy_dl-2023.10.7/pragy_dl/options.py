...
def parseOpts(overrideArguments=None, ignore_config_files='if_override'):
    ...
    def add_config(label, path=None, func=None):
        ...
        if root.parse_known_args()[0].ignoreconfig:
            ...
            current_path = os.path.join(path, 'pragy-dl.conf')
...
class _YoutubeDLOptionParser(optparse.OptionParser):
    ...
    def __init__(self):
        super().__init__(
            prog='pragy-dl' if detect_variant() == 'source' else None,
            version=__version__,
            usage='%prog [OPTIONS] URL [URL...]',
            epilog='See full documentation at  https://github.com/pragy-dl/pragy-dl#readme',
...
def create_parser():
    ...
    general.add_option(
        ...
        help=(
            ...
            'Use the value "auto" to let pragy-dl guess ("auto_warning" to emit a warning when guessing). '
    ...
    general.add_option(
        ...
        callback_kwargs={
            ...
            'configurations by reverting some of the changes made in pragy-dl. '
    ...
    authentication.add_option(
        ...
        help='Account password. If this option is left out, pragy-dl will ask interactively')
    authentication.add_option(
        '-2', '--twofactor',
    ...
    authentication.add_option(
        ...
        help='Multiple-system operator account password. If this option is left out, pragy-dl will ask interactively')
    authentication.add_option(
        '--ap-list-mso',
    ...
    authentication.add_option(
        ...
        help='Password for client certificate private key, if encrypted. '
             'If not provided, and the key is encrypted, pragy-dl will ask interactively')
    ...
    verbosity.add_option(
        ...
        # help='Contact the pragy-dl server for debugging')
        help=optparse.SUPPRESS_HELP)
    verbosity.add_option(
        '--no-call-home',
        dest='call_home', action='store_false',
        # help='Do not contact the pragy-dl server for debugging (default)')
        help=optparse.SUPPRESS_HELP)
    ...
    filesystem.add_option(
        ...
        help=(
            'Location in the filesystem where pragy-dl can store some downloaded information '
            '(such as client ids and signatures) permanently. By default ${XDG_CACHE_HOME}/pragy-dl'))
    filesystem.add_option(
