...
class FragmentFD(FileDownloader):
    ...
    def report_retry_fragment(self, err, frag_index, count, retries):
        self.deprecation_warning('pragy_dl.downloader.FragmentFD.report_retry_fragment is deprecated. '
                                 'Use pragy_dl.downloader.FileDownloader.report_retry instead')
