...
class PluginFinder(importlib.abc.MetaPathFinder):
    ...
    It searches in sys.path and pragy-dl config folders for
    ...
    def search_locations(self, fullname):
        ...
        # Load from pragy-dl config folders
        candidate_locations.extend(_get_package_paths(
            *get_user_config_dirs('pragy-dl'),
            *get_system_config_dirs('pragy-dl'),
            containing_folder='plugins'))

        # Load from pragy-dl-plugins folders
        candidate_locations.extend(_get_package_paths(
            get_executable_path(),
            *get_user_config_dirs(''),
            *get_system_config_dirs(''),
            containing_folder='pragy-dl-plugins'))
