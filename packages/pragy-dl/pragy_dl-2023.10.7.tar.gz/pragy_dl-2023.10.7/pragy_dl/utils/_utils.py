        ...
        try:
            try:
                if sys.platform == 'win32':
                    ...
                    # Ref: https://github.com/pragy-dl/pragy-dl/issues/3124
...
def sanitize_filename(s, restricted=False, is_id=NO_DEFAULT):
    ...
    @param is_id        Whether this is an ID that should be kept unchanged if possible.
                        If unset, pragy-dl's new sanitization rules are in effect
    """
    if s == '':
        return ''
    ...
    def _fix_pyinstaller_ld_path(env):
        """Restore LD_LIBRARY_PATH when using PyInstaller
            Ref: https://github.com/pyinstaller/pyinstaller/blob/develop/doc/runtime-information.rst#ld_library_path--libpath-considerations
                 https://github.com/pragy-dl/pragy-dl/issues/4573
        """
...
def bug_reports_message(before=';'):
    ...
    msg = (f'please report this issue on  https://github.com/{REPOSITORY}/issues?q= , '
           'filling out the appropriate issue template. Confirm you are on the latest version using  pragy-dl -U')
...
class ExtractorError(YoutubeDLError):
    ...
    def __init__(self, msg, tb=None, expected=False, cause=None, video_id=None, ie=None):
        ...
        If expected is set, this is a normal error message and most likely not a bug in pragy-dl.
        """
...
def setproctitle(title):
    ...
    # Workaround for https://github.com/pragy-dl/pragy-dl/issues/4541
    try:
        import ctypes
    except ImportError:
        return
...
def strftime_or_none(timestamp, date_format='%Y%m%d', default=None):
    ...
    try:
        if isinstance(timestamp, (int, float)):  # unix timestamp
            ...
            # Ref: https://github.com/pragy-dl/pragy-dl/issues/5185, https://github.com/python/cpython/issues/94414
            # Also, datetime.datetime.fromtimestamp breaks for negative timestamps
            # Ref: https://github.com/pragy-dl/pragy-dl/issues/6706#issuecomment-1496842642
...
def _get_exe_version_output(exe, args):
    try:
        ...
        # SIGTTOU if pragy-dl is run in the background.
...
def ytdl_is_updateable():
    """ Returns if pragy-dl can be updated with -U """
...
def dfxp2srt(dfxp_data):
    ...
    # Fix UTF-8 encoded file wrongly marked as UTF-16. See https://github.com/pragy-dl/pragy-dl/issues/6543#issuecomment-1477169870
    ...
    def load_configs(self):
        ...
        for location in opts.config_locations or []:
            ...
            if os.path.isdir(location):
                location = os.path.join(location, 'pragy-dl.conf')
...
class FormatSorter:
    ...
    def calculate_preference(self, format):
        ...
        if format.get('preference') is None and format.get('ext') == 'flv' and re.match('[hx]265|he?vc?', format.get('vcodec') or ''):
            ...
            # ref. https://github.com/pragy-dl/pragy-dl/pull/5821
