...
def _choose_linux_keyring(logger):
    ...
    and so would be aware enough to tell pragy-dl to use the BASIC_TEXT keyring.
...
class LenientSimpleCookie(http.cookies.SimpleCookie):
    ...
    def load(self, data):
        # Workaround for https://github.com/pragy-dl/pragy-dl/issues/4776
...
# This file is generated by pragy-dl.  Do not edit.
                ...
                try:
                    ...
                    if f'{line.strip()} '[0] in '[{"':
                        raise http.cookiejar.LoadError(
                            ...
                            'https://github.com/pragy-dl/pragy-dl/wiki/FAQ#how-do-i-pass-cookies-to-pragy-dl')
