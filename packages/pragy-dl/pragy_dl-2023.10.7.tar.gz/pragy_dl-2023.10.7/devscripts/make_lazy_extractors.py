...
def main():
    ...
    import pragy_dl.plugins
    from pragy_dl.extractor.common import InfoExtractor, SearchInfoExtractor

    # Filter out plugins
    _ALL_CLASSES = [cls for cls in _ALL_CLASSES if not cls.__module__.startswith(f'{pragy_dl.plugins.PACKAGE_NAME}.')]
...
def get_all_ies():
    ...
    try:
        from pragy_dl.extractor.extractors import _ALL_CLASSES
    finally:
