...
import pragy_dl.YoutubeDL  # isort: split
from pragy_dl.extractor import get_info_extractor
from pragy_dl.networking.exceptions import HTTPError, TransportError
...
class YoutubeDL(pragy_dl.YoutubeDL):
...
def generator(test_case, tname):
    def test_template(self):
        ...
        ie = pragy_dl.extractor.get_info_extractor(test_case['name'])()
