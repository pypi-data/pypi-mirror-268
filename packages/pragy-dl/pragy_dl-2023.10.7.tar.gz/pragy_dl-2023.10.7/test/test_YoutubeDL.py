...
from pragy_dl.compat import compat_os_name
from pragy_dl.extractor import YoutubeIE
from pragy_dl.extractor.common import InfoExtractor
from pragy_dl.postprocessor.common import PostProcessor
...
from pragy_dl.utils.traversal import traverse_obj
...
class TestYoutubeDL(unittest.TestCase):
    ...
    def test_prepare_outtmpl_and_filename(self):
        ...
        os.environ['__pragy_dl_var'] = 'expanded'
        envvar = '%__pragy_dl_var%' if compat_os_name == 'nt' else '$__pragy_dl_var'
    ...
    def test_playlist_items_selection(self):
        ...
        # Tests for https://github.com/pragy-dl/pragy-dl/issues/720
        # https://github.com/pragy-dl/pragy-dl/issues/302
