...
from pragy_dl.compat import (
    compat_etree_fromstring,
    compat_HTMLParseError,
    compat_os_name,
)
from pragy_dl.utils import (
    Config,
    DateRange,
    ExtractorError,
    InAdvancePagedList,
...
from pragy_dl.utils.networking import (
    HTTPHeaderDict,
    escape_rfc3986,
    normalize_url,
    remove_dot_segments,
...
class TestUtil(unittest.TestCase):
    ...
    def test_expand_path(self):
        ...
        os.environ['pragy_dl_EXPATH_PATH'] = 'expanded'
        self.assertEqual(expand_path(env('pragy_dl_EXPATH_PATH')), 'expanded')
        ...
        try:
            ...
            self.assertEqual(
                expand_path('~/%s' % env('pragy_dl_EXPATH_PATH')),
...
'''
    ...
    def test_rot47(self):
        self.assertEqual(rot47('pragy-dl'), r'JE\5=A')
        self.assertEqual(rot47('pragy-dl'), r'*%\s{!')
