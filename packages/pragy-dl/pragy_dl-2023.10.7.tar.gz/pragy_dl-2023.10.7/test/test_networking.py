...
from pragy_dl.dependencies import brotli
from pragy_dl.networking import (
    HEADRequest,
    PUTRequest,
    Request,
    RequestDirector,
...
from pragy_dl.networking._urllib import UrllibRH
...
class TestRequestHandlerBase:
    ...
    def setup_class(cls):
        ...
        # See: https://github.com/pragy-dl/pragy-dl/pull/7094#discussion_r1199746041
