...
class DpskCls:
	...
	def get_devm(self) -> DevmStruct:
		...
		Snippet: value: DevmStruct = driver.configure.bluetooth.measurement.multiEval.limit.edrate.dpsk.get_devm() \n
	...
	def set_devm(self, value: DevmStruct) -> None:
		...
		structure = driver.configure.bluetooth.measurement.multiEval.limit.edrate.dpsk.DevmStruct() \n
		...
		driver.configure.bluetooth.measurement.multiEval.limit.edrate.dpsk.set_devm(value = structure) \n
		Defines and activates upper limits for the differential error vector magnitude for 8DPSK modulated packets (3-DHx) . \n
