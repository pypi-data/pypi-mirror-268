...
class FaccuracyCls:
	...
	def set(self, freq_accuracy: float, freq_acc_enabled: List[bool]) -> None:
		...
		Snippet: driver.configure.bluetooth.measurement.multiEval.limit.brate.faccuracy.set(freq_accuracy = 1.0, freq_acc_enabled = [True, False, True]) \n
	...
	def get(self) -> FaccuracyStruct:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:BRATe:FACCuracy \n
		Snippet: value: FaccuracyStruct = driver.configure.bluetooth.measurement.multiEval.limit.brate.faccuracy.get() \n
		Defines the limit for the frequency accuracy. \n
