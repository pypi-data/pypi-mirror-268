...
class MeasurementCls:
	...
	def get_mode(self) -> enums.BrEdrChannelsRange:
		...
		Snippet: value: enums.BrEdrChannelsRange = driver.configure.bluetooth.measurement.hdr.sgacp.measurement.get_mode() \n
	...
	def set_mode(self, meas_mode: enums.BrEdrChannelsRange) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:HDR:SGACp:MEASurement:MODE \n
		Snippet: driver.configure.bluetooth.measurement.hdr.sgacp.measurement.set_mode(meas_mode = enums.BrEdrChannelsRange.CH21) \n
		No command help available \n
