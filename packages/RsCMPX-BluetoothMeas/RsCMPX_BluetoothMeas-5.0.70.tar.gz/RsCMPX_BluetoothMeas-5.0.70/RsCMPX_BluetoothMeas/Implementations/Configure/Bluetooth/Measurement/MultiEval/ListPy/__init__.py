...
class ListPyCls:
	...
	def get_nconnections(self) -> int:
		...
		Snippet: value: int = driver.configure.bluetooth.measurement.multiEval.listPy.get_nconnections() \n
		Sets the number of connections to be defined for the list mode, for connector mode LIST. Define the connections via
		ROUTe:BLUetooth:MEAS<i>:SPATh. \n
	...
	def set_nconnections(self, no_of_connections: int) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIST:NCONnections \n
		Snippet: driver.configure.bluetooth.measurement.multiEval.listPy.set_nconnections(no_of_connections = 1) \n
		Sets the number of connections to be defined for the list mode, for connector mode LIST. Define the connections via
		ROUTe:BLUetooth:MEAS<i>:SPATh. \n
	...
	def get_count(self) -> int:
		...
		Snippet: value: int = driver.configure.bluetooth.measurement.multiEval.listPy.get_count() \n
	...
	def set_count(self, segments: int) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIST:COUNt \n
		Snippet: driver.configure.bluetooth.measurement.multiEval.listPy.set_count(segments = 1) \n
		Defines the number of segments in the entire measurement interval. \n
	...
	def get_malgorithm(self) -> enums.PatternIndependent:
		...
		Snippet: value: enums.PatternIndependent = driver.configure.bluetooth.measurement.multiEval.listPy.get_malgorithm() \n
	...
	def set_malgorithm(self, pattern_independent: enums.PatternIndependent) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIST:MALGorithm \n
		Snippet: driver.configure.bluetooth.measurement.multiEval.listPy.set_malgorithm(pattern_independent = enums.PatternIndependent.PINDependent) \n
		No command help available \n
	...
	def get_cmode(self) -> enums.ParameterSetMode:
		...
		Snippet: value: enums.ParameterSetMode = driver.configure.bluetooth.measurement.multiEval.listPy.get_cmode() \n
	...
	def set_cmode(self, connector_mode: enums.ParameterSetMode) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIST:CMODe \n
		Snippet: driver.configure.bluetooth.measurement.multiEval.listPy.set_cmode(connector_mode = enums.ParameterSetMode.GLOBal) \n
		Sets the connector mode, selecting whether all list mode segments use the same RF connection. \n
	...
	def get_value(self) -> bool:
		...
		Snippet: value: bool = driver.configure.bluetooth.measurement.multiEval.listPy.get_value() \n
	...
	def set_value(self, enable: bool) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIST \n
		Snippet: driver.configure.bluetooth.measurement.multiEval.listPy.set_value(enable = False) \n
		Enables or disables the list mode. \n
