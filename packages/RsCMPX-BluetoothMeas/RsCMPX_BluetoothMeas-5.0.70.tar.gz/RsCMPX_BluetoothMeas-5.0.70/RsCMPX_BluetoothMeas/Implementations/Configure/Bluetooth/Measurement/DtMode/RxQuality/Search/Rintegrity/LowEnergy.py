...
class LowEnergyCls:
	...
	def get_le_1_m(self) -> bool:
		...
		Snippet: value: bool = driver.configure.bluetooth.measurement.dtMode.rxQuality.search.rintegrity.lowEnergy.get_le_1_m() \n
	...
	def set_le_1_m(self, report_integrity: bool) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:DTMode:RXQuality:SEARch:RINTegrity:LENergy:LE1M \n
		Snippet: driver.configure.bluetooth.measurement.dtMode.rxQuality.search.rintegrity.lowEnergy.set_le_1_m(report_integrity = False) \n
		No command help available \n
	...
	def get_le_2_m(self) -> bool:
		...
		Snippet: value: bool = driver.configure.bluetooth.measurement.dtMode.rxQuality.search.rintegrity.lowEnergy.get_le_2_m() \n
		No command help available \n
			:return: report_integrity: No help available
		"""
	...
	def set_le_2_m(self, report_integrity: bool) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:DTMode:RXQuality:SEARch:RINTegrity:LENergy:LE2M \n
		Snippet: driver.configure.bluetooth.measurement.dtMode.rxQuality.search.rintegrity.lowEnergy.set_le_2_m(report_integrity = False) \n
		No command help available \n
			:param report_integrity: No help available
		"""
		param = Conversions.bool_to_str(report_integrity)
	...
	def get_lrange(self) -> bool:
		...
		Snippet: value: bool = driver.configure.bluetooth.measurement.dtMode.rxQuality.search.rintegrity.lowEnergy.get_lrange() \n
		No command help available \n
			:return: report_integrity: No help available
		"""
	...
	def set_lrange(self, report_integrity: bool) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:DTMode:RXQuality:SEARch:RINTegrity:LENergy:LRANge \n
		Snippet: driver.configure.bluetooth.measurement.dtMode.rxQuality.search.rintegrity.lowEnergy.set_lrange(report_integrity = False) \n
		No command help available \n
			:param report_integrity: No help available
		"""
		param = Conversions.bool_to_str(report_integrity)
