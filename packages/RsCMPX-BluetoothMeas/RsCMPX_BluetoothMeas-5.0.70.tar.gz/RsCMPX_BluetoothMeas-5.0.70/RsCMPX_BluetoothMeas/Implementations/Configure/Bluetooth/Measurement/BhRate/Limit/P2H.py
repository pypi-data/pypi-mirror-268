...
class P2HCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("p2H", core, parent)
	...
	def get_devm(self) -> DevmStruct:
		...
		Snippet: value: DevmStruct = driver.configure.bluetooth.measurement.bhRate.limit.p2H.get_devm() \n
		No command help available \n
			:return: structure: for return value, see the help for DevmStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:BHRate:LIMit:P2H:DEVM?', self.__class__.DevmStruct())
	...
	def set_devm(self, value: DevmStruct) -> None:
		...
		driver.configure.bluetooth.measurement.bhRate.limit.p2H.set_devm(value = structure) \n
		No command help available \n
			:param value: see the help for DevmStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:BHRate:LIMit:P2H:DEVM', value)
	...
	def get_sgacp(self) -> SgacpStruct:
		...
		Snippet: value: SgacpStruct = driver.configure.bluetooth.measurement.bhRate.limit.p2H.get_sgacp() \n
		No command help available \n
			:return: structure: for return value, see the help for SgacpStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:BHRate:LIMit:P2H:SGACp?', self.__class__.SgacpStruct())

	def set_sgacp(self, value: SgacpStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:BHRate:LIMit:P2H:SGACp \n
		Snippet with structure: \n
		structure = driver.configure.bluetooth.measurement.bhRate.limit.p2H.SgacpStruct() \n
		...
		driver.configure.bluetooth.measurement.bhRate.limit.p2H.set_sgacp(value = structure) \n
		No command help available \n
			:param value: see the help for SgacpStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:BHRate:LIMit:P2H:SGACp', value)
