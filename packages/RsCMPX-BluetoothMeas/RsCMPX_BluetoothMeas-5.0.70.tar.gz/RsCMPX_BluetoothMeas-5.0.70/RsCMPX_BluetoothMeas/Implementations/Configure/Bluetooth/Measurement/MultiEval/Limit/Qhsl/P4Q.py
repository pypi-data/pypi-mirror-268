...
class P4QCls:
	...
	def get_devm(self) -> DevmStruct:
		...
		Snippet: value: DevmStruct = driver.configure.bluetooth.measurement.multiEval.limit.qhsl.p4Q.get_devm() \n
	...
	def set_devm(self, value: DevmStruct) -> None:
		...
		structure = driver.configure.bluetooth.measurement.multiEval.limit.qhsl.p4Q.DevmStruct() \n
		...
		driver.configure.bluetooth.measurement.multiEval.limit.qhsl.p4Q.set_devm(value = structure) \n
		No command help available \n
