...
class MaximumCls:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.bluetooth.measurement.multiEval.powerVsTime.qhsl.p6Q.maximum.calculate() \n
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.bluetooth.measurement.multiEval.powerVsTime.qhsl.p6Q.maximum.read() \n
		No command help available \n
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.bluetooth.measurement.multiEval.powerVsTime.qhsl.p6Q.maximum.fetch() \n
		No command help available \n
