...
class AverageCls:
	...
	def fetch(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.bluetooth.measurement.multiEval.trace.pdifference.average.fetch() \n
	...
	def read(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.bluetooth.measurement.multiEval.trace.pdifference.average.read() \n
		Returns the values of the phase difference traces. The results of the current, average minimum and maximum traces can be
		retrieved. The phase difference traces are available for EDR bursts (method RsCMPX_BluetoothMeas.Configure.Bluetooth.
		Measurement.InputSignal.btype EDR) . \n
		Suppressed linked return values: reliability \n
