...
class MinimumCls:
	...
	def read(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.bluetooth.measurement.hdr.trace.powerVsTime.minimum.read() \n
	...
	def fetch(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.bluetooth.measurement.hdr.trace.powerVsTime.minimum.fetch() \n
		No command help available \n
		Suppressed linked return values: reliability \n
			:return: pvt_trace: No help available"""
		suppressed = ArgSingleSuppressed(0, DataType.Integer, False, 1, 'Reliability')
