...
class MaximumCls:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.bluetooth.measurement.multiEval.powerVsTime.nmode.lowEnergy.lrange.maximum.calculate() \n
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.bluetooth.measurement.multiEval.powerVsTime.nmode.lowEnergy.lrange.maximum.read() \n
		No command help available \n
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.bluetooth.measurement.multiEval.powerVsTime.nmode.lowEnergy.lrange.maximum.fetch() \n
		No command help available \n
