...
class ExtendedCls:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Delta_F_299_P: float: Frequency deviation value Δf2 above which 99.9% of all measured Δf2 values occur (BR, LE) .
	...
	def fetch(self, segment=repcap.Segment.Default) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.bluetooth.measurement.multiEval.listPy.segment.modulation.current.extended.fetch(segment = repcap.Segment.Default) \n
