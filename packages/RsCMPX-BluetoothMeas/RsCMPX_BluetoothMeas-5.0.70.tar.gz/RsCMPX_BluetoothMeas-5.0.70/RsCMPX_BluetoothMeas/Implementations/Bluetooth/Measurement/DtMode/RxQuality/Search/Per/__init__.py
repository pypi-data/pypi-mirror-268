...
class PerCls:
	...
	def initiate(self, opc_timeout_ms: int = -1) -> None:
		...
		Snippet: driver.bluetooth.measurement.dtMode.rxQuality.search.per.initiate() \n
	...
	def stop(self, opc_timeout_ms: int = -1) -> None:
		...
		Snippet: driver.bluetooth.measurement.dtMode.rxQuality.search.per.stop() \n
		No command help available \n
			:param opc_timeout_ms: Maximum time to wait in milliseconds, valid only for this call."""
	...
	def abort(self, opc_timeout_ms: int = -1) -> None:
		...
		Snippet: driver.bluetooth.measurement.dtMode.rxQuality.search.per.abort() \n
		No command help available \n
			:param opc_timeout_ms: Maximum time to wait in milliseconds, valid only for this call."""
