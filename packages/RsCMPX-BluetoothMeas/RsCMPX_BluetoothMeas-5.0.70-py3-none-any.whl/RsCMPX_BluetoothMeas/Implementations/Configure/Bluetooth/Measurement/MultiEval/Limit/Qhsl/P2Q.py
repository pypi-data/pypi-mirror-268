...
class P2QCls:
	...
	def get_devm(self) -> DevmStruct:
		...
		Snippet: value: DevmStruct = driver.configure.bluetooth.measurement.multiEval.limit.qhsl.p2Q.get_devm() \n
	...
	def set_devm(self, value: DevmStruct) -> None:
		...
		structure = driver.configure.bluetooth.measurement.multiEval.limit.qhsl.p2Q.DevmStruct() \n
		...
		driver.configure.bluetooth.measurement.multiEval.limit.qhsl.p2Q.set_devm(value = structure) \n
		No command help available \n
