...
class LowEnergyCls:
	...
	def get_le_1_m(self) -> int:
		...
		Snippet: value: int = driver.configure.bluetooth.measurement.dtMode.rxQuality.search.packets.lowEnergy.get_le_1_m() \n
	...
	def set_le_1_m(self, number_of_packets: int) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:DTMode:RXQuality:SEARch:PACKets:LENergy:LE1M \n
		Snippet: driver.configure.bluetooth.measurement.dtMode.rxQuality.search.packets.lowEnergy.set_le_1_m(number_of_packets = 1) \n
		No command help available \n
	...
	def get_le_2_m(self) -> int:
		...
		Snippet: value: int = driver.configure.bluetooth.measurement.dtMode.rxQuality.search.packets.lowEnergy.get_le_2_m() \n
		No command help available \n
			:return: number_of_packets: No help available
		"""
	...
	def set_le_2_m(self, number_of_packets: int) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:DTMode:RXQuality:SEARch:PACKets:LENergy:LE2M \n
		Snippet: driver.configure.bluetooth.measurement.dtMode.rxQuality.search.packets.lowEnergy.set_le_2_m(number_of_packets = 1) \n
		No command help available \n
			:param number_of_packets: No help available
		"""
		param = Conversions.decimal_value_to_str(number_of_packets)
	...
	def get_lrange(self) -> int:
		...
		Snippet: value: int = driver.configure.bluetooth.measurement.dtMode.rxQuality.search.packets.lowEnergy.get_lrange() \n
		No command help available \n
			:return: number_of_packets: No help available
		"""
	...
	def set_lrange(self, number_of_packets: int) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:DTMode:RXQuality:SEARch:PACKets:LENergy:LRANge \n
		Snippet: driver.configure.bluetooth.measurement.dtMode.rxQuality.search.packets.lowEnergy.set_lrange(number_of_packets = 1) \n
		No command help available \n
			:param number_of_packets: No help available
		"""
		param = Conversions.decimal_value_to_str(number_of_packets)
