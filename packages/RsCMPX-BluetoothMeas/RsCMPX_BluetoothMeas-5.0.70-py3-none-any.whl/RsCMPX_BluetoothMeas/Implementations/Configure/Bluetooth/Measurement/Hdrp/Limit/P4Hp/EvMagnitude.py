...
class EvMagnitudeCls:
	...
	def get_offset(self) -> OffsetStruct:
		...
		Snippet: value: OffsetStruct = driver.configure.bluetooth.measurement.hdrp.limit.p4Hp.evMagnitude.get_offset() \n
	...
	def set_offset(self, value: OffsetStruct) -> None:
		...
		structure = driver.configure.bluetooth.measurement.hdrp.limit.p4Hp.evMagnitude.OffsetStruct() \n
		...
		driver.configure.bluetooth.measurement.hdrp.limit.p4Hp.evMagnitude.set_offset(value = structure) \n
		No command help available \n
