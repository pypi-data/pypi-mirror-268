...
class P5QCls:
	...
	def get_type_py(self) -> enums.CtePacketType:
		...
		Snippet: value: enums.CtePacketType = driver.configure.bluetooth.measurement.inputSignal.cte.qhsl.p5Q.get_type_py() \n
	...
	def set_type_py(self, cte_type: enums.CtePacketType) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:ISIGnal:CTE:QHSL:P5Q:TYPE \n
		Snippet: driver.configure.bluetooth.measurement.inputSignal.cte.qhsl.p5Q.set_type_py(cte_type = enums.CtePacketType.AOA1us) \n
		No command help available \n
	...
	def get_units(self) -> int:
		...
		Snippet: value: int = driver.configure.bluetooth.measurement.inputSignal.cte.qhsl.p5Q.get_units() \n
		No command help available \n
	...
	def set_units(self, cte_units: int) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:ISIGnal:CTE:QHSL:P5Q:UNITs \n
		Snippet: driver.configure.bluetooth.measurement.inputSignal.cte.qhsl.p5Q.set_units(cte_units = 1) \n
		No command help available \n
