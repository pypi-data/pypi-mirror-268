...
class SingleCmwCls:
	...
	def get_cmode(self) -> enums.ParameterSetMode:
		...
		Snippet: value: enums.ParameterSetMode = driver.configure.bluetooth.measurement.multiEval.listPy.singleCmw.get_cmode() \n
	...
	def set_cmode(self, connector_mode: enums.ParameterSetMode) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<instance>:MEValuation:LIST:CMWS:CMODe \n
		Snippet: driver.configure.bluetooth.measurement.multiEval.listPy.singleCmw.set_cmode(connector_mode = enums.ParameterSetMode.GLOBal) \n
		No command help available \n
