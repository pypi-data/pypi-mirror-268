...
class MratioCls:
	...
	def set(self, mod_ratio: float, mod_ratio_enabled: bool) -> None:
		...
		Snippet: driver.configure.bluetooth.measurement.multiEval.limit.brate.mratio.set(mod_ratio = 1.0, mod_ratio_enabled = False) \n
	...
	def get(self) -> MratioStruct:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:BRATe:MRATio \n
		Snippet: value: MratioStruct = driver.configure.bluetooth.measurement.multiEval.limit.brate.mratio.get() \n
		Specifies the modulation ratio limit Δf2 avg / Δf1 avg for BR bursts. \n
