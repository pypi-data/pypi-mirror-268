...
class DeltaCls:
	...
	def set(self, delta_f_2_p_99_p_9: float, delta_f_2_p_99_enable: bool) -> None:
		...
		Snippet: driver.configure.bluetooth.measurement.multiEval.limit.lowEnergy.delta.set(delta_f_2_p_99_p_9 = 1.0, delta_f_2_p_99_enable = False) \n
		Sets/gets the limit for the frequency deviation Δf2 for LE 1M PHY that must be exceeded by 99.9% of the measured samples. \n
			:param delta_f_2_p_99_p_9: No help available
			:param delta_f_2_p_99_enable: Disable/enable limit checking
		"""
		...
		self._core.io.write(f'CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:DELTa {param}'.rstrip())
	...
	def get(self) -> DeltaStruct:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:DELTa \n
		Snippet: value: DeltaStruct = driver.configure.bluetooth.measurement.multiEval.limit.lowEnergy.delta.get() \n
		Sets/gets the limit for the frequency deviation Δf2 for LE 1M PHY that must be exceeded by 99.9% of the measured samples. \n
			:return: structure: for return value, see the help for DeltaStruct structure arguments."""
		return self._core.io.query_struct(f'CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:DELTa?', self.__class__.DeltaStruct())
