...
class StandardDevCls:
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.bluetooth.measurement.hdr.modulation.standardDev.read() \n
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.bluetooth.measurement.hdr.modulation.standardDev.fetch() \n
		No command help available \n
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.bluetooth.measurement.hdr.modulation.standardDev.calculate() \n
		No command help available \n
