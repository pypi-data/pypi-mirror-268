...
class P4QCls:
	...
	def fetch(self) -> int:
		...
		Snippet: value: int = driver.bluetooth.measurement.inputSignal.adetected.plength.qhsl.p4Q.fetch() \n
		No command help available \n
		Suppressed linked return values: reliability \n
			:return: payload_length: No help available"""
		suppressed = ArgSingleSuppressed(0, DataType.Integer, False, 1, 'Reliability')
		response = self._core.io.query_str_suppressed(f'FETCh:BLUetooth:MEASurement<Instance>:ISIGnal:ADETected:PLENgth:QHSL:P4Q?', suppressed)
