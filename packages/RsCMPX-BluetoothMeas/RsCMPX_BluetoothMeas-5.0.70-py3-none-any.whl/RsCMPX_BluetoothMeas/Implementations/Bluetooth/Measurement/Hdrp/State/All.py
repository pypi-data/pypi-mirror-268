...
class AllCls:
	...
	def fetch(self, timeout: float = None, target_main_state: enums.TargetMainState = None, target_sync_state: enums.SyncState = None) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.bluetooth.measurement.hdrp.state.all.fetch(timeout = 1.0, target_main_state = enums.TargetMainState.OFF, target_sync_state = enums.SyncState.ADJusted) \n
