...
class Le1MCls:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.bluetooth.measurement.multiEval.sacp.lowEnergy.le1M.calculate() \n
		Returns the Spectrum ACP results for LE1M. See 'Square Spectrum ACP'. The values described below are returned by FETCh
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.bluetooth.measurement.multiEval.sacp.lowEnergy.le1M.read() \n
		Returns the Spectrum ACP results for LE1M. See 'Square Spectrum ACP'. The values described below are returned by FETCh
		and READ commands. CALCulate commands return limit check results instead, one value for each result listed below. \n
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.bluetooth.measurement.multiEval.sacp.lowEnergy.le1M.fetch() \n
		Returns the Spectrum ACP results for LE1M. See 'Square Spectrum ACP'. The values described below are returned by FETCh
		and READ commands. CALCulate commands return limit check results instead, one value for each result listed below. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
