...
class CurrentCls:
	...
	def calculate(self) -> CalculateStruct:
		"""SCPI: CALCulate:BLUetooth:MEASurement<Instance>:MEValuation:PVTime:QHSL:P3Q:CURRent \n
		Snippet: value: CalculateStruct = driver.bluetooth.measurement.multiEval.powerVsTime.qhsl.p3Q.current.calculate() \n
		No command help available \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:BLUetooth:MEASurement<Instance>:MEValuation:PVTime:QHSL:P3Q:CURRent?', self.__class__.CalculateStruct())
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.bluetooth.measurement.multiEval.powerVsTime.qhsl.p3Q.current.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ReadStruct structure arguments."""
		return self._core.io.query_struct(f'READ:BLUetooth:MEASurement<Instance>:MEValuation:PVTime:QHSL:P3Q:CURRent?', self.__class__.ReadStruct())
	...
	def fetch(self) -> FetchStruct:
		"""SCPI: FETCh:BLUetooth:MEASurement<Instance>:MEValuation:PVTime:QHSL:P3Q:CURRent \n
		Snippet: value: FetchStruct = driver.bluetooth.measurement.multiEval.powerVsTime.qhsl.p3Q.current.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for FetchStruct structure arguments."""
		return self._core.io.query_struct(f'FETCh:BLUetooth:MEASurement<Instance>:MEValuation:PVTime:QHSL:P3Q:CURRent?', self.__class__.FetchStruct())
