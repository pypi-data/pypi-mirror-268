...
class MinimumCls:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.bluetooth.measurement.multiEval.powerVsTime.nmode.lowEnergy.le1M.minimum.calculate() \n
	...
	def read(self) -> ReadStruct:
		...
		Snippet: value: ReadStruct = driver.bluetooth.measurement.multiEval.powerVsTime.nmode.lowEnergy.le1M.minimum.read() \n
		No command help available \n
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.bluetooth.measurement.multiEval.powerVsTime.nmode.lowEnergy.le1M.minimum.fetch() \n
		No command help available \n
