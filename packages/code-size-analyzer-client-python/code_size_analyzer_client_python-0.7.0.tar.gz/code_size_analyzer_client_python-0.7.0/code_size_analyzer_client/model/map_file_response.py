...
class MapFileResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'summary_ext': ({str: (SummaryRecord,)},),  # noqa: E501
    ...
    attribute_map = {
        ...
        'summary_ext': 'summary_ext',  # noqa: E501
        'data': 'data',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, summary, summary_ext, data, categories, *args, **kwargs):  # noqa: E501
        """MapFileResponse - a model defined in OpenAPI

        Args:
            summary ({str: (SummaryRecord,)}):
            summary_ext ({str: (SummaryRecord,)}):
            data ([DataRecord]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, summary, summary_ext, data, categories, *args, **kwargs):  # noqa: E501
        """MapFileResponse - a model defined in OpenAPI
