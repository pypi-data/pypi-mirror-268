...
class FlexibleCls:
	...
	def get_internal(self) -> InternalStruct:
		...
		Snippet: value: InternalStruct = driver.route.scenario.ejf.flexible.get_internal() \n
		Activates the scenario '5CC - Fading - nx2 nx2 nx2 nx2 nx2' with internal fading and selects the signal paths.
		...
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:EJF:FLEXible:INTernal?', self.__class__.InternalStruct())
	...
	def set_internal(self, value: InternalStruct) -> None:
		...
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:EJF:FLEXible:INTernal', value)
