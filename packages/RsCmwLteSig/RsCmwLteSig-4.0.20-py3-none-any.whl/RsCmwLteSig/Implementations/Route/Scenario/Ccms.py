...
class CcmsCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("ccms", core, parent)
	...
	def set_flexible(self, value: FlexibleStruct) -> None:
		...
		structure.Scc_1_Tx_1_Connect: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_1_Tx_1_Convert: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_1_Tx_2_Connect: enums.TxConnector = enums.TxConnector.I12O \n
