...
class HyasCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("hyas", core, parent)
	...
	def get_flexible(self) -> FlexibleStruct:
		...
		Activates the scenario '8CC - nx2 nx4 nx4 nx4 nx4 nx4 nx2 nx2' and selects the signal paths. For possible parameter
