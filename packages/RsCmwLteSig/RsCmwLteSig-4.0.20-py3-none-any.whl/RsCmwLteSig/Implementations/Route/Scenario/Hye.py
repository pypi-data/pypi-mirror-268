...
class HyeCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("hye", core, parent)
	...
	def get_flexible(self) -> FlexibleStruct:
		...
		Snippet: value: FlexibleStruct = driver.route.scenario.hye.get_flexible() \n
		Activates the scenario '8CC - nx4 nx4 nx4 nx4 nx4 nx4 nx4 nx2' and selects the signal paths. For possible parameter
		...
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:HYE:FLEXible?', self.__class__.FlexibleStruct())
	...
	def set_flexible(self, value: FlexibleStruct) -> None:
		...
		structure.Pcc_Tx_3_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Pcc_Tx_3_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Pcc_Tx_4_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:HYE:FLEXible', value)
