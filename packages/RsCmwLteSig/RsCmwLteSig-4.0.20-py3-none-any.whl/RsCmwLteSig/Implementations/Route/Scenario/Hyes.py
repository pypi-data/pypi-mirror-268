...
class HyesCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("hyes", core, parent)
	...
	class FlexibleStruct(StructBase):  # From WriteStructDefinition CmdPropertyTemplate.xml
		"""Structure for setting input parameters. Contains optional set arguments. Fields: \n
			...
			- Scc_3_Tx_3_Connector: enums.TxConnector: RF connector for the third SCC3 output path
			- Scc_3_Tx_3_Converter: enums.TxConverter: TX module for the third SCC3 output path
			- Scc_3_Tx_4_Connector: enums.TxConnector: RF connector for the fourth SCC3 output path
			- Scc_3_Tx_4_Converter: enums.TxConverter: TX module for the fourth SCC3 output path
			...
			- Scc_7_Tx_1_Connector: enums.TxConnector: RF connector for the first SCC7 output path
			- Scc_7_Tx_1_Converter: enums.TxConverter: TX module for the first SCC7 output path
			- Scc_7_Tx_2_Connector: enums.TxConnector: RF connector for the second SCC7 output path
			- Scc_7_Tx_2_Converter: enums.TxConverter: TX module for the second SCC7 output path
			- Scc_7_Tx_3_Connector: enums.TxConnector: RF connector for the third SCC7 output path
			- Scc_7_Tx_3_Converter: enums.TxConverter: TX module for the third SCC7 output path
			- Scc_7_Tx_4_Connector: enums.TxConnector: RF connector for the fourth SCC7 output path
			- Scc_7_Tx_4_Converter: enums.TxConverter: TX module for the fourth SCC7 output path
		...
		__meta_args_list = [
			...
			ArgStruct.scalar_enum('Scc_3_Tx_3_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_3_Tx_3_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_3_Tx_4_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_3_Tx_4_Converter', enums.TxConverter),
			...
			ArgStruct.scalar_enum('Scc_4_Tx_3_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_4_Tx_3_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_4_Tx_4_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_4_Tx_4_Converter', enums.TxConverter),
			...
			ArgStruct.scalar_enum('Scc_5_Tx_3_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_5_Tx_3_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_5_Tx_4_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_5_Tx_4_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_6_Bb_Board', enums.BasebandBoard),
			ArgStruct.scalar_enum('Scc_6_Tx_1_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_6_Tx_1_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_6_Tx_2_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_6_Tx_2_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_6_Tx_3_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_6_Tx_3_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_6_Tx_4_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_6_Tx_4_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_7_Bb_Board', enums.BasebandBoard),
			ArgStruct.scalar_enum('Scc_7_Tx_1_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_7_Tx_1_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_7_Tx_2_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_7_Tx_2_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_7_Tx_3_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_7_Tx_3_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_7_Tx_4_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_7_Tx_4_Converter', enums.TxConverter),
		...
		def __init__(self):
			...
			self.Scc_3_Tx_3_Connector: enums.TxConnector = None
			self.Scc_3_Tx_3_Converter: enums.TxConverter = None
			self.Scc_3_Tx_4_Connector: enums.TxConnector = None
			self.Scc_3_Tx_4_Converter: enums.TxConverter = None
			...
			self.Scc_4_Tx_3_Connector: enums.TxConnector = None
			self.Scc_4_Tx_3_Converter: enums.TxConverter = None
			self.Scc_4_Tx_4_Connector: enums.TxConnector = None
			self.Scc_4_Tx_4_Converter: enums.TxConverter = None
			...
			self.Scc_5_Tx_3_Connector: enums.TxConnector = None
			self.Scc_5_Tx_3_Converter: enums.TxConverter = None
			self.Scc_5_Tx_4_Connector: enums.TxConnector = None
			self.Scc_5_Tx_4_Converter: enums.TxConverter = None
			self.Scc_6_Bb_Board: enums.BasebandBoard = None
			self.Scc_6_Tx_1_Connector: enums.TxConnector = None
			self.Scc_6_Tx_1_Converter: enums.TxConverter = None
			self.Scc_6_Tx_2_Connector: enums.TxConnector = None
			self.Scc_6_Tx_2_Converter: enums.TxConverter = None
			self.Scc_6_Tx_3_Connector: enums.TxConnector = None
			self.Scc_6_Tx_3_Converter: enums.TxConverter = None
			self.Scc_6_Tx_4_Connector: enums.TxConnector = None
			self.Scc_6_Tx_4_Converter: enums.TxConverter = None
			self.Scc_7_Bb_Board: enums.BasebandBoard = None
			self.Scc_7_Tx_1_Connector: enums.TxConnector = None
			self.Scc_7_Tx_1_Converter: enums.TxConverter = None
			self.Scc_7_Tx_2_Connector: enums.TxConnector = None
			self.Scc_7_Tx_2_Converter: enums.TxConverter = None
			self.Scc_7_Tx_3_Connector: enums.TxConnector = None
			self.Scc_7_Tx_3_Converter: enums.TxConverter = None
			self.Scc_7_Tx_4_Connector: enums.TxConnector = None
			self.Scc_7_Tx_4_Converter: enums.TxConverter = None
	...
	def get_flexible(self) -> FlexibleStruct:
		...
		Snippet: value: FlexibleStruct = driver.route.scenario.hyes.get_flexible() \n
		Activates the scenario '8CC - nx2 nx4 nx4 nx4 nx4 nx4 nx4 nx4' and selects the signal paths. For possible parameter
		...
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:HYES4:FLEXible?', self.__class__.FlexibleStruct())
	...
	def set_flexible(self, value: FlexibleStruct) -> None:
		...
		structure.Scc_3_Tx_3_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_3_Tx_3_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_3_Tx_4_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Scc_4_Tx_3_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_4_Tx_3_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_4_Tx_4_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Scc_5_Tx_3_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_5_Tx_3_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_5_Tx_4_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Scc_6_Tx_1_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_6_Tx_1_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_6_Tx_2_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_6_Tx_2_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_6_Tx_3_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_6_Tx_3_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_6_Tx_4_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Scc_7_Tx_1_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_7_Tx_1_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_7_Tx_2_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_7_Tx_2_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_7_Tx_3_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_7_Tx_3_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_7_Tx_4_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:HYES4:FLEXible', value)
