...
class RelativeCls:
	...
	def fetch(self, secondaryCompCarrier=repcap.SecondaryCompCarrier.Default) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.intermediate.ebler.scc.relative.fetch(secondaryCompCarrier = repcap.SecondaryCompCarrier.Default) \n
		...
		return self._core.io.query_struct(f'FETCh:INTermediate:LTE:SIGNaling<Instance>:EBLer:SCC{secondaryCompCarrier_cmd_val}:RELative?', self.__class__.FetchStruct())
