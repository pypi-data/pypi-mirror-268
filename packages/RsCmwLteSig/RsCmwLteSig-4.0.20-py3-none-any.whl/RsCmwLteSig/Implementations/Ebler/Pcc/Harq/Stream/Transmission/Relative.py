...
class RelativeCls:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Sent: List[float]: float Sent subframes (percentage of sum of sent subframes over all transmissions) Unit: %
	...
	def fetch(self, stream=repcap.Stream.Default) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.ebler.pcc.harq.stream.transmission.relative.fetch(stream = repcap.Stream.Default) \n
