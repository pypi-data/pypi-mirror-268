...
class UpdateCls:
	...
	def set(self) -> None:
		...
		Snippet: driver.configure.sib.update.set() \n
		No command help available \n
		"""
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:SIB1:UPDate')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:SIB<n>:UPDate \n
		Snippet: driver.configure.sib.update.set_with_opc() \n
		No command help available \n
		...
		self._core.io.write_with_opc(f'CONFigure:LTE:SIGNaling<Instance>:SIB1:UPDate', opc_timeout_ms)
