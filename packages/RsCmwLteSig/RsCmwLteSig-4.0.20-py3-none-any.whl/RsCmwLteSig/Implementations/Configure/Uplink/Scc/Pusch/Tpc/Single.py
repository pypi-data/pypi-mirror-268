...
class SingleCls:
	...
	def set(self, no_of_steps: int, step_direction: enums.UpDownDirection, secondaryCompCarrier=repcap.SecondaryCompCarrier.Default) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL:SCC<Carrier>:PUSCh:TPC:SINGle \n
		Snippet: driver.configure.uplink.scc.pusch.tpc.single.set(no_of_steps = 1, step_direction = enums.UpDownDirection.DOWN, secondaryCompCarrier = repcap.SecondaryCompCarrier.Default) \n
		...
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:UL:SCC{secondaryCompCarrier_cmd_val}:PUSCh:TPC:SINGle {param}'.rstrip())
