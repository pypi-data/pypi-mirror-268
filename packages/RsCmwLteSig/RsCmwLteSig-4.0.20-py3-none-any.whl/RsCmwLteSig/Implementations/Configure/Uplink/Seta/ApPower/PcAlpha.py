...
class PcAlphaCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("pcAlpha", core, parent)

	# noinspection PyTypeChecker
	def get_advanced(self) -> enums.PathCompAlpha:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL:SETA:APPower:PCALpha:ADVanced \n
		Snippet: value: enums.PathCompAlpha = driver.configure.uplink.seta.apPower.pcAlpha.get_advanced() \n
		...
		"""
		response = self._core.io.query_str('CONFigure:LTE:SIGNaling<Instance>:UL:SETA:APPower:PCALpha:ADVanced?')
	...
	def set_advanced(self, path_comp_alpha: enums.PathCompAlpha) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL:SETA:APPower:PCALpha:ADVanced \n
		Snippet: driver.configure.uplink.seta.apPower.pcAlpha.set_advanced(path_comp_alpha = enums.PathCompAlpha.DOT4) \n
		Specifies the value of parameter 'alpha', signaled to the UE if advanced UL power configuration applies. \n
		...
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:UL:SETA:APPower:PCALpha:ADVanced {param}')
