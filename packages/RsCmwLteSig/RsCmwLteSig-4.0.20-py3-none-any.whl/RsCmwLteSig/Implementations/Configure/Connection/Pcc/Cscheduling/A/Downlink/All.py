...
class AllCls:
	...
	def set(self, number_rb: int, start_rb: int, modulation: enums.Modulation, trans_block_size_idx: int) -> None:
		...
		Snippet: driver.configure.connection.pcc.cscheduling.a.downlink.all.set(number_rb = 1, start_rb = 1, modulation = enums.Modulation.Q1024, trans_block_size_idx = 1) \n
		Configures eMTC compact scheduling, downlink, for CE mode A. The indicated input ranges list all possible values.
		The ranges have dependencies described in the background information, see 'eMTC compact scheduling'. \n
			...
			:param start_rb: numeric Position of first resource block Range: 0 to 4
			:param modulation: QPSK | Q16 Modulation type QPSK | 16-QAM
			:param trans_block_size_idx: numeric Transport block size index Range: 0 to 14
		"""
		...
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:CSCHeduling:A:DL:ALL {param}'.rstrip())

	# noinspection PyTypeChecker
	class AllStruct(StructBase):
		"""Response structure. Fields: \n
			- Number_Rb: int: numeric Number of allocated resource blocks Range: 0 to 4
			- Start_Rb: int: numeric Position of first resource block Range: 0 to 4
			- Modulation: enums.Modulation: QPSK | Q16 Modulation type QPSK | 16-QAM
			- Trans_Block_Size_Idx: int: numeric Transport block size index Range: 0 to 14"""
		__meta_args_list = [
	...
	def get(self) -> AllStruct:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:CONNection[:PCC]:CSCHeduling:A:DL:ALL \n
		Snippet: value: AllStruct = driver.configure.connection.pcc.cscheduling.a.downlink.all.get() \n
		Configures eMTC compact scheduling, downlink, for CE mode A. The indicated input ranges list all possible values.
		The ranges have dependencies described in the background information, see 'eMTC compact scheduling'. \n
			:return: structure: for return value, see the help for AllStruct structure arguments."""
		return self._core.io.query_struct(f'CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:CSCHeduling:A:DL:ALL?', self.__class__.AllStruct())
