...
class PcAlphaCls:
	...
	def get_basic(self) -> enums.PathCompAlpha:
		...
		Snippet: value: enums.PathCompAlpha = driver.sense.uplink.pcc.apPower.pcAlpha.get_basic() \n
		...
		"""
		response = self._core.io.query_str('SENSe:LTE:SIGNaling<Instance>:UL:PCC:APPower:PCALpha:BASic?')
