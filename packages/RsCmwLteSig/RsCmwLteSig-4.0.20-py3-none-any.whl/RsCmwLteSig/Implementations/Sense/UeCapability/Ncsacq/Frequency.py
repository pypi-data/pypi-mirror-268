...
class FrequencyCls:
	...
	def get_intra(self) -> bool:
		...
		Snippet: value: bool = driver.sense.ueCapability.ncsacq.frequency.get_intra() \n
		...
		"""
		response = self._core.io.query_str('SENSe:LTE:SIGNaling<Instance>:UECapability:NCSacq:FREQuency:INTRa?')
		return Conversions.str_to_bool(response)

	def get_inter(self) -> bool:
		"""SCPI: SENSe:LTE:SIGNaling<instance>:UECapability:NCSacq:FREQuency:INTer \n
		Snippet: value: bool = driver.sense.ueCapability.ncsacq.frequency.get_inter() \n
		Returns whether the UE supports system information acquisition for inter-frequency neighbor cells or not. \n
			:return: supported: OFF | ON
		"""
		response = self._core.io.query_str('SENSe:LTE:SIGNaling<Instance>:UECapability:NCSacq:FREQuency:INTer?')
		return Conversions.str_to_bool(response)
