...
class NcsacqCls:
	...
	def get_utran(self) -> bool:
		...
		Snippet: value: bool = driver.sense.ueCapability.faueEutra.ncsacq.get_utran() \n
		Returns whether the UE supports system information acquisition for UMTS neighbor cells or not. \n
			:return: supported: OFF | ON
		"""
		response = self._core.io.query_str('SENSe:LTE:SIGNaling<Instance>:UECapability:FAUeeutra:NCSacq:UTRan?')
