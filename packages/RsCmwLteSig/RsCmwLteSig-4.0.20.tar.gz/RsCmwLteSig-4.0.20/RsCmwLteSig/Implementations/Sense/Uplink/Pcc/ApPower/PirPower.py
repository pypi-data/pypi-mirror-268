...
class PirPowerCls:
	...
	def get_basic(self) -> float:
		...
		Snippet: value: float = driver.sense.uplink.pcc.apPower.pirPower.get_basic() \n
		...
		"""
		response = self._core.io.query_str('SENSe:LTE:SIGNaling<Instance>:UL:PCC:APPower:PIRPower:BASic?')
