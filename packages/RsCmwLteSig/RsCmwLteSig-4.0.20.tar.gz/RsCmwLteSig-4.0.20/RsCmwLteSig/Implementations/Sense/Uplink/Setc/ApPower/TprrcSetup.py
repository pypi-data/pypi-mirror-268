...
class TprrcSetupCls:
	...
	def get_basic(self) -> bool:
		...
		Snippet: value: bool = driver.sense.uplink.setc.apPower.tprrcSetup.get_basic() \n
		...
		"""
		response = self._core.io.query_str('SENSe:LTE:SIGNaling<Instance>:UL:SETC:APPower:TPRRcsetup:BASic?')
