...
class CrateCls:
	...
	def get_all(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.sense.connection.pcc.udChannels.uplink.crate.get_all() \n
		...
		"""
		response = self._core.io.query_bin_or_ascii_float_list('SENSe:LTE:SIGNaling<Instance>:CONNection:PCC:UDCHannels:UL:CRATe:ALL?')
		return response
