...
class AtableCls:
	...
	def get_list_py(self) -> List[enums.Table]:
		...
		Snippet: value: List[enums.Table] = driver.sense.connection.pcc.fwbcqi.downlink.mcs.atable.get_list_py() \n
		...
		"""
		response = self._core.io.query_str('SENSe:LTE:SIGNaling<Instance>:CONNection:PCC:FWBCqi:DL:MCS:ATABle:LIST?')
