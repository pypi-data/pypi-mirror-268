...
class GeranCls:
	...
	def get_supported(self) -> List[bool]:
		"""SCPI: SENSe:LTE:SIGNaling<instance>:UECapability:TAUeeutra:IRAT:GERan:SUPPorted \n
		Snippet: value: List[bool] = driver.sense.ueCapability.taueEutra.interRat.geran.get_supported() \n
		...
		"""
		response = self._core.io.query_str('SENSe:LTE:SIGNaling<Instance>:UECapability:TAUeeutra:IRAT:GERan:SUPPorted?')
		return Conversions.str_to_bool_list(response)

	def get_phgeran(self) -> bool:
		"""SCPI: SENSe:LTE:SIGNaling<instance>:UECapability:TAUeeutra:IRAT:GERan:PHGeran \n
		Snippet: value: bool = driver.sense.ueCapability.taueEutra.interRat.geran.get_phgeran() \n
		Returns whether the UE supports handover to GERAN or not. \n
			:return: ps_ho_geran: OFF | ON
		"""
		response = self._core.io.query_str('SENSe:LTE:SIGNaling<Instance>:UECapability:TAUeeutra:IRAT:GERan:PHGeran?')
