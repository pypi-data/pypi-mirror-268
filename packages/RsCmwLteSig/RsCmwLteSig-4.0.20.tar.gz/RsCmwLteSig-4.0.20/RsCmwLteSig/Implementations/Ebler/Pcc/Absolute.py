...
class AbsoluteCls:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.ebler.pcc.absolute.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:LTE:SIGNaling<Instance>:EBLer:PCC:ABSolute?', self.__class__.FetchStruct())
