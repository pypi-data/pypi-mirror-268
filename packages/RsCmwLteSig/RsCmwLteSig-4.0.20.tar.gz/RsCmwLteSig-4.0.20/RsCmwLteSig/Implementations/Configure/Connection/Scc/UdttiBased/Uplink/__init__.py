...
class UplinkCls:
	...
	def set(self, tti: float, number_rb: int or bool, start_rb: int or bool, modulation: enums.Modulation, trans_block_size_idx: int or bool, secondaryCompCarrier=repcap.SecondaryCompCarrier.Default) -> None:
