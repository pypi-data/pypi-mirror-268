...
class StypeCls:
	...
	def set(self, type_py: enums.SchedulingType, cqi_mode: enums.CqiMode = None, secondaryCompCarrier=repcap.SecondaryCompCarrier.Default) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:CONNection:SCC<Carrier>:STYPe \n
		Snippet: driver.configure.connection.scc.stype.set(type_py = enums.SchedulingType.CQI, cqi_mode = enums.CqiMode.FCPRi, secondaryCompCarrier = repcap.SecondaryCompCarrier.Default) \n
		...
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:CONNection:SCC{secondaryCompCarrier_cmd_val}:STYPe {param}'.rstrip())
