...
class UplinkCls:
	...
	def set(self, number_rb: enums.NumberRb, modulation: enums.Modulation, trans_block_size_idx: enums.TransBlockSizeIdx) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:CONNection[:PCC]:RMC:UL \n
		Snippet: driver.configure.connection.pcc.rmc.uplink.set(number_rb = enums.NumberRb.N1, modulation = enums.Modulation.Q1024, trans_block_size_idx = enums.TransBlockSizeIdx.T1) \n
		Configures an uplink reference measurement channel (RMC) with contiguous allocation.
			...
			:param number_rb: ZERO | N1 | N2 | N3 | N4 | N5 | N6 | N7 | N8 | N9 | N10 | N12 | N15 | N16 | N17 | N18 | N20 | N21 | N24 | N25 | N27 | N30 | N32 | N36 | N40 | N42 | N45 | N48 | N50 | N54 | N60 | N64 | N72 | N75 | N80 | N81 | N83 | N90 | N92 | N96 | N100 Number of allocated resource blocks
		...
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:RMC:UL {param}'.rstrip())

	# noinspection PyTypeChecker
	class UplinkStruct(StructBase):
		"""Response structure. Fields: \n
			- Number_Rb: enums.NumberRb: ZERO | N1 | N2 | N3 | N4 | N5 | N6 | N7 | N8 | N9 | N10 | N12 | N15 | N16 | N17 | N18 | N20 | N21 | N24 | N25 | N27 | N30 | N32 | N36 | N40 | N42 | N45 | N48 | N50 | N54 | N60 | N64 | N72 | N75 | N80 | N81 | N83 | N90 | N92 | N96 | N100 Number of allocated resource blocks
	...
	def get(self) -> UplinkStruct:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:CONNection[:PCC]:RMC:UL \n
		Snippet: value: UplinkStruct = driver.configure.connection.pcc.rmc.uplink.get() \n
		Configures an uplink reference measurement channel (RMC) with contiguous allocation.
			INTRO_CMD_HELP: Depending on other settings, only a subset of the listed values is allowed, see: \n
			- 'Scheduling type RMC'
			- 'Scheduling type RMC for eMTC'
		...
		return self._core.io.query_struct(f'CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:RMC:UL?', self.__class__.UplinkStruct())
