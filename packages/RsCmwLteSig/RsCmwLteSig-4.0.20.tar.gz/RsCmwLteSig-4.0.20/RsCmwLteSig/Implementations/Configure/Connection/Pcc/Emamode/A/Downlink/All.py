...
class AllCls:
	...
	def set(self, number_rb: enums.NumberRb, start_rb: int, narrow_band: int, modulation: enums.Modulation, transp_block_size_idx: int) -> None:
		...
		Snippet: driver.configure.connection.pcc.emamode.a.downlink.all.set(number_rb = enums.NumberRb.N1, start_rb = 1, narrow_band = 1, modulation = enums.Modulation.Q1024, transp_block_size_idx = 1) \n
		...
		have dependencies described in the background information, see 'eMTC auto mode'. \n
			:param number_rb: ZERO | N1 | N2 | N3 | N4 | N5 | N6 Number of allocated resource blocks
			...
			:param transp_block_size_idx: numeric Transport block size index Range: 0 to 14
		"""
		...
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:EMAMode:A:DL:ALL {param}'.rstrip())
	...
	def get(self) -> AllStruct:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:CONNection[:PCC]:EMAMode:A:DL:ALL \n
		Snippet: value: AllStruct = driver.configure.connection.pcc.emamode.a.downlink.all.get() \n
		Configures the eMTC auto mode, downlink, for CE mode A. The indicated input ranges list all possible values. The ranges
		have dependencies described in the background information, see 'eMTC auto mode'. \n
			:return: structure: for return value, see the help for AllStruct structure arguments."""
		return self._core.io.query_struct(f'CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:EMAMode:A:DL:ALL?', self.__class__.AllStruct())
