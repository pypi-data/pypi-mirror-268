...
class PexecuteCls:
	...
	def set(self) -> None:
		...
		Snippet: driver.configure.uplink.pcc.pusch.tpc.pexecute.set() \n
		...
		"""
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:PEXecute')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL[:PCC]:PUSCh:TPC:PEXecute \n
		Snippet: driver.configure.uplink.pcc.pusch.tpc.pexecute.set_with_opc() \n
		Execute the active TPC setup for power control of the PUSCH. This command is only relevant for setups which are not
		executed automatically (SINGle, UDSingle, RPControl, FULPower) . \n
		...
		self._core.io.write_with_opc(f'CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:PEXecute', opc_timeout_ms)
