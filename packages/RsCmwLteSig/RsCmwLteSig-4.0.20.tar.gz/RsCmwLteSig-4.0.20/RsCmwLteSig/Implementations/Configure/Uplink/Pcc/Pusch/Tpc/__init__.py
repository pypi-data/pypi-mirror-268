...
class TpcCls:
	...
	def get_set(self) -> enums.SetType:
		...
		Snippet: value: enums.SetType = driver.configure.uplink.pcc.pusch.tpc.get_set() \n
		...
		"""
		response = self._core.io.query_str('CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:SET?')
		return Conversions.str_to_scalar_enum(response, enums.SetType)

	def set_set(self, set_type: enums.SetType) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL[:PCC]:PUSCh:TPC:SET \n
		Snippet: driver.configure.uplink.pcc.pusch.tpc.set_set(set_type = enums.SetType.ALT0) \n
		Selects the active TPC setup to be executed for power control of the PUSCH. For some TPC setups, the execution must be
		explicitly triggered via method RsCmwLteSig.Configure.Uplink.Pcc.Pusch.Tpc.Pexecute.set. \n
		...
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:SET {param}')

	# noinspection PyTypeChecker
	def get_rp_control(self) -> enums.RpControlPattern:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL[:PCC]:PUSCh:TPC:RPControl \n
		Snippet: value: enums.RpControlPattern = driver.configure.uplink.pcc.pusch.tpc.get_rp_control() \n
		...
		"""
		response = self._core.io.query_str('CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:RPControl?')
	...
	def set_rp_control(self, pattern: enums.RpControlPattern) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL[:PCC]:PUSCh:TPC:RPControl \n
		Snippet: driver.configure.uplink.pcc.pusch.tpc.set_rp_control(pattern = enums.RpControlPattern.RDA) \n
		Selects a TPC pattern for 3GPP relative power control tests with the TPC setup RPControl. \n
		...
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:RPControl {param}')

	def get_clt_power(self) -> float:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL[:PCC]:PUSCh:TPC:CLTPower \n
		Snippet: value: float = driver.configure.uplink.pcc.pusch.tpc.get_clt_power() \n
		Defines the target power for power control with the TPC setup CLOop. \n
			:return: power: numeric Range: -50 dBm to 33 dBm, Unit: dBm
		"""
		response = self._core.io.query_str('CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:CLTPower?')
		return Conversions.str_to_float(response)

	def set_clt_power(self, power: float) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL[:PCC]:PUSCh:TPC:CLTPower \n
		Snippet: driver.configure.uplink.pcc.pusch.tpc.set_clt_power(power = 1.0) \n
		Defines the target power for power control with the TPC setup CLOop. \n
			:param power: numeric Range: -50 dBm to 33 dBm, Unit: dBm
		"""
		param = Conversions.decimal_value_to_str(power)
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:CLTPower {param}')

	def get_tpower(self) -> float:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL[:PCC]:PUSCh:TPC:TPOWer \n
		Snippet: value: float = driver.configure.uplink.pcc.pusch.tpc.get_tpower() \n
		Defines the target powers for power control with the TPC setup FULPower. \n
			:return: power: numeric Range: -50 dBm to 33 dBm, Unit: dBm
		"""
		response = self._core.io.query_str('CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:TPOWer?')
		return Conversions.str_to_float(response)

	def set_tpower(self, power: float) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL[:PCC]:PUSCh:TPC:TPOWer \n
		Snippet: driver.configure.uplink.pcc.pusch.tpc.set_tpower(power = 1.0) \n
		Defines the target powers for power control with the TPC setup FULPower. \n
			:param power: numeric Range: -50 dBm to 33 dBm, Unit: dBm
		"""
		param = Conversions.decimal_value_to_str(power)
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:TPOWer {param}')
	...
	def get_ud_pattern(self) -> UdPatternStruct:
		...
		Snippet: value: UdPatternStruct = driver.configure.uplink.pcc.pusch.tpc.get_ud_pattern() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:UDPattern?', self.__class__.UdPatternStruct())
	...
	def set_ud_pattern(self, value: UdPatternStruct) -> None:
		...
		"""
		self._core.io.write_struct('CONFigure:LTE:SIGNaling<Instance>:UL:PCC:PUSCh:TPC:UDPattern', value)
