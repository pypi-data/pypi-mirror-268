...
class CellCls:
	...
	def set(self, enable: bool, band_class: enums.BandClass, channel: int, cell_id: int, measurement: bool = None, cellNo=repcap.CellNo.Default) -> None:
		...
		Snippet: driver.configure.ncell.evdo.cell.set(enable = False, band_class = enums.BandClass.AWS, channel = 1, cell_id = 1, measurement = False, cellNo = repcap.CellNo.Default) \n
		...
		self._core.io.write(f'CONFigure:LTE:SIGNaling<Instance>:NCELl:EVDO:CELL{cellNo_cmd_val} {param}'.rstrip())
