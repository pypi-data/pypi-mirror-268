...
class HhCls:
	...
	class FlexibleStruct(StructBase):  # From WriteStructDefinition CmdPropertyTemplate.xml
		"""Structure for setting input parameters. Contains optional set arguments. Fields: \n
			...
			- Bb_Board_8: enums.BasebandBoard: Signaling unit for the SCC7
			- Tx_8_Connector: enums.TxConnector: RF connector for the SCC7 output path
			- Tx_8_Converter: enums.TxConverter: TX module for the SCC7 output path
		...
		__meta_args_list = [
			...
			ArgStruct.scalar_enum('Bb_Board_8', enums.BasebandBoard),
			ArgStruct.scalar_enum('Tx_8_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Tx_8_Converter', enums.TxConverter),
		...
		def __init__(self):
			...
			self.Bb_Board_8: enums.BasebandBoard = None
			self.Tx_8_Connector: enums.TxConnector = None
			self.Tx_8_Converter: enums.TxConverter = None
	...
	def get_flexible(self) -> FlexibleStruct:
		...
		Snippet: value: FlexibleStruct = driver.route.scenario.hh.get_flexible() \n
		Activates the scenario '8CC - 1x1 1x1 1x1 1x1 1x1 1x1 1x1 1x1' and selects the signal paths. For possible parameter
		...
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:HH:FLEXible?', self.__class__.FlexibleStruct())
	...
	def set_flexible(self, value: FlexibleStruct) -> None:
		...
		structure.Tx_5_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Tx_6_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Tx_7_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Tx_8_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:HH:FLEXible', value)
