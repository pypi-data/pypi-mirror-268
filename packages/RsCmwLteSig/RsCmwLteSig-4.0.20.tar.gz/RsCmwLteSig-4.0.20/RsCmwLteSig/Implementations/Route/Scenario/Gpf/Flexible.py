...
class FlexibleCls:
	...
	class InternalStruct(StructBase):  # From WriteStructDefinition CmdPropertyTemplate.xml
		"""Structure for setting input parameters. Contains optional set arguments. Fields: \n
			...
			- Scc_6_Fading_Board: enums.FadingBoard: Optional setting parameter. Internal fader for the SCC6
		...
		__meta_args_list = [
			...
			ArgStruct.scalar_enum_optional('Scc_6_Fading_Board', enums.FadingBoard),
	...
	def get_internal(self) -> InternalStruct:
		...
		Snippet: value: InternalStruct = driver.route.scenario.gpf.flexible.get_internal() \n
		Activates the scenario '7CC - Fading - nx4 nx2 nx2 nx2 nx2 nx2 nx2' with internal fading and selects the signal paths.
		...
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:GPF:FLEXible:INTernal?', self.__class__.InternalStruct())
	...
	def set_internal(self, value: InternalStruct) -> None:
		...
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:GPF:FLEXible:INTernal', value)
