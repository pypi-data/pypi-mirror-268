...
class GycCls:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("gyc", core, parent)
	...
	def get_flexible(self) -> FlexibleStruct:
		...
		Activates the scenario '7CC - nx4 nx4 nx4 nx4 nx4 nx4 nx4' and selects the signal paths. For possible parameter values,
