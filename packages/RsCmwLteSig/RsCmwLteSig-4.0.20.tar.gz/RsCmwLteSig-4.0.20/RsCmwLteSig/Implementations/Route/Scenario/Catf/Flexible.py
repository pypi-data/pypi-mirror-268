...
class FlexibleCls:
	...
	class ExternalStruct(StructBase):  # From WriteStructDefinition CmdPropertyTemplate.xml
		"""Structure for setting input parameters. Fields: \n
			...
			- Pcc_Tx_Connector: enums.TxConnector: No parameter help available
			- Pcc_Tx_Converter: enums.TxConverter: No parameter help available
			- Pcc_Iq_Connector: enums.TxConnector: No parameter help available
			- Scc_1_Bb_Board: enums.BasebandBoard: No parameter help available
			- Scc_1_Tx_Connector: enums.TxConnector: No parameter help available
			- Scc_1_Tx_Converter: enums.TxConverter: No parameter help available
			- Scc_1_Iq_Connector: enums.TxConnector: No parameter help available"""
		__meta_args_list = [
			...
			ArgStruct.scalar_enum('Pcc_Iq_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_1_Bb_Board', enums.BasebandBoard),
			ArgStruct.scalar_enum('Scc_1_Tx_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_1_Tx_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_1_Iq_Connector', enums.TxConnector)]
		...
		def __init__(self):
			...
			self.Pcc_Iq_Connector: enums.TxConnector = None
			self.Scc_1_Bb_Board: enums.BasebandBoard = None
			self.Scc_1_Tx_Connector: enums.TxConnector = None
			self.Scc_1_Tx_Converter: enums.TxConverter = None
			self.Scc_1_Iq_Connector: enums.TxConnector = None

	def get_external(self) -> ExternalStruct:
		"""SCPI: ROUTe:LTE:SIGNaling<instance>:SCENario:CATF:FLEXible[:EXTernal] \n
		Snippet: value: ExternalStruct = driver.route.scenario.catf.flexible.get_external() \n
		No command help available \n
			:return: structure: for return value, see the help for ExternalStruct structure arguments.
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:CATF:FLEXible:EXTernal?', self.__class__.ExternalStruct())
	...
	def set_external(self, value: ExternalStruct) -> None:
		...
		structure.Pcc_Tx_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Pcc_Tx_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Pcc_Iq_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_1_Bb_Board: enums.BasebandBoard = enums.BasebandBoard.BBR1 \n
		structure.Scc_1_Tx_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		structure.Scc_1_Tx_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_1_Iq_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:CATF:FLEXible:EXTernal', value)
	...
	class InternalStruct(StructBase):  # From WriteStructDefinition CmdPropertyTemplate.xml
		"""Structure for setting input parameters. Contains optional set arguments. Fields: \n
			...
			- Scc_1_Fading_Board: enums.FadingBoard: Optional setting parameter. Internal fader for the SCC"""
		__meta_args_list = [
			ArgStruct.scalar_enum('Pcc_Bb_Board', enums.BasebandBoard),
			ArgStruct.scalar_enum('Rx_Connector', enums.RxConnector),
			ArgStruct.scalar_enum('Rx_Converter', enums.RxConverter),
	...
	def get_internal(self) -> InternalStruct:
		...
		Snippet: value: InternalStruct = driver.route.scenario.catf.flexible.get_internal() \n
		Activates the scenario '2CC - Fading - 1x1 1x1' with internal fading and selects the signal paths. For possible parameter
		...
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:CATF:FLEXible:INTernal?', self.__class__.InternalStruct())
	...
	def set_internal(self, value: InternalStruct) -> None:
		...
		structure.Pcc_Tx_Converter: enums.TxConverter = enums.TxConverter.ITX1 \n
		structure.Scc_1_Bb_Board: enums.BasebandBoard = enums.BasebandBoard.BBR1 \n
		structure.Scc_Tx_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:CATF:FLEXible:INTernal', value)
