...
class FlexibleCls:
	...
	class InternalStruct(StructBase):  # From WriteStructDefinition CmdPropertyTemplate.xml
		"""Structure for setting input parameters. Contains optional set arguments. Fields: \n
			...
			- Scc_7_Fading_Board: enums.FadingBoard: Optional setting parameter. Internal fader for the SCC7
		...
		__meta_args_list = [
			...
			ArgStruct.scalar_enum_optional('Scc_7_Fading_Board', enums.FadingBoard),
