...
class FlexibleCls:
	...
	class ExternalStruct(StructBase):  # From WriteStructDefinition CmdPropertyTemplate.xml
		"""Structure for setting input parameters. Fields: \n
			...
			- Scc_1_Tx_1_Connector: enums.TxConnector: No parameter help available
			- Scc_1_Tx_1_Converter: enums.TxConverter: No parameter help available
			- Scc_1_Iq_1_Connector: enums.TxConnector: No parameter help available
			- Scc_1_Tx_2_Connector: enums.TxConnector: No parameter help available
			- Scc_1_Tx_2_Converter: enums.TxConverter: No parameter help available
			- Scc_1_Iq_2_Connector: enums.TxConnector: No parameter help available
			- Scc_2_Bb_Board: enums.BasebandBoard: No parameter help available
			- Scc_2_Tx_1_Connector: enums.TxConnector: No parameter help available
			- Scc_2_Tx_1_Converter: enums.TxConverter: No parameter help available
			- Scc_2_Iq_1_Connector: enums.TxConnector: No parameter help available
			- Scc_2_Tx_2_Connector: enums.TxConnector: No parameter help available
			- Scc_2_Tx_2_Converter: enums.TxConverter: No parameter help available
			- Scc_2_Iq_2_Connector: enums.TxConnector: No parameter help available
			- Scc_3_Bb_Board: enums.BasebandBoard: No parameter help available
			- Scc_3_Tx_1_Connector: enums.TxConnector: No parameter help available
			- Scc_3_Tx_1_Converter: enums.TxConverter: No parameter help available
			- Scc_3_Iq_1_Connector: enums.TxConnector: No parameter help available
			- Scc_3_Tx_2_Connector: enums.TxConnector: No parameter help available
			- Scc_3_Tx_2_Converter: enums.TxConverter: No parameter help available
			- Scc_3_Iq_2_Connector: enums.TxConnector: No parameter help available"""
		__meta_args_list = [
			...
			ArgStruct.scalar_enum('Scc_1_Iq_1_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_1_Tx_2_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_1_Tx_2_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_1_Iq_2_Connector', enums.TxConnector),
			...
			ArgStruct.scalar_enum('Scc_2_Iq_1_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_2_Tx_2_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_2_Tx_2_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_2_Iq_2_Connector', enums.TxConnector),
			...
			ArgStruct.scalar_enum('Scc_3_Iq_1_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_3_Tx_2_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_3_Tx_2_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_3_Iq_2_Connector', enums.TxConnector)]
		...
		def __init__(self):
			...
			self.Scc_1_Iq_1_Connector: enums.TxConnector = None
			self.Scc_1_Tx_2_Connector: enums.TxConnector = None
			self.Scc_1_Tx_2_Converter: enums.TxConverter = None
			self.Scc_1_Iq_2_Connector: enums.TxConnector = None
			...
			self.Scc_2_Iq_1_Connector: enums.TxConnector = None
			self.Scc_2_Tx_2_Connector: enums.TxConnector = None
			self.Scc_2_Tx_2_Converter: enums.TxConverter = None
			self.Scc_2_Iq_2_Connector: enums.TxConnector = None
			...
			self.Scc_3_Iq_1_Connector: enums.TxConnector = None
			self.Scc_3_Tx_2_Connector: enums.TxConnector = None
			self.Scc_3_Tx_2_Converter: enums.TxConverter = None
			self.Scc_3_Iq_2_Connector: enums.TxConnector = None

	def get_external(self) -> ExternalStruct:
		"""SCPI: ROUTe:LTE:SIGNaling<instance>:SCENario:DHF[:FLEXible][:EXTernal] \n
		Snippet: value: ExternalStruct = driver.route.scenario.dhf.flexible.get_external() \n
		No command help available \n
			:return: structure: for return value, see the help for ExternalStruct structure arguments.
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:DHF:FLEXible:EXTernal?', self.__class__.ExternalStruct())
	...
	def set_external(self, value: ExternalStruct) -> None:
		...
		structure.Pcc_Iq_1_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Pcc_Iq_2_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Scc_1_Iq_1_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Scc_1_Iq_2_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Scc_2_Iq_1_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Scc_2_Iq_2_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Scc_3_Iq_1_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		structure.Scc_3_Iq_2_Connector: enums.TxConnector = enums.TxConnector.I12O \n
		...
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:DHF:FLEXible:EXTernal', value)
	...
	def get_internal(self) -> InternalStruct:
		...
		Snippet: value: InternalStruct = driver.route.scenario.dhf.flexible.get_internal() \n
		Activates the scenario '4CC - Fading - nx2 nx2 nx2 nx2' with internal fading and selects the signal paths. For possible
		...
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:DHF:FLEXible:INTernal?', self.__class__.InternalStruct())
	...
	def set_internal(self, value: InternalStruct) -> None:
		...
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:DHF:FLEXible:INTernal', value)
