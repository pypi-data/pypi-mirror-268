...
if TYPE_CHECKING:
    ...
    from .get_notification_rules import GetNotificationRulesNotificationRules
    ...
    from .get_source_incidents import GetSourceIncidentsSource
    ...
    from .get_users import GetUsersUsers
    ...
    from .update_source_namespace import UpdateSourceNamespaceSourceNamespaceUpdate
    ...
    from .update_user_namespace import UpdateUserNamespaceUserNamespaceUpdate
    ...
    from .update_window_namespace import UpdateWindowNamespaceWindowNamespaceUpdate
...
class Client(AsyncBaseClient):
    ...
    async def get_channel_by_resource_name(
        self, resource_name: str, resource_namespace: str, **kwargs: Any
    ) -> Optional[
        Union[
            "GetChannelByResourceNameChannelByResourceNameChannel",
            "GetChannelByResourceNameChannelByResourceNameMsTeamsChannel",
    ...
    async def get_channels(
        ...
        **kwargs: Any
        ...
        response = await self.execute(
            query=query, operation_name="GetChannels", variables=variables, **kwargs
        )
        data = self.get_data(response)
    ...
    async def get_identity_providers(
        ...
        **kwargs: Any
        ...
        from .get_identity_providers import GetIdentityProviders
        ...
        response = await self.execute(
            query=query,
            operation_name="GetIdentityProviders",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def get_incidents(
        ...
        **kwargs: Any
        ...
        response = await self.execute(
            query=query, operation_name="GetIncidents", variables=variables, **kwargs
        )
        data = self.get_data(response)
    ...
    async def get_notification_rules(
        ...
        **kwargs: Any
        ...
        from .get_notification_rules import GetNotificationRules
        ...
        response = await self.execute(
            query=query,
            operation_name="GetNotificationRules",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def get_source_incidents(
        self, id: SourceId, range: "TimeRangeInput", **kwargs: Any
    ) -> Optional["GetSourceIncidentsSource"]:
        from .get_source_incidents import GetSourceIncidents
        ...
        response = await self.execute(
            query=query,
            operation_name="GetSourceIncidents",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def list_databricks_catalogs(
        self, input: "DatabricksListCatalogsInput", **kwargs: Any
    ) -> List[str]:
        ...
        response = await self.execute(
            query=query,
            operation_name="ListDatabricksCatalogs",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def list_databricks_schemas(
        self, input: "DatabricksListSchemasInput", **kwargs: Any
    ) -> List[str]:
        ...
        response = await self.execute(
            query=query,
            operation_name="ListDatabricksSchemas",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def list_databricks_tables(
        self, input: "DatabricksListTablesInput", **kwargs: Any
    ) -> List[str]:
        ...
        response = await self.execute(
            query=query,
            operation_name="ListDatabricksTables",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def list_dbt_model_jobs(
        self, input: "DbtModelListJobsInput", **kwargs: Any
    ) -> List[str]:
        ...
        response = await self.execute(
            query=query,
            operation_name="ListDbtModelJobs",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def list_dbt_model_projects(self, **kwargs: Any) -> List[str]:
        ...
        response = await self.execute(
            query=query,
            operation_name="ListDbtModelProjects",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def update_identity_provider_namespace(
        ...
        from .update_identity_provider_namespace import UpdateIdentityProviderNamespace
        ...
        response = await self.execute(
            query=query,
            operation_name="UpdateIdentityProviderNamespace",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def update_notification_rule_namespace(
        ...
        from .update_notification_rule_namespace import UpdateNotificationRuleNamespace
        ...
        response = await self.execute(
            query=query,
            operation_name="UpdateNotificationRuleNamespace",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def update_segmentation_namespace(
        ...
        from .update_segmentation_namespace import UpdateSegmentationNamespace
        ...
        response = await self.execute(
            query=query,
            operation_name="UpdateSegmentationNamespace",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def update_source_namespace(
        ...
        from .update_source_namespace import UpdateSourceNamespace
        ...
        response = await self.execute(
            query=query,
            operation_name="UpdateSourceNamespace",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def update_user_namespace(
        ...
        from .update_user_namespace import UpdateUserNamespace
        ...
        response = await self.execute(
            query=query,
            operation_name="UpdateUserNamespace",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def update_validator_namespace(
        ...
        from .update_validator_namespace import UpdateValidatorNamespace
        ...
        response = await self.execute(
            query=query,
            operation_name="UpdateValidatorNamespace",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
    ...
    async def update_window_namespace(
        ...
        from .update_window_namespace import UpdateWindowNamespace
        ...
        response = await self.execute(
            query=query,
            operation_name="UpdateWindowNamespace",
            variables=variables,
            **kwargs
        )
        data = self.get_data(response)
