...
class CapsuleCreateResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "writeContextConfiguration": WriteContextConfigInfo.from_dict(obj.get("writeContextConfiguration")) if obj.get("writeContextConfiguration") is not None else None
        })
        return _obj
