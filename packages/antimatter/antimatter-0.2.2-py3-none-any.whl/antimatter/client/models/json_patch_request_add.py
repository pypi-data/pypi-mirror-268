...
class JSONPatchRequestAdd(BaseModel):
    """
    JSONPatchRequestAdd
    """ # noqa: E501
    path: StrictStr = Field(description="A JSON Pointer path.")
    value: JSONPatchRequestAddValue
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "path": obj.get("path"),
            "value": JSONPatchRequestAddValue.from_dict(obj.get("value")) if obj.get("value") is not None else None,
            "op": obj.get("op")
        })
        return _obj
