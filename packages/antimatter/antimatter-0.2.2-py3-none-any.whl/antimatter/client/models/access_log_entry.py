...
class AccessLogEntry(BaseModel):
    ...
    def operation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('open', 'read', 'create'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "createInfo": AccessLogEntryCreateInfo.from_dict(obj.get("createInfo")) if obj.get("createInfo") is not None else None,
            "openInfo": AccessLogEntryOpenInfo.from_dict(obj.get("openInfo")) if obj.get("openInfo") is not None else None,
            "readInfo": AccessLogEntryReadInfo.from_dict(obj.get("readInfo")) if obj.get("readInfo") is not None else None
        })
        return _obj
