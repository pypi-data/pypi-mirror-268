...
class CapsuleInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "domain", "capsuleTags", "spanTags", "size", "created", "pageKey"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spanTags": TagSummary.from_dict(obj.get("spanTags")) if obj.get("spanTags") is not None else None,
            "size": obj.get("size"),
