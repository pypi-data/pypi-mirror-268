...
class JSONPatchRequestReplace(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "path": obj.get("path"),
            "value": JSONPatchRequestReplaceValue.from_dict(obj.get("value")) if obj.get("value") is not None else None,
            "op": obj.get("op")
        })
        return _obj
