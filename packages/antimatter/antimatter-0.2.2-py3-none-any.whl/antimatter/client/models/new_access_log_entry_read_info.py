...
class NewAccessLogEntryReadInfo(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "allowedTags": TagSummary.from_dict(obj.get("allowedTags")) if obj.get("allowedTags") is not None else None,
            "redactedTags": TagSummary.from_dict(obj.get("redactedTags")) if obj.get("redactedTags") is not None else None,
            "tokenizedTags": TagSummary.from_dict(obj.get("tokenizedTags")) if obj.get("tokenizedTags") is not None else None,
