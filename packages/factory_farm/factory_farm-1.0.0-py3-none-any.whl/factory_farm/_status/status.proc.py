...
factory_farm_path = str (normpath (join (this_folder, "..")))

print ("factory_farm_path:", factory_farm_path)

import sys
if (len (sys.argv) >= 2):
	glob_string = factory_farm_path + '/' + sys.argv [1]
else:
	glob_string = factory_farm_path + '/**/status_*.py'
