...
'''
	python3 /factory_farm/venues/stages/factory_farm/_status/status.proc.py "_status/monitors/4_bad_import/status_1.py"
'''
...
def check_1 ():
	...
	import json
	print ("UT 4.1 status found", json.dumps (status ["stats"], indent = 4))
	assert (len (paths) == 1)
