...
class TrackersListResponse(object):
    ...
    def __init__(self, id=None, name=None, matches=None):  # noqa: E501
        """TrackersListResponse - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
        self._matches = None
    ...
    @property
    def id(self):
        """Gets the id of this TrackersListResponse.  # noqa: E501


        :return: The id of this TrackersListResponse.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TrackersListResponse.


        :param id: The id of this TrackersListResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this TrackersListResponse.  # noqa: E501


        :return: The name of this TrackersListResponse.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TrackersListResponse.


        :param name: The name of this TrackersListResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def matches(self):
        """Gets the matches of this TrackersListResponse.  # noqa: E501


        :return: The matches of this TrackersListResponse.  # noqa: E501
        :rtype: list[MatchesItems]
        """
        return self._matches

    @matches.setter
    def matches(self, matches):
        """Sets the matches of this TrackersListResponse.


        :param matches: The matches of this TrackersListResponse.  # noqa: E501
        :type: list[MatchesItems]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TrackersListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrackersListResponse):
            return False
