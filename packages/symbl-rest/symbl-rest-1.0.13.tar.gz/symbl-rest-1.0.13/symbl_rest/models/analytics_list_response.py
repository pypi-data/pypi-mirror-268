...
class AnalyticsListResponse(object):
    ...
    """
    swagger_types = {
        'metrics': 'list[AnalyticsMetricsInfo]',
        'members': 'list[AnalyticsMembersInfo]'
    }
    ...
    def __init__(self, metrics=None, members=None):  # noqa: E501
        """AnalyticsListResponse - a model defined in Swagger"""  # noqa: E501
        self._metrics = None
        self._members = None
    ...
    @property
    def metrics(self):
        """Gets the metrics of this AnalyticsListResponse.  # noqa: E501


        :return: The metrics of this AnalyticsListResponse.  # noqa: E501
        :rtype: list[AnalyticsMetricsInfo]
        """
        return self._metrics

    @metrics.setter
    def metrics(self, metrics):
        """Sets the metrics of this AnalyticsListResponse.


        :param metrics: The metrics of this AnalyticsListResponse.  # noqa: E501
        :type: list[AnalyticsMetricsInfo]
        """
    ...
    @property
    def members(self):
        """Gets the members of this AnalyticsListResponse.  # noqa: E501


        :return: The members of this AnalyticsListResponse.  # noqa: E501
        :rtype: list[AnalyticsMembersInfo]
        """
        return self._members

    @members.setter
    def members(self, members):
        """Sets the members of this AnalyticsListResponse.


        :param members: The members of this AnalyticsListResponse.  # noqa: E501
        :type: list[AnalyticsMembersInfo]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnalyticsListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnalyticsListResponse):
            return False
