...
class EntitiesListResponse(object):
    ...
    def __init__(self, entities=None):  # noqa: E501
        """EntitiesListResponse - a model defined in Swagger"""  # noqa: E501
        self._entities = None
    ...
    @property
    def entities(self):
        """Gets the entities of this EntitiesListResponse.  # noqa: E501


        :return: The entities of this EntitiesListResponse.  # noqa: E501
        :rtype: list[EntitiesTag]
        """
        return self._entities

    @entities.setter
    def entities(self, entities):
        """Sets the entities of this EntitiesListResponse.


        :param entities: The entities of this EntitiesListResponse.  # noqa: E501
        :type: list[EntitiesTag]
        """
        if entities is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EntitiesListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EntitiesListResponse):
            return False
