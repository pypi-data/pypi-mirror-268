...
class AsyncTrackersInner(object):
    ...
    def __init__(self, name=None, vocabulary=None):  # noqa: E501
        """AsyncTrackersInner - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this AsyncTrackersInner.  # noqa: E501


        :return: The name of this AsyncTrackersInner.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AsyncTrackersInner.


        :param name: The name of this AsyncTrackersInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def vocabulary(self):
        """Gets the vocabulary of this AsyncTrackersInner.  # noqa: E501


        :return: The vocabulary of this AsyncTrackersInner.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def vocabulary(self, vocabulary):
        """Sets the vocabulary of this AsyncTrackersInner.


        :param vocabulary: The vocabulary of this AsyncTrackersInner.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AsyncTrackersInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncTrackersInner):
            return False
