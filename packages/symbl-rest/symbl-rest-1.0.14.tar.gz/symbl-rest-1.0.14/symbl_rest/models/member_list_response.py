...
class MemberListResponse(object):
    ...
    def __init__(self, members=None):  # noqa: E501
        """MemberListResponse - a model defined in Swagger"""  # noqa: E501
        self._members = None
    ...
    @property
    def members(self):
        """Gets the members of this MemberListResponse.  # noqa: E501


        :return: The members of this MemberListResponse.  # noqa: E501
        :rtype: list[ModelFrom]
        """
        return self._members

    @members.setter
    def members(self, members):
        """Sets the members of this MemberListResponse.


        :param members: The members of this MemberListResponse.  # noqa: E501
        :type: list[ModelFrom]
        """
        if members is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MemberListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MemberListResponse):
            return False
