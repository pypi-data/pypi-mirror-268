...
class CallScoreStatusResponse(object):
    ...
    def __init__(self, job_id=None, status=None):  # noqa: E501
        """CallScoreStatusResponse - a model defined in Swagger"""  # noqa: E501
        self._job_id = None
        self._status = None
    ...
    @property
    def job_id(self):
        """Gets the job_id of this CallScoreStatusResponse.  # noqa: E501

        Job Identifier to be used in Job API  # noqa: E501

        :return: The job_id of this CallScoreStatusResponse.  # noqa: E501
        :rtype: str
        """
        return self._job_id
    ...
    def job_id(self, job_id):
        """Sets the job_id of this CallScoreStatusResponse.

        Job Identifier to be used in Job API  # noqa: E501

        :param job_id: The job_id of this CallScoreStatusResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this CallScoreStatusResponse.  # noqa: E501

        Status of the Conversation  # noqa: E501

        :return: The status of this CallScoreStatusResponse.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this CallScoreStatusResponse.

        Status of the Conversation  # noqa: E501

        :param status: The status of this CallScoreStatusResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CallScoreStatusResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallScoreStatusResponse):
            return False
