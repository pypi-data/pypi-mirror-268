...
class DurationPayload(object):
    ...
    def __init__(self, start_time=None, end_time=None):  # noqa: E501
        """DurationPayload - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def start_time(self):
        """Gets the start_time of this DurationPayload.  # noqa: E501

        Timestamp in ISO 8601 format when the event was generated. If this is omitted, automatic calculation of timestamp will be done.  # noqa: E501

        :return: The start_time of this DurationPayload.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this DurationPayload.

        Timestamp in ISO 8601 format when the event was generated. If this is omitted, automatic calculation of timestamp will be done.  # noqa: E501

        :param start_time: The start_time of this DurationPayload.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def end_time(self):
        """Gets the end_time of this DurationPayload.  # noqa: E501

        Timestamp in ISO 8601 format when the event was generated. If this is omitted, automatic calculation of timestamp will be done.  # noqa: E501

        :return: The end_time of this DurationPayload.  # noqa: E501
        :rtype: datetime
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this DurationPayload.

        Timestamp in ISO 8601 format when the event was generated. If this is omitted, automatic calculation of timestamp will be done.  # noqa: E501

        :param end_time: The end_time of this DurationPayload.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DurationPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DurationPayload):
            return False
