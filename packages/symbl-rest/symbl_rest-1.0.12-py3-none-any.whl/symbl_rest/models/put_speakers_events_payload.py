...
class PutSpeakersEventsPayload(object):
    ...
    """
    swagger_types = {
        'speaker_events': 'list[ConversationSpeakersEvents]'
    }
    ...
    def __init__(self, speaker_events=None):  # noqa: E501
        """PutSpeakersEventsPayload - a model defined in Swagger"""  # noqa: E501
        self._speaker_events = None
        self.discriminator = None
        self.speaker_events = speaker_events

    @property
    def speaker_events(self):
        """Gets the speaker_events of this PutSpeakersEventsPayload.  # noqa: E501


        :return: The speaker_events of this PutSpeakersEventsPayload.  # noqa: E501
        :rtype: list[ConversationSpeakersEvents]
        """
        return self._speaker_events

    @speaker_events.setter
    def speaker_events(self, speaker_events):
        """Sets the speaker_events of this PutSpeakersEventsPayload.


        :param speaker_events: The speaker_events of this PutSpeakersEventsPayload.  # noqa: E501
        :type: list[ConversationSpeakersEvents]
        """
        if speaker_events is None:
            raise ValueError("Invalid value for `speaker_events`, must not be `None`")  # noqa: E501

        self._speaker_events = speaker_events
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PutSpeakersEventsPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PutSpeakersEventsPayload):
            return False
