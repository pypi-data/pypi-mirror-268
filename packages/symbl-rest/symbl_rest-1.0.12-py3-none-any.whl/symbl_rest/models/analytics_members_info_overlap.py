...
class AnalyticsMembersInfoOverlap(object):
    ...
    swagger_types = {
        ...
        'overlapping_members': 'list[AnalyticsMembersInfoOverlapOverlappingMembers]'
    }

    attribute_map = {
        'overlap_duration': 'overlapDuration',
        'overlapping_members': 'overlappingMembers'
    }

    def __init__(self, overlap_duration=None, overlapping_members=None):  # noqa: E501
        """AnalyticsMembersInfoOverlap - a model defined in Swagger"""  # noqa: E501
        self._overlap_duration = None
        self._overlapping_members = None
        self.discriminator = None
        if overlap_duration is not None:
            self.overlap_duration = overlap_duration
        if overlapping_members is not None:
            self.overlapping_members = overlapping_members

    @property
    def overlap_duration(self):
        """Gets the overlap_duration of this AnalyticsMembersInfoOverlap.  # noqa: E501


        :return: The overlap_duration of this AnalyticsMembersInfoOverlap.  # noqa: E501
        :rtype: float
        """
        return self._overlap_duration

    @overlap_duration.setter
    def overlap_duration(self, overlap_duration):
        """Sets the overlap_duration of this AnalyticsMembersInfoOverlap.


        :param overlap_duration: The overlap_duration of this AnalyticsMembersInfoOverlap.  # noqa: E501
        :type: float
        """
    ...
    @property
    def overlapping_members(self):
        """Gets the overlapping_members of this AnalyticsMembersInfoOverlap.  # noqa: E501


        :return: The overlapping_members of this AnalyticsMembersInfoOverlap.  # noqa: E501
        :rtype: list[AnalyticsMembersInfoOverlapOverlappingMembers]
        """
        return self._overlapping_members

    @overlapping_members.setter
    def overlapping_members(self, overlapping_members):
        """Sets the overlapping_members of this AnalyticsMembersInfoOverlap.


        :param overlapping_members: The overlapping_members of this AnalyticsMembersInfoOverlap.  # noqa: E501
        :type: list[AnalyticsMembersInfoOverlapOverlappingMembers]
        """

        self._overlapping_members = overlapping_members
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnalyticsMembersInfoOverlap, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnalyticsMembersInfoOverlap):
            return False
