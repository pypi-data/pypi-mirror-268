...
class FromPayload(object):
    ...
    def __init__(self, id=None, name=None, user_id=None):  # noqa: E501
        """FromPayload - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
        self._user_id = None
    ...
    @property
    def id(self):
        """Gets the id of this FromPayload.  # noqa: E501

        Id of the user  # noqa: E501

        :return: The id of this FromPayload.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this FromPayload.

        Id of the user  # noqa: E501

        :param id: The id of this FromPayload.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this FromPayload.  # noqa: E501

        Name of the user  # noqa: E501

        :return: The name of this FromPayload.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FromPayload.

        Name of the user  # noqa: E501

        :param name: The name of this FromPayload.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_id(self):
        """Gets the user_id of this FromPayload.  # noqa: E501
        ...
        :return: The user_id of this FromPayload.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this FromPayload.

        Unique Identifier for user, recommended to be human readable. Usually this should be username or email Id etc. that user is also aware of.  # noqa: E501

        :param user_id: The user_id of this FromPayload.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FromPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FromPayload):
            return False
