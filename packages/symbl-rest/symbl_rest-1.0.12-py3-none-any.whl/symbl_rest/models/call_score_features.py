...
class CallScoreFeatures(object):
    ...
    def __init__(self, feature_list=None):  # noqa: E501
        """CallScoreFeatures - a model defined in Swagger"""  # noqa: E501
    ...
    def feature_list(self):
        """Gets the feature_list of this CallScoreFeatures.  # noqa: E501

        List of features to be used for scoring  # noqa: E501

        :return: The feature_list of this CallScoreFeatures.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def feature_list(self, feature_list):
        """Sets the feature_list of this CallScoreFeatures.

        List of features to be used for scoring  # noqa: E501

        :param feature_list: The feature_list of this CallScoreFeatures.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CallScoreFeatures, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallScoreFeatures):
            return False
