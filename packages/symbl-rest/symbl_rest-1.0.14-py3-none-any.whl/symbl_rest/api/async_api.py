...
class AsyncApi(object):
    ...
    def add_audio(self, body, content_type, **kwargs):  # noqa: E501
        ...
        :param CallScoreFeatures features:
        :param CallScoreMetadata metadata:
    ...
    def add_audio_with_http_info(self, body, content_type, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'content_type', 'name', 'webhook_url', 'custom_vocabulary', 'confidence_threshold', 'entities', 'detect_entities', 'enable_all_trackers', 'detect_phrases', 'enable_separate_recognition_per_channel', 'channel_metadata', 'language_code', 'mode', 'trackers', 'enable_speaker_diarization', 'diarization_speaker_count', 'features', 'metadata']  # noqa: E501
    ...
    def append_video_with_http_info(self, body, content_type, conversation_id, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'content_type', 'conversation_id', 'name', 'webhook_url', 'custom_vocabulary', 'confidence_threshold', 'entities', 'detect_entities', 'detect_phrases', 'enable_separate_recognition_per_channel', 'channel_metadata', 'language_code', 'mode', 'trackers', 'enable_speaker_diarization', 'diarization_speaker_count', 'features', 'metadata']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
