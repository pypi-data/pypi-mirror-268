...
class ExperienceApi(object):
    ...
    def get_experience_url_by_conversation_id(self, conversation_id, **kwargs):  # noqa: E501
        """Retrieve insights ui url  # noqa: E501

        Get insights ui url by conversationId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_experience_url_by_conversation_id(conversation_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str conversation_id: ID of the conversation (required)
        :param bool include_call_score:
        ...
        if kwargs.get('async_req'):
            return self.get_experience_url_by_conversation_id_with_http_info(conversation_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_experience_url_by_conversation_id_with_http_info(conversation_id, **kwargs)  # noqa: E501
            return data

    def get_experience_url_by_conversation_id_with_http_info(self, conversation_id, **kwargs):  # noqa: E501
        """Retrieve insights ui url  # noqa: E501

        Get insights ui url by conversationId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_experience_url_by_conversation_id_with_http_info(conversation_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['conversation_id', 'include_call_score']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_experience_url_by_conversation_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('conversation_id' not in params or
            ...
            raise ValueError("Missing the required parameter `conversation_id` when calling `get_experience_url_by_conversation_id`")  # noqa: E501
        ...
        query_params = []
        if 'include_call_score' in params:
            query_params.append(('includeCallScore', params['include_call_score']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/conversations/experiences/insights/details/{conversationId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ExperienceResponse',  # noqa: E501
