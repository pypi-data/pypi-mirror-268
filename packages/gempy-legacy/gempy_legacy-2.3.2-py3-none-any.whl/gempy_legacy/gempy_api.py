...
import warnings
from gempy_legacy.core.model import Project
from gempy_legacy.core.solution import Solution
from gempy_legacy.utils.meta import _setdoc, _setdoc_pro
...
def activate_interactive_df(geo_model: Project, plot_object=None):
    ...
    """
    try:
        from gempy_legacy.core.qgrid_integration import QgridModelIntegration
    except ImportError:
