...
def plot_ar(geo_model, path=None, project_name=None, api_token=None, secret=None):
    ...
    """
    from gempy_legacy.addons.rex_api import upload_to_rexcloud
    from gempy_legacy.addons.gempy_to_rexfile import write_rex, geomodel_to_rex
